...
assert  my_inv (  (  BV32_SLE(0bv32, $i.2) ) ,  (  BV32_SLE($i.2, 0bv32) ) ,  (  BV32_SGE($i.2, 0bv32) ) ,  (  BV32_ULE($i.2, 0bv32) ) ,  (  BV32_UGE($i.2, 0bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$fail ==> _WATCHED_OFFSET == 0bv32 )  ); 
