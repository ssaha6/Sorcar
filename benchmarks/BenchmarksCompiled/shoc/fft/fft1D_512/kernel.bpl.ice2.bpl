...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $i.i38.0) ) ,  (  BV32_SLE($i.i38.0, 0bv32) ) ,  (  BV32_SGE($i.i38.0, 0bv32) ) ,  (  BV32_ULE($i.i38.0, 0bv32) ) ,  (  BV32_UGE($i.i38.0, 0bv32) ) ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$work ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$work ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 512bv32), local_id_x$1), 2bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$work ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32))) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32)), 1bv32)) )  ); 
  ...
  $truebb10:
    ...
    call {:sourceloc} {:sourceloc_num 638} _LOG_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), v365$1, $$work[BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32))]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 638} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), v365$2);
    ...
    call {:sourceloc} {:sourceloc_num 639} _LOG_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32), v366$1, $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 639} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32), v366$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$work"} true;
  ...
  $truebb8:
    ...
    call {:sourceloc} {:sourceloc_num 466} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$1, BV32_MUL($i.i41.0, 72bv32)), v267$1, $$fft1D_512.smem[1bv1][BV32_ADD(v255$1, BV32_MUL($i.i41.0, 72bv32))]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 466} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$2, BV32_MUL($i.i41.0, 72bv32)), v267$2);
  ...
  $truebb6:
    ...
    call {:sourceloc} {:sourceloc_num 431} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$1, BV32_MUL($i.i44.0, 72bv32)), v248$1, $$fft1D_512.smem[1bv1][BV32_ADD(v237$1, BV32_MUL($i.i44.0, 72bv32))]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 431} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$2, BV32_MUL($i.i44.0, 72bv32)), v248$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
  ...
  $truebb3:
    ...
    call {:sourceloc} {:sourceloc_num 231} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$1, BV32_MUL($i.i48.0, 66bv32)), v134$1, $$fft1D_512.smem[1bv1][BV32_ADD(v122$1, BV32_MUL($i.i48.0, 66bv32))]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 231} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$2, BV32_MUL($i.i48.0, 66bv32)), v134$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
  ...
  $truebb2:
    ...
    v119$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v117$1, BV32_MUL($i.i53.0, 8bv32))];
    v119$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v117$2, BV32_MUL($i.i53.0, 8bv32))];
  ...
  $truebb1:
    ...
    call {:sourceloc} {:sourceloc_num 196} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$1, BV32_MUL($i.i51.0, 66bv32)), v115$1, $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i51.0, 66bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i51.0, 66bv32)));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 196} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 196} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i51.0, 66bv32)), v115$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i51.0, 66bv32))] := v115$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v104$2, BV32_MUL($i.i51.0, 66bv32))] := v115$2;
