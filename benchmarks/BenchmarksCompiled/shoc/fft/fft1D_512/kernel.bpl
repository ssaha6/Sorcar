...
implementation {:source_name "fft1D_512"} {:kernel} $fft1D_512()
{
  ...
  $for.cond.i.1242:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($i.i.1224.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($i.i.1224.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($i.i.1224.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($i.i.1224.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $i.i.1224.0);
    assert {:block_sourceloc} {:sourceloc_num 189} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 190} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 66bv32), 8bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 191} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 66bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    v113 := BV32_SLT($i.i.1224.0, 8bv32);
  ...
  $for.cond.i.1255:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($i.i.1253.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($i.i.1253.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($i.i.1253.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($i.i.1253.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b10 ==> BV32_SLE(0bv32, $i.i.1253.0);
    assert {:block_sourceloc} {:sourceloc_num 199} true;
    v118 := BV32_SLT($i.i.1253.0, 8bv32);
  ...
  $for.cond.i.1173:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_UGE($i.i.1155.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_ULE($i.i.1155.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SGE($i.i.1155.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SLE($i.i.1155.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b15 ==> BV32_SLE(0bv32, $i.i.1155.0);
    assert {:block_sourceloc} {:sourceloc_num 224} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 225} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 66bv32), 8bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 226} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 66bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    v131 := BV32_SLT($i.i.1155.0, 8bv32);
  ...
  $for.cond.i.1140:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b24 ==> BV32_UGE($i.i.1138.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b23 ==> BV32_ULE($i.i.1138.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b22 ==> BV32_SGE($i.i.1138.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b21 ==> BV32_SLE($i.i.1138.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b20 ==> BV32_SLE(0bv32, $i.i.1138.0);
    assert {:block_sourceloc} {:sourceloc_num 234} true;
    v136 := BV32_SLT($i.i.1138.0, 8bv32);
  ...
  $for.cond.i.795:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b29 ==> BV32_UGE($i.i.777.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b28 ==> BV32_ULE($i.i.777.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b27 ==> BV32_SGE($i.i.777.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b26 ==> BV32_SLE($i.i.777.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b25 ==> BV32_SLE(0bv32, $i.i.777.0);
    assert {:block_sourceloc} {:sourceloc_num 424} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 425} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 72bv32), 8bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 426} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 72bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    v246 := BV32_SLT($i.i.777.0, 8bv32);
  ...
  $for.cond.i.763:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b34 ==> BV32_UGE($i.i.761.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b33 ==> BV32_ULE($i.i.761.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b32 ==> BV32_SGE($i.i.761.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b31 ==> BV32_SLE($i.i.761.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b30 ==> BV32_SLE(0bv32, $i.i.761.0);
    assert {:block_sourceloc} {:sourceloc_num 434} true;
    v251 := BV32_SLT($i.i.761.0, 8bv32);
  ...
  $for.cond.i.652:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b39 ==> BV32_UGE($i.i.649.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b38 ==> BV32_ULE($i.i.649.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b37 ==> BV32_SGE($i.i.649.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b36 ==> BV32_SLE($i.i.649.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b35 ==> BV32_SLE(0bv32, $i.i.649.0);
    assert {:block_sourceloc} {:sourceloc_num 459} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 460} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 72bv32), 8bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 461} {:thread 1} (if _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), local_id_x$1), 72bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    v264 := BV32_SLT($i.i.649.0, 8bv32);
  ...
  $for.cond.i.639:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b44 ==> BV32_UGE($i.i.637.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b43 ==> BV32_ULE($i.i.637.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b42 ==> BV32_SGE($i.i.637.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b41 ==> BV32_SLE($i.i.637.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b40 ==> BV32_SLE(0bv32, $i.i.637.0);
    assert {:block_sourceloc} {:sourceloc_num 469} true;
    v269 := BV32_SLT($i.i.637.0, 8bv32);
  ...
  $for.cond.i.421:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b49 ==> BV32_UGE($i.i.419.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b48 ==> BV32_ULE($i.i.419.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b47 ==> BV32_SGE($i.i.419.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b46 ==> BV32_SLE($i.i.419.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b45 ==> BV32_SLE(0bv32, $i.i.419.0);
    assert {:block_sourceloc} {:sourceloc_num 633} true;
    v363 := BV32_SLT($i.i.419.0, 8bv32);
  ...
  $truebb10:
    assume {:partition} v363;
    v364$1 := $$reversed.i$1[$i.i.419.0];
    v364$2 := $$reversed.i$2[$i.i.419.0];
    ...
    call {:sourceloc} {:sourceloc_num 638} _LOG_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), v365$1, $$work[BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$work(true, BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 638} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 638} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), v365$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$work"} true;
    $$work[BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32))] := v365$1;
    $$work[BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32))] := v365$2;
    call {:sourceloc} {:sourceloc_num 639} _LOG_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32), v366$1, $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 639} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 639} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32), v366$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$work"} true;
    $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32)] := v366$1;
    $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i.419.0, 64bv32), 2bv32)), 1bv32)] := v366$2;
    $i.i.419.0 := BV32_ADD($i.i.419.0, 1bv32);
  ...
  $truebb9:
    ...
    v270$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v268$1, BV32_MUL($i.i.637.0, 8bv32))];
    v270$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v268$2, BV32_MUL($i.i.637.0, 8bv32))];
    v271$1 := $$data$1[BV32_MUL($i.i.637.0, 2bv32)];
    v271$2 := $$data$2[BV32_MUL($i.i.637.0, 2bv32)];
    v272$1 := $$data$1[BV32_ADD(BV32_MUL($i.i.637.0, 2bv32), 1bv32)];
    v272$2 := $$data$2[BV32_ADD(BV32_MUL($i.i.637.0, 2bv32), 1bv32)];
    $$data$1[BV32_MUL($i.i.637.0, 2bv32)] := v271$1;
    $$data$2[BV32_MUL($i.i.637.0, 2bv32)] := v271$2;
    $$data$1[BV32_ADD(BV32_MUL($i.i.637.0, 2bv32), 1bv32)] := v270$1;
    $$data$2[BV32_ADD(BV32_MUL($i.i.637.0, 2bv32), 1bv32)] := v270$2;
    $i.i.637.0 := BV32_ADD($i.i.637.0, 1bv32);
    assume {:captureState "loop_back_edge_state_1_0"} true;
    goto $for.cond.i.639;

  $truebb8:
    assume {:partition} v264;
    v265$1 := $$reversed.i$1[$i.i.649.0];
    v265$2 := $$reversed.i$2[$i.i.649.0];
    ...
    call {:sourceloc} {:sourceloc_num 466} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$1, BV32_MUL($i.i.649.0, 72bv32)), v267$1, $$fft1D_512.smem[1bv1][BV32_ADD(v255$1, BV32_MUL($i.i.649.0, 72bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v255$2, BV32_MUL($i.i.649.0, 72bv32)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 466} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 466} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$2, BV32_MUL($i.i.649.0, 72bv32)), v267$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v255$1, BV32_MUL($i.i.649.0, 72bv32))] := v267$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v255$2, BV32_MUL($i.i.649.0, 72bv32))] := v267$2;
    $i.i.649.0 := BV32_ADD($i.i.649.0, 1bv32);
  ...
  $truebb7:
    ...
    v252$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v250$1, BV32_MUL($i.i.761.0, 8bv32))];
    v252$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v250$2, BV32_MUL($i.i.761.0, 8bv32))];
    v253$1 := $$data$1[BV32_MUL($i.i.761.0, 2bv32)];
    v253$2 := $$data$2[BV32_MUL($i.i.761.0, 2bv32)];
    v254$1 := $$data$1[BV32_ADD(BV32_MUL($i.i.761.0, 2bv32), 1bv32)];
    v254$2 := $$data$2[BV32_ADD(BV32_MUL($i.i.761.0, 2bv32), 1bv32)];
    $$data$1[BV32_MUL($i.i.761.0, 2bv32)] := v252$1;
    $$data$2[BV32_MUL($i.i.761.0, 2bv32)] := v252$2;
    $$data$1[BV32_ADD(BV32_MUL($i.i.761.0, 2bv32), 1bv32)] := v254$1;
    $$data$2[BV32_ADD(BV32_MUL($i.i.761.0, 2bv32), 1bv32)] := v254$2;
    $i.i.761.0 := BV32_ADD($i.i.761.0, 1bv32);
    assume {:captureState "loop_back_edge_state_3_0"} true;
    goto $for.cond.i.763;

  $truebb6:
    assume {:partition} v246;
    v247$1 := $$reversed.i$1[$i.i.777.0];
    v247$2 := $$reversed.i$2[$i.i.777.0];
    ...
    call {:sourceloc} {:sourceloc_num 431} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$1, BV32_MUL($i.i.777.0, 72bv32)), v248$1, $$fft1D_512.smem[1bv1][BV32_ADD(v237$1, BV32_MUL($i.i.777.0, 72bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v237$2, BV32_MUL($i.i.777.0, 72bv32)));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 431} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 431} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$2, BV32_MUL($i.i.777.0, 72bv32)), v248$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v237$1, BV32_MUL($i.i.777.0, 72bv32))] := v248$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v237$2, BV32_MUL($i.i.777.0, 72bv32))] := v248$2;
    $i.i.777.0 := BV32_ADD($i.i.777.0, 1bv32);
  ...
  $truebb4:
    ...
    v137$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v135$1, BV32_MUL($i.i.1138.0, 8bv32))];
    v137$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v135$2, BV32_MUL($i.i.1138.0, 8bv32))];
    v138$1 := $$data$1[BV32_MUL($i.i.1138.0, 2bv32)];
    v138$2 := $$data$2[BV32_MUL($i.i.1138.0, 2bv32)];
    v139$1 := $$data$1[BV32_ADD(BV32_MUL($i.i.1138.0, 2bv32), 1bv32)];
    v139$2 := $$data$2[BV32_ADD(BV32_MUL($i.i.1138.0, 2bv32), 1bv32)];
    $$data$1[BV32_MUL($i.i.1138.0, 2bv32)] := v138$1;
    $$data$2[BV32_MUL($i.i.1138.0, 2bv32)] := v138$2;
    $$data$1[BV32_ADD(BV32_MUL($i.i.1138.0, 2bv32), 1bv32)] := v137$1;
    $$data$2[BV32_ADD(BV32_MUL($i.i.1138.0, 2bv32), 1bv32)] := v137$2;
    $i.i.1138.0 := BV32_ADD($i.i.1138.0, 1bv32);
    assume {:captureState "loop_back_edge_state_6_0"} true;
    goto $for.cond.i.1140;

  $truebb3:
    assume {:partition} v131;
    v132$1 := $$reversed.i$1[$i.i.1155.0];
    v132$2 := $$reversed.i$2[$i.i.1155.0];
    ...
    call {:sourceloc} {:sourceloc_num 231} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$1, BV32_MUL($i.i.1155.0, 66bv32)), v134$1, $$fft1D_512.smem[1bv1][BV32_ADD(v122$1, BV32_MUL($i.i.1155.0, 66bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v122$2, BV32_MUL($i.i.1155.0, 66bv32)));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 231} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 231} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$2, BV32_MUL($i.i.1155.0, 66bv32)), v134$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v122$1, BV32_MUL($i.i.1155.0, 66bv32))] := v134$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v122$2, BV32_MUL($i.i.1155.0, 66bv32))] := v134$2;
    $i.i.1155.0 := BV32_ADD($i.i.1155.0, 1bv32);
  ...
  $truebb2:
    ...
    v119$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v117$1, BV32_MUL($i.i.1253.0, 8bv32))];
    v119$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v117$2, BV32_MUL($i.i.1253.0, 8bv32))];
    v120$1 := $$data$1[BV32_MUL($i.i.1253.0, 2bv32)];
    v120$2 := $$data$2[BV32_MUL($i.i.1253.0, 2bv32)];
    v121$1 := $$data$1[BV32_ADD(BV32_MUL($i.i.1253.0, 2bv32), 1bv32)];
    v121$2 := $$data$2[BV32_ADD(BV32_MUL($i.i.1253.0, 2bv32), 1bv32)];
    $$data$1[BV32_MUL($i.i.1253.0, 2bv32)] := v119$1;
    $$data$2[BV32_MUL($i.i.1253.0, 2bv32)] := v119$2;
    $$data$1[BV32_ADD(BV32_MUL($i.i.1253.0, 2bv32), 1bv32)] := v121$1;
    $$data$2[BV32_ADD(BV32_MUL($i.i.1253.0, 2bv32), 1bv32)] := v121$2;
    $i.i.1253.0 := BV32_ADD($i.i.1253.0, 1bv32);
    assume {:captureState "loop_back_edge_state_8_0"} true;
    goto $for.cond.i.1255;

  $truebb1:
    assume {:partition} v113;
    v114$1 := $$reversed.i$1[$i.i.1224.0];
    v114$2 := $$reversed.i$2[$i.i.1224.0];
    ...
    call {:sourceloc} {:sourceloc_num 196} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$1, BV32_MUL($i.i.1224.0, 66bv32)), v115$1, $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i.1224.0, 66bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i.1224.0, 66bv32)));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 196} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 196} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i.1224.0, 66bv32)), v115$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i.1224.0, 66bv32))] := v115$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v104$2, BV32_MUL($i.i.1224.0, 66bv32))] := v115$2;
    $i.i.1224.0 := BV32_ADD($i.i.1224.0, 1bv32);
