...
assert  my_inv (  (  BV32_SLE($i.i.0, 1bv32) ) ,  (  BV32_SGE($i.i.0, 1bv32) ) ,  (  BV32_ULE($i.i.0, 1bv32) ) ,  (  BV32_UGE($i.i.0, 1bv32) ) ,  (  $i.i.0 == 0bv32 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1bv32)) == 0bv32 ) ,  (  $i.i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) )  ); 
