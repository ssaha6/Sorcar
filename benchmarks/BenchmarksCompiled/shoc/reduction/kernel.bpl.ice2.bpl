...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1)) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2)) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1)) )  && ( p0$2 ==> BV32_SLE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2)) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1)) )  && ( p0$2 ==> BV32_SGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2)) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1)) )  && ( p0$2 ==> BV32_ULE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2)) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1)) )  && ( p0$2 ==> BV32_UGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2)) ) ,  (  BV32_ULT($i.0$1, $n) ==> p0$1 )  && (  BV32_ULT($i.0$2, $n) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($s.0, BV32_UDIV(v1, 2bv32)) ) ,  (  BV32_SGE($s.0, BV32_UDIV(v1, 2bv32)) ) ,  (  BV32_ULE($s.0, BV32_UDIV(v1, 2bv32)) ) ,  (  BV32_UGE($s.0, BV32_UDIV(v1, 2bv32)) ) ,  true ,  true ,  (  $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32 ) ,  (  $s.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$sdata ) ,  (  !_WRITE_HAS_OCCURRED_$$sdata ) ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
