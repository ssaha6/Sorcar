...
implementation {:source_name "reduce"} {:kernel} $reduce($n: bv32)
{
  ...
  $while.cond:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2));
