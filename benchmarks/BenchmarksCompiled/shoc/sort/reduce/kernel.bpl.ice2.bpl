...
assert  my_inv (  (  BV32_SLE(0bv32, $d.0) ) ,  (  BV32_SLE($d.0, 0bv32) ) ,  (  BV32_SGE($d.0, 0bv32) ) ,  (  BV32_ULE($d.0, 0bv32) ) ,  (  BV32_UGE($d.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  (  $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32 ) ,  (  $s.0 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$isums ) ,  (  _WRITE_HAS_OCCURRED_$$isums ==> BV32_SLE(group_id_x$1, _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$isums ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(group_id_x$1, 1bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$isums ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(0bv32, num_groups_x), group_id_x$1)) ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == 0bv32 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 27} true;
    assert {:originated_from_invariant} {:sourceloc_num 28} {:thread 1} (if v3$1 != 0bv32 ==> BV1_XOR((if _WRITE_HAS_OCCURRED_$$isums then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 29} {:thread 1} (if v3$1 != 0bv32 ==> BV1_XOR((if _READ_HAS_OCCURRED_$$lmem then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($s.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_SGE($s.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_ULE($s.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_UGE($s.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32 ) ,  (  $s.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
  ...
  $falsebb2:
    ...
    call {:sourceloc} {:sourceloc_num 45} _LOG_READ_$$lmem(p8$1, 0bv32, $$lmem[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 45} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 45} _CHECK_READ_$$lmem(p8$2, 0bv32, $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
