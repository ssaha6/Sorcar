...
assert  my_inv (  (  BV32_SLE(0bv32, $d.0) ) ,  (  BV32_SLE($d.0, 0bv32) ) ,  (  BV32_SGE($d.0, 0bv32) ) ,  (  BV32_ULE($d.0, 0bv32) ) ,  (  BV32_UGE($d.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  (  $i.i.0 == 0bv32 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1bv32)) == 0bv32 ) ,  (  $i.i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$isums ) ,  (  !_WRITE_HAS_OCCURRED_$$isums ) ,  (  _READ_HAS_OCCURRED_$$isums ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$isums ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(local_id_x$1, group_size_x), 1bv32) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) ) ,  (  !_READ_HAS_OCCURRED_$$top_scan.s_seed ) ,  (  !_WRITE_HAS_OCCURRED_$$top_scan.s_seed ) ,  (  _READ_HAS_OCCURRED_$$top_scan.s_seed ==> _WATCHED_OFFSET == 0bv32 ) ,  (  _WRITE_HAS_OCCURRED_$$top_scan.s_seed ==> _WATCHED_OFFSET == 0bv32 ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 6} true;
    assert {:originated_from_invariant} {:sourceloc_num 7} {:thread 1} (if BV32_UGE(local_id_x$1, $n) ==> BV1_XOR((if _WRITE_HAS_OCCURRED_$$isums then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 8} {:thread 1} (if BV32_UGE(local_id_x$1, $n) ==> BV1_XOR((if _READ_HAS_OCCURRED_$$isums then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$truebb0_0:
    ...
    v4$1 := local_id_x$1;
    v4$2 := local_id_x$2;
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$lmem(true, v4$1, 0bv32, $$lmem[1bv1][v4$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$lmem(true, v4$2, 0bv32);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($i.i.0, 1bv32) ) ,  (  BV32_SGE($i.i.0, 1bv32) ) ,  (  BV32_ULE($i.i.0, 1bv32) ) ,  (  BV32_UGE($i.i.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $i.i.0 == 0bv32 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1bv32)) == 0bv32 ) ,  (  $i.i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) )  ); 
  ...
  __partitioned_block_$falsebb2_0:
    assume {:partition} !v6;
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$lmem(true, BV32_SUB(v5$1, 1bv32), $$lmem[1bv1][BV32_SUB(v5$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$lmem(true, BV32_SUB(v5$2, 1bv32), $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(v5$2, 1bv32)]);
  ...
  __partitioned_block_$falsebb2_1:
    call {:sourceloc_num 29} $bugle_barrier_duplicated_2(1bv1, 0bv1);
    ...
    call {:sourceloc} {:sourceloc_num 31} _LOG_READ_$$top_scan.s_seed(p7$1, 0bv32, $$top_scan.s_seed[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 31} _CHECK_READ_$$top_scan.s_seed(p7$2, 0bv32, $$top_scan.s_seed[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_WRITE_$$top_scan.s_seed(p7$1, 0bv32, BV32_ADD(v13$1, BV32_ADD(v9$1, $val.0$1)), $$top_scan.s_seed[1bv1][0bv32]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 32} _CHECK_WRITE_$$top_scan.s_seed(p7$2, 0bv32, BV32_ADD(v13$2, BV32_ADD(v9$2, $val.0$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$top_scan.s_seed"} true;
  ...
  __partitioned_block_$truebb2_1:
    call {:sourceloc_num 19} $bugle_barrier_duplicated_4(1bv1, 0bv1);
