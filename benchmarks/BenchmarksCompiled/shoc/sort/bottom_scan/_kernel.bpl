...
implementation {:source_name "bottom_scan"} {:kernel} $bottom_scan($n: bv32, $shift: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0: bool;
  var _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0: bool;
  ...
  var _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93: bool;
  var _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93: bool;
  ...
  $while.cond:
    ...
    assert {:tag "predicatedEquality"} _b111 ==> p4$1 && p4$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b110 ==> p4$1 && p4$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b109 ==> p4$1 && p4$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b108 ==> p4$1 && p4$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b107 ==> p4$1 && p4$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b106 ==> p4$1 && p4$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b105 ==> p4$1 && p4$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b104 ==> p4$1 && p4$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b103 ==> p4$1 && p4$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b102 ==> p4$1 && p4$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b101 ==> p4$1 && p4$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b100 ==> p4$1 && p4$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b99 ==> p4$1 && p4$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b98 ==> p4$1 && p4$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b97 ==> p4$1 && p4$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b96 ==> p4$1 && p4$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b95 ==> p4$1 && p4$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b94 ==> p4$1 && p4$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b93 ==> p4$1 && p4$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b92 ==> p4$1 && p4$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b91 ==> p4$1 && p4$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b90 ==> p4$1 && p4$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b89 ==> p4$1 && p4$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b88 ==> p4$1 && p4$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b87 ==> p4$1 && p4$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b86 ==> p4$1 && p4$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b85 ==> p4$1 && p4$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b84 ==> p4$1 && p4$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b83 ==> p4$1 && p4$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b82 ==> p4$1 && p4$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b81 ==> p4$1 && p4$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b80 ==> p4$1 && p4$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b79 ==> p4$1 && p4$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b78 ==> p4$1 && p4$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b77 ==> p4$1 && p4$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b76 ==> p4$1 && p4$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b75 ==> p4$1 && p4$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b74 ==> p4$1 && p4$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b73 ==> p4$1 && p4$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b72 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    ...
    assert {:tag "predicatedEquality"} _b67 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b66 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b65 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b64 ==> p4$1 && p4$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b63 ==> p4$1 && p4$2 ==> $q92.0$1 == $q92.0$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> BV32_SLT($window.0$1, $cond$1) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> BV32_SLT($window.0$2, $cond$2) ==> p4$2;
    ...
    v8$1 := (if p4$1 then BV32_SLT($window.0$1, $cond$1) else v8$1);
    v8$2 := (if p4$2 then BV32_SLT($window.0$2, $cond$2) else v8$2);
    p5$1 := false;
    p5$2 := false;
    p6$1 := false;
    p6$2 := false;
  ...
  $for.cond.tail:
    assume !p6$1 && !p6$2;
    v10$1 := (if p5$1 then BV32_SLT($i.0$1, $cond$1) else v10$1);
    v10$2 := (if p5$2 then BV32_SLT($i.0$2, $cond$2) else v10$2);
    ...
    _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0 := _READ_HAS_OCCURRED_$$lmem;
    _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0 := _WRITE_HAS_OCCURRED_$$lmem;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto __partitioned_block_$for.cond.43_0;

  __partitioned_block_$for.cond.43_0:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b140 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0 == _WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "disabledMaintainsInstrumentation"} _b139 ==> !p5$1 ==> _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.43_0 == _READ_HAS_OCCURRED_$$lmem;
    ...
    assert {:tag "predicatedEquality"} _b134 ==> p10$1 && p10$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b133 ==> p10$1 && p10$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b132 ==> p10$1 && p10$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b131 ==> p10$1 && p10$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b130 ==> p10$1 && p10$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b129 ==> p10$1 && p10$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b128 ==> p10$1 && p10$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b127 ==> p10$1 && p10$2 ==> v25$1 == v25$2;
    ...
    assert p10$1 ==> p4$1;
    assert p10$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _WRITE_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $cond$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $cond$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b22 ==> BV32_SLT($window.0$1, $cond$1) && BV32_SLT($digit.0$1, 16bv32) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b22 ==> BV32_SLT($window.0$2, $cond$2) && BV32_SLT($digit.0$2, 16bv32) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b21 ==> p10$1 ==> BV32_SLT($window.0$1, $cond$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b21 ==> p10$2 ==> BV32_SLT($window.0$2, $cond$2);
    ...
    goto __partitioned_block_$for.cond.43_1;

  __partitioned_block_$for.cond.43_1:
  ...
  __partitioned_block_$for.cond.i_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b156 ==> !p11$1 ==> _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.i_0 == _WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "disabledMaintainsInstrumentation"} _b155 ==> !p11$1 ==> _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$for.cond.i_0 == _READ_HAS_OCCURRED_$$lmem;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b46 ==> _WRITE_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $cond$1);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b44 ==> _READ_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $cond$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b43 ==> BV32_SLT($window.0$1, $cond$1) && BV32_SLT($digit.0$1, 16bv32) && BV32_ULT($i.i.0$1, group_size_x) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b43 ==> BV32_SLT($window.0$2, $cond$2) && BV32_SLT($digit.0$2, 16bv32) && BV32_ULT($i.i.0$2, group_size_x) ==> p12$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p12$1 ==> _b42 ==> p12$1 ==> BV32_SLT($window.0$1, $cond$1) && BV32_SLT($digit.0$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p12$2 ==> _b42 ==> p12$2 ==> BV32_SLT($window.0$2, $cond$2) && BV32_SLT($digit.0$2, 16bv32);
  ...
  __partitioned_block_$for.cond.43.tail_0:
    assume !p10$1 && !p10$2;
    v31$1 := (if p5$1 then BV32_SLT($i.0$1, $cond$1) else v31$1);
    v31$2 := (if p5$2 then BV32_SLT($i.0$2, $cond$2) else v31$2);
  ...
  __partitioned_block_$for.cond.43.tail_1:
    ...
    $q92.0$1 := (if p17$1 then 0bv32 else $q92.0$1);
    $q92.0$2 := (if p17$2 then 0bv32 else $q92.0$2);
    p18$1 := (if p17$1 then true else p18$1);
    p18$2 := (if p17$2 then true else p18$2);
    _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93 := _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93 := _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.93;

  $for.cond.93:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b158 ==> !p17$1 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93 == _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "disabledMaintainsInstrumentation"} _b157 ==> !p17$1 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$for.cond.93 == _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> BV32_SLT($window.0$1, $cond$1);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> BV32_SLT($window.0$1, $cond$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b31 ==> BV32_SLT($window.0$1, $cond$1) && local_id_x$1 == BV32_SUB(group_size_x, 1bv32) && BV32_SLT($q92.0$1, 16bv32) ==> p18$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b31 ==> BV32_SLT($window.0$2, $cond$2) && local_id_x$2 == BV32_SUB(group_size_x, 1bv32) && BV32_SLT($q92.0$2, 16bv32) ==> p18$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p18$1 ==> _b30 ==> p18$1 ==> BV32_SLT($window.0$1, $cond$1) && local_id_x$1 == BV32_SUB(group_size_x, 1bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p18$2 ==> _b30 ==> p18$2 ==> BV32_SLT($window.0$2, $cond$2) && local_id_x$2 == BV32_SUB(group_size_x, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b29 ==> BV32_UGE($q92.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b29 ==> BV32_UGE($q92.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b28 ==> BV32_ULE($q92.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b28 ==> BV32_ULE($q92.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b27 ==> BV32_SGE($q92.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b27 ==> BV32_SGE($q92.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b26 ==> BV32_SLE($q92.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b26 ==> BV32_SLE($q92.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p18$1 ==> _b25 ==> BV32_SLE(0bv32, $q92.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p18$2 ==> _b25 ==> BV32_SLE(0bv32, $q92.0$2);
    assert {:block_sourceloc} {:sourceloc_num 95} p18$1 ==> true;
    v53$1 := (if p18$1 then BV32_SLT($q92.0$1, 16bv32) else v53$1);
    v53$2 := (if p18$2 then BV32_SLT($q92.0$2, 16bv32) else v53$2);
    p19$1 := false;
    p19$2 := false;
    ...
    v54$1 := (if p19$1 then $$histogram$1[$q92.0$1] else v54$1);
    v54$2 := (if p19$2 then $$histogram$2[$q92.0$2] else v54$2);
    call {:sourceloc} {:sourceloc_num 98} _LOG_READ_$$bottom_scan.l_block_counts(p19$1, $q92.0$1, $$bottom_scan.l_block_counts[1bv1][$q92.0$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 98} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 98} _CHECK_READ_$$bottom_scan.l_block_counts(p19$2, $q92.0$2, $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$q92.0$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_block_counts"} true;
    v55$1 := (if p19$1 then $$bottom_scan.l_block_counts[1bv1][$q92.0$1] else v55$1);
    v55$2 := (if p19$2 then $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$q92.0$2] else v55$2);
    call {:sourceloc} {:sourceloc_num 99} _LOG_WRITE_$$bottom_scan.l_block_counts(p19$1, $q92.0$1, BV32_ADD(v55$1, v54$1), $$bottom_scan.l_block_counts[1bv1][$q92.0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_block_counts(p19$2, $q92.0$2);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 99} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 99} _CHECK_WRITE_$$bottom_scan.l_block_counts(p19$2, $q92.0$2, BV32_ADD(v55$2, v54$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$bottom_scan.l_block_counts"} true;
    $$bottom_scan.l_block_counts[1bv1][$q92.0$1] := (if p19$1 then BV32_ADD(v55$1, v54$1) else $$bottom_scan.l_block_counts[1bv1][$q92.0$1]);
    $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$q92.0$2] := (if p19$2 then BV32_ADD(v55$2, v54$2) else $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$q92.0$2]);
    $q92.0$1 := (if p19$1 then BV32_ADD($q92.0$1, 1bv32) else $q92.0$1);
    $q92.0$2 := (if p19$2 then BV32_ADD($q92.0$2, 1bv32) else $q92.0$2);
    p18$1 := (if p19$1 then true else p18$1);
    p18$2 := (if p19$2 then true else p18$2);
    goto $for.cond.93.backedge, __partitioned_block_$for.cond.93.tail_0;

  __partitioned_block_$for.cond.93.tail_0:
    assume !p18$1 && !p18$2;
    goto __partitioned_block_$for.cond.93.tail_1;

  __partitioned_block_$for.cond.93.tail_1:
