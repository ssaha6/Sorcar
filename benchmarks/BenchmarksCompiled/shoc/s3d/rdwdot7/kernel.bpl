...
implementation {:source_name "rdwdot7_kernel"} {:kernel} $rdwdot7_kernel($rateconv: bv32)
{
  ...
  $0:
    ...
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$WDOT(true, BV32_ADD(124416bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
