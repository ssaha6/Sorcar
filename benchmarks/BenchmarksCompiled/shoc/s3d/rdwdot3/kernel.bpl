...
implementation {:source_name "rdwdot3_kernel"} {:kernel} $rdwdot3_kernel($rateconv: bv32)
{
  ...
  $0:
    ...
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$WDOT(true, BV32_ADD(165888bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    ...
    havoc v166$1, v166$2;
    havoc v167$1, v167$2;
    call {:sourceloc} {:sourceloc_num 172} _LOG_WRITE_$$WDOT(true, BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), FMUL32(FMUL32(FSUB32(FSUB32(FSUB32(FSUB32(FSUB32(FADD32(FADD32(FADD32(FADD32(FSUB32(v147$1, v148$1), FSUB32(v149$1, v150$1)), FSUB32(v151$1, v152$1)), FSUB32(v153$1, v154$1)), FSUB32(v155$1, v156$1)), FSUB32(v157$1, v158$1)), FSUB32(v159$1, v160$1)), FSUB32(v161$1, v162$1)), FSUB32(v163$1, v164$1)), FSUB32(v165$1, v166$1)), $rateconv), v167$1), $$WDOT[BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$WDOT(true, BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 172} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 172} _CHECK_WRITE_$$WDOT(true, BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), FMUL32(FMUL32(FSUB32(FSUB32(FSUB32(FSUB32(FSUB32(FADD32(FADD32(FADD32(FADD32(FSUB32(v147$2, v148$2), FSUB32(v149$2, v150$2)), FSUB32(v151$2, v152$2)), FSUB32(v153$2, v154$2)), FSUB32(v155$2, v156$2)), FSUB32(v157$2, v158$2)), FSUB32(v159$2, v160$2)), FSUB32(v161$2, v162$2)), FSUB32(v163$2, v164$2)), FSUB32(v165$2, v166$2)), $rateconv), v167$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$WDOT"} true;
    $$WDOT[BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := FMUL32(FMUL32(FSUB32(FSUB32(FSUB32(FSUB32(FSUB32(FADD32(FADD32(FADD32(FADD32(FSUB32(v147$1, v148$1), FSUB32(v149$1, v150$1)), FSUB32(v151$1, v152$1)), FSUB32(v153$1, v154$1)), FSUB32(v155$1, v156$1)), FSUB32(v157$1, v158$1)), FSUB32(v159$1, v160$1)), FSUB32(v161$1, v162$1)), FSUB32(v163$1, v164$1)), FSUB32(v165$1, v166$1)), $rateconv), v167$1);
    $$WDOT[BV32_ADD(207360bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := FMUL32(FMUL32(FSUB32(FSUB32(FSUB32(FSUB32(FSUB32(FADD32(FADD32(FADD32(FADD32(FSUB32(v147$2, v148$2), FSUB32(v149$2, v150$2)), FSUB32(v151$2, v152$2)), FSUB32(v153$2, v154$2)), FSUB32(v155$2, v156$2)), FSUB32(v157$2, v158$2)), FSUB32(v159$2, v160$2)), FSUB32(v161$2, v162$2)), FSUB32(v163$2, v164$2)), FSUB32(v165$2, v166$2)), $rateconv), v167$2);
    havoc v168$1, v168$2;
    havoc v169$1, v169$2;
    havoc v170$1, v170$2;
    ...
    havoc v235$1, v235$2;
    havoc v236$1, v236$2;
    call {:sourceloc} {:sourceloc_num 244} _LOG_WRITE_$$WDOT(true, BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), FMUL32(FMUL32(FADD32(FADD32(FADD32(FSUB32(v228$1, v229$1), FSUB32(v230$1, v231$1)), FSUB32(v232$1, v233$1)), FSUB32(v234$1, v235$1)), $rateconv), v236$1), $$WDOT[BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$WDOT(true, BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 244} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 244} _CHECK_WRITE_$$WDOT(true, BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), FMUL32(FMUL32(FADD32(FADD32(FADD32(FSUB32(v228$2, v229$2), FSUB32(v230$2, v231$2)), FSUB32(v232$2, v233$2)), FSUB32(v234$2, v235$2)), $rateconv), v236$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$WDOT"} true;
    $$WDOT[BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := FMUL32(FMUL32(FADD32(FADD32(FADD32(FSUB32(v228$1, v229$1), FSUB32(v230$1, v231$1)), FSUB32(v232$1, v233$1)), FSUB32(v234$1, v235$1)), $rateconv), v236$1);
    $$WDOT[BV32_ADD(248832bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := FMUL32(FMUL32(FADD32(FADD32(FADD32(FSUB32(v228$2, v229$2), FSUB32(v230$2, v231$2)), FSUB32(v232$2, v233$2)), FSUB32(v234$2, v235$2)), $rateconv), v236$2);
    return;
}
