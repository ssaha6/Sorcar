...
assert  my_inv (  (  BV32_SLE(0bv32, $d.0) ) ,  (  BV32_SLE($d.0, group_size_x) ) ,  (  BV32_SGE($d.0, group_size_x) ) ,  (  BV32_ULE($d.0, group_size_x) ) ,  (  BV32_UGE($d.0, group_size_x) ) ,  true ,  true ,  true ,  true ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  $d.0 == 0bv32 || BV32_AND($d.0, BV32_SUB($d.0, 1bv32)) == 0bv32 ) ,  (  $d.0 != 0bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 65536bv32) || BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32768bv32) || BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16384bv32) || BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8192bv32) || BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4096bv32) || BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2048bv32) || BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 1024bv32) || BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 512bv32) || BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 256bv32) || BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 128bv32) || BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 64bv32) || BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32bv32) || BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16bv32) || BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8bv32) || BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4bv32) || BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2bv32) || BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$s_data ) ,  (  _WRITE_HAS_OCCURRED_$$s_data ==> local_id_x$1 == BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 12} true;
    assert {:originated_from_invariant} {:sourceloc_num 13} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _WRITE_HAS_OCCURRED_$$s_data then 1bv1 else 0bv1))) != 0bv32 ==> v1$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 14} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _READ_HAS_OCCURRED_$$s_data then 1bv1 else 0bv1))) != 0bv32 ==> v1$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$15_0:
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$s_data(p5$1, v16$1, $$s_data[1bv1][v16$1]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$s_data(p5$2, v16$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v16$2]);
    ...
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 32} _CHECK_WRITE_$$s_data(p4$2, v16$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s_data"} true;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($d1.0, 1bv32) ) ,  (  BV32_SGE($d1.0, 1bv32) ) ,  (  BV32_ULE($d1.0, 1bv32) ) ,  (  BV32_UGE($d1.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride.1 == 0bv32 || BV32_AND($stride.1, BV32_SUB($stride.1, 1bv32)) == 0bv32 ) ,  (  $stride.1 != 0bv32 ) ,  (  $d1.0 == 0bv32 || BV32_AND($d1.0, BV32_SUB($d1.0, 1bv32)) == 0bv32 ) ,  (  $d1.0 != 0bv32 ) ,  (  v20 == 0bv32 || BV32_AND(v20, BV32_SUB(v20, 1bv32)) == 0bv32 ) ,  (  v20 != 0bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 65536bv32) || BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32768bv32) || BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16384bv32) || BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8192bv32) || BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4096bv32) || BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2048bv32) || BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 1024bv32) || BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 512bv32) || BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 256bv32) || BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 128bv32) || BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 64bv32) || BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32bv32) || BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16bv32) || BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8bv32) || BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4bv32) || BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2bv32) || BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$s_data )  ); 
  ...
  __partitioned_block_$falsebb6_1:
    ...
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 49} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 49} _CHECK_WRITE_$$g_odata(true, v2$2, v27$2);
    ...
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 52} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 52} _CHECK_WRITE_$$g_odata(p10$2, v3$2, v29$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
  ...
  __partitioned_block_$truebb6_1:
    ...
    call {:sourceloc} {:sourceloc_num 39} _LOG_READ_$$s_data(p9$1, v22$1, $$s_data[1bv1][v22$1]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 39} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 39} _CHECK_READ_$$s_data(p9$2, v22$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v22$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$s_data"} true;
    ...
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 40} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 40} _CHECK_READ_$$s_data(p9$2, v23$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v23$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 41} _LOG_WRITE_$$s_data(p9$1, v22$1, v25$1, $$s_data[1bv1][v22$1]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 41} _CHECK_WRITE_$$s_data(p9$2, v22$2, v25$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 42} _LOG_READ_$$s_data(p9$1, v23$1, $$s_data[1bv1][v23$1]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 42} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 42} _CHECK_READ_$$s_data(p9$2, v23$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v23$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 43} _LOG_WRITE_$$s_data(p9$1, v23$1, FADD32(v26$1, v24$1), $$s_data[1bv1][v23$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$s_data(p9$2, v23$2);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 43} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 43} _CHECK_WRITE_$$s_data(p9$2, v23$2, FADD32(v26$2, v24$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s_data"} true;
  ...
  __partitioned_block_$truebb1_1:
    call {:sourceloc_num 16} $bugle_barrier_duplicated_3(1bv1, 0bv1);
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$s_data(p3$1, v10$1, $$s_data[1bv1][v10$1]);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$s_data(p3$2, v10$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v10$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 19} _LOG_READ_$$s_data(p3$1, v11$1, $$s_data[1bv1][v11$1]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 19} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 19} _CHECK_READ_$$s_data(p3$2, v11$2, $$s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v11$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_WRITE_$$s_data(p3$1, v11$1, FADD32(v13$1, v12$1), $$s_data[1bv1][v11$1]);
    ...
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 20} _CHECK_WRITE_$$s_data(p3$2, v11$2, FADD32(v13$2, v12$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s_data"} true;
