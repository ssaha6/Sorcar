...
implementation {:source_name "sgemmNT"} {:kernel} $sgemmNT($lda: bv32, $ldb: bv32, $ldc: bv32, $k: bv32, $alpha: bv32, $beta: bv32)
{
  ...
  $falsebb0:
    ...
    $B.addr.0$1, $A.addr.0$1, $counter.0, $b.0$1 := BV32_ADD(v6$1, BV32_MUL(4bv32, $ldb)), BV32_ADD(v5$1, BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $ldb), v9$1;
    $B.addr.0$2, $A.addr.0$2, $b.0$2 := BV32_ADD(v6$2, BV32_MUL(4bv32, $ldb)), BV32_ADD(v5$2, BV32_MUL(4bv32, $lda)), v9$2;
  ...
  $do.body:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), $A.addr.0$1) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), BV32_ADD(v5$1, BV32_MUL(4bv32, $lda)));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b1 ==> BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), $A.addr.0$2) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), BV32_ADD(v5$2, BV32_MUL(4bv32, $lda)));
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), $B.addr.0$1) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), BV32_ADD(v6$1, BV32_MUL(4bv32, $ldb)));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), $B.addr.0$2) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), BV32_ADD(v6$2, BV32_MUL(4bv32, $ldb)));
  ...
  __partitioned_block_$falsebb2_1:
    ...
    $C.addr.0$1, $i597.0 := BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc)), 0bv32;
    $C.addr.0$2 := BV32_ADD(BV32_ADD(v2$2, v4$2), BV32_MUL(v3$2, $ldc));
  ...
  $for.cond.598:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sgemmNT.bs ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sgemmNT.bs ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_UGE($i597.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_ULE($i597.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SGE($i597.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SLE($i597.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b8 ==> BV32_SLE(0bv32, $i597.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b7 ==> BV32_AND(BV32_SUB($ldc, 1bv32), $C.addr.0$1) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc)));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b7 ==> BV32_AND(BV32_SUB($ldc, 1bv32), $C.addr.0$2) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$2, v4$2), BV32_MUL(v3$2, $ldc)));
    assert {:block_sourceloc} {:sourceloc_num 565} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 566} {:thread 1} (if BV32_SUB(BV32_UDIV(BV32_MUL($C.addr.0$1, 4bv32), 4bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc))) == BV32_MUL($ldc, $i597.0) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 566} {:thread 2} (if BV32_SUB(BV32_UDIV(BV32_MUL($C.addr.0$2, 4bv32), 4bv32), BV32_ADD(BV32_ADD(v2$2, v4$2), BV32_MUL(v3$2, $ldc))) == BV32_MUL($ldc, $i597.0) then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb3:
    ...
    v405$1 := $$c$1[$i597.0];
    v405$2 := $$c$2[$i597.0];
    call {:sourceloc} {:sourceloc_num 571} _LOG_READ_$$C(true, $C.addr.0$1, $$C[$C.addr.0$1]);
    assume {:do_not_predicate} {:check_id "check_state_130"} {:captureState "check_state_130"} {:sourceloc} {:sourceloc_num 571} true;
    call {:check_id "check_state_130"} {:sourceloc} {:sourceloc_num 571} _CHECK_READ_$$C(true, $C.addr.0$2, $$C[$C.addr.0$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$C"} true;
    v406$1 := $$C[$C.addr.0$1];
    v406$2 := $$C[$C.addr.0$2];
    call {:sourceloc} {:sourceloc_num 572} _LOG_WRITE_$$C(true, $C.addr.0$1, FADD32(FMUL32($alpha, v405$1), FMUL32($beta, v406$1)), $$C[$C.addr.0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$C(true, $C.addr.0$2);
    assume {:do_not_predicate} {:check_id "check_state_131"} {:captureState "check_state_131"} {:sourceloc} {:sourceloc_num 572} true;
    call {:check_id "check_state_131"} {:sourceloc} {:sourceloc_num 572} _CHECK_WRITE_$$C(true, $C.addr.0$2, FADD32(FMUL32($alpha, v405$2), FMUL32($beta, v406$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$C"} true;
    $$C[$C.addr.0$1] := FADD32(FMUL32($alpha, v405$1), FMUL32($beta, v406$1));
    $$C[$C.addr.0$2] := FADD32(FMUL32($alpha, v405$2), FMUL32($beta, v406$2));
    $C.addr.0$1, $i597.0 := BV32_ADD($C.addr.0$1, $ldc), BV32_ADD($i597.0, 1bv32);
    $C.addr.0$2 := BV32_ADD($C.addr.0$2, $ldc);
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond.598;

  $truebb2:
    assume {:partition} v211;
    $B.addr.0$1, $A.addr.0$1, $counter.0, $b.0$1 := BV32_ADD($B.addr.0$1, BV32_MUL(4bv32, $ldb)), BV32_ADD($A.addr.0$1, BV32_MUL(4bv32, $lda)), v210, v17$1;
    $B.addr.0$2, $A.addr.0$2, $b.0$2 := BV32_ADD($B.addr.0$2, BV32_MUL(4bv32, $ldb)), BV32_ADD($A.addr.0$2, BV32_MUL(4bv32, $lda)), v17$2;
