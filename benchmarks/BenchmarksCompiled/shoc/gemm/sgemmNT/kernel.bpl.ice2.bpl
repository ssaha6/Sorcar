...
assert  my_inv (  (  BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), $.02$1) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), BV32_ADD(v6$1, BV32_MUL(4bv32, $ldb))) )  && (  BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), $.02$2) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), BV32_ADD(v6$2, BV32_MUL(4bv32, $ldb))) ) ,  (  BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), $.01$1) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), BV32_ADD(v5$1, BV32_MUL(4bv32, $lda))) )  && (  BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), $.01$2) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $lda), 1bv32), BV32_ADD(v5$2, BV32_MUL(4bv32, $lda))) ) ,  (  BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), $counter.0) == BV32_AND(BV32_SUB(BV32_MUL(4bv32, $ldb), 1bv32), BV32_MUL(4bv32, $ldb)) ) ,  (  BV32_SLE($counter.0, BV32_MUL(4bv32, $ldb)) ) ,  (  BV32_SGE($counter.0, BV32_MUL(4bv32, $ldb)) ) ,  (  BV32_ULE($counter.0, BV32_MUL(4bv32, $ldb)) ) ,  (  BV32_UGE($counter.0, BV32_MUL(4bv32, $ldb)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$sgemmNT.bs ) ,  (  _WRITE_HAS_OCCURRED_$$sgemmNT.bs ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), local_id_x$1) ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB($ldc, 1bv32), $.0$1) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc))) )  && (  BV32_AND(BV32_SUB($ldc, 1bv32), $.0$2) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$2, v4$2), BV32_MUL(v3$2, $ldc))) ) ,  (  BV32_SLE(0bv32, $i1.0) ) ,  (  BV32_SLE($i1.0, 0bv32) ) ,  (  BV32_SGE($i1.0, 0bv32) ) ,  (  BV32_ULE($i1.0, 0bv32) ) ,  (  BV32_UGE($i1.0, 0bv32) ) ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB($ldc, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc))) ) ,  (  _WRITE_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB($ldc, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB($ldc, 1bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc))) )  ); 
