...
implementation {:source_name "sgemmNN"} {:kernel} $sgemmNN($lda: bv32, $ldb: bv32, $ldc: bv32, $k: bv32, $alpha: bv32, $beta: bv32)
{
  ...
  $falsebb:
    assume {:partition} !v5;
    $B.addr.0$1, $A.addr.0$1, $counter.0 := BV32_ADD(v0$1, BV32_MUL(BV32_ADD(v3$1, v1$1), $ldb)), BV32_ADD(v2$1, v4$1), 0bv32;
    $B.addr.0$2, $A.addr.0$2 := BV32_ADD(v0$2, BV32_MUL(BV32_ADD(v3$2, v1$2), $ldb)), BV32_ADD(v2$2, v4$2);
  ...
  $do.body:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> BV32_AND(BV32_SUB(BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(4bv32, $lda), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), 1bv32), $A.addr.0$1) == BV32_AND(BV32_SUB(BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(4bv32, $lda), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), 1bv32), BV32_ADD(v2$1, v4$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b1 ==> BV32_AND(BV32_SUB(BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(4bv32, $lda), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), 1bv32), $A.addr.0$2) == BV32_AND(BV32_SUB(BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(4bv32, $lda), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), BV32_MUL(4bv32, $lda)), 1bv32), BV32_ADD(v2$2, v4$2));
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(16bv32, 1bv32), $B.addr.0$1) == BV32_AND(BV32_SUB(16bv32, 1bv32), BV32_ADD(v0$1, BV32_MUL(BV32_ADD(v3$1, v1$1), $ldb)));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(16bv32, 1bv32), $B.addr.0$2) == BV32_AND(BV32_SUB(16bv32, 1bv32), BV32_ADD(v0$2, BV32_MUL(BV32_ADD(v3$2, v1$2), $ldb)));
  ...
  $falsebb1:
    ...
    $C.addr.0$1, $i1147.0 := BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc)), 0bv32;
  ...
  $for.cond.1148:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sgemmNN.bs ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sgemmNN.bs ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_UGE($i1147.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_ULE($i1147.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SGE($i1147.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SLE($i1147.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b8 ==> BV32_SLE(0bv32, $i1147.0);
    ...
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 1107} {:thread 1} (if BV32_SUB(BV32_UDIV(BV32_MUL($C.addr.0$1, 4bv32), 4bv32), BV32_ADD(BV32_ADD(v2$1, v4$1), BV32_MUL(v3$1, $ldc))) == BV32_MUL($ldc, $i1147.0) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 1107} {:thread 2} (if BV32_SUB(BV32_UDIV(BV32_MUL($C.addr.0$2, 4bv32), 4bv32), BV32_ADD(BV32_ADD(v2$2, v4$2), BV32_MUL(v3$2, $ldc))) == BV32_MUL($ldc, $i1147.0) then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb2:
    ...
    v798$1 := $$c$1[$i1147.0];
    v798$2 := $$c$2[$i1147.0];
    call {:sourceloc} {:sourceloc_num 1112} _LOG_READ_$$C(true, $C.addr.0$1, $$C[$C.addr.0$1]);
    assume {:do_not_predicate} {:check_id "check_state_260"} {:captureState "check_state_260"} {:sourceloc} {:sourceloc_num 1112} true;
    call {:check_id "check_state_260"} {:sourceloc} {:sourceloc_num 1112} _CHECK_READ_$$C(true, $C.addr.0$2, $$C[$C.addr.0$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$C"} true;
    v799$1 := $$C[$C.addr.0$1];
    v799$2 := $$C[$C.addr.0$2];
    call {:sourceloc} {:sourceloc_num 1113} _LOG_WRITE_$$C(true, $C.addr.0$1, FADD32(FMUL32($alpha, v798$1), FMUL32($beta, v799$1)), $$C[$C.addr.0$1]);
    ...
    call {:check_id "check_state_261"} {:sourceloc} {:sourceloc_num 1113} _CHECK_WRITE_$$C(true, $C.addr.0$2, FADD32(FMUL32($alpha, v798$2), FMUL32($beta, v799$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$C"} true;
    $$C[$C.addr.0$1] := FADD32(FMUL32($alpha, v798$1), FMUL32($beta, v799$1));
    $$C[$C.addr.0$2] := FADD32(FMUL32($alpha, v798$2), FMUL32($beta, v799$2));
    $C.addr.0$1, $i1147.0 := BV32_ADD($C.addr.0$1, $ldc), BV32_ADD($i1147.0, 1bv32);
  ...
  $truebb1:
    assume {:partition} v796;
    $B.addr.0$1, $A.addr.0$1, $counter.0 := BV32_ADD($B.addr.0$1, 16bv32), BV32_ADD(BV32_ADD(BV32_ADD(BV32_ADD($A.addr.0$1, v12), v209), v406), BV32_MUL(4bv32, $lda)), v795;
    $B.addr.0$2, $A.addr.0$2 := BV32_ADD($B.addr.0$2, 16bv32), BV32_ADD(BV32_ADD(BV32_ADD(BV32_ADD($A.addr.0$2, v12), v209), v406), BV32_MUL(4bv32, $lda));
