...
implementation {:source_name "readInCache"} {:kernel} $readInCache($n: bv32, $samp: bv32)
{
  ...
  $truebb:
    ...
    v5$1 := (if p1$1 then BV32_SGE(v0$1, 8192bv32) else v5$1);
    v5$2 := (if p1$2 then BV32_SGE(v0$2, 8192bv32) else v5$2);
    ...
    v7$1 := (if p5$1 then BV32_SGE(v1$1, 8192bv32) else v7$1);
    v7$2 := (if p5$2 then BV32_SGE(v1$2, 8192bv32) else v7$2);
    ...
    havoc v10$1, v10$2;
    havoc v11$1, v11$2;
    $sum.0$1, $i.0 := FADD32($sum.0$1, v8$1), BV32_ADD($i.0, 1bv32);
