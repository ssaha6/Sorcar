...
implementation {:source_name "readImg"} {:kernel} $readImg($n: bv32, $samp: bv32, $w: bv32, $h: bv32)
{
  ...
  $truebb:
    ...
    havoc v10$1, v10$2;
    havoc v11$1, v11$2;
    $ridx.0$1, $sum.0$1, $i.0 := $ridx.0$1[64:32] ++ BV32_AND(BV32_ADD($ridx.0$1[32:0], 1bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$1, v8$1), BV32_ADD($i.0, 1bv32);
    $ridx.0$2, $sum.0$2 := $ridx.0$2[64:32] ++ BV32_AND(BV32_ADD($ridx.0$2[32:0], 1bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$2, v8$2);
