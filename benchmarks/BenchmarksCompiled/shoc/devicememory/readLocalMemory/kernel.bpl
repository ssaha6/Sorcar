...
implementation {:source_name "readLocalMemory"} {:kernel} $readLocalMemory($size: bv32)
{
  ...
  $1:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> $0$1 == 1bv1 ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> $0$2 == 1bv1 ==> p0$2;
