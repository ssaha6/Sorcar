...
assert  my_inv (  ( p0$1 ==> BV32_SLE(0bv32, $j.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $j.0$2) ) ,  ( p0$1 ==> BV32_SLE($j.0$1, 0bv32) )  && ( p0$2 ==> BV32_SLE($j.0$2, 0bv32) ) ,  ( p0$1 ==> BV32_SGE($j.0$1, 0bv32) )  && ( p0$2 ==> BV32_SGE($j.0$2, 0bv32) ) ,  ( p0$1 ==> BV32_ULE($j.0$1, 0bv32) )  && ( p0$2 ==> BV32_ULE($j.0$2, 0bv32) ) ,  ( p0$1 ==> BV32_UGE($j.0$1, 0bv32) )  && ( p0$2 ==> BV32_UGE($j.0$2, 0bv32) ) ,  (  $0$1 == 1bv1 ==> p0$1 )  && (  $0$2 == 1bv1 ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 2} p0$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> BV32_ULT(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_MUL(v1$1, v3)), v3) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 4} {:thread 1} (if BV32_SGE($j.0$1, 0bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 4} {:thread 2} (if BV32_SGE($j.0$2, 0bv32) then 1bv1 else 0bv1) != 0bv1;
    ...
    v6$1 := (if p0$1 then $0$1 == 1bv1 else v6$1);
    v6$2 := (if p0$2 then $0$2 == 1bv1 else v6$2);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p5$1 ==> BV32_SLE(0bv32, $j.1$1) )  && ( p5$2 ==> BV32_SLE(0bv32, $j.1$2) ) ,  ( p5$1 ==> BV32_SLE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_SLE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_SGE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_SGE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_ULE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_ULE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_UGE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_UGE($j.1$2, $j.0$2) ) ,  (  BV32_SLT($j.1$1, BV32_SDIV(4096bv32, group_size_x)) ==> p5$1 )  && (  BV32_SLT($j.1$2, BV32_SDIV(4096bv32, group_size_x)) ==> p5$2 ) ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 12} p5$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 13} {:thread 1} (if _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> BV32_ULT(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_MUL(v1$1, v3)), v3) then 1bv1 else 0bv1) != 0bv1;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $j.2) ) ,  (  BV32_SLE($j.2, 0bv32) ) ,  (  BV32_SGE($j.2, 0bv32) ) ,  (  BV32_ULE($j.2, 0bv32) ) ,  (  BV32_UGE($j.2, 0bv32) )  ); 
  ...
  $truebb2:
    assume {:partition} v10;
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND($s.0$1, 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND($s.0$1, 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 22} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND($s.0$2, 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND($s.0$2, 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v11$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND($s.0$1, 4095bv32)];
    v11$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND($s.0$2, 4095bv32)];
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 1bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 1bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 1bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 1bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v12$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 1bv32), 4095bv32)];
    v12$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 1bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 2bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 2bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 2bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 2bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v13$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 2bv32), 4095bv32)];
    v13$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 2bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 3bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 3bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 3bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 3bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v14$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 3bv32), 4095bv32)];
    v14$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 3bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 4bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 4bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 26} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 26} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 4bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 4bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v15$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 4bv32), 4095bv32)];
    v15$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 4bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 5bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 5bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 5bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 5bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v16$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 5bv32), 4095bv32)];
    v16$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 5bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 6bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 6bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 6bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 6bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v17$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 6bv32), 4095bv32)];
    v17$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 6bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 7bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 7bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 7bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 7bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v18$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 7bv32), 4095bv32)];
    v18$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 7bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 30} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 8bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 8bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 30} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 8bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 8bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v19$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 8bv32), 4095bv32)];
    v19$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 8bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 31} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 9bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 9bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 31} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 9bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 9bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v20$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 9bv32), 4095bv32)];
    v20$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 9bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 32} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 10bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 10bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 32} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 10bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 10bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v21$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 10bv32), 4095bv32)];
    v21$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 10bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 33} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 11bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 11bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 33} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 33} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 11bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 11bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v22$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 11bv32), 4095bv32)];
    v22$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 11bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 34} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 12bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 12bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 34} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 34} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 12bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 12bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v23$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 12bv32), 4095bv32)];
    v23$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 12bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 35} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 13bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 13bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 35} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 13bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 13bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v24$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 13bv32), 4095bv32)];
    v24$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 13bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 36} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 14bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 14bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 36} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 36} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 14bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 14bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v25$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 14bv32), 4095bv32)];
    v25$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 14bv32), 4095bv32)];
    call {:sourceloc} {:sourceloc_num 37} _LOG_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$1, 15bv32), 4095bv32), $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 15bv32), 4095bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 37} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 37} _CHECK_READ_$$readLocalMemory.lbuf(true, BV32_AND(BV32_ADD($s.0$2, 15bv32), 4095bv32), $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 15bv32), 4095bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readLocalMemory.lbuf"} true;
    v26$1 := $$readLocalMemory.lbuf[1bv1][BV32_AND(BV32_ADD($s.0$1, 15bv32), 4095bv32)];
    v26$2 := $$readLocalMemory.lbuf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_AND(BV32_ADD($s.0$2, 15bv32), 4095bv32)];
