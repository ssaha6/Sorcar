...
implementation {:source_name "readRand"} {:kernel} $readRand($n: bv32, $samp: bv32, $w: bv32, $h: bv32)
{
  ...
  $truebb:
    ...
    v5$1 := (if p1$1 then BV32_SGE($ridx.0$1[32:0], 8192bv32) else v5$1);
    v5$2 := (if p1$2 then BV32_SGE($ridx.0$2[32:0], 8192bv32) else v5$2);
    ...
    $1$1 := (if p3$1 then 8191bv32 else $1$1);
    $1$2 := (if p3$2 then 8191bv32 else $1$2);
    ...
    v7$1 := (if p5$1 then BV32_SGE($ridx.0$1[64:32], 8192bv32) else v7$1);
    v7$2 := (if p5$2 then BV32_SGE($ridx.0$2[64:32], 8192bv32) else v7$2);
    ...
    $3$1 := (if p7$1 then 8191bv32 else $3$1);
    $3$2 := (if p7$2 then 8191bv32 else $3$2);
    ...
    havoc v10$1, v10$2;
    havoc v11$1, v11$2;
    v12$1 := $ridx.0$1[64:32];
    v12$2 := $ridx.0$2[64:32];
    $ridx.0$1, $sum.0$1, $i.0 := BV32_AND(BV32_ADD(BV32_MUL(v12$1, 5bv32), 11bv32), BV32_SUB($h, 1bv32)) ++ BV32_AND(BV32_ADD(BV32_MUL($ridx.0$1[32:0], 3bv32), 29bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$1, v8$1), BV32_ADD($i.0, 1bv32);
    $ridx.0$2, $sum.0$2 := BV32_AND(BV32_ADD(BV32_MUL(v12$2, 5bv32), 11bv32), BV32_SUB($h, 1bv32)) ++ BV32_AND(BV32_ADD(BV32_MUL($ridx.0$2[32:0], 3bv32), 29bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$2, v8$2);
