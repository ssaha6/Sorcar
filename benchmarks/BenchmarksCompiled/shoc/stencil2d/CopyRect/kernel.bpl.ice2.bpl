...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$dest ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $dpitch), group_size_x), BV32_DIV(local_id_x$1, group_size_x)) ) ,  (  _WRITE_HAS_OCCURRED_$$dest ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $dpitch), BV32_MUL(group_id_x$1, group_size_x)) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$dest$ghost$$2 == _WRITE_HAS_OCCURRED_$$dest )  ); 
...
assert  my_inv (  ( p1$1 ==> BV32_SLE(0bv32, $c.0$1) )  && ( p1$2 ==> BV32_SLE(0bv32, $c.0$2) ) ,  ( p1$1 ==> BV32_SLE($c.0$1, 0bv32) )  && ( p1$2 ==> BV32_SLE($c.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_SGE($c.0$1, 0bv32) )  && ( p1$2 ==> BV32_SGE($c.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_ULE($c.0$1, 0bv32) )  && ( p1$2 ==> BV32_ULE($c.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_UGE($c.0$1, 0bv32) )  && ( p1$2 ==> BV32_UGE($c.0$2, 0bv32) ) ,  ( p1$1 ==> p1$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $height) )  && ( p1$2 ==> p1$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $height) ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $height) && BV32_SLT($c.0$1, $width) ==> p1$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $height) && BV32_SLT($c.0$2, $width) ==> p1$2 ) ,  (  _WRITE_HAS_OCCURRED_$$dest ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $height) ) ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 5} p1$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 6} {:thread 1} (if _WRITE_HAS_OCCURRED_$$dest ==> BV32_ULT(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD($doffset, BV32_MUL(v0$1, $dpitch))), $width) then 1bv1 else 0bv1) != 0bv1;
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$dest(p2$1, BV32_ADD($doffset, BV32_ADD(BV32_MUL(v0$1, $dpitch), $c.0$1)), v3$1, $$dest[BV32_ADD($doffset, BV32_ADD(BV32_MUL(v0$1, $dpitch), $c.0$1))]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$dest(p2$2, BV32_ADD($doffset, BV32_ADD(BV32_MUL(v0$2, $dpitch), $c.0$2)), v3$2);
