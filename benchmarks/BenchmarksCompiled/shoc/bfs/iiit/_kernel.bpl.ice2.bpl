...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p8$1 ==> BV32_AND(BV32_SUB($W_SZ, 1bv32), $i.0$1) == BV32_AND(BV32_SUB($W_SZ, 1bv32), BV32_SREM(v0$1, $W_SZ)) )  && ( p8$2 ==> BV32_AND(BV32_SUB($W_SZ, 1bv32), $i.0$2) == BV32_AND(BV32_SUB($W_SZ, 1bv32), BV32_SREM(v0$2, $W_SZ)) ) ,  ( p8$1 ==> BV32_SUB($i.0$1, BV32_SREM(v0$1, $W_SZ)) == BV32_SUB($i.0$2, BV32_SREM(v0$2, $W_SZ)) )  && ( p8$2 ==> BV32_SUB($i.0$2, BV32_SREM(v0$2, $W_SZ)) == BV32_SUB($i.0$1, BV32_SREM(v0$1, $W_SZ)) ) ,  ( p8$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.0$1, BV32_SREM(v0$1, $W_SZ)) == BV32_SUB($i.0$2, BV32_SREM(v0$2, $W_SZ)) )  && ( p8$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.0$2, BV32_SREM(v0$2, $W_SZ)) == BV32_SUB($i.0$1, BV32_SREM(v0$1, $W_SZ)) ) ,  ( p8$1 ==> BV32_SLE($i.0$1, BV32_SREM(v0$1, $W_SZ)) )  && ( p8$2 ==> BV32_SLE($i.0$2, BV32_SREM(v0$2, $W_SZ)) ) ,  ( p8$1 ==> BV32_SGE($i.0$1, BV32_SREM(v0$1, $W_SZ)) )  && ( p8$2 ==> BV32_SGE($i.0$2, BV32_SREM(v0$2, $W_SZ)) ) ,  ( p8$1 ==> BV32_ULE($i.0$1, BV32_SREM(v0$1, $W_SZ)) )  && ( p8$2 ==> BV32_ULE($i.0$2, BV32_SREM(v0$2, $W_SZ)) ) ,  ( p8$1 ==> BV32_UGE($i.0$1, BV32_SREM(v0$1, $W_SZ)) )  && ( p8$2 ==> BV32_UGE($i.0$2, BV32_SREM(v0$2, $W_SZ)) ) ,  ( p8$1 ==> p8$1 ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) && v6$1 == $curr )  && ( p8$2 ==> p8$2 ==> BV32_SLT($v.0$2, BV32_ADD(BV32_SUB($chk_sz.1$2, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $W_SZ), $CHUNK_SZ))) && v6$2 == $curr ) ,  (  BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) && v6$1 == $curr && BV32_ULT($i.0$1, BV32_SUB(v8$1, v9$1)) ==> p8$1 )  && (  BV32_SLT($v.0$2, BV32_ADD(BV32_SUB($chk_sz.1$2, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $W_SZ), $CHUNK_SZ))) && v6$2 == $curr && BV32_ULT($i.0$2, BV32_SUB(v8$2, v9$2)) ==> p8$2 ) ,  (  _READ_HAS_OCCURRED_$$levels ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) ) ,  (  _READ_HAS_OCCURRED_$$levels ==> v6$1 == $curr ) ,  (  _WRITE_HAS_OCCURRED_$$levels ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) ) ,  (  _WRITE_HAS_OCCURRED_$$levels ==> v6$1 == $curr ) ,  (  _WRITE_HAS_OCCURRED_$$flag ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1bv32), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) ) ,  (  _WRITE_HAS_OCCURRED_$$flag ==> v6$1 == $curr ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
