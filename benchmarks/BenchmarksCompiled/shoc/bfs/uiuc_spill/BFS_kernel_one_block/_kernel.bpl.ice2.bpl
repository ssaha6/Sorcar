...
assert  my_inv (  ( p2$1 ==> BV32_SUB($f_len.0$1, $frontier_len) == BV32_SUB($f_len.0$2, $frontier_len) )  && ( p2$2 ==> BV32_SUB($f_len.0$2, $frontier_len) == BV32_SUB($f_len.0$1, $frontier_len) ) ,  ( p2$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($f_len.0$1, $frontier_len) == BV32_SUB($f_len.0$2, $frontier_len) )  && ( p2$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($f_len.0$2, $frontier_len) == BV32_SUB($f_len.0$1, $frontier_len) ) ,  ( p2$1 ==> BV32_SLE($f_len.0$1, $frontier_len) )  && ( p2$2 ==> BV32_SLE($f_len.0$2, $frontier_len) ) ,  ( p2$1 ==> BV32_SGE($f_len.0$1, $frontier_len) )  && ( p2$2 ==> BV32_SGE($f_len.0$2, $frontier_len) ) ,  ( p2$1 ==> BV32_ULE($f_len.0$1, $frontier_len) )  && ( p2$2 ==> BV32_ULE($f_len.0$2, $frontier_len) ) ,  ( p2$1 ==> BV32_UGE($f_len.0$1, $frontier_len) )  && ( p2$2 ==> BV32_UGE($f_len.0$2, $frontier_len) ) ,  (  v21$1 != 0bv32 ==> p2$1 )  && (  v21$2 != 0bv32 ==> p2$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  p2$1 == p2$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p2$1 == p2$2 ) ,  (  p2$1 && p2$2 ==> $f_len.0$1 == $f_len.0$2 ) ,  (  p2$1 && p2$2 ==> $offset.0$1 == $offset.0$2 ) ,  (  p2$1 && p2$2 ==> v18$1 == v18$2 ) ,  (  p2$1 && p2$2 ==> v11$1 == v11$2 ) ,  (  p2$1 && p2$2 ==> v16$1 == v16$2 ) ,  (  p2$1 && p2$2 ==> v14$1 == v14$2 ) ,  (  p2$1 && p2$2 ==> v3$1 == v3$2 ) ,  (  p2$1 && p2$2 ==> v4$1 == v4$2 ) ,  (  p2$1 && p2$2 ==> v5$1 == v5$2 ) ,  (  p2$1 && p2$2 ==> v6$1 == v6$2 ) ,  (  p2$1 && p2$2 ==> v7$1 == v7$2 ) ,  (  p2$1 && p2$2 ==> v8$1 == v8$2 ) ,  (  p2$1 && p2$2 ==> v9$1 == v9$2 ) ,  (  p2$1 && p2$2 ==> v10$1 == v10$2 ) ,  (  p2$1 && p2$2 ==> v12$1 == v12$2 ) ,  (  p2$1 && p2$2 ==> v13$1 == v13$2 ) ,  (  p2$1 && p2$2 ==> v15$1 == v15$2 ) ,  (  p2$1 && p2$2 ==> v17$1 == v17$2 ) ,  (  p2$1 && p2$2 ==> v19$1 == v19$2 ) ,  (  p2$1 && p2$2 ==> v20$1 == v20$2 ) ,  (  p2$1 && p2$2 ==> v21$1 == v21$2 ) ,  (  p2$1 && p2$2 ==> v22$1 == v22$2 ) ,  (  p2$1 && p2$2 ==> v24$1 == v24$2 ) ,  (  p2$1 && p2$2 ==> v25$1 == v25$2 ) ,  (  p2$1 && p2$2 ==> v26$1 == v26$2 ) ,  (  p2$1 && p2$2 ==> v27$1 == v27$2 ) ,  (  p2$1 && p2$2 ==> v35$1 == v35$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_0$1 == _abstracted_call_arg_0$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_1$1 == _abstracted_call_arg_1$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_2$1 == _abstracted_call_arg_2$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_3$1 == _abstracted_call_arg_3$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_4$1 == _abstracted_call_arg_4$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_5$1 == _abstracted_call_arg_5$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_6$1 == _abstracted_call_arg_6$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_7$1 == _abstracted_call_arg_7$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_16$1 == _abstracted_call_arg_16$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_17$1 == _abstracted_call_arg_17$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_18$1 == _abstracted_call_arg_18$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_19$1 == _abstracted_call_arg_19$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_20$1 == _abstracted_call_arg_20$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_21$1 == _abstracted_call_arg_21$2 ) ,  (  p2$1 && p2$2 ==> _abstracted_call_arg_22$1 == _abstracted_call_arg_22$2 ) ,  (  !_WRITE_HAS_OCCURRED_$$frontier ) ,  (  _WRITE_HAS_OCCURRED_$$frontier ==> _WATCHED_OFFSET == v18$1 ) ,  (  !_WRITE_HAS_OCCURRED_$$visited ) ,  (  !_ATOMIC_HAS_OCCURRED_$$visited ) ,  (  !_READ_HAS_OCCURRED_$$cost ) ,  (  !_ATOMIC_HAS_OCCURRED_$$cost ) ,  (  !_READ_HAS_OCCURRED_$$b_q ) ,  (  !_WRITE_HAS_OCCURRED_$$b_q ) ,  (  _READ_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  !_READ_HAS_OCCURRED_$$b_q2 ) ,  (  !_WRITE_HAS_OCCURRED_$$b_q2 ) ,  (  _READ_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == v16$1 ) ,  (  !_READ_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ) ,  (  !_WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ) ,  (  !_ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ) ,  (  _READ_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  _WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ) ,  (  !_ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ) ,  (  _WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0bv32 ) ,  (  _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0bv32 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$frontier ==> _WATCHED_OFFSET == v18$1 ) ,  (  !p6$1 ==> _WRITE_HAS_OCCURRED_$$frontier$ghost$$7 == _WRITE_HAS_OCCURRED_$$frontier ) ,  (  !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$visited$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$visited ) ,  (  !p6$1 ==> _READ_HAS_OCCURRED_$$cost$ghost$$7 == _READ_HAS_OCCURRED_$$cost ) ,  (  !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$cost$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$cost ) ,  (  _WRITE_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == v16$1 ) ,  (  !p6$1 ==> _WRITE_HAS_OCCURRED_$$b_q2$ghost$$7 == _WRITE_HAS_OCCURRED_$$b_q2 ) ,  (  _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ) ,  (  _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset )  ); 
