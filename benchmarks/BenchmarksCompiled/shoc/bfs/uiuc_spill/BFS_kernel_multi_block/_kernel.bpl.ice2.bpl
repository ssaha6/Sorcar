...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$frontier2 ==> _WATCHED_OFFSET == v17$1 ) ,  (  !p2$1 ==> _WRITE_HAS_OCCURRED_$$frontier2$ghost$$4 == _WRITE_HAS_OCCURRED_$$frontier2 ) ,  (  !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$visited$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$visited ) ,  (  !p2$1 ==> _READ_HAS_OCCURRED_$$cost$ghost$$4 == _READ_HAS_OCCURRED_$$cost ) ,  (  !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$cost$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$cost ) ,  (  _ATOMIC_HAS_OCCURRED_$$frontier_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$frontier_length$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$frontier_length ) ,  (  _WRITE_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == v15$1 ) ,  (  !p2$1 ==> _WRITE_HAS_OCCURRED_$$b_q$ghost$$4 == _WRITE_HAS_OCCURRED_$$b_q ) ,  (  _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length )  ); 
...
assert  my_inv (  ( p3$1 ==> BV32_SLE($offset.0$1, v5$1) )  && ( p3$2 ==> BV32_SLE($offset.0$2, v5$2) ) ,  ( p3$1 ==> BV32_SGE($offset.0$1, v5$1) )  && ( p3$2 ==> BV32_SGE($offset.0$2, v5$2) ) ,  ( p3$1 ==> BV32_ULE($offset.0$1, v5$1) )  && ( p3$2 ==> BV32_ULE($offset.0$2, v5$2) ) ,  ( p3$1 ==> BV32_UGE($offset.0$1, v5$1) )  && ( p3$2 ==> BV32_UGE($offset.0$2, v5$2) ) ,  ( p3$1 ==> p3$1 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) )  && ( p3$2 ==> p3$2 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $frontier_len) ) ,  (  BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) && BV32_ULT($offset.0$1, v6$1) ==> p3$1 )  && (  BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $frontier_len) && BV32_ULT($offset.0$2, v6$2) ==> p3$2 ) ,  (  _READ_HAS_OCCURRED_$$cost ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) ) ,  (  _WRITE_HAS_OCCURRED_$$frontier2 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) ) ,  (  _WRITE_HAS_OCCURRED_$$b_q ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
  ...
  __partitioned_block_$4.tail_2:
    ...
    call {:sourceloc} {:sourceloc_num 46} _LOG_READ_$$BFS_kernel_multi_block.b_q_length(true, 0bv32, _abstracted_call_arg_0$1);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 46} _CHECK_READ_$$BFS_kernel_multi_block.b_q_length(true, 0bv32, _abstracted_call_arg_1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$BFS_kernel_multi_block.b_q_length"} true;
    havoc v23$1, v23$2;
    ...
    call {:sourceloc} {:sourceloc_num 49} _LOG_READ_$$BFS_kernel_multi_block.b_offset(p16$1, 0bv32, $$BFS_kernel_multi_block.b_offset[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 49} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 49} _CHECK_READ_$$BFS_kernel_multi_block.b_offset(p16$2, 0bv32, $$BFS_kernel_multi_block.b_offset[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
