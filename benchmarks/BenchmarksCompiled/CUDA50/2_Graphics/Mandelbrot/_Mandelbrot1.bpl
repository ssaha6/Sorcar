...
var {:source_name "blockIndex"} {:group_shared} $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex: [bv32]bv32;
...
var {:source_name "blockX"} {:group_shared} $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX: [bv32]bv32;
...
var {:source_name "blockY"} {:group_shared} $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY: [bv32]bv32;
...
procedure {:source_name "Mandelbrot1<float>"} {:kernel} $_Z11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiib($imageW: bv32, $imageH: bv32, $crunch: bv32, $xOff: bv32, $yOff: bv32, $xJP: bv32, $yJP: bv32, $scale: bv32, $colors: bv32, $frame: bv32, $animationFrame: bv32, $gridWidth: bv32, $numBlocks: bv32, $isJ: bv1);
...
implementation {:source_name "Mandelbrot1<float>"} {:kernel} $_Z11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiib($imageW: bv32, $imageH: bv32, $crunch: bv32, $xOff: bv32, $yOff: bv32, $xJP: bv32, $yJP: bv32, $scale: bv32, $colors: bv32, $frame: bv32, $animationFrame: bv32, $gridWidth: bv32, $numBlocks: bv32, $isJ: bv1)
{
  ...
  var $count.1$1: bv32;
  var $count.1$2: bv32;
  var $cond.i.232$1: bv32;
  var $cond.i.232$2: bv32;
  var $1$1: bv1;
  var $1$2: bv1;
  var $cond21.i.240$1: bv32;
  var $cond21.i.240$2: bv32;
  var $cond28.i.248$1: bv32;
  var $cond28.i.248$2: bv32;
  var $count.2$1: bv32;
  var $count.2$2: bv32;
  var $cond.i.187$1: bv32;
  var $cond.i.187$2: bv32;
  var $2$1: bv1;
  var $2$2: bv1;
  var $cond21.i.195$1: bv32;
  var $cond21.i.195$2: bv32;
  var $cond28.i.203$1: bv32;
  var $cond28.i.203$2: bv32;
  var $count.3$1: bv32;
  var $count.3$2: bv32;
  var $cond.i.142$1: bv32;
  var $cond.i.142$2: bv32;
  var $3$1: bv1;
  var $3$2: bv1;
  var $cond21.i.150$1: bv32;
  var $cond21.i.150$2: bv32;
  var $cond28.i.158$1: bv32;
  var $cond28.i.158$2: bv32;
  var $x.i.112.0$1: bv32;
  var $x.i.112.0$2: bv32;
  var $y.i.113.0$1: bv32;
  var $y.i.113.0$2: bv32;
  var $xx.i.0$1: bv32;
  var $xx.i.0$2: bv32;
  var $yy.i.0$1: bv32;
  var $yy.i.0$2: bv32;
  ...
  var $yC.i.0$1: bv32;
  var $yC.i.0$2: bv32;
  var $x.i.112.1$1: bv32;
  var $x.i.112.1$2: bv32;
  var $y.i.113.1$1: bv32;
  var $y.i.113.1$2: bv32;
  var $xx.i.1$1: bv32;
  var $xx.i.1$2: bv32;
  var $yy.i.1$1: bv32;
  var $yy.i.1$2: bv32;
  ...
  __partitioned_block_$while.body_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b255 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY ==> _WATCHED_OFFSET == 0bv32;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b254 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY ==> _WATCHED_OFFSET == 0bv32;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b251 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX ==> _WATCHED_OFFSET == 0bv32;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b250 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX ==> _WATCHED_OFFSET == 0bv32;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b247 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0bv32;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b246 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0bv32;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b243 ==> _ATOMIC_HAS_OCCURRED_$$blockCounter ==> _WATCHED_OFFSET == 0bv32;
    ...
    assert {:tag "predicatedEquality"} _b239 ==> p0$1 && p0$2 ==> v189$1 == v189$2;
    assert {:tag "predicatedEquality"} _b238 ==> p0$1 && p0$2 ==> v188$1 == v188$2;
    assert {:tag "predicatedEquality"} _b237 ==> p0$1 && p0$2 ==> v184$1 == v184$2;
    assert {:tag "predicatedEquality"} _b236 ==> p0$1 && p0$2 ==> v183$1 == v183$2;
    assert {:tag "predicatedEquality"} _b235 ==> p0$1 && p0$2 ==> v177$1 == v177$2;
    assert {:tag "predicatedEquality"} _b234 ==> p0$1 && p0$2 ==> v178$1 == v178$2;
    assert {:tag "predicatedEquality"} _b233 ==> p0$1 && p0$2 ==> v182$1 == v182$2;
    assert {:tag "predicatedEquality"} _b232 ==> p0$1 && p0$2 ==> v180$1 == v180$2;
    assert {:tag "predicatedEquality"} _b231 ==> p0$1 && p0$2 ==> v174$1 == v174$2;
    assert {:tag "predicatedEquality"} _b230 ==> p0$1 && p0$2 ==> v179$1 == v179$2;
    assert {:tag "predicatedEquality"} _b229 ==> p0$1 && p0$2 ==> v173$1 == v173$2;
    assert {:tag "predicatedEquality"} _b228 ==> p0$1 && p0$2 ==> v175$1 == v175$2;
    assert {:tag "predicatedEquality"} _b227 ==> p0$1 && p0$2 ==> v181$1 == v181$2;
    assert {:tag "predicatedEquality"} _b226 ==> p0$1 && p0$2 ==> v176$1 == v176$2;
    assert {:tag "predicatedEquality"} _b225 ==> p0$1 && p0$2 ==> v195$1 == v195$2;
    assert {:tag "predicatedEquality"} _b224 ==> p0$1 && p0$2 ==> v187$1 == v187$2;
    assert {:tag "predicatedEquality"} _b223 ==> p0$1 && p0$2 ==> v193$1 == v193$2;
    assert {:tag "predicatedEquality"} _b222 ==> p0$1 && p0$2 ==> v186$1 == v186$2;
    assert {:tag "predicatedEquality"} _b221 ==> p0$1 && p0$2 ==> v192$1 == v192$2;
    assert {:tag "predicatedEquality"} _b220 ==> p0$1 && p0$2 ==> v185$1 == v185$2;
    assert {:tag "predicatedEquality"} _b219 ==> p0$1 && p0$2 ==> v190$1 == v190$2;
    assert {:tag "predicatedEquality"} _b218 ==> p0$1 && p0$2 ==> v194$1 == v194$2;
    assert {:tag "predicatedEquality"} _b217 ==> p0$1 && p0$2 ==> v191$1 == v191$2;
    assert {:tag "predicatedEquality"} _b216 ==> p0$1 && p0$2 ==> v151$1 == v151$2;
    assert {:tag "predicatedEquality"} _b215 ==> p0$1 && p0$2 ==> v152$1 == v152$2;
    assert {:tag "predicatedEquality"} _b214 ==> p0$1 && p0$2 ==> v146$1 == v146$2;
    assert {:tag "predicatedEquality"} _b213 ==> p0$1 && p0$2 ==> v148$1 == v148$2;
    assert {:tag "predicatedEquality"} _b212 ==> p0$1 && p0$2 ==> v145$1 == v145$2;
    assert {:tag "predicatedEquality"} _b211 ==> p0$1 && p0$2 ==> v143$1 == v143$2;
    assert {:tag "predicatedEquality"} _b210 ==> p0$1 && p0$2 ==> v142$1 == v142$2;
    assert {:tag "predicatedEquality"} _b209 ==> p0$1 && p0$2 ==> v150$1 == v150$2;
    assert {:tag "predicatedEquality"} _b208 ==> p0$1 && p0$2 ==> v149$1 == v149$2;
    assert {:tag "predicatedEquality"} _b207 ==> p0$1 && p0$2 ==> v147$1 == v147$2;
    assert {:tag "predicatedEquality"} _b206 ==> p0$1 && p0$2 ==> v144$1 == v144$2;
    assert {:tag "predicatedEquality"} _b205 ==> p0$1 && p0$2 ==> v141$1 == v141$2;
    assert {:tag "predicatedEquality"} _b204 ==> p0$1 && p0$2 ==> v137$1 == v137$2;
    assert {:tag "predicatedEquality"} _b203 ==> p0$1 && p0$2 ==> v135$1 == v135$2;
    assert {:tag "predicatedEquality"} _b202 ==> p0$1 && p0$2 ==> v134$1 == v134$2;
    assert {:tag "predicatedEquality"} _b201 ==> p0$1 && p0$2 ==> v132$1 == v132$2;
    assert {:tag "predicatedEquality"} _b200 ==> p0$1 && p0$2 ==> v136$1 == v136$2;
    assert {:tag "predicatedEquality"} _b199 ==> p0$1 && p0$2 ==> v140$1 == v140$2;
    assert {:tag "predicatedEquality"} _b198 ==> p0$1 && p0$2 ==> v139$1 == v139$2;
    assert {:tag "predicatedEquality"} _b197 ==> p0$1 && p0$2 ==> v138$1 == v138$2;
    assert {:tag "predicatedEquality"} _b196 ==> p0$1 && p0$2 ==> v133$1 == v133$2;
    assert {:tag "predicatedEquality"} _b195 ==> p0$1 && p0$2 ==> v131$1 == v131$2;
    assert {:tag "predicatedEquality"} _b194 ==> p0$1 && p0$2 ==> v130$1 == v130$2;
    assert {:tag "predicatedEquality"} _b193 ==> p0$1 && p0$2 ==> v126$1 == v126$2;
    assert {:tag "predicatedEquality"} _b192 ==> p0$1 && p0$2 ==> v124$1 == v124$2;
    assert {:tag "predicatedEquality"} _b191 ==> p0$1 && p0$2 ==> v125$1 == v125$2;
    assert {:tag "predicatedEquality"} _b190 ==> p0$1 && p0$2 ==> v129$1 == v129$2;
    assert {:tag "predicatedEquality"} _b189 ==> p0$1 && p0$2 ==> v128$1 == v128$2;
    assert {:tag "predicatedEquality"} _b188 ==> p0$1 && p0$2 ==> v123$1 == v123$2;
    assert {:tag "predicatedEquality"} _b187 ==> p0$1 && p0$2 ==> v122$1 == v122$2;
    assert {:tag "predicatedEquality"} _b186 ==> p0$1 && p0$2 ==> v127$1 == v127$2;
    assert {:tag "predicatedEquality"} _b185 ==> p0$1 && p0$2 ==> v121$1 == v121$2;
    assert {:tag "predicatedEquality"} _b184 ==> p0$1 && p0$2 ==> v118$1 == v118$2;
    assert {:tag "predicatedEquality"} _b183 ==> p0$1 && p0$2 ==> v111$1 == v111$2;
    assert {:tag "predicatedEquality"} _b182 ==> p0$1 && p0$2 ==> v113$1 == v113$2;
    assert {:tag "predicatedEquality"} _b181 ==> p0$1 && p0$2 ==> v115$1 == v115$2;
    assert {:tag "predicatedEquality"} _b180 ==> p0$1 && p0$2 ==> v116$1 == v116$2;
    assert {:tag "predicatedEquality"} _b179 ==> p0$1 && p0$2 ==> v120$1 == v120$2;
    assert {:tag "predicatedEquality"} _b178 ==> p0$1 && p0$2 ==> v117$1 == v117$2;
    assert {:tag "predicatedEquality"} _b177 ==> p0$1 && p0$2 ==> v119$1 == v119$2;
    assert {:tag "predicatedEquality"} _b176 ==> p0$1 && p0$2 ==> v114$1 == v114$2;
    assert {:tag "predicatedEquality"} _b175 ==> p0$1 && p0$2 ==> v112$1 == v112$2;
    assert {:tag "predicatedEquality"} _b174 ==> p0$1 && p0$2 ==> v163$1 == v163$2;
    assert {:tag "predicatedEquality"} _b173 ==> p0$1 && p0$2 ==> v164$1 == v164$2;
    assert {:tag "predicatedEquality"} _b172 ==> p0$1 && p0$2 ==> v165$1 == v165$2;
    assert {:tag "predicatedEquality"} _b171 ==> p0$1 && p0$2 ==> v169$1 == v169$2;
    assert {:tag "predicatedEquality"} _b170 ==> p0$1 && p0$2 ==> v170$1 == v170$2;
    assert {:tag "predicatedEquality"} _b169 ==> p0$1 && p0$2 ==> v166$1 == v166$2;
    assert {:tag "predicatedEquality"} _b168 ==> p0$1 && p0$2 ==> v172$1 == v172$2;
    assert {:tag "predicatedEquality"} _b167 ==> p0$1 && p0$2 ==> v171$1 == v171$2;
    assert {:tag "predicatedEquality"} _b166 ==> p0$1 && p0$2 ==> v168$1 == v168$2;
    assert {:tag "predicatedEquality"} _b165 ==> p0$1 && p0$2 ==> v167$1 == v167$2;
    assert {:tag "predicatedEquality"} _b164 ==> p0$1 && p0$2 ==> v160$1 == v160$2;
    assert {:tag "predicatedEquality"} _b163 ==> p0$1 && p0$2 ==> v156$1 == v156$2;
    assert {:tag "predicatedEquality"} _b162 ==> p0$1 && p0$2 ==> v153$1 == v153$2;
    assert {:tag "predicatedEquality"} _b161 ==> p0$1 && p0$2 ==> v158$1 == v158$2;
    assert {:tag "predicatedEquality"} _b160 ==> p0$1 && p0$2 ==> v159$1 == v159$2;
    assert {:tag "predicatedEquality"} _b159 ==> p0$1 && p0$2 ==> v157$1 == v157$2;
    assert {:tag "predicatedEquality"} _b158 ==> p0$1 && p0$2 ==> v155$1 == v155$2;
    assert {:tag "predicatedEquality"} _b157 ==> p0$1 && p0$2 ==> v161$1 == v161$2;
    assert {:tag "predicatedEquality"} _b156 ==> p0$1 && p0$2 ==> v162$1 == v162$2;
    assert {:tag "predicatedEquality"} _b155 ==> p0$1 && p0$2 ==> v154$1 == v154$2;
    assert {:tag "predicatedEquality"} _b154 ==> p0$1 && p0$2 ==> v99$1 == v99$2;
    assert {:tag "predicatedEquality"} _b153 ==> p0$1 && p0$2 ==> v98$1 == v98$2;
    assert {:tag "predicatedEquality"} _b152 ==> p0$1 && p0$2 ==> v88$1 == v88$2;
    assert {:tag "predicatedEquality"} _b151 ==> p0$1 && p0$2 ==> v89$1 == v89$2;
    assert {:tag "predicatedEquality"} _b150 ==> p0$1 && p0$2 ==> v92$1 == v92$2;
    assert {:tag "predicatedEquality"} _b149 ==> p0$1 && p0$2 ==> v97$1 == v97$2;
    assert {:tag "predicatedEquality"} _b148 ==> p0$1 && p0$2 ==> v95$1 == v95$2;
    assert {:tag "predicatedEquality"} _b147 ==> p0$1 && p0$2 ==> v90$1 == v90$2;
    assert {:tag "predicatedEquality"} _b146 ==> p0$1 && p0$2 ==> v94$1 == v94$2;
    assert {:tag "predicatedEquality"} _b145 ==> p0$1 && p0$2 ==> v91$1 == v91$2;
    assert {:tag "predicatedEquality"} _b144 ==> p0$1 && p0$2 ==> v93$1 == v93$2;
    assert {:tag "predicatedEquality"} _b143 ==> p0$1 && p0$2 ==> v96$1 == v96$2;
    assert {:tag "predicatedEquality"} _b142 ==> p0$1 && p0$2 ==> v87$1 == v87$2;
    assert {:tag "predicatedEquality"} _b141 ==> p0$1 && p0$2 ==> v85$1 == v85$2;
    assert {:tag "predicatedEquality"} _b140 ==> p0$1 && p0$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b139 ==> p0$1 && p0$2 ==> v84$1 == v84$2;
    assert {:tag "predicatedEquality"} _b138 ==> p0$1 && p0$2 ==> v86$1 == v86$2;
    assert {:tag "predicatedEquality"} _b137 ==> p0$1 && p0$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b136 ==> p0$1 && p0$2 ==> v81$1 == v81$2;
    assert {:tag "predicatedEquality"} _b135 ==> p0$1 && p0$2 ==> v80$1 == v80$2;
    assert {:tag "predicatedEquality"} _b134 ==> p0$1 && p0$2 ==> v79$1 == v79$2;
    assert {:tag "predicatedEquality"} _b133 ==> p0$1 && p0$2 ==> v77$1 == v77$2;
    assert {:tag "predicatedEquality"} _b132 ==> p0$1 && p0$2 ==> v78$1 == v78$2;
    assert {:tag "predicatedEquality"} _b131 ==> p0$1 && p0$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b130 ==> p0$1 && p0$2 ==> v75$1 == v75$2;
    assert {:tag "predicatedEquality"} _b129 ==> p0$1 && p0$2 ==> v69$1 == v69$2;
    assert {:tag "predicatedEquality"} _b128 ==> p0$1 && p0$2 ==> v73$1 == v73$2;
    assert {:tag "predicatedEquality"} _b127 ==> p0$1 && p0$2 ==> v74$1 == v74$2;
    assert {:tag "predicatedEquality"} _b126 ==> p0$1 && p0$2 ==> v72$1 == v72$2;
    assert {:tag "predicatedEquality"} _b125 ==> p0$1 && p0$2 ==> v104$1 == v104$2;
    assert {:tag "predicatedEquality"} _b124 ==> p0$1 && p0$2 ==> v100$1 == v100$2;
    assert {:tag "predicatedEquality"} _b123 ==> p0$1 && p0$2 ==> v106$1 == v106$2;
    assert {:tag "predicatedEquality"} _b122 ==> p0$1 && p0$2 ==> v105$1 == v105$2;
    assert {:tag "predicatedEquality"} _b121 ==> p0$1 && p0$2 ==> v107$1 == v107$2;
    assert {:tag "predicatedEquality"} _b120 ==> p0$1 && p0$2 ==> v103$1 == v103$2;
    assert {:tag "predicatedEquality"} _b119 ==> p0$1 && p0$2 ==> v110$1 == v110$2;
    assert {:tag "predicatedEquality"} _b118 ==> p0$1 && p0$2 ==> v108$1 == v108$2;
    assert {:tag "predicatedEquality"} _b117 ==> p0$1 && p0$2 ==> v102$1 == v102$2;
    assert {:tag "predicatedEquality"} _b116 ==> p0$1 && p0$2 ==> v101$1 == v101$2;
    assert {:tag "predicatedEquality"} _b115 ==> p0$1 && p0$2 ==> v109$1 == v109$2;
    assert {:tag "predicatedEquality"} _b114 ==> p0$1 && p0$2 ==> v66$1 == v66$2;
    assert {:tag "predicatedEquality"} _b113 ==> p0$1 && p0$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b112 ==> p0$1 && p0$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b111 ==> p0$1 && p0$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b110 ==> p0$1 && p0$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b109 ==> p0$1 && p0$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b108 ==> p0$1 && p0$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b107 ==> p0$1 && p0$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b106 ==> p0$1 && p0$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b105 ==> p0$1 && p0$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b104 ==> p0$1 && p0$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b103 ==> p0$1 && p0$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b102 ==> p0$1 && p0$2 ==> v70$1 == v70$2;
    assert {:tag "predicatedEquality"} _b101 ==> p0$1 && p0$2 ==> v67$1 == v67$2;
    assert {:tag "predicatedEquality"} _b100 ==> p0$1 && p0$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b99 ==> p0$1 && p0$2 ==> v68$1 == v68$2;
    assert {:tag "predicatedEquality"} _b98 ==> p0$1 && p0$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b97 ==> p0$1 && p0$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b96 ==> p0$1 && p0$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b95 ==> p0$1 && p0$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b94 ==> p0$1 && p0$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b93 ==> p0$1 && p0$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b92 ==> p0$1 && p0$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b91 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b90 ==> p0$1 && p0$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b89 ==> p0$1 && p0$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b88 ==> p0$1 && p0$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b87 ==> p0$1 && p0$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b86 ==> p0$1 && p0$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b85 ==> p0$1 && p0$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b84 ==> p0$1 && p0$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b83 ==> p0$1 && p0$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b82 ==> p0$1 && p0$2 ==> v39$1 == v39$2;
    ...
    assert {:tag "predicatedEquality"} _b76 ==> p0$1 && p0$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b75 ==> p0$1 && p0$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b74 ==> p0$1 && p0$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b73 ==> p0$1 && p0$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b72 ==> p0$1 && p0$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b71 ==> p0$1 && p0$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b69 ==> p0$1 && p0$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b68 ==> p0$1 && p0$2 ==> v24$1 == v24$2;
    ...
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b63 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b61 ==> p0$1 && p0$2 ==> v2$1 == v2$2;
    assert {:tag "predicatedEquality"} _b60 ==> p0$1 && p0$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b58 ==> p0$1 && p0$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b57 ==> p0$1 && p0$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b56 ==> p0$1 && p0$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b55 ==> p0$1 && p0$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b54 ==> p0$1 && p0$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b53 ==> p0$1 && p0$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b52 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    ...
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b45 ==> p0$1 && p0$2 ==> v1$1 == v1$2;
    assert {:tag "predicatedEquality"} _b44 ==> p0$1 && p0$2 ==> v0$1 == v0$2;
    assert {:tag "predicatedEquality"} _b43 ==> p0$1 && p0$2 ==> $cond$1 == $cond$2;
    assert {:tag "predicatedEquality"} _b42 ==> p0$1 && p0$2 ==> $retval.i.0$1 == $retval.i.0$2;
    ...
    assert {:tag "predicatedEquality"} _b38 ==> p0$1 && p0$2 ==> $y.i.113.1$1 == $y.i.113.1$2;
    assert {:tag "predicatedEquality"} _b37 ==> p0$1 && p0$2 ==> $x.i.112.1$1 == $x.i.112.1$2;
    ...
    assert {:tag "predicatedEquality"} _b32 ==> p0$1 && p0$2 ==> $y.i.113.0$1 == $y.i.113.0$2;
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> $x.i.112.0$1 == $x.i.112.0$2;
    assert {:tag "predicatedEquality"} _b30 ==> p0$1 && p0$2 ==> $cond28.i.158$1 == $cond28.i.158$2;
    assert {:tag "predicatedEquality"} _b29 ==> p0$1 && p0$2 ==> $cond21.i.150$1 == $cond21.i.150$2;
    assert {:tag "predicatedEquality"} _b28 ==> p0$1 && p0$2 ==> $3$1 == $3$2;
    assert {:tag "predicatedEquality"} _b27 ==> p0$1 && p0$2 ==> $cond.i.142$1 == $cond.i.142$2;
    assert {:tag "predicatedEquality"} _b26 ==> p0$1 && p0$2 ==> $count.3$1 == $count.3$2;
    assert {:tag "predicatedEquality"} _b25 ==> p0$1 && p0$2 ==> $cond28.i.203$1 == $cond28.i.203$2;
    assert {:tag "predicatedEquality"} _b24 ==> p0$1 && p0$2 ==> $cond21.i.195$1 == $cond21.i.195$2;
    assert {:tag "predicatedEquality"} _b23 ==> p0$1 && p0$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b22 ==> p0$1 && p0$2 ==> $cond.i.187$1 == $cond.i.187$2;
    assert {:tag "predicatedEquality"} _b21 ==> p0$1 && p0$2 ==> $count.2$1 == $count.2$2;
    assert {:tag "predicatedEquality"} _b20 ==> p0$1 && p0$2 ==> $cond28.i.248$1 == $cond28.i.248$2;
    assert {:tag "predicatedEquality"} _b19 ==> p0$1 && p0$2 ==> $cond21.i.240$1 == $cond21.i.240$2;
    assert {:tag "predicatedEquality"} _b18 ==> p0$1 && p0$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b17 ==> p0$1 && p0$2 ==> $cond.i.232$1 == $cond.i.232$2;
    assert {:tag "predicatedEquality"} _b16 ==> p0$1 && p0$2 ==> $count.1$1 == $count.1$2;
    assert {:tag "predicatedEquality"} _b15 ==> p0$1 && p0$2 ==> $cond28.i$1 == $cond28.i$2;
    assert {:tag "predicatedEquality"} _b14 ==> p0$1 && p0$2 ==> $cond21.i$1 == $cond21.i$2;
    assert {:tag "predicatedEquality"} _b13 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b12 ==> p0$1 && p0$2 ==> $cond.i$1 == $cond.i$2;
    ...
    assert {:tag "pow2NotZero"} _b8 ==> v189$2 != 0bv32;
    assert {:tag "pow2"} _b7 ==> v189$2 == 0bv32 || BV32_AND(v189$2, BV32_SUB(v189$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b6 ==> v189$1 != 0bv32;
    assert {:tag "pow2"} _b5 ==> v189$1 == 0bv32 || BV32_AND(v189$1, BV32_SUB(v189$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b4 ==> v188$2 != 0bv32;
    assert {:tag "pow2"} _b3 ==> v188$2 == 0bv32 || BV32_AND(v188$2, BV32_SUB(v188$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b2 ==> v188$1 != 0bv32;
    assert {:tag "pow2"} _b1 ==> v188$1 == 0bv32 || BV32_AND(v188$1, BV32_SUB(v188$1, 1bv32)) == 0bv32;
  ...
  __partitioned_block_$while.body_1:
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$1, 0bv32, v2$1, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_23"} {:captureState "check_state_23"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_23"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$2, 0bv32, v2$2);
    ...
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] := (if p4$1 then v2$1 else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] := (if p4$2 then v2$2 else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$1, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_24"} {:captureState "check_state_24"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_24"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$2, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    ...
    v3$1 := (if p4$1 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v3$1);
    v3$2 := (if p4$2 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v3$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(p4$1, 0bv32, BV32_UREM(v3$1, $gridWidth), $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(p4$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_25"} {:captureState "check_state_25"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_25"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(p4$2, 0bv32, BV32_UREM(v3$2, $gridWidth));
    ...
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32] := (if p4$1 then BV32_UREM(v3$1, $gridWidth) else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32]);
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32] := (if p4$2 then BV32_UREM(v3$2, $gridWidth) else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32]);
    call {:sourceloc} {:sourceloc_num 13} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$1, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_26"} {:captureState "check_state_26"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_26"} {:sourceloc} {:sourceloc_num 13} _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p4$2, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex"} true;
    v4$1 := (if p4$1 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v4$1);
    v4$2 := (if p4$2 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v4$2);
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(p4$1, 0bv32, BV32_UDIV(v4$1, $gridWidth), $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(p4$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_27"} {:captureState "check_state_27"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_27"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(p4$2, 0bv32, BV32_UDIV(v4$2, $gridWidth));
    ...
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32] := (if p4$1 then BV32_UDIV(v4$1, $gridWidth) else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32]);
    $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32] := (if p4$2 then BV32_UDIV(v4$2, $gridWidth) else $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32]);
  ...
  __partitioned_block_$while.body_2:
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p0$1, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 17} _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(p0$2, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex"} true;
    v5$1 := (if p0$1 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v5$1);
    v5$2 := (if p0$2 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex[0bv32] else v5$2);
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(p5$1, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(p5$2, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32]);
    ...
    v7$1 := (if p5$1 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32] else v7$1);
    v7$2 := (if p5$2 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX[0bv32] else v7$2);
    ...
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(p5$1, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(p5$2, 0bv32, $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32]);
    ...
    v9$1 := (if p5$1 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32] else v9$1);
    v9$2 := (if p5$2 then $$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY[0bv32] else v9$2);
    ...
    $cond.i$1 := (if p12$1 then v21$1 else $cond.i$1);
    $cond.i$2 := (if p12$2 then v21$2 else $cond.i$2);
    $cond.i$1 := (if p13$1 then BV32_SUB(0bv32, v21$1) else $cond.i$1);
    $cond.i$2 := (if p13$2 then BV32_SUB(0bv32, v21$2) else $cond.i$2);
    v29$1 := (if p11$1 then BV32_SGT($cond.i$1, 10bv32) else v29$1);
    v29$2 := (if p11$2 then BV32_SGT($cond.i$2, 10bv32) else v29$2);
    ...
    $0$1 := (if p14$1 then 1bv1 else $0$1);
    $0$2 := (if p14$2 then 1bv1 else $0$2);
    ...
    $cond21.i$1 := (if p16$1 then v24$1 else $cond21.i$1);
    $cond21.i$2 := (if p16$2 then v24$2 else $cond21.i$2);
    $cond21.i$1 := (if p17$1 then BV32_SUB(0bv32, v24$1) else $cond21.i$1);
    $cond21.i$2 := (if p17$2 then BV32_SUB(0bv32, v24$2) else $cond21.i$2);
    v31$1 := (if p15$1 then BV32_SGT($cond21.i$1, 10bv32) else v31$1);
    v31$2 := (if p15$2 then BV32_SGT($cond21.i$2, 10bv32) else v31$2);
    ...
    $0$1 := (if p18$1 then 1bv1 else $0$1);
    $0$2 := (if p18$2 then 1bv1 else $0$2);
    ...
    $cond28.i$1 := (if p20$1 then v27$1 else $cond28.i$1);
    $cond28.i$2 := (if p20$2 then v27$2 else $cond28.i$2);
    $cond28.i$1 := (if p21$1 then BV32_SUB(0bv32, v27$1) else $cond28.i$1);
    $cond28.i$2 := (if p21$2 then BV32_SUB(0bv32, v27$2) else $cond28.i$2);
    $0$1 := (if p19$1 then (if BV32_SGT($cond28.i$1, 10bv32) then 1bv1 else 0bv1) else $0$1);
    $0$2 := (if p19$2 then (if BV32_SGT($cond28.i$2, 10bv32) then 1bv1 else 0bv1) else $0$2);
    $count.0$1 := (if p11$1 then BV1_ZEXT32($0$1) else $count.0$1);
    $count.0$2 := (if p11$2 then BV1_ZEXT32($0$2) else $count.0$2);
    ...
    $cond.i.232$1 := (if p24$1 then v36$1 else $cond.i.232$1);
    $cond.i.232$2 := (if p24$2 then v36$2 else $cond.i.232$2);
    $cond.i.232$1 := (if p25$1 then BV32_SUB(0bv32, v36$1) else $cond.i.232$1);
    $cond.i.232$2 := (if p25$2 then BV32_SUB(0bv32, v36$2) else $cond.i.232$2);
    v44$1 := (if p23$1 then BV32_SGT($cond.i.232$1, 10bv32) else v44$1);
    v44$2 := (if p23$2 then BV32_SGT($cond.i.232$2, 10bv32) else v44$2);
    ...
    $1$1 := (if p26$1 then 1bv1 else $1$1);
    $1$2 := (if p26$2 then 1bv1 else $1$2);
    ...
    $cond21.i.240$1 := (if p28$1 then v39$1 else $cond21.i.240$1);
    $cond21.i.240$2 := (if p28$2 then v39$2 else $cond21.i.240$2);
    $cond21.i.240$1 := (if p29$1 then BV32_SUB(0bv32, v39$1) else $cond21.i.240$1);
    $cond21.i.240$2 := (if p29$2 then BV32_SUB(0bv32, v39$2) else $cond21.i.240$2);
    v46$1 := (if p27$1 then BV32_SGT($cond21.i.240$1, 10bv32) else v46$1);
    v46$2 := (if p27$2 then BV32_SGT($cond21.i.240$2, 10bv32) else v46$2);
    ...
    $1$1 := (if p30$1 then 1bv1 else $1$1);
    $1$2 := (if p30$2 then 1bv1 else $1$2);
    ...
    $cond28.i.248$1 := (if p32$1 then v42$1 else $cond28.i.248$1);
    $cond28.i.248$2 := (if p32$2 then v42$2 else $cond28.i.248$2);
    $cond28.i.248$1 := (if p33$1 then BV32_SUB(0bv32, v42$1) else $cond28.i.248$1);
    $cond28.i.248$2 := (if p33$2 then BV32_SUB(0bv32, v42$2) else $cond28.i.248$2);
    $1$1 := (if p31$1 then (if BV32_SGT($cond28.i.248$1, 10bv32) then 1bv1 else 0bv1) else $1$1);
    $1$2 := (if p31$2 then (if BV32_SGT($cond28.i.248$2, 10bv32) then 1bv1 else 0bv1) else $1$2);
    $count.1$1 := (if p23$1 then BV32_ADD($count.0$1, BV1_ZEXT32($1$1)) else $count.1$1);
    $count.1$2 := (if p23$2 then BV32_ADD($count.0$2, BV1_ZEXT32($1$2)) else $count.1$2);
    ...
    $cond.i.187$1 := (if p36$1 then v51$1 else $cond.i.187$1);
    $cond.i.187$2 := (if p36$2 then v51$2 else $cond.i.187$2);
    $cond.i.187$1 := (if p37$1 then BV32_SUB(0bv32, v51$1) else $cond.i.187$1);
    $cond.i.187$2 := (if p37$2 then BV32_SUB(0bv32, v51$2) else $cond.i.187$2);
    v59$1 := (if p35$1 then BV32_SGT($cond.i.187$1, 10bv32) else v59$1);
    v59$2 := (if p35$2 then BV32_SGT($cond.i.187$2, 10bv32) else v59$2);
    ...
    $2$1 := (if p38$1 then 1bv1 else $2$1);
    $2$2 := (if p38$2 then 1bv1 else $2$2);
    ...
    $cond21.i.195$1 := (if p40$1 then v54$1 else $cond21.i.195$1);
    $cond21.i.195$2 := (if p40$2 then v54$2 else $cond21.i.195$2);
    $cond21.i.195$1 := (if p41$1 then BV32_SUB(0bv32, v54$1) else $cond21.i.195$1);
    $cond21.i.195$2 := (if p41$2 then BV32_SUB(0bv32, v54$2) else $cond21.i.195$2);
    v61$1 := (if p39$1 then BV32_SGT($cond21.i.195$1, 10bv32) else v61$1);
    v61$2 := (if p39$2 then BV32_SGT($cond21.i.195$2, 10bv32) else v61$2);
    ...
    $2$1 := (if p42$1 then 1bv1 else $2$1);
    $2$2 := (if p42$2 then 1bv1 else $2$2);
    ...
    $cond28.i.203$1 := (if p44$1 then v57$1 else $cond28.i.203$1);
    $cond28.i.203$2 := (if p44$2 then v57$2 else $cond28.i.203$2);
    $cond28.i.203$1 := (if p45$1 then BV32_SUB(0bv32, v57$1) else $cond28.i.203$1);
    $cond28.i.203$2 := (if p45$2 then BV32_SUB(0bv32, v57$2) else $cond28.i.203$2);
    $2$1 := (if p43$1 then (if BV32_SGT($cond28.i.203$1, 10bv32) then 1bv1 else 0bv1) else $2$1);
    $2$2 := (if p43$2 then (if BV32_SGT($cond28.i.203$2, 10bv32) then 1bv1 else 0bv1) else $2$2);
    $count.2$1 := (if p35$1 then BV32_ADD($count.1$1, BV1_ZEXT32($2$1)) else $count.2$1);
    $count.2$2 := (if p35$2 then BV32_ADD($count.1$2, BV1_ZEXT32($2$2)) else $count.2$2);
    ...
    $cond.i.142$1 := (if p48$1 then v66$1 else $cond.i.142$1);
    $cond.i.142$2 := (if p48$2 then v66$2 else $cond.i.142$2);
    $cond.i.142$1 := (if p49$1 then BV32_SUB(0bv32, v66$1) else $cond.i.142$1);
    $cond.i.142$2 := (if p49$2 then BV32_SUB(0bv32, v66$2) else $cond.i.142$2);
    v74$1 := (if p47$1 then BV32_SGT($cond.i.142$1, 10bv32) else v74$1);
    v74$2 := (if p47$2 then BV32_SGT($cond.i.142$2, 10bv32) else v74$2);
    ...
    $3$1 := (if p50$1 then 1bv1 else $3$1);
    $3$2 := (if p50$2 then 1bv1 else $3$2);
    ...
    $cond21.i.150$1 := (if p52$1 then v69$1 else $cond21.i.150$1);
    $cond21.i.150$2 := (if p52$2 then v69$2 else $cond21.i.150$2);
    $cond21.i.150$1 := (if p53$1 then BV32_SUB(0bv32, v69$1) else $cond21.i.150$1);
    $cond21.i.150$2 := (if p53$2 then BV32_SUB(0bv32, v69$2) else $cond21.i.150$2);
    v76$1 := (if p51$1 then BV32_SGT($cond21.i.150$1, 10bv32) else v76$1);
    v76$2 := (if p51$2 then BV32_SGT($cond21.i.150$2, 10bv32) else v76$2);
    ...
    $3$1 := (if p54$1 then 1bv1 else $3$1);
    $3$2 := (if p54$2 then 1bv1 else $3$2);
    ...
    $cond28.i.158$1 := (if p56$1 then v72$1 else $cond28.i.158$1);
    $cond28.i.158$2 := (if p56$2 then v72$2 else $cond28.i.158$2);
    $cond28.i.158$1 := (if p57$1 then BV32_SUB(0bv32, v72$1) else $cond28.i.158$1);
    $cond28.i.158$2 := (if p57$2 then BV32_SUB(0bv32, v72$2) else $cond28.i.158$2);
    $3$1 := (if p55$1 then (if BV32_SGT($cond28.i.158$1, 10bv32) then 1bv1 else 0bv1) else $3$1);
    $3$2 := (if p55$2 then (if BV32_SGT($cond28.i.158$2, 10bv32) then 1bv1 else 0bv1) else $3$2);
    $count.3$1 := (if p47$1 then BV32_ADD($count.2$1, BV1_ZEXT32($3$1)) else $count.3$1);
    $count.3$2 := (if p47$2 then BV32_ADD($count.2$2, BV1_ZEXT32($3$2)) else $count.3$2);
    ...
    v81$1 := (if p59$1 then $isJ == 1bv1 else v81$1);
    v81$2 := (if p59$2 then $isJ == 1bv1 else v81$2);
    ...
    $x.i.112.0$1, $y.i.113.0$1, $xx.i.0$1, $yy.i.0$1, $xC.i.0$1, $yC.i.0$1 := (if p60$1 then 0bv32 else $x.i.112.0$1), (if p60$1 then 0bv32 else $y.i.113.0$1), (if p60$1 then 0bv32 else $xx.i.0$1), (if p60$1 then 0bv32 else $yy.i.0$1), (if p60$1 then v79$1 else $xC.i.0$1), (if p60$1 then v80$1 else $yC.i.0$1);
    $x.i.112.0$2, $y.i.113.0$2, $xx.i.0$2, $yy.i.0$2, $xC.i.0$2, $yC.i.0$2 := (if p60$2 then 0bv32 else $x.i.112.0$2), (if p60$2 then 0bv32 else $y.i.113.0$2), (if p60$2 then 0bv32 else $xx.i.0$2), (if p60$2 then 0bv32 else $yy.i.0$2), (if p60$2 then v79$2 else $xC.i.0$2), (if p60$2 then v80$2 else $yC.i.0$2);
    $x.i.112.0$1, $y.i.113.0$1, $xx.i.0$1, $yy.i.0$1, $xC.i.0$1, $yC.i.0$1 := (if p61$1 then v79$1 else $x.i.112.0$1), (if p61$1 then v80$1 else $y.i.113.0$1), (if p61$1 then FMUL32(v79$1, v79$1) else $xx.i.0$1), (if p61$1 then FMUL32(v80$1, v80$1) else $yy.i.0$1), (if p61$1 then $xJP else $xC.i.0$1), (if p61$1 then $yJP else $yC.i.0$1);
    $x.i.112.0$2, $y.i.113.0$2, $xx.i.0$2, $yy.i.0$2, $xC.i.0$2, $yC.i.0$2 := (if p61$2 then v79$2 else $x.i.112.0$2), (if p61$2 then v80$2 else $y.i.113.0$2), (if p61$2 then FMUL32(v79$2, v79$2) else $xx.i.0$2), (if p61$2 then FMUL32(v80$2, v80$2) else $yy.i.0$2), (if p61$2 then $xJP else $xC.i.0$2), (if p61$2 then $yJP else $yC.i.0$2);
    $x.i.112.1$1, $y.i.113.1$1, $xx.i.1$1, $yy.i.1$1, $i.i.0$1 := (if p59$1 then $x.i.112.0$1 else $x.i.112.1$1), (if p59$1 then $y.i.113.0$1 else $y.i.113.1$1), (if p59$1 then $xx.i.0$1 else $xx.i.1$1), (if p59$1 then $yy.i.0$1 else $yy.i.1$1), (if p59$1 then $crunch else $i.i.0$1);
    $x.i.112.1$2, $y.i.113.1$2, $xx.i.1$2, $yy.i.1$2, $i.i.0$2 := (if p59$2 then $x.i.112.0$2 else $x.i.112.1$2), (if p59$2 then $y.i.113.0$2 else $y.i.113.1$2), (if p59$2 then $xx.i.0$2 else $xx.i.1$2), (if p59$2 then $yy.i.0$2 else $yy.i.1$2), (if p59$2 then $crunch else $i.i.0$2);
  ...
  $do.body.i:
    ...
    v82$1 := (if p62$1 then FLT32(1082130432bv32, FADD32($xx.i.1$1, $yy.i.1$1)) else v82$1);
    v82$2 := (if p62$2 then FLT32(1082130432bv32, FADD32($xx.i.1$2, $yy.i.1$2)) else v82$2);
    p63$1 := false;
    p63$2 := false;
    p64$1 := false;
    p64$2 := false;
    ...
    v83$1 := (if p63$1 then FADD32(FMUL32(FMUL32($x.i.112.1$1, $y.i.113.1$1), 1073741824bv32), $yC.i.0$1) else v83$1);
    v83$2 := (if p63$2 then FADD32(FMUL32(FMUL32($x.i.112.1$2, $y.i.113.1$2), 1073741824bv32), $yC.i.0$2) else v83$2);
    ...
    v87$1 := (if p63$1 then FLT32(1082130432bv32, FADD32(v86$1, v85$1)) else v87$1);
    v87$2 := (if p63$2 then FLT32(1082130432bv32, FADD32(v86$2, v85$2)) else v87$2);
    ...
    v88$1 := (if p64$1 then FADD32(FMUL32(FMUL32(v84$1, v83$1), 1073741824bv32), $yC.i.0$1) else v88$1);
    v88$2 := (if p64$2 then FADD32(FMUL32(FMUL32(v84$2, v83$2), 1073741824bv32), $yC.i.0$2) else v88$2);
    ...
    v92$1 := (if p64$1 then FLT32(1082130432bv32, FADD32(v91$1, v90$1)) else v92$1);
    v92$2 := (if p64$2 then FLT32(1082130432bv32, FADD32(v91$2, v90$2)) else v92$2);
    ...
    v93$1 := (if p65$1 then FADD32(FMUL32(FMUL32(v89$1, v88$1), 1073741824bv32), $yC.i.0$1) else v93$1);
    v93$2 := (if p65$2 then FADD32(FMUL32(FMUL32(v89$2, v88$2), 1073741824bv32), $yC.i.0$2) else v93$2);
    ...
    v97$1 := (if p65$1 then FLT32(1082130432bv32, FADD32(v96$1, v95$1)) else v97$1);
    v97$2 := (if p65$2 then FLT32(1082130432bv32, FADD32(v96$2, v95$2)) else v97$2);
    ...
    v98$1 := (if p66$1 then FADD32(FMUL32(FMUL32(v94$1, v93$1), 1073741824bv32), $yC.i.0$1) else v98$1);
    v98$2 := (if p66$2 then FADD32(FMUL32(FMUL32(v94$2, v93$2), 1073741824bv32), $yC.i.0$2) else v98$2);
    ...
    v102$1 := (if p66$1 then FLT32(1082130432bv32, FADD32(v101$1, v100$1)) else v102$1);
    v102$2 := (if p66$2 then FLT32(1082130432bv32, FADD32(v101$2, v100$2)) else v102$2);
    ...
    v103$1 := (if p67$1 then FADD32(FMUL32(FMUL32(v99$1, v98$1), 1073741824bv32), $yC.i.0$1) else v103$1);
    v103$2 := (if p67$2 then FADD32(FMUL32(FMUL32(v99$2, v98$2), 1073741824bv32), $yC.i.0$2) else v103$2);
    ...
    v107$1 := (if p67$1 then FLT32(1082130432bv32, FADD32(v106$1, v105$1)) else v107$1);
    v107$2 := (if p67$2 then FLT32(1082130432bv32, FADD32(v106$2, v105$2)) else v107$2);
    ...
    v108$1 := (if p68$1 then FADD32(FMUL32(FMUL32(v104$1, v103$1), 1073741824bv32), $yC.i.0$1) else v108$1);
    v108$2 := (if p68$2 then FADD32(FMUL32(FMUL32(v104$2, v103$2), 1073741824bv32), $yC.i.0$2) else v108$2);
    ...
    v112$1 := (if p68$1 then FLT32(1082130432bv32, FADD32(v111$1, v110$1)) else v112$1);
    v112$2 := (if p68$2 then FLT32(1082130432bv32, FADD32(v111$2, v110$2)) else v112$2);
    ...
    v113$1 := (if p69$1 then FADD32(FMUL32(FMUL32(v109$1, v108$1), 1073741824bv32), $yC.i.0$1) else v113$1);
    v113$2 := (if p69$2 then FADD32(FMUL32(FMUL32(v109$2, v108$2), 1073741824bv32), $yC.i.0$2) else v113$2);
    ...
    v117$1 := (if p69$1 then FLT32(1082130432bv32, FADD32(v116$1, v115$1)) else v117$1);
    v117$2 := (if p69$2 then FLT32(1082130432bv32, FADD32(v116$2, v115$2)) else v117$2);
    ...
    v118$1 := (if p70$1 then FADD32(FMUL32(FMUL32(v114$1, v113$1), 1073741824bv32), $yC.i.0$1) else v118$1);
    v118$2 := (if p70$2 then FADD32(FMUL32(FMUL32(v114$2, v113$2), 1073741824bv32), $yC.i.0$2) else v118$2);
    ...
    v122$1 := (if p70$1 then FLT32(1082130432bv32, FADD32(v121$1, v120$1)) else v122$1);
    v122$2 := (if p70$2 then FLT32(1082130432bv32, FADD32(v121$2, v120$2)) else v122$2);
    ...
    v123$1 := (if p71$1 then FADD32(FMUL32(FMUL32(v119$1, v118$1), 1073741824bv32), $yC.i.0$1) else v123$1);
    v123$2 := (if p71$2 then FADD32(FMUL32(FMUL32(v119$2, v118$2), 1073741824bv32), $yC.i.0$2) else v123$2);
    ...
    v127$1 := (if p71$1 then FLT32(1082130432bv32, FADD32(v126$1, v125$1)) else v127$1);
    v127$2 := (if p71$2 then FLT32(1082130432bv32, FADD32(v126$2, v125$2)) else v127$2);
    ...
    v128$1 := (if p72$1 then FADD32(FMUL32(FMUL32(v124$1, v123$1), 1073741824bv32), $yC.i.0$1) else v128$1);
    v128$2 := (if p72$2 then FADD32(FMUL32(FMUL32(v124$2, v123$2), 1073741824bv32), $yC.i.0$2) else v128$2);
    ...
    v132$1 := (if p72$1 then FLT32(1082130432bv32, FADD32(v131$1, v130$1)) else v132$1);
    v132$2 := (if p72$2 then FLT32(1082130432bv32, FADD32(v131$2, v130$2)) else v132$2);
    ...
    v133$1 := (if p73$1 then FADD32(FMUL32(FMUL32(v129$1, v128$1), 1073741824bv32), $yC.i.0$1) else v133$1);
    v133$2 := (if p73$2 then FADD32(FMUL32(FMUL32(v129$2, v128$2), 1073741824bv32), $yC.i.0$2) else v133$2);
    ...
    v137$1 := (if p73$1 then FLT32(1082130432bv32, FADD32(v136$1, v135$1)) else v137$1);
    v137$2 := (if p73$2 then FLT32(1082130432bv32, FADD32(v136$2, v135$2)) else v137$2);
    ...
    v138$1 := (if p74$1 then FADD32(FMUL32(FMUL32(v134$1, v133$1), 1073741824bv32), $yC.i.0$1) else v138$1);
    v138$2 := (if p74$2 then FADD32(FMUL32(FMUL32(v134$2, v133$2), 1073741824bv32), $yC.i.0$2) else v138$2);
    ...
    v142$1 := (if p74$1 then FLT32(1082130432bv32, FADD32(v141$1, v140$1)) else v142$1);
    v142$2 := (if p74$2 then FLT32(1082130432bv32, FADD32(v141$2, v140$2)) else v142$2);
    ...
    v143$1 := (if p75$1 then FADD32(FMUL32(FMUL32(v139$1, v138$1), 1073741824bv32), $yC.i.0$1) else v143$1);
    v143$2 := (if p75$2 then FADD32(FMUL32(FMUL32(v139$2, v138$2), 1073741824bv32), $yC.i.0$2) else v143$2);
    ...
    v147$1 := (if p75$1 then FLT32(1082130432bv32, FADD32(v146$1, v145$1)) else v147$1);
    v147$2 := (if p75$2 then FLT32(1082130432bv32, FADD32(v146$2, v145$2)) else v147$2);
    ...
    v148$1 := (if p76$1 then FADD32(FMUL32(FMUL32(v144$1, v143$1), 1073741824bv32), $yC.i.0$1) else v148$1);
    v148$2 := (if p76$2 then FADD32(FMUL32(FMUL32(v144$2, v143$2), 1073741824bv32), $yC.i.0$2) else v148$2);
    ...
    v152$1 := (if p76$1 then FLT32(1082130432bv32, FADD32(v151$1, v150$1)) else v152$1);
    v152$2 := (if p76$2 then FLT32(1082130432bv32, FADD32(v151$2, v150$2)) else v152$2);
    ...
    v153$1 := (if p77$1 then FADD32(FMUL32(FMUL32(v149$1, v148$1), 1073741824bv32), $yC.i.0$1) else v153$1);
    v153$2 := (if p77$2 then FADD32(FMUL32(FMUL32(v149$2, v148$2), 1073741824bv32), $yC.i.0$2) else v153$2);
    ...
    v157$1 := (if p77$1 then FLT32(1082130432bv32, FADD32(v156$1, v155$1)) else v157$1);
    v157$2 := (if p77$2 then FLT32(1082130432bv32, FADD32(v156$2, v155$2)) else v157$2);
    ...
    v158$1 := (if p78$1 then FADD32(FMUL32(FMUL32(v154$1, v153$1), 1073741824bv32), $yC.i.0$1) else v158$1);
    v158$2 := (if p78$2 then FADD32(FMUL32(FMUL32(v154$2, v153$2), 1073741824bv32), $yC.i.0$2) else v158$2);
    ...
    v162$1 := (if p78$1 then FLT32(1082130432bv32, FADD32(v161$1, v160$1)) else v162$1);
    v162$2 := (if p78$2 then FLT32(1082130432bv32, FADD32(v161$2, v160$2)) else v162$2);
    ...
    v163$1 := (if p79$1 then FADD32(FMUL32(FMUL32(v159$1, v158$1), 1073741824bv32), $yC.i.0$1) else v163$1);
    v163$2 := (if p79$2 then FADD32(FMUL32(FMUL32(v159$2, v158$2), 1073741824bv32), $yC.i.0$2) else v163$2);
    ...
    v167$1 := (if p79$1 then FLT32(1082130432bv32, FADD32(v166$1, v165$1)) else v167$1);
    v167$2 := (if p79$2 then FLT32(1082130432bv32, FADD32(v166$2, v165$2)) else v167$2);
    ...
    v168$1 := (if p80$1 then FADD32(FMUL32(FMUL32(v164$1, v163$1), 1073741824bv32), $yC.i.0$1) else v168$1);
    v168$2 := (if p80$2 then FADD32(FMUL32(FMUL32(v164$2, v163$2), 1073741824bv32), $yC.i.0$2) else v168$2);
    ...
    v172$1 := (if p80$1 then FLT32(1082130432bv32, FADD32(v171$1, v170$1)) else v172$1);
    v172$2 := (if p80$2 then FLT32(1082130432bv32, FADD32(v171$2, v170$2)) else v172$2);
    ...
    v173$1 := (if p81$1 then FADD32(FMUL32(FMUL32(v169$1, v168$1), 1073741824bv32), $yC.i.0$1) else v173$1);
    v173$2 := (if p81$2 then FADD32(FMUL32(FMUL32(v169$2, v168$2), 1073741824bv32), $yC.i.0$2) else v173$2);
    ...
    v177$1 := (if p81$1 then BV32_SUB($i.i.0$1, 20bv32) else v177$1);
    v177$2 := (if p81$2 then BV32_SUB($i.i.0$2, 20bv32) else v177$2);
    v178$1 := (if p81$1 then BV32_SLE(v177$1, 0bv32) else v178$1);
    v178$2 := (if p81$2 then BV32_SLE(v177$2, 0bv32) else v178$2);
    ...
    v179$1 := (if p82$1 then FLT32(1082130432bv32, FADD32(v176$1, v175$1)) else v179$1);
    v179$2 := (if p82$2 then FLT32(1082130432bv32, FADD32(v176$2, v175$2)) else v179$2);
    ...
    v180$1 := (if p83$1 then FADD32(FMUL32(FMUL32(v174$1, v173$1), 1073741824bv32), $yC.i.0$1) else v180$1);
    v180$2 := (if p83$2 then FADD32(FMUL32(FMUL32(v174$2, v173$2), 1073741824bv32), $yC.i.0$2) else v180$2);
    ...
    $x.i.112.1$1, $y.i.113.1$1, $xx.i.1$1, $yy.i.1$1, $i.i.0$1 := (if p83$1 then v181$1 else $x.i.112.1$1), (if p83$1 then v180$1 else $y.i.113.1$1), (if p83$1 then FMUL32(v181$1, v181$1) else $xx.i.1$1), (if p83$1 then FMUL32(v180$1, v180$1) else $yy.i.1$1), (if p83$1 then v177$1 else $i.i.0$1);
    $x.i.112.1$2, $y.i.113.1$2, $xx.i.1$2, $yy.i.1$2, $i.i.0$2 := (if p83$2 then v181$2 else $x.i.112.1$2), (if p83$2 then v180$2 else $y.i.113.1$2), (if p83$2 then FMUL32(v181$2, v181$2) else $xx.i.1$2), (if p83$2 then FMUL32(v180$2, v180$2) else $yy.i.1$2), (if p83$2 then v177$2 else $i.i.0$2);
  ...
  $do.body.i.tail:
    assume !p62$1 && !p62$2;
    $retval.i.0$1 := (if p84$1 then BV32_SUB($i.i.0$1, 1bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p84$2 then BV32_SUB($i.i.0$2, 1bv32) else $retval.i.0$2);
    ...
    $retval.i.0$1 := (if p87$1 then v177$1 else $retval.i.0$1);
    $retval.i.0$2 := (if p87$2 then v177$2 else $retval.i.0$2);
    $retval.i.0$1 := (if p88$1 then BV32_SUB($i.i.0$1, 19bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p88$2 then BV32_SUB($i.i.0$2, 19bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p89$1 then BV32_SUB($i.i.0$1, 18bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p89$2 then BV32_SUB($i.i.0$2, 18bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p90$1 then BV32_SUB($i.i.0$1, 17bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p90$2 then BV32_SUB($i.i.0$2, 17bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p91$1 then BV32_SUB($i.i.0$1, 16bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p91$2 then BV32_SUB($i.i.0$2, 16bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p92$1 then BV32_SUB($i.i.0$1, 15bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p92$2 then BV32_SUB($i.i.0$2, 15bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p93$1 then BV32_SUB($i.i.0$1, 14bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p93$2 then BV32_SUB($i.i.0$2, 14bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p94$1 then BV32_SUB($i.i.0$1, 13bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p94$2 then BV32_SUB($i.i.0$2, 13bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p95$1 then BV32_SUB($i.i.0$1, 12bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p95$2 then BV32_SUB($i.i.0$2, 12bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p96$1 then BV32_SUB($i.i.0$1, 11bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p96$2 then BV32_SUB($i.i.0$2, 11bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p97$1 then BV32_SUB($i.i.0$1, 10bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p97$2 then BV32_SUB($i.i.0$2, 10bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p98$1 then BV32_SUB($i.i.0$1, 9bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p98$2 then BV32_SUB($i.i.0$2, 9bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p99$1 then BV32_SUB($i.i.0$1, 8bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p99$2 then BV32_SUB($i.i.0$2, 8bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p100$1 then BV32_SUB($i.i.0$1, 7bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p100$2 then BV32_SUB($i.i.0$2, 7bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p101$1 then BV32_SUB($i.i.0$1, 6bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p101$2 then BV32_SUB($i.i.0$2, 6bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p102$1 then BV32_SUB($i.i.0$1, 5bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p102$2 then BV32_SUB($i.i.0$2, 5bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p103$1 then BV32_SUB($i.i.0$1, 4bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p103$2 then BV32_SUB($i.i.0$2, 4bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p104$1 then BV32_SUB($i.i.0$1, 3bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p104$2 then BV32_SUB($i.i.0$2, 3bv32) else $retval.i.0$2);
    $retval.i.0$1 := (if p105$1 then BV32_SUB($i.i.0$1, 2bv32) else $retval.i.0$1);
    $retval.i.0$2 := (if p105$2 then BV32_SUB($i.i.0$2, 2bv32) else $retval.i.0$2);
    v182$1 := (if p59$1 then BV32_SGT($retval.i.0$1, 0bv32) else v182$1);
    v182$2 := (if p59$2 then BV32_SGT($retval.i.0$2, 0bv32) else v182$2);
    ...
    $cond$1 := (if p106$1 then 0bv32 else $cond$1);
    $cond$2 := (if p106$2 then 0bv32 else $cond$2);
    $cond$1 := (if p107$1 then BV32_SUB($crunch, $retval.i.0$1) else $cond$1);
    $cond$2 := (if p107$2 then BV32_SUB($crunch, $retval.i.0$2) else $cond$2);
    v183$1 := (if p59$1 then $cond$1 != 0bv32 else v183$1);
    v183$2 := (if p59$2 then $cond$2 != 0bv32 else v183$2);
    ...
    $$color$0bv32$1 := (if p108$1 then 0bv8 else $$color$0bv32$1);
    $$color$0bv32$2 := (if p108$2 then 0bv8 else $$color$0bv32$2);
    $$color$1bv32$1 := (if p108$1 then 0bv8 else $$color$1bv32$1);
    $$color$1bv32$2 := (if p108$2 then 0bv8 else $$color$1bv32$2);
    $$color$2bv32$1 := (if p108$1 then 0bv8 else $$color$2bv32$1);
    $$color$2bv32$2 := (if p108$2 then 0bv8 else $$color$2bv32$2);
    v184$1 := (if p109$1 then BV32_ADD($cond$1, $animationFrame) else v184$1);
    v184$2 := (if p109$2 then BV32_ADD($cond$2, $animationFrame) else v184$2);
    v185$1 := (if p109$1 then $$colors.val$0bv32$1 else v185$1);
    v185$2 := (if p109$2 then $$colors.val$0bv32$2 else v185$2);
    $$color$0bv32$1 := (if p109$1 then BV32_MUL(v184$1, BV8_ZEXT32(v185$1))[8:0] else $$color$0bv32$1);
    $$color$0bv32$2 := (if p109$2 then BV32_MUL(v184$2, BV8_ZEXT32(v185$2))[8:0] else $$color$0bv32$2);
    v186$1 := (if p109$1 then $$colors.val$1bv32$1 else v186$1);
    v186$2 := (if p109$2 then $$colors.val$1bv32$2 else v186$2);
    $$color$1bv32$1 := (if p109$1 then BV32_MUL(v184$1, BV8_ZEXT32(v186$1))[8:0] else $$color$1bv32$1);
    $$color$1bv32$2 := (if p109$2 then BV32_MUL(v184$2, BV8_ZEXT32(v186$2))[8:0] else $$color$1bv32$2);
    v187$1 := (if p109$1 then $$colors.val$2bv32$1 else v187$1);
    v187$2 := (if p109$2 then $$colors.val$2bv32$2 else v187$2);
    $$color$2bv32$1 := (if p109$1 then BV32_MUL(v184$1, BV8_ZEXT32(v187$1))[8:0] else $$color$2bv32$1);
    $$color$2bv32$2 := (if p109$2 then BV32_MUL(v184$2, BV8_ZEXT32(v187$2))[8:0] else $$color$2bv32$2);
    v188$1 := (if p59$1 then BV32_ADD($frame, 1bv32) else v188$1);
    v188$2 := (if p59$2 then BV32_ADD($frame, 1bv32) else v188$2);
    v189$1 := (if p59$1 then BV32_SDIV(v188$1, 2bv32) else v189$1);
    v189$2 := (if p59$2 then BV32_SDIV(v188$2, 2bv32) else v189$2);
    v190$1 := (if p59$1 then $$pixelColor$0bv32$1 else v190$1);
    v190$2 := (if p59$2 then $$pixelColor$0bv32$2 else v190$2);
    v191$1 := (if p59$1 then $$color$0bv32$1 else v191$1);
    v191$2 := (if p59$2 then $$color$0bv32$2 else v191$2);
    call {:sourceloc} {:sourceloc_num 176} _LOG_WRITE_$$dst(p59$1, BV32_MUL(v13$1, 4bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v190$1), $frame), BV8_ZEXT32(v191$1)), v189$1), v188$1)[8:0], $$dst[BV32_MUL(v13$1, 4bv32)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 176} _CHECK_WRITE_$$dst(p59$2, BV32_MUL(v13$2, 4bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v190$2), $frame), BV8_ZEXT32(v191$2)), v189$2), v188$2)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_MUL(v13$1, 4bv32)] := (if p59$1 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v190$1), $frame), BV8_ZEXT32(v191$1)), v189$1), v188$1)[8:0] else $$dst[BV32_MUL(v13$1, 4bv32)]);
    $$dst[BV32_MUL(v13$2, 4bv32)] := (if p59$2 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v190$2), $frame), BV8_ZEXT32(v191$2)), v189$2), v188$2)[8:0] else $$dst[BV32_MUL(v13$2, 4bv32)]);
    v192$1 := (if p59$1 then $$pixelColor$1bv32$1 else v192$1);
    v192$2 := (if p59$2 then $$pixelColor$1bv32$2 else v192$2);
    v193$1 := (if p59$1 then $$color$1bv32$1 else v193$1);
    v193$2 := (if p59$2 then $$color$1bv32$2 else v193$2);
    call {:sourceloc} {:sourceloc_num 179} _LOG_WRITE_$$dst(p59$1, BV32_ADD(BV32_MUL(v13$1, 4bv32), 1bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$1), $frame), BV8_ZEXT32(v193$1)), v189$1), v188$1)[8:0], $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 179} _CHECK_WRITE_$$dst(p59$2, BV32_ADD(BV32_MUL(v13$2, 4bv32), 1bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$2), $frame), BV8_ZEXT32(v193$2)), v189$2), v188$2)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 1bv32)] := (if p59$1 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$1), $frame), BV8_ZEXT32(v193$1)), v189$1), v188$1)[8:0] else $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 1bv32)]);
    $$dst[BV32_ADD(BV32_MUL(v13$2, 4bv32), 1bv32)] := (if p59$2 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$2), $frame), BV8_ZEXT32(v193$2)), v189$2), v188$2)[8:0] else $$dst[BV32_ADD(BV32_MUL(v13$2, 4bv32), 1bv32)]);
    v194$1 := (if p59$1 then $$pixelColor$2bv32$1 else v194$1);
    v194$2 := (if p59$2 then $$pixelColor$2bv32$2 else v194$2);
    v195$1 := (if p59$1 then $$color$2bv32$1 else v195$1);
    v195$2 := (if p59$2 then $$color$2bv32$2 else v195$2);
    call {:sourceloc} {:sourceloc_num 182} _LOG_WRITE_$$dst(p59$1, BV32_ADD(BV32_MUL(v13$1, 4bv32), 2bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$1), $frame), BV8_ZEXT32(v195$1)), v189$1), v188$1)[8:0], $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 182} _CHECK_WRITE_$$dst(p59$2, BV32_ADD(BV32_MUL(v13$2, 4bv32), 2bv32), BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$2), $frame), BV8_ZEXT32(v195$2)), v189$2), v188$2)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 2bv32)] := (if p59$1 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$1), $frame), BV8_ZEXT32(v195$1)), v189$1), v188$1)[8:0] else $$dst[BV32_ADD(BV32_MUL(v13$1, 4bv32), 2bv32)]);
    $$dst[BV32_ADD(BV32_MUL(v13$2, 4bv32), 2bv32)] := (if p59$2 then BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$2), $frame), BV8_ZEXT32(v195$2)), v189$2), v188$2)[8:0] else $$dst[BV32_ADD(BV32_MUL(v13$2, 4bv32), 2bv32)]);
...
const _WATCHED_VALUE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;



implementation {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;



implementation {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;



implementation {:inline 1} _LOG_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY(_P: bool, _offset: bv32)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;
    assume _P$1 && $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;
    assume _P$1 && $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex;
    goto anon1;

  anon1:
    assume _P$1 && $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;
    assume _P$1 && $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;
    assume _P$1 && $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX;
    goto anon2;

  anon2:
    assume _P$1 && $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;
    assume _P$1 && $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;
    assume _P$1 && $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ11Mandelbrot1IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY;
    goto anon3;
