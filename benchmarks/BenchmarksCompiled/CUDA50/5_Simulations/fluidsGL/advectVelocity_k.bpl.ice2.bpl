...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$vx ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $pdx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$vx ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), group_size_y), BV32_DIV(BV32_DIV(BV32_MUL(local_id_y$1, $lb), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb), group_size_y)) ) ,  (  _WRITE_HAS_OCCURRED_$$vx ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $lb), group_size_y), $lb)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb)) ) ,  (  _WRITE_HAS_OCCURRED_$$vx ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $pdx), $lb), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(BV32_MUL(local_id_y$1, $pdx), $lb), group_size_x)) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$vx$ghost$$2 == _WRITE_HAS_OCCURRED_$$vx ) ,  (  _WRITE_HAS_OCCURRED_$$vy ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $pdx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$vy ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), group_size_y), BV32_DIV(BV32_DIV(BV32_MUL(local_id_y$1, $lb), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb), group_size_y)) ) ,  (  _WRITE_HAS_OCCURRED_$$vy ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $lb), group_size_y), $lb)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb)) ) ,  (  _WRITE_HAS_OCCURRED_$$vy ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $pdx), $lb), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(BV32_MUL(local_id_y$1, $pdx), $lb), group_size_x)) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$vy$ghost$$2 == _WRITE_HAS_OCCURRED_$$vy )  ); 
