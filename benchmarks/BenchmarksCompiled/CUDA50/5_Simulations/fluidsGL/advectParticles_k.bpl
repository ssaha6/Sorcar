...
implementation {:source_name "advectParticles_k"} {:kernel} $_Z17advectParticles_kP6float2S0_iifij($dx: bv32, $dy: bv32, $dt: bv32, $lb: bv32, $pitch: bv32)
{
  ...
  $2:
    ...
    assert {:tag "accessBreak"} _b14 ==> _READ_HAS_OCCURRED_$$part ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 2bv32), BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $dx), $lb), group_size_y)), BV32_MUL(BV32_MUL(local_id_y$1, $dx), $lb)), BV32_MUL(group_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b13 ==> _READ_HAS_OCCURRED_$$part ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $dx), $lb), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(BV32_MUL(local_id_y$1, $dx), $lb), group_size_x)), BV32_DIV(local_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b12 ==> _READ_HAS_OCCURRED_$$part ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $dx), $lb), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $lb), group_size_y), $lb)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $dx), $lb)), BV32_DIV(BV32_DIV(local_id_x$1, $dx), $lb));
    assert {:tag "accessBreak"} _b11 ==> _READ_HAS_OCCURRED_$$part ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $dx), $lb), group_size_y), BV32_DIV(BV32_DIV(BV32_MUL(local_id_y$1, $lb), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $dx), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(local_id_x$1, $dx), $lb), group_size_y));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _WRITE_HAS_OCCURRED_$$part ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $dx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $dx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 2bv32), 1bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _READ_HAS_OCCURRED_$$part ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $dx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $dx), 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $dx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 2bv32), 1bv32));
    assume {:predicate "p1"} {:dominator_predicate "p0"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _WRITE_HAS_OCCURRED_$$part ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $dx);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$part ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $dx);
