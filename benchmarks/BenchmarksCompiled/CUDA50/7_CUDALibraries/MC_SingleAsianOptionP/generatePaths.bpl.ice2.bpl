...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), v0$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), v0$2) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, v0$1) )  && ( p0$2 ==> BV32_SLE($i.0$2, v0$2) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, v0$1) )  && ( p0$2 ==> BV32_SGE($i.0$2, v0$2) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, v0$1) )  && ( p0$2 ==> BV32_ULE($i.0$2, v0$2) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, v0$1) )  && ( p0$2 ==> BV32_UGE($i.0$2, v0$2) ) ,  (  BV32_ULT($i.0$1, $numSims) ==> p0$1 )  && (  BV32_ULT($i.0$2, $numSims) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$paths ==> BV32_AND(BV32_SUB($numSims, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$1) ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$paths ==> BV32_AND(BV32_SUB($numSims, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$1) ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$paths$ghost$$3 == _WRITE_HAS_OCCURRED_$$paths )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p2$1 ==> BV32_AND(BV32_SUB($numSims, 1bv32), $output.0$1) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$1) )  && ( p2$2 ==> BV32_AND(BV32_SUB($numSims, 1bv32), $output.0$2) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$2) ) ,  ( p2$1 ==> BV32_SLE($t.0$1, 0bv32) )  && ( p2$2 ==> BV32_SLE($t.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_SGE($t.0$1, 0bv32) )  && ( p2$2 ==> BV32_SGE($t.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_ULE($t.0$1, 0bv32) )  && ( p2$2 ==> BV32_ULE($t.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_UGE($t.0$1, 0bv32) )  && ( p2$2 ==> BV32_UGE($t.0$2, 0bv32) ) ,  ( p2$1 ==> p2$1 ==> BV32_ULT($i.0$1, $numSims) )  && ( p2$2 ==> p2$2 ==> BV32_ULT($i.0$2, $numSims) ) ,  (  BV32_ULT($i.0$1, $numSims) && BV32_ULT($t.0$1, $numTimesteps) ==> p2$1 )  && (  BV32_ULT($i.0$2, $numSims) && BV32_ULT($t.0$2, $numTimesteps) ==> p2$2 ) ,  (  _WRITE_HAS_OCCURRED_$$paths ==> BV32_ULT($i.0$1, $numSims) ) ,  true ,  true ,  true  ); 
