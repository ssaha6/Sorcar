...
implementation {:source_name "generatePaths<float>"} {:kernel} $_Z13generatePathsIfEvPT_P17curandStateXORWOWPK11AsianOptionIS0_Ejj($numSims: bv32, $numTimesteps: bv32)
{
  ...
  $entry:
    ...
    havoc v25$1, v25$2;
    havoc v26$1, v26$2;
    $$localState$0bv32$1 := v26$1;
    $$localState$0bv32$2 := v26$2;
    $i.0$1 := v0$1;
    $i.0$2 := v0$2;
    p0$1 := false;
    p0$2 := false;
  ...
  $for.cond:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), v0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), v0$2);
    assert {:block_sourceloc} {:sourceloc_num 29} p0$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 30} {:thread 1} (if BV32_UREM($i.0$1, v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 30} {:thread 2} (if BV32_UREM($i.0$2, v1) == v0$2 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 31} {:thread 1} (if _WRITE_HAS_OCCURRED_$$paths ==> BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $numSims), v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
  ...
  $for.cond.20:
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$paths ==> BV32_ULT($i.0$1, $numSims);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_ULT($i.0$1, $numSims) && BV32_ULT($t.0$1, $numTimesteps) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_ULT($i.0$2, $numSims) && BV32_ULT($t.0$2, $numTimesteps) ==> p2$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b10 ==> BV32_UGE($t.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b10 ==> BV32_UGE($t.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b9 ==> BV32_ULE($t.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b9 ==> BV32_ULE($t.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b8 ==> BV32_SGE($t.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b8 ==> BV32_SGE($t.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b7 ==> BV32_SLE($t.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b7 ==> BV32_SLE($t.0$2, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b6 ==> BV32_AND(BV32_SUB($numSims, 1bv32), $output.0$1) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b6 ==> BV32_AND(BV32_SUB($numSims, 1bv32), $output.0$2) == BV32_AND(BV32_SUB($numSims, 1bv32), $i.0$2);
    assert {:block_sourceloc} {:sourceloc_num 33} p2$1 ==> true;
    assert {:originated_from_invariant} {:sourceloc_num 34} {:thread 1} p2$1 ==> (if BV32_SUB(BV32_UDIV(BV32_MUL($output.0$1, 4bv32), 4bv32), $i.0$1) == BV32_MUL($t.0$1, $numSims) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 34} {:thread 2} p2$2 ==> (if BV32_SUB(BV32_UDIV(BV32_MUL($output.0$2, 4bv32), 4bv32), $i.0$2) == BV32_MUL($t.0$2, $numSims) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 35} {:thread 1} (if _WRITE_HAS_OCCURRED_$$paths ==> BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $numSims), v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    ...
    v30$1 := (if p3$1 then $$localState$0bv32$1 else v30$1);
    v30$2 := (if p3$2 then $$localState$0bv32$2 else v30$2);
    $$localState$0bv32$1 := (if p3$1 then BV32_ADD(v30$1, v29$1) else $$localState$0bv32$1);
    $$localState$0bv32$2 := (if p3$2 then BV32_ADD(v30$2, v29$2) else $$localState$0bv32$2);
    ...
    call {:sourceloc_num 42} v33$1, v33$2 := $expf(p3$1, FADD32(FMUL32(FSUB32(v5$1 ++ v4$1 ++ v3$1 ++ v2$1, FMUL32(FMUL32(1056964608bv32, v9$1 ++ v8$1 ++ v7$1 ++ v6$1), v13$1 ++ v12$1 ++ v11$1 ++ v10$1)), v17$1 ++ v16$1 ++ v15$1 ++ v14$1), FMUL32(FP64_CONV32(FMUL64(FP32_CONV64(v21$1 ++ v20$1 ++ v19$1 ++ v18$1), FSQRT64(FP32_CONV64(v25$1 ++ v24$1 ++ v23$1 ++ v22$1)))), v32$1)), p3$2, FADD32(FMUL32(FSUB32(v5$2 ++ v4$2 ++ v3$2 ++ v2$2, FMUL32(FMUL32(1056964608bv32, v9$2 ++ v8$2 ++ v7$2 ++ v6$2), v13$2 ++ v12$2 ++ v11$2 ++ v10$2)), v17$2 ++ v16$2 ++ v15$2 ++ v14$2), FMUL32(FP64_CONV32(FMUL64(FP32_CONV64(v21$2 ++ v20$2 ++ v19$2 ++ v18$2), FSQRT64(FP32_CONV64(v25$2 ++ v24$2 ++ v23$2 ++ v22$2)))), v32$2)));
    ...
    $output.0$1, $s.0$1, $t.0$1 := (if p3$1 then BV32_ADD($output.0$1, $numSims) else $output.0$1), (if p3$1 then v34$1 else $s.0$1), (if p3$1 then BV32_ADD($t.0$1, 1bv32) else $t.0$1);
