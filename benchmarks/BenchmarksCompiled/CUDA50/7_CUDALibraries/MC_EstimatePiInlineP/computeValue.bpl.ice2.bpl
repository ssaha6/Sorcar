...
assert  my_inv (  (  BV32_SLE($s.i.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_SGE($s.i.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_ULE($s.i.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  BV32_UGE($s.i.0, BV32_UDIV(group_size_x, 2bv32)) ) ,  (  $s.i.0 == 0bv32 || BV32_AND($s.i.0, BV32_SUB($s.i.0, 1bv32)) == 0bv32 ) ,  (  $s.i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$sdata ) ,  (  !_WRITE_HAS_OCCURRED_$$sdata ) ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
