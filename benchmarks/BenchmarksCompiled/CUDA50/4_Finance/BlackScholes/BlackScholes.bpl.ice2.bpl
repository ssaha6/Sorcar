...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $opt.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $opt.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$2) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $opt.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $opt.0$2) ) ,  ( p0$1 ==> BV32_SLE($opt.0$1, v0$1) )  && ( p0$2 ==> BV32_SLE($opt.0$2, v0$2) ) ,  ( p0$1 ==> BV32_SGE($opt.0$1, v0$1) )  && ( p0$2 ==> BV32_SGE($opt.0$2, v0$2) ) ,  ( p0$1 ==> BV32_ULE($opt.0$1, v0$1) )  && ( p0$2 ==> BV32_ULE($opt.0$2, v0$2) ) ,  ( p0$1 ==> BV32_UGE($opt.0$1, v0$1) )  && ( p0$2 ==> BV32_UGE($opt.0$2, v0$2) ) ,  (  BV32_SLT($opt.0$1, $optN) ==> p0$1 )  && (  BV32_SLT($opt.0$2, $optN) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$d_CallResult ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) ) ,  (  _WRITE_HAS_OCCURRED_$$d_PutResult ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) )  ); 
