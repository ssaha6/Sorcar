...
implementation {:source_name "BlackScholesGPU"} {:kernel} $_Z15BlackScholesGPUPfS_S_S_S_ffi($Riskfree: bv32, $Volatility: bv32, $optN: bv32)
{
  ...
  $1:
    ...
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b5 ==> BV32_UGE($opt.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b5 ==> BV32_UGE($opt.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_ULE($opt.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_ULE($opt.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_SGE($opt.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_SGE($opt.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SLE($opt.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SLE($opt.0$2, v0$2);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $opt.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $opt.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$2);
    assert {:block_sourceloc} {:sourceloc_num 2} p0$1 ==> true;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} p0$1 ==> (if BV32_SREM($opt.0$1, v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 2} p0$2 ==> (if BV32_SREM($opt.0$2, v1) == v0$2 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 4} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_CallResult ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 5} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_PutResult ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), v1) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    ...
    v8$1 := (if p1$1 then FDIV32(FADD32(v7$1, FMUL32(FADD32($Riskfree, FMUL32(FMUL32(1056964608bv32, $Volatility), $Volatility)), v5$1)), FMUL32($Volatility, v6$1)) else v8$1);
    v8$2 := (if p1$2 then FDIV32(FADD32(v7$2, FMUL32(FADD32($Riskfree, FMUL32(FMUL32(1056964608bv32, $Volatility), $Volatility)), v5$2)), FMUL32($Volatility, v6$2)) else v8$2);
    ...
    v11$1 := (if p1$1 then FDIV32(1065353216bv32, FADD32(1065353216bv32, FMUL32(1047344009bv32, v10$1))) else v11$1);
    v11$2 := (if p1$2 then FDIV32(1065353216bv32, FADD32(1065353216bv32, FMUL32(1047344009bv32, v10$2))) else v11$2);
    call {:sourceloc_num 12} v12$1, v12$2 := $__expf(p1$1, FMUL32(FMUL32(3204448256bv32, v8$1), v8$1), p1$2, FMUL32(FMUL32(3204448256bv32, v8$2), v8$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$__expf"} true;
    v13$1 := (if p1$1 then FMUL32(FMUL32(1053573674bv32, v12$1), FMUL32(v11$1, FADD32(1050904058bv32, FMUL32(v11$1, FADD32(3199635335bv32, FMUL32(v11$1, FADD32(1071908728bv32, FMUL32(v11$1, FADD32(3219726058bv32, FMUL32(v11$1, 1068123759bv32)))))))))) else v13$1);
    v13$2 := (if p1$2 then FMUL32(FMUL32(1053573674bv32, v12$2), FMUL32(v11$2, FADD32(1050904058bv32, FMUL32(v11$2, FADD32(3199635335bv32, FMUL32(v11$2, FADD32(1071908728bv32, FMUL32(v11$2, FADD32(3219726058bv32, FMUL32(v11$2, 1068123759bv32)))))))))) else v13$2);
    v14$1 := (if p1$1 then FLT32(0bv32, v8$1) else v14$1);
    v14$2 := (if p1$2 then FLT32(0bv32, v8$2) else v14$2);
    ...
    $cnd.i.i.0$1 := (if p3$1 then FSUB32(1065353216bv32, v13$1) else $cnd.i.i.0$1);
    $cnd.i.i.0$2 := (if p3$2 then FSUB32(1065353216bv32, v13$2) else $cnd.i.i.0$2);
    call {:sourceloc_num 15} v15$1, v15$2 := $fabsf(p1$1, v9$1, p1$2, v9$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$fabsf"} true;
    v16$1 := (if p1$1 then FDIV32(1065353216bv32, FADD32(1065353216bv32, FMUL32(1047344009bv32, v15$1))) else v16$1);
    v16$2 := (if p1$2 then FDIV32(1065353216bv32, FADD32(1065353216bv32, FMUL32(1047344009bv32, v15$2))) else v16$2);
    call {:sourceloc_num 16} v17$1, v17$2 := $__expf(p1$1, FMUL32(FMUL32(3204448256bv32, v9$1), v9$1), p1$2, FMUL32(FMUL32(3204448256bv32, v9$2), v9$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$__expf"} true;
    v18$1 := (if p1$1 then FMUL32(FMUL32(1053573674bv32, v17$1), FMUL32(v16$1, FADD32(1050904058bv32, FMUL32(v16$1, FADD32(3199635335bv32, FMUL32(v16$1, FADD32(1071908728bv32, FMUL32(v16$1, FADD32(3219726058bv32, FMUL32(v16$1, 1068123759bv32)))))))))) else v18$1);
    v18$2 := (if p1$2 then FMUL32(FMUL32(1053573674bv32, v17$2), FMUL32(v16$2, FADD32(1050904058bv32, FMUL32(v16$2, FADD32(3199635335bv32, FMUL32(v16$2, FADD32(1071908728bv32, FMUL32(v16$2, FADD32(3219726058bv32, FMUL32(v16$2, 1068123759bv32)))))))))) else v18$2);
    v19$1 := (if p1$1 then FLT32(0bv32, v9$1) else v19$1);
    v19$2 := (if p1$2 then FLT32(0bv32, v9$2) else v19$2);
