...
implementation {:source_name "binomialOptionsKernel"} {:kernel} $_Z21binomialOptionsKernelP13__TOptionDataPfS1_()
{
  ...
  $for.cond:
    ...
    assert {:tag "accessBreak"} _b27 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 2064bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b26 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_AND(BV32_SUB(256bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(256bv32, 1bv32), BV32_ADD(local_id_x$1, BV32_MUL(group_id_x$1, 2064bv32)));
    assert {:tag "accessUpperBoundBlock"} _b25 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 2064bv32));
    assert {:tag "accessLowerBoundBlock"} _b24 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLE(BV32_MUL(group_id_x$1, 2064bv32), _WATCHED_OFFSET);
    ...
    $cond.i$1 := (if p3$1 then v8$1 else $cond.i$1);
    $cond.i$2 := (if p3$2 then v8$2 else $cond.i$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$d_CallBuffer(p1$1, BV32_ADD(v0$1, $i.0$1), $cond.i$1, $$d_CallBuffer[BV32_ADD(v0$1, $i.0$1)]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$d_CallBuffer(p1$2, BV32_ADD(v0$2, $i.0$2), $cond.i$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_CallBuffer"} true;
    $$d_CallBuffer[BV32_ADD(v0$1, $i.0$1)] := (if p1$1 then $cond.i$1 else $$d_CallBuffer[BV32_ADD(v0$1, $i.0$1)]);
    $$d_CallBuffer[BV32_ADD(v0$2, $i.0$2)] := (if p1$2 then $cond.i$2 else $$d_CallBuffer[BV32_ADD(v0$2, $i.0$2)]);
  ...
  $for.cond.13:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b45 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b44 ==> _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, 1bv32) || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b43 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "noread"} _b42 ==> !_READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b41 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b40 ==> _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b39 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA;
    assert {:tag "noread"} _b38 ==> !_READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA;
    assert {:tag "accessBreak"} _b37 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 2064bv32);
    assert {:tag "accessBreak"} _b36 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 2064bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b35 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_AND(BV32_SUB(224bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(224bv32, 1bv32), BV32_ADD(BV32_ADD(0bv32, local_id_x$1), BV32_MUL(group_id_x$1, 2064bv32)));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b34 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_AND(BV32_SUB(224bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(224bv32, 1bv32), BV32_ADD(BV32_ADD(0bv32, local_id_x$1), BV32_MUL(group_id_x$1, 2064bv32)));
    assert {:tag "accessUpperBoundBlock"} _b33 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 2064bv32));
    assert {:tag "accessLowerBoundBlock"} _b32 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLE(BV32_MUL(group_id_x$1, 2064bv32), _WATCHED_OFFSET);
    assert {:tag "accessUpperBoundBlock"} _b31 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 2064bv32));
    assert {:tag "accessLowerBoundBlock"} _b30 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLE(BV32_MUL(group_id_x$1, 2064bv32), _WATCHED_OFFSET);
    assert {:tag "nowrite"} _b29 ==> !_WRITE_HAS_OCCURRED_$$d_CallBuffer;
    assert {:tag "noread"} _b28 ==> !_READ_HAS_OCCURRED_$$d_CallBuffer;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_UGE($i12.0, 2048bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_ULE($i12.0, 2048bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SGE($i12.0, 2048bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_SLE($i12.0, 2048bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b7 ==> BV32_SLE(0bv32, $i12.0);
  ...
  $for.cond.16:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b63 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b62 ==> _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, 1bv32) || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b61 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "noread"} _b60 ==> !_READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b59 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b58 ==> _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b57 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA;
    assert {:tag "noread"} _b56 ==> !_READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA;
    assert {:tag "accessBreak"} _b55 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 2064bv32);
    assert {:tag "accessBreak"} _b54 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 2064bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b53 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_AND(BV32_SUB(224bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(224bv32, 1bv32), BV32_ADD(BV32_ADD(0bv32, local_id_x$1), BV32_MUL(group_id_x$1, 2064bv32)));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b52 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_AND(BV32_SUB(224bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(224bv32, 1bv32), BV32_ADD(BV32_ADD(0bv32, local_id_x$1), BV32_MUL(group_id_x$1, 2064bv32)));
    assert {:tag "accessUpperBoundBlock"} _b51 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 2064bv32));
    assert {:tag "accessLowerBoundBlock"} _b50 ==> _WRITE_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLE(BV32_MUL(group_id_x$1, 2064bv32), _WATCHED_OFFSET);
    assert {:tag "accessUpperBoundBlock"} _b49 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 2064bv32));
    assert {:tag "accessLowerBoundBlock"} _b48 ==> _READ_HAS_OCCURRED_$$d_CallBuffer ==> BV32_SLE(BV32_MUL(group_id_x$1, 2064bv32), _WATCHED_OFFSET);
    assert {:tag "nowrite"} _b47 ==> !_WRITE_HAS_OCCURRED_$$d_CallBuffer;
    assert {:tag "noread"} _b46 ==> !_READ_HAS_OCCURRED_$$d_CallBuffer;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  __partitioned_block_$cond.end_1:
    ...
    v14$1 := BV32_SLE(local_id_x$1, $cond);
    v14$2 := BV32_SLE(local_id_x$2, $cond);
  ...
  $for.cond.27:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b68 ==> _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, 1bv32) || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b67 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "noread"} _b66 ==> !_READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b65 ==> _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b64 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21binomialOptionsKernelP13__TOptionDataPfS1_E5callA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
