...
implementation {:source_name "inverseCNDKernel"} {:kernel} $_Z16inverseCNDKernelPfPjj($pathN: bv32)
{
  ...
  $2:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b14 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos.0$1, $pathN) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b14 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos.0$2, $pathN) ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p0$1 ==> _b13 ==> p0$1 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p0$2 ==> _b13 ==> p0$2 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b12 ==> BV32_UGE($pos.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b12 ==> BV32_UGE($pos.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b11 ==> BV32_ULE($pos.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b11 ==> BV32_ULE($pos.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b10 ==> BV32_SGE($pos.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b10 ==> BV32_SGE($pos.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b9 ==> BV32_SLE($pos.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b9 ==> BV32_SLE($pos.0$2, v0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b8 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b8 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$2);
