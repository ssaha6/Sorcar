...
implementation {:source_name "testKernel"} {:kernel} $_Z10testKernelPi()
{
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 1} _LOG_ATOMIC_$$g_odata(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 1} _CHECK_ATOMIC_$$g_odata(true, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 2} _LOG_ATOMIC_$$g_odata(true, 1bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 2} _CHECK_ATOMIC_$$g_odata(true, 1bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v2$1, v2$2;
    call {:sourceloc} {:sourceloc_num 3} _LOG_ATOMIC_$$g_odata(true, 2bv32);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 3} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 3} _CHECK_ATOMIC_$$g_odata(true, 2bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v3$1, v3$2;
    call {:sourceloc} {:sourceloc_num 4} _LOG_ATOMIC_$$g_odata(true, 3bv32);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 4} _CHECK_ATOMIC_$$g_odata(true, 3bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v4$1, v4$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_ATOMIC_$$g_odata(true, 4bv32);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 5} _CHECK_ATOMIC_$$g_odata(true, 4bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v5$1, v5$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_ATOMIC_$$g_odata(true, 5bv32);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 6} _CHECK_ATOMIC_$$g_odata(true, 5bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v6$1, v6$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_ATOMIC_$$g_odata(true, 6bv32);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 7} _CHECK_ATOMIC_$$g_odata(true, 6bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v7$1, v7$2;
    call {:sourceloc} {:sourceloc_num 8} _LOG_ATOMIC_$$g_odata(true, 7bv32);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 8} _CHECK_ATOMIC_$$g_odata(true, 7bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v8$1, v8$2;
    call {:sourceloc} {:sourceloc_num 9} _LOG_ATOMIC_$$g_odata(true, 8bv32);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 9} _CHECK_ATOMIC_$$g_odata(true, 8bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v9$1, v9$2;
    call {:sourceloc} {:sourceloc_num 10} _LOG_ATOMIC_$$g_odata(true, 9bv32);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 10} _CHECK_ATOMIC_$$g_odata(true, 9bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v10$1, v10$2;
    call {:sourceloc} {:sourceloc_num 11} _LOG_ATOMIC_$$g_odata(true, 10bv32);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 11} _CHECK_ATOMIC_$$g_odata(true, 10bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$g_odata"} true;
    havoc v11$1, v11$2;
    return;
}
