...
assert  my_inv (  (  BV32_SLE($face.0, 0bv32) ) ,  (  BV32_SGE($face.0, 0bv32) ) ,  (  BV32_ULE($face.0, 0bv32) ) ,  (  BV32_UGE($face.0, 0bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), $width), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(0bv32, $width), $width), BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), $width)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), group_size_y), BV32_DIV(local_id_y$1, group_size_y)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $width), group_size_y)) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_MUL(group_id_y$1, group_size_y)), BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $width)) ) ,  (  _WRITE_HAS_OCCURRED_$$g_odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $width), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(local_id_y$1, $width), group_size_x)) )  ); 
