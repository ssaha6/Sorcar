...
implementation {:source_name "matrixMulCUDA<32>"} {:kernel} $_Z13matrixMulCUDAILi32EEvPfS0_S0_ii($wA: bv32, $wB: bv32)
{
  ...
  __partitioned_block_$for.cond_0:
    ...
    assert {:tag "nowrite"} _b37 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs;
    assert {:tag "noread"} _b36 ==> !_READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs;
    assert {:tag "accessBreak"} _b35 ==> _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    ...
    assert {:tag "predicatedEquality"} _b22 ==> p0$1 && p0$2 ==> $a.0$1 == $a.0$2;
    assert {:tag "predicatedEquality"} _b21 ==> p0$1 && p0$2 ==> $Csub.0$1 == $Csub.0$2;
    assert {:tag "loopPredicateEquality"} _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b19 ==> p0$1 == p0$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b9 ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b9 ==> BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32)) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b8 ==> BV32_UGE($a.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b8 ==> BV32_UGE($a.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b7 ==> BV32_ULE($a.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b7 ==> BV32_ULE($a.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b6 ==> BV32_SGE($a.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b6 ==> BV32_SGE($a.0$2, v0$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b5 ==> BV32_SLE($a.0$1, v0$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b5 ==> BV32_SLE($a.0$2, v0$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p0$1 ==> _b4 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($a.0$1, v0$1) == BV32_SUB($a.0$2, v0$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p0$2 ==> _b4 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($a.0$2, v0$2) == BV32_SUB($a.0$1, v0$1);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p0$1 ==> _b3 ==> BV32_SUB($a.0$1, v0$1) == BV32_SUB($a.0$2, v0$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p0$2 ==> _b3 ==> BV32_SUB($a.0$2, v0$2) == BV32_SUB($a.0$1, v0$1);
    assert {:tag "guardNonNeg"} {:thread 1} p0$1 ==> _b2 ==> BV32_SLE(0bv32, $a.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p0$2 ==> _b2 ==> BV32_SLE(0bv32, $a.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b1 ==> BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), $b.0$1) == BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), BV32_MUL(32bv32, group_id_x$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b1 ==> BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), $b.0$2) == BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), BV32_MUL(32bv32, group_id_x$2));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $a.0$1) == BV32_AND(BV32_SUB(32bv32, 1bv32), v0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $a.0$2) == BV32_AND(BV32_SUB(32bv32, 1bv32), v0$2);
  ...
  $for.cond.17:
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) && BV32_SLT($k.0$1, 32bv32) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32)) && BV32_SLT($k.0$2, 32bv32) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b15 ==> p2$1 ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b15 ==> p2$2 ==> BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b14 ==> BV32_UGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b14 ==> BV32_UGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b13 ==> BV32_ULE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b13 ==> BV32_ULE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b12 ==> BV32_SGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b12 ==> BV32_SGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b11 ==> BV32_SLE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b11 ==> BV32_SLE($k.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p2$1 ==> _b10 ==> BV32_SLE(0bv32, $k.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p2$2 ==> _b10 ==> BV32_SLE(0bv32, $k.0$2);
