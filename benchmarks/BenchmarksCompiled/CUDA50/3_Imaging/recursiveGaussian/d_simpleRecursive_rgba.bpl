...
implementation {:source_name "d_simpleRecursive_rgba"} {:kernel} $_Z22d_simpleRecursive_rgbaPjS_iif($w: bv32, $h: bv32, $a: bv32)
{
  ...
  $for.cond.23:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b27 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$od$ghost$$for.cond.23 == _WRITE_HAS_OCCURRED_$$od;
    assert {:tag "disabledMaintainsInstrumentation"} _b26 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$od$ghost$$for.cond.23 == _READ_HAS_OCCURRED_$$od;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b19 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w) && BV32_SGE($y22.0$1, 0bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b19 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $w) && BV32_SGE($y22.0$2, 0bv32) ==> p4$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b17 ==> BV32_UGE($y22.0$1, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b17 ==> BV32_UGE($y22.0$2, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b16 ==> BV32_ULE($y22.0$1, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b16 ==> BV32_ULE($y22.0$2, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b15 ==> BV32_SGE($y22.0$1, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b15 ==> BV32_SGE($y22.0$2, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b14 ==> BV32_SLE($y22.0$1, BV32_SUB($h, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b14 ==> BV32_SLE($y22.0$2, BV32_SUB($h, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} p4$1 ==> _b13 ==> BV32_SLE(0bv32, $y22.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p4$2 ==> _b13 ==> BV32_SLE(0bv32, $y22.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b12 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y22.0$1) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($h, 1bv32));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b12 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y22.0$2) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($h, 1bv32));
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b10 ==> BV32_AND(BV32_SUB(BV32_SUB(0bv32, $w), 1bv32), $id.addr.1$1) == BV32_AND(BV32_SUB(BV32_SUB(0bv32, $w), 1bv32), BV32_ADD($id.addr.0$1, v113$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b10 ==> BV32_AND(BV32_SUB(BV32_SUB(0bv32, $w), 1bv32), $id.addr.1$2) == BV32_AND(BV32_SUB(BV32_SUB(0bv32, $w), 1bv32), BV32_ADD($id.addr.0$2, v113$2));
