...
assert  my_inv (  (  BV32_SLE($stride.0, 128bv32) ) ,  (  BV32_SGE($stride.0, 128bv32) ) ,  (  BV32_ULE($stride.0, 128bv32) ) ,  (  BV32_UGE($stride.0, 128bv32) ) ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ) ,  (  _READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
