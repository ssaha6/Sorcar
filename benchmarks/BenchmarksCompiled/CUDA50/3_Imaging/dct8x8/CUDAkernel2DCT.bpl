...
implementation {:source_name "CUDAkernel2DCT"} {:kernel} $_Z14CUDAkernel2DCTPfS_i($ImgStride: bv32)
{
  ...
  $truebb0:
    assume {:partition} v65;
    call _PRE_WARP_SYNC_$$_ZZ14CUDAkernel2DCTPfS_iE5block_READ(true, true);
    call {:sourceloc} {:sourceloc_num 58} _LOG_READ_$$_ZZ14CUDAkernel2DCTPfS_iE5block(true, BV32_ADD(BV32_ADD(v4$1, v0$1), BV32_MUL($i27.0, 33bv32)), $$_ZZ14CUDAkernel2DCTPfS_iE5block[1bv1][BV32_ADD(BV32_ADD(v4$1, v0$1), BV32_MUL($i27.0, 33bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_48"} {:captureState "check_state_48"} {:sourceloc} {:sourceloc_num 58} true;
    call {:check_id "check_state_48"} {:sourceloc} {:sourceloc_num 58} _CHECK_READ_$$_ZZ14CUDAkernel2DCTPfS_iE5block(true, BV32_ADD(BV32_ADD(v4$2, v0$2), BV32_MUL($i27.0, 33bv32)), $$_ZZ14CUDAkernel2DCTPfS_iE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v4$2, v0$2), BV32_MUL($i27.0, 33bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ14CUDAkernel2DCTPfS_iE5block"} true;
    call _POST_WARP_SYNC_$$_ZZ14CUDAkernel2DCTPfS_iE5block_READ(true, true);
    v66$1 := $$_ZZ14CUDAkernel2DCTPfS_iE5block[1bv1][BV32_ADD(BV32_ADD(v4$1, v0$1), BV32_MUL($i27.0, 33bv32))];
    v66$2 := $$_ZZ14CUDAkernel2DCTPfS_iE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v4$2, v0$2), BV32_MUL($i27.0, 33bv32))];
    call _PRE_WARP_SYNC_$$dst_WRITE(true, true);
    call {:sourceloc} {:sourceloc_num 59} _LOG_WRITE_$$dst(true, BV32_ADD(v3$1, BV32_MUL($i27.0, $ImgStride)), v66$1, $$dst[BV32_ADD(v3$1, BV32_MUL($i27.0, $ImgStride))]);
    ...
    call {:check_id "check_state_49"} {:sourceloc} {:sourceloc_num 59} _CHECK_WRITE_$$dst(true, BV32_ADD(v3$2, BV32_MUL($i27.0, $ImgStride)), v66$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    call _POST_WARP_SYNC_$$dst_WRITE(true, true);
    $$dst[BV32_ADD(v3$1, BV32_MUL($i27.0, $ImgStride))] := v66$1;
    $$dst[BV32_ADD(v3$2, BV32_MUL($i27.0, $ImgStride))] := v66$2;
