...
implementation {:source_name "CUDAkernel1DCT"} {:kernel} $_Z14CUDAkernel1DCTPfiii($ImgWidth: bv32, $OffsetXBlocks: bv32, $OffsetYBlocks: bv32)
{
  ...
  $1:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> BV32_AND(BV32_SUB(8bv32, 1bv32), $CurBlockLocal1Index.0$1) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b1 ==> BV32_AND(BV32_SUB(8bv32, 1bv32), $CurBlockLocal1Index.0$2) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.0$1) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_y$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.0$2) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_y$2);
  ...
  $5:
    ...
    assert {:tag "pow2NotZero"} _b14 ==> $CurBlockLocal2Index.0$1 != 0bv32;
    assert {:tag "pow2"} _b13 ==> $CurBlockLocal2Index.0$1 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
