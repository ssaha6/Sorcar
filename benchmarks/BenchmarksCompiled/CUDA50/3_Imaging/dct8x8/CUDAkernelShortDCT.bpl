...
implementation {:source_name "CUDAkernelShortDCT"} {:kernel} $_Z18CUDAkernelShortDCTPsi($ImgStride: bv32)
{
  ...
  var _WRITE_HAS_OCCURRED_$$_ZZ18CUDAkernelShortDCTPsiE5block$ghost$$for.cond: bool;
  ...
  $entry:
    ...
    _WRITE_HAS_OCCURRED_$$_ZZ18CUDAkernelShortDCTPsiE5block$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$_ZZ18CUDAkernelShortDCTPsiE5block;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond;

  $for.cond:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b21 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ18CUDAkernelShortDCTPsiE5block$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$_ZZ18CUDAkernelShortDCTPsiE5block;
  ...
  $for.cond.81:
    ...
    v142$1 := (if p6$1 then $$_ZZ18CUDAkernelShortDCTPsiE5block[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$1, 34bv32), BV32_MUL(v0$1, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$1, 17bv32), 4bv32))] else v142$1);
    v142$2 := (if p6$2 then $$_ZZ18CUDAkernelShortDCTPsiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$2, 34bv32), BV32_MUL(v0$2, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$2, 17bv32), 4bv32))] else v142$2);
    assume {:do_not_predicate} {:check_id "check_state_65"} {:captureState "check_state_65"} {:sourceloc} {:sourceloc_num 157} true;
    v143$1 := (if p6$1 then $$_ZZ18CUDAkernelShortDCTPsiE5block[1bv1][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$1, 34bv32), BV32_MUL(v0$1, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$1, 17bv32), 4bv32)), 1bv32)] else v143$1);
    v143$2 := (if p6$2 then $$_ZZ18CUDAkernelShortDCTPsiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$2, 34bv32), BV32_MUL(v0$2, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$2, 17bv32), 4bv32)), 1bv32)] else v143$2);
    assume {:do_not_predicate} {:check_id "check_state_66"} {:captureState "check_state_66"} {:sourceloc} {:sourceloc_num 158} true;
    v144$1 := (if p6$1 then $$_ZZ18CUDAkernelShortDCTPsiE5block[1bv1][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$1, 34bv32), BV32_MUL(v0$1, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$1, 17bv32), 4bv32)), 2bv32)] else v144$1);
    v144$2 := (if p6$2 then $$_ZZ18CUDAkernelShortDCTPsiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$2, 34bv32), BV32_MUL(v0$2, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$2, 17bv32), 4bv32)), 2bv32)] else v144$2);
    assume {:do_not_predicate} {:check_id "check_state_67"} {:captureState "check_state_67"} {:sourceloc} {:sourceloc_num 159} true;
    v145$1 := (if p6$1 then $$_ZZ18CUDAkernelShortDCTPsiE5block[1bv1][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$1, 34bv32), BV32_MUL(v0$1, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$1, 17bv32), 4bv32)), 3bv32)] else v145$1);
    v145$2 := (if p6$2 then $$_ZZ18CUDAkernelShortDCTPsiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v1$2, 34bv32), BV32_MUL(v0$2, 2bv32)), 2bv32), BV32_MUL(BV32_MUL($i80.0$2, 17bv32), 4bv32)), 3bv32)] else v145$2);
