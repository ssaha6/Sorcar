...
assert  my_inv (  (  BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.0$1) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_y$1) )  && (  BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.0$2) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_y$2) ) ,  (  BV32_AND(BV32_SUB(8bv32, 1bv32), $CurBlockLocal1Index.0$1) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$1) )  && (  BV32_AND(BV32_SUB(8bv32, 1bv32), $CurBlockLocal1Index.0$2) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$2) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.1$1) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$1) )  && (  BV32_AND(BV32_SUB(8bv32, 1bv32), $DCTv8matrixIndex.1$2) == BV32_AND(BV32_SUB(8bv32, 1bv32), local_id_x$2) ) ,  (  BV32_SLE(0bv32, $i1.0) ) ,  (  BV32_SLE($i1.0, 0bv32) ) ,  (  BV32_SGE($i1.0, 0bv32) ) ,  (  BV32_ULE($i1.0, 0bv32) ) ,  (  BV32_UGE($i1.0, 0bv32) ) ,  (  $CurBlockLocal2Index.0$1 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1bv32)) == 0bv32 ) ,  (  $CurBlockLocal2Index.0$1 != 0bv32 ) ,  (  $CurBlockLocal2Index.0$2 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1bv32)) == 0bv32 ) ,  (  $CurBlockLocal2Index.0$2 != 0bv32 )  ); 
