...
implementation {:source_name "convolutionRowsKernel"} {:kernel} $_Z21convolutionRowsKernelPfS_iii($imageW: bv32, $imageH: bv32, $pitch: bv32)
{
  ...
  $for.cond.16:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($i15.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($i15.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($i15.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($i15.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $i15.0);
    assert {:block_sourceloc} {:sourceloc_num 8} true;
    v6 := BV32_SLT($i15.0, 1bv32);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  $for.cond.32:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($i31.0, 9bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($i31.0, 9bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($i31.0, 9bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($i31.0, 9bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b10 ==> BV32_SLE(0bv32, $i31.0);
    assert {:block_sourceloc} {:sourceloc_num 17} true;
    v9 := BV32_SLT($i31.0, 10bv32);
    p2$1 := false;
    p2$2 := false;
    p3$1 := false;
    p3$2 := false;
  ...
  $for.cond.52:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_UGE($i51.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_ULE($i51.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SGE($i51.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SLE($i51.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b15 ==> BV32_SLE(0bv32, $i51.0);
    assert {:block_sourceloc} {:sourceloc_num 27} true;
    assert {:originated_from_invariant} {:sourceloc_num 28} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_Dst ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(BV32_MUL(v1$1, $pitch), v0$1)), 16bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 29} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_Dst ==> BV32_UGE(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(BV32_MUL(v1$1, $pitch), v0$1)), 16bv32), 1bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 30} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_Dst ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(BV32_MUL(v1$1, $pitch), v0$1)), 16bv32), 9bv32) then 1bv1 else 0bv1) != 0bv1;
    v12 := BV32_SLT($i51.0, 9bv32);
  ...
  $falsebb5:
    ...
    call {:sourceloc} {:sourceloc_num 38} _LOG_WRITE_$$d_Dst(true, BV32_ADD(v3$1, BV32_MUL($i51.0, 16bv32)), $sum.0$1, $$d_Dst[BV32_ADD(v3$1, BV32_MUL($i51.0, 16bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(true, BV32_ADD(v3$2, BV32_MUL($i51.0, 16bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 38} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 38} _CHECK_WRITE_$$d_Dst(true, BV32_ADD(v3$2, BV32_MUL($i51.0, 16bv32)), $sum.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(v3$1, BV32_MUL($i51.0, 16bv32))] := $sum.0$1;
    $$d_Dst[BV32_ADD(v3$2, BV32_MUL($i51.0, 16bv32))] := $sum.0$2;
    $i51.0 := BV32_ADD($i51.0, 1bv32);
  ...
  $truebb5:
    ...
    v15$1 := $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(BV32_ADD(local_id_x$1, BV32_MUL($i51.0, 16bv32)), $j.0))];
    v15$2 := $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(BV32_ADD(local_id_x$2, BV32_MUL($i51.0, 16bv32)), $j.0))];
  ...
  $truebb2:
    assume {:partition} v9;
    v10$1 := BV32_SGT(BV32_SUB($imageW, v0$1), BV32_MUL($i31.0, 16bv32));
    v10$2 := BV32_SGT(BV32_SUB($imageW, v0$2), BV32_MUL($i31.0, 16bv32));
    ...
    $cond43$1 := (if p2$1 then 0bv32 else $cond43$1);
    $cond43$2 := (if p2$2 then 0bv32 else $cond43$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v11$1 := (if p3$1 then _HAVOC_bv32$1 else v11$1);
    v11$2 := (if p3$2 then _HAVOC_bv32$2 else v11$2);
    $cond43$1 := (if p3$1 then v11$1 else $cond43$1);
    $cond43$2 := (if p3$2 then v11$2 else $cond43$2);
    call {:sourceloc} {:sourceloc_num 23} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i31.0, 16bv32))), $cond43$1, $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i31.0, 16bv32)))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i31.0, 16bv32))));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 23} _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i31.0, 16bv32))), $cond43$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i31.0, 16bv32)))] := $cond43$1;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i31.0, 16bv32)))] := $cond43$2;
    $i31.0 := BV32_ADD($i31.0, 1bv32);
    assume {:captureState "loop_back_edge_state_2_0"} true;
    goto $for.cond.32;

  $truebb0:
    assume {:partition} v6;
    v7$1 := BV32_SGE(v0$1, BV32_MUL(BV32_SUB(0bv32, $i15.0), 16bv32));
    v7$2 := BV32_SGE(v0$2, BV32_MUL(BV32_SUB(0bv32, $i15.0), 16bv32));
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i15.0, 16bv32))), $cond$1, $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i15.0, 16bv32)))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i15.0, 16bv32))));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i15.0, 16bv32))), $cond$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i15.0, 16bv32)))] := $cond$1;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i15.0, 16bv32)))] := $cond$2;
    $i15.0 := BV32_ADD($i15.0, 1bv32);
