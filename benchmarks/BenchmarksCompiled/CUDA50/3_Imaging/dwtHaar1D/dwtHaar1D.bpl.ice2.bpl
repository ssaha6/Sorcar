...
assert  my_inv (  (  BV32_SLE($i.0, 1bv32) ) ,  (  BV32_SGE($i.0, 1bv32) ) ,  (  BV32_ULE($i.0, 1bv32) ) ,  (  BV32_UGE($i.0, 1bv32) ) ,  (  BV32_SLE($num_threads.0$1, BV32_ASHR($bdim, 1bv32)) )  && (  BV32_SLE($num_threads.0$2, BV32_ASHR($bdim, 1bv32)) ) ,  (  BV32_SGE($num_threads.0$1, BV32_ASHR($bdim, 1bv32)) )  && (  BV32_SGE($num_threads.0$2, BV32_ASHR($bdim, 1bv32)) ) ,  (  BV32_ULE($num_threads.0$1, BV32_ASHR($bdim, 1bv32)) )  && (  BV32_ULE($num_threads.0$2, BV32_ASHR($bdim, 1bv32)) ) ,  (  BV32_UGE($num_threads.0$1, BV32_ASHR($bdim, 1bv32)) )  && (  BV32_UGE($num_threads.0$2, BV32_ASHR($bdim, 1bv32)) ) ,  (  $offset_neighbor.0$1 == 0bv32 || BV32_AND($offset_neighbor.0$1, BV32_SUB($offset_neighbor.0$1, 1bv32)) == 0bv32 ) ,  (  $offset_neighbor.0$1 != 0bv32 ) ,  (  $offset_neighbor.0$2 == 0bv32 || BV32_AND($offset_neighbor.0$2, BV32_SUB($offset_neighbor.0$2, 1bv32)) == 0bv32 ) ,  (  $offset_neighbor.0$2 != 0bv32 ) ,  (  $num_threads.0$1 == 0bv32 || BV32_AND($num_threads.0$1, BV32_SUB($num_threads.0$1, 1bv32)) == 0bv32 ) ,  (  $num_threads.0$1 != 0bv32 ) ,  (  $num_threads.0$2 == 0bv32 || BV32_AND($num_threads.0$2, BV32_SUB($num_threads.0$2, 1bv32)) == 0bv32 ) ,  (  $num_threads.0$2 != 0bv32 ) ,  (  $idata0.0$1 == 0bv32 || BV32_AND($idata0.0$1, BV32_SUB($idata0.0$1, 1bv32)) == 0bv32 ) ,  (  $idata0.0$1 != 0bv32 ) ,  (  $idata0.0$2 == 0bv32 || BV32_AND($idata0.0$2, BV32_SUB($idata0.0$2, 1bv32)) == 0bv32 ) ,  (  $idata0.0$2 != 0bv32 ) ,  (  $offset_neighbor.1$1 == 0bv32 || BV32_AND($offset_neighbor.1$1, BV32_SUB($offset_neighbor.1$1, 1bv32)) == 0bv32 ) ,  (  $offset_neighbor.1$1 != 0bv32 ) ,  (  $offset_neighbor.1$2 == 0bv32 || BV32_AND($offset_neighbor.1$2, BV32_SUB($offset_neighbor.1$2, 1bv32)) == 0bv32 ) ,  (  $offset_neighbor.1$2 != 0bv32 ) ,  (  $num_threads.1$1 == 0bv32 || BV32_AND($num_threads.1$1, BV32_SUB($num_threads.1$1, 1bv32)) == 0bv32 ) ,  (  $num_threads.1$1 != 0bv32 ) ,  (  $num_threads.1$2 == 0bv32 || BV32_AND($num_threads.1$2, BV32_SUB($num_threads.1$2, 1bv32)) == 0bv32 ) ,  (  $num_threads.1$2 != 0bv32 ) ,  (  $idata0.1$1 == 0bv32 || BV32_AND($idata0.1$1, BV32_SUB($idata0.1$1, 1bv32)) == 0bv32 ) ,  (  $idata0.1$1 != 0bv32 ) ,  (  $idata0.1$2 == 0bv32 || BV32_AND($idata0.1$2, BV32_SUB($idata0.1$2, 1bv32)) == 0bv32 ) ,  (  $idata0.1$2 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$od ) ,  (  !_READ_HAS_OCCURRED_$$shared ) ,  (  !_WRITE_HAS_OCCURRED_$$shared )  ); 


    assert {:block_sourceloc} {:sourceloc_num 15} true;
    assert {:originated_from_invariant} {:sourceloc_num 16} {:thread 1} (if BV32_ULT(local_id_x$1, $num_threads.0$1) ==> $num_threads.0$1 == BV32_ASHR($bdim, $i.0) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 16} {:thread 2} (if BV32_ULT(local_id_x$2, $num_threads.0$2) ==> $num_threads.0$2 == BV32_ASHR($bdim, $i.0) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 17} {:thread 1} (if BV32_ULT(local_id_x$1, $num_threads.0$1) ==> $offset_neighbor.0$1 == BV32_SHL(1bv32, BV32_SUB($i.0, 1bv32)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 17} {:thread 2} (if BV32_ULT(local_id_x$2, $num_threads.0$2) ==> $offset_neighbor.0$2 == BV32_SHL(1bv32, BV32_SUB($i.0, 1bv32)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 18} {:thread 1} (if BV32_ULT(local_id_x$1, $num_threads.0$1) ==> $idata0.0$1 == BV32_SHL(local_id_x$1, $i.0) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 18} {:thread 2} (if BV32_ULT(local_id_x$2, $num_threads.0$2) ==> $idata0.0$2 == BV32_SHL(local_id_x$2, $i.0) then 1bv1 else 0bv1) != 0bv1;
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_READ_$$shared(p2$1, 0bv32, $$shared[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 32} _CHECK_READ_$$shared(p2$2, 0bv32, $$shared[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
  ...
  __partitioned_block_$truebb0_0:
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 23} _CHECK_WRITE_$$od(p1$2, BV32_ADD(BV32_ADD(BV32_MUL($num_threads.0$2, num_groups_x), BV32_MUL(group_id_x$2, $num_threads.0$2)), local_id_x$2), FMUL32(FSUB32(v11$2, v12$2), 1060439283bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$od"} true;
    ...
    call {:sourceloc} {:sourceloc_num 26} _LOG_WRITE_$$shared(p1$1, v9$1, FMUL32(FADD32(v13$1, v14$1), 1060439283bv32), $$shared[1bv1][v9$1]);
    ...
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 26} _CHECK_WRITE_$$shared(p1$2, v9$2, FMUL32(FADD32(v13$2, v14$2), 1060439283bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$shared"} true;
  ...
  __partitioned_block_$truebb0_1:
    call {:sourceloc_num 28} $bugle_barrier_duplicated_3(1bv1, 1bv1);
