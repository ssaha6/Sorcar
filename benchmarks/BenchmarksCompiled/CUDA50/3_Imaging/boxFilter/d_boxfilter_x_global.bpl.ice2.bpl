...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $x2.i.0) ) ,  (  BV32_SLE($x2.i.0, BV32_ADD($r, 1bv32)) ) ,  (  BV32_SGE($x2.i.0, BV32_ADD($r, 1bv32)) ) ,  (  BV32_ULE($x2.i.0, BV32_ADD($r, 1bv32)) ) ,  (  BV32_UGE($x2.i.0, BV32_ADD($r, 1bv32)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$od ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1), $w)) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $w), group_size_x), BV32_DIV(local_id_x$1, group_size_x)) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $w), BV32_MUL(group_id_x$1, group_size_x)) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $x3.i.0) ) ,  (  BV32_SLE($x3.i.0, BV32_SUB($w, $r)) ) ,  (  BV32_SGE($x3.i.0, BV32_SUB($w, $r)) ) ,  (  BV32_ULE($x3.i.0, BV32_SUB($w, $r)) ) ,  (  BV32_UGE($x3.i.0, BV32_SUB($w, $r)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$od ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1), $w)) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $w), group_size_x), BV32_DIV(local_id_x$1, group_size_x)) ) ,  (  _WRITE_HAS_OCCURRED_$$od ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $w), BV32_MUL(group_id_x$1, group_size_x)) )  ); 
