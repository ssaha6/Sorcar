...
implementation {:source_name "d_boxfilter_y_tex"} {:kernel} $_Z17d_boxfilter_y_texPfiii($w: bv32, $h: bv32, $r: bv32)
{
  ...
  $for.cond.9:
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($y8.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($y8.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($y8.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($y8.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $y8.0);
  ...
  $truebb0:
    assume {:partition} v16;
    havoc v17$1, v17$2;
    $$agg.tmp12$0bv32$1 := v17$1;
    $$agg.tmp12$0bv32$2 := v17$2;
    havoc v18$1, v18$2;
    $$agg.tmp12$1bv32$1 := v18$1;
    $$agg.tmp12$1bv32$2 := v18$2;
    havoc v19$1, v19$2;
    $$agg.tmp12$2bv32$1 := v19$1;
    $$agg.tmp12$2bv32$2 := v19$2;
    havoc v20$1, v20$2;
    $$agg.tmp12$3bv32$1 := v20$1;
    $$agg.tmp12$3bv32$2 := v20$2;
    havoc v21$1, v21$2;
    $$agg.tmp12$4bv32$1 := v21$1;
    $$agg.tmp12$4bv32$2 := v21$2;
    havoc v22$1, v22$2;
    $$agg.tmp12$5bv32$1 := v22$1;
    $$agg.tmp12$5bv32$2 := v22$2;
    havoc v23$1, v23$2;
    $$agg.tmp12$6bv32$1 := v23$1;
    $$agg.tmp12$6bv32$2 := v23$2;
    havoc v24$1, v24$2;
    $$agg.tmp12$7bv32$1 := v24$1;
    $$agg.tmp12$7bv32$2 := v24$2;
    havoc v25$1, v25$2;
    $$agg.tmp12$8bv32$1 := v25$1;
    $$agg.tmp12$8bv32$2 := v25$2;
    havoc v26$1, v26$2;
    $$agg.tmp12$9bv32$1 := v26$1;
    $$agg.tmp12$9bv32$2 := v26$2;
    havoc v27$1, v27$2;
    $$agg.tmp12$10bv32$1 := v27$1;
    $$agg.tmp12$10bv32$2 := v27$2;
    havoc v28$1, v28$2;
    $$agg.tmp12$11bv32$1 := v28$1;
    $$agg.tmp12$11bv32$2 := v28$2;
    call {:sourceloc_num 59} v29$1, v29$2 := $_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp12, 0bv32), SI32_TO_FP32(BV32_ADD($y8.0, $r)), UI32_TO_FP32(v1$1), UI32_TO_FP32(v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc v30$1, v30$2;
    $$agg.tmp18$0bv32$1 := v30$1;
    $$agg.tmp18$0bv32$2 := v30$2;
    havoc v31$1, v31$2;
    $$agg.tmp18$1bv32$1 := v31$1;
    $$agg.tmp18$1bv32$2 := v31$2;
    havoc v32$1, v32$2;
    $$agg.tmp18$2bv32$1 := v32$1;
    $$agg.tmp18$2bv32$2 := v32$2;
    havoc v33$1, v33$2;
    $$agg.tmp18$3bv32$1 := v33$1;
    $$agg.tmp18$3bv32$2 := v33$2;
    havoc v34$1, v34$2;
    $$agg.tmp18$4bv32$1 := v34$1;
    $$agg.tmp18$4bv32$2 := v34$2;
    havoc v35$1, v35$2;
    $$agg.tmp18$5bv32$1 := v35$1;
    $$agg.tmp18$5bv32$2 := v35$2;
    havoc v36$1, v36$2;
    $$agg.tmp18$6bv32$1 := v36$1;
    $$agg.tmp18$6bv32$2 := v36$2;
    havoc v37$1, v37$2;
    $$agg.tmp18$7bv32$1 := v37$1;
    $$agg.tmp18$7bv32$2 := v37$2;
    havoc v38$1, v38$2;
    $$agg.tmp18$8bv32$1 := v38$1;
    $$agg.tmp18$8bv32$2 := v38$2;
    havoc v39$1, v39$2;
    $$agg.tmp18$9bv32$1 := v39$1;
    $$agg.tmp18$9bv32$2 := v39$2;
    havoc v40$1, v40$2;
    $$agg.tmp18$10bv32$1 := v40$1;
    $$agg.tmp18$10bv32$2 := v40$2;
    havoc v41$1, v41$2;
    $$agg.tmp18$11bv32$1 := v41$1;
    $$agg.tmp18$11bv32$2 := v41$2;
    call {:sourceloc_num 84} v42$1, v42$2 := $_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp18, 0bv32), SI32_TO_FP32(BV32_SUB(BV32_SUB($y8.0, $r), 1bv32)), UI32_TO_FP32(v1$1), UI32_TO_FP32(v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    v43$1 := FSUB32(FADD32($t.1$1, v29$1), v42$1);
    v43$2 := FSUB32(FADD32($t.1$2, v29$2), v42$2);
    call {:sourceloc} {:sourceloc_num 85} _LOG_WRITE_$$od(true, BV32_ADD(BV32_MUL($y8.0, $w), v1$1), FMUL32(v43$1, v0), $$od[BV32_ADD(BV32_MUL($y8.0, $w), v1$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$od(true, BV32_ADD(BV32_MUL($y8.0, $w), v1$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 85} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 85} _CHECK_WRITE_$$od(true, BV32_ADD(BV32_MUL($y8.0, $w), v1$2), FMUL32(v43$2, v0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$od"} true;
    $$od[BV32_ADD(BV32_MUL($y8.0, $w), v1$1)] := FMUL32(v43$1, v0);
    $$od[BV32_ADD(BV32_MUL($y8.0, $w), v1$2)] := FMUL32(v43$2, v0);
    $t.1$1, $y8.0 := v43$1, BV32_ADD($y8.0, 1bv32);
    $t.1$2 := v43$2;
  ...
  $truebb:
    ...
    call {:sourceloc_num 29} v15$1, v15$2 := $_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp, 0bv32), SI32_TO_FP32($y.0), UI32_TO_FP32(v1$1), UI32_TO_FP32(v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
...
var $$agg.tmp18$0bv32$1: bv8;

var $$agg.tmp18$0bv32$2: bv8;

var $$agg.tmp18$1bv32$1: bv8;

var $$agg.tmp18$1bv32$2: bv8;

var $$agg.tmp18$2bv32$1: bv8;

var $$agg.tmp18$2bv32$2: bv8;

var $$agg.tmp18$3bv32$1: bv8;

var $$agg.tmp18$3bv32$2: bv8;

var $$agg.tmp18$4bv32$1: bv8;

var $$agg.tmp18$4bv32$2: bv8;

var $$agg.tmp18$5bv32$1: bv8;

var $$agg.tmp18$5bv32$2: bv8;

var $$agg.tmp18$6bv32$1: bv8;

var $$agg.tmp18$6bv32$2: bv8;

var $$agg.tmp18$7bv32$1: bv8;

var $$agg.tmp18$7bv32$2: bv8;

var $$agg.tmp18$8bv32$1: bv8;

var $$agg.tmp18$8bv32$2: bv8;

var $$agg.tmp18$9bv32$1: bv8;

var $$agg.tmp18$9bv32$2: bv8;

var $$agg.tmp18$10bv32$1: bv8;

var $$agg.tmp18$10bv32$2: bv8;

var $$agg.tmp18$11bv32$1: bv8;

var $$agg.tmp18$11bv32$2: bv8;
