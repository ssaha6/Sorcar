...
implementation {:source_name "NLM2"} {:kernel} $_Z4NLM2Pjiiff($imageW: bv32, $imageH: bv32, $Noise: bv32, $lerpC: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.48: bool;
  var _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.51: bool;
  ...
  $for.cond.18:
    ...
    $$agg.tmp21$0bv32$1 := (if p5$1 then v8$1 else $$agg.tmp21$0bv32$1);
    $$agg.tmp21$0bv32$2 := (if p5$2 then v8$2 else $$agg.tmp21$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v9$1 := (if p5$1 then _HAVOC_bv8$1 else v9$1);
    v9$2 := (if p5$2 then _HAVOC_bv8$2 else v9$2);
    $$agg.tmp21$1bv32$1 := (if p5$1 then v9$1 else $$agg.tmp21$1bv32$1);
    $$agg.tmp21$1bv32$2 := (if p5$2 then v9$2 else $$agg.tmp21$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v10$1 := (if p5$1 then _HAVOC_bv8$1 else v10$1);
    v10$2 := (if p5$2 then _HAVOC_bv8$2 else v10$2);
    $$agg.tmp21$2bv32$1 := (if p5$1 then v10$1 else $$agg.tmp21$2bv32$1);
    $$agg.tmp21$2bv32$2 := (if p5$2 then v10$2 else $$agg.tmp21$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v11$1 := (if p5$1 then _HAVOC_bv8$1 else v11$1);
    v11$2 := (if p5$2 then _HAVOC_bv8$2 else v11$2);
    $$agg.tmp21$3bv32$1 := (if p5$1 then v11$1 else $$agg.tmp21$3bv32$1);
    $$agg.tmp21$3bv32$2 := (if p5$2 then v11$2 else $$agg.tmp21$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v12$1 := (if p5$1 then _HAVOC_bv8$1 else v12$1);
    v12$2 := (if p5$2 then _HAVOC_bv8$2 else v12$2);
    $$agg.tmp21$4bv32$1 := (if p5$1 then v12$1 else $$agg.tmp21$4bv32$1);
    $$agg.tmp21$4bv32$2 := (if p5$2 then v12$2 else $$agg.tmp21$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v13$1 := (if p5$1 then _HAVOC_bv8$1 else v13$1);
    v13$2 := (if p5$2 then _HAVOC_bv8$2 else v13$2);
    $$agg.tmp21$5bv32$1 := (if p5$1 then v13$1 else $$agg.tmp21$5bv32$1);
    $$agg.tmp21$5bv32$2 := (if p5$2 then v13$2 else $$agg.tmp21$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v14$1 := (if p5$1 then _HAVOC_bv8$1 else v14$1);
    v14$2 := (if p5$2 then _HAVOC_bv8$2 else v14$2);
    $$agg.tmp21$6bv32$1 := (if p5$1 then v14$1 else $$agg.tmp21$6bv32$1);
    $$agg.tmp21$6bv32$2 := (if p5$2 then v14$2 else $$agg.tmp21$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v15$1 := (if p5$1 then _HAVOC_bv8$1 else v15$1);
    v15$2 := (if p5$2 then _HAVOC_bv8$2 else v15$2);
    $$agg.tmp21$7bv32$1 := (if p5$1 then v15$1 else $$agg.tmp21$7bv32$1);
    $$agg.tmp21$7bv32$2 := (if p5$2 then v15$2 else $$agg.tmp21$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v16$1 := (if p5$1 then _HAVOC_bv8$1 else v16$1);
    v16$2 := (if p5$2 then _HAVOC_bv8$2 else v16$2);
    $$agg.tmp21$8bv32$1 := (if p5$1 then v16$1 else $$agg.tmp21$8bv32$1);
    $$agg.tmp21$8bv32$2 := (if p5$2 then v16$2 else $$agg.tmp21$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v17$1 := (if p5$1 then _HAVOC_bv8$1 else v17$1);
    v17$2 := (if p5$2 then _HAVOC_bv8$2 else v17$2);
    $$agg.tmp21$9bv32$1 := (if p5$1 then v17$1 else $$agg.tmp21$9bv32$1);
    $$agg.tmp21$9bv32$2 := (if p5$2 then v17$2 else $$agg.tmp21$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v18$1 := (if p5$1 then _HAVOC_bv8$1 else v18$1);
    v18$2 := (if p5$2 then _HAVOC_bv8$2 else v18$2);
    $$agg.tmp21$10bv32$1 := (if p5$1 then v18$1 else $$agg.tmp21$10bv32$1);
    $$agg.tmp21$10bv32$2 := (if p5$2 then v18$2 else $$agg.tmp21$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v19$1 := (if p5$1 then _HAVOC_bv8$1 else v19$1);
    v19$2 := (if p5$2 then _HAVOC_bv8$2 else v19$2);
    $$agg.tmp21$11bv32$1 := (if p5$1 then v19$1 else $$agg.tmp21$11bv32$1);
    $$agg.tmp21$11bv32$2 := (if p5$2 then v19$2 else $$agg.tmp21$11bv32$2);
    call {:sourceloc_num 33} v20$1, v20$2 := $_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff(MKPTR($arrayId$$agg.tmp21, 0bv32), p5$1, FADD32(FADD32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), 3bv32)), 1056964608bv32), $m.0$1), FADD32(FADD32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_size_x, group_id_y$1), 3bv32)), 1056964608bv32), $n.0$1), p5$2, FADD32(FADD32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), 3bv32)), 1056964608bv32), $m.0$2), FADD32(FADD32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_size_x, group_id_y$2), 3bv32)), 1056964608bv32), $n.0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff"} true;
    $$agg.tmp$0bv32$1 := (if p5$1 then v20$1[32:0] else $$agg.tmp$0bv32$1);
    $$agg.tmp$0bv32$2 := (if p5$2 then v20$2[32:0] else $$agg.tmp$0bv32$2);
    $$agg.tmp$1bv32$1 := (if p5$1 then v20$1[64:32] else $$agg.tmp$1bv32$1);
    $$agg.tmp$1bv32$2 := (if p5$2 then v20$2[64:32] else $$agg.tmp$1bv32$2);
    $$agg.tmp$2bv32$1 := (if p5$1 then v20$1[96:64] else $$agg.tmp$2bv32$1);
    $$agg.tmp$2bv32$2 := (if p5$2 then v20$2[96:64] else $$agg.tmp$2bv32$2);
    $$agg.tmp$3bv32$1 := (if p5$1 then v20$1[128:96] else $$agg.tmp$3bv32$1);
    $$agg.tmp$3bv32$2 := (if p5$2 then v20$2[128:96] else $$agg.tmp$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v21$1 := (if p5$1 then _HAVOC_bv8$1 else v21$1);
    v21$2 := (if p5$2 then _HAVOC_bv8$2 else v21$2);
    $$agg.tmp25$0bv32$1 := (if p5$1 then v21$1 else $$agg.tmp25$0bv32$1);
    $$agg.tmp25$0bv32$2 := (if p5$2 then v21$2 else $$agg.tmp25$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v22$1 := (if p5$1 then _HAVOC_bv8$1 else v22$1);
    v22$2 := (if p5$2 then _HAVOC_bv8$2 else v22$2);
    $$agg.tmp25$1bv32$1 := (if p5$1 then v22$1 else $$agg.tmp25$1bv32$1);
    $$agg.tmp25$1bv32$2 := (if p5$2 then v22$2 else $$agg.tmp25$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v23$1 := (if p5$1 then _HAVOC_bv8$1 else v23$1);
    v23$2 := (if p5$2 then _HAVOC_bv8$2 else v23$2);
    $$agg.tmp25$2bv32$1 := (if p5$1 then v23$1 else $$agg.tmp25$2bv32$1);
    $$agg.tmp25$2bv32$2 := (if p5$2 then v23$2 else $$agg.tmp25$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v24$1 := (if p5$1 then _HAVOC_bv8$1 else v24$1);
    v24$2 := (if p5$2 then _HAVOC_bv8$2 else v24$2);
    $$agg.tmp25$3bv32$1 := (if p5$1 then v24$1 else $$agg.tmp25$3bv32$1);
    $$agg.tmp25$3bv32$2 := (if p5$2 then v24$2 else $$agg.tmp25$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v25$1 := (if p5$1 then _HAVOC_bv8$1 else v25$1);
    v25$2 := (if p5$2 then _HAVOC_bv8$2 else v25$2);
    $$agg.tmp25$4bv32$1 := (if p5$1 then v25$1 else $$agg.tmp25$4bv32$1);
    $$agg.tmp25$4bv32$2 := (if p5$2 then v25$2 else $$agg.tmp25$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v26$1 := (if p5$1 then _HAVOC_bv8$1 else v26$1);
    v26$2 := (if p5$2 then _HAVOC_bv8$2 else v26$2);
    $$agg.tmp25$5bv32$1 := (if p5$1 then v26$1 else $$agg.tmp25$5bv32$1);
    $$agg.tmp25$5bv32$2 := (if p5$2 then v26$2 else $$agg.tmp25$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v27$1 := (if p5$1 then _HAVOC_bv8$1 else v27$1);
    v27$2 := (if p5$2 then _HAVOC_bv8$2 else v27$2);
    $$agg.tmp25$6bv32$1 := (if p5$1 then v27$1 else $$agg.tmp25$6bv32$1);
    $$agg.tmp25$6bv32$2 := (if p5$2 then v27$2 else $$agg.tmp25$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v28$1 := (if p5$1 then _HAVOC_bv8$1 else v28$1);
    v28$2 := (if p5$2 then _HAVOC_bv8$2 else v28$2);
    $$agg.tmp25$7bv32$1 := (if p5$1 then v28$1 else $$agg.tmp25$7bv32$1);
    $$agg.tmp25$7bv32$2 := (if p5$2 then v28$2 else $$agg.tmp25$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v29$1 := (if p5$1 then _HAVOC_bv8$1 else v29$1);
    v29$2 := (if p5$2 then _HAVOC_bv8$2 else v29$2);
    $$agg.tmp25$8bv32$1 := (if p5$1 then v29$1 else $$agg.tmp25$8bv32$1);
    $$agg.tmp25$8bv32$2 := (if p5$2 then v29$2 else $$agg.tmp25$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v30$1 := (if p5$1 then _HAVOC_bv8$1 else v30$1);
    v30$2 := (if p5$2 then _HAVOC_bv8$2 else v30$2);
    $$agg.tmp25$9bv32$1 := (if p5$1 then v30$1 else $$agg.tmp25$9bv32$1);
    $$agg.tmp25$9bv32$2 := (if p5$2 then v30$2 else $$agg.tmp25$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v31$1 := (if p5$1 then _HAVOC_bv8$1 else v31$1);
    v31$2 := (if p5$2 then _HAVOC_bv8$2 else v31$2);
    $$agg.tmp25$10bv32$1 := (if p5$1 then v31$1 else $$agg.tmp25$10bv32$1);
    $$agg.tmp25$10bv32$2 := (if p5$2 then v31$2 else $$agg.tmp25$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v32$1 := (if p5$1 then _HAVOC_bv8$1 else v32$1);
    v32$2 := (if p5$2 then _HAVOC_bv8$2 else v32$2);
    $$agg.tmp25$11bv32$1 := (if p5$1 then v32$1 else $$agg.tmp25$11bv32$1);
    $$agg.tmp25$11bv32$2 := (if p5$2 then v32$2 else $$agg.tmp25$11bv32$2);
    call {:sourceloc_num 62} v33$1, v33$2 := $_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff(MKPTR($arrayId$$agg.tmp25, 0bv32), p5$1, FADD32(v2$1, $m.0$1), FADD32(v3$1, $n.0$1), p5$2, FADD32(v2$2, $m.0$2), FADD32(v3$2, $n.0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff"} true;
    $$agg.tmp24$0bv32$1 := (if p5$1 then v33$1[32:0] else $$agg.tmp24$0bv32$1);
    $$agg.tmp24$0bv32$2 := (if p5$2 then v33$2[32:0] else $$agg.tmp24$0bv32$2);
    $$agg.tmp24$1bv32$1 := (if p5$1 then v33$1[64:32] else $$agg.tmp24$1bv32$1);
    $$agg.tmp24$1bv32$2 := (if p5$2 then v33$2[64:32] else $$agg.tmp24$1bv32$2);
    $$agg.tmp24$2bv32$1 := (if p5$1 then v33$1[96:64] else $$agg.tmp24$2bv32$1);
    $$agg.tmp24$2bv32$2 := (if p5$2 then v33$2[96:64] else $$agg.tmp24$2bv32$2);
    $$agg.tmp24$3bv32$1 := (if p5$1 then v33$1[128:96] else $$agg.tmp24$3bv32$1);
    $$agg.tmp24$3bv32$2 := (if p5$2 then v33$2[128:96] else $$agg.tmp24$3bv32$2);
    v34$1 := (if p5$1 then $$agg.tmp24$0bv32$1 else v34$1);
    v34$2 := (if p5$2 then $$agg.tmp24$0bv32$2 else v34$2);
    $$agg.tmp24111$0bv32$1 := (if p5$1 then v34$1 else $$agg.tmp24111$0bv32$1);
    $$agg.tmp24111$0bv32$2 := (if p5$2 then v34$2 else $$agg.tmp24111$0bv32$2);
    v35$1 := (if p5$1 then $$agg.tmp24$1bv32$1 else v35$1);
    v35$2 := (if p5$2 then $$agg.tmp24$1bv32$2 else v35$2);
    $$agg.tmp24111$1bv32$1 := (if p5$1 then v35$1 else $$agg.tmp24111$1bv32$1);
    $$agg.tmp24111$1bv32$2 := (if p5$2 then v35$2 else $$agg.tmp24111$1bv32$2);
    v36$1 := (if p5$1 then $$agg.tmp24$2bv32$1 else v36$1);
    v36$2 := (if p5$2 then $$agg.tmp24$2bv32$2 else v36$2);
    $$agg.tmp24111$2bv32$1 := (if p5$1 then v36$1 else $$agg.tmp24111$2bv32$1);
    $$agg.tmp24111$2bv32$2 := (if p5$2 then v36$2 else $$agg.tmp24111$2bv32$2);
    v37$1 := (if p5$1 then $$agg.tmp24$3bv32$1 else v37$1);
    v37$2 := (if p5$2 then $$agg.tmp24$3bv32$2 else v37$2);
    $$agg.tmp24111$3bv32$1 := (if p5$1 then v37$1 else $$agg.tmp24111$3bv32$1);
    $$agg.tmp24111$3bv32$2 := (if p5$2 then v37$2 else $$agg.tmp24111$3bv32$2);
    v38$1 := (if p5$1 then $$agg.tmp$0bv32$1 else v38$1);
    v38$2 := (if p5$2 then $$agg.tmp$0bv32$2 else v38$2);
    $$agg.tmp110$0bv32$1 := (if p5$1 then v38$1 else $$agg.tmp110$0bv32$1);
    $$agg.tmp110$0bv32$2 := (if p5$2 then v38$2 else $$agg.tmp110$0bv32$2);
    v39$1 := (if p5$1 then $$agg.tmp$1bv32$1 else v39$1);
    v39$2 := (if p5$2 then $$agg.tmp$1bv32$2 else v39$2);
    $$agg.tmp110$1bv32$1 := (if p5$1 then v39$1 else $$agg.tmp110$1bv32$1);
    $$agg.tmp110$1bv32$2 := (if p5$2 then v39$2 else $$agg.tmp110$1bv32$2);
    v40$1 := (if p5$1 then $$agg.tmp$2bv32$1 else v40$1);
    v40$2 := (if p5$2 then $$agg.tmp$2bv32$2 else v40$2);
    $$agg.tmp110$2bv32$1 := (if p5$1 then v40$1 else $$agg.tmp110$2bv32$1);
    $$agg.tmp110$2bv32$2 := (if p5$2 then v40$2 else $$agg.tmp110$2bv32$2);
    v41$1 := (if p5$1 then $$agg.tmp$3bv32$1 else v41$1);
    v41$2 := (if p5$2 then $$agg.tmp$3bv32$2 else v41$2);
    $$agg.tmp110$3bv32$1 := (if p5$1 then v41$1 else $$agg.tmp110$3bv32$1);
    $$agg.tmp110$3bv32$2 := (if p5$2 then v41$2 else $$agg.tmp110$3bv32$2);
    v42$1 := (if p5$1 then $$agg.tmp24111$0bv32$1 else v42$1);
    v42$2 := (if p5$2 then $$agg.tmp24111$0bv32$2 else v42$2);
    v43$1 := (if p5$1 then $$agg.tmp110$0bv32$1 else v43$1);
    v43$2 := (if p5$2 then $$agg.tmp110$0bv32$2 else v43$2);
    v44$1 := (if p5$1 then $$agg.tmp24111$0bv32$1 else v44$1);
    v44$2 := (if p5$2 then $$agg.tmp24111$0bv32$2 else v44$2);
    v45$1 := (if p5$1 then $$agg.tmp110$0bv32$1 else v45$1);
    v45$2 := (if p5$2 then $$agg.tmp110$0bv32$2 else v45$2);
    v46$1 := (if p5$1 then $$agg.tmp24111$1bv32$1 else v46$1);
    v46$2 := (if p5$2 then $$agg.tmp24111$1bv32$2 else v46$2);
    v47$1 := (if p5$1 then $$agg.tmp110$1bv32$1 else v47$1);
    v47$2 := (if p5$2 then $$agg.tmp110$1bv32$2 else v47$2);
    v48$1 := (if p5$1 then $$agg.tmp24111$1bv32$1 else v48$1);
    v48$2 := (if p5$2 then $$agg.tmp24111$1bv32$2 else v48$2);
    v49$1 := (if p5$1 then $$agg.tmp110$1bv32$1 else v49$1);
    v49$2 := (if p5$2 then $$agg.tmp110$1bv32$2 else v49$2);
    v50$1 := (if p5$1 then $$agg.tmp24111$2bv32$1 else v50$1);
    v50$2 := (if p5$2 then $$agg.tmp24111$2bv32$2 else v50$2);
    v51$1 := (if p5$1 then $$agg.tmp110$2bv32$1 else v51$1);
    v51$2 := (if p5$2 then $$agg.tmp110$2bv32$2 else v51$2);
    v52$1 := (if p5$1 then $$agg.tmp24111$2bv32$1 else v52$1);
    v52$2 := (if p5$2 then $$agg.tmp24111$2bv32$2 else v52$2);
    v53$1 := (if p5$1 then $$agg.tmp110$2bv32$1 else v53$1);
    v53$2 := (if p5$2 then $$agg.tmp110$2bv32$2 else v53$2);
    ...
    goto $for.cond.18.backedge, $for.cond.18.tail;
  ...
  __partitioned_block_$for.cond.tail_1:
    ...
    _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.48 := _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $for.cond.48;

  $for.cond.48:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b6 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.48 == _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.51 := _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.51;

  $for.cond.51:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b7 ==> !p7$1 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights$ghost$$for.cond.51 == _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p8$1 ==> p6$1;
    assert p8$2 ==> p6$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b5 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b4 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b3 ==> p8$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b3 ==> p8$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$2), local_id_y$2), $imageH);
    ...
    $$agg.tmp56$0bv32$1 := (if p9$1 then v58$1 else $$agg.tmp56$0bv32$1);
    $$agg.tmp56$0bv32$2 := (if p9$2 then v58$2 else $$agg.tmp56$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v59$1 := (if p9$1 then _HAVOC_bv8$1 else v59$1);
    v59$2 := (if p9$2 then _HAVOC_bv8$2 else v59$2);
    $$agg.tmp56$1bv32$1 := (if p9$1 then v59$1 else $$agg.tmp56$1bv32$1);
    $$agg.tmp56$1bv32$2 := (if p9$2 then v59$2 else $$agg.tmp56$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v60$1 := (if p9$1 then _HAVOC_bv8$1 else v60$1);
    v60$2 := (if p9$2 then _HAVOC_bv8$2 else v60$2);
    $$agg.tmp56$2bv32$1 := (if p9$1 then v60$1 else $$agg.tmp56$2bv32$1);
    $$agg.tmp56$2bv32$2 := (if p9$2 then v60$2 else $$agg.tmp56$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v61$1 := (if p9$1 then _HAVOC_bv8$1 else v61$1);
    v61$2 := (if p9$2 then _HAVOC_bv8$2 else v61$2);
    $$agg.tmp56$3bv32$1 := (if p9$1 then v61$1 else $$agg.tmp56$3bv32$1);
    $$agg.tmp56$3bv32$2 := (if p9$2 then v61$2 else $$agg.tmp56$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v62$1 := (if p9$1 then _HAVOC_bv8$1 else v62$1);
    v62$2 := (if p9$2 then _HAVOC_bv8$2 else v62$2);
    $$agg.tmp56$4bv32$1 := (if p9$1 then v62$1 else $$agg.tmp56$4bv32$1);
    $$agg.tmp56$4bv32$2 := (if p9$2 then v62$2 else $$agg.tmp56$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v63$1 := (if p9$1 then _HAVOC_bv8$1 else v63$1);
    v63$2 := (if p9$2 then _HAVOC_bv8$2 else v63$2);
    $$agg.tmp56$5bv32$1 := (if p9$1 then v63$1 else $$agg.tmp56$5bv32$1);
    $$agg.tmp56$5bv32$2 := (if p9$2 then v63$2 else $$agg.tmp56$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v64$1 := (if p9$1 then _HAVOC_bv8$1 else v64$1);
    v64$2 := (if p9$2 then _HAVOC_bv8$2 else v64$2);
    $$agg.tmp56$6bv32$1 := (if p9$1 then v64$1 else $$agg.tmp56$6bv32$1);
    $$agg.tmp56$6bv32$2 := (if p9$2 then v64$2 else $$agg.tmp56$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v65$1 := (if p9$1 then _HAVOC_bv8$1 else v65$1);
    v65$2 := (if p9$2 then _HAVOC_bv8$2 else v65$2);
    $$agg.tmp56$7bv32$1 := (if p9$1 then v65$1 else $$agg.tmp56$7bv32$1);
    $$agg.tmp56$7bv32$2 := (if p9$2 then v65$2 else $$agg.tmp56$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v66$1 := (if p9$1 then _HAVOC_bv8$1 else v66$1);
    v66$2 := (if p9$2 then _HAVOC_bv8$2 else v66$2);
    $$agg.tmp56$8bv32$1 := (if p9$1 then v66$1 else $$agg.tmp56$8bv32$1);
    $$agg.tmp56$8bv32$2 := (if p9$2 then v66$2 else $$agg.tmp56$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v67$1 := (if p9$1 then _HAVOC_bv8$1 else v67$1);
    v67$2 := (if p9$2 then _HAVOC_bv8$2 else v67$2);
    $$agg.tmp56$9bv32$1 := (if p9$1 then v67$1 else $$agg.tmp56$9bv32$1);
    $$agg.tmp56$9bv32$2 := (if p9$2 then v67$2 else $$agg.tmp56$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v68$1 := (if p9$1 then _HAVOC_bv8$1 else v68$1);
    v68$2 := (if p9$2 then _HAVOC_bv8$2 else v68$2);
    $$agg.tmp56$10bv32$1 := (if p9$1 then v68$1 else $$agg.tmp56$10bv32$1);
    $$agg.tmp56$10bv32$2 := (if p9$2 then v68$2 else $$agg.tmp56$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v69$1 := (if p9$1 then _HAVOC_bv8$1 else v69$1);
    v69$2 := (if p9$2 then _HAVOC_bv8$2 else v69$2);
    $$agg.tmp56$11bv32$1 := (if p9$1 then v69$1 else $$agg.tmp56$11bv32$1);
    $$agg.tmp56$11bv32$2 := (if p9$2 then v69$2 else $$agg.tmp56$11bv32$2);
    call {:sourceloc_num 134} v70$1, v70$2 := $_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff(MKPTR($arrayId$$agg.tmp56, 0bv32), p9$1, FADD32(v2$1, $j.0$1), FADD32(v3$1, $i.0$1), p9$2, FADD32(v2$2, $j.0$2), FADD32(v3$2, $i.0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff"} true;
    ...
    goto $for.cond.51.backedge, $for.cond.51.tail;
  ...
  $for.cond.48.tail:
    ...
    $cond88$1 := (if p10$1 then $lerpC else $cond88$1);
    $cond88$2 := (if p10$2 then $lerpC else $cond88$2);
    $cond88$1 := (if p11$1 then FSUB32(1065353216bv32, $lerpC) else $cond88$1);
    $cond88$2 := (if p11$2 then FSUB32(1065353216bv32, $lerpC) else $cond88$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v82$1 := (if p1$1 then _HAVOC_bv8$1 else v82$1);
    v82$2 := (if p1$2 then _HAVOC_bv8$2 else v82$2);
    $$agg.tmp89$0bv32$1 := (if p1$1 then v82$1 else $$agg.tmp89$0bv32$1);
    $$agg.tmp89$0bv32$2 := (if p1$2 then v82$2 else $$agg.tmp89$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v83$1 := (if p1$1 then _HAVOC_bv8$1 else v83$1);
    v83$2 := (if p1$2 then _HAVOC_bv8$2 else v83$2);
    $$agg.tmp89$1bv32$1 := (if p1$1 then v83$1 else $$agg.tmp89$1bv32$1);
    $$agg.tmp89$1bv32$2 := (if p1$2 then v83$2 else $$agg.tmp89$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v84$1 := (if p1$1 then _HAVOC_bv8$1 else v84$1);
    v84$2 := (if p1$2 then _HAVOC_bv8$2 else v84$2);
    $$agg.tmp89$2bv32$1 := (if p1$1 then v84$1 else $$agg.tmp89$2bv32$1);
    $$agg.tmp89$2bv32$2 := (if p1$2 then v84$2 else $$agg.tmp89$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v85$1 := (if p1$1 then _HAVOC_bv8$1 else v85$1);
    v85$2 := (if p1$2 then _HAVOC_bv8$2 else v85$2);
    $$agg.tmp89$3bv32$1 := (if p1$1 then v85$1 else $$agg.tmp89$3bv32$1);
    $$agg.tmp89$3bv32$2 := (if p1$2 then v85$2 else $$agg.tmp89$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v86$1 := (if p1$1 then _HAVOC_bv8$1 else v86$1);
    v86$2 := (if p1$2 then _HAVOC_bv8$2 else v86$2);
    $$agg.tmp89$4bv32$1 := (if p1$1 then v86$1 else $$agg.tmp89$4bv32$1);
    $$agg.tmp89$4bv32$2 := (if p1$2 then v86$2 else $$agg.tmp89$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v87$1 := (if p1$1 then _HAVOC_bv8$1 else v87$1);
    v87$2 := (if p1$2 then _HAVOC_bv8$2 else v87$2);
    $$agg.tmp89$5bv32$1 := (if p1$1 then v87$1 else $$agg.tmp89$5bv32$1);
    $$agg.tmp89$5bv32$2 := (if p1$2 then v87$2 else $$agg.tmp89$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v88$1 := (if p1$1 then _HAVOC_bv8$1 else v88$1);
    v88$2 := (if p1$2 then _HAVOC_bv8$2 else v88$2);
    $$agg.tmp89$6bv32$1 := (if p1$1 then v88$1 else $$agg.tmp89$6bv32$1);
    $$agg.tmp89$6bv32$2 := (if p1$2 then v88$2 else $$agg.tmp89$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v89$1 := (if p1$1 then _HAVOC_bv8$1 else v89$1);
    v89$2 := (if p1$2 then _HAVOC_bv8$2 else v89$2);
    $$agg.tmp89$7bv32$1 := (if p1$1 then v89$1 else $$agg.tmp89$7bv32$1);
    $$agg.tmp89$7bv32$2 := (if p1$2 then v89$2 else $$agg.tmp89$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v90$1 := (if p1$1 then _HAVOC_bv8$1 else v90$1);
    v90$2 := (if p1$2 then _HAVOC_bv8$2 else v90$2);
    $$agg.tmp89$8bv32$1 := (if p1$1 then v90$1 else $$agg.tmp89$8bv32$1);
    $$agg.tmp89$8bv32$2 := (if p1$2 then v90$2 else $$agg.tmp89$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v91$1 := (if p1$1 then _HAVOC_bv8$1 else v91$1);
    v91$2 := (if p1$2 then _HAVOC_bv8$2 else v91$2);
    $$agg.tmp89$9bv32$1 := (if p1$1 then v91$1 else $$agg.tmp89$9bv32$1);
    $$agg.tmp89$9bv32$2 := (if p1$2 then v91$2 else $$agg.tmp89$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v92$1 := (if p1$1 then _HAVOC_bv8$1 else v92$1);
    v92$2 := (if p1$2 then _HAVOC_bv8$2 else v92$2);
    $$agg.tmp89$10bv32$1 := (if p1$1 then v92$1 else $$agg.tmp89$10bv32$1);
    $$agg.tmp89$10bv32$2 := (if p1$2 then v92$2 else $$agg.tmp89$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v93$1 := (if p1$1 then _HAVOC_bv8$1 else v93$1);
    v93$2 := (if p1$2 then _HAVOC_bv8$2 else v93$2);
    $$agg.tmp89$11bv32$1 := (if p1$1 then v93$1 else $$agg.tmp89$11bv32$1);
    $$agg.tmp89$11bv32$2 := (if p1$2 then v93$2 else $$agg.tmp89$11bv32$2);
    call {:sourceloc_num 185} v94$1, v94$2 := $_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff(MKPTR($arrayId$$agg.tmp89, 0bv32), p1$1, v2$1, v3$1, p1$2, v2$2, v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2D7textureI6uchar4Li2EL19cudaTextureReadMode1EEff"} true;
    ...
    call {:sourceloc_num 192} v97$1, v97$2 := $_Z5lerpffff(p1$1, v95$1, v96$1, $cond88$1, p1$2, v95$2, v96$2, $cond88$2);
    ...
    call {:sourceloc_num 196} v100$1, v100$2 := $_Z5lerpffff(p1$1, v98$1, v99$1, $cond88$1, p1$2, v98$2, v99$2, $cond88$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5lerpffff"} true;
    ...
    call {:sourceloc_num 200} v103$1, v103$2 := $_Z5lerpffff(p1$1, v101$1, v102$1, $cond88$1, p1$2, v101$2, v102$2, $cond88$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5lerpffff"} true;
...
var $$agg.tmp24111$0bv32$1: bv32;

var $$agg.tmp24111$0bv32$2: bv32;

var $$agg.tmp24111$1bv32$1: bv32;

var $$agg.tmp24111$1bv32$2: bv32;

var $$agg.tmp24111$2bv32$1: bv32;

var $$agg.tmp24111$2bv32$2: bv32;

var $$agg.tmp24111$3bv32$1: bv32;

var $$agg.tmp24111$3bv32$2: bv32;

var $$agg.tmp110$0bv32$1: bv32;

var $$agg.tmp110$0bv32$2: bv32;

var $$agg.tmp110$1bv32$1: bv32;

var $$agg.tmp110$1bv32$2: bv32;

var $$agg.tmp110$2bv32$1: bv32;

var $$agg.tmp110$2bv32$2: bv32;

var $$agg.tmp110$3bv32$1: bv32;

var $$agg.tmp110$3bv32$2: bv32;
...
var $$agg.tmp21$0bv32$1: bv8;

var $$agg.tmp21$0bv32$2: bv8;

var $$agg.tmp21$1bv32$1: bv8;

var $$agg.tmp21$1bv32$2: bv8;

var $$agg.tmp21$2bv32$1: bv8;

var $$agg.tmp21$2bv32$2: bv8;

var $$agg.tmp21$3bv32$1: bv8;

var $$agg.tmp21$3bv32$2: bv8;

var $$agg.tmp21$4bv32$1: bv8;

var $$agg.tmp21$4bv32$2: bv8;

var $$agg.tmp21$5bv32$1: bv8;

var $$agg.tmp21$5bv32$2: bv8;

var $$agg.tmp21$6bv32$1: bv8;

var $$agg.tmp21$6bv32$2: bv8;

var $$agg.tmp21$7bv32$1: bv8;

var $$agg.tmp21$7bv32$2: bv8;

var $$agg.tmp21$8bv32$1: bv8;

var $$agg.tmp21$8bv32$2: bv8;

var $$agg.tmp21$9bv32$1: bv8;

var $$agg.tmp21$9bv32$2: bv8;

var $$agg.tmp21$10bv32$1: bv8;

var $$agg.tmp21$10bv32$2: bv8;

var $$agg.tmp21$11bv32$1: bv8;

var $$agg.tmp21$11bv32$2: bv8;
...
var $$agg.tmp56$0bv32$1: bv8;

var $$agg.tmp56$0bv32$2: bv8;

var $$agg.tmp56$1bv32$1: bv8;

var $$agg.tmp56$1bv32$2: bv8;

var $$agg.tmp56$2bv32$1: bv8;

var $$agg.tmp56$2bv32$2: bv8;

var $$agg.tmp56$3bv32$1: bv8;

var $$agg.tmp56$3bv32$2: bv8;

var $$agg.tmp56$4bv32$1: bv8;

var $$agg.tmp56$4bv32$2: bv8;

var $$agg.tmp56$5bv32$1: bv8;

var $$agg.tmp56$5bv32$2: bv8;

var $$agg.tmp56$6bv32$1: bv8;

var $$agg.tmp56$6bv32$2: bv8;

var $$agg.tmp56$7bv32$1: bv8;

var $$agg.tmp56$7bv32$2: bv8;

var $$agg.tmp56$8bv32$1: bv8;

var $$agg.tmp56$8bv32$2: bv8;

var $$agg.tmp56$9bv32$1: bv8;

var $$agg.tmp56$9bv32$2: bv8;

var $$agg.tmp56$10bv32$1: bv8;

var $$agg.tmp56$10bv32$2: bv8;

var $$agg.tmp56$11bv32$1: bv8;

var $$agg.tmp56$11bv32$2: bv8;
...
var $$agg.tmp89$0bv32$1: bv8;

var $$agg.tmp89$0bv32$2: bv8;

var $$agg.tmp89$1bv32$1: bv8;

var $$agg.tmp89$1bv32$2: bv8;

var $$agg.tmp89$2bv32$1: bv8;

var $$agg.tmp89$2bv32$2: bv8;

var $$agg.tmp89$3bv32$1: bv8;

var $$agg.tmp89$3bv32$2: bv8;

var $$agg.tmp89$4bv32$1: bv8;

var $$agg.tmp89$4bv32$2: bv8;

var $$agg.tmp89$5bv32$1: bv8;

var $$agg.tmp89$5bv32$2: bv8;

var $$agg.tmp89$6bv32$1: bv8;

var $$agg.tmp89$6bv32$2: bv8;

var $$agg.tmp89$7bv32$1: bv8;

var $$agg.tmp89$7bv32$2: bv8;

var $$agg.tmp89$8bv32$1: bv8;

var $$agg.tmp89$8bv32$2: bv8;

var $$agg.tmp89$9bv32$1: bv8;

var $$agg.tmp89$9bv32$2: bv8;

var $$agg.tmp89$10bv32$1: bv8;

var $$agg.tmp89$10bv32$2: bv8;

var $$agg.tmp89$11bv32$1: bv8;

var $$agg.tmp89$11bv32$2: bv8;
