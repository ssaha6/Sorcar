...
implementation {:source_name "SobelCopyImage"} {:kernel} $_Z14SobelCopyImagePhjiif($Pitch: bv32, $w: bv32, $h: bv32, $fscale: bv32)
{
  ...
  $for.cond:
    ...
    call {:sourceloc_num 31} v13$1, v13$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp, 0bv32), p1$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p1$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    ...
    $$agg.tmp15$0bv32$1 := (if p2$1 then v15$1 else $$agg.tmp15$0bv32$1);
    $$agg.tmp15$0bv32$2 := (if p2$2 then v15$2 else $$agg.tmp15$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v16$1 := (if p2$1 then _HAVOC_bv8$1 else v16$1);
    v16$2 := (if p2$2 then _HAVOC_bv8$2 else v16$2);
    $$agg.tmp15$1bv32$1 := (if p2$1 then v16$1 else $$agg.tmp15$1bv32$1);
    $$agg.tmp15$1bv32$2 := (if p2$2 then v16$2 else $$agg.tmp15$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v17$1 := (if p2$1 then _HAVOC_bv8$1 else v17$1);
    v17$2 := (if p2$2 then _HAVOC_bv8$2 else v17$2);
    $$agg.tmp15$2bv32$1 := (if p2$1 then v17$1 else $$agg.tmp15$2bv32$1);
    $$agg.tmp15$2bv32$2 := (if p2$2 then v17$2 else $$agg.tmp15$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v18$1 := (if p2$1 then _HAVOC_bv8$1 else v18$1);
    v18$2 := (if p2$2 then _HAVOC_bv8$2 else v18$2);
    $$agg.tmp15$3bv32$1 := (if p2$1 then v18$1 else $$agg.tmp15$3bv32$1);
    $$agg.tmp15$3bv32$2 := (if p2$2 then v18$2 else $$agg.tmp15$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v19$1 := (if p2$1 then _HAVOC_bv8$1 else v19$1);
    v19$2 := (if p2$2 then _HAVOC_bv8$2 else v19$2);
    $$agg.tmp15$4bv32$1 := (if p2$1 then v19$1 else $$agg.tmp15$4bv32$1);
    $$agg.tmp15$4bv32$2 := (if p2$2 then v19$2 else $$agg.tmp15$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v20$1 := (if p2$1 then _HAVOC_bv8$1 else v20$1);
    v20$2 := (if p2$2 then _HAVOC_bv8$2 else v20$2);
    $$agg.tmp15$5bv32$1 := (if p2$1 then v20$1 else $$agg.tmp15$5bv32$1);
    $$agg.tmp15$5bv32$2 := (if p2$2 then v20$2 else $$agg.tmp15$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v21$1 := (if p2$1 then _HAVOC_bv8$1 else v21$1);
    v21$2 := (if p2$2 then _HAVOC_bv8$2 else v21$2);
    $$agg.tmp15$6bv32$1 := (if p2$1 then v21$1 else $$agg.tmp15$6bv32$1);
    $$agg.tmp15$6bv32$2 := (if p2$2 then v21$2 else $$agg.tmp15$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v22$1 := (if p2$1 then _HAVOC_bv8$1 else v22$1);
    v22$2 := (if p2$2 then _HAVOC_bv8$2 else v22$2);
    $$agg.tmp15$7bv32$1 := (if p2$1 then v22$1 else $$agg.tmp15$7bv32$1);
    $$agg.tmp15$7bv32$2 := (if p2$2 then v22$2 else $$agg.tmp15$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v23$1 := (if p2$1 then _HAVOC_bv8$1 else v23$1);
    v23$2 := (if p2$2 then _HAVOC_bv8$2 else v23$2);
    $$agg.tmp15$8bv32$1 := (if p2$1 then v23$1 else $$agg.tmp15$8bv32$1);
    $$agg.tmp15$8bv32$2 := (if p2$2 then v23$2 else $$agg.tmp15$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v24$1 := (if p2$1 then _HAVOC_bv8$1 else v24$1);
    v24$2 := (if p2$2 then _HAVOC_bv8$2 else v24$2);
    $$agg.tmp15$9bv32$1 := (if p2$1 then v24$1 else $$agg.tmp15$9bv32$1);
    $$agg.tmp15$9bv32$2 := (if p2$2 then v24$2 else $$agg.tmp15$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v25$1 := (if p2$1 then _HAVOC_bv8$1 else v25$1);
    v25$2 := (if p2$2 then _HAVOC_bv8$2 else v25$2);
    $$agg.tmp15$10bv32$1 := (if p2$1 then v25$1 else $$agg.tmp15$10bv32$1);
    $$agg.tmp15$10bv32$2 := (if p2$2 then v25$2 else $$agg.tmp15$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v26$1 := (if p2$1 then _HAVOC_bv8$1 else v26$1);
    v26$2 := (if p2$2 then _HAVOC_bv8$2 else v26$2);
    $$agg.tmp15$11bv32$1 := (if p2$1 then v26$1 else $$agg.tmp15$11bv32$1);
    $$agg.tmp15$11bv32$2 := (if p2$2 then v26$2 else $$agg.tmp15$11bv32$2);
    call {:sourceloc_num 58} v27$1, v27$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp15, 0bv32), p2$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p2$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    $cond$1 := (if p2$1 then FMUL32(SI32_TO_FP32(BV8_ZEXT32(v27$1)), $fscale) else $cond$1);
    $cond$2 := (if p2$2 then FMUL32(SI32_TO_FP32(BV8_ZEXT32(v27$2)), $fscale) else $cond$2);
    $cond$1 := (if p3$1 then 0bv32 else $cond$1);
    $cond$2 := (if p3$2 then 0bv32 else $cond$2);
    v28$1 := (if p1$1 then FLT32($cond$1, 1132396544bv32) else v28$1);
    v28$2 := (if p1$2 then FLT32($cond$2, 1132396544bv32) else v28$2);
    ...
    $cond45$1 := (if p4$1 then 1132396544bv32 else $cond45$1);
    $cond45$2 := (if p4$2 then 1132396544bv32 else $cond45$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v29$1 := (if p5$1 then _HAVOC_bv8$1 else v29$1);
    v29$2 := (if p5$2 then _HAVOC_bv8$2 else v29$2);
    $$agg.tmp24$0bv32$1 := (if p5$1 then v29$1 else $$agg.tmp24$0bv32$1);
    $$agg.tmp24$0bv32$2 := (if p5$2 then v29$2 else $$agg.tmp24$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v30$1 := (if p5$1 then _HAVOC_bv8$1 else v30$1);
    v30$2 := (if p5$2 then _HAVOC_bv8$2 else v30$2);
    $$agg.tmp24$1bv32$1 := (if p5$1 then v30$1 else $$agg.tmp24$1bv32$1);
    $$agg.tmp24$1bv32$2 := (if p5$2 then v30$2 else $$agg.tmp24$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v31$1 := (if p5$1 then _HAVOC_bv8$1 else v31$1);
    v31$2 := (if p5$2 then _HAVOC_bv8$2 else v31$2);
    $$agg.tmp24$2bv32$1 := (if p5$1 then v31$1 else $$agg.tmp24$2bv32$1);
    $$agg.tmp24$2bv32$2 := (if p5$2 then v31$2 else $$agg.tmp24$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v32$1 := (if p5$1 then _HAVOC_bv8$1 else v32$1);
    v32$2 := (if p5$2 then _HAVOC_bv8$2 else v32$2);
    $$agg.tmp24$3bv32$1 := (if p5$1 then v32$1 else $$agg.tmp24$3bv32$1);
    $$agg.tmp24$3bv32$2 := (if p5$2 then v32$2 else $$agg.tmp24$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v33$1 := (if p5$1 then _HAVOC_bv8$1 else v33$1);
    v33$2 := (if p5$2 then _HAVOC_bv8$2 else v33$2);
    $$agg.tmp24$4bv32$1 := (if p5$1 then v33$1 else $$agg.tmp24$4bv32$1);
    $$agg.tmp24$4bv32$2 := (if p5$2 then v33$2 else $$agg.tmp24$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v34$1 := (if p5$1 then _HAVOC_bv8$1 else v34$1);
    v34$2 := (if p5$2 then _HAVOC_bv8$2 else v34$2);
    $$agg.tmp24$5bv32$1 := (if p5$1 then v34$1 else $$agg.tmp24$5bv32$1);
    $$agg.tmp24$5bv32$2 := (if p5$2 then v34$2 else $$agg.tmp24$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v35$1 := (if p5$1 then _HAVOC_bv8$1 else v35$1);
    v35$2 := (if p5$2 then _HAVOC_bv8$2 else v35$2);
    $$agg.tmp24$6bv32$1 := (if p5$1 then v35$1 else $$agg.tmp24$6bv32$1);
    $$agg.tmp24$6bv32$2 := (if p5$2 then v35$2 else $$agg.tmp24$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v36$1 := (if p5$1 then _HAVOC_bv8$1 else v36$1);
    v36$2 := (if p5$2 then _HAVOC_bv8$2 else v36$2);
    $$agg.tmp24$7bv32$1 := (if p5$1 then v36$1 else $$agg.tmp24$7bv32$1);
    $$agg.tmp24$7bv32$2 := (if p5$2 then v36$2 else $$agg.tmp24$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v37$1 := (if p5$1 then _HAVOC_bv8$1 else v37$1);
    v37$2 := (if p5$2 then _HAVOC_bv8$2 else v37$2);
    $$agg.tmp24$8bv32$1 := (if p5$1 then v37$1 else $$agg.tmp24$8bv32$1);
    $$agg.tmp24$8bv32$2 := (if p5$2 then v37$2 else $$agg.tmp24$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v38$1 := (if p5$1 then _HAVOC_bv8$1 else v38$1);
    v38$2 := (if p5$2 then _HAVOC_bv8$2 else v38$2);
    $$agg.tmp24$9bv32$1 := (if p5$1 then v38$1 else $$agg.tmp24$9bv32$1);
    $$agg.tmp24$9bv32$2 := (if p5$2 then v38$2 else $$agg.tmp24$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v39$1 := (if p5$1 then _HAVOC_bv8$1 else v39$1);
    v39$2 := (if p5$2 then _HAVOC_bv8$2 else v39$2);
    $$agg.tmp24$10bv32$1 := (if p5$1 then v39$1 else $$agg.tmp24$10bv32$1);
    $$agg.tmp24$10bv32$2 := (if p5$2 then v39$2 else $$agg.tmp24$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v40$1 := (if p5$1 then _HAVOC_bv8$1 else v40$1);
    v40$2 := (if p5$2 then _HAVOC_bv8$2 else v40$2);
    $$agg.tmp24$11bv32$1 := (if p5$1 then v40$1 else $$agg.tmp24$11bv32$1);
    $$agg.tmp24$11bv32$2 := (if p5$2 then v40$2 else $$agg.tmp24$11bv32$2);
    call {:sourceloc_num 85} v41$1, v41$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp24, 0bv32), p5$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p5$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    ...
    $$agg.tmp34$0bv32$1 := (if p6$1 then v43$1 else $$agg.tmp34$0bv32$1);
    $$agg.tmp34$0bv32$2 := (if p6$2 then v43$2 else $$agg.tmp34$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v44$1 := (if p6$1 then _HAVOC_bv8$1 else v44$1);
    v44$2 := (if p6$2 then _HAVOC_bv8$2 else v44$2);
    $$agg.tmp34$1bv32$1 := (if p6$1 then v44$1 else $$agg.tmp34$1bv32$1);
    $$agg.tmp34$1bv32$2 := (if p6$2 then v44$2 else $$agg.tmp34$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v45$1 := (if p6$1 then _HAVOC_bv8$1 else v45$1);
    v45$2 := (if p6$2 then _HAVOC_bv8$2 else v45$2);
    $$agg.tmp34$2bv32$1 := (if p6$1 then v45$1 else $$agg.tmp34$2bv32$1);
    $$agg.tmp34$2bv32$2 := (if p6$2 then v45$2 else $$agg.tmp34$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v46$1 := (if p6$1 then _HAVOC_bv8$1 else v46$1);
    v46$2 := (if p6$2 then _HAVOC_bv8$2 else v46$2);
    $$agg.tmp34$3bv32$1 := (if p6$1 then v46$1 else $$agg.tmp34$3bv32$1);
    $$agg.tmp34$3bv32$2 := (if p6$2 then v46$2 else $$agg.tmp34$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v47$1 := (if p6$1 then _HAVOC_bv8$1 else v47$1);
    v47$2 := (if p6$2 then _HAVOC_bv8$2 else v47$2);
    $$agg.tmp34$4bv32$1 := (if p6$1 then v47$1 else $$agg.tmp34$4bv32$1);
    $$agg.tmp34$4bv32$2 := (if p6$2 then v47$2 else $$agg.tmp34$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v48$1 := (if p6$1 then _HAVOC_bv8$1 else v48$1);
    v48$2 := (if p6$2 then _HAVOC_bv8$2 else v48$2);
    $$agg.tmp34$5bv32$1 := (if p6$1 then v48$1 else $$agg.tmp34$5bv32$1);
    $$agg.tmp34$5bv32$2 := (if p6$2 then v48$2 else $$agg.tmp34$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v49$1 := (if p6$1 then _HAVOC_bv8$1 else v49$1);
    v49$2 := (if p6$2 then _HAVOC_bv8$2 else v49$2);
    $$agg.tmp34$6bv32$1 := (if p6$1 then v49$1 else $$agg.tmp34$6bv32$1);
    $$agg.tmp34$6bv32$2 := (if p6$2 then v49$2 else $$agg.tmp34$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v50$1 := (if p6$1 then _HAVOC_bv8$1 else v50$1);
    v50$2 := (if p6$2 then _HAVOC_bv8$2 else v50$2);
    $$agg.tmp34$7bv32$1 := (if p6$1 then v50$1 else $$agg.tmp34$7bv32$1);
    $$agg.tmp34$7bv32$2 := (if p6$2 then v50$2 else $$agg.tmp34$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v51$1 := (if p6$1 then _HAVOC_bv8$1 else v51$1);
    v51$2 := (if p6$2 then _HAVOC_bv8$2 else v51$2);
    $$agg.tmp34$8bv32$1 := (if p6$1 then v51$1 else $$agg.tmp34$8bv32$1);
    $$agg.tmp34$8bv32$2 := (if p6$2 then v51$2 else $$agg.tmp34$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v52$1 := (if p6$1 then _HAVOC_bv8$1 else v52$1);
    v52$2 := (if p6$2 then _HAVOC_bv8$2 else v52$2);
    $$agg.tmp34$9bv32$1 := (if p6$1 then v52$1 else $$agg.tmp34$9bv32$1);
    $$agg.tmp34$9bv32$2 := (if p6$2 then v52$2 else $$agg.tmp34$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v53$1 := (if p6$1 then _HAVOC_bv8$1 else v53$1);
    v53$2 := (if p6$2 then _HAVOC_bv8$2 else v53$2);
    $$agg.tmp34$10bv32$1 := (if p6$1 then v53$1 else $$agg.tmp34$10bv32$1);
    $$agg.tmp34$10bv32$2 := (if p6$2 then v53$2 else $$agg.tmp34$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v54$1 := (if p6$1 then _HAVOC_bv8$1 else v54$1);
    v54$2 := (if p6$2 then _HAVOC_bv8$2 else v54$2);
    $$agg.tmp34$11bv32$1 := (if p6$1 then v54$1 else $$agg.tmp34$11bv32$1);
    $$agg.tmp34$11bv32$2 := (if p6$2 then v54$2 else $$agg.tmp34$11bv32$2);
    call {:sourceloc_num 112} v55$1, v55$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(MKPTR($arrayId$$agg.tmp34, 0bv32), p6$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p6$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    $cond42$1 := (if p6$1 then FMUL32(SI32_TO_FP32(BV8_ZEXT32(v55$1)), $fscale) else $cond42$1);
    $cond42$2 := (if p6$2 then FMUL32(SI32_TO_FP32(BV8_ZEXT32(v55$2)), $fscale) else $cond42$2);
    $cond42$1 := (if p7$1 then 0bv32 else $cond42$1);
    $cond42$2 := (if p7$2 then 0bv32 else $cond42$2);
    $cond45$1 := (if p5$1 then $cond42$1 else $cond45$1);
    $cond45$2 := (if p5$2 then $cond42$2 else $cond45$2);
    call {:sourceloc} {:sourceloc_num 116} _LOG_WRITE_$$pSobelOriginal(p1$1, BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1), FP32_TO_UI8($cond45$1), $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 116} _CHECK_WRITE_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2), FP32_TO_UI8($cond45$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pSobelOriginal"} true;
    $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)] := (if p1$1 then FP32_TO_UI8($cond45$1) else $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)]);
    $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2)] := (if p1$2 then FP32_TO_UI8($cond45$2) else $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2)]);
...
var $$agg.tmp15$0bv32$1: bv8;

var $$agg.tmp15$0bv32$2: bv8;

var $$agg.tmp15$1bv32$1: bv8;

var $$agg.tmp15$1bv32$2: bv8;

var $$agg.tmp15$2bv32$1: bv8;

var $$agg.tmp15$2bv32$2: bv8;

var $$agg.tmp15$3bv32$1: bv8;

var $$agg.tmp15$3bv32$2: bv8;

var $$agg.tmp15$4bv32$1: bv8;

var $$agg.tmp15$4bv32$2: bv8;

var $$agg.tmp15$5bv32$1: bv8;

var $$agg.tmp15$5bv32$2: bv8;

var $$agg.tmp15$6bv32$1: bv8;

var $$agg.tmp15$6bv32$2: bv8;

var $$agg.tmp15$7bv32$1: bv8;

var $$agg.tmp15$7bv32$2: bv8;

var $$agg.tmp15$8bv32$1: bv8;

var $$agg.tmp15$8bv32$2: bv8;

var $$agg.tmp15$9bv32$1: bv8;

var $$agg.tmp15$9bv32$2: bv8;

var $$agg.tmp15$10bv32$1: bv8;

var $$agg.tmp15$10bv32$2: bv8;

var $$agg.tmp15$11bv32$1: bv8;

var $$agg.tmp15$11bv32$2: bv8;
