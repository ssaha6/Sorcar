...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($i.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.0$1, $w) ==> p0$1 )  && (  BV32_SLT($i.0$2, $w) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLE(BV32_MUL(group_id_x$1, $Pitch), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), $Pitch)) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), BV32_ADD(local_id_x$1, BV32_MUL(group_id_x$1, $Pitch))) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $Pitch) )  ); 
    ...
    call {:sourceloc_num 40} v22$1, v22$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v13$1, v17$1 ++ v16$1 ++ v15$1 ++ v14$1, v21$1 ++ v20$1 ++ v19$1 ++ v18$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v13$2, v17$2 ++ v16$2 ++ v15$2 ++ v14$2, v21$2 ++ v20$2 ++ v19$2 ++ v18$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    ...
    call {:sourceloc_num 108} v66$1, v66$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v57$1, v61$1 ++ v60$1 ++ v59$1 ++ v58$1, v65$1 ++ v64$1 ++ v63$1 ++ v62$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v57$2, v61$2 ++ v60$2 ++ v59$2 ++ v58$2, v65$2 ++ v64$2 ++ v63$2 ++ v62$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 142} v88$1, v88$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v79$1, v83$1 ++ v82$1 ++ v81$1 ++ v80$1, v87$1 ++ v86$1 ++ v85$1 ++ v84$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v79$2, v83$2 ++ v82$2 ++ v81$2 ++ v80$2, v87$2 ++ v86$2 ++ v85$2 ++ v84$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 244} v154$1, v154$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v145$1, v149$1 ++ v148$1 ++ v147$1 ++ v146$1, v153$1 ++ v152$1 ++ v151$1 ++ v150$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v145$2, v149$2 ++ v148$2 ++ v147$2 ++ v146$2, v153$2 ++ v152$2 ++ v151$2 ++ v150$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 312} v198$1, v198$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v189$1, v193$1 ++ v192$1 ++ v191$1 ++ v190$1, v197$1 ++ v196$1 ++ v195$1 ++ v194$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v189$2, v193$2 ++ v192$2 ++ v191$2 ++ v190$2, v197$2 ++ v196$2 ++ v195$2 ++ v194$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    call {:sourceloc_num 313} v199$1, v199$2 := $abs(p1$1, SI32_TO_FP32(BV16_SEXT32(BV32_SUB(BV32_SUB(BV32_SUB(BV32_ADD(BV32_ADD(BV8_ZEXT32(v66$1), BV32_MUL(2bv32, BV8_ZEXT32(v132$1))), BV8_ZEXT32(v198$1)), BV8_ZEXT32(v22$1)), BV32_MUL(2bv32, BV8_ZEXT32(v88$1))), BV8_ZEXT32(v154$1))[16:0])), p1$2, SI32_TO_FP32(BV16_SEXT32(BV32_SUB(BV32_SUB(BV32_SUB(BV32_ADD(BV32_ADD(BV8_ZEXT32(v66$2), BV32_MUL(2bv32, BV8_ZEXT32(v132$2))), BV8_ZEXT32(v198$2)), BV8_ZEXT32(v22$2)), BV32_MUL(2bv32, BV8_ZEXT32(v88$2))), BV8_ZEXT32(v154$2))[16:0])));
    assume {:captureState "call_return_state_0"} {:procedureName "$abs"} true;
    call {:sourceloc_num 314} v200$1, v200$2 := $abs(p1$1, SI32_TO_FP32(BV16_SEXT32(BV32_SUB(BV32_SUB(BV32_SUB(BV32_ADD(BV32_ADD(BV8_ZEXT32(v22$1), BV32_MUL(2bv32, BV8_ZEXT32(v44$1))), BV8_ZEXT32(v66$1)), BV8_ZEXT32(v154$1)), BV32_MUL(2bv32, BV8_ZEXT32(v176$1))), BV8_ZEXT32(v198$1))[16:0])), p1$2, SI32_TO_FP32(BV16_SEXT32(BV32_SUB(BV32_SUB(BV32_SUB(BV32_ADD(BV32_ADD(BV8_ZEXT32(v22$2), BV32_MUL(2bv32, BV8_ZEXT32(v44$2))), BV8_ZEXT32(v66$2)), BV8_ZEXT32(v154$2)), BV32_MUL(2bv32, BV8_ZEXT32(v176$2))), BV8_ZEXT32(v198$2))[16:0])));
    assume {:captureState "call_return_state_0"} {:procedureName "$abs"} true;
    ...
    call {:sourceloc} {:sourceloc_num 320} _LOG_WRITE_$$pSobelOriginal(p1$1, BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1), $.0$1, $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 320} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 320} _CHECK_WRITE_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2), $.0$2);
