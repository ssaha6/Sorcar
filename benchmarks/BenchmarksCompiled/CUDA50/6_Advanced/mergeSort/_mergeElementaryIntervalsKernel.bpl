...
implementation {:source_name "mergeElementaryIntervalsKernel<1>"} {:kernel} $_Z30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jj($stride: bv32, $N: bv32)
{
  ...
  $23:
    ...
    assert {:tag "pow2NotZero"} _b27 ==> $.03$2 != 0bv32;
    assert {:tag "pow2"} _b26 ==> $.03$2 == 0bv32 || BV32_AND($.03$2, BV32_SUB($.03$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b25 ==> $.03$1 != 0bv32;
    assert {:tag "pow2"} _b24 ==> $.03$1 == 0bv32 || BV32_AND($.03$1, BV32_SUB($.03$1, 1bv32)) == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_ULT(local_id_x$1, v31$1) && v32$1 != 0bv32 && BV32_UGT($.03$1, 0bv32) ==> p19$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_ULT(local_id_x$2, v31$2) && v32$2 != 0bv32 && BV32_UGT($.03$2, 0bv32) ==> p19$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b15 ==> BV32_UGE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b15 ==> BV32_UGE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b14 ==> BV32_ULE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b14 ==> BV32_ULE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b13 ==> BV32_SGE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b13 ==> BV32_SGE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b12 ==> BV32_SLE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b12 ==> BV32_SLE($.03$2, 128bv32);
  ...
  $35:
    ...
    assert {:tag "pow2NotZero"} _b31 ==> $.01$2 != 0bv32;
    assert {:tag "pow2"} _b30 ==> $.01$2 == 0bv32 || BV32_AND($.01$2, BV32_SUB($.01$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b29 ==> $.01$1 != 0bv32;
    assert {:tag "pow2"} _b28 ==> $.01$1 == 0bv32 || BV32_AND($.01$1, BV32_SUB($.01$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b9 ==> BV32_ULT(local_id_x$1, v32$1) && v31$1 != 0bv32 && BV32_UGT($.01$1, 0bv32) ==> p29$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b9 ==> BV32_ULT(local_id_x$2, v32$2) && v31$2 != 0bv32 && BV32_UGT($.01$2, 0bv32) ==> p29$2;
