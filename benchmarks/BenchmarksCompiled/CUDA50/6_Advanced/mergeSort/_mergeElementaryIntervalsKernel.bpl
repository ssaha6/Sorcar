...
implementation {:source_name "mergeElementaryIntervalsKernel<1>"} {:kernel} $_Z30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jj($stride: bv32, $N: bv32)
{
  ...
  var $cond.i.i$1: bv32;
  var $cond.i.i$2: bv32;
  var $cond.i.i.99$1: bv32;
  var $cond.i.i.99$2: bv32;
  var $cond25$1: bv32;
  var $cond25$2: bv32;
  var $cond33$1: bv32;
  var $cond33$2: bv32;
  ...
  var $retval.i.i.0$1: bv32;
  var $retval.i.i.0$2: bv32;
  var $pos.i.i.0$1: bv32;
  var $pos.i.i.0$2: bv32;
  var $stride.addr.i.i.0$1: bv32;
  var $stride.addr.i.i.0$2: bv32;
  var $cond.i.i.88$1: bv32;
  var $cond.i.i.88$2: bv32;
  ...
  var $retval.i.19.i.0$1: bv32;
  var $retval.i.19.i.0$2: bv32;
  var $pos.i.24.i.0$1: bv32;
  var $pos.i.24.i.0$2: bv32;
  var $stride.addr.i.23.i.0$1: bv32;
  var $stride.addr.i.23.i.0$2: bv32;
  var $cond.i.37.i$1: bv32;
  var $cond.i.37.i$2: bv32;
  var $pos.i.24.i.1$1: bv32;
  var $pos.i.24.i.1$2: bv32;
  var v14$1: bv32;
  var v14$2: bv32;
  var v12$1: bv32;
  var v12$2: bv32;
  ...
  __partitioned_block_$entry_0:
    ...
    $cond$1 := (if p1$1 then $stride else $cond$1);
    $cond$2 := (if p1$2 then $stride else $cond$2);
    $cond$1 := (if p2$1 then BV32_SUB(BV32_SUB($N, v1$1), $stride) else $cond$1);
    $cond$2 := (if p2$2 then BV32_SUB(BV32_SUB($N, v1$2), $stride) else $cond$2);
    ...
    $cond.i.i$1 := (if p3$1 then BV32_UDIV($stride, 128bv32) else $cond.i.i$1);
    $cond.i.i$2 := (if p3$2 then BV32_UDIV($stride, 128bv32) else $cond.i.i$2);
    $cond.i.i$1 := (if p4$1 then BV32_ADD(BV32_UDIV($stride, 128bv32), 1bv32) else $cond.i.i$1);
    $cond.i.i$2 := (if p4$2 then BV32_ADD(BV32_UDIV($stride, 128bv32), 1bv32) else $cond.i.i$2);
    v5$1 := (if p0$1 then BV32_UREM($cond$1, 128bv32) == 0bv32 else v5$1);
    v5$2 := (if p0$2 then BV32_UREM($cond$2, 128bv32) == 0bv32 else v5$2);
    ...
    $cond.i.i.99$1 := (if p5$1 then BV32_UDIV($cond$1, 128bv32) else $cond.i.i.99$1);
    $cond.i.i.99$2 := (if p5$2 then BV32_UDIV($cond$2, 128bv32) else $cond.i.i.99$2);
    $cond.i.i.99$1 := (if p6$1 then BV32_ADD(BV32_UDIV($cond$1, 128bv32), 1bv32) else $cond.i.i.99$1);
    $cond.i.i.99$2 := (if p6$2 then BV32_ADD(BV32_UDIV($cond$2, 128bv32), 1bv32) else $cond.i.i.99$2);
    v6$1 := (if p0$1 then BV32_ADD($cond.i.i$1, $cond.i.i.99$1) else v6$1);
    v6$2 := (if p0$2 then BV32_ADD($cond.i.i$2, $cond.i.i.99$2) else v6$2);
    ...
    $cond25$1 := (if p7$1 then v10$1 else $cond25$1);
    $cond25$2 := (if p7$2 then v10$2 else $cond25$2);
    $cond25$1 := (if p8$1 then $stride else $cond25$1);
    $cond25$2 := (if p8$2 then $stride else $cond25$2);
    ...
    $cond33$1 := (if p9$1 then v12$1 else $cond33$1);
    $cond33$2 := (if p9$2 then v12$2 else $cond33$2);
    $cond33$1 := (if p10$1 then $cond$1 else $cond33$1);
    $cond33$2 := (if p10$2 then $cond$2 else $cond33$2);
    ...
    call {:sourceloc} {:sourceloc_num 27} _LOG_WRITE_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA(p0$1, 0bv32, BV32_SUB($cond25$1, v13$1), $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32]);
    ...
    call {:check_id "check_state_41"} {:sourceloc} {:sourceloc_num 27} _CHECK_WRITE_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA(p0$2, 0bv32, BV32_SUB($cond25$2, v13$2));
    ...
    $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32] := (if p0$1 then BV32_SUB($cond25$1, v13$1) else $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32]);
    $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p0$2 then BV32_SUB($cond25$2, v13$2) else $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB(p0$1, 0bv32, BV32_SUB($cond33$1, v14$1), $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32]);
    ...
    call {:check_id "check_state_43"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB(p0$2, 0bv32, BV32_SUB($cond33$2, v14$2));
    ...
    $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32] := (if p0$1 then BV32_SUB($cond33$1, v14$1) else $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32]);
    $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p0$2 then BV32_SUB($cond33$2, v14$2) else $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
  ...
  __partitioned_block_$entry_2:
    ...
    $retval.i.i.0$1 := (if p17$1 then 0bv32 else $retval.i.i.0$1);
    $retval.i.i.0$2 := (if p17$2 then 0bv32 else $retval.i.i.0$2);
    $pos.i.i.0$1, $stride.addr.i.i.0$1 := (if p18$1 then 0bv32 else $pos.i.i.0$1), (if p18$1 then 128bv32 else $stride.addr.i.i.0$1);
    $pos.i.i.0$2, $stride.addr.i.i.0$2 := (if p18$2 then 0bv32 else $pos.i.i.0$2), (if p18$2 then 128bv32 else $stride.addr.i.i.0$2);
  ...
  $for.cond.i.i:
    ...
    assert {:tag "pow2NotZero"} _b27 ==> $stride.addr.i.i.0$2 != 0bv32;
    assert {:tag "pow2"} _b26 ==> $stride.addr.i.i.0$2 == 0bv32 || BV32_AND($stride.addr.i.i.0$2, BV32_SUB($stride.addr.i.i.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b25 ==> $stride.addr.i.i.0$1 != 0bv32;
    assert {:tag "pow2"} _b24 ==> $stride.addr.i.i.0$1 == 0bv32 || BV32_AND($stride.addr.i.i.0$1, BV32_SUB($stride.addr.i.i.0$1, 1bv32)) == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> v32$1 != 0bv32;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_ULT(local_id_x$1, v31$1) && v32$1 != 0bv32 && BV32_UGT($stride.addr.i.i.0$1, 0bv32) ==> p19$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_ULT(local_id_x$2, v31$2) && v32$2 != 0bv32 && BV32_UGT($stride.addr.i.i.0$2, 0bv32) ==> p19$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p19$1 ==> _b20 ==> p19$1 ==> BV32_ULT(local_id_x$1, v31$1) && v32$1 != 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p19$2 ==> _b20 ==> p19$2 ==> BV32_ULT(local_id_x$2, v31$2) && v32$2 != 0bv32;
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b19 ==> BV32_UGE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b19 ==> BV32_UGE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b18 ==> BV32_ULE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b18 ==> BV32_ULE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b17 ==> BV32_SGE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b17 ==> BV32_SGE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b16 ==> BV32_SLE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b16 ==> BV32_SLE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b15 ==> BV32_UGE($stride.addr.i.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b15 ==> BV32_UGE($stride.addr.i.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b14 ==> BV32_ULE($stride.addr.i.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b14 ==> BV32_ULE($stride.addr.i.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b13 ==> BV32_SGE($stride.addr.i.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b13 ==> BV32_SGE($stride.addr.i.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b12 ==> BV32_SLE($stride.addr.i.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b12 ==> BV32_SLE($stride.addr.i.i.0$2, 128bv32);
    assert {:block_sourceloc} {:sourceloc_num 64} p19$1 ==> true;
    v37$1 := (if p19$1 then BV32_UGT($stride.addr.i.i.0$1, 0bv32) else v37$1);
    v37$2 := (if p19$2 then BV32_UGT($stride.addr.i.i.0$2, 0bv32) else v37$2);
    p20$1 := false;
    p20$2 := false;
    p21$1 := false;
    p21$2 := false;
    ...
    v38$1 := (if p20$1 then BV32_ULT(BV32_ADD($pos.i.i.0$1, $stride.addr.i.i.0$1), v32$1) else v38$1);
    v38$2 := (if p20$2 then BV32_ULT(BV32_ADD($pos.i.i.0$2, $stride.addr.i.i.0$2), v32$2) else v38$2);
    ...
    $cond.i.i.88$1 := (if p21$1 then v32$1 else $cond.i.i.88$1);
    $cond.i.i.88$2 := (if p21$2 then v32$2 else $cond.i.i.88$2);
    $cond.i.i.88$1 := (if p22$1 then BV32_ADD($pos.i.i.0$1, $stride.addr.i.i.0$1) else $cond.i.i.88$1);
    $cond.i.i.88$2 := (if p22$2 then BV32_ADD($pos.i.i.0$2, $stride.addr.i.i.0$2) else $cond.i.i.88$2);
    assume {:do_not_predicate} {:check_id "check_state_29"} {:captureState "check_state_29"} {:sourceloc} {:sourceloc_num 69} true;
    v39$1 := (if p20$1 then $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key[1bv1][BV32_ADD(128bv32, BV32_SUB($cond.i.i.88$1, 1bv32))] else v39$1);
    v39$2 := (if p20$2 then $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(128bv32, BV32_SUB($cond.i.i.88$2, 1bv32))] else v39$2);
    ...
    $pos.i.i.1$1 := (if p24$1 then $cond.i.i.88$1 else $pos.i.i.1$1);
    $pos.i.i.1$2 := (if p24$2 then $cond.i.i.88$2 else $pos.i.i.1$2);
    $pos.i.i.0$1, $stride.addr.i.i.0$1 := (if p20$1 then $pos.i.i.1$1 else $pos.i.i.0$1), (if p20$1 then BV32_LSHR($stride.addr.i.i.0$1, 1bv32) else $stride.addr.i.i.0$1);
    $pos.i.i.0$2, $stride.addr.i.i.0$2 := (if p20$2 then $pos.i.i.1$2 else $pos.i.i.0$2), (if p20$2 then BV32_LSHR($stride.addr.i.i.0$2, 1bv32) else $stride.addr.i.i.0$2);
    p19$1 := (if p20$1 then true else p19$1);
    p19$2 := (if p20$2 then true else p19$2);
    goto $for.cond.i.i.backedge, $for.cond.i.i.tail;

  $for.cond.i.i.tail:
    assume !p19$1 && !p19$2;
    $retval.i.i.0$1 := (if p18$1 then $pos.i.i.0$1 else $retval.i.i.0$1);
    $retval.i.i.0$2 := (if p18$2 then $pos.i.i.0$2 else $retval.i.i.0$2);
    $keyA.i.0$1, $valA.i.0$1, $dstPosA.i.0$1 := (if p16$1 then v34$1 else $keyA.i.0$1), (if p16$1 then v35$1 else $valA.i.0$1), (if p16$1 then BV32_ADD($retval.i.i.0$1, local_id_x$1) else $dstPosA.i.0$1);
    $keyA.i.0$2, $valA.i.0$2, $dstPosA.i.0$2 := (if p16$2 then v34$2 else $keyA.i.0$2), (if p16$2 then v35$2 else $valA.i.0$2), (if p16$2 then BV32_ADD($retval.i.i.0$2, local_id_x$2) else $dstPosA.i.0$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    $retval.i.19.i.0$1 := (if p27$1 then 0bv32 else $retval.i.19.i.0$1);
    $retval.i.19.i.0$2 := (if p27$2 then 0bv32 else $retval.i.19.i.0$2);
    $pos.i.24.i.0$1, $stride.addr.i.23.i.0$1 := (if p28$1 then 0bv32 else $pos.i.24.i.0$1), (if p28$1 then 128bv32 else $stride.addr.i.23.i.0$1);
    $pos.i.24.i.0$2, $stride.addr.i.23.i.0$2 := (if p28$2 then 0bv32 else $pos.i.24.i.0$2), (if p28$2 then 128bv32 else $stride.addr.i.23.i.0$2);
  ...
  $for.cond.i.30.i:
    ...
    assert {:tag "pow2NotZero"} _b31 ==> $stride.addr.i.23.i.0$2 != 0bv32;
    assert {:tag "pow2"} _b30 ==> $stride.addr.i.23.i.0$2 == 0bv32 || BV32_AND($stride.addr.i.23.i.0$2, BV32_SUB($stride.addr.i.23.i.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b29 ==> $stride.addr.i.23.i.0$1 != 0bv32;
    assert {:tag "pow2"} _b28 ==> $stride.addr.i.23.i.0$1 == 0bv32 || BV32_AND($stride.addr.i.23.i.0$1, BV32_SUB($stride.addr.i.23.i.0$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b11 ==> _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> v31$1 != 0bv32;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b9 ==> BV32_ULT(local_id_x$1, v32$1) && v31$1 != 0bv32 && BV32_UGT($stride.addr.i.23.i.0$1, 0bv32) ==> p29$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b9 ==> BV32_ULT(local_id_x$2, v32$2) && v31$2 != 0bv32 && BV32_UGT($stride.addr.i.23.i.0$2, 0bv32) ==> p29$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p29$1 ==> _b8 ==> p29$1 ==> BV32_ULT(local_id_x$1, v32$1) && v31$1 != 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p29$2 ==> _b8 ==> p29$2 ==> BV32_ULT(local_id_x$2, v32$2) && v31$2 != 0bv32;
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b7 ==> BV32_UGE($pos.i.24.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b7 ==> BV32_UGE($pos.i.24.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b6 ==> BV32_ULE($pos.i.24.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b6 ==> BV32_ULE($pos.i.24.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b5 ==> BV32_SGE($pos.i.24.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b5 ==> BV32_SGE($pos.i.24.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b4 ==> BV32_SLE($pos.i.24.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b4 ==> BV32_SLE($pos.i.24.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b3 ==> BV32_UGE($stride.addr.i.23.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b3 ==> BV32_UGE($stride.addr.i.23.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b2 ==> BV32_ULE($stride.addr.i.23.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b2 ==> BV32_ULE($stride.addr.i.23.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b1 ==> BV32_SGE($stride.addr.i.23.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b1 ==> BV32_SGE($stride.addr.i.23.i.0$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b0 ==> BV32_SLE($stride.addr.i.23.i.0$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b0 ==> BV32_SLE($stride.addr.i.23.i.0$2, 128bv32);
    assert {:block_sourceloc} {:sourceloc_num 80} p29$1 ==> true;
    v45$1 := (if p29$1 then BV32_UGT($stride.addr.i.23.i.0$1, 0bv32) else v45$1);
    v45$2 := (if p29$2 then BV32_UGT($stride.addr.i.23.i.0$2, 0bv32) else v45$2);
    p30$1 := false;
    p30$2 := false;
    p31$1 := false;
    p31$2 := false;
    ...
    v46$1 := (if p30$1 then BV32_ULT(BV32_ADD($pos.i.24.i.0$1, $stride.addr.i.23.i.0$1), v31$1) else v46$1);
    v46$2 := (if p30$2 then BV32_ULT(BV32_ADD($pos.i.24.i.0$2, $stride.addr.i.23.i.0$2), v31$2) else v46$2);
    ...
    $cond.i.37.i$1 := (if p31$1 then v31$1 else $cond.i.37.i$1);
    $cond.i.37.i$2 := (if p31$2 then v31$2 else $cond.i.37.i$2);
    $cond.i.37.i$1 := (if p32$1 then BV32_ADD($pos.i.24.i.0$1, $stride.addr.i.23.i.0$1) else $cond.i.37.i$1);
    $cond.i.37.i$2 := (if p32$2 then BV32_ADD($pos.i.24.i.0$2, $stride.addr.i.23.i.0$2) else $cond.i.37.i$2);
    assume {:do_not_predicate} {:check_id "check_state_26"} {:captureState "check_state_26"} {:sourceloc} {:sourceloc_num 85} true;
    v47$1 := (if p30$1 then $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key[1bv1][BV32_SUB($cond.i.37.i$1, 1bv32)] else v47$1);
    v47$2 := (if p30$2 then $$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB($cond.i.37.i$2, 1bv32)] else v47$2);
    ...
    $pos.i.24.i.1$1 := (if p33$1 then $pos.i.24.i.0$1 else $pos.i.24.i.1$1);
    $pos.i.24.i.1$2 := (if p33$2 then $pos.i.24.i.0$2 else $pos.i.24.i.1$2);
    $pos.i.24.i.1$1 := (if p34$1 then $cond.i.37.i$1 else $pos.i.24.i.1$1);
    $pos.i.24.i.1$2 := (if p34$2 then $cond.i.37.i$2 else $pos.i.24.i.1$2);
    $pos.i.24.i.0$1, $stride.addr.i.23.i.0$1 := (if p30$1 then $pos.i.24.i.1$1 else $pos.i.24.i.0$1), (if p30$1 then BV32_LSHR($stride.addr.i.23.i.0$1, 1bv32) else $stride.addr.i.23.i.0$1);
    $pos.i.24.i.0$2, $stride.addr.i.23.i.0$2 := (if p30$2 then $pos.i.24.i.1$2 else $pos.i.24.i.0$2), (if p30$2 then BV32_LSHR($stride.addr.i.23.i.0$2, 1bv32) else $stride.addr.i.23.i.0$2);
    p29$1 := (if p30$1 then true else p29$1);
    p29$2 := (if p30$2 then true else p29$2);
    goto $for.cond.i.30.i.backedge, __partitioned_block_$for.cond.i.30.i.tail_0;

  __partitioned_block_$for.cond.i.30.i.tail_0:
    assume !p29$1 && !p29$2;
    $retval.i.19.i.0$1 := (if p28$1 then $pos.i.24.i.0$1 else $retval.i.19.i.0$1);
    $retval.i.19.i.0$2 := (if p28$2 then $pos.i.24.i.0$2 else $retval.i.19.i.0$2);
    $keyB.i.0$1, $valB.i.0$1, $dstPosB.i.0$1 := (if p26$1 then v42$1 else $keyB.i.0$1), (if p26$1 then v43$1 else $valB.i.0$1), (if p26$1 then BV32_ADD($retval.i.19.i.0$1, local_id_x$1) else $dstPosB.i.0$1);
    $keyB.i.0$2, $valB.i.0$2, $dstPosB.i.0$2 := (if p26$2 then v42$2 else $keyB.i.0$2), (if p26$2 then v43$2 else $valB.i.0$2), (if p26$2 then BV32_ADD($retval.i.19.i.0$2, local_id_x$2) else $dstPosB.i.0$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    goto __partitioned_block_$for.cond.i.30.i.tail_1;

  __partitioned_block_$for.cond.i.30.i.tail_1:
    ...
    goto __partitioned_block_$for.cond.i.30.i.tail_2;

  __partitioned_block_$for.cond.i.30.i.tail_2:
