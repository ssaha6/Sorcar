...
assert  my_inv (  (  BV32_SLE($stride.0, 1bv32) ) ,  (  BV32_SGE($stride.0, 1bv32) ) ,  (  BV32_ULE($stride.0, 1bv32) ) ,  (  BV32_UGE($stride.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  $.03 == 0bv32 || BV32_AND($.03, BV32_SUB($.03, 1bv32)) == 0bv32 ) ,  (  $.03 != 0bv32 ) ,  (  $.01 == 0bv32 || BV32_AND($.01, BV32_SUB($.01, 1bv32)) == 0bv32 ) ,  (  $.01 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ) ,  true ,  true ,  true ,  true  ); 
  ...
  __partitioned_block_$falsebb_1:
    ...
    $$d_DstVal[v3$1] := v29$1;
    $$d_DstVal[v3$2] := v29$2;
    call {:sourceloc} {:sourceloc_num 52} _LOG_READ_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key(true, BV32_ADD(local_id_x$1, 512bv32), $$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key[1bv1][BV32_ADD(local_id_x$1, 512bv32)]);
    ...
    call {:sourceloc} {:sourceloc_num 54} _LOG_READ_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val(true, BV32_ADD(local_id_x$1, 512bv32), $$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val[1bv1][BV32_ADD(local_id_x$1, 512bv32)]);
...
assert  my_inv (  true ,  true ,  true ,  true ,  (  BV32_SLE($.03, $stride.0) ) ,  (  BV32_SGE($.03, $stride.0) ) ,  (  BV32_ULE($.03, $stride.0) ) ,  (  BV32_UGE($.03, $stride.0) ) ,  (  BV32_SLE($pos.i.0$1, 0bv32) )  && (  BV32_SLE($pos.i.0$2, 0bv32) ) ,  (  BV32_SGE($pos.i.0$1, 0bv32) )  && (  BV32_SGE($pos.i.0$2, 0bv32) ) ,  (  BV32_ULE($pos.i.0$1, 0bv32) )  && (  BV32_ULE($pos.i.0$2, 0bv32) ) ,  (  BV32_UGE($pos.i.0$1, 0bv32) )  && (  BV32_UGE($pos.i.0$2, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $.03 == 0bv32 || BV32_AND($.03, BV32_SUB($.03, 1bv32)) == 0bv32 ) ,  (  $.03 != 0bv32 ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($.01, $stride.0) ) ,  (  BV32_SGE($.01, $stride.0) ) ,  (  BV32_ULE($.01, $stride.0) ) ,  (  BV32_UGE($.01, $stride.0) ) ,  (  BV32_SLE($pos.i1.0$1, 0bv32) )  && (  BV32_SLE($pos.i1.0$2, 0bv32) ) ,  (  BV32_SGE($pos.i1.0$1, 0bv32) )  && (  BV32_SGE($pos.i1.0$2, 0bv32) ) ,  (  BV32_ULE($pos.i1.0$1, 0bv32) )  && (  BV32_ULE($pos.i1.0$2, 0bv32) ) ,  (  BV32_UGE($pos.i1.0$1, 0bv32) )  && (  BV32_UGE($pos.i1.0$2, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $.01 == 0bv32 || BV32_AND($.01, BV32_SUB($.01, 1bv32)) == 0bv32 ) ,  (  $.01 != 0bv32 )  ); 
