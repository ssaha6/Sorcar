...
implementation {:source_name "bitonicMergeElementaryIntervalsKernel<1>"} {:kernel} $_Z37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jj($stride: bv32, $N: bv32)
{
  ...
  __partitioned_block_$entry_0:
    ...
    v4$1 := (if p0$1 then BV32_UREM($cond$1, 128bv32) == 0bv32 else v4$1);
    v4$2 := (if p0$2 then BV32_UREM($cond$2, 128bv32) == 0bv32 else v4$2);
    ...
    $cond.i.i$1 := (if p3$1 then BV32_UDIV($cond$1, 128bv32) else $cond.i.i$1);
    $cond.i.i$2 := (if p3$2 then BV32_UDIV($cond$2, 128bv32) else $cond.i.i$2);
    $cond.i.i$1 := (if p4$1 then BV32_ADD(BV32_UDIV($cond$1, 128bv32), 1bv32) else $cond.i.i$1);
    $cond.i.i$2 := (if p4$2 then BV32_ADD(BV32_UDIV($cond$2, 128bv32), 1bv32) else $cond.i.i$2);
    v5$1 := (if p0$1 then BV32_ADD(BV32_UDIV($stride, 128bv32), $cond.i.i$1) else v5$1);
    v5$2 := (if p0$2 then BV32_ADD(BV32_UDIV($stride, 128bv32), $cond.i.i$2) else v5$2);
    ...
    $cond26$1 := (if p5$1 then v11$1 else $cond26$1);
    $cond26$2 := (if p5$2 then v11$2 else $cond26$2);
    $cond26$1 := (if p6$1 then $stride else $cond26$1);
    $cond26$2 := (if p6$2 then $stride else $cond26$2);
    ...
    $cond34$1 := (if p7$1 then v13$1 else $cond34$1);
    $cond34$2 := (if p7$2 then v13$2 else $cond34$2);
    $cond34$1 := (if p8$1 then $cond$1 else $cond34$1);
    $cond34$2 := (if p8$2 then $cond$2 else $cond34$2);
    ...
    call {:sourceloc} {:sourceloc_num 27} _LOG_WRITE_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA(p0$1, 0bv32, BV32_SUB($cond26$1, v14$1), $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32]);
    ...
    call {:check_id "check_state_54"} {:sourceloc} {:sourceloc_num 27} _CHECK_WRITE_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA(p0$2, 0bv32, BV32_SUB($cond26$2, v14$2));
    ...
    $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32] := (if p0$1 then BV32_SUB($cond26$1, v14$1) else $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[1bv1][0bv32]);
    $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p0$2 then BV32_SUB($cond26$2, v14$2) else $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB(p0$1, 0bv32, BV32_SUB($cond34$1, v15$1), $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32]);
    ...
    call {:check_id "check_state_56"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB(p0$2, 0bv32, BV32_SUB($cond34$2, v15$2));
    ...
    $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32] := (if p0$1 then BV32_SUB($cond34$1, v15$1) else $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[1bv1][0bv32]);
    $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p0$2 then BV32_SUB($cond34$2, v15$2) else $$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE7lenSrcB[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
  ...
  $for.cond:
    ...
    assert {:tag "pow2NotZero"} _b5 ==> $stride68.0 != 0bv32;
    assert {:tag "pow2"} _b4 ==> $stride68.0 == 0bv32 || BV32_AND($stride68.0, BV32_SUB($stride68.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride68.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride68.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride68.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride68.0, 128bv32);
  ...
  __partitioned_block_$truebb6_1:
    ...
    v29$1 := BV32_SUB(BV32_MUL(2bv32, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB($stride68.0, 1bv32)));
    v29$2 := BV32_SUB(BV32_MUL(2bv32, local_id_x$2), BV32_AND(local_id_x$2, BV32_SUB($stride68.0, 1bv32)));
    v30$1 := BV32_ADD(v29$1, $stride68.0);
    v30$2 := BV32_ADD(v29$2, $stride68.0);
    v31$1 := BV32_ADD(v29$1, $stride68.0);
    v31$2 := BV32_ADD(v29$2, $stride68.0);
    v32$1 := BV32_ADD(v29$1, $stride68.0);
    v32$2 := BV32_ADD(v29$2, $stride68.0);
