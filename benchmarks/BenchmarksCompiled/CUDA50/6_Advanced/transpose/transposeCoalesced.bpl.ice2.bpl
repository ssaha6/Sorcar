...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ18transposeCoalescedPfS_iiiE4tile ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 16bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ18transposeCoalescedPfS_iiiE4tile ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32) ) ,  true ,  true ,  true ,  true  ); 
