...
implementation {:source_name "transposeCoalesced"} {:kernel} $_Z18transposeCoalescedPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  ...
  $truebb1:
    ...
    v4$1 := $$_ZZ18transposeCoalescedPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 16bv32), BV32_ADD(local_id_y$1, $i23.0))];
    v4$2 := $$_ZZ18transposeCoalescedPfS_iiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_x$2, 16bv32), BV32_ADD(local_id_y$2, $i23.0))];
