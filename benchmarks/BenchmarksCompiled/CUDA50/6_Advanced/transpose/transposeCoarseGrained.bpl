...
implementation {:source_name "transposeCoarseGrained"} {:kernel} $_Z22transposeCoarseGrainedPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  ...
  $truebb1:
    ...
    v4$1 := $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i23.0), 17bv32), local_id_x$1)];
    v4$2 := $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i23.0), 17bv32), local_id_x$2)];
