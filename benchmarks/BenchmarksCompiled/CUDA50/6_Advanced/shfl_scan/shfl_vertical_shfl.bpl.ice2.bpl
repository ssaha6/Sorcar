...
assert  my_inv (  (  BV32_SLE(0bv32, $step.0) ) ,  (  BV32_SLE($step.0, 0bv32) ) ,  (  BV32_SGE($step.0, 0bv32) ) ,  (  BV32_ULE($step.0, 0bv32) ) ,  (  BV32_UGE($step.0, 0bv32) ) ,  (  $i.0 == 0bv32 || BV32_AND($i.0, BV32_SUB($i.0, 1bv32)) == 0bv32 ) ,  (  $i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$img ) ,  (  !_WRITE_HAS_OCCURRED_$$img ) ,  (  _READ_HAS_OCCURRED_$$img ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _READ_HAS_OCCURRED_$$img ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$img ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$img ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _READ_HAS_OCCURRED_$$img ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 8bv32), $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 8bv32), $width), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0bv32, 8bv32), local_id_y$1), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$img ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 8bv32), $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 8bv32), $width), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0bv32, 8bv32), local_id_y$1), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _READ_HAS_OCCURRED_$$img ==> local_id_y$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $width)) ) ,  (  _READ_HAS_OCCURRED_$$img ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(local_id_y$1, $width), group_size_x)) ) ,  (  _WRITE_HAS_OCCURRED_$$img ==> local_id_y$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $width)) ) ,  (  _WRITE_HAS_OCCURRED_$$img ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(local_id_y$1, $width), group_size_x)) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ18shfl_vertical_shflPjiiE4sums ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ18shfl_vertical_shflPjiiE4sums ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18shfl_vertical_shflPjiiE4sums ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_UDIV(local_id_x$1, 8bv32), BV32_MUL(local_id_y$1, 4bv32)), 9bv32), BV32_UREM(local_id_x$1, 8bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ18shfl_vertical_shflPjiiE4sums ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_UDIV(local_id_x$1, 8bv32), BV32_MUL(local_id_y$1, 4bv32)), 9bv32), BV32_UREM(local_id_x$1, 8bv32)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 9bv32), local_id_y$1) )  ); 


    assert {:block_sourceloc} {:sourceloc_num 4} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 5} {:thread 1} (if _WRITE_HAS_OCCURRED_$$img ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $width) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 6} {:thread 1} (if _READ_HAS_OCCURRED_$$img ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $width) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 7} {:thread 1} (if _WRITE_HAS_OCCURRED_$$img ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), v0$1), $width), local_id_y$1), 8bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$truebb_0:
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_READ_$$img(true, BV32_ADD(v2$1, v0$1), $$img[BV32_ADD(v2$1, v0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 9} _CHECK_READ_$$img(true, BV32_ADD(v2$2, v0$2), $$img[BV32_ADD(v2$2, v0$2)]);
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(local_id_x$1, 9bv32), local_id_y$1), v3$1, $$_ZZ18shfl_vertical_shflPjiiE4sums[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 9bv32), local_id_y$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(local_id_x$2, 9bv32), local_id_y$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(local_id_x$2, 9bv32), local_id_y$2), v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums"} true;
  ...
  __partitioned_block_$truebb_1:
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_READ_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(v5$1, 9bv32), v4$1), $$_ZZ18shfl_vertical_shflPjiiE4sums[1bv1][BV32_ADD(BV32_MUL(v5$1, 9bv32), v4$1)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_READ_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(v5$2, 9bv32), v4$2), $$_ZZ18shfl_vertical_shflPjiiE4sums[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v5$2, 9bv32), v4$2)]);
  ...
  __partitioned_block_$falsebb0_0:
    assume {:partition} !v7;
    call {:sourceloc} {:sourceloc_num 20} _LOG_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(v5$1, 9bv32), v4$1), $partial_sum.0$1, $$_ZZ18shfl_vertical_shflPjiiE4sums[1bv1][BV32_ADD(BV32_MUL(v5$1, 9bv32), v4$1)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 20} _CHECK_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums(true, BV32_ADD(BV32_MUL(v5$2, 9bv32), v4$2), $partial_sum.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ18shfl_vertical_shflPjiiE4sums"} true;
  ...
  __partitioned_block_$falsebb0_1:
    call {:sourceloc_num 21} $bugle_barrier_duplicated_2(1bv1, 1bv1);
  ...
  __partitioned_block_$falsebb0_2:
    call {:sourceloc_num 26} $bugle_barrier_duplicated_3(1bv1, 1bv1);
    call {:sourceloc} {:sourceloc_num 27} _LOG_WRITE_$$img(true, BV32_ADD(v2$1, v0$1), BV32_ADD($sum.0$1, $stepSum.0$1), $$img[BV32_ADD(v2$1, v0$1)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 27} _CHECK_WRITE_$$img(true, BV32_ADD(v2$2, v0$2), BV32_ADD($sum.0$2, $stepSum.0$2));
  ...
  $truebb0:
    assume {:partition} v7;
    call {:sourceloc_num 15} v8$1, v8$2 := $_Z9__shfl_upiii($i.0, 32bv32, $partial_sum.0$1, $partial_sum.0$2);
