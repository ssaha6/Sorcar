...
assert  my_inv (  true ,  true ,  true ,  true ,  (  BV32_SLE($stride2.0, 512bv32) ) ,  (  BV32_SGE($stride2.0, 512bv32) ) ,  (  BV32_ULE($stride2.0, 512bv32) ) ,  (  BV32_UGE($stride2.0, 512bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride2.0 == 0bv32 || BV32_AND($stride2.0, BV32_SUB($stride2.0, 1bv32)) == 0bv32 ) ,  (  $stride2.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
