...
implementation {:source_name "bisectKernelLarge_OneIntervals"} {:kernel} $_Z30bisectKernelLarge_OneIntervalsPfS_jjS_S_Pjf($n: bv32, $num_intervals: bv32, $precision: bv32)
{
  ...
  $5:
    ...
    assert {:tag "nowrite"} _b84 ==> !_WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "noread"} _b83 ==> !_READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b82 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE21converged_all_threads ==> _WATCHED_OFFSET == 0bv32;
    ...
    assert {:tag "predicatedEquality"} _b39 ==> p4$1 && p4$2 ==> $count.i.2$1 == $count.i.2$2;
    assert {:tag "predicatedEquality"} _b38 ==> p4$1 && p4$2 ==> $delta.i.2$1 == $delta.i.2$2;
    assert {:tag "predicatedEquality"} _b37 ==> p4$1 && p4$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "predicatedEquality"} _b36 ==> p4$1 && p4$2 ==> $rem.i.0$1 == $rem.i.0$2;
    assert {:tag "predicatedEquality"} _b35 ==> p4$1 && p4$2 ==> $count.i.0$1 == $count.i.0$2;
    assert {:tag "predicatedEquality"} _b34 ==> p4$1 && p4$2 ==> $delta.i.0$1 == $delta.i.0$2;
    assert {:tag "predicatedEquality"} _b33 ==> p4$1 && p4$2 ==> $mid.i.0$1 == $mid.i.0$2;
    assert {:tag "predicatedEquality"} _b32 ==> p4$1 && p4$2 ==> $mid.1$1 == $mid.1$2;
    assert {:tag "predicatedEquality"} _b31 ==> p4$1 && p4$2 ==> $mid.0$1 == $mid.0$2;
    assert {:tag "predicatedEquality"} _b30 ==> p4$1 && p4$2 ==> $converged.0$1 == $converged.0$2;
    assert {:tag "predicatedEquality"} _b29 ==> p4$1 && p4$2 ==> $right.1$1 == $right.1$2;
    assert {:tag "predicatedEquality"} _b28 ==> p4$1 && p4$2 ==> $left.1$1 == $left.1$2;
    assert {:tag "loopPredicateEquality"} _b27 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b26 ==> p4$1 == p4$2;
  ...
  __partitioned_block_$11_0:
    ...
    assert {:tag "predicatedEquality"} _b96 ==> p11$1 && p11$2 ==> $count.i.2$1 == $count.i.2$2;
    assert {:tag "predicatedEquality"} _b95 ==> p11$1 && p11$2 ==> $delta.i.2$1 == $delta.i.2$2;
    assert {:tag "predicatedEquality"} _b94 ==> p11$1 && p11$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "predicatedEquality"} _b93 ==> p11$1 && p11$2 ==> $rem.i.0$1 == $rem.i.0$2;
    assert {:tag "predicatedEquality"} _b92 ==> p11$1 && p11$2 ==> $count.i.0$1 == $count.i.0$2;
    assert {:tag "predicatedEquality"} _b91 ==> p11$1 && p11$2 ==> $delta.i.0$1 == $delta.i.0$2;
    assert {:tag "loopPredicateEquality"} _b90 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p11$1 == p11$2;
    assert {:tag "loopPredicateEquality"} _b89 ==> p11$1 == p11$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p11$1 ==> _b6 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.i.0$1, 0bv32) == BV32_SUB($i.i.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p11$2 ==> _b6 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.i.0$2, 0bv32) == BV32_SUB($i.i.0$1, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p11$1 ==> _b5 ==> BV32_SUB($i.i.0$1, 0bv32) == BV32_SUB($i.i.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p11$2 ==> _b5 ==> BV32_SUB($i.i.0$2, 0bv32) == BV32_SUB($i.i.0$1, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p11$1 ==> _b4 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p11$2 ==> _b4 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), 0bv32);
  ...
  $16:
    ...
    assert p11$1 ==> p4$1;
    assert p11$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $num_intervals);
