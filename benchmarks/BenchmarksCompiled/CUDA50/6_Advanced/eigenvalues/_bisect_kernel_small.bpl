...
implementation {:source_name "bisectKernel"} {:kernel} $_Z12bisectKernelPfS_jS_S_PjS0_ffjjf($n: bv32, $lg: bv32, $ug: bv32, $lg_eig_count: bv32, $ug_eig_count: bv32, $epsilon: bv32)
{
  ...
  __partitioned_block_$3_0:
    ...
    assert {:tag "predicatedEquality"} _b178 ==> p2$1 && p2$2 ==> v100$1 == v100$2;
    assert {:tag "predicatedEquality"} _b177 ==> p2$1 && p2$2 ==> v99$1 == v99$2;
    assert {:tag "predicatedEquality"} _b176 ==> p2$1 && p2$2 ==> v98$1 == v98$2;
    assert {:tag "predicatedEquality"} _b175 ==> p2$1 && p2$2 ==> v97$1 == v97$2;
    assert {:tag "predicatedEquality"} _b174 ==> p2$1 && p2$2 ==> v96$1 == v96$2;
    assert {:tag "predicatedEquality"} _b173 ==> p2$1 && p2$2 ==> v95$1 == v95$2;
    assert {:tag "predicatedEquality"} _b172 ==> p2$1 && p2$2 ==> v94$1 == v94$2;
    assert {:tag "predicatedEquality"} _b171 ==> p2$1 && p2$2 ==> v93$1 == v93$2;
    assert {:tag "predicatedEquality"} _b170 ==> p2$1 && p2$2 ==> v92$1 == v92$2;
    assert {:tag "predicatedEquality"} _b169 ==> p2$1 && p2$2 ==> v91$1 == v91$2;
    assert {:tag "predicatedEquality"} _b168 ==> p2$1 && p2$2 ==> v90$1 == v90$2;
    assert {:tag "predicatedEquality"} _b167 ==> p2$1 && p2$2 ==> v89$1 == v89$2;
    assert {:tag "predicatedEquality"} _b166 ==> p2$1 && p2$2 ==> v88$1 == v88$2;
    assert {:tag "predicatedEquality"} _b165 ==> p2$1 && p2$2 ==> v87$1 == v87$2;
    assert {:tag "predicatedEquality"} _b164 ==> p2$1 && p2$2 ==> v86$1 == v86$2;
    assert {:tag "predicatedEquality"} _b163 ==> p2$1 && p2$2 ==> v85$1 == v85$2;
    assert {:tag "predicatedEquality"} _b162 ==> p2$1 && p2$2 ==> v84$1 == v84$2;
    assert {:tag "predicatedEquality"} _b161 ==> p2$1 && p2$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b160 ==> p2$1 && p2$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b159 ==> p2$1 && p2$2 ==> v81$1 == v81$2;
    assert {:tag "predicatedEquality"} _b158 ==> p2$1 && p2$2 ==> v80$1 == v80$2;
    assert {:tag "predicatedEquality"} _b157 ==> p2$1 && p2$2 ==> v79$1 == v79$2;
    assert {:tag "predicatedEquality"} _b156 ==> p2$1 && p2$2 ==> v78$1 == v78$2;
    assert {:tag "predicatedEquality"} _b155 ==> p2$1 && p2$2 ==> v77$1 == v77$2;
    assert {:tag "predicatedEquality"} _b154 ==> p2$1 && p2$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b153 ==> p2$1 && p2$2 ==> v75$1 == v75$2;
    ...
    assert {:tag "predicatedEquality"} _b149 ==> p2$1 && p2$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b148 ==> p2$1 && p2$2 ==> v70$1 == v70$2;
    assert {:tag "predicatedEquality"} _b147 ==> p2$1 && p2$2 ==> v67$1 == v67$2;
    assert {:tag "predicatedEquality"} _b146 ==> p2$1 && p2$2 ==> v66$1 == v66$2;
    assert {:tag "predicatedEquality"} _b145 ==> p2$1 && p2$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b144 ==> p2$1 && p2$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b143 ==> p2$1 && p2$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b142 ==> p2$1 && p2$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b141 ==> p2$1 && p2$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b140 ==> p2$1 && p2$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b139 ==> p2$1 && p2$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b138 ==> p2$1 && p2$2 ==> v51$1 == v51$2;
    ...
    assert {:tag "predicatedEquality"} _b134 ==> p2$1 && p2$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b133 ==> p2$1 && p2$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b132 ==> p2$1 && p2$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b131 ==> p2$1 && p2$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b130 ==> p2$1 && p2$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b129 ==> p2$1 && p2$2 ==> v30$1 == v30$2;
    ...
    assert {:tag "predicatedEquality"} _b108 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b107 ==> p2$1 && p2$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b106 ==> p2$1 && p2$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b105 ==> p2$1 && p2$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b104 ==> p2$1 && p2$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b103 ==> p2$1 && p2$2 ==> v2$1 == v2$2;
  ...
  __partitioned_block_$70_0:
    ...
    assert {:tag "predicatedEquality"} _b260 ==> p63$1 && p63$2 ==> v87$1 == v87$2;
    assert {:tag "predicatedEquality"} _b259 ==> p63$1 && p63$2 ==> v86$1 == v86$2;
