...
assert  my_inv (  (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(4bv32, v2), 4bv32), BV32_ADD(BV32_MUL(v1$1, v2), v0$1))) )  && (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(4bv32, v2), 4bv32), BV32_ADD(BV32_MUL(v1$2, v2), v0$2))) ) ,  (  BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 2bv32) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 2bv32) ) ,  (  BV32_SGE($i.0, 2bv32) ) ,  (  BV32_ULE($i.0, 2bv32) ) ,  (  BV32_UGE($i.0, 2bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 10} true;
    assert {:originated_from_invariant} {:sourceloc_num 11} {:thread 1} (if BV32_SUB($inputIndex.0$1, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(4bv32, v1$1), v2), 4bv32), v0$1)) == BV32_MUL(v3, BV32_SUB(2bv32, $i.0)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 11} {:thread 2} (if BV32_SUB($inputIndex.0$2, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(4bv32, v1$2), v2), 4bv32), v0$2)) == BV32_MUL(v3, BV32_SUB(2bv32, $i.0)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 12} {:thread 1} (if BV32_SGE($i.0, 4294967295bv32) then 1bv1 else 0bv1) != 0bv1;
  ...
  $falsebb3:
    ...
    v13$1 := $validr.0$1[1:0] == 1bv1;
    v13$2 := $validr.0$2[1:0] == 1bv1;
    ...
    v14$1 := (if p12$1 then _HAVOC_bv32$1 else v14$1);
    v14$2 := (if p12$2 then _HAVOC_bv32$2 else v14$2);
    $current.0$1 := (if p12$1 then v14$1 else $current.0$1);
    $current.0$2 := (if p12$2 then v14$2 else $current.0$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v43$1 := (if p13$1 then _HAVOC_bv32$1 else v43$1);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.2$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.1$1) )  && (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.2$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.1$2) ) ,  (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $outputIndex.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$1) )  && (  BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $outputIndex.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$2) ) ,  (  BV32_SLE(0bv32, $iz.0) ) ,  (  BV32_SLE($iz.0, 0bv32) ) ,  (  BV32_SGE($iz.0, 0bv32) ) ,  (  BV32_ULE($iz.0, 0bv32) ) ,  (  BV32_UGE($iz.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$output ) ,  (  _WRITE_HAS_OCCURRED_$$output ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD($inputIndex.0$1, BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)))) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ) ,  (  _READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 40bv32), BV32_ADD(local_id_x$1, 4bv32))) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(local_id_y$1, 4bv32)), 40bv32), BV32_ADD(local_id_x$1, 4bv32))) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 40bv32), BV32_ADD(local_id_x$1, 4bv32)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4bv32), 40bv32), BV32_ADD(local_id_x$1, 4bv32)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4bv32), 40bv32), local_id_x$1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4bv32), 40bv32), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4bv32)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4bv32), 40bv32), BV32_ADD(local_id_x$1, 4bv32)) ) ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 31} true;
    assert {:originated_from_invariant} {:sourceloc_num 32} {:thread 1} (if BV32_SUB($outputIndex.0$1, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(4bv32, v1$1), v2), 4bv32), v0$1)) == BV32_MUL(v3, BV32_ADD(3bv32, $iz.0)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 32} {:thread 2} (if BV32_SUB($outputIndex.0$2, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(4bv32, v1$2), v2), 4bv32), v0$2)) == BV32_MUL(v3, BV32_ADD(3bv32, $iz.0)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 33} {:thread 1} (if _WRITE_HAS_OCCURRED_$$output ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(4bv32, v1$1), v2), 4bv32), v0$1)), v3) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 34} {:thread 1} (if BV32_SGE(v0$1, $dimx) ==> BV1_XOR((if _WRITE_HAS_OCCURRED_$$output then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 35} {:thread 1} (if BV32_SGE(v1$1, $dimy) ==> BV1_XOR((if _WRITE_HAS_OCCURRED_$$output then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$falsebb10_0:
    ...
    v24$1 := $validr.0$1[1:0] == 1bv1;
    v24$2 := $validr.0$2[1:0] == 1bv1;
    p17$1 := (if v24$1 then v24$1 else p17$1);
    p17$2 := (if v24$2 then v24$2 else p17$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v25$1 := (if p17$1 then _HAVOC_bv32$1 else v25$1);
    v25$2 := (if p17$2 then _HAVOC_bv32$2 else v25$2);
    $$infront$1[3bv32] := (if p17$1 then v25$1 else $$infront$1[3bv32]);
    $$infront$2[3bv32] := (if p17$2 then v25$2 else $$infront$2[3bv32]);
  ...
  __partitioned_block_$falsebb10_1:
    call {:sourceloc_num 55} $bugle_barrier_duplicated_0(1bv1, 1bv1);
    v27$1 := BV32_SLT(local_id_y$1, 4bv32);
    v27$2 := BV32_SLT(local_id_y$2, 4bv32);
    ...
    call {:sourceloc} {:sourceloc_num 58} _LOG_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p19$1, BV32_ADD(BV32_MUL(local_id_y$1, 40bv32), v4$1), v28$1, $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 40bv32), v4$1)]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 58} _CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p19$2, BV32_ADD(BV32_MUL(local_id_y$2, 40bv32), v4$2), v28$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile"} true;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 40bv32), v4$1)] := (if p19$1 then v28$1 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 40bv32), v4$1)]);
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 40bv32), v4$2)] := (if p19$2 then v28$2 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 40bv32), v4$2)]);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v29$1 := (if p19$1 then _HAVOC_bv32$1 else v29$1);
    v29$2 := (if p19$2 then _HAVOC_bv32$2 else v29$2);
    call {:sourceloc} {:sourceloc_num 60} _LOG_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p19$1, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4bv32), 40bv32), v4$1), v29$1, $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4bv32), 40bv32), v4$1)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 60} _CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p19$2, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$2, group_size_y), 4bv32), 40bv32), v4$2), v29$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile"} true;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4bv32), 40bv32), v4$1)] := (if p19$1 then v29$1 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4bv32), 40bv32), v4$1)]);
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$2, group_size_y), 4bv32), 40bv32), v4$2)] := (if p19$2 then v29$2 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$2, group_size_y), 4bv32), 40bv32), v4$2)]);
    v30$1 := BV32_SLT(local_id_x$1, 4bv32);
    v30$2 := BV32_SLT(local_id_x$2, 4bv32);
    ...
    call {:sourceloc} {:sourceloc_num 64} _LOG_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p21$1, BV32_ADD(BV32_MUL(v5$1, 40bv32), local_id_x$1), v31$1, $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 64} _CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p21$2, BV32_ADD(BV32_MUL(v5$2, 40bv32), local_id_x$2), v31$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile"} true;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), local_id_x$1)] := (if p21$1 then v31$1 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), local_id_x$1)]);
    ...
    call {:sourceloc} {:sourceloc_num 66} _LOG_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p21$1, BV32_ADD(BV32_MUL(v5$1, 40bv32), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4bv32)), v32$1, $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4bv32))]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 66} _CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(p21$2, BV32_ADD(BV32_MUL(v5$2, 40bv32), BV32_ADD(BV32_ADD(local_id_x$2, group_size_x), 4bv32)), v32$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile"} true;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4bv32))] := (if p21$1 then v32$1 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4bv32))]);
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v5$2, 40bv32), BV32_ADD(BV32_ADD(local_id_x$2, group_size_x), 4bv32))] := (if p21$2 then v32$2 else $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v5$2, 40bv32), BV32_ADD(BV32_ADD(local_id_x$2, group_size_x), 4bv32))]);
    call {:sourceloc} {:sourceloc_num 68} _LOG_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(true, BV32_ADD(BV32_MUL(v5$1, 40bv32), v4$1), v21$1, $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), v4$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 68} _CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile(true, BV32_ADD(BV32_MUL(v5$2, 40bv32), v4$2), v21$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile"} true;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[1bv1][BV32_ADD(BV32_MUL(v5$1, 40bv32), v4$1)] := v21$1;
    $$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v5$2, 40bv32), v4$2)] := v21$2;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $i4.0) ) ,  (  BV32_SLE($i4.0, 1bv32) ) ,  (  BV32_SGE($i4.0, 1bv32) ) ,  (  BV32_ULE($i4.0, 1bv32) ) ,  (  BV32_UGE($i4.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 40bv32), BV32_ADD(local_id_x$1, 4bv32))) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 40bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(local_id_y$1, 4bv32)), 40bv32), BV32_ADD(local_id_x$1, 4bv32))) )  ); 
  ...
  $falsebb14:
    ...
    v42$1 := $validw.0$1[1:0] == 1bv1;
    v42$2 := $validw.0$2[1:0] == 1bv1;
  ...
  $truebb6:
    assume {:partition} v15;
    v16$1 := $validr.0$1[1:0] == 1bv1;
    v16$2 := $validr.0$2[1:0] == 1bv1;
  ...
  $truebb3:
    assume {:partition} v10;
    v11$1 := $validr.0$1[1:0] == 1bv1;
    v11$2 := $validr.0$2[1:0] == 1bv1;
    p11$1 := (if v11$1 then v11$1 else p11$1);
    p11$2 := (if v11$2 then v11$2 else p11$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v12$1 := (if p11$1 then _HAVOC_bv32$1 else v12$1);
    v12$2 := (if p11$2 then _HAVOC_bv32$2 else v12$2);
