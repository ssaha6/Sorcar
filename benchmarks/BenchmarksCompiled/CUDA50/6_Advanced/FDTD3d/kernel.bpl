...
implementation {:source_name "FiniteDifferencesKernel"} {:kernel} $_Z23FiniteDifferencesKernelPfPKfiii($dimx: bv32, $dimy: bv32, $dimz: bv32)
{
  ...
  $for.cond:
    ...
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_UGE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_ULE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SGE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SLE($i.0, 2bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b2 ==> BV32_SLE(0bv32, $i.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 2bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(4bv32, v2), 4bv32), BV32_ADD(BV32_MUL(v1$1, v2), v0$1)));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(4bv32, v2), 4bv32), BV32_ADD(BV32_MUL(v1$2, v2), v0$2)));
  ...
  $for.cond.55:
    ...
    assert {:tag "nowrite"} _b22 ==> !_WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile;
    assert {:tag "noread"} _b21 ==> !_READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _WRITE_HAS_OCCURRED_$$output ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), BV32_ADD($inputIndex.0$1, BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32))));
    assert {:tag "nowrite"} _b19 ==> !_WRITE_HAS_OCCURRED_$$output;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_UGE($iz.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_ULE($iz.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SGE($iz.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SLE($iz.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b9 ==> BV32_SLE(0bv32, $iz.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b8 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $outputIndex.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b8 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $outputIndex.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.2$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.1$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.2$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_ADD($dimx, 8bv32), BV32_ADD($dimy, 8bv32)), 1bv32), $inputIndex.1$2);
