...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $i1.0) ) ,  (  BV32_SLE($i1.0, 16bv32) ) ,  (  BV32_SGE($i1.0, 16bv32) ) ,  (  BV32_ULE($i1.0, 16bv32) ) ,  (  BV32_UGE($i1.0, 16bv32) ) ,  true ,  (  $i1.0 == 0bv32 || BV32_AND($i1.0, BV32_SUB($i1.0, 1bv32)) == 0bv32 ) ,  (  $i1.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ) ,  (  _READ_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
