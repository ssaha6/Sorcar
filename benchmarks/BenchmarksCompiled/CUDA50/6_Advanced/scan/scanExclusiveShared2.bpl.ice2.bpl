...
assert  my_inv (  (  BV32_SLE($offset.i.i.0, 1bv32) ) ,  (  BV32_SGE($offset.i.i.0, 1bv32) ) ,  (  BV32_ULE($offset.i.i.0, 1bv32) ) ,  (  BV32_UGE($offset.i.i.0, 1bv32) ) ,  (  $offset.i.i.0 == 0bv32 || BV32_AND($offset.i.i.0, BV32_SUB($offset.i.i.0, 1bv32)) == 0bv32 ) ,  (  $offset.i.i.0 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2bv32, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB($arrayLength, 1bv32))), $arrayLength) )  ); 


    assert {:block_sourceloc} {:sourceloc_num 9} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 10} {:thread 1} (if _WRITE_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ==> BV32_OR(BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == v5$1 then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_SUB(v5$1, $arrayLength) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
