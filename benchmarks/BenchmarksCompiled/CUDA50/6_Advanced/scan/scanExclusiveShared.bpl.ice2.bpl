...
assert  my_inv (  (  BV32_SLE($offset.i.i.i.i.0, 1bv32) ) ,  (  BV32_SGE($offset.i.i.i.i.0, 1bv32) ) ,  (  BV32_ULE($offset.i.i.i.i.0, 1bv32) ) ,  (  BV32_UGE($offset.i.i.i.i.0, 1bv32) ) ,  (  $offset.i.i.i.i.0 == 0bv32 || BV32_AND($offset.i.i.i.i.0, BV32_SUB($offset.i.i.i.i.0, 1bv32)) == 0bv32 ) ,  (  $offset.i.i.i.i.0 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2bv32, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB(BV32_UDIV($size, 4bv32), 1bv32))), BV32_UDIV($size, 4bv32)) )  ); 


    assert {:block_sourceloc} {:sourceloc_num 54} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 55} {:thread 1} (if _WRITE_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data ==> BV32_OR(BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == v30$1 then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_SUB(v30$1, v28) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 109} _LOG_WRITE_$$d_Dst(true, BV32_MUL(v0$1, 4bv32), v60$1, $$d_Dst[BV32_MUL(v0$1, 4bv32)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 109} _CHECK_WRITE_$$d_Dst(true, BV32_MUL(v0$2, 4bv32), v60$2);
    ...
    call {:sourceloc} {:sourceloc_num 111} _LOG_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32), v61$1, $$d_Dst[BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 111} _CHECK_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 1bv32), v61$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    ...
    call {:sourceloc} {:sourceloc_num 113} _LOG_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32), v62$1, $$d_Dst[BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 113} _CHECK_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 2bv32), v62$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    ...
    call {:sourceloc} {:sourceloc_num 115} _LOG_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32), v63$1, $$d_Dst[BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 115} _CHECK_WRITE_$$d_Dst(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 3bv32), v63$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
  ...
  __partitioned_block_$truebb_1:
    call {:sourceloc_num 57} $bugle_barrier_duplicated_0(1bv1, 1bv1);
