...
implementation {:source_name "reduceSinglePass<128, true>"} {:kernel} $_Z16reduceSinglePassILj128ELb1EEvPKfPfj($n: bv32)
{
  ...
  $while.cond:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$g_odata ==> v23$1[1:0] == 1bv1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$g_odata ==> BV32_UGT(num_groups_x, 1bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_UGT(num_groups_x, 1bv32) && v23$1[1:0] == 1bv1 && BV32_ULT($i.0$1, num_groups_x) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_UGT(num_groups_x, 1bv32) && v23$2[1:0] == 1bv1 && BV32_ULT($i.0$2, num_groups_x) ==> p12$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p12$1 ==> _b5 ==> p12$1 ==> BV32_UGT(num_groups_x, 1bv32) && v23$1[1:0] == 1bv1;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p12$2 ==> _b5 ==> p12$2 ==> BV32_UGT(num_groups_x, 1bv32) && v23$2[1:0] == 1bv1;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p12$1 ==> _b0 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $i.0$1) == BV32_AND(BV32_SUB(128bv32, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p12$2 ==> _b0 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $i.0$2) == BV32_AND(BV32_SUB(128bv32, 1bv32), local_id_x$2);
