...
assert  my_inv (  (  BV32_SLE($k.0, 2bv32) ) ,  (  BV32_SGE($k.0, 2bv32) ) ,  (  BV32_ULE($k.0, 2bv32) ) ,  (  BV32_UGE($k.0, 2bv32) ) ,  true ,  true ,  true ,  true ,  (  $k.0 == 0bv32 || BV32_AND($k.0, BV32_SUB($k.0, 1bv32)) == 0bv32 ) ,  (  $k.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$shared ) ,  (  !_WRITE_HAS_OCCURRED_$$shared ) ,  (  _READ_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  (  BV32_SLE($j.0, BV32_UDIV($k.0, 2bv32)) ) ,  (  BV32_SGE($j.0, BV32_UDIV($k.0, 2bv32)) ) ,  (  BV32_ULE($j.0, BV32_UDIV($k.0, 2bv32)) ) ,  (  BV32_UGE($j.0, BV32_UDIV($k.0, 2bv32)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !_READ_HAS_OCCURRED_$$shared ) ,  (  !_WRITE_HAS_OCCURRED_$$shared ) ,  (  _READ_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 )  ); 
