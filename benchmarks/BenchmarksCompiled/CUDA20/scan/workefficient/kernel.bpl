...
implementation {:source_name "scan_workefficient_kernel"} {:kernel} $_Z25scan_workefficient_kernelPfS_i($n: bv32)
{
  ...
  $for.cond.46:
    ...
    assert {:tag "relationalPow2"} _b87 ==> ($offset.1 == 0bv32 && $d45.0 == 2bv32) || BV32_MUL($d45.0, $offset.1) == 1bv32;
    assert {:tag "relationalPow2"} _b86 ==> BV32_MUL($d45.0, $offset.1) == 1bv32;
    assert {:tag "relationalPow2"} _b85 ==> ($offset.1 == 0bv32 && $d45.0 == 4bv32) || BV32_MUL($d45.0, $offset.1) == 2bv32;
    assert {:tag "relationalPow2"} _b84 ==> BV32_MUL($d45.0, $offset.1) == 2bv32;
    assert {:tag "relationalPow2"} _b83 ==> ($offset.1 == 0bv32 && $d45.0 == 8bv32) || BV32_MUL($d45.0, $offset.1) == 4bv32;
    assert {:tag "relationalPow2"} _b82 ==> BV32_MUL($d45.0, $offset.1) == 4bv32;
    assert {:tag "relationalPow2"} _b81 ==> ($offset.1 == 0bv32 && $d45.0 == 16bv32) || BV32_MUL($d45.0, $offset.1) == 8bv32;
    assert {:tag "relationalPow2"} _b80 ==> BV32_MUL($d45.0, $offset.1) == 8bv32;
    assert {:tag "relationalPow2"} _b79 ==> ($offset.1 == 0bv32 && $d45.0 == 32bv32) || BV32_MUL($d45.0, $offset.1) == 16bv32;
    assert {:tag "relationalPow2"} _b78 ==> BV32_MUL($d45.0, $offset.1) == 16bv32;
    assert {:tag "relationalPow2"} _b77 ==> ($offset.1 == 0bv32 && $d45.0 == 64bv32) || BV32_MUL($d45.0, $offset.1) == 32bv32;
    assert {:tag "relationalPow2"} _b76 ==> BV32_MUL($d45.0, $offset.1) == 32bv32;
    assert {:tag "relationalPow2"} _b75 ==> ($offset.1 == 0bv32 && $d45.0 == 128bv32) || BV32_MUL($d45.0, $offset.1) == 64bv32;
    assert {:tag "relationalPow2"} _b74 ==> BV32_MUL($d45.0, $offset.1) == 64bv32;
    assert {:tag "relationalPow2"} _b73 ==> ($offset.1 == 0bv32 && $d45.0 == 256bv32) || BV32_MUL($d45.0, $offset.1) == 128bv32;
    assert {:tag "relationalPow2"} _b72 ==> BV32_MUL($d45.0, $offset.1) == 128bv32;
    assert {:tag "relationalPow2"} _b71 ==> ($offset.1 == 0bv32 && $d45.0 == 512bv32) || BV32_MUL($d45.0, $offset.1) == 256bv32;
    assert {:tag "relationalPow2"} _b70 ==> BV32_MUL($d45.0, $offset.1) == 256bv32;
    assert {:tag "relationalPow2"} _b69 ==> ($offset.1 == 0bv32 && $d45.0 == 1024bv32) || BV32_MUL($d45.0, $offset.1) == 512bv32;
    assert {:tag "relationalPow2"} _b68 ==> BV32_MUL($d45.0, $offset.1) == 512bv32;
    assert {:tag "relationalPow2"} _b67 ==> ($offset.1 == 0bv32 && $d45.0 == 2048bv32) || BV32_MUL($d45.0, $offset.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b66 ==> BV32_MUL($d45.0, $offset.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b65 ==> ($offset.1 == 0bv32 && $d45.0 == 4096bv32) || BV32_MUL($d45.0, $offset.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b64 ==> BV32_MUL($d45.0, $offset.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b63 ==> ($offset.1 == 0bv32 && $d45.0 == 8192bv32) || BV32_MUL($d45.0, $offset.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b62 ==> BV32_MUL($d45.0, $offset.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b61 ==> ($offset.1 == 0bv32 && $d45.0 == 16384bv32) || BV32_MUL($d45.0, $offset.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b60 ==> BV32_MUL($d45.0, $offset.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b59 ==> ($offset.1 == 0bv32 && $d45.0 == 32768bv32) || BV32_MUL($d45.0, $offset.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b58 ==> BV32_MUL($d45.0, $offset.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b57 ==> ($offset.1 == 0bv32 && $d45.0 == 65536bv32) || BV32_MUL($d45.0, $offset.1) == 32768bv32;
    assert {:tag "relationalPow2"} _b56 ==> BV32_MUL($d45.0, $offset.1) == 32768bv32;
    assert {:tag "pow2NotZero"} _b55 ==> v10 != 0bv32;
    assert {:tag "pow2"} _b54 ==> v10 == 0bv32 || BV32_AND(v10, BV32_SUB(v10, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b53 ==> $d45.0 != 0bv32;
    assert {:tag "pow2"} _b52 ==> $d45.0 == 0bv32 || BV32_AND($d45.0, BV32_SUB($d45.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ25scan_workefficient_kernelPfS_iE4temp ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ25scan_workefficient_kernelPfS_iE4temp ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($d45.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $d45.0);
  ...
  __partitioned_block_$truebb2_1:
    ...
    v11$1 := BV32_SLT(local_id_x$1, $d45.0);
    v11$2 := BV32_SLT(local_id_x$2, $d45.0);
