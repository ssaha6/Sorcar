...
assert  my_inv (  (  BV32_SLE(0bv32, $offset.0) ) ,  (  BV32_SLE($offset.0, 1bv32) ) ,  (  BV32_SGE($offset.0, 1bv32) ) ,  (  BV32_ULE($offset.0, 1bv32) ) ,  (  BV32_UGE($offset.0, 1bv32) ) ,  (  $offset.0 == 0bv32 || BV32_AND($offset.0, BV32_SUB($offset.0, 1bv32)) == 0bv32 ) ,  (  $offset.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ) ,  (  _READ_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) )  ); 
