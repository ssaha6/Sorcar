...
assert  my_inv (  (  BV32_SLE(0bv32, $d.0) ) ,  (  BV32_SLE($d.0, group_size_x) ) ,  (  BV32_SGE($d.0, group_size_x) ) ,  (  BV32_ULE($d.0, group_size_x) ) ,  (  BV32_UGE($d.0, group_size_x) ) ,  true ,  true ,  true ,  true ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  $d.0 == 0bv32 || BV32_AND($d.0, BV32_SUB($d.0, 1bv32)) == 0bv32 ) ,  (  $d.0 != 0bv32 ) ,  (  v12 == 0bv32 || BV32_AND(v12, BV32_SUB(v12, 1bv32)) == 0bv32 ) ,  (  v12 != 0bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 65536bv32) || BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32768bv32) || BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16384bv32) || BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8192bv32) || BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4096bv32) || BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2048bv32) || BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 1024bv32) || BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 512bv32) || BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 256bv32) || BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 128bv32) || BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 64bv32) || BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32bv32) || BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16bv32) || BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8bv32) || BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4bv32) || BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2bv32) || BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data ==> local_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $stride.0), 2bv32), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data ==> local_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $stride.0), 2bv32), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 16} true;
    assert {:originated_from_invariant} {:sourceloc_num 17} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _WRITE_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data then 1bv1 else 0bv1))) != 0bv32 ==> local_id_x$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 18} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _READ_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data then 1bv1 else 0bv1))) != 0bv32 ==> local_id_x$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  $18:
    ...
    call {:sourceloc} {:sourceloc_num 33} _LOG_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p5$1, v22$1, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v22$1]);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 33} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 33} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p5$2, v22$2, $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v22$2]);
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_WRITE_$$g_blockSums(p5$1, $2$1, v24$1, $$g_blockSums[$2$1]);
    ...
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 34} _CHECK_WRITE_$$g_blockSums(p5$2, $2$2, v24$2);
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p4$1, v22$1, 0bv32, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v22$1]);
    ...
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p4$2, v22$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($d1.0, 1bv32) ) ,  (  BV32_SGE($d1.0, 1bv32) ) ,  (  BV32_ULE($d1.0, 1bv32) ) ,  (  BV32_UGE($d1.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride.1 == 0bv32 || BV32_AND($stride.1, BV32_SUB($stride.1, 1bv32)) == 0bv32 ) ,  (  $stride.1 != 0bv32 ) ,  (  $d1.0 == 0bv32 || BV32_AND($d1.0, BV32_SUB($d1.0, 1bv32)) == 0bv32 ) ,  (  $d1.0 != 0bv32 ) ,  (  v26 == 0bv32 || BV32_AND(v26, BV32_SUB(v26, 1bv32)) == 0bv32 ) ,  (  v26 != 0bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 65536bv32) || BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32768bv32) || BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16384bv32) || BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8192bv32) || BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4096bv32) || BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2048bv32) || BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 1024bv32) || BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 512bv32) || BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 256bv32) || BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 128bv32) || BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 64bv32) || BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32bv32) || BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16bv32) || BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8bv32) || BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4bv32) || BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2bv32) || BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ1kPfPKfS_iiiiiE6s_data )  ); 
  ...
  __partitioned_block_$falsebb7_1:
    ...
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 52} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 52} _CHECK_WRITE_$$g_odata(true, v1$2, v35$2);
  ...
  $falsebb9:
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 60} _CHECK_WRITE_$$g_odata(true, v2$2, v39$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
    $$g_odata[v2$1] := v39$1;
    $$g_odata[v2$2] := v39$2;
    goto $33;
  ...
  $truebb9:
    ...
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 56} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 56} _CHECK_WRITE_$$g_odata(p10$2, v2$2, v38$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
  ...
  __partitioned_block_$truebb7_1:
    ...
    call {:sourceloc} {:sourceloc_num 42} _LOG_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$1, v30$1, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v30$1]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 42} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 42} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$2, v30$2, $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v30$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 43} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$2, v31$2, $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v31$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 44} _LOG_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$1, v30$1, v33$1, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v30$1]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 44} _CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$2, v30$2, v33$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 45} _LOG_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$1, v31$1, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v31$1]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 45} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 45} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$2, v31$2, $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v31$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 46} _LOG_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$1, v31$1, FADD32(v34$1, v32$1), $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v31$1]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 46} _CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p9$2, v31$2, FADD32(v34$2, v32$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
  ...
  __partitioned_block_$truebb2_1:
    call {:sourceloc_num 20} $bugle_barrier_duplicated_2(1bv1, 1bv1);
    ...
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$1, BV32_ADD(v14$1, BV32_ASHR(v14$1, 4bv32)), $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][BV32_ADD(v14$1, BV32_ASHR(v14$1, 4bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 22} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$2, BV32_ADD(v14$2, BV32_ASHR(v14$2, 4bv32)), $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v14$2, BV32_ASHR(v14$2, 4bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$1, v16$1, $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v16$1]);
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$2, v16$2, $$_ZZ1kPfPKfS_iiiiiE6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v16$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 24} _LOG_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$1, v16$1, FADD32(v18$1, v17$1), $$_ZZ1kPfPKfS_iiiiiE6s_data[1bv1][v16$1]);
    ...
    call {:check_id "check_state_18"} {:sourceloc} {:sourceloc_num 24} _CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data(p3$2, v16$2, FADD32(v18$2, v17$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ1kPfPKfS_iiiiiE6s_data"} true;
