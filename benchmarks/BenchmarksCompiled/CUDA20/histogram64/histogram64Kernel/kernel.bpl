...
implementation {:source_name "histogram64Kernel"} {:kernel} $_Z17histogram64KernelPjS_i($dataN: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b24 ==> _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 128bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 128bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 128bv32), local_id_x$1));
  ...
  $10:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_ULT(local_id_x$1, 64bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b22 ==> BV32_ULT(local_id_x$1, 64bv32) && BV32_SLT($j.0$1, 128bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b22 ==> BV32_ULT(local_id_x$2, 64bv32) && BV32_SLT($j.0$2, 128bv32) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b21 ==> p4$1 ==> BV32_ULT(local_id_x$1, 64bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b21 ==> p4$2 ==> BV32_ULT(local_id_x$2, 64bv32);
