...
assert  my_inv (  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 128bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 128bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 128bv32), local_id_x$1)) ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $pos.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $pos.0$2) ) ,  ( p0$1 ==> BV32_SLE($pos.0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && ( p0$2 ==> BV32_SLE($pos.0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SGE($pos.0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && ( p0$2 ==> BV32_SGE($pos.0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  ( p0$1 ==> BV32_ULE($pos.0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && ( p0$2 ==> BV32_ULE($pos.0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  ( p0$1 ==> BV32_UGE($pos.0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && ( p0$2 ==> BV32_UGE($pos.0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  (  BV32_SLT($pos.0$1, $dataN) ==> p0$1 )  && (  BV32_SLT($pos.0$2, $dataN) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 7} p0$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 8} {:thread 1} (if 1bv1 == 1bv1 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_AND(127bv32, BV32_SUB(_WATCHED_OFFSET, BV32_MUL(BV32_AND(BV32_LSHR($data4.0$1, 26bv32), 63bv32), 128bv32))) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 9} {:thread 1} (if 1bv1 == 1bv1 ==> _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_AND(127bv32, BV32_SUB(_WATCHED_OFFSET, BV32_MUL(BV32_AND(BV32_LSHR($data4.0$1, 26bv32), 63bv32), 128bv32))) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    ...
    v5$1 := (if p1$1 then BV32_ADD(v0$1, BV32_MUL(BV32_AND(BV32_LSHR(v4$1, 2bv32), 63bv32), 128bv32)) else v5$1);
    v5$2 := (if p1$2 then BV32_ADD(v0$2, BV32_MUL(BV32_AND(BV32_LSHR(v4$2, 2bv32), 63bv32), 128bv32)) else v5$2);
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$1, v5$1, BV8_ADD(v6$1, 1bv8), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v5$1]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$2, v5$2, BV8_ADD(v6$2, 1bv8));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v5$1] := (if p1$1 then BV8_ADD(v6$1, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v5$1]);
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v5$2] := (if p1$2 then BV8_ADD(v6$2, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v5$2]);
    v7$1 := (if p1$1 then BV32_ADD(v0$1, BV32_MUL(BV32_AND(BV32_LSHR(v4$1, 10bv32), 63bv32), 128bv32)) else v7$1);
    v7$2 := (if p1$2 then BV32_ADD(v0$2, BV32_MUL(BV32_AND(BV32_LSHR(v4$2, 10bv32), 63bv32), 128bv32)) else v7$2);
    ...
    call {:sourceloc} {:sourceloc_num 15} _LOG_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$1, v7$1, BV8_ADD(v8$1, 1bv8), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v7$1]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 15} _CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$2, v7$2, BV8_ADD(v8$2, 1bv8));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v7$1] := (if p1$1 then BV8_ADD(v8$1, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v7$1]);
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v7$2] := (if p1$2 then BV8_ADD(v8$2, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v7$2]);
    v9$1 := (if p1$1 then BV32_ADD(v0$1, BV32_MUL(BV32_AND(BV32_LSHR(v4$1, 18bv32), 63bv32), 128bv32)) else v9$1);
    v9$2 := (if p1$2 then BV32_ADD(v0$2, BV32_MUL(BV32_AND(BV32_LSHR(v4$2, 18bv32), 63bv32), 128bv32)) else v9$2);
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$1, v9$1, BV8_ADD(v10$1, 1bv8), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v9$1]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$2, v9$2, BV8_ADD(v10$2, 1bv8));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v9$1] := (if p1$1 then BV8_ADD(v10$1, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v9$1]);
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v9$2] := (if p1$2 then BV8_ADD(v10$2, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v9$2]);
    v11$1 := (if p1$1 then BV32_ADD(v0$1, BV32_MUL(BV32_AND(BV32_LSHR(v4$1, 26bv32), 63bv32), 128bv32)) else v11$1);
    v11$2 := (if p1$2 then BV32_ADD(v0$2, BV32_MUL(BV32_AND(BV32_LSHR(v4$2, 26bv32), 63bv32), 128bv32)) else v11$2);
    ...
    call {:sourceloc} {:sourceloc_num 19} _LOG_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$1, v11$1, BV8_ADD(v12$1, 1bv8), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v11$1]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 19} _CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p1$2, v11$2, BV8_ADD(v12$2, 1bv8));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v11$1] := (if p1$1 then BV8_ADD(v12$1, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][v11$1]);
    $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v11$2] := (if p1$2 then BV8_ADD(v12$2, 1bv8) else $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v11$2]);
  ...
  __partitioned_block_$5.tail_1:
    ...
    v13$1 := BV32_ULT(local_id_x$1, 64bv32);
    v13$2 := BV32_ULT(local_id_x$2, 64bv32);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p3$1 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist$ghost$$10 == _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> BV32_SLE(0bv32, $j.0$1) )  && ( p4$2 ==> BV32_SLE(0bv32, $j.0$2) ) ,  ( p4$1 ==> BV32_SLE($j.0$1, 0bv32) )  && ( p4$2 ==> BV32_SLE($j.0$2, 0bv32) ) ,  ( p4$1 ==> BV32_SGE($j.0$1, 0bv32) )  && ( p4$2 ==> BV32_SGE($j.0$2, 0bv32) ) ,  ( p4$1 ==> BV32_ULE($j.0$1, 0bv32) )  && ( p4$2 ==> BV32_ULE($j.0$2, 0bv32) ) ,  ( p4$1 ==> BV32_UGE($j.0$1, 0bv32) )  && ( p4$2 ==> BV32_UGE($j.0$2, 0bv32) ) ,  ( p4$1 ==> BV32_SLE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15bv32), 4bv32)) )  && ( p4$2 ==> BV32_SLE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15bv32), 4bv32)) ) ,  ( p4$1 ==> BV32_SGE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15bv32), 4bv32)) )  && ( p4$2 ==> BV32_SGE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15bv32), 4bv32)) ) ,  ( p4$1 ==> BV32_ULE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15bv32), 4bv32)) )  && ( p4$2 ==> BV32_ULE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15bv32), 4bv32)) ) ,  ( p4$1 ==> BV32_UGE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15bv32), 4bv32)) )  && ( p4$2 ==> BV32_UGE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15bv32), 4bv32)) ) ,  ( p4$1 ==> p4$1 ==> BV32_ULT(local_id_x$1, 64bv32) )  && ( p4$2 ==> p4$2 ==> BV32_ULT(local_id_x$2, 64bv32) ) ,  (  BV32_ULT(local_id_x$1, 64bv32) && BV32_SLT($j.0$1, 128bv32) ==> p4$1 )  && (  BV32_ULT(local_id_x$2, 64bv32) && BV32_SLT($j.0$2, 128bv32) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_ULT(local_id_x$1, 64bv32) ) ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 24} p4$1 ==> true;
    v14$1 := (if p4$1 then BV32_SLT($j.0$1, 128bv32) else v14$1);
    v14$2 := (if p4$2 then BV32_SLT($j.0$2, 128bv32) else v14$2);
    p5$1 := false;
    p5$2 := false;
    p6$1 := false;
    p6$2 := false;
    ...
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p5$1, BV32_ADD(BV32_MUL(local_id_x$1, 128bv32), $accumPos.0$1), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 128bv32), $accumPos.0$1)]);
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
    v15$1 := (if p5$1 then $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 128bv32), $accumPos.0$1)] else v15$1);
    v15$2 := (if p5$2 then $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_x$2, 128bv32), $accumPos.0$2)] else v15$2);
    v16$1 := (if p5$1 then BV32_ADD($accumPos.0$1, 1bv32) else v16$1);
    v16$2 := (if p5$2 then BV32_ADD($accumPos.0$2, 1bv32) else v16$2);
    v17$1 := (if p5$1 then v16$1 == 128bv32 else v17$1);
    v17$2 := (if p5$2 then v16$2 == 128bv32 else v17$2);
    ...
    $sum.0$1, $j.0$1, $accumPos.0$1 := (if p5$1 then BV32_ADD($sum.0$1, BV8_ZEXT32(v15$1)) else $sum.0$1), (if p5$1 then BV32_ADD($j.0$1, 1bv32) else $j.0$1), (if p5$1 then $accumPos.1$1 else $accumPos.0$1);
    $sum.0$2, $j.0$2, $accumPos.0$2 := (if p5$2 then BV32_ADD($sum.0$2, BV8_ZEXT32(v15$2)) else $sum.0$2), (if p5$2 then BV32_ADD($j.0$2, 1bv32) else $j.0$2), (if p5$2 then $accumPos.1$2 else $accumPos.0$2);
  ...
  $10.tail:
    assume !p4$1 && !p4$2;
    call {:sourceloc} {:sourceloc_num 31} _LOG_WRITE_$$d_Result(p3$1, BV32_ADD(BV32_MUL(group_id_x$1, 64bv32), local_id_x$1), $sum.0$1, $$d_Result[BV32_ADD(BV32_MUL(group_id_x$1, 64bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 31} _CHECK_WRITE_$$d_Result(p3$2, BV32_ADD(BV32_MUL(group_id_x$2, 64bv32), local_id_x$2), $sum.0$2);
