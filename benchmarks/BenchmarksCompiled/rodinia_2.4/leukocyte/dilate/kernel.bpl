...
implementation {:source_name "dilate_kernel"} {:kernel} $dilate_kernel($img_m: bv32, $img_n: bv32, $strel_m: bv32, $strel_n: bv32)
{
  ...
  $0:
    ...
    $max.0$1, $el_i.0$1 := (if p0$1 then 0bv32 else $max.0$1), (if p0$1 then 0bv32 else $el_i.0$1);
    $max.0$2, $el_i.0$2 := (if p0$2 then 0bv32 else $max.0$2), (if p0$2 then 0bv32 else $el_i.0$2);
  ...
  $2:
    ...
    v5$1 := (if p2$1 then BV32_ADD(BV32_SUB(v1$1, BV32_SDIV($strel_m, 2bv32)), $el_i.0$1) else v5$1);
    v5$2 := (if p2$2 then BV32_ADD(BV32_SUB(v1$2, BV32_SDIV($strel_m, 2bv32)), $el_i.0$2) else v5$2);
    v6$1 := (if p2$1 then BV32_SGE(v5$1, 0bv32) else v6$1);
    v6$2 := (if p2$2 then BV32_SGE(v5$2, 0bv32) else v6$2);
    ...
    $max.1$1, $el_j.0$1 := (if p6$1 then $max.0$1 else $max.1$1), (if p6$1 then 0bv32 else $el_j.0$1);
    $max.1$2, $el_j.0$2 := (if p6$2 then $max.0$2 else $max.1$2), (if p6$2 then 0bv32 else $el_j.0$2);
  ...
  $6:
    ...
    v9$1 := (if p8$1 then BV32_ADD(BV32_SUB(v2$1, BV32_SDIV($strel_n, 2bv32)), $el_j.0$1) else v9$1);
    v9$2 := (if p8$2 then BV32_ADD(BV32_SUB(v2$2, BV32_SDIV($strel_n, 2bv32)), $el_j.0$2) else v9$2);
    v10$1 := (if p8$1 then BV32_SGE(v9$1, 0bv32) else v10$1);
    v10$2 := (if p8$2 then BV32_SGE(v9$2, 0bv32) else v10$2);
    ...
    v13$1 := (if p12$1 then FLT32(0bv32, v12$1) || FLT32(v12$1, 0bv32) || FUNO32(v12$1, 0bv32) else v13$1);
    v13$2 := (if p12$2 then FLT32(0bv32, v12$2) || FLT32(v12$2, 0bv32) || FUNO32(v12$2, 0bv32) else v13$2);
    ...
    $max.1$1, $el_j.0$1 := (if p8$1 then $max.3$1 else $max.1$1), (if p8$1 then BV32_ADD($el_j.0$1, 1bv32) else $el_j.0$1);
    $max.1$2, $el_j.0$2 := (if p8$2 then $max.3$2 else $max.1$2), (if p8$2 then BV32_ADD($el_j.0$2, 1bv32) else $el_j.0$2);
  ...
  $6.tail:
    ...
    $max.0$1, $el_i.0$1 := (if p2$1 then $max.4$1 else $max.0$1), (if p2$1 then BV32_ADD($el_i.0$1, 1bv32) else $el_i.0$1);
    $max.0$2, $el_i.0$2 := (if p2$2 then $max.4$2 else $max.0$2), (if p2$2 then BV32_ADD($el_i.0$2, 1bv32) else $el_i.0$2);
