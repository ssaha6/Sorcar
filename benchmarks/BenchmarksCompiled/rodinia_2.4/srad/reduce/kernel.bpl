...
implementation {:source_name "reduce_kernel"} {:kernel} $reduce_kernel($d_Ne: bv64, $d_no: bv64, $d_mul: bv32, $gridDim: bv32)
{
  ...
  __partitioned_block_$14_0:
    ...
    assert {:tag "predicatedEquality"} _b76 ==> p7$1 && p7$2 ==> v23$1 == v23$2;
    ...
    assert {:tag "pow2NotZero"} _b67 ==> $i.1$2 != 0bv32;
    assert {:tag "pow2"} _b66 ==> $i.1$2 == 0bv32 || BV32_AND($i.1$2, BV32_SUB($i.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b65 ==> $i.1$1 != 0bv32;
    assert {:tag "pow2"} _b64 ==> $i.1$1 == 0bv32 || BV32_AND($i.1$1, BV32_SUB($i.1$1, 1bv32)) == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b58 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 != BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b57 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b56 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 != BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b55 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b54 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 != BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b53 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b52 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 != BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b51 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b50 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 != BV32_SUB($gridDim, 1bv32) && BV32_SLE($i.1$1, 512bv32) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b50 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 != BV32_SUB($gridDim, 1bv32) && BV32_SLE($i.1$2, 512bv32) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b49 ==> p7$1 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 != BV32_SUB($gridDim, 1bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b49 ==> p7$2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 != BV32_SUB($gridDim, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b48 ==> BV32_UGE($i.1$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b48 ==> BV32_UGE($i.1$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b47 ==> BV32_ULE($i.1$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b47 ==> BV32_ULE($i.1$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b46 ==> BV32_SGE($i.1$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b46 ==> BV32_SGE($i.1$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b45 ==> BV32_SLE($i.1$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b45 ==> BV32_SLE($i.1$2, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p7$1 ==> _b44 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.1$1, 2bv32) == BV32_SUB($i.1$2, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p7$2 ==> _b44 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.1$2, 2bv32) == BV32_SUB($i.1$1, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p7$1 ==> _b43 ==> BV32_SUB($i.1$1, 2bv32) == BV32_SUB($i.1$2, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p7$2 ==> _b43 ==> BV32_SUB($i.1$2, 2bv32) == BV32_SUB($i.1$1, 2bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p7$1 ==> _b42 ==> BV32_SLE(0bv32, $i.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p7$2 ==> _b42 ==> BV32_SLE(0bv32, $i.1$2);
  ...
  __partitioned_block_$29_0:
    ...
    assert {:tag "pow2NotZero"} _b92 ==> $i.3$2 != 0bv32;
    assert {:tag "pow2"} _b91 ==> $i.3$2 == 0bv32 || BV32_AND($i.3$2, BV32_SUB($i.3$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b90 ==> $i.3$1 != 0bv32;
    assert {:tag "pow2"} _b89 ==> $i.3$1 == 0bv32 || BV32_AND($i.3$1, BV32_SUB($i.3$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b11 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b10 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b8 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 == BV32_SUB($gridDim, 1bv32) && BV32_SLE($i.3$1, $df.0$1) ==> p18$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b8 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 == BV32_SUB($gridDim, 1bv32) && BV32_SLE($i.3$2, $df.0$2) ==> p18$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p18$1 ==> _b7 ==> p18$1 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p18$2 ==> _b7 ==> p18$2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 == BV32_SUB($gridDim, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b6 ==> BV32_UGE($i.3$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b6 ==> BV32_UGE($i.3$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b5 ==> BV32_ULE($i.3$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b5 ==> BV32_ULE($i.3$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b4 ==> BV32_SGE($i.3$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b4 ==> BV32_SGE($i.3$2, 2bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b3 ==> BV32_SLE($i.3$1, 2bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b3 ==> BV32_SLE($i.3$2, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p18$1 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.3$1, 2bv32) == BV32_SUB($i.3$2, 2bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p18$2 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($i.3$2, 2bv32) == BV32_SUB($i.3$1, 2bv32);
  ...
  $37:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b36 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _READ_HAS_OCCURRED_$$d_sums2 ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _READ_HAS_OCCURRED_$$d_sums2 ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b33 ==> _READ_HAS_OCCURRED_$$d_sums2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$d_sums ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$d_sums ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$d_sums ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == BV32_SUB($gridDim, 1bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b23 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 == BV32_SUB($gridDim, 1bv32) && local_id_x$1 == BV32_SUB($df.0$1, 1bv32) && BV32_SLT($i.4$1, BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0])) ==> p25$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b23 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 == BV32_SUB($gridDim, 1bv32) && local_id_x$2 == BV32_SUB($df.0$2, 1bv32) && BV32_SLT($i.4$2, BV32_ADD(BV32_MUL(group_id_x$2, 512bv32), BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0])) ==> p25$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p25$1 ==> _b22 ==> p25$1 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$1 == BV32_SUB($gridDim, 1bv32) && local_id_x$1 == BV32_SUB($df.0$1, 1bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p25$2 ==> _b22 ==> p25$2 ==> BV64_SUB(512bv64, BV64_SUB(BV32_SEXT64(BV32_MUL($gridDim, 512bv32)), $d_no))[32:0] != 512bv32 && group_id_x$2 == BV32_SUB($gridDim, 1bv32) && local_id_x$2 == BV32_SUB($df.0$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p25$1 ==> _b21 ==> BV32_UGE($i.4$1, BV32_ADD(BV32_MUL(v0$1, 512bv32), $df.0$1));
    assert {:tag "loopBound"} {:thread 2} p25$2 ==> _b21 ==> BV32_UGE($i.4$2, BV32_ADD(BV32_MUL(v0$2, 512bv32), $df.0$2));
    assert {:tag "loopBound"} {:thread 1} p25$1 ==> _b20 ==> BV32_ULE($i.4$1, BV32_ADD(BV32_MUL(v0$1, 512bv32), $df.0$1));
    assert {:tag "loopBound"} {:thread 2} p25$2 ==> _b20 ==> BV32_ULE($i.4$2, BV32_ADD(BV32_MUL(v0$2, 512bv32), $df.0$2));
    assert {:tag "loopBound"} {:thread 1} p25$1 ==> _b19 ==> BV32_SGE($i.4$1, BV32_ADD(BV32_MUL(v0$1, 512bv32), $df.0$1));
    assert {:tag "loopBound"} {:thread 2} p25$2 ==> _b19 ==> BV32_SGE($i.4$2, BV32_ADD(BV32_MUL(v0$2, 512bv32), $df.0$2));
    assert {:tag "loopBound"} {:thread 1} p25$1 ==> _b18 ==> BV32_SLE($i.4$1, BV32_ADD(BV32_MUL(v0$1, 512bv32), $df.0$1));
    assert {:tag "loopBound"} {:thread 2} p25$2 ==> _b18 ==> BV32_SLE($i.4$2, BV32_ADD(BV32_MUL(v0$2, 512bv32), $df.0$2));
    assert {:tag "guardNonNeg"} {:thread 1} p25$1 ==> _b17 ==> BV32_SLE(0bv32, $i.4$1);
    assert {:tag "guardNonNeg"} {:thread 2} p25$2 ==> _b17 ==> BV32_SLE(0bv32, $i.4$2);
  ...
  $4:
    ...
    assert {:tag "nowrite"} _b132 ==> !_WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2;
    assert {:tag "noread"} _b131 ==> !_READ_HAS_OCCURRED_$$reduce_kernel.d_psum2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b130 ==> _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b129 ==> _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b128 ==> !_WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum;
    assert {:tag "noread"} _b127 ==> !_READ_HAS_OCCURRED_$$reduce_kernel.d_psum;
    assert {:tag "pow2NotZero"} _b126 ==> $i.0 != 0bv32;
    assert {:tag "pow2"} _b125 ==> $i.0 == 0bv32 || BV32_AND($i.0, BV32_SUB($i.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reduce_kernel.d_psum2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reduce_kernel.d_psum ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b63 ==> BV32_UGE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b62 ==> BV32_ULE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b61 ==> BV32_SGE($i.0, 2bv32);
    assert {:tag "loopBound"} {:thread 1} _b60 ==> BV32_SLE($i.0, 2bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b59 ==> BV32_SLE(0bv32, $i.0);
