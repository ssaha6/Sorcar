...
assert  my_inv (  (  BV32_SLE(0bv32, $j.0) ) ,  (  BV32_SLE($j.0, 0bv32) ) ,  (  BV32_SGE($j.0, 0bv32) ) ,  (  BV32_ULE($j.0, 0bv32) ) ,  (  BV32_UGE($j.0, 0bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$variables ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$variables ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$variables ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $nelr), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $nelr), 1bv32), BV32_ADD(BV32_MUL(0bv32, $nelr), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$variables ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, group_size_x) )  ); 


    assert {:block_sourceloc} {:sourceloc_num 2} true;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$variables ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $nelr) == BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb:
    ...
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$variables(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_MUL($j.0, $nelr)), v1$1, $$variables[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_MUL($j.0, $nelr))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$variables(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_MUL($j.0, $nelr)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$variables(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_MUL($j.0, $nelr)), v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$variables"} true;
    $$variables[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_MUL($j.0, $nelr))] := v1$1;
