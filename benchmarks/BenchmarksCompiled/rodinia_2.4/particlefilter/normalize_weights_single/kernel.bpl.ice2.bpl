...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p4$1 ==> _READ_HAS_OCCURRED_$$weights$ghost$$6 == _READ_HAS_OCCURRED_$$weights ) ,  (  !p4$1 ==> _READ_HAS_OCCURRED_$$CDF$ghost$$6 == _READ_HAS_OCCURRED_$$CDF ) ,  (  !p4$1 ==> _WRITE_HAS_OCCURRED_$$CDF$ghost$$6 == _WRITE_HAS_OCCURRED_$$CDF )  ); 
...
assert  my_inv (  ( p5$1 ==> BV32_SLE(0bv32, $x.i.0$1) )  && ( p5$2 ==> BV32_SLE(0bv32, $x.i.0$2) ) ,  ( p5$1 ==> BV32_SLE($x.i.0$1, 1bv32) )  && ( p5$2 ==> BV32_SLE($x.i.0$2, 1bv32) ) ,  ( p5$1 ==> BV32_SGE($x.i.0$1, 1bv32) )  && ( p5$2 ==> BV32_SGE($x.i.0$2, 1bv32) ) ,  ( p5$1 ==> BV32_ULE($x.i.0$1, 1bv32) )  && ( p5$2 ==> BV32_ULE($x.i.0$2, 1bv32) ) ,  ( p5$1 ==> BV32_UGE($x.i.0$1, 1bv32) )  && ( p5$2 ==> BV32_UGE($x.i.0$2, 1bv32) ) ,  ( p5$1 ==> p5$1 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 )  && ( p5$2 ==> p5$2 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 ) ,  (  BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 && BV32_SLT($x.i.0$1, $Nparticles) ==> p5$1 )  && (  BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 && BV32_SLT($x.i.0$2, $Nparticles) ==> p5$2 ) ,  (  _READ_HAS_OCCURRED_$$weights ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 ) ,  (  _READ_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 ) ,  (  _WRITE_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 ) ,  true ,  true ,  true  ); 
