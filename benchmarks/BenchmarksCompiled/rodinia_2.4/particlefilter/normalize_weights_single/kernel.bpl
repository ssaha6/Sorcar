...
implementation {:source_name "normalize_weights_kernel"} {:kernel} $normalize_weights_kernel($Nparticles: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$weights$ghost$$for.cond.i: bool;
  var _READ_HAS_OCCURRED_$$CDF$ghost$$for.cond.i: bool;
  var _WRITE_HAS_OCCURRED_$$CDF$ghost$$for.cond.i: bool;
  ...
  __partitioned_block_$entry_2:
    ...
    _READ_HAS_OCCURRED_$$weights$ghost$$for.cond.i := _READ_HAS_OCCURRED_$$weights;
    _READ_HAS_OCCURRED_$$CDF$ghost$$for.cond.i := _READ_HAS_OCCURRED_$$CDF;
    _WRITE_HAS_OCCURRED_$$CDF$ghost$$for.cond.i := _WRITE_HAS_OCCURRED_$$CDF;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $for.cond.i;

  $for.cond.i:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b12 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$CDF$ghost$$for.cond.i == _WRITE_HAS_OCCURRED_$$CDF;
    assert {:tag "disabledMaintainsInstrumentation"} _b11 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$CDF$ghost$$for.cond.i == _READ_HAS_OCCURRED_$$CDF;
    assert {:tag "disabledMaintainsInstrumentation"} _b10 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$weights$ghost$$for.cond.i == _READ_HAS_OCCURRED_$$weights;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _WRITE_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$weights ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 && BV32_SLT($x.i.0$1, $Nparticles) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 && BV32_SLT($x.i.0$2, $Nparticles) ==> p5$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b5 ==> p5$1 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b5 ==> p5$2 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32;
