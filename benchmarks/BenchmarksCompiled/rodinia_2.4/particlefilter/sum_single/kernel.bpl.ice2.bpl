...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p0$1 ==> _READ_HAS_OCCURRED_$$partial_sums$ghost$$2 == _READ_HAS_OCCURRED_$$partial_sums )  ); 
...
assert  my_inv (  ( p1$1 ==> BV32_SLE(0bv32, $x.0$1) )  && ( p1$2 ==> BV32_SLE(0bv32, $x.0$2) ) ,  ( p1$1 ==> BV32_SLE($x.0$1, 0bv32) )  && ( p1$2 ==> BV32_SLE($x.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_SGE($x.0$1, 0bv32) )  && ( p1$2 ==> BV32_SGE($x.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_ULE($x.0$1, 0bv32) )  && ( p1$2 ==> BV32_ULE($x.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_UGE($x.0$1, 0bv32) )  && ( p1$2 ==> BV32_UGE($x.0$2, 0bv32) ) ,  ( p1$1 ==> p1$1 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 )  && ( p1$2 ==> p1$2 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 ) ,  (  BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 && BV32_SLT($x.0$1, BV32_ADD(BV32_UDIV($Nparticles, group_size_x), 1bv32)) ==> p1$1 )  && (  BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 && BV32_SLT($x.0$2, BV32_ADD(BV32_UDIV($Nparticles, group_size_x), 1bv32)) ==> p1$2 ) ,  (  _READ_HAS_OCCURRED_$$partial_sums ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32 ) ,  true  ); 
