...
implementation {:source_name "sum_kernel"} {:kernel} $sum_kernel($Nparticles: bv32)
{
  ...
  $2:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32 && BV32_SLT($x.0$2, BV32_ADD(BV32_UDIV($Nparticles, group_size_x), 1bv32)) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b5 ==> p1$1 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b5 ==> p1$2 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32;
