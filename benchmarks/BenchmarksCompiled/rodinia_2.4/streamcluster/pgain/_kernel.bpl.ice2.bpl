...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$coord_s$ghost$$3 == _WRITE_HAS_OCCURRED_$$coord_s ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p2$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p2$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p2$1 ==> BV32_SLE($i.0$1, 0bv32) )  && ( p2$2 ==> BV32_SLE($i.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_SGE($i.0$1, 0bv32) )  && ( p2$2 ==> BV32_SGE($i.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_ULE($i.0$1, 0bv32) )  && ( p2$2 ==> BV32_ULE($i.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_UGE($i.0$1, 0bv32) )  && ( p2$2 ==> BV32_UGE($i.0$2, 0bv32) ) ,  ( p2$1 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && local_id_x$1 == 0bv32 )  && ( p2$2 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && local_id_x$2 == 0bv32 ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && local_id_x$1 == 0bv32 && BV32_SLT($i.0$1, $dim) ==> p2$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && local_id_x$2 == 0bv32 && BV32_SLT($i.0$2, $dim) ==> p2$2 ) ,  (  _WRITE_HAS_OCCURRED_$$coord_s ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) ) ,  (  _WRITE_HAS_OCCURRED_$$coord_s ==> local_id_x$1 == 0bv32 ) ,  true ,  true  ); 
  ...
  __partitioned_block_$3.tail_1:
    ...
    $x_cost.0$1, $i1.0$1 := (if p0$1 then 0bv32 else $x_cost.0$1), (if p0$1 then 0bv32 else $i1.0$1);
    $x_cost.0$2, $i1.0$2 := (if p0$2 then 0bv32 else $x_cost.0$2), (if p0$2 then 0bv32 else $i1.0$2);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p0$1 ==> _READ_HAS_OCCURRED_$$coord_s$ghost$$8 == _READ_HAS_OCCURRED_$$coord_s )  ); 
...
assert  my_inv (  ( p5$1 ==> BV32_SLE(0bv32, $i1.0$1) )  && ( p5$2 ==> BV32_SLE(0bv32, $i1.0$2) ) ,  ( p5$1 ==> BV32_SLE($i1.0$1, 0bv32) )  && ( p5$2 ==> BV32_SLE($i1.0$2, 0bv32) ) ,  ( p5$1 ==> BV32_SGE($i1.0$1, 0bv32) )  && ( p5$2 ==> BV32_SGE($i1.0$2, 0bv32) ) ,  ( p5$1 ==> BV32_ULE($i1.0$1, 0bv32) )  && ( p5$2 ==> BV32_ULE($i1.0$2, 0bv32) ) ,  ( p5$1 ==> BV32_UGE($i1.0$1, 0bv32) )  && ( p5$2 ==> BV32_UGE($i1.0$2, 0bv32) ) ,  ( p5$1 ==> p5$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) )  && ( p5$2 ==> p5$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && BV32_SLT($i1.0$1, $dim) ==> p5$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && BV32_SLT($i1.0$2, $dim) ==> p5$2 ) ,  (  _READ_HAS_OCCURRED_$$coord_s ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    $x_cost.0$1, $i1.0$1 := (if p6$1 then FADD32($x_cost.0$1, FMUL32(FSUB32(v6$1, v7$1), FSUB32(v8$1, v9$1))) else $x_cost.0$1), (if p6$1 then BV32_ADD($i1.0$1, 1bv32) else $i1.0$1);
    $x_cost.0$2, $i1.0$2 := (if p6$2 then FADD32($x_cost.0$2, FMUL32(FSUB32(v6$2, v7$2), FSUB32(v8$2, v9$2))) else $x_cost.0$2), (if p6$2 then BV32_ADD($i1.0$2, 1bv32) else $i1.0$2);
