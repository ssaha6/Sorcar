...
implementation {:source_name "kernel_gpu_opencl"} {:kernel} $kernel_gpu_opencl($d_par_gpu: bv32, $d_dim_gpu: bv448)
{
  ...
  var _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond: bool;
  var _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond: bool;
  var _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond: bool;
  var _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond: bool;
  var _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond: bool;
  var _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.23: bool;
  var _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.23: bool;
  var _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35: bool;
  var _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond.35: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.35: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.35: bool;
  var _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39: bool;
  var _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond.39: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond.39: bool;
  var _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond.39: bool;
  ...
  $entry:
    ...
    _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond := _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assume {:captureState "loop_entry_state_4_0"} true;
    goto $while.cond;

  $while.cond:
    assume {:captureState "loop_head_state_4"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b78 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b77 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($wtx.0$1, 100bv32) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($wtx.0$2, 100bv32) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b6 ==> p1$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b6 ==> p1$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b5 ==> BV32_UGE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b5 ==> BV32_UGE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b4 ==> BV32_ULE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b4 ==> BV32_ULE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b3 ==> BV32_SGE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b3 ==> BV32_SGE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b2 ==> BV32_SLE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b2 ==> BV32_SLE($wtx.0$2, v1$2);
    assert {:tag "guardNonNeg"} {:thread 1} p1$1 ==> _b1 ==> BV32_SLE(0bv32, $wtx.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p1$2 ==> _b1 ==> BV32_SLE(0bv32, $wtx.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p1$1 ==> _b0 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.0$1) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p1$2 ==> _b0 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.0$2) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$2);
  ...
  __partitioned_block_$while.cond.tail_1:
    ...
    _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond := _READ_HAS_OCCURRED_$$d_fv_gpu;
    _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $for.cond;

  $for.cond:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b161 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b160 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b159 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_AND(BV32_SUB(128bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$1);
    assert {:tag "nowrite"} _b158 ==> !_WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "noread"} _b157 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b156 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b155 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b154 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b153 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32));
    assert {:tag "nowrite"} _b152 ==> !_WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "noread"} _b151 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b150 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b149 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    assert {:tag "noread"} _b148 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b147 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b146 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "nowrite"} _b145 ==> !_WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "noread"} _b144 ==> !_READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "predicatedEquality"} _b143 ==> p3$1 && p3$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b142 ==> p3$1 && p3$2 ==> v84$1 == v84$2;
    assert {:tag "predicatedEquality"} _b141 ==> p3$1 && p3$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b140 ==> p3$1 && p3$2 ==> v77$1 == v77$2;
    assert {:tag "predicatedEquality"} _b139 ==> p3$1 && p3$2 ==> v80$1 == v80$2;
    assert {:tag "predicatedEquality"} _b138 ==> p3$1 && p3$2 ==> v74$1 == v74$2;
    assert {:tag "predicatedEquality"} _b137 ==> p3$1 && p3$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b136 ==> p3$1 && p3$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b135 ==> p3$1 && p3$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b134 ==> p3$1 && p3$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b133 ==> p3$1 && p3$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b132 ==> p3$1 && p3$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b131 ==> p3$1 && p3$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b130 ==> p3$1 && p3$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b129 ==> p3$1 && p3$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b128 ==> p3$1 && p3$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b127 ==> p3$1 && p3$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b126 ==> p3$1 && p3$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b125 ==> p3$1 && p3$2 ==> v70$1 == v70$2;
    assert {:tag "predicatedEquality"} _b124 ==> p3$1 && p3$2 ==> v69$1 == v69$2;
    assert {:tag "predicatedEquality"} _b123 ==> p3$1 && p3$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b122 ==> p3$1 && p3$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b121 ==> p3$1 && p3$2 ==> v67$1 == v67$2;
    assert {:tag "predicatedEquality"} _b120 ==> p3$1 && p3$2 ==> v66$1 == v66$2;
    assert {:tag "predicatedEquality"} _b119 ==> p3$1 && p3$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b118 ==> p3$1 && p3$2 ==> v68$1 == v68$2;
    assert {:tag "predicatedEquality"} _b117 ==> p3$1 && p3$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b116 ==> p3$1 && p3$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b115 ==> p3$1 && p3$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b114 ==> p3$1 && p3$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b113 ==> p3$1 && p3$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b112 ==> p3$1 && p3$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b111 ==> p3$1 && p3$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b110 ==> p3$1 && p3$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b109 ==> p3$1 && p3$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b108 ==> p3$1 && p3$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b107 ==> p3$1 && p3$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b106 ==> p3$1 && p3$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b105 ==> p3$1 && p3$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b104 ==> p3$1 && p3$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b103 ==> p3$1 && p3$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b102 ==> p3$1 && p3$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b101 ==> p3$1 && p3$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b100 ==> p3$1 && p3$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b99 ==> p3$1 && p3$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b98 ==> p3$1 && p3$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b97 ==> p3$1 && p3$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b96 ==> p3$1 && p3$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b95 ==> p3$1 && p3$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b94 ==> p3$1 && p3$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b93 ==> p3$1 && p3$2 ==> v73$1 == v73$2;
    assert {:tag "predicatedEquality"} _b92 ==> p3$1 && p3$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b91 ==> p3$1 && p3$2 ==> v75$1 == v75$2;
    assert {:tag "predicatedEquality"} _b90 ==> p3$1 && p3$2 ==> v78$1 == v78$2;
    assert {:tag "predicatedEquality"} _b89 ==> p3$1 && p3$2 ==> v72$1 == v72$2;
    assert {:tag "predicatedEquality"} _b88 ==> p3$1 && p3$2 ==> v81$1 == v81$2;
    assert {:tag "predicatedEquality"} _b87 ==> p3$1 && p3$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b86 ==> p3$1 && p3$2 ==> v79$1 == v79$2;
    assert {:tag "predicatedEquality"} _b85 ==> p3$1 && p3$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b84 ==> p3$1 && p3$2 ==> $wtx.3$1 == $wtx.3$2;
    assert {:tag "predicatedEquality"} _b83 ==> p3$1 && p3$2 ==> $wtx.2$1 == $wtx.2$2;
    assert {:tag "predicatedEquality"} _b82 ==> p3$1 && p3$2 ==> $pointer.0$1 == $pointer.0$2;
    assert {:tag "predicatedEquality"} _b81 ==> p3$1 && p3$2 ==> $k.0$1 == $k.0$2;
    assert {:tag "loopPredicateEquality"} _b80 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p3$1 == p3$2;
    assert {:tag "loopPredicateEquality"} _b79 ==> p3$1 == p3$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b21 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b17 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1)) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b17 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2)) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b16 ==> p3$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b16 ==> p3$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b15 ==> BV32_UGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b15 ==> BV32_UGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b14 ==> BV32_ULE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b14 ==> BV32_ULE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b13 ==> BV32_SGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b13 ==> BV32_SGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b12 ==> BV32_SLE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b12 ==> BV32_SLE($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p3$1 ==> _b11 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($k.0$1, 0bv32) == BV32_SUB($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p3$2 ==> _b11 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($k.0$2, 0bv32) == BV32_SUB($k.0$1, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p3$1 ==> _b10 ==> BV32_SUB($k.0$1, 0bv32) == BV32_SUB($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p3$2 ==> _b10 ==> BV32_SUB($k.0$2, 0bv32) == BV32_SUB($k.0$1, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p3$1 ==> _b9 ==> BV32_SLE(0bv32, $k.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p3$2 ==> _b9 ==> BV32_SLE(0bv32, $k.0$2);
    ...
    _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.23 := _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.23 := _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $while.cond.23;

  $while.cond.23:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b165 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.23 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b164 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_AND(BV32_SUB(128bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$1);
    assert {:tag "disabledMaintainsInstrumentation"} _b163 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.23 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b162 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p7$1 ==> p3$1;
    assert p7$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b36 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b33 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b32 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1)) && BV32_SLT($wtx.2$1, 100bv32) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b32 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2)) && BV32_SLT($wtx.2$2, 100bv32) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b31 ==> p7$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b31 ==> p7$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b30 ==> BV32_UGE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b30 ==> BV32_UGE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b29 ==> BV32_ULE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b29 ==> BV32_ULE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b28 ==> BV32_SGE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b28 ==> BV32_SGE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b27 ==> BV32_SLE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b27 ==> BV32_SLE($wtx.2$2, v1$2);
    assert {:tag "guardNonNeg"} {:thread 1} p7$1 ==> _b26 ==> BV32_SLE(0bv32, $wtx.2$1);
    assert {:tag "guardNonNeg"} {:thread 2} p7$2 ==> _b26 ==> BV32_SLE(0bv32, $wtx.2$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b25 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.2$1) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b25 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.2$2) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$2);
    ...
    goto $while.cond.23.backedge, __partitioned_block_$while.cond.23.tail_0;

  __partitioned_block_$while.cond.23.tail_0:
    assume !p7$1 && !p7$2;
    goto __partitioned_block_$while.cond.23.tail_1;

  __partitioned_block_$while.cond.23.tail_1:
    ...
    _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35 := _READ_HAS_OCCURRED_$$d_fv_gpu;
    _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35 := _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond.35 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.35 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.35 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $while.cond.35;

  $while.cond.35:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b172 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$while.cond.35 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b171 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$while.cond.35 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b170 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32));
    assert {:tag "disabledMaintainsInstrumentation"} _b169 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$while.cond.35 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b168 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    assert {:tag "disabledMaintainsInstrumentation"} _b167 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35 == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b166 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$while.cond.35 == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p9$1 ==> p3$1;
    assert p9$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b54 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b53 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b52 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b51 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b50 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b49 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b48 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b47 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b46 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b45 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b44 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1)) && BV32_SLT($wtx.3$1, 100bv32) ==> p9$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b44 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2)) && BV32_SLT($wtx.3$2, 100bv32) ==> p9$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p9$1 ==> _b43 ==> p9$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p9$2 ==> _b43 ==> p9$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2));
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b42 ==> BV32_UGE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b42 ==> BV32_UGE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b41 ==> BV32_ULE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b41 ==> BV32_ULE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b40 ==> BV32_SGE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b40 ==> BV32_SGE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b39 ==> BV32_SLE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b39 ==> BV32_SLE($wtx.3$2, v1$2);
    assert {:tag "guardNonNeg"} {:thread 1} p9$1 ==> _b38 ==> BV32_SLE(0bv32, $wtx.3$1);
    assert {:tag "guardNonNeg"} {:thread 2} p9$2 ==> _b38 ==> BV32_SLE(0bv32, $wtx.3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p9$1 ==> _b37 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.3$1) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p9$2 ==> _b37 ==> BV32_AND(BV32_SUB(128bv32, 1bv32), $wtx.3$2) == BV32_AND(BV32_SUB(128bv32, 1bv32), v1$2);
    ...
    _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39 := _READ_HAS_OCCURRED_$$d_fv_gpu;
    _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39 := _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond.39 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond.39 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond.39 := _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.39;

  $for.cond.39:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b179 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$for.cond.39 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b178 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$for.cond.39 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b177 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32));
    assert {:tag "disabledMaintainsInstrumentation"} _b176 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$for.cond.39 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b175 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_MUL(v1$1, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(128bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32));
    assert {:tag "disabledMaintainsInstrumentation"} _b174 ==> !p10$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39 == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b173 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$for.cond.39 == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p9$1 ==> p3$1;
    assert p9$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b76 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($wtx.3$1, 100bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b75 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b74 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b73 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($wtx.3$1, 100bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b72 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b71 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b70 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($wtx.3$1, 100bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b69 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b68 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b67 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($wtx.3$1, 100bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b66 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b65 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b64 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($wtx.3$1, 100bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b63 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b62 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b61 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1)) && BV32_SLT($wtx.3$1, 100bv32) && BV32_SLT($j.0$1, 100bv32) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b61 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2)) && BV32_SLT($wtx.3$2, 100bv32) && BV32_SLT($j.0$2, 100bv32) ==> p11$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p11$1 ==> _b60 ==> p11$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$1, BV32_ADD(1bv32, v30$1 ++ v29$1 ++ v28$1 ++ v27$1)) && BV32_SLT($wtx.3$1, 100bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p11$2 ==> _b60 ==> p11$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), $d_dim_gpu[192:184] ++ $d_dim_gpu[184:176] ++ $d_dim_gpu[176:168] ++ $d_dim_gpu[168:160] ++ $d_dim_gpu[160:152] ++ $d_dim_gpu[152:144] ++ $d_dim_gpu[144:136] ++ $d_dim_gpu[136:128]) && BV32_SLT($k.0$2, BV32_ADD(1bv32, v30$2 ++ v29$2 ++ v28$2 ++ v27$2)) && BV32_SLT($wtx.3$2, 100bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b59 ==> BV32_UGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b59 ==> BV32_UGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b58 ==> BV32_ULE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b58 ==> BV32_ULE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b57 ==> BV32_SGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b57 ==> BV32_SGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b56 ==> BV32_SLE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b56 ==> BV32_SLE($j.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p11$1 ==> _b55 ==> BV32_SLE(0bv32, $j.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p11$2 ==> _b55 ==> BV32_SLE(0bv32, $j.0$2);
    ...
    goto $for.cond.39.backedge, $for.cond.39.tail;
  ...
  $for.cond.39.tail:
    ...
    goto $while.cond.35.backedge, __partitioned_block_$while.cond.35.tail_0;

  __partitioned_block_$while.cond.35.tail_0:
    assume !p9$1 && !p9$2;
    goto __partitioned_block_$while.cond.35.tail_1;

  __partitioned_block_$while.cond.35.tail_1:
