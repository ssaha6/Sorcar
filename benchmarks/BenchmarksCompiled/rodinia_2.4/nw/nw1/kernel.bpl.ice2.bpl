...
assert  my_inv (  (  BV32_SLE(0bv32, $ty.0) ) ,  (  BV32_SLE($ty.0, 0bv32) ) ,  (  BV32_SGE($ty.0, 0bv32) ) ,  (  BV32_ULE($ty.0, 0bv32) ) ,  (  BV32_UGE($ty.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$reference_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $m.0) ) ,  (  BV32_SLE($m.0, 0bv32) ) ,  (  BV32_SGE($m.0, 0bv32) ) ,  (  BV32_ULE($m.0, 0bv32) ) ,  (  BV32_UGE($m.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !_READ_HAS_OCCURRED_$$input_itemsets_l ) ,  (  !_WRITE_HAS_OCCURRED_$$input_itemsets_l ) ,  (  _READ_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 17bv32), BV32_ADD(local_id_x$1, 1bv32))) ) ,  (  _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 17bv32), BV32_ADD(local_id_x$1, 1bv32))) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $ty4.0) ) ,  (  BV32_SLE($ty4.0, 0bv32) ) ,  (  BV32_SGE($ty4.0, 0bv32) ) ,  (  BV32_ULE($ty4.0, 0bv32) ) ,  (  BV32_UGE($ty4.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 17bv32), BV32_ADD(local_id_x$1, 1bv32))) )  ); 
  ...
  $truebb9:
    assume {:partition} v38;
    call {:sourceloc} {:sourceloc_num 67} _LOG_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32)), $$input_itemsets_l[1bv1][BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 67} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 67} _CHECK_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32)), $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32))]);
    ...
    call {:sourceloc} {:sourceloc_num 68} _LOG_WRITE_$$input_itemsets_d(true, BV32_ADD(v4$1, BV32_MUL($cols, $ty4.0)), v39$1, $$input_itemsets_d[BV32_ADD(v4$1, BV32_MUL($cols, $ty4.0))]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 68} _CHECK_WRITE_$$input_itemsets_d(true, BV32_ADD(v4$2, BV32_MUL($cols, $ty4.0)), v39$2);
