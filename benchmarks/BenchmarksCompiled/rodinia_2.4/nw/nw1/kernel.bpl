...
procedure {:source_name "nw_kernel1"} {:kernel} $nw_kernel1($cols: bv32, $penalty: bv32, $blk: bv32, $block_width: bv32, $worksize: bv32, $offset_r: bv32, $offset_c: bv32);
  ...
  requires {:sourceloc_num 2} {:thread 1} (if $blk == 128bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "nw_kernel1"} {:kernel} $nw_kernel1($cols: bv32, $penalty: bv32, $blk: bv32, $block_width: bv32, $worksize: bv32, $offset_r: bv32, $offset_c: bv32)
{
  ...
  var $m95.0: bv32;
  var $k.i.165.0$1: bv32;
  var $k.i.165.0$2: bv32;
  var $retval.i.161.0$1: bv32;
  var $retval.i.161.0$2: bv32;
  var $ty134.0: bv32;
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $for.cond.96:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_UGE($m95.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_ULE($m95.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_SGE($m95.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SLE($m95.0, 14bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b11 ==> BV32_SLE(0bv32, $m95.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b10 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $m95.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 14bv32);
    assert {:block_sourceloc} {:sourceloc_num 45} true;
    v25 := BV32_SGE($m95.0, 0bv32);
    p8$1 := false;
    p8$2 := false;
    p9$1 := false;
    p9$2 := false;
  ...
  $for.cond.135:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _READ_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 17bv32), BV32_ADD(local_id_x$1, 1bv32)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b20 ==> BV32_UGE($ty134.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_ULE($ty134.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_SGE($ty134.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SLE($ty134.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b16 ==> BV32_SLE(0bv32, $ty134.0);
    assert {:block_sourceloc} {:sourceloc_num 63} true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 64} {:thread 1} (if _WRITE_HAS_OCCURRED_$$input_itemsets_d ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), v4$1), $cols) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 65} {:thread 1} (if _WRITE_HAS_OCCURRED_$$input_itemsets_d ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), v4$1), $cols), 16bv32) then 1bv1 else 0bv1) != 0bv1;
    v38 := BV32_SLT($ty134.0, 16bv32);
  ...
  $truebb9:
    assume {:partition} v38;
    call {:sourceloc} {:sourceloc_num 67} _LOG_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32)), $$input_itemsets_l[1bv1][BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 67} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 67} _CHECK_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32)), $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$input_itemsets_l"} true;
    v39$1 := $$input_itemsets_l[1bv1][BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32))];
    v39$2 := $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty134.0, 1bv32), 17bv32))];
    call {:sourceloc} {:sourceloc_num 68} _LOG_WRITE_$$input_itemsets_d(true, BV32_ADD(v4$1, BV32_MUL($cols, $ty134.0)), v39$1, $$input_itemsets_d[BV32_ADD(v4$1, BV32_MUL($cols, $ty134.0))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$input_itemsets_d(true, BV32_ADD(v4$2, BV32_MUL($cols, $ty134.0)));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 68} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 68} _CHECK_WRITE_$$input_itemsets_d(true, BV32_ADD(v4$2, BV32_MUL($cols, $ty134.0)), v39$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$input_itemsets_d"} true;
    $$input_itemsets_d[BV32_ADD(v4$1, BV32_MUL($cols, $ty134.0))] := v39$1;
    $$input_itemsets_d[BV32_ADD(v4$2, BV32_MUL($cols, $ty134.0))] := v39$2;
    $ty134.0 := BV32_ADD($ty134.0, 1bv32);
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond.135;

  __partitioned_block_$truebb5_0:
    assume {:partition} v25;
    v26$1 := BV32_SLE(v1$1, $m95.0);
    v26$2 := BV32_SLE(v1$2, $m95.0);
    p9$1 := (if v26$1 then v26$1 else p9$1);
    p9$2 := (if v26$2 then v26$2 else p9$2);
    v27$1 := (if p9$1 then BV32_SUB(BV32_ADD(v1$1, 16bv32), $m95.0) else v27$1);
    v27$2 := (if p9$2 then BV32_SUB(BV32_ADD(v1$2, 16bv32), $m95.0) else v27$2);
    ...
    $k.i.165.0$1 := (if p10$1 then v31$1 else $k.i.165.0$1);
    $k.i.165.0$2 := (if p10$2 then v31$2 else $k.i.165.0$2);
    $k.i.165.0$1 := (if p11$1 then v33$1 else $k.i.165.0$1);
    $k.i.165.0$2 := (if p11$2 then v33$2 else $k.i.165.0$2);
    v37$1 := (if p9$1 then BV32_SLE($k.i.165.0$1, v35$1) else v37$1);
    v37$2 := (if p9$2 then BV32_SLE($k.i.165.0$2, v35$2) else v37$2);
    ...
    $retval.i.161.0$1 := (if p12$1 then $k.i.165.0$1 else $retval.i.161.0$1);
    $retval.i.161.0$2 := (if p12$2 then $k.i.165.0$2 else $retval.i.161.0$2);
    $retval.i.161.0$1 := (if p13$1 then v35$1 else $retval.i.161.0$1);
    $retval.i.161.0$2 := (if p13$2 then v35$2 else $retval.i.161.0$2);
    call {:sourceloc} {:sourceloc_num 58} _LOG_WRITE_$$input_itemsets_l(p9$1, BV32_ADD(v27$1, BV32_MUL(v28$1, 17bv32)), $retval.i.161.0$1, $$input_itemsets_l[1bv1][BV32_ADD(v27$1, BV32_MUL(v28$1, 17bv32))]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 58} _CHECK_WRITE_$$input_itemsets_l(p9$2, BV32_ADD(v27$2, BV32_MUL(v28$2, 17bv32)), $retval.i.161.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$input_itemsets_l"} true;
    $$input_itemsets_l[1bv1][BV32_ADD(v27$1, BV32_MUL(v28$1, 17bv32))] := (if p9$1 then $retval.i.161.0$1 else $$input_itemsets_l[1bv1][BV32_ADD(v27$1, BV32_MUL(v28$1, 17bv32))]);
    $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v27$2, BV32_MUL(v28$2, 17bv32))] := (if p9$2 then $retval.i.161.0$2 else $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v27$2, BV32_MUL(v28$2, 17bv32))]);
  ...
  __partitioned_block_$truebb5_1:
    ...
    $m95.0 := BV32_ADD($m95.0, 4294967295bv32);
  ...
  __partitioned_block_$truebb1_0:
    ...
    $retval.i.0$1 := (if p6$1 then $k.i.0$1 else $retval.i.0$1);
    $retval.i.0$2 := (if p6$2 then $k.i.0$2 else $retval.i.0$2);
    $retval.i.0$1 := (if p7$1 then v22$1 else $retval.i.0$1);
    $retval.i.0$2 := (if p7$2 then v22$2 else $retval.i.0$2);
    call {:sourceloc} {:sourceloc_num 39} _LOG_WRITE_$$input_itemsets_l(p3$1, BV32_ADD(v14$1, BV32_MUL(v15$1, 17bv32)), $retval.i.0$1, $$input_itemsets_l[1bv1][BV32_ADD(v14$1, BV32_MUL(v15$1, 17bv32))]);
    ...
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 39} _CHECK_WRITE_$$input_itemsets_l(p3$2, BV32_ADD(v14$2, BV32_MUL(v15$2, 17bv32)), $retval.i.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$input_itemsets_l"} true;
    $$input_itemsets_l[1bv1][BV32_ADD(v14$1, BV32_MUL(v15$1, 17bv32))] := (if p3$1 then $retval.i.0$1 else $$input_itemsets_l[1bv1][BV32_ADD(v14$1, BV32_MUL(v15$1, 17bv32))]);
    $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v14$2, BV32_MUL(v15$2, 17bv32))] := (if p3$2 then $retval.i.0$2 else $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v14$2, BV32_MUL(v15$2, 17bv32))]);
