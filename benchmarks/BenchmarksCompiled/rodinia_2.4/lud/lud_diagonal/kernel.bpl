...
implementation {:source_name "lud_diagonal"} {:kernel} $lud_diagonal($matrix_dim: bv32, $offset: bv32)
{
  ...
  $1:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.0) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL($offset, $matrix_dim), $offset));
  ...
  $5:
    ...
    assert {:tag "nowrite"} _b42 ==> !_WRITE_HAS_OCCURRED_$$shadow;
    assert {:tag "noread"} _b41 ==> !_READ_HAS_OCCURRED_$$shadow;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$shadow ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$shadow ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$shadow ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_UGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_ULE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_SGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SLE($i.1, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b6 ==> BV32_SLE(0bv32, $i.1);
  ...
  $21:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$shadow ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$shadow ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_UGE($i.2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_ULE($i.2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_SGE($i.2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_SLE($i.2, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b12 ==> BV32_SLE(0bv32, $i.2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b11 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, 1bv32), $matrix_dim), $offset));
  ...
  $8:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _WRITE_HAS_OCCURRED_$$shadow ==> BV32_SGT(local_id_x$1, $i.1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _WRITE_HAS_OCCURRED_$$shadow ==> BV32_SLT($i.1, 15bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b36 ==> _READ_HAS_OCCURRED_$$shadow ==> BV32_SGT(local_id_x$1, $i.1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _READ_HAS_OCCURRED_$$shadow ==> BV32_SLT($i.1, 15bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b34 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$1, $i.1) && BV32_SLT($j.0$1, $i.1) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b34 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$2, $i.1) && BV32_SLT($j.0$2, $i.1) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b33 ==> p2$1 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$1, $i.1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b33 ==> p2$2 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$2, $i.1);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b32 ==> BV32_UGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b32 ==> BV32_UGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b31 ==> BV32_ULE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b31 ==> BV32_ULE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b30 ==> BV32_SGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b30 ==> BV32_SGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b29 ==> BV32_SLE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b29 ==> BV32_SLE($j.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p2$1 ==> _b28 ==> BV32_SLE(0bv32, $j.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p2$2 ==> _b28 ==> BV32_SLE(0bv32, $j.0$2);
  ...
  $14:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _WRITE_HAS_OCCURRED_$$shadow ==> BV32_SGT(local_id_x$1, $i.1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _WRITE_HAS_OCCURRED_$$shadow ==> BV32_SLT($i.1, 15bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$shadow ==> BV32_SGT(local_id_x$1, $i.1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$shadow ==> BV32_SLT($i.1, 15bv32);
    ...
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b22 ==> p6$1 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$1, $i.1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b22 ==> p6$2 ==> BV32_SLT($i.1, 15bv32) && BV32_SGT(local_id_x$2, $i.1);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b21 ==> BV32_UGE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b21 ==> BV32_UGE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b20 ==> BV32_ULE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b20 ==> BV32_ULE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b19 ==> BV32_SGE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b19 ==> BV32_SGE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b18 ==> BV32_SLE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b18 ==> BV32_SLE($j.1$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p6$1 ==> _b17 ==> BV32_SLE(0bv32, $j.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p6$2 ==> _b17 ==> BV32_SLE(0bv32, $j.1$2);
