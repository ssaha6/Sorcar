...
assert  my_inv (  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 1bv32) ) ,  (  BV32_SGE($i.0, 1bv32) ) ,  (  BV32_ULE($i.0, 1bv32) ) ,  (  BV32_UGE($i.0, 1bv32) ) ,  (  $i.0 == 0bv32 || BV32_AND($i.0, BV32_SUB($i.0, 1bv32)) == 0bv32 ) ,  (  $i.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$weight_matrix ) ,  (  !_WRITE_HAS_OCCURRED_$$weight_matrix ) ,  (  _READ_HAS_OCCURRED_$$weight_matrix ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), local_id_x$1) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 16bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$weight_matrix ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), local_id_x$1) )  ); 
