...
assert  my_inv (  (  BV32_AND(BV32_SUB(2bv32, 1bv32), $out.0) == BV32_AND(BV32_SUB(2bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $out.0) ) ,  (  BV32_SLE($out.0, 0bv32) ) ,  (  BV32_SGE($out.0, 0bv32) ) ,  (  BV32_ULE($out.0, 0bv32) ) ,  (  BV32_UGE($out.0, 0bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) || BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) )  ); 
