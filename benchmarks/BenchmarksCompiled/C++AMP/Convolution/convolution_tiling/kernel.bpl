...
implementation {:source_name "convolution_tiling"} {:kernel} $_Z18convolution_tilingPKfS0_Pf()
{
  ...
  $12:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SLT(local_id_y$1, 121bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SGE(local_id_y$1, 7bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SGE(local_id_y$1, 7bv32) && BV32_SLT(local_id_y$1, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32) && BV32_SLE($k.0$1, 7bv32) ==> p9$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SGE(local_id_y$2, 7bv32) && BV32_SLT(local_id_y$2, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114bv32), local_id_y$2), 7bv32), 512bv32) && BV32_SLE($k.0$2, 7bv32) ==> p9$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p9$1 ==> _b5 ==> p9$1 ==> BV32_SGE(local_id_y$1, 7bv32) && BV32_SLT(local_id_y$1, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p9$2 ==> _b5 ==> p9$2 ==> BV32_SGE(local_id_y$2, 7bv32) && BV32_SLT(local_id_y$2, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114bv32), local_id_y$2), 7bv32), 512bv32);
