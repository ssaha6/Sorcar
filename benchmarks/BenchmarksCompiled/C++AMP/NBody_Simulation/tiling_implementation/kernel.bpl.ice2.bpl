...
assert  my_inv (  (  BV32_AND(BV32_SUB(256bv32, 1bv32), $particle_idx.0$1) == BV32_AND(BV32_SUB(256bv32, 1bv32), local_id_x$1) )  && (  BV32_AND(BV32_SUB(256bv32, 1bv32), $particle_idx.0$2) == BV32_AND(BV32_SUB(256bv32, 1bv32), local_id_x$2) ) ,  (  BV32_SLE($tile.0, 0bv32) ) ,  (  BV32_SGE($tile.0, 0bv32) ) ,  (  BV32_ULE($tile.0, 0bv32) ) ,  (  BV32_UGE($tile.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32) )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(4bv32, 1bv32), $j.0) == BV32_AND(BV32_SUB(4bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE($j.0, 0bv32) ) ,  (  BV32_SGE($j.0, 0bv32) ) ,  (  BV32_ULE($j.0, 0bv32) ) ,  (  BV32_UGE($j.0, 0bv32) ) ,  true ,  true  ); 
