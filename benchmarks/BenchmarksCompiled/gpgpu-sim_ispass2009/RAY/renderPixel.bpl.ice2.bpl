...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p20$1 ==> _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T$ghost$$24 == _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p20$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj$ghost$$24 == _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj )  ); 
