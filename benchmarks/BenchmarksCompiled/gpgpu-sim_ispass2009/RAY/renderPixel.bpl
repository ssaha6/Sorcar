...
implementation {:source_name "renderPixel"} {:kernel} $_Z11renderPixelPjP4Nodejjff($imageW: bv32, $imageH: bv32, $pas: bv32, $df: bv32)
{
  ...
  $for.cond:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b17 ==> !p20$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b15 ==> !p20$1 ==> _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T$ghost$$for.cond == _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> local_id_x$1 == 0bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> BV32_ULT(local_id_x$1, 4bv32);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b10 ==> _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> local_id_x$1 == 0bv32;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> BV32_ULT(local_id_x$1, 4bv32);
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_ULT(group_id_x$1, $imageW) && BV32_ULT(group_id_y$1, $imageH) && BV32_ULT(local_id_x$1, 4bv32) && local_id_x$1 == 0bv32 && BV32_SLT($i.0$1, 4bv32) ==> p21$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_ULT(group_id_x$2, $imageW) && BV32_ULT(group_id_y$2, $imageH) && BV32_ULT(local_id_x$2, 4bv32) && local_id_x$2 == 0bv32 && BV32_SLT($i.0$2, 4bv32) ==> p21$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p21$1 ==> _b5 ==> p21$1 ==> BV32_ULT(group_id_x$1, $imageW) && BV32_ULT(group_id_y$1, $imageH) && BV32_ULT(local_id_x$1, 4bv32) && local_id_x$1 == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p21$2 ==> _b5 ==> p21$2 ==> BV32_ULT(group_id_x$2, $imageW) && BV32_ULT(group_id_y$2, $imageH) && BV32_ULT(local_id_x$2, 4bv32) && local_id_x$2 == 0bv32;
