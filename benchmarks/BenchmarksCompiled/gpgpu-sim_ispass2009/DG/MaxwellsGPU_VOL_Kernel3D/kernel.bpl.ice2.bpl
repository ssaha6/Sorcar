...
implementation {:source_name "MaxwellsGPU_VOL_Kernel3D"} {:kernel} $_Z24MaxwellsGPU_VOL_Kernel3DPf()
{
  ...
  __partitioned_block_$0_0:
    ...
    $$0$11bv32$1 := v12$1;
    $$0$11bv32$2 := v12$2;
    call {:sourceloc_num 25} v13$1, v13$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$0, 0bv32), true, v0$1, true, v0$2);
    ...
    $$1$11bv32$1 := v25$1;
    $$1$11bv32$2 := v25$2;
    call {:sourceloc_num 51} v26$1, v26$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$1, 0bv32), true, BV32_ADD(v0$1, 96bv32), true, BV32_ADD(v0$2, 96bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    $$2$11bv32$1 := v38$1;
    $$2$11bv32$2 := v38$2;
    call {:sourceloc_num 77} v39$1, v39$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$2, 0bv32), true, BV32_ADD(v0$1, 192bv32), true, BV32_ADD(v0$2, 192bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    $$3$11bv32$1 := v51$1;
    $$3$11bv32$2 := v51$2;
    call {:sourceloc_num 103} v52$1, v52$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$3, 0bv32), true, BV32_ADD(v0$1, 288bv32), true, BV32_ADD(v0$2, 288bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    $$4$11bv32$1 := v64$1;
    $$4$11bv32$2 := v64$2;
    call {:sourceloc_num 129} v65$1, v65$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$4, 0bv32), true, BV32_ADD(v0$1, 384bv32), true, BV32_ADD(v0$2, 384bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    $$5$11bv32$1 := v77$1;
    $$5$11bv32$2 := v77$2;
    call {:sourceloc_num 155} v78$1, v78$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$5, 0bv32), true, BV32_ADD(v0$1, 480bv32), true, BV32_ADD(v0$2, 480bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    $$6$0bv32$1 := (if p0$1 then v80$1 else $$6$0bv32$1);
    $$6$0bv32$2 := (if p0$2 then v80$2 else $$6$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v81$1 := (if p0$1 then _HAVOC_bv8$1 else v81$1);
    v81$2 := (if p0$2 then _HAVOC_bv8$2 else v81$2);
    $$6$1bv32$1 := (if p0$1 then v81$1 else $$6$1bv32$1);
    $$6$1bv32$2 := (if p0$2 then v81$2 else $$6$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v82$1 := (if p0$1 then _HAVOC_bv8$1 else v82$1);
    v82$2 := (if p0$2 then _HAVOC_bv8$2 else v82$2);
    $$6$2bv32$1 := (if p0$1 then v82$1 else $$6$2bv32$1);
    $$6$2bv32$2 := (if p0$2 then v82$2 else $$6$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v83$1 := (if p0$1 then _HAVOC_bv8$1 else v83$1);
    v83$2 := (if p0$2 then _HAVOC_bv8$2 else v83$2);
    $$6$3bv32$1 := (if p0$1 then v83$1 else $$6$3bv32$1);
    $$6$3bv32$2 := (if p0$2 then v83$2 else $$6$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v84$1 := (if p0$1 then _HAVOC_bv8$1 else v84$1);
    v84$2 := (if p0$2 then _HAVOC_bv8$2 else v84$2);
    $$6$4bv32$1 := (if p0$1 then v84$1 else $$6$4bv32$1);
    $$6$4bv32$2 := (if p0$2 then v84$2 else $$6$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v85$1 := (if p0$1 then _HAVOC_bv8$1 else v85$1);
    v85$2 := (if p0$2 then _HAVOC_bv8$2 else v85$2);
    $$6$5bv32$1 := (if p0$1 then v85$1 else $$6$5bv32$1);
    $$6$5bv32$2 := (if p0$2 then v85$2 else $$6$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v86$1 := (if p0$1 then _HAVOC_bv8$1 else v86$1);
    v86$2 := (if p0$2 then _HAVOC_bv8$2 else v86$2);
    $$6$6bv32$1 := (if p0$1 then v86$1 else $$6$6bv32$1);
    $$6$6bv32$2 := (if p0$2 then v86$2 else $$6$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v87$1 := (if p0$1 then _HAVOC_bv8$1 else v87$1);
    v87$2 := (if p0$2 then _HAVOC_bv8$2 else v87$2);
    $$6$7bv32$1 := (if p0$1 then v87$1 else $$6$7bv32$1);
    $$6$7bv32$2 := (if p0$2 then v87$2 else $$6$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v88$1 := (if p0$1 then _HAVOC_bv8$1 else v88$1);
    v88$2 := (if p0$2 then _HAVOC_bv8$2 else v88$2);
    $$6$8bv32$1 := (if p0$1 then v88$1 else $$6$8bv32$1);
    $$6$8bv32$2 := (if p0$2 then v88$2 else $$6$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v89$1 := (if p0$1 then _HAVOC_bv8$1 else v89$1);
    v89$2 := (if p0$2 then _HAVOC_bv8$2 else v89$2);
    $$6$9bv32$1 := (if p0$1 then v89$1 else $$6$9bv32$1);
    $$6$9bv32$2 := (if p0$2 then v89$2 else $$6$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v90$1 := (if p0$1 then _HAVOC_bv8$1 else v90$1);
    v90$2 := (if p0$2 then _HAVOC_bv8$2 else v90$2);
    $$6$10bv32$1 := (if p0$1 then v90$1 else $$6$10bv32$1);
    $$6$10bv32$2 := (if p0$2 then v90$2 else $$6$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v91$1 := (if p0$1 then _HAVOC_bv8$1 else v91$1);
    v91$2 := (if p0$2 then _HAVOC_bv8$2 else v91$2);
    $$6$11bv32$1 := (if p0$1 then v91$1 else $$6$11bv32$1);
    $$6$11bv32$2 := (if p0$2 then v91$2 else $$6$11bv32$2);
    call {:sourceloc_num 182} v92$1, v92$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$6, 0bv32), p0$1, BV32_ADD(BV32_MUL(12bv32, group_id_x$1), local_id_x$1), p0$2, BV32_ADD(BV32_MUL(12bv32, group_id_x$2), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
...
assert  my_inv (  (  BV32_AND(BV32_SUB(3bv32, 1bv32), $m.0) == BV32_AND(BV32_SUB(3bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE($m.0, 0bv32) ) ,  (  BV32_SGE($m.0, 0bv32) ) ,  (  BV32_ULE($m.0, 0bv32) ) ,  (  BV32_UGE($m.0, 0bv32) )  ); 
  ...
  $truebb0:
    ...
    $$7$23bv32$1 := v117$1;
    $$7$23bv32$2 := v117$2;
    call {:sourceloc_num 236} v118$1, v118$2 := $_Z10tex1DfetchI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$7, 0bv32), BV32_ADD(local_id_x$1, BV32_MUL($m.0, 96bv32)), BV32_ADD(local_id_x$2, BV32_MUL($m.0, 96bv32)));
    ...
    $$9$23bv32$1 := v167$1;
    $$9$23bv32$2 := v167$2;
    call {:sourceloc_num 313} v168$1, v168$2 := $_Z10tex1DfetchI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$9, 0bv32), BV32_ADD(local_id_x$1, BV32_MUL(v143, 96bv32)), BV32_ADD(local_id_x$2, BV32_MUL(v143, 96bv32)));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi"} true;
    $$8$0bv32$1 := v168$1[32:0];
    $$8$0bv32$2 := v168$2[32:0];
    $$8$1bv32$1 := v168$1[64:32];
    $$8$1bv32$2 := v168$2[64:32];
    $$8$2bv32$1 := v168$1[96:64];
    $$8$2bv32$2 := v168$2[96:64];
    $$8$3bv32$1 := v168$1[128:96];
    $$8$3bv32$2 := v168$2[128:96];
    v169$1 := $$8$0bv32$1;
    v169$2 := $$8$0bv32$2;
    $$D$0bv32$1 := v169$1;
    $$D$0bv32$2 := v169$2;
    ...
    $$11$23bv32$1 := v221$1;
    $$11$23bv32$2 := v221$2;
    call {:sourceloc_num 398} v222$1, v222$2 := $_Z10tex1DfetchI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$11, 0bv32), BV32_ADD(local_id_x$1, BV32_MUL(v197, 96bv32)), BV32_ADD(local_id_x$2, BV32_MUL(v197, 96bv32)));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi"} true;
    $$10$0bv32$1 := v222$1[32:0];
    $$10$0bv32$2 := v222$2[32:0];
    $$10$1bv32$1 := v222$1[64:32];
    $$10$1bv32$2 := v222$2[64:32];
    $$10$2bv32$1 := v222$1[96:64];
    $$10$2bv32$2 := v222$2[96:64];
    $$10$3bv32$1 := v222$1[128:96];
    $$10$3bv32$2 := v222$2[128:96];
    v223$1 := $$10$0bv32$1;
    v223$2 := $$10$0bv32$2;
    $$D$0bv32$1 := v223$1;
    $$D$0bv32$2 := v223$2;
