...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $path.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $path.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $path.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $path.0$2) ) ,  ( p0$1 ==> BV32_SLE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SLE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SGE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SGE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_ULE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_ULE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_UGE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_UGE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  (  BV32_SLT($path.0$1, 4096bv32) ==> p0$1 )  && (  BV32_SLT($path.0$2, 4096bv32) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$d_v ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$d_Lb ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  ); 
