...
assert  my_inv (  ( p2$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p2$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p2$1 ==> BV32_SLE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_SLE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_SGE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_SGE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_ULE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_ULE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_UGE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_UGE($i.0$2, v4$2) ) ,  ( p2$1 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) && v2$1[1:0] == 1bv1 )  && ( p2$2 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256bv32), local_id_x$2), $no_of_nodes) && v2$2[1:0] == 1bv1 ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) && v2$1[1:0] == 1bv1 && BV32_SLT($i.0$1, BV32_ADD(v5$1, v6$1)) ==> p2$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256bv32), local_id_x$2), $no_of_nodes) && v2$2[1:0] == 1bv1 && BV32_SLT($i.0$2, BV32_ADD(v5$2, v6$2)) ==> p2$2 ) ,  (  _READ_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) ) ,  (  _READ_HAS_OCCURRED_$$g_cost ==> v2$1[1:0] == 1bv1 ) ,  (  _READ_HAS_OCCURRED_$$g_graph_visited ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) ) ,  (  _READ_HAS_OCCURRED_$$g_graph_visited ==> v2$1[1:0] == 1bv1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_cost ==> v2$1[1:0] == 1bv1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_graph_mask ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_graph_mask ==> v2$1[1:0] == 1bv1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_over ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256bv32), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_over ==> v2$1[1:0] == 1bv1 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
