...
axiom {:array_info "$$agg.tmp565"} {:elem_width 32} {:source_name "agg.tmp565"} {:source_elem_width 96} {:source_dimensions "1"} true;

const $arrayId$$agg.tmp565: arrayId;

axiom $arrayId$$agg.tmp565 == 13bv5;

axiom {:array_info "$$agg.tmp617"} {:elem_width 32} {:source_name "agg.tmp617"} {:source_elem_width 96} {:source_dimensions "1"} true;

const $arrayId$$agg.tmp617: arrayId;

axiom $arrayId$$agg.tmp617 == 14bv5;

axiom {:array_info "$$agg.tmp669"} {:elem_width 32} {:source_name "agg.tmp669"} {:source_elem_width 96} {:source_dimensions "1"} true;

const $arrayId$$agg.tmp669: arrayId;

axiom $arrayId$$agg.tmp669 == 15bv5;

axiom {:array_info "$$agg.tmp721"} {:elem_width 32} {:source_name "agg.tmp721"} {:source_elem_width 96} {:source_dimensions "1"} true;

const $arrayId$$agg.tmp721: arrayId;

axiom $arrayId$$agg.tmp721 == 16bv5;

axiom {:array_info "$$agg.tmp765"} {:elem_width 32} {:source_name "agg.tmp765"} {:source_elem_width 96} {:source_dimensions "1"} true;

const $arrayId$$agg.tmp765: arrayId;

axiom $arrayId$$agg.tmp765 == 17bv5;
...
implementation {:source_name "aesEncrypt256"} {:kernel} $_Z13aesEncrypt256PjS_i($inputSize: bv32)
{
  ...
  __partitioned_block_$falsebb_11:
    ...
    havoc v212$1, v212$2;
    $$agg.tmp565$0bv32$1 := v212$1;
    $$agg.tmp565$0bv32$2 := v212$2;
    havoc v213$1, v213$2;
    $$agg.tmp565$1bv32$1 := v213$1;
    $$agg.tmp565$1bv32$2 := v213$2;
    havoc v214$1, v214$2;
    $$agg.tmp565$2bv32$1 := v214$1;
    $$agg.tmp565$2bv32$2 := v214$2;
    call {:sourceloc_num 306} v215$1, v215$2 := $_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$agg.tmp565, 0bv32), BV32_ADD(v0$1, 40bv32), BV32_ADD(v0$2, 40bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
  ...
  __partitioned_block_$falsebb_12:
    ...
    havoc v232$1, v232$2;
    $$agg.tmp617$0bv32$1 := v232$1;
    $$agg.tmp617$0bv32$2 := v232$2;
    havoc v233$1, v233$2;
    $$agg.tmp617$1bv32$1 := v233$1;
    $$agg.tmp617$1bv32$2 := v233$2;
    havoc v234$1, v234$2;
    $$agg.tmp617$2bv32$1 := v234$1;
    $$agg.tmp617$2bv32$2 := v234$2;
    call {:sourceloc_num 333} v235$1, v235$2 := $_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$agg.tmp617, 0bv32), BV32_ADD(v0$1, 44bv32), BV32_ADD(v0$2, 44bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
  ...
  __partitioned_block_$falsebb_13:
    ...
    havoc v252$1, v252$2;
    $$agg.tmp669$0bv32$1 := v252$1;
    $$agg.tmp669$0bv32$2 := v252$2;
    havoc v253$1, v253$2;
    $$agg.tmp669$1bv32$1 := v253$1;
    $$agg.tmp669$1bv32$2 := v253$2;
    havoc v254$1, v254$2;
    $$agg.tmp669$2bv32$1 := v254$1;
    $$agg.tmp669$2bv32$2 := v254$2;
    call {:sourceloc_num 360} v255$1, v255$2 := $_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$agg.tmp669, 0bv32), BV32_ADD(v0$1, 48bv32), BV32_ADD(v0$2, 48bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
  ...
  __partitioned_block_$falsebb_14:
    ...
    havoc v272$1, v272$2;
    $$agg.tmp721$0bv32$1 := v272$1;
    $$agg.tmp721$0bv32$2 := v272$2;
    havoc v273$1, v273$2;
    $$agg.tmp721$1bv32$1 := v273$1;
    $$agg.tmp721$1bv32$2 := v273$2;
    havoc v274$1, v274$2;
    $$agg.tmp721$2bv32$1 := v274$1;
    $$agg.tmp721$2bv32$2 := v274$2;
    call {:sourceloc_num 387} v275$1, v275$2 := $_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$agg.tmp721, 0bv32), BV32_ADD(v0$1, 52bv32), BV32_ADD(v0$2, 52bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
  ...
  __partitioned_block_$falsebb_15:
    ...
    havoc v285$1, v285$2;
    $$agg.tmp765$0bv32$1 := v285$1;
    $$agg.tmp765$0bv32$2 := v285$2;
    havoc v286$1, v286$2;
    $$agg.tmp765$1bv32$1 := v286$1;
    $$agg.tmp765$1bv32$2 := v286$2;
    havoc v287$1, v287$2;
    $$agg.tmp765$2bv32$1 := v287$1;
    $$agg.tmp765$2bv32$2 := v287$2;
    call {:sourceloc_num 407} v288$1, v288$2 := $_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(MKPTR($arrayId$$agg.tmp765, 0bv32), BV32_ADD(v0$1, 56bv32), BV32_ADD(v0$2, 56bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIjET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
...
var $$agg.tmp565$0bv32$1: bv32;

var $$agg.tmp565$0bv32$2: bv32;

var $$agg.tmp565$1bv32$1: bv32;

var $$agg.tmp565$1bv32$2: bv32;

var $$agg.tmp565$2bv32$1: bv32;

var $$agg.tmp565$2bv32$2: bv32;

var $$agg.tmp617$0bv32$1: bv32;

var $$agg.tmp617$0bv32$2: bv32;

var $$agg.tmp617$1bv32$1: bv32;

var $$agg.tmp617$1bv32$2: bv32;

var $$agg.tmp617$2bv32$1: bv32;

var $$agg.tmp617$2bv32$2: bv32;

var $$agg.tmp669$0bv32$1: bv32;

var $$agg.tmp669$0bv32$2: bv32;

var $$agg.tmp669$1bv32$1: bv32;

var $$agg.tmp669$1bv32$2: bv32;

var $$agg.tmp669$2bv32$1: bv32;

var $$agg.tmp669$2bv32$2: bv32;

var $$agg.tmp721$0bv32$1: bv32;

var $$agg.tmp721$0bv32$2: bv32;

var $$agg.tmp721$1bv32$1: bv32;

var $$agg.tmp721$1bv32$2: bv32;

var $$agg.tmp721$2bv32$1: bv32;

var $$agg.tmp721$2bv32$2: bv32;

var $$agg.tmp765$0bv32$1: bv32;

var $$agg.tmp765$0bv32$2: bv32;

var $$agg.tmp765$1bv32$1: bv32;

var $$agg.tmp765$1bv32$2: bv32;

var $$agg.tmp765$2bv32$1: bv32;

var $$agg.tmp765$2bv32$2: bv32;
