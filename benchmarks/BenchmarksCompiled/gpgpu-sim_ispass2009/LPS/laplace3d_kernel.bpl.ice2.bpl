...
assert  my_inv (  (  BV32_SLE(0bv32, $k.0) ) ,  (  BV32_SLE($k.0, 0bv32) ) ,  (  BV32_SGE($k.0, 0bv32) ) ,  (  BV32_ULE($k.0, 0bv32) ) ,  (  BV32_UGE($k.0, 0bv32) ) ,  (  !_WRITE_HAS_OCCURRED_$$d_u2 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 ==> _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_ADD(local_id_x$1, 1bv32), BV32_MUL(BV32_ADD(local_id_y$1, 1bv32), 34bv32)), 204bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_ADD(local_id_x$1, 1bv32), BV32_MUL(BV32_ADD(local_id_y$1, 1bv32), 34bv32)), 408bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(BV32_ADD(BV32_ADD(local_id_x$1, 1bv32), BV32_MUL(BV32_ADD(local_id_y$1, 1bv32), 34bv32)), 204bv32), 204bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_ADD(local_id_x$1, 1bv32), BV32_MUL(BV32_ADD(local_id_y$1, 1bv32), 34bv32)), 204bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_ADD(local_id_x$1, 1bv32), BV32_MUL(BV32_ADD(local_id_y$1, 1bv32), 34bv32)), 408bv32) )  ); 


    assert {:block_sourceloc} {:sourceloc_num 24} true;
    assert {:originated_from_invariant} {:sourceloc_num 25} {:thread 1} (if v16$1 != 0bv32 ==> $indg.0$1 == BV32_ADD(BV32_ADD(v12$1, BV32_MUL(v13$1, $pitch)), BV32_MUL(BV32_MUL($k.0, $NY), $pitch)) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 25} {:thread 2} (if v16$2 != 0bv32 ==> $indg.0$2 == BV32_ADD(BV32_ADD(v12$2, BV32_MUL(v13$2, $pitch)), BV32_MUL(BV32_MUL($k.0, $NY), $pitch)) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 26} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_u2 ==> BV32_UREM(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(v12$1, BV32_MUL(v13$1, $pitch))), BV32_MUL($NY, $pitch)) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 27} {:thread 1} (if _WRITE_HAS_OCCURRED_$$d_u2 ==> BV32_ULT(BV32_UDIV(BV32_SUB(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), BV32_ADD(v12$1, BV32_MUL(v13$1, $pitch))), BV32_MUL($NY, $pitch)), $NZ) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 28} {:thread 1} (if _WRITE_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 ==> BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_AND(v16$1, BV1_ZEXT32(BV1_XOR((if $halo.0$1 != 0bv32 then 1bv1 else 0bv1), 1bv1))) != 0bv32 ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_ADD(v10$1, 408bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_AND(BV1_ZEXT32(BV1_XOR((if v16$1 != 0bv32 then 1bv1 else 0bv1), 1bv1)), $halo.0$1) != 0bv32 ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_ADD($ind_h.0$1, 204bv32) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_AND(v16$1, $halo.0$1) != 0bv32 ==> BV32_OR(BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_ADD(v10$1, 408bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == BV32_ADD($ind_h.0$1, 204bv32) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 29} {:thread 1} (if BV32_AND(BV1_ZEXT32(BV1_XOR((if v16$1 != 0bv32 then 1bv1 else 0bv1), 1bv1)), BV1_ZEXT32(BV1_XOR((if $halo.0$1 != 0bv32 then 1bv1 else 0bv1), 1bv1))) != 0bv32 ==> BV1_XOR((if _WRITE_HAS_OCCURRED_$$_ZZ13GPU_laplace3diiiiPfS_E2u1 then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    v22 := BV32_SLT($k.0, $NZ);
    p16$1 := false;
    p16$2 := false;
    p17$1 := false;
  ...
  __partitioned_block_$truebb7_0:
    ...
    call {:sourceloc} {:sourceloc_num 33} _LOG_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p17$1, BV32_SUB(v11$1, 204bv32), v25$1, $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_SUB(v11$1, 204bv32)]);
    ...
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 33} _CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p17$2, BV32_SUB(v11$2, 204bv32), v25$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p17$1, BV32_ADD(v10$1, 408bv32), $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_ADD(v10$1, 408bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 34} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 34} _CHECK_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p17$2, BV32_ADD(v10$2, 408bv32), $$_ZZ13GPU_laplace3diiiiPfS_E2u1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v10$2, 408bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
    ...
    call {:sourceloc} {:sourceloc_num 38} _LOG_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p19$1, BV32_ADD(v10$1, 408bv32), v28$1, $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_ADD(v10$1, 408bv32)]);
    ...
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 38} _CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p19$2, BV32_ADD(v10$2, 408bv32), v28$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
    ...
    call {:sourceloc} {:sourceloc_num 43} _LOG_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p21$1, BV32_SUB($ind_h.0$1, 204bv32), v31$1, $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_SUB($ind_h.0$1, 204bv32)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 43} _CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p21$2, BV32_SUB($ind_h.0$2, 204bv32), v31$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
    ...
    call {:sourceloc} {:sourceloc_num 44} _LOG_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p21$1, BV32_ADD($ind_h.0$1, 204bv32), $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_ADD($ind_h.0$1, 204bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 44} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 44} _CHECK_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p21$2, BV32_ADD($ind_h.0$2, 204bv32), $$_ZZ13GPU_laplace3diiiiPfS_E2u1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($ind_h.0$2, 204bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
    ...
    call {:sourceloc} {:sourceloc_num 48} _LOG_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p23$1, BV32_ADD($ind_h.0$1, 204bv32), v34$1, $$_ZZ13GPU_laplace3diiiiPfS_E2u1[1bv1][BV32_ADD($ind_h.0$1, 204bv32)]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 48} _CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1(p23$2, BV32_ADD($ind_h.0$2, 204bv32), v34$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ13GPU_laplace3diiiiPfS_E2u1"} true;
  ...
  __partitioned_block_$truebb7_1:
    call {:sourceloc_num 51} $bugle_barrier_duplicated_0(1bv1, 1bv1);
    v35$1 := v16$1 != 0bv32;
    v35$2 := v16$2 != 0bv32;
  ...
  __partitioned_block_$truebb7_2:
    call {:sourceloc_num 70} $bugle_barrier_duplicated_1(1bv1, 1bv1);
