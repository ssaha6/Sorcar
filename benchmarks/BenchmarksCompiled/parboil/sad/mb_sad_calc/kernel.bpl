...
implementation {:source_name "mb_sad_calc"} {:kernel} $mb_sad_calc($mb_width: bv32, $mb_height: bv32)
{
  ...
  $5:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_x$1), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_y$1), 2bv32), $mb_height) && BV32_SLT($search_pos.0$1, $search_pos_end.0$1) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_x$2), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_y$2), 2bv32), $mb_height) && BV32_SLT($search_pos.0$2, $search_pos_end.0$2) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b5 ==> p4$1 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_x$1), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_y$1), 2bv32), $mb_height);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b5 ==> p4$2 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_x$2), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_y$2), 2bv32), $mb_height);
