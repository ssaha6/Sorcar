...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$blk_sad$ghost$$5 == _WRITE_HAS_OCCURRED_$$blk_sad )  ); 
...
assert  my_inv (  ( p4$1 ==> BV32_SLE(0bv32, $search_pos.0$1) )  && ( p4$2 ==> BV32_SLE(0bv32, $search_pos.0$2) ) ,  ( p4$1 ==> BV32_SLE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_SLE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_SGE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_SGE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_ULE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_ULE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_UGE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_UGE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> p4$1 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_x$1), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_y$1), 2bv32), $mb_height) )  && ( p4$2 ==> p4$2 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_x$2), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_y$2), 2bv32), $mb_height) ) ,  (  BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_x$1), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_y$1), 2bv32), $mb_height) && BV32_SLT($search_pos.0$1, $search_pos_end.0$1) ==> p4$1 )  && (  BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_x$2), 2bv32), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61bv32), 1bv32), group_id_y$2), 2bv32), $mb_height) && BV32_SLT($search_pos.0$2, $search_pos_end.0$2) ==> p4$2 ) ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_x$1), 2bv32), $mb_width) ) ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61bv32), 1bv32), group_id_y$1), 2bv32), $mb_height) ) ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 7} p4$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 8} {:thread 1} (if _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_UGE(BV32_SUB(BV32_UDIV(BV32_MUL(2bv32, _WATCHED_OFFSET), 2bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(BV32_MUL($mb_width, $mb_height), 1096bv32), 25bv32), BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v6$1, $mb_width), v5$1), 1096bv32), 16bv32)), BV32_MUL(BV32_ADD(BV32_MUL(4bv32, v8$1), v7$1), 1096bv32))), v13$1) then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 9} {:thread 1} (if _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_ULT(BV32_SUB(BV32_UDIV(BV32_MUL(2bv32, _WATCHED_OFFSET), 2bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(BV32_MUL($mb_width, $mb_height), 1096bv32), 25bv32), BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v6$1, $mb_width), v5$1), 1096bv32), 16bv32)), BV32_MUL(BV32_ADD(BV32_MUL(4bv32, v8$1), v7$1), 1096bv32))), $search_pos_end.0$1) then 1bv1 else 0bv1) != 0bv1;
  ...
  $9:
    ...
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v27$1 := (if p9$1 then _HAVOC_bv32$1 else v27$1);
    v27$2 := (if p9$2 then _HAVOC_bv32$2 else v27$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v28$1 := (if p9$1 then _HAVOC_bv32$1 else v28$1);
    v28$2 := (if p9$2 then _HAVOC_bv32$2 else v28$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v29$1 := (if p9$1 then _HAVOC_bv32$1 else v29$1);
    v29$2 := (if p9$2 then _HAVOC_bv32$2 else v29$2);
    havoc _HAVOC_bv16$1, _HAVOC_bv16$2;
    v30$1 := (if p9$1 then _HAVOC_bv16$1 else v30$1);
    v30$2 := (if p9$2 then _HAVOC_bv16$2 else v30$2);
    v31$1 := (if p9$1 then BV32_SUB(BV16_ZEXT32(v26$1[16:0]), BV16_ZEXT32(v30$1)) else v31$1);
    v31$2 := (if p9$2 then BV32_SUB(BV16_ZEXT32(v26$2[16:0]), BV16_ZEXT32(v30$2)) else v31$2);
    $sad4x4.1$1, $x.0$1 := (if p9$1 then BV32_ADD(BV16_ZEXT32($sad4x4.1$1), (if BV32_SGT(v31$1, 0bv32) then v31$1 else BV32_SUB(0bv32, v31$1)))[16:0] else $sad4x4.1$1), (if p9$1 then BV32_ADD($x.0$1, 1bv32) else $x.0$1);
...
const _WATCHED_VALUE_$$img_ref: bv32;

procedure {:inline 1} _LOG_READ_$$img_ref(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$img_ref;



implementation {:inline 1} _LOG_READ_$$img_ref(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$img_ref(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$img_ref(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$img_ref, _WRITE_READ_BENIGN_FLAG_$$img_ref;



implementation {:inline 1} _LOG_WRITE_$$img_ref(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$img_ref(_P: bool, _offset: bv32, _value: bv32);
