...
assert  my_inv (  (  BV32_AND(BV32_SUB(BV32_MUL($input_pitch, 2bv32), 1bv32), $load_bin.0$1) == BV32_AND(BV32_SUB(BV32_MUL($input_pitch, 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_MUL(v2$1, $input_pitch), 2bv32), BV32_MUL(v0$1, 2bv32))) )  && (  BV32_AND(BV32_SUB(BV32_MUL($input_pitch, 2bv32), 1bv32), $load_bin.0$2) == BV32_AND(BV32_SUB(BV32_MUL($input_pitch, 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_MUL(v2$2, $input_pitch), 2bv32), BV32_MUL(v0$2, 2bv32))) ) ,  (  BV32_AND(BV32_SUB($width, 1bv32), $store.0$1) == BV32_AND(BV32_SUB($width, 1bv32), BV32_ADD(BV32_MUL(v2$1, $width), v0$1)) )  && (  BV32_AND(BV32_SUB($width, 1bv32), $store.0$2) == BV32_AND(BV32_SUB($width, 1bv32), BV32_ADD(BV32_MUL(v2$2, $width), v0$2)) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$sm_mappings ==> BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL($width, 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4bv32), 3bv32)) )  ); 
  ...
  $truebb0:
    ...
    havoc v5$1, v5$2;
    havoc v6$1, v6$2;
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$sm_mappings(true, BV32_MUL($store.0$1, 4bv32), BV32_UDIV(v5$1, 24576bv32)[8:0], $$sm_mappings[BV32_MUL($store.0$1, 4bv32)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$sm_mappings(true, BV32_MUL($store.0$2, 4bv32), BV32_UDIV(v5$2, 24576bv32)[8:0]);
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$1, 4bv32), 1bv32), BV32_UREM(BV32_LSHR(v5$1, 10bv32), 24bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL($store.0$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$2, 4bv32), 1bv32), BV32_UREM(BV32_LSHR(v5$2, 10bv32), 24bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$1, 4bv32), 2bv32), BV32_UREM(BV32_LSHR(v5$1, 2bv32), 256bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL($store.0$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$2, 4bv32), 2bv32), BV32_UREM(BV32_LSHR(v5$2, 2bv32), 256bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$1, 4bv32), 3bv32), BV32_MUL(BV8_ZEXT32(BV32_UREM(v5$1, 4bv32)[8:0]), 8bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL($store.0$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$sm_mappings(true, BV32_ADD(BV32_MUL($store.0$2, 4bv32), 3bv32), BV32_MUL(BV8_ZEXT32(BV32_UREM(v5$2, 4bv32)[8:0]), 8bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 15} _LOG_WRITE_$$sm_mappings(p0$1, BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), BV32_UDIV(v6$1, 24576bv32)[8:0], $$sm_mappings[BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 15} _CHECK_WRITE_$$sm_mappings(p0$2, BV32_MUL(BV32_ADD($store.0$2, v1), 4bv32), BV32_UDIV(v6$2, 24576bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$sm_mappings(p0$1, BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 1bv32), BV32_UREM(BV32_LSHR(v6$1, 10bv32), 24bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$sm_mappings(p0$2, BV32_ADD(BV32_MUL(BV32_ADD($store.0$2, v1), 4bv32), 1bv32), BV32_UREM(BV32_LSHR(v6$2, 10bv32), 24bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$sm_mappings(p0$1, BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 2bv32), BV32_UREM(BV32_LSHR(v6$1, 2bv32), 256bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$sm_mappings(p0$2, BV32_ADD(BV32_MUL(BV32_ADD($store.0$2, v1), 4bv32), 2bv32), BV32_UREM(BV32_LSHR(v6$2, 2bv32), 256bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_WRITE_$$sm_mappings(p0$1, BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 3bv32), BV32_MUL(BV8_ZEXT32(BV32_UREM(v6$1, 4bv32)[8:0]), 8bv32)[8:0], $$sm_mappings[BV32_ADD(BV32_MUL(BV32_ADD($store.0$1, v1), 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 18} _CHECK_WRITE_$$sm_mappings(p0$2, BV32_ADD(BV32_MUL(BV32_ADD($store.0$2, v1), 4bv32), 3bv32), BV32_MUL(BV8_ZEXT32(BV32_UREM(v6$2, 4bv32)[8:0]), 8bv32)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sm_mappings"} true;
