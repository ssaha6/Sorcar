...
implementation {:source_name "histo_final_kernel"} {:kernel} $histo_final_kernel($sm_range_min: bv32, $sm_range_max: bv32, $histo_height: bv32, $histo_width: bv32)
{
  ...
  $5:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p3$1 ==> _b6 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i1.0$1) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(BV32_UDIV(v3, 4bv32), v2$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p3$2 ==> _b6 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i1.0$2) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(BV32_UDIV(v3, 4bv32), v2$2));
  ...
  $9:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p5$1 ==> _b12 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i4.0$1) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(BV32_UDIV(BV32_ADD(v3, v4), 4bv32), v2$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p5$2 ==> _b12 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i4.0$2) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(BV32_UDIV(BV32_ADD(v3, v4), 4bv32), v2$2));
