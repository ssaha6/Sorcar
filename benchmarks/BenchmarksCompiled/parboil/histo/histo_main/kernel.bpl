...
implementation {:source_name "histo_main_kernel"} {:kernel} $histo_main_kernel($num_elements: bv32, $sm_range_min: bv32, $sm_range_max: bv32, $histo_height: bv32, $histo_width: bv32)
{
  ...
  var $bin_plus_1_add.i.86.0$1: bv32;
  var $bin_plus_1_add.i.86.0$2: bv32;
  var $bin_plus_2_add.i.87.0$1: bv32;
  var $bin_plus_2_add.i.87.0$2: bv32;
  var $bin_plus_3_add.i.88.0$1: bv32;
  var $bin_plus_3_add.i.88.0$2: bv32;
  var $local_scan_load.1$1: bv32;
  var $local_scan_load.1$2: bv32;
  var $bin_plus_1_add.i.86.3$1: bv32;
  var $bin_plus_1_add.i.86.3$2: bv32;
  var $bin_plus_2_add.i.87.3$1: bv32;
  var $bin_plus_2_add.i.87.3$2: bv32;
  var $bin_plus_3_add.i.88.3$1: bv32;
  var $bin_plus_3_add.i.88.3$2: bv32;
  var $bin_plus_1_add.i.86.2$1: bv32;
  var $bin_plus_1_add.i.86.2$2: bv32;
  var $bin_plus_2_add.i.87.2$1: bv32;
  var $bin_plus_2_add.i.87.2$2: bv32;
  var $bin_plus_3_add.i.88.2$1: bv32;
  var $bin_plus_3_add.i.88.2$2: bv32;
  var $overflow_into_bin_plus_1.i.80.0$1: bv8;
  var $overflow_into_bin_plus_1.i.80.0$2: bv8;
  var $overflow_into_bin_plus_2.i.81.0$1: bv8;
  var $overflow_into_bin_plus_2.i.81.0$2: bv8;
  var $overflow_into_bin_plus_3.i.82.0$1: bv8;
  var $overflow_into_bin_plus_3.i.82.0$2: bv8;
  var $bin_plus_1_add.i.86.1$1: bv32;
  var $bin_plus_1_add.i.86.1$2: bv32;
  var $bin_plus_2_add.i.87.1$1: bv32;
  var $bin_plus_2_add.i.87.1$2: bv32;
  var $bin_plus_3_add.i.88.1$1: bv32;
  var $bin_plus_3_add.i.88.1$2: bv32;
  var $i.i.187.0$1: bv32;
  var $i.i.187.0$2: bv32;
  var v2$1: bv32;
  var v2$2: bv32;
  var v4$1: bool;
  var v4$2: bool;
  ...
  var _ATOMIC_HAS_OCCURRED_$$global_histo$ghost$$while.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond.10: bool;
  var _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond.10: bool;
  ...
  $for.cond.i:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    ...
    assert {:originated_from_invariant} {:sourceloc_num 2} {:thread 1} p0$1 ==> (if BV32_UREM($i.i.0$1, group_size_x) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 2} {:thread 2} p0$2 ==> (if BV32_UREM($i.i.0$2, group_size_x) == local_id_x$2 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), group_size_x) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    ...
    _abstracted_call_arg_8$1 := (if p1$1 then _HAVOC_bv32$1 else _abstracted_call_arg_8$1);
    _abstracted_call_arg_8$2 := (if p1$2 then _HAVOC_bv32$2 else _abstracted_call_arg_8$2);
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$histo_main_kernel.sub_histo(p1$1, $i.i.0$1, 0bv32, _abstracted_call_arg_8$1);
    ...
    call {:check_id "check_state_20"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$histo_main_kernel.sub_histo(p1$2, $i.i.0$2, 0bv32);
  ...
  __partitioned_block_$for.cond.i.tail_1:
    ...
    _ATOMIC_HAS_OCCURRED_$$global_histo$ghost$$while.cond := _ATOMIC_HAS_OCCURRED_$$global_histo;
    _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond := _ATOMIC_HAS_OCCURRED_$$global_overflow;
    _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond := _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $while.cond;

  $while.cond:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assert {:tag "disabledMaintainsInstrumentation"} _b30 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond == _ATOMIC_HAS_OCCURRED_$$global_overflow;
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_histo$ghost$$while.cond == _ATOMIC_HAS_OCCURRED_$$global_histo;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p4"} {:dominator_predicate "p3"} true;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b27 ==> group_id_y$1 == 0bv32 && BV32_ULT($local_scan_load.0$1, $num_elements) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b27 ==> group_id_y$2 == 0bv32 && BV32_ULT($local_scan_load.0$2, $num_elements) ==> p4$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b25 ==> BV32_UGE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b25 ==> BV32_UGE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b24 ==> BV32_ULE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b24 ==> BV32_ULE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b23 ==> BV32_SGE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b23 ==> BV32_SGE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b22 ==> BV32_SLE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b22 ==> BV32_SLE($local_scan_load.0$2, v3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b21 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v3$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b21 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v3$2);
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_ATOMIC_$$histo_main_kernel.sub_histo(p7$1, BV32_SDIV(BV32_ADD(BV32_MUL(v15$1, 1024bv32), BV32_MUL(v16$1, 4bv32)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 16} _CHECK_ATOMIC_$$histo_main_kernel.sub_histo(p7$2, BV32_SDIV(BV32_ADD(BV32_MUL(v15$2, 1024bv32), BV32_MUL(v16$2, 4bv32)), 4bv32));
    ...
    v31$1 := (if p9$1 then $overflow_into_bin_plus_1.i.0$1[1:0] == 1bv1 else v31$1);
    v31$2 := (if p9$2 then $overflow_into_bin_plus_1.i.0$2[1:0] == 1bv1 else v31$2);
    ...
    v32$1 := (if p9$1 then $overflow_into_bin_plus_2.i.0$1[1:0] == 1bv1 else v32$1);
    v32$2 := (if p9$2 then $overflow_into_bin_plus_2.i.0$2[1:0] == 1bv1 else v32$2);
    ...
    v33$1 := (if p9$1 then $overflow_into_bin_plus_3.i.0$1[1:0] == 1bv1 else v33$1);
    v33$2 := (if p9$2 then $overflow_into_bin_plus_3.i.0$2[1:0] == 1bv1 else v33$2);
    ...
    call {:sourceloc} {:sourceloc_num 33} _LOG_ATOMIC_$$global_overflow(p9$1, BV32_SDIV(BV32_MUL(v22$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 33} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 33} _CHECK_ATOMIC_$$global_overflow(p9$2, BV32_SDIV(BV32_MUL(v22$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v34$1 := (if p9$1 then _HAVOC_bv32$1 else v34$1);
    v34$2 := (if p9$2 then _HAVOC_bv32$2 else v34$2);
    v35$1 := (if p9$1 then $overflow_into_bin_plus_1.i.0$1[1:0] == 1bv1 else v35$1);
    v35$2 := (if p9$2 then $overflow_into_bin_plus_1.i.0$2[1:0] == 1bv1 else v35$2);
    p29$1 := (if p9$1 && v35$1 then v35$1 else p29$1);
    p29$2 := (if p9$2 && v35$2 then v35$2 else p29$2);
    call {:sourceloc} {:sourceloc_num 35} _LOG_ATOMIC_$$global_overflow(p29$1, BV32_SDIV(BV32_MUL(BV32_ADD(v22$1, 1bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_19"} {:captureState "check_state_19"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_19"} {:sourceloc} {:sourceloc_num 35} _CHECK_ATOMIC_$$global_overflow(p29$2, BV32_SDIV(BV32_MUL(BV32_ADD(v22$2, 1bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v36$1 := (if p29$1 then _HAVOC_bv32$1 else v36$1);
    v36$2 := (if p29$2 then _HAVOC_bv32$2 else v36$2);
    v37$1 := (if p9$1 then $overflow_into_bin_plus_2.i.0$1[1:0] == 1bv1 else v37$1);
    v37$2 := (if p9$2 then $overflow_into_bin_plus_2.i.0$2[1:0] == 1bv1 else v37$2);
    p31$1 := (if p9$1 && v37$1 then v37$1 else p31$1);
    p31$2 := (if p9$2 && v37$2 then v37$2 else p31$2);
    call {:sourceloc} {:sourceloc_num 38} _LOG_ATOMIC_$$global_overflow(p31$1, BV32_SDIV(BV32_MUL(BV32_ADD(v22$1, 2bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_18"} {:captureState "check_state_18"} {:sourceloc} {:sourceloc_num 38} true;
    call {:check_id "check_state_18"} {:sourceloc} {:sourceloc_num 38} _CHECK_ATOMIC_$$global_overflow(p31$2, BV32_SDIV(BV32_MUL(BV32_ADD(v22$2, 2bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v38$1 := (if p31$1 then _HAVOC_bv32$1 else v38$1);
    v38$2 := (if p31$2 then _HAVOC_bv32$2 else v38$2);
    v39$1 := (if p9$1 then $overflow_into_bin_plus_3.i.0$1[1:0] == 1bv1 else v39$1);
    v39$2 := (if p9$2 then $overflow_into_bin_plus_3.i.0$2[1:0] == 1bv1 else v39$2);
    p33$1 := (if p9$1 && v39$1 then v39$1 else p33$1);
    p33$2 := (if p9$2 && v39$2 then v39$2 else p33$2);
    call {:sourceloc} {:sourceloc_num 41} _LOG_ATOMIC_$$global_overflow(p33$1, BV32_SDIV(BV32_MUL(BV32_ADD(v22$1, 3bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 41} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 41} _CHECK_ATOMIC_$$global_overflow(p33$2, BV32_SDIV(BV32_MUL(BV32_ADD(v22$2, 3bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v40$1 := (if p33$1 then _HAVOC_bv32$1 else v40$1);
    v40$2 := (if p33$2 then _HAVOC_bv32$2 else v40$2);
    ...
    v44$1 := (if p38$1 then BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(v41$1, 24576bv32), BV32_UDIV(BV8_ZEXT32(v13$1), 8bv32)), BV32_SHL(BV8_ZEXT32(v12$1), 2bv32)), BV32_SHL(BV8_ZEXT32(v11$1), 10bv32)) else v44$1);
    v44$2 := (if p38$2 then BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(v41$2, 24576bv32), BV32_UDIV(BV8_ZEXT32(v13$2), 8bv32)), BV32_SHL(BV8_ZEXT32(v12$2), 2bv32)), BV32_SHL(BV8_ZEXT32(v11$2), 10bv32)) else v44$2);
    v45$1 := (if p38$1 then BV32_UDIV(v44$1, 2bv32) else v45$1);
    v45$2 := (if p38$2 then BV32_UDIV(v44$2, 2bv32) else v45$2);
    v46$1 := (if p38$1 then (if BV32_UREM(v44$1, 2bv32) == 1bv32 then 16bv32 else 0bv32) else v46$1);
    v46$2 := (if p38$2 then (if BV32_UREM(v44$2, 2bv32) == 1bv32 then 16bv32 else 0bv32) else v46$2);
    call {:sourceloc} {:sourceloc_num 47} _LOG_ATOMIC_$$global_histo(p38$1, BV32_SDIV(BV32_MUL(v45$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 47} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 47} _CHECK_ATOMIC_$$global_histo(p38$2, BV32_SDIV(BV32_MUL(v45$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_histo"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v47$1 := (if p38$1 then _HAVOC_bv32$1 else v47$1);
    v47$2 := (if p38$2 then _HAVOC_bv32$2 else v47$2);
    v48$1 := (if p38$1 then BV32_SLT(BV16_ZEXT32(BV32_AND(BV32_LSHR(v47$1, BV32_AND(v46$1, 31bv32)), 65535bv32)[16:0]), 255bv32) else v48$1);
    v48$2 := (if p38$2 then BV32_SLT(BV16_ZEXT32(BV32_AND(BV32_LSHR(v47$2, BV32_AND(v46$2, 31bv32)), 65535bv32)[16:0]), 255bv32) else v48$2);
    p40$1 := (if p38$1 && v48$1 then v48$1 else p40$1);
    p40$2 := (if p38$2 && v48$2 then v48$2 else p40$2);
    call {:sourceloc} {:sourceloc_num 49} _LOG_ATOMIC_$$global_histo(p40$1, BV32_SDIV(BV32_MUL(v45$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 49} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 49} _CHECK_ATOMIC_$$global_histo(p40$2, BV32_SDIV(BV32_MUL(v45$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_histo"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v49$1 := (if p40$1 then _HAVOC_bv32$1 else v49$1);
    v49$2 := (if p40$2 then _HAVOC_bv32$2 else v49$2);
  ...
  $while.cond.tail:
    assume !p4$1 && !p4$2;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v50$1 := (if p41$1 then _HAVOC_bv32$1 else v50$1);
    v50$2 := (if p41$2 then _HAVOC_bv32$2 else v50$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v51$1 := (if p41$1 then _HAVOC_bv32$1 else v51$1);
    v51$2 := (if p41$2 then _HAVOC_bv32$2 else v51$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v52$1 := (if p41$1 then _HAVOC_bv32$1 else v52$1);
    v52$2 := (if p41$2 then _HAVOC_bv32$2 else v52$2);
    $bin_plus_1_add.i.86.0$1, $bin_plus_2_add.i.87.0$1, $bin_plus_3_add.i.88.0$1, $local_scan_load.1$1 := (if p41$1 then v50$1 else $bin_plus_1_add.i.86.0$1), (if p41$1 then v51$1 else $bin_plus_2_add.i.87.0$1), (if p41$1 then v52$1 else $bin_plus_3_add.i.88.0$1), (if p41$1 then v3$1 else $local_scan_load.1$1);
    $bin_plus_1_add.i.86.0$2, $bin_plus_2_add.i.87.0$2, $bin_plus_3_add.i.88.0$2, $local_scan_load.1$2 := (if p41$2 then v50$2 else $bin_plus_1_add.i.86.0$2), (if p41$2 then v51$2 else $bin_plus_2_add.i.87.0$2), (if p41$2 then v52$2 else $bin_plus_3_add.i.88.0$2), (if p41$2 then v3$2 else $local_scan_load.1$2);
    p42$1 := (if p41$1 then true else p42$1);
    p42$2 := (if p41$2 then true else p42$2);
    _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond.10 := _ATOMIC_HAS_OCCURRED_$$global_overflow;
    _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond.10 := _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $while.cond.10;

  $while.cond.10:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b33 ==> !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$while.cond.10 == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assert {:tag "disabledMaintainsInstrumentation"} _b32 ==> !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$while.cond.10 == _ATOMIC_HAS_OCCURRED_$$global_overflow;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p42"} {:dominator_predicate "p41"} true;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> group_id_y$1 != 0bv32 && BV32_ULT($local_scan_load.1$1, $num_elements) ==> p42$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> group_id_y$2 != 0bv32 && BV32_ULT($local_scan_load.1$2, $num_elements) ==> p42$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p42$1 ==> _b12 ==> p42$1 ==> group_id_y$1 != 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p42$2 ==> _b12 ==> p42$2 ==> group_id_y$2 != 0bv32;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p42$1 ==> _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.1$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v3$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p42$2 ==> _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.1$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v3$2);
    ...
    v54$1 := (if p43$1 then $$sm_mappings[BV32_MUL($local_scan_load.1$1, 4bv32)] else v54$1);
    v54$2 := (if p43$2 then $$sm_mappings[BV32_MUL($local_scan_load.1$2, 4bv32)] else v54$2);
    v55$1 := (if p43$1 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$1, 4bv32), 1bv32)] else v55$1);
    v55$2 := (if p43$2 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$2, 4bv32), 1bv32)] else v55$2);
    v56$1 := (if p43$1 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$1, 4bv32), 2bv32)] else v56$1);
    v56$2 := (if p43$2 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$2, 4bv32), 2bv32)] else v56$2);
    v57$1 := (if p43$1 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$1, 4bv32), 3bv32)] else v57$1);
    v57$2 := (if p43$2 then $$sm_mappings[BV32_ADD(BV32_MUL($local_scan_load.1$2, 4bv32), 3bv32)] else v57$2);
    ...
    $bin_plus_1_add.i.86.3$1, $bin_plus_2_add.i.87.3$1, $bin_plus_3_add.i.88.3$1 := (if p44$1 then $bin_plus_1_add.i.86.0$1 else $bin_plus_1_add.i.86.3$1), (if p44$1 then $bin_plus_2_add.i.87.0$1 else $bin_plus_2_add.i.87.3$1), (if p44$1 then $bin_plus_3_add.i.88.0$1 else $bin_plus_3_add.i.88.3$1);
    $bin_plus_1_add.i.86.3$2, $bin_plus_2_add.i.87.3$2, $bin_plus_3_add.i.88.3$2 := (if p44$2 then $bin_plus_1_add.i.86.0$2 else $bin_plus_1_add.i.86.3$2), (if p44$2 then $bin_plus_2_add.i.87.0$2 else $bin_plus_2_add.i.87.3$2), (if p44$2 then $bin_plus_3_add.i.88.0$2 else $bin_plus_3_add.i.88.3$2);
    call {:sourceloc} {:sourceloc_num 61} _LOG_ATOMIC_$$histo_main_kernel.sub_histo(p45$1, BV32_SDIV(BV32_ADD(BV32_MUL(v59$1, 1024bv32), BV32_MUL(v60$1, 4bv32)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 61} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 61} _CHECK_ATOMIC_$$histo_main_kernel.sub_histo(p45$2, BV32_SDIV(BV32_ADD(BV32_MUL(v59$2, 1024bv32), BV32_MUL(v60$2, 4bv32)), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histo_main_kernel.sub_histo"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v63$1 := (if p45$1 then _HAVOC_bv32$1 else v63$1);
    v63$2 := (if p45$2 then _HAVOC_bv32$2 else v63$2);
    v64$1 := (if p45$1 then BV32_AND(BV32_LSHR(v63$1, BV32_AND(v61$1, 31bv32)), 255bv32) else v64$1);
    v64$2 := (if p45$2 then BV32_AND(BV32_LSHR(v63$2, BV32_AND(v61$2, 31bv32)), 255bv32) else v64$2);
    v65$1 := (if p45$1 then v64$1 == 255bv32 else v65$1);
    v65$2 := (if p45$2 then v64$2 == 255bv32 else v65$2);
    ...
    $bin_plus_1_add.i.86.2$1, $bin_plus_2_add.i.87.2$1, $bin_plus_3_add.i.88.2$1 := (if p46$1 then $bin_plus_1_add.i.86.0$1 else $bin_plus_1_add.i.86.2$1), (if p46$1 then $bin_plus_2_add.i.87.0$1 else $bin_plus_2_add.i.87.2$1), (if p46$1 then $bin_plus_3_add.i.88.0$1 else $bin_plus_3_add.i.88.2$1);
    $bin_plus_1_add.i.86.2$2, $bin_plus_2_add.i.87.2$2, $bin_plus_3_add.i.88.2$2 := (if p46$2 then $bin_plus_1_add.i.86.0$2 else $bin_plus_1_add.i.86.2$2), (if p46$2 then $bin_plus_2_add.i.87.0$2 else $bin_plus_2_add.i.87.2$2), (if p46$2 then $bin_plus_3_add.i.88.0$2 else $bin_plus_3_add.i.88.2$2);
    v66$1 := (if p47$1 then BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(v58$1, 24576bv32), BV32_UDIV(v61$1, 8bv32)), BV32_SHL(v60$1, 2bv32)), BV32_SHL(v59$1, 10bv32)) else v66$1);
    v66$2 := (if p47$2 then BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(v58$2, 24576bv32), BV32_UDIV(v61$2, 8bv32)), BV32_SHL(v60$2, 2bv32)), BV32_SHL(v59$2, 10bv32)) else v66$2);
    v67$1 := (if p47$1 then BV32_ULT(v61$1, 24bv32) else v67$1);
    v67$2 := (if p47$2 then BV32_ULT(v61$2, 24bv32) else v67$2);
    v68$1 := (if p47$1 then BV32_ULT(v61$1, 16bv32) else v68$1);
    v68$2 := (if p47$2 then BV32_ULT(v61$2, 16bv32) else v68$2);
    v69$1 := (if p47$1 then BV32_ULT(v61$1, 8bv32) else v69$1);
    v69$2 := (if p47$2 then BV32_ULT(v61$2, 8bv32) else v69$2);
    v70$1 := (if p47$1 then BV32_AND(BV32_LSHR(v63$1, BV32_AND(BV32_ADD(v61$1, 8bv32), 31bv32)), 255bv32) else v70$1);
    v70$2 := (if p47$2 then BV32_AND(BV32_LSHR(v63$2, BV32_AND(BV32_ADD(v61$2, 8bv32), 31bv32)), 255bv32) else v70$2);
    v71$1 := (if p47$1 then BV32_AND(BV32_LSHR(v63$1, BV32_AND(BV32_ADD(v61$1, 16bv32), 31bv32)), 255bv32) else v71$1);
    v71$2 := (if p47$2 then BV32_AND(BV32_LSHR(v63$2, BV32_AND(BV32_ADD(v61$2, 16bv32), 31bv32)), 255bv32) else v71$2);
    ...
    $overflow_into_bin_plus_1.i.80.0$1 := (if p48$1 then 0bv8 else $overflow_into_bin_plus_1.i.80.0$1);
    $overflow_into_bin_plus_1.i.80.0$2 := (if p48$2 then 0bv8 else $overflow_into_bin_plus_1.i.80.0$2);
    v72$1 := (if p49$1 then v64$1 == 255bv32 else v72$1);
    v72$2 := (if p49$2 then v64$2 == 255bv32 else v72$2);
    ...
    $overflow_into_bin_plus_1.i.80.0$1 := (if p50$1 then 0bv8 else $overflow_into_bin_plus_1.i.80.0$1);
    $overflow_into_bin_plus_1.i.80.0$2 := (if p50$2 then 0bv8 else $overflow_into_bin_plus_1.i.80.0$2);
    $overflow_into_bin_plus_1.i.80.0$1 := (if p51$1 then 1bv8 else $overflow_into_bin_plus_1.i.80.0$1);
    $overflow_into_bin_plus_1.i.80.0$2 := (if p51$2 then 1bv8 else $overflow_into_bin_plus_1.i.80.0$2);
    ...
    $overflow_into_bin_plus_2.i.81.0$1 := (if p52$1 then 0bv8 else $overflow_into_bin_plus_2.i.81.0$1);
    $overflow_into_bin_plus_2.i.81.0$2 := (if p52$2 then 0bv8 else $overflow_into_bin_plus_2.i.81.0$2);
    v73$1 := (if p53$1 then v70$1 == 255bv32 else v73$1);
    v73$2 := (if p53$2 then v70$2 == 255bv32 else v73$2);
    ...
    $overflow_into_bin_plus_2.i.81.0$1 := (if p54$1 then 0bv8 else $overflow_into_bin_plus_2.i.81.0$1);
    $overflow_into_bin_plus_2.i.81.0$2 := (if p54$2 then 0bv8 else $overflow_into_bin_plus_2.i.81.0$2);
    $overflow_into_bin_plus_2.i.81.0$1 := (if p55$1 then 1bv8 else $overflow_into_bin_plus_2.i.81.0$1);
    $overflow_into_bin_plus_2.i.81.0$2 := (if p55$2 then 1bv8 else $overflow_into_bin_plus_2.i.81.0$2);
    ...
    $overflow_into_bin_plus_3.i.82.0$1 := (if p56$1 then 0bv8 else $overflow_into_bin_plus_3.i.82.0$1);
    $overflow_into_bin_plus_3.i.82.0$2 := (if p56$2 then 0bv8 else $overflow_into_bin_plus_3.i.82.0$2);
    v74$1 := (if p57$1 then v71$1 == 255bv32 else v74$1);
    v74$2 := (if p57$2 then v71$2 == 255bv32 else v74$2);
    ...
    $overflow_into_bin_plus_3.i.82.0$1 := (if p58$1 then 0bv8 else $overflow_into_bin_plus_3.i.82.0$1);
    $overflow_into_bin_plus_3.i.82.0$2 := (if p58$2 then 0bv8 else $overflow_into_bin_plus_3.i.82.0$2);
    $overflow_into_bin_plus_3.i.82.0$1 := (if p59$1 then 1bv8 else $overflow_into_bin_plus_3.i.82.0$1);
    $overflow_into_bin_plus_3.i.82.0$2 := (if p59$2 then 1bv8 else $overflow_into_bin_plus_3.i.82.0$2);
    v75$1 := (if p47$1 then $overflow_into_bin_plus_1.i.80.0$1[1:0] == 1bv1 else v75$1);
    v75$2 := (if p47$2 then $overflow_into_bin_plus_1.i.80.0$2[1:0] == 1bv1 else v75$2);
    ...
    $bin_plus_1_add.i.86.1$1 := (if p60$1 then $bin_plus_1_add.i.86.0$1 else $bin_plus_1_add.i.86.1$1);
    $bin_plus_1_add.i.86.1$2 := (if p60$2 then $bin_plus_1_add.i.86.0$2 else $bin_plus_1_add.i.86.1$2);
    $bin_plus_1_add.i.86.1$1 := (if p61$1 then (if BV32_ULT(v70$1, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_1_add.i.86.1$1);
    $bin_plus_1_add.i.86.1$2 := (if p61$2 then (if BV32_ULT(v70$2, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_1_add.i.86.1$2);
    v76$1 := (if p47$1 then $overflow_into_bin_plus_2.i.81.0$1[1:0] == 1bv1 else v76$1);
    v76$2 := (if p47$2 then $overflow_into_bin_plus_2.i.81.0$2[1:0] == 1bv1 else v76$2);
    ...
    $bin_plus_2_add.i.87.1$1 := (if p62$1 then $bin_plus_2_add.i.87.0$1 else $bin_plus_2_add.i.87.1$1);
    $bin_plus_2_add.i.87.1$2 := (if p62$2 then $bin_plus_2_add.i.87.0$2 else $bin_plus_2_add.i.87.1$2);
    $bin_plus_2_add.i.87.1$1 := (if p63$1 then (if BV32_ULT(v71$1, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_2_add.i.87.1$1);
    $bin_plus_2_add.i.87.1$2 := (if p63$2 then (if BV32_ULT(v71$2, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_2_add.i.87.1$2);
    v77$1 := (if p47$1 then $overflow_into_bin_plus_3.i.82.0$1[1:0] == 1bv1 else v77$1);
    v77$2 := (if p47$2 then $overflow_into_bin_plus_3.i.82.0$2[1:0] == 1bv1 else v77$2);
    ...
    $bin_plus_3_add.i.88.1$1 := (if p64$1 then $bin_plus_3_add.i.88.0$1 else $bin_plus_3_add.i.88.1$1);
    $bin_plus_3_add.i.88.1$2 := (if p64$2 then $bin_plus_3_add.i.88.0$2 else $bin_plus_3_add.i.88.1$2);
    $bin_plus_3_add.i.88.1$1 := (if p65$1 then (if BV32_ULT(BV32_AND(BV32_LSHR(v63$1, BV32_AND(BV32_ADD(v61$1, 24bv32), 31bv32)), 255bv32), 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_3_add.i.88.1$1);
    $bin_plus_3_add.i.88.1$2 := (if p65$2 then (if BV32_ULT(BV32_AND(BV32_LSHR(v63$2, BV32_AND(BV32_ADD(v61$2, 24bv32), 31bv32)), 255bv32), 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_3_add.i.88.1$2);
    call {:sourceloc} {:sourceloc_num 78} _LOG_ATOMIC_$$global_overflow(p47$1, BV32_SDIV(BV32_MUL(v66$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 78} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 78} _CHECK_ATOMIC_$$global_overflow(p47$2, BV32_SDIV(BV32_MUL(v66$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v78$1 := (if p47$1 then _HAVOC_bv32$1 else v78$1);
    v78$2 := (if p47$2 then _HAVOC_bv32$2 else v78$2);
    v79$1 := (if p47$1 then $overflow_into_bin_plus_1.i.80.0$1[1:0] == 1bv1 else v79$1);
    v79$2 := (if p47$2 then $overflow_into_bin_plus_1.i.80.0$2[1:0] == 1bv1 else v79$2);
    p67$1 := (if p47$1 && v79$1 then v79$1 else p67$1);
    p67$2 := (if p47$2 && v79$2 then v79$2 else p67$2);
    call {:sourceloc} {:sourceloc_num 80} _LOG_ATOMIC_$$global_overflow(p67$1, BV32_SDIV(BV32_MUL(BV32_ADD(v66$1, 1bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 80} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 80} _CHECK_ATOMIC_$$global_overflow(p67$2, BV32_SDIV(BV32_MUL(BV32_ADD(v66$2, 1bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v80$1 := (if p67$1 then _HAVOC_bv32$1 else v80$1);
    v80$2 := (if p67$2 then _HAVOC_bv32$2 else v80$2);
    v81$1 := (if p47$1 then $overflow_into_bin_plus_2.i.81.0$1[1:0] == 1bv1 else v81$1);
    v81$2 := (if p47$2 then $overflow_into_bin_plus_2.i.81.0$2[1:0] == 1bv1 else v81$2);
    p69$1 := (if p47$1 && v81$1 then v81$1 else p69$1);
    p69$2 := (if p47$2 && v81$2 then v81$2 else p69$2);
    call {:sourceloc} {:sourceloc_num 83} _LOG_ATOMIC_$$global_overflow(p69$1, BV32_SDIV(BV32_MUL(BV32_ADD(v66$1, 2bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 83} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 83} _CHECK_ATOMIC_$$global_overflow(p69$2, BV32_SDIV(BV32_MUL(BV32_ADD(v66$2, 2bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v82$1 := (if p69$1 then _HAVOC_bv32$1 else v82$1);
    v82$2 := (if p69$2 then _HAVOC_bv32$2 else v82$2);
    v83$1 := (if p47$1 then $overflow_into_bin_plus_3.i.82.0$1[1:0] == 1bv1 else v83$1);
    v83$2 := (if p47$2 then $overflow_into_bin_plus_3.i.82.0$2[1:0] == 1bv1 else v83$2);
    p71$1 := (if p47$1 && v83$1 then v83$1 else p71$1);
    p71$2 := (if p47$2 && v83$2 then v83$2 else p71$2);
    call {:sourceloc} {:sourceloc_num 86} _LOG_ATOMIC_$$global_overflow(p71$1, BV32_SDIV(BV32_MUL(BV32_ADD(v66$1, 3bv32), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 86} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 86} _CHECK_ATOMIC_$$global_overflow(p71$2, BV32_SDIV(BV32_MUL(BV32_ADD(v66$2, 3bv32), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_overflow"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v84$1 := (if p71$1 then _HAVOC_bv32$1 else v84$1);
    v84$2 := (if p71$2 then _HAVOC_bv32$2 else v84$2);
    $bin_plus_1_add.i.86.2$1, $bin_plus_2_add.i.87.2$1, $bin_plus_3_add.i.88.2$1 := (if p47$1 then $bin_plus_1_add.i.86.1$1 else $bin_plus_1_add.i.86.2$1), (if p47$1 then $bin_plus_2_add.i.87.1$1 else $bin_plus_2_add.i.87.2$1), (if p47$1 then $bin_plus_3_add.i.88.1$1 else $bin_plus_3_add.i.88.2$1);
    $bin_plus_1_add.i.86.2$2, $bin_plus_2_add.i.87.2$2, $bin_plus_3_add.i.88.2$2 := (if p47$2 then $bin_plus_1_add.i.86.1$2 else $bin_plus_1_add.i.86.2$2), (if p47$2 then $bin_plus_2_add.i.87.1$2 else $bin_plus_2_add.i.87.2$2), (if p47$2 then $bin_plus_3_add.i.88.1$2 else $bin_plus_3_add.i.88.2$2);
    $bin_plus_1_add.i.86.3$1, $bin_plus_2_add.i.87.3$1, $bin_plus_3_add.i.88.3$1 := (if p45$1 then $bin_plus_1_add.i.86.2$1 else $bin_plus_1_add.i.86.3$1), (if p45$1 then $bin_plus_2_add.i.87.2$1 else $bin_plus_2_add.i.87.3$1), (if p45$1 then $bin_plus_3_add.i.88.2$1 else $bin_plus_3_add.i.88.3$1);
    $bin_plus_1_add.i.86.3$2, $bin_plus_2_add.i.87.3$2, $bin_plus_3_add.i.88.3$2 := (if p45$2 then $bin_plus_1_add.i.86.2$2 else $bin_plus_1_add.i.86.3$2), (if p45$2 then $bin_plus_2_add.i.87.2$2 else $bin_plus_2_add.i.87.3$2), (if p45$2 then $bin_plus_3_add.i.88.2$2 else $bin_plus_3_add.i.88.3$2);
    $bin_plus_1_add.i.86.0$1, $bin_plus_2_add.i.87.0$1, $bin_plus_3_add.i.88.0$1, $local_scan_load.1$1 := (if p43$1 then $bin_plus_1_add.i.86.3$1 else $bin_plus_1_add.i.86.0$1), (if p43$1 then $bin_plus_2_add.i.87.3$1 else $bin_plus_2_add.i.87.0$1), (if p43$1 then $bin_plus_3_add.i.88.3$1 else $bin_plus_3_add.i.88.0$1), (if p43$1 then BV32_ADD($local_scan_load.1$1, BV32_MUL(v0, v1)) else $local_scan_load.1$1);
    $bin_plus_1_add.i.86.0$2, $bin_plus_2_add.i.87.0$2, $bin_plus_3_add.i.88.0$2, $local_scan_load.1$2 := (if p43$2 then $bin_plus_1_add.i.86.3$2 else $bin_plus_1_add.i.86.0$2), (if p43$2 then $bin_plus_2_add.i.87.3$2 else $bin_plus_2_add.i.87.0$2), (if p43$2 then $bin_plus_3_add.i.88.3$2 else $bin_plus_3_add.i.88.0$2), (if p43$2 then BV32_ADD($local_scan_load.1$2, BV32_MUL(v0, v1)) else $local_scan_load.1$2);
    p42$1 := (if p43$1 then true else p42$1);
    p42$2 := (if p43$2 then true else p42$2);
    goto $while.cond.10.backedge, __partitioned_block_$while.cond.10.tail_0;

  __partitioned_block_$while.cond.10.tail_0:
    assume !p42$1 && !p42$2;
    goto __partitioned_block_$while.cond.10.tail_1;

  __partitioned_block_$while.cond.10.tail_1:
    call {:sourceloc_num 91} $bugle_barrier_duplicated_1(1bv1, 0bv1);
    $i.i.187.0$1 := local_id_x$1;
    $i.i.187.0$2 := local_id_x$2;
    p72$1 := true;
    p72$2 := true;
  ...
  $for.cond.i.192:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_SLT($i.i.187.0$1, 6144bv32) ==> p72$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_SLT($i.i.187.0$2, 6144bv32) ==> p72$2;
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b19 ==> BV32_UGE($i.i.187.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b19 ==> BV32_UGE($i.i.187.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b18 ==> BV32_ULE($i.i.187.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b18 ==> BV32_ULE($i.i.187.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b17 ==> BV32_SGE($i.i.187.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b17 ==> BV32_SGE($i.i.187.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b16 ==> BV32_SLE($i.i.187.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b16 ==> BV32_SLE($i.i.187.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p72$1 ==> _b15 ==> BV32_SLE(0bv32, $i.i.187.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p72$2 ==> _b15 ==> BV32_SLE(0bv32, $i.i.187.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p72$1 ==> _b14 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.187.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p72$2 ==> _b14 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.187.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2);
    assert {:block_sourceloc} {:sourceloc_num 92} p72$1 ==> true;
    v85$1 := (if p72$1 then BV32_SLT($i.i.187.0$1, 6144bv32) else v85$1);
    v85$2 := (if p72$2 then BV32_SLT($i.i.187.0$2, 6144bv32) else v85$2);
    p73$1 := false;
    p73$2 := false;
    ...
    call {:sourceloc} {:sourceloc_num 95} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$1, 4bv32), 4bv32)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 95} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 95} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$2, 4bv32), 4bv32)), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v87$1 := (if p73$1 then _HAVOC_bv32$1 else v87$1);
    v87$2 := (if p73$2 then _HAVOC_bv32$2 else v87$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 97} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$1, 4bv32), 4bv32)), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 97} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 97} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$2, 4bv32), 4bv32)), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v89$1 := (if p73$1 then _HAVOC_bv32$1 else v89$1);
    v89$2 := (if p73$2 then _HAVOC_bv32$2 else v89$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 99} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$1, 4bv32), 4bv32)), 8bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 99} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 99} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$2, 4bv32), 4bv32)), 8bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v91$1 := (if p73$1 then _HAVOC_bv32$1 else v91$1);
    v91$2 := (if p73$2 then _HAVOC_bv32$2 else v91$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 101} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$1, 4bv32), 4bv32)), 12bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 101} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 101} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i.187.0$2, 4bv32), 4bv32)), 12bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v93$1 := (if p73$1 then _HAVOC_bv32$1 else v93$1);
    v93$2 := (if p73$2 then _HAVOC_bv32$2 else v93$2);
    $i.i.187.0$1 := (if p73$1 then BV32_ADD($i.i.187.0$1, group_size_x) else $i.i.187.0$1);
    $i.i.187.0$2 := (if p73$2 then BV32_ADD($i.i.187.0$2, group_size_x) else $i.i.187.0$2);
    p72$1 := (if p73$1 then true else p72$1);
    p72$2 := (if p73$2 then true else p72$2);
    goto $for.cond.i.192.backedge, $for.cond.i.192.tail;

  $for.cond.i.192.tail:
    assume !p72$1 && !p72$2;
    return;

  $for.cond.i.192.backedge:
    assume {:backedge} p72$1 || p72$2;
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond.i.192;

  $while.cond.10.backedge:
