...
implementation {:source_name "histo_main_kernel"} {:kernel} $histo_main_kernel($num_elements: bv32, $sm_range_min: bv32, $sm_range_max: bv32, $histo_height: bv32, $histo_width: bv32)
{
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assert {:tag "disabledMaintainsInstrumentation"} _b30 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$global_overflow;
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_histo$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$global_histo;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $36:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b33 ==> !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$36 == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo;
    assert {:tag "disabledMaintainsInstrumentation"} _b32 ==> !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$36 == _ATOMIC_HAS_OCCURRED_$$global_overflow;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    v75$1 := (if p47$1 then $overflow_into_bin_plus_1.i18.0$1[1:0] == 1bv1 else v75$1);
    v75$2 := (if p47$2 then $overflow_into_bin_plus_1.i18.0$2[1:0] == 1bv1 else v75$2);
    ...
    $bin_plus_1_add.i24.1$1 := (if p61$1 then (if BV32_ULT(v70$1, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_1_add.i24.1$1);
    $bin_plus_1_add.i24.1$2 := (if p61$2 then (if BV32_ULT(v70$2, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_1_add.i24.1$2);
    v76$1 := (if p47$1 then $overflow_into_bin_plus_2.i19.0$1[1:0] == 1bv1 else v76$1);
    v76$2 := (if p47$2 then $overflow_into_bin_plus_2.i19.0$2[1:0] == 1bv1 else v76$2);
    ...
    $bin_plus_2_add.i25.1$1 := (if p63$1 then (if BV32_ULT(v71$1, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_2_add.i25.1$1);
    $bin_plus_2_add.i25.1$2 := (if p63$2 then (if BV32_ULT(v71$2, 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_2_add.i25.1$2);
    v77$1 := (if p47$1 then $overflow_into_bin_plus_3.i20.0$1[1:0] == 1bv1 else v77$1);
    v77$2 := (if p47$2 then $overflow_into_bin_plus_3.i20.0$2[1:0] == 1bv1 else v77$2);
    ...
    $bin_plus_3_add.i26.1$1 := (if p65$1 then (if BV32_ULT(BV32_AND(BV32_LSHR(v63$1, BV32_AND(BV32_ADD(v61$1, 24bv32), 31bv32)), 255bv32), 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_3_add.i26.1$1);
    $bin_plus_3_add.i26.1$2 := (if p65$2 then (if BV32_ULT(BV32_AND(BV32_LSHR(v63$2, BV32_AND(BV32_ADD(v61$2, 24bv32), 31bv32)), 255bv32), 255bv32) then 4294967295bv32 else 255bv32) else $bin_plus_3_add.i26.1$2);
    ...
    v79$1 := (if p47$1 then $overflow_into_bin_plus_1.i18.0$1[1:0] == 1bv1 else v79$1);
    v79$2 := (if p47$2 then $overflow_into_bin_plus_1.i18.0$2[1:0] == 1bv1 else v79$2);
    ...
    v81$1 := (if p47$1 then $overflow_into_bin_plus_2.i19.0$1[1:0] == 1bv1 else v81$1);
    v81$2 := (if p47$2 then $overflow_into_bin_plus_2.i19.0$2[1:0] == 1bv1 else v81$2);
    ...
    v83$1 := (if p47$1 then $overflow_into_bin_plus_3.i20.0$1[1:0] == 1bv1 else v83$1);
    v83$2 := (if p47$2 then $overflow_into_bin_plus_3.i20.0$2[1:0] == 1bv1 else v83$2);
  ...
  $64:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_SLT($i.i28.0$1, 6144bv32) ==> p72$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_SLT($i.i28.0$2, 6144bv32) ==> p72$2;
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b19 ==> BV32_UGE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b19 ==> BV32_UGE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b18 ==> BV32_ULE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b18 ==> BV32_ULE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b17 ==> BV32_SGE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b17 ==> BV32_SGE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b16 ==> BV32_SLE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b16 ==> BV32_SLE($i.i28.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p72$1 ==> _b15 ==> BV32_SLE(0bv32, $i.i28.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p72$2 ==> _b15 ==> BV32_SLE(0bv32, $i.i28.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p72$1 ==> _b14 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i28.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p72$2 ==> _b14 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i28.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2);
    assert {:block_sourceloc} {:sourceloc_num 92} p72$1 ==> true;
    v85$1 := (if p72$1 then BV32_SLT($i.i28.0$1, 6144bv32) else v85$1);
    v85$2 := (if p72$2 then BV32_SLT($i.i28.0$2, 6144bv32) else v85$2);
    p73$1 := false;
    p73$2 := false;
    ...
    call {:sourceloc} {:sourceloc_num 95} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$1, 4bv32), 4bv32)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 95} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 95} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$2, 4bv32), 4bv32)), 4bv32));
    ...
    call {:sourceloc} {:sourceloc_num 97} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$1, 4bv32), 4bv32)), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 97} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 97} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$2, 4bv32), 4bv32)), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 99} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$1, 4bv32), 4bv32)), 8bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 99} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 99} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$2, 4bv32), 4bv32)), 8bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 101} _LOG_ATOMIC_$$global_subhisto(p73$1, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$1, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$1, 4bv32), 4bv32)), 12bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 101} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 101} _CHECK_ATOMIC_$$global_subhisto(p73$2, BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(v2$2, 24576bv32), 4bv32), BV32_MUL(BV32_MUL($i.i28.0$2, 4bv32), 4bv32)), 12bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$global_subhisto"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
