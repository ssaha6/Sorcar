...
implementation {:source_name "scan_L1_kernel"} {:kernel} $scan_L1_kernel($n: bv32, $data_offset: bv32, $inter_offset: bv32)
{
  ...
  $entry:
    ...
    $cond$1 := (if p0$1 then v9$1 else $cond$1);
    $cond$2 := (if p0$2 then v9$2 else $cond$2);
    $cond$1 := (if p1$1 then 0bv32 else $cond$1);
    $cond$2 := (if p1$2 then 0bv32 else $cond$2);
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$scan_L1_kernel.s_data(true, v5$1, $cond$1, $$scan_L1_kernel.s_data[1bv1][v5$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$scan_L1_kernel.s_data(true, v5$2, $cond$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
    $$scan_L1_kernel.s_data[1bv1][v5$1] := $cond$1;
    $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v5$2] := $cond$2;
    ...
    $cond26$1 := (if p2$1 then v11$1 else $cond26$1);
    $cond26$2 := (if p2$2 then v11$2 else $cond26$2);
    $cond26$1 := (if p3$1 then 0bv32 else $cond26$1);
    $cond26$2 := (if p3$2 then 0bv32 else $cond26$2);
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$scan_L1_kernel.s_data(true, v7$1, $cond26$1, $$scan_L1_kernel.s_data[1bv1][v7$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$scan_L1_kernel.s_data(true, v7$2, $cond26$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
    $$scan_L1_kernel.s_data[1bv1][v7$1] := $cond26$1;
    $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v7$2] := $cond26$2;
  ...
  $for.cond.87:
    ...
    assert {:tag "relationalPow2"} _b87 ==> ($stride.1 == 0bv32 && $d86.0 == 2bv32) || BV32_MUL($d86.0, $stride.1) == 1bv32;
    assert {:tag "relationalPow2"} _b86 ==> BV32_MUL($d86.0, $stride.1) == 1bv32;
    assert {:tag "relationalPow2"} _b85 ==> ($stride.1 == 0bv32 && $d86.0 == 4bv32) || BV32_MUL($d86.0, $stride.1) == 2bv32;
    assert {:tag "relationalPow2"} _b84 ==> BV32_MUL($d86.0, $stride.1) == 2bv32;
    assert {:tag "relationalPow2"} _b83 ==> ($stride.1 == 0bv32 && $d86.0 == 8bv32) || BV32_MUL($d86.0, $stride.1) == 4bv32;
    assert {:tag "relationalPow2"} _b82 ==> BV32_MUL($d86.0, $stride.1) == 4bv32;
    assert {:tag "relationalPow2"} _b81 ==> ($stride.1 == 0bv32 && $d86.0 == 16bv32) || BV32_MUL($d86.0, $stride.1) == 8bv32;
    assert {:tag "relationalPow2"} _b80 ==> BV32_MUL($d86.0, $stride.1) == 8bv32;
    assert {:tag "relationalPow2"} _b79 ==> ($stride.1 == 0bv32 && $d86.0 == 32bv32) || BV32_MUL($d86.0, $stride.1) == 16bv32;
    assert {:tag "relationalPow2"} _b78 ==> BV32_MUL($d86.0, $stride.1) == 16bv32;
    assert {:tag "relationalPow2"} _b77 ==> ($stride.1 == 0bv32 && $d86.0 == 64bv32) || BV32_MUL($d86.0, $stride.1) == 32bv32;
    assert {:tag "relationalPow2"} _b76 ==> BV32_MUL($d86.0, $stride.1) == 32bv32;
    assert {:tag "relationalPow2"} _b75 ==> ($stride.1 == 0bv32 && $d86.0 == 128bv32) || BV32_MUL($d86.0, $stride.1) == 64bv32;
    assert {:tag "relationalPow2"} _b74 ==> BV32_MUL($d86.0, $stride.1) == 64bv32;
    assert {:tag "relationalPow2"} _b73 ==> ($stride.1 == 0bv32 && $d86.0 == 256bv32) || BV32_MUL($d86.0, $stride.1) == 128bv32;
    assert {:tag "relationalPow2"} _b72 ==> BV32_MUL($d86.0, $stride.1) == 128bv32;
    assert {:tag "relationalPow2"} _b71 ==> ($stride.1 == 0bv32 && $d86.0 == 512bv32) || BV32_MUL($d86.0, $stride.1) == 256bv32;
    assert {:tag "relationalPow2"} _b70 ==> BV32_MUL($d86.0, $stride.1) == 256bv32;
    assert {:tag "relationalPow2"} _b69 ==> ($stride.1 == 0bv32 && $d86.0 == 1024bv32) || BV32_MUL($d86.0, $stride.1) == 512bv32;
    assert {:tag "relationalPow2"} _b68 ==> BV32_MUL($d86.0, $stride.1) == 512bv32;
    assert {:tag "relationalPow2"} _b67 ==> ($stride.1 == 0bv32 && $d86.0 == 2048bv32) || BV32_MUL($d86.0, $stride.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b66 ==> BV32_MUL($d86.0, $stride.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b65 ==> ($stride.1 == 0bv32 && $d86.0 == 4096bv32) || BV32_MUL($d86.0, $stride.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b64 ==> BV32_MUL($d86.0, $stride.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b63 ==> ($stride.1 == 0bv32 && $d86.0 == 8192bv32) || BV32_MUL($d86.0, $stride.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b62 ==> BV32_MUL($d86.0, $stride.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b61 ==> ($stride.1 == 0bv32 && $d86.0 == 16384bv32) || BV32_MUL($d86.0, $stride.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b60 ==> BV32_MUL($d86.0, $stride.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b59 ==> ($stride.1 == 0bv32 && $d86.0 == 32768bv32) || BV32_MUL($d86.0, $stride.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b58 ==> BV32_MUL($d86.0, $stride.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b57 ==> ($stride.1 == 0bv32 && $d86.0 == 65536bv32) || BV32_MUL($d86.0, $stride.1) == 32768bv32;
    assert {:tag "relationalPow2"} _b56 ==> BV32_MUL($d86.0, $stride.1) == 32768bv32;
    assert {:tag "pow2NotZero"} _b55 ==> v27 != 0bv32;
    assert {:tag "pow2"} _b54 ==> v27 == 0bv32 || BV32_AND(v27, BV32_SUB(v27, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b53 ==> $d86.0 != 0bv32;
    assert {:tag "pow2"} _b52 ==> $d86.0 == 0bv32 || BV32_AND($d86.0, BV32_SUB($d86.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($d86.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($d86.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($d86.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($d86.0, 1bv32);
  ...
  __partitioned_block_$truebb4_1:
    ...
    v28$1 := BV32_ULT(v0$1, $d86.0);
    v28$2 := BV32_ULT(v0$2, $d86.0);
