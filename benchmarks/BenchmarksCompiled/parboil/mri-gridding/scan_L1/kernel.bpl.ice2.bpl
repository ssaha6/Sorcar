...
assert  my_inv (  (  BV32_SLE($d.0, group_size_x) ) ,  (  BV32_SGE($d.0, group_size_x) ) ,  (  BV32_ULE($d.0, group_size_x) ) ,  (  BV32_UGE($d.0, group_size_x) ) ,  true ,  true ,  true ,  true ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  $d.0 == 0bv32 || BV32_AND($d.0, BV32_SUB($d.0, 1bv32)) == 0bv32 ) ,  (  $d.0 != 0bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 65536bv32) || BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32768bv32) || BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16384bv32) || BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8192bv32) || BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4096bv32) || BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2048bv32) || BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 1024bv32) || BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 512bv32) || BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 256bv32) || BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 128bv32) || BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 64bv32) || BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32bv32) || BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16bv32) || BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8bv32) || BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4bv32) || BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2bv32) || BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$scan_L1_kernel.s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ) ,  (  _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 11} true;
    assert {:originated_from_invariant} {:sourceloc_num 12} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _READ_HAS_OCCURRED_$$scan_L1_kernel.s_data then 1bv1 else 0bv1))) != 0bv32 ==> v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 13} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data then 1bv1 else 0bv1))) != 0bv32 ==> v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  $falsebb1:
    ...
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$scan_L1_kernel.s_data(p6$1, v24$1, $$scan_L1_kernel.s_data[1bv1][v24$1]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$scan_L1_kernel.s_data(p6$2, v24$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v24$2]);
    ...
    call {:sourceloc} {:sourceloc_num 25} _LOG_WRITE_$$interBase(p6$1, BV32_ADD($inter_offset, group_id_x$1), v25$1, $$interBase[BV32_ADD($inter_offset, group_id_x$1)]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 25} _CHECK_WRITE_$$interBase(p6$2, BV32_ADD($inter_offset, group_id_x$2), v25$2);
    ...
    call {:sourceloc} {:sourceloc_num 26} _LOG_WRITE_$$scan_L1_kernel.s_data(p6$1, v24$1, 0bv32, $$scan_L1_kernel.s_data[1bv1][v24$1]);
    ...
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 26} _CHECK_WRITE_$$scan_L1_kernel.s_data(p6$2, v24$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
...
assert  my_inv (  true ,  true ,  true ,  true ,  (  BV32_SLE($d1.0, 1bv32) ) ,  (  BV32_SGE($d1.0, 1bv32) ) ,  (  BV32_ULE($d1.0, 1bv32) ) ,  (  BV32_UGE($d1.0, 1bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride.1 == 0bv32 || BV32_AND($stride.1, BV32_SUB($stride.1, 1bv32)) == 0bv32 ) ,  (  $stride.1 != 0bv32 ) ,  (  $d1.0 == 0bv32 || BV32_AND($d1.0, BV32_SUB($d1.0, 1bv32)) == 0bv32 ) ,  (  $d1.0 != 0bv32 ) ,  (  v27 == 0bv32 || BV32_AND(v27, BV32_SUB(v27, 1bv32)) == 0bv32 ) ,  (  v27 != 0bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 65536bv32) || BV32_MUL($d1.0, $stride.1) == 32768bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32768bv32) || BV32_MUL($d1.0, $stride.1) == 16384bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16384bv32) || BV32_MUL($d1.0, $stride.1) == 8192bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8192bv32) || BV32_MUL($d1.0, $stride.1) == 4096bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4096bv32) || BV32_MUL($d1.0, $stride.1) == 2048bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2048bv32) || BV32_MUL($d1.0, $stride.1) == 1024bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 1024bv32) || BV32_MUL($d1.0, $stride.1) == 512bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 512bv32) || BV32_MUL($d1.0, $stride.1) == 256bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 256bv32) || BV32_MUL($d1.0, $stride.1) == 128bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 128bv32) || BV32_MUL($d1.0, $stride.1) == 64bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 64bv32) || BV32_MUL($d1.0, $stride.1) == 32bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 32bv32) || BV32_MUL($d1.0, $stride.1) == 16bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 16bv32) || BV32_MUL($d1.0, $stride.1) == 8bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 8bv32) || BV32_MUL($d1.0, $stride.1) == 4bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 4bv32) || BV32_MUL($d1.0, $stride.1) == 2bv32 ) ,  (  BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  ($stride.1 == 0bv32 && $d1.0 == 2bv32) || BV32_MUL($d1.0, $stride.1) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$scan_L1_kernel.s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data )  ); 
  ...
  __partitioned_block_$falsebb4_1:
    call {:sourceloc_num 40} $bugle_barrier_duplicated_0(1bv1, 0bv1);
    v38$1 := BV32_ULT(v1$1, $n);
    v38$2 := BV32_ULT(v1$2, $n);
    p10$1 := (if v38$1 then v38$1 else p10$1);
    p10$2 := (if v38$2 then v38$2 else p10$2);
    call {:sourceloc} {:sourceloc_num 42} _LOG_READ_$$scan_L1_kernel.s_data(p10$1, v5$1, $$scan_L1_kernel.s_data[1bv1][v5$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 42} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 42} _CHECK_READ_$$scan_L1_kernel.s_data(p10$2, v5$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v5$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 43} _LOG_WRITE_$$dataBase(p10$1, BV32_ADD($data_offset, v1$1), v39$1, $$dataBase[BV32_ADD($data_offset, v1$1)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 43} _CHECK_WRITE_$$dataBase(p10$2, BV32_ADD($data_offset, v1$2), v39$2);
    ...
    call {:sourceloc} {:sourceloc_num 46} _LOG_READ_$$scan_L1_kernel.s_data(p12$1, v7$1, $$scan_L1_kernel.s_data[1bv1][v7$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 46} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 46} _CHECK_READ_$$scan_L1_kernel.s_data(p12$2, v7$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v7$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 47} _LOG_WRITE_$$dataBase(p12$1, BV32_ADD($data_offset, v2$1), v41$1, $$dataBase[BV32_ADD($data_offset, v2$1)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 47} _CHECK_WRITE_$$dataBase(p12$2, BV32_ADD($data_offset, v2$2), v41$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dataBase"} true;
  ...
  __partitioned_block_$truebb4_1:
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_READ_$$scan_L1_kernel.s_data(p9$1, v32$1, $$scan_L1_kernel.s_data[1bv1][v32$1]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 32} _CHECK_READ_$$scan_L1_kernel.s_data(p9$2, v32$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v32$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 33} _CHECK_READ_$$scan_L1_kernel.s_data(p9$2, v34$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v34$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_WRITE_$$scan_L1_kernel.s_data(p9$1, v32$1, v36$1, $$scan_L1_kernel.s_data[1bv1][v32$1]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 34} _CHECK_WRITE_$$scan_L1_kernel.s_data(p9$2, v32$2, v36$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 35} _LOG_READ_$$scan_L1_kernel.s_data(p9$1, v34$1, $$scan_L1_kernel.s_data[1bv1][v34$1]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 35} _CHECK_READ_$$scan_L1_kernel.s_data(p9$2, v34$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v34$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$scan_L1_kernel.s_data(p9$1, v34$1, BV32_ADD(v37$1, v35$1), $$scan_L1_kernel.s_data[1bv1][v34$1]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$scan_L1_kernel.s_data(p9$2, v34$2, BV32_ADD(v37$2, v35$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
  ...
  __partitioned_block_$truebb1_1:
    call {:sourceloc_num 15} $bugle_barrier_duplicated_2(1bv1, 0bv1);
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$scan_L1_kernel.s_data(p5$1, v18$1, $$scan_L1_kernel.s_data[1bv1][v18$1]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$scan_L1_kernel.s_data(p5$2, v18$2, $$scan_L1_kernel.s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v18$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$scan_L1_kernel.s_data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 19} _LOG_WRITE_$$scan_L1_kernel.s_data(p5$1, v18$1, BV32_ADD(v20$1, v19$1), $$scan_L1_kernel.s_data[1bv1][v18$1]);
    ...
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 19} _CHECK_WRITE_$$scan_L1_kernel.s_data(p5$2, v18$2, BV32_ADD(v20$2, v19$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$scan_L1_kernel.s_data"} true;
