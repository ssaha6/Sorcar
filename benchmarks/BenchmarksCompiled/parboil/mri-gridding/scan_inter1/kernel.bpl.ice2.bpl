...
implementation {:source_name "scan_inter1_kernel"} {:kernel} $scan_inter1_kernel($iter: bv32)
{
  ...
  $0:
    ...
    v1$2 := BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL(2bv32, $iter), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), $iter), 1bv32);
...
assert  my_inv (  (  BV32_SLE($d.0, group_size_x) ) ,  (  BV32_SGE($d.0, group_size_x) ) ,  (  BV32_ULE($d.0, group_size_x) ) ,  (  BV32_UGE($d.0, group_size_x) ) ,  (  $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32 ) ,  (  $stride.0 != 0bv32 ) ,  (  $d.0 == 0bv32 || BV32_AND($d.0, BV32_SUB($d.0, 1bv32)) == 0bv32 ) ,  (  $d.0 != 0bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 65536bv32) || BV32_MUL($stride.0, $d.0) == 32768bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32768bv32) || BV32_MUL($stride.0, $d.0) == 16384bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16384bv32) || BV32_MUL($stride.0, $d.0) == 8192bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8192bv32) || BV32_MUL($stride.0, $d.0) == 4096bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4096bv32) || BV32_MUL($stride.0, $d.0) == 2048bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2048bv32) || BV32_MUL($stride.0, $d.0) == 1024bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 1024bv32) || BV32_MUL($stride.0, $d.0) == 512bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 512bv32) || BV32_MUL($stride.0, $d.0) == 256bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 256bv32) || BV32_MUL($stride.0, $d.0) == 128bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 128bv32) || BV32_MUL($stride.0, $d.0) == 64bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 64bv32) || BV32_MUL($stride.0, $d.0) == 32bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 32bv32) || BV32_MUL($stride.0, $d.0) == 16bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 16bv32) || BV32_MUL($stride.0, $d.0) == 8bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 8bv32) || BV32_MUL($stride.0, $d.0) == 4bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 4bv32) || BV32_MUL($stride.0, $d.0) == 2bv32 ) ,  (  BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  ($d.0 == 0bv32 && $stride.0 == 2bv32) || BV32_MUL($stride.0, $d.0) == 1bv32 ) ,  (  !_READ_HAS_OCCURRED_$$scan_inter1_kernel.s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$scan_inter1_kernel.s_data ) ,  (  _WRITE_HAS_OCCURRED_$$scan_inter1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_inter1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_inter1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) ) ,  (  _WRITE_HAS_OCCURRED_$$scan_inter1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)) )  ); 
