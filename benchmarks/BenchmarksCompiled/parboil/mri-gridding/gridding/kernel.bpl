...
implementation {:source_name "gridding_GPU"} {:kernel} $gridding_GPU($beta: bv32)
{
  ...
  $19:
    ...
    assert {:tag "predicatedEquality"} _b92 ==> p12$1 && p12$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b91 ==> p12$1 && p12$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b90 ==> p12$1 && p12$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b89 ==> p12$1 && p12$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b88 ==> p12$1 && p12$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b87 ==> p12$1 && p12$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b86 ==> p12$1 && p12$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b85 ==> p12$1 && p12$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b84 ==> p12$1 && p12$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b83 ==> p12$1 && p12$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b82 ==> p12$1 && p12$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b81 ==> p12$1 && p12$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b80 ==> p12$1 && p12$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b79 ==> p12$1 && p12$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b78 ==> p12$1 && p12$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b77 ==> p12$1 && p12$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b76 ==> p12$1 && p12$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b75 ==> p12$1 && p12$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b74 ==> p12$1 && p12$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b73 ==> p12$1 && p12$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b72 ==> p12$1 && p12$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b71 ==> p12$1 && p12$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b70 ==> p12$1 && p12$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b69 ==> p12$1 && p12$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b68 ==> p12$1 && p12$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b67 ==> p12$1 && p12$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b66 ==> p12$1 && p12$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b65 ==> p12$1 && p12$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b64 ==> p12$1 && p12$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b63 ==> p12$1 && p12$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b62 ==> p12$1 && p12$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b61 ==> p12$1 && p12$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b60 ==> p12$1 && p12$2 ==> v20$1 == v20$2;
    ...
    assert {:tag "predicatedEquality"} _b52 ==> p12$1 && p12$2 ==> $6$1 == $6$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLE($z.0$1, $5$1) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLE($z.0$2, $5$2) ==> p12$2;
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b6 ==> BV32_UGE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b6 ==> BV32_UGE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b5 ==> BV32_ULE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b5 ==> BV32_ULE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b4 ==> BV32_SGE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b4 ==> BV32_SGE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b3 ==> BV32_SLE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b3 ==> BV32_SLE($z.0$2, $4$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p12$1 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($z.0$1, $4$1) == BV32_SUB($z.0$2, $4$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p12$2 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($z.0$2, $4$2) == BV32_SUB($z.0$1, $4$1);
  ...
  $21:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b154 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$21 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b153 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$21 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    ...
    assert {:tag "predicatedEquality"} _b146 ==> p14$1 && p14$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b145 ==> p14$1 && p14$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b144 ==> p14$1 && p14$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b143 ==> p14$1 && p14$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b142 ==> p14$1 && p14$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b141 ==> p14$1 && p14$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b140 ==> p14$1 && p14$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b139 ==> p14$1 && p14$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b138 ==> p14$1 && p14$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b137 ==> p14$1 && p14$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b136 ==> p14$1 && p14$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b135 ==> p14$1 && p14$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b134 ==> p14$1 && p14$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b133 ==> p14$1 && p14$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b132 ==> p14$1 && p14$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b131 ==> p14$1 && p14$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b130 ==> p14$1 && p14$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b129 ==> p14$1 && p14$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b128 ==> p14$1 && p14$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b127 ==> p14$1 && p14$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b126 ==> p14$1 && p14$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b125 ==> p14$1 && p14$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b124 ==> p14$1 && p14$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b123 ==> p14$1 && p14$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b122 ==> p14$1 && p14$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b121 ==> p14$1 && p14$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b120 ==> p14$1 && p14$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b119 ==> p14$1 && p14$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b118 ==> p14$1 && p14$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b117 ==> p14$1 && p14$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b116 ==> p14$1 && p14$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b115 ==> p14$1 && p14$2 ==> v21$1 == v21$2;
    ...
    assert {:tag "predicatedEquality"} _b107 ==> p14$1 && p14$2 ==> $6$1 == $6$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) ==> p14$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p14$1 ==> _b15 ==> p14$1 ==> BV32_SLE($z.0$1, $5$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p14$2 ==> _b15 ==> p14$2 ==> BV32_SLE($z.0$2, $5$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b14 ==> BV32_UGE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b14 ==> BV32_UGE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b13 ==> BV32_ULE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b13 ==> BV32_ULE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b12 ==> BV32_SGE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b12 ==> BV32_SGE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b11 ==> BV32_SLE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b11 ==> BV32_SLE($y.0$2, $2$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p14$1 ==> _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($y.0$1, $2$1) == BV32_SUB($y.0$2, $2$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p14$2 ==> _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($y.0$2, $2$2) == BV32_SUB($y.0$1, $2$1);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p14$1 ==> _b9 ==> BV32_SUB($y.0$1, $2$1) == BV32_SUB($y.0$2, $2$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p14$2 ==> _b9 ==> BV32_SUB($y.0$2, $2$2) == BV32_SUB($y.0$1, $2$1);
  ...
  __partitioned_block_$23_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b201 ==> !p15$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$23_0 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b200 ==> !p15$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$23_0 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    ...
    assert {:tag "predicatedEquality"} _b193 ==> p16$1 && p16$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b192 ==> p16$1 && p16$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b191 ==> p16$1 && p16$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b190 ==> p16$1 && p16$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b189 ==> p16$1 && p16$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b188 ==> p16$1 && p16$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b187 ==> p16$1 && p16$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b186 ==> p16$1 && p16$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b185 ==> p16$1 && p16$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b184 ==> p16$1 && p16$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b183 ==> p16$1 && p16$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b182 ==> p16$1 && p16$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b181 ==> p16$1 && p16$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b180 ==> p16$1 && p16$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b179 ==> p16$1 && p16$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b178 ==> p16$1 && p16$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b177 ==> p16$1 && p16$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b176 ==> p16$1 && p16$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b175 ==> p16$1 && p16$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b174 ==> p16$1 && p16$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b173 ==> p16$1 && p16$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b172 ==> p16$1 && p16$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b171 ==> p16$1 && p16$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b170 ==> p16$1 && p16$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b169 ==> p16$1 && p16$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b168 ==> p16$1 && p16$2 ==> v27$1 == v27$2;
    ...
    assert {:tag "predicatedEquality"} _b160 ==> p16$1 && p16$2 ==> $6$1 == $6$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32)) ==> p16$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32)) ==> p16$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p16$1 ==> _b25 ==> p16$1 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p16$2 ==> _b25 ==> p16$2 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2);
  ...
  $30:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b203 ==> !p17$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$30 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b37 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32)) && BV32_SLT($j.0$1, $6$1) ==> p22$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b37 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32)) && BV32_SLT($j.0$2, $6$2) ==> p22$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p22$1 ==> _b36 ==> p22$1 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p22$2 ==> _b36 ==> p22$2 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32));
