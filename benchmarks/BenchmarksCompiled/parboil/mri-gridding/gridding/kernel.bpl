...
implementation {:source_name "gridding_GPU"} {:kernel} $gridding_GPU($beta: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87: bool;
  var _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87: bool;
  var _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0: bool;
  var _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0: bool;
  var _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.119: bool;
  ...
  $entry:
    ...
    $cond$1 := (if p1$1 then v7$1 else $cond$1);
    $cond$2 := (if p1$2 then v7$2 else $cond$2);
    ...
    $cond40$1 := (if p2$1 then 255bv32 else $cond40$1);
    $cond40$2 := (if p2$2 then 255bv32 else $cond40$2);
    $cond40$1 := (if p3$1 then v9$1 else $cond40$1);
    $cond40$2 := (if p3$2 then v9$2 else $cond40$2);
    ...
    $cond49$1 := (if p4$1 then 0bv32 else $cond49$1);
    $cond49$2 := (if p4$2 then 0bv32 else $cond49$2);
    $cond49$1 := (if p5$1 then v11$1 else $cond49$1);
    $cond49$2 := (if p5$2 then v11$2 else $cond49$2);
    ...
    $cond60$1 := (if p6$1 then 255bv32 else $cond60$1);
    $cond60$2 := (if p6$2 then 255bv32 else $cond60$2);
    $cond60$1 := (if p7$1 then v13$1 else $cond60$1);
    $cond60$2 := (if p7$2 then v13$2 else $cond60$2);
    ...
    $cond69$1 := (if p8$1 then 0bv32 else $cond69$1);
    $cond69$2 := (if p8$2 then 0bv32 else $cond69$2);
    $cond69$1 := (if p9$1 then v15$1 else $cond69$1);
    $cond69$2 := (if p9$2 then v15$2 else $cond69$2);
    ...
    $cond80$1 := (if p10$1 then 255bv32 else $cond80$1);
    $cond80$2 := (if p10$2 then 255bv32 else $cond80$2);
    $cond80$1 := (if p11$1 then v17$1 else $cond80$1);
    $cond80$2 := (if p11$2 then v17$2 else $cond80$2);
    ...
    $pt.0$1, $density.0$1, $z.0$1 := 0bv64, 0bv32, $cond69$1;
    $pt.0$2, $density.0$2, $z.0$2 := 0bv64, 0bv32, $cond69$2;
    p12$1 := true;
    p12$2 := true;
  ...
  $for.cond:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b98 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 3bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 5bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b97 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_MUL(0bv32, 6bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 5bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32));
    assert {:tag "nowrite"} _b96 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b95 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b94 ==> p12$1 && p12$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b93 ==> p12$1 && p12$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b92 ==> p12$1 && p12$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b91 ==> p12$1 && p12$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b90 ==> p12$1 && p12$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b89 ==> p12$1 && p12$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b88 ==> p12$1 && p12$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b87 ==> p12$1 && p12$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b86 ==> p12$1 && p12$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b85 ==> p12$1 && p12$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b84 ==> p12$1 && p12$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b83 ==> p12$1 && p12$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b82 ==> p12$1 && p12$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b81 ==> p12$1 && p12$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b80 ==> p12$1 && p12$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b79 ==> p12$1 && p12$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b78 ==> p12$1 && p12$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b77 ==> p12$1 && p12$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b76 ==> p12$1 && p12$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b75 ==> p12$1 && p12$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b74 ==> p12$1 && p12$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b73 ==> p12$1 && p12$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b72 ==> p12$1 && p12$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b71 ==> p12$1 && p12$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b70 ==> p12$1 && p12$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b69 ==> p12$1 && p12$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b68 ==> p12$1 && p12$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b67 ==> p12$1 && p12$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b66 ==> p12$1 && p12$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b65 ==> p12$1 && p12$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b64 ==> p12$1 && p12$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b63 ==> p12$1 && p12$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b62 ==> p12$1 && p12$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b61 ==> p12$1 && p12$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b60 ==> p12$1 && p12$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b59 ==> p12$1 && p12$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b58 ==> p12$1 && p12$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b57 ==> p12$1 && p12$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b56 ==> p12$1 && p12$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b55 ==> p12$1 && p12$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b54 ==> p12$1 && p12$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b53 ==> p12$1 && p12$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b52 ==> p12$1 && p12$2 ==> $cond112$1 == $cond112$2;
    assert {:tag "predicatedEquality"} _b51 ==> p12$1 && p12$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b50 ==> p12$1 && p12$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b49 ==> p12$1 && p12$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "predicatedEquality"} _b48 ==> p12$1 && p12$2 ==> $y.0$1 == $y.0$2;
    assert {:tag "predicatedEquality"} _b47 ==> p12$1 && p12$2 ==> $density.1$1 == $density.1$2;
    assert {:tag "predicatedEquality"} _b46 ==> p12$1 && p12$2 ==> $pt.1$1 == $pt.1$2;
    assert {:tag "predicatedEquality"} _b45 ==> p12$1 && p12$2 ==> $z.0$1 == $z.0$2;
    assert {:tag "predicatedEquality"} _b44 ==> p12$1 && p12$2 ==> $density.0$1 == $density.0$2;
    assert {:tag "predicatedEquality"} _b43 ==> p12$1 && p12$2 ==> $pt.0$1 == $pt.0$2;
    assert {:tag "loopPredicateEquality"} _b42 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p12$1 == p12$2;
    assert {:tag "loopPredicateEquality"} _b41 ==> p12$1 == p12$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLE($z.0$1, $cond80$1) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLE($z.0$2, $cond80$2) ==> p12$2;
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b6 ==> BV32_UGE($z.0$1, $cond69$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b6 ==> BV32_UGE($z.0$2, $cond69$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b5 ==> BV32_ULE($z.0$1, $cond69$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b5 ==> BV32_ULE($z.0$2, $cond69$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b4 ==> BV32_SGE($z.0$1, $cond69$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b4 ==> BV32_SGE($z.0$2, $cond69$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b3 ==> BV32_SLE($z.0$1, $cond69$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b3 ==> BV32_SLE($z.0$2, $cond69$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p12$1 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($z.0$1, $cond69$1) == BV32_SUB($z.0$2, $cond69$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p12$2 ==> _b2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($z.0$2, $cond69$2) == BV32_SUB($z.0$1, $cond69$1);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p12$1 ==> _b1 ==> BV32_SUB($z.0$1, $cond69$1) == BV32_SUB($z.0$2, $cond69$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p12$2 ==> _b1 ==> BV32_SUB($z.0$2, $cond69$2) == BV32_SUB($z.0$1, $cond69$1);
    ...
    v20$1 := (if p12$1 then BV32_SLE($z.0$1, $cond80$1) else v20$1);
    v20$2 := (if p12$2 then BV32_SLE($z.0$2, $cond80$2) else v20$2);
    p13$1 := false;
    p13$2 := false;
    p14$1 := false;
    p14$2 := false;
    ...
    $pt.1$1, $density.1$1, $y.0$1 := (if p13$1 then $pt.0$1 else $pt.1$1), (if p13$1 then $density.0$1 else $density.1$1), (if p13$1 then $cond49$1 else $y.0$1);
    $pt.1$2, $density.1$2, $y.0$2 := (if p13$2 then $pt.0$2 else $pt.1$2), (if p13$2 then $density.0$2 else $density.1$2), (if p13$2 then $cond49$2 else $y.0$2);
    p14$1 := (if p13$1 then true else p14$1);
    p14$2 := (if p13$2 then true else p14$2);
    _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87 := _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87 := _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.87;

  $for.cond.87:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b154 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b153 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.87 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b152 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 3bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 5bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b151 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_MUL(0bv32, 6bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 5bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32));
    assert {:tag "nowrite"} _b150 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b149 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b148 ==> p14$1 && p14$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b147 ==> p14$1 && p14$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b146 ==> p14$1 && p14$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b145 ==> p14$1 && p14$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b144 ==> p14$1 && p14$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b143 ==> p14$1 && p14$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b142 ==> p14$1 && p14$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b141 ==> p14$1 && p14$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b140 ==> p14$1 && p14$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b139 ==> p14$1 && p14$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b138 ==> p14$1 && p14$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b137 ==> p14$1 && p14$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b136 ==> p14$1 && p14$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b135 ==> p14$1 && p14$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b134 ==> p14$1 && p14$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b133 ==> p14$1 && p14$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b132 ==> p14$1 && p14$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b131 ==> p14$1 && p14$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b130 ==> p14$1 && p14$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b129 ==> p14$1 && p14$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b128 ==> p14$1 && p14$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b127 ==> p14$1 && p14$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b126 ==> p14$1 && p14$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b125 ==> p14$1 && p14$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b124 ==> p14$1 && p14$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b123 ==> p14$1 && p14$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b122 ==> p14$1 && p14$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b121 ==> p14$1 && p14$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b120 ==> p14$1 && p14$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b119 ==> p14$1 && p14$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b118 ==> p14$1 && p14$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b117 ==> p14$1 && p14$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b116 ==> p14$1 && p14$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b115 ==> p14$1 && p14$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b114 ==> p14$1 && p14$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b113 ==> p14$1 && p14$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b112 ==> p14$1 && p14$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b111 ==> p14$1 && p14$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b110 ==> p14$1 && p14$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b109 ==> p14$1 && p14$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b108 ==> p14$1 && p14$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b107 ==> p14$1 && p14$2 ==> $cond112$1 == $cond112$2;
    assert {:tag "predicatedEquality"} _b106 ==> p14$1 && p14$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b105 ==> p14$1 && p14$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b104 ==> p14$1 && p14$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "predicatedEquality"} _b103 ==> p14$1 && p14$2 ==> $y.0$1 == $y.0$2;
    assert {:tag "predicatedEquality"} _b102 ==> p14$1 && p14$2 ==> $density.1$1 == $density.1$2;
    assert {:tag "predicatedEquality"} _b101 ==> p14$1 && p14$2 ==> $pt.1$1 == $pt.1$2;
    assert {:tag "loopPredicateEquality"} _b100 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p14$1 == p14$2;
    assert {:tag "loopPredicateEquality"} _b99 ==> p14$1 == p14$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> BV32_SLE($z.0$1, $cond80$1) && BV32_SLE($y.0$1, $cond60$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> BV32_SLE($z.0$2, $cond80$2) && BV32_SLE($y.0$2, $cond60$2) ==> p14$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p14$1 ==> _b15 ==> p14$1 ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p14$2 ==> _b15 ==> p14$2 ==> BV32_SLE($z.0$2, $cond80$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b14 ==> BV32_UGE($y.0$1, $cond49$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b14 ==> BV32_UGE($y.0$2, $cond49$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b13 ==> BV32_ULE($y.0$1, $cond49$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b13 ==> BV32_ULE($y.0$2, $cond49$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b12 ==> BV32_SGE($y.0$1, $cond49$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b12 ==> BV32_SGE($y.0$2, $cond49$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b11 ==> BV32_SLE($y.0$1, $cond49$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b11 ==> BV32_SLE($y.0$2, $cond49$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p14$1 ==> _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($y.0$1, $cond49$1) == BV32_SUB($y.0$2, $cond49$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p14$2 ==> _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($y.0$2, $cond49$2) == BV32_SUB($y.0$1, $cond49$1);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p14$1 ==> _b9 ==> BV32_SUB($y.0$1, $cond49$1) == BV32_SUB($y.0$2, $cond49$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p14$2 ==> _b9 ==> BV32_SUB($y.0$2, $cond49$2) == BV32_SUB($y.0$1, $cond49$1);
    assert {:tag "guardNonNeg"} {:thread 1} p14$1 ==> _b8 ==> BV32_SLE(0bv32, $y.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p14$2 ==> _b8 ==> BV32_SLE(0bv32, $y.0$2);
    assert {:block_sourceloc} {:sourceloc_num 21} p14$1 ==> true;
    v21$1 := (if p14$1 then BV32_SLE($y.0$1, $cond60$1) else v21$1);
    v21$2 := (if p14$2 then BV32_SLE($y.0$2, $cond60$2) else v21$2);
    p15$1 := false;
    p15$2 := false;
    p16$1 := false;
    p16$2 := false;
    ...
    v24$1 := (if p15$1 then $$binStartAddr_g[BV32_ADD(BV32_ADD(v22$1, v23$1), $cond$1)] else v24$1);
    v24$2 := (if p15$2 then $$binStartAddr_g[BV32_ADD(BV32_ADD(v22$2, v23$2), $cond$2)] else v24$2);
    v25$1 := (if p15$1 then $$binStartAddr_g[BV32_ADD(BV32_ADD(BV32_ADD(v22$1, v23$1), $cond40$1), 1bv32)] else v25$1);
    v25$2 := (if p15$2 then $$binStartAddr_g[BV32_ADD(BV32_ADD(BV32_ADD(v22$2, v23$2), $cond40$2), 1bv32)] else v25$2);
    ...
    _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0 := _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0 := _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto __partitioned_block_$for.cond.98_0;

  __partitioned_block_$for.cond.98_0:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b201 ==> !p15$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b200 ==> !p15$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$for.cond.98_0 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b199 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 3bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6bv32), 5bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b198 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_MUL(0bv32, 6bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 5bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32));
    assert {:tag "nowrite"} _b197 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b196 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b195 ==> p16$1 && p16$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b194 ==> p16$1 && p16$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b193 ==> p16$1 && p16$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b192 ==> p16$1 && p16$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b191 ==> p16$1 && p16$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b190 ==> p16$1 && p16$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b189 ==> p16$1 && p16$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b188 ==> p16$1 && p16$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b187 ==> p16$1 && p16$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b186 ==> p16$1 && p16$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b185 ==> p16$1 && p16$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b184 ==> p16$1 && p16$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b183 ==> p16$1 && p16$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b182 ==> p16$1 && p16$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b181 ==> p16$1 && p16$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b180 ==> p16$1 && p16$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b179 ==> p16$1 && p16$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b178 ==> p16$1 && p16$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b177 ==> p16$1 && p16$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b176 ==> p16$1 && p16$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b175 ==> p16$1 && p16$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b174 ==> p16$1 && p16$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b173 ==> p16$1 && p16$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b172 ==> p16$1 && p16$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b171 ==> p16$1 && p16$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b170 ==> p16$1 && p16$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b169 ==> p16$1 && p16$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b168 ==> p16$1 && p16$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b167 ==> p16$1 && p16$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b166 ==> p16$1 && p16$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b165 ==> p16$1 && p16$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b164 ==> p16$1 && p16$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b163 ==> p16$1 && p16$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b162 ==> p16$1 && p16$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b161 ==> p16$1 && p16$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b160 ==> p16$1 && p16$2 ==> $cond112$1 == $cond112$2;
    assert {:tag "predicatedEquality"} _b159 ==> p16$1 && p16$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b158 ==> p16$1 && p16$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b157 ==> p16$1 && p16$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "loopPredicateEquality"} _b156 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p16$1 == p16$2;
    assert {:tag "loopPredicateEquality"} _b155 ==> p16$1 == p16$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $cond60$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $cond60$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> BV32_SLE($z.0$1, $cond80$1) && BV32_SLE($y.0$1, $cond60$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32)) ==> p16$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> BV32_SLE($z.0$2, $cond80$2) && BV32_SLE($y.0$2, $cond60$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32)) ==> p16$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p16$1 ==> _b25 ==> p16$1 ==> BV32_SLE($z.0$1, $cond80$1) && BV32_SLE($y.0$1, $cond60$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p16$2 ==> _b25 ==> p16$2 ==> BV32_SLE($z.0$2, $cond80$2) && BV32_SLE($y.0$2, $cond60$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b24 ==> BV32_UGE($x.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b24 ==> BV32_UGE($x.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b23 ==> BV32_ULE($x.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b23 ==> BV32_ULE($x.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b22 ==> BV32_SGE($x.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b22 ==> BV32_SGE($x.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b21 ==> BV32_SLE($x.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b21 ==> BV32_SLE($x.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p16$1 ==> _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($x.0$1, 0bv32) == BV32_SUB($x.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p16$2 ==> _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($x.0$2, 0bv32) == BV32_SUB($x.0$1, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p16$1 ==> _b19 ==> BV32_SUB($x.0$1, 0bv32) == BV32_SUB($x.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p16$2 ==> _b19 ==> BV32_SUB($x.0$2, 0bv32) == BV32_SUB($x.0$1, 0bv32);
    ...
    $cond112$1 := (if p18$1 then BV32_SUB(v26$1, BV32_SHL($x.0$1, 6bv32)) else $cond112$1);
    $cond112$2 := (if p18$2 then BV32_SUB(v26$2, BV32_SHL($x.0$2, 6bv32)) else $cond112$2);
    $cond112$1 := (if p19$1 then 64bv32 else $cond112$1);
    $cond112$2 := (if p19$2 then 64bv32 else $cond112$2);
    goto __partitioned_block_$for.cond.98_1;

  __partitioned_block_$for.cond.98_1:
    call {:sourceloc_num 30} $bugle_barrier_duplicated_0(1bv1, 0bv1, p17$1, p17$2);
    v29$1 := (if p17$1 then BV32_SLT(v0$1, $cond112$1) else v29$1);
    v29$2 := (if p17$2 then BV32_SLT(v0$2, $cond112$2) else v29$2);
    ...
    goto __partitioned_block_$for.cond.98_2;

  __partitioned_block_$for.cond.98_2:
    ...
    _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.119 := _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $for.cond.119;

  $for.cond.119:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b203 ==> !p17$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$for.cond.119 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b202 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_MUL(0bv32, 6bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 5bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 6bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 6bv32), 4bv32));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $cond60$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $cond80$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b37 ==> BV32_SLE($z.0$1, $cond80$1) && BV32_SLE($y.0$1, $cond60$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32)) && BV32_SLT($j.0$1, $cond112$1) ==> p22$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b37 ==> BV32_SLE($z.0$2, $cond80$2) && BV32_SLE($y.0$2, $cond60$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32)) && BV32_SLT($j.0$2, $cond112$2) ==> p22$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p22$1 ==> _b36 ==> p22$1 ==> BV32_SLE($z.0$1, $cond80$1) && BV32_SLE($y.0$1, $cond60$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64bv32), 1bv32), 6bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p22$2 ==> _b36 ==> p22$2 ==> BV32_SLE($z.0$2, $cond80$2) && BV32_SLE($y.0$2, $cond60$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64bv32), 1bv32), 6bv32));
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b35 ==> BV32_UGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b35 ==> BV32_UGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b34 ==> BV32_ULE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b34 ==> BV32_ULE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b33 ==> BV32_SGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b33 ==> BV32_SGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b32 ==> BV32_SLE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b32 ==> BV32_SLE($j.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p22$1 ==> _b31 ==> BV32_SLE(0bv32, $j.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p22$2 ==> _b31 ==> BV32_SLE(0bv32, $j.0$2);
    assert {:block_sourceloc} {:sourceloc_num 46} p22$1 ==> true;
    v36$1 := (if p22$1 then BV32_SLT($j.0$1, $cond112$1) else v36$1);
    v36$2 := (if p22$2 then BV32_SLT($j.0$2, $cond112$2) else v36$2);
    p23$1 := false;
    p23$2 := false;
    p24$1 := false;
    p24$2 := false;
    ...
    goto $for.cond.119.backedge, $for.cond.119.tail;
  ...
  $for.cond.119.tail:
    ...
    goto $for.cond.98.backedge, $for.cond.98.tail;
  ...
  $for.cond.98.tail:
    ...
    goto $for.cond.87.backedge, $for.cond.87.tail;
  ...
  $for.cond.87.backedge:
    assume {:backedge} p14$1 || p14$2;
    assume {:captureState "loop_back_edge_state_1_0"} true;
    goto $for.cond.87;

  $for.cond.98.backedge:
