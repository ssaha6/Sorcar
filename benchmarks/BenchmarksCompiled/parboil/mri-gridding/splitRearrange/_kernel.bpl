...
implementation {:source_name "splitRearrange"} {:kernel} $splitRearrange($numElems: bv32, $iter: bv32)
{
  ...
  $while.cond.tail:
    ...
    $cond$1 := (if p9$1 then BV32_ADD($new_index.0$1[32:0], 1bv32) else $cond$1);
    $cond$2 := (if p9$2 then BV32_ADD($new_index.0$2[32:0], 1bv32) else $cond$2);
    $cond$1 := (if p10$1 then $new_index.0$1[64:32] else $cond$1);
    $cond$2 := (if p10$2 then $new_index.0$2[64:32] else $cond$2);
    v26$1 := v15$1 == v14$1;
    v26$2 := v15$2 == v14$2;
    ...
    $cond75$1 := (if p11$1 then BV32_ADD($cond$1, 1bv32) else $cond75$1);
    $cond75$2 := (if p11$2 then BV32_ADD($cond$2, 1bv32) else $cond75$2);
    $cond75$1 := (if p12$1 then $new_index.0$1[96:64] else $cond75$1);
    $cond75$2 := (if p12$2 then $new_index.0$2[96:64] else $cond75$2);
    v27$1 := v16$1 == v15$1;
    v27$2 := v16$2 == v15$2;
    ...
    $cond81$1 := (if p13$1 then BV32_ADD($cond75$1, 1bv32) else $cond81$1);
    $cond81$2 := (if p13$2 then BV32_ADD($cond75$2, 1bv32) else $cond81$2);
    $cond81$1 := (if p14$1 then $new_index.0$1[128:96] else $cond81$1);
    $cond81$2 := (if p14$2 then $new_index.0$2[128:96] else $cond81$2);
    ...
    call {:sourceloc} {:sourceloc_num 44} _LOG_WRITE_$$keys_o(p15$1, $cond$1, $mine.0$1[64:32], $$keys_o[$cond$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$keys_o(p15$2, $cond$2);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 44} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 44} _CHECK_WRITE_$$keys_o(p15$2, $cond$2, $mine.0$2[64:32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$keys_o"} true;
    $$keys_o[$cond$1] := (if p15$1 then $mine.0$1[64:32] else $$keys_o[$cond$1]);
    $$keys_o[$cond$2] := (if p15$2 then $mine.0$2[64:32] else $$keys_o[$cond$2]);
    call {:sourceloc} {:sourceloc_num 45} _LOG_WRITE_$$values_o(p15$1, $cond$1, $value.0$1[64:32], $$values_o[$cond$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$values_o(p15$2, $cond$2);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 45} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 45} _CHECK_WRITE_$$values_o(p15$2, $cond$2, $value.0$2[64:32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$values_o"} true;
    $$values_o[$cond$1] := (if p15$1 then $value.0$1[64:32] else $$values_o[$cond$1]);
    $$values_o[$cond$2] := (if p15$2 then $value.0$2[64:32] else $$values_o[$cond$2]);
    call {:sourceloc} {:sourceloc_num 46} _LOG_WRITE_$$keys_o(p15$1, $cond75$1, $mine.0$1[96:64], $$keys_o[$cond75$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$keys_o(p15$2, $cond75$2);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 46} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 46} _CHECK_WRITE_$$keys_o(p15$2, $cond75$2, $mine.0$2[96:64]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$keys_o"} true;
    $$keys_o[$cond75$1] := (if p15$1 then $mine.0$1[96:64] else $$keys_o[$cond75$1]);
    $$keys_o[$cond75$2] := (if p15$2 then $mine.0$2[96:64] else $$keys_o[$cond75$2]);
    call {:sourceloc} {:sourceloc_num 47} _LOG_WRITE_$$values_o(p15$1, $cond75$1, $value.0$1[96:64], $$values_o[$cond75$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$values_o(p15$2, $cond75$2);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 47} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 47} _CHECK_WRITE_$$values_o(p15$2, $cond75$2, $value.0$2[96:64]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$values_o"} true;
    $$values_o[$cond75$1] := (if p15$1 then $value.0$1[96:64] else $$values_o[$cond75$1]);
    $$values_o[$cond75$2] := (if p15$2 then $value.0$2[96:64] else $$values_o[$cond75$2]);
    call {:sourceloc} {:sourceloc_num 48} _LOG_WRITE_$$keys_o(p15$1, $cond81$1, $mine.0$1[128:96], $$keys_o[$cond81$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$keys_o(p15$2, $cond81$2);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 48} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 48} _CHECK_WRITE_$$keys_o(p15$2, $cond81$2, $mine.0$2[128:96]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$keys_o"} true;
    $$keys_o[$cond81$1] := (if p15$1 then $mine.0$1[128:96] else $$keys_o[$cond81$1]);
    $$keys_o[$cond81$2] := (if p15$2 then $mine.0$2[128:96] else $$keys_o[$cond81$2]);
    call {:sourceloc} {:sourceloc_num 49} _LOG_WRITE_$$values_o(p15$1, $cond81$1, $value.0$1[128:96], $$values_o[$cond81$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$values_o(p15$2, $cond81$2);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 49} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 49} _CHECK_WRITE_$$values_o(p15$2, $cond81$2, $value.0$2[128:96]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$values_o"} true;
    $$values_o[$cond81$1] := (if p15$1 then $value.0$1[128:96] else $$values_o[$cond81$1]);
    $$values_o[$cond81$2] := (if p15$2 then $value.0$2[128:96] else $$values_o[$cond81$2]);
    return;
