...
implementation {:source_name "binning_kernel"} {:kernel} $binning_kernel($n: bv32, $binsize: bv32, $gridNumElems: bv32)
{
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_ATOMIC_$$binCount_g(p0$1, BV32_SDIV(BV32_MUL(v11$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 17} _CHECK_ATOMIC_$$binCount_g(p0$2, BV32_SDIV(BV32_MUL(v11$2, 4bv32), 4bv32));
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_ATOMIC_$$binCount_g(p2$1, BV32_SDIV(BV32_MUL(v11$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 20} _CHECK_ATOMIC_$$binCount_g(p2$2, BV32_SDIV(BV32_MUL(v11$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$binCount_g"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
