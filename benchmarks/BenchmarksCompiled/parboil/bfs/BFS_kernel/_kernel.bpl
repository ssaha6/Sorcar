...
implementation {:source_name "BFS_kernel"} {:kernel} $BFS_kernel($no_of_nodes: bv32, $gray_shade: bv32, $k: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$g_color$ghost$$for.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$g_color$ghost$$for.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$g_cost$ghost$$for.cond: bool;
  var _ATOMIC_HAS_OCCURRED_$$local_q_tail$ghost$$for.cond: bool;
  var _WRITE_HAS_OCCURRED_$$local_q$ghost$$for.cond: bool;
  ...
  __partitioned_block_$entry_1:
    ...
    _READ_HAS_OCCURRED_$$g_color$ghost$$for.cond := _READ_HAS_OCCURRED_$$g_color;
    _ATOMIC_HAS_OCCURRED_$$g_color$ghost$$for.cond := _ATOMIC_HAS_OCCURRED_$$g_color;
    _ATOMIC_HAS_OCCURRED_$$g_cost$ghost$$for.cond := _ATOMIC_HAS_OCCURRED_$$g_cost;
    _ATOMIC_HAS_OCCURRED_$$local_q_tail$ghost$$for.cond := _ATOMIC_HAS_OCCURRED_$$local_q_tail;
    _WRITE_HAS_OCCURRED_$$local_q$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$local_q;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond;

  $for.cond:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b22 ==> !p2$1 ==> _WRITE_HAS_OCCURRED_$$local_q$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$local_q;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$local_q ==> _WATCHED_OFFSET == v22$1;
    assert {:tag "disabledMaintainsInstrumentation"} _b20 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$local_q_tail$ghost$$for.cond == _ATOMIC_HAS_OCCURRED_$$local_q_tail;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _ATOMIC_HAS_OCCURRED_$$local_q_tail ==> _WATCHED_OFFSET == 0bv32;
    assert {:tag "disabledMaintainsInstrumentation"} _b18 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$g_cost$ghost$$for.cond == _ATOMIC_HAS_OCCURRED_$$g_cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b17 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$g_color$ghost$$for.cond == _ATOMIC_HAS_OCCURRED_$$g_color;
    assert {:tag "disabledMaintainsInstrumentation"} _b16 ==> !p2$1 ==> _READ_HAS_OCCURRED_$$g_color$ghost$$for.cond == _READ_HAS_OCCURRED_$$g_color;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$local_q ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$g_color ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes) && BV32_SLT($i.0$1, BV32_ADD(v6$1, v5$1)) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes) && BV32_SLT($i.0$2, BV32_ADD(v6$2, v5$2)) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b12 ==> p3$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b12 ==> p3$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b11 ==> BV32_UGE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b11 ==> BV32_UGE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b10 ==> BV32_ULE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b10 ==> BV32_ULE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b9 ==> BV32_SGE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b9 ==> BV32_SGE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b8 ==> BV32_SLE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b8 ==> BV32_SLE($i.0$2, v7$2);
    assert {:tag "guardNonNeg"} {:thread 1} p3$1 ==> _b7 ==> BV32_SLE(0bv32, $i.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p3$2 ==> _b7 ==> BV32_SLE(0bv32, $i.0$2);
  ...
  $while.cond:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$local_q_tail ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$local_q_tail ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT($local_shift.0$1, v26$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT($local_shift.0$2, v26$2) ==> p14$2;
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b5 ==> BV32_UGE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b5 ==> BV32_UGE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b4 ==> BV32_ULE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b4 ==> BV32_ULE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b3 ==> BV32_SGE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b3 ==> BV32_SGE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b2 ==> BV32_SLE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b2 ==> BV32_SLE($local_shift.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p14$1 ==> _b1 ==> BV32_SLE(0bv32, $local_shift.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p14$2 ==> _b1 ==> BV32_SLE(0bv32, $local_shift.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p14$1 ==> _b0 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $local_shift.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p14$2 ==> _b0 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $local_shift.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2);
