...
implementation {:source_name "gen_hists"} {:kernel} $gen_hists($NUM_SETS: bv32, $NUM_ELEMENTS: bv32)
{
  ...
  $37:
    ...
    assert {:tag "nowrite"} _b46 ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "noread"} _b45 ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    ...
    assert {:tag "pow2NotZero"} _b40 ==> $offset.0 != 0bv32;
    assert {:tag "pow2"} _b39 ==> $offset.0 == 0bv32 || BV32_AND($offset.0, BV32_SUB($offset.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $39:
    ...
    assert {:tag "nowrite"} _b54 ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "noread"} _b53 ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b52 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$all_x_data;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b51 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$all_x_data;
  ...
  $14:
    ...
    assert {:tag "loopPredicateEquality"} _b57 ==> p6$1 == p6$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && $0$1 == 1bv1 ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && $0$2 == 1bv1 ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b25 ==> p6$1 ==> BV32_ULT($j.0, $NUM_ELEMENTS);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b25 ==> p6$2 ==> BV32_ULT($j.0, $NUM_ELEMENTS);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b24 ==> BV32_UGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b24 ==> BV32_UGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b23 ==> BV32_ULE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b23 ==> BV32_ULE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b22 ==> BV32_SGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b22 ==> BV32_SGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b21 ==> BV32_SLE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b21 ==> BV32_SLE($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p6$1 ==> _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($k.0$1, 0bv32) == BV32_SUB($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p6$2 ==> _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($k.0$2, 0bv32) == BV32_SUB($k.0$1, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p6$1 ==> _b19 ==> BV32_SUB($k.0$1, 0bv32) == BV32_SUB($k.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p6$2 ==> _b19 ==> BV32_SUB($k.0$2, 0bv32) == BV32_SUB($k.0$1, 0bv32);
