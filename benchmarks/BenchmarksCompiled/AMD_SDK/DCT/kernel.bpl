...
implementation {:source_name "DCT"} {:kernel} $DCT($width: bv32, $blockWidth: bv32, $inverse: bv32)
{
  ...
  $entry:
    ...
    v1$1 := local_id_y$1;
    v1$2 := local_id_y$2;
    v2$1 := BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    v2$2 := BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), $width), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
