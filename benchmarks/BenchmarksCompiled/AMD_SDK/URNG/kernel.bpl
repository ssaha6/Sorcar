...
implementation {:source_name "noise_uniform"} {:kernel} $noise_uniform($factor: bv32)
{
  ...
  $entry:
    ...
    v8$1 := local_id_x$1;
    v8$2 := local_id_x$2;
    $j.i.0, $idum.addr.i.0$1 := 16bv32, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$1, v6$1), v7$1), v6$1), 1082130432bv32)));
  ...
  $truebb1:
    assume {:partition} v13;
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$noise_uniform.iv(true, BV32_ADD(BV32_MUL(16bv32, v8$1), $j.i.0), $idum.addr.i.1$1, $$noise_uniform.iv[1bv1][BV32_ADD(BV32_MUL(16bv32, v8$1), $j.i.0)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$noise_uniform.iv(true, BV32_ADD(BV32_MUL(16bv32, v8$2), $j.i.0), $idum.addr.i.1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$noise_uniform.iv"} true;
    $$noise_uniform.iv[1bv1][BV32_ADD(BV32_MUL(16bv32, v8$1), $j.i.0)] := $idum.addr.i.1$1;
    $$noise_uniform.iv[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(16bv32, v8$2), $j.i.0)] := $idum.addr.i.1$2;
    goto $if.end.9.i;
}
