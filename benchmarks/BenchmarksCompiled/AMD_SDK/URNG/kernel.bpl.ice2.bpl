...
assert  my_inv (  (  BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $j.i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 16bv32) ) ,  (  BV32_SLE(0bv32, $j.i.0) ) ,  (  BV32_SLE($j.i.0, 16bv32) ) ,  (  BV32_SGE($j.i.0, 16bv32) ) ,  (  BV32_ULE($j.i.0, 16bv32) ) ,  (  BV32_UGE($j.i.0, 16bv32) ) ,  (  BV32_SLE($.0$1, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$1, v6$1), v7$1), v6$1), 1082130432bv32)))) )  && (  BV32_SLE($.0$2, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$2, v6$2), v7$2), v6$2), 1082130432bv32)))) ) ,  (  BV32_SGE($.0$1, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$1, v6$1), v7$1), v6$1), 1082130432bv32)))) )  && (  BV32_SGE($.0$2, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$2, v6$2), v7$2), v6$2), 1082130432bv32)))) ) ,  (  BV32_ULE($.0$1, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$1, v6$1), v7$1), v6$1), 1082130432bv32)))) )  && (  BV32_ULE($.0$2, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$2, v6$2), v7$2), v6$2), 1082130432bv32)))) ) ,  (  BV32_UGE($.0$1, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$1, v6$1), v7$1), v6$1), 1082130432bv32)))) )  && (  BV32_UGE($.0$2, FP32_TO_SI32(FSUB32(2147483648bv32, FDIV32(FADD32(FADD32(FADD32(v5$2, v6$2), v7$2), v6$2), 1082130432bv32)))) ) ,  (  _WRITE_HAS_OCCURRED_$$noise_uniform.iv ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_ADD(16bv32, BV32_MUL(16bv32, local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$noise_uniform.iv ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32) )  ); 
