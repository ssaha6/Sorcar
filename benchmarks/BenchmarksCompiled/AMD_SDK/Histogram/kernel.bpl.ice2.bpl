...
assert  my_inv (  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$sharedArray ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 256bv32) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $i1.0) ) ,  (  BV32_SLE($i1.0, 0bv32) ) ,  (  BV32_SGE($i1.0, 0bv32) ) ,  (  BV32_ULE($i1.0, 0bv32) ) ,  (  BV32_UGE($i1.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 256bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 256bv32) ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($i2.0, 0bv32) ) ,  (  BV32_SGE($i2.0, 0bv32) ) ,  (  BV32_ULE($i2.0, 0bv32) ) ,  (  BV32_UGE($i2.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$binResult ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, group_size_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, group_size_x), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(0bv32, group_size_x), BV32_MUL(group_id_x$1, 256bv32)), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$binResult ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 256bv32) )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($j.0, 0bv32) ) ,  (  BV32_SGE($j.0, 0bv32) ) ,  (  BV32_ULE($j.0, 0bv32) ) ,  (  BV32_UGE($j.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true  ); 
