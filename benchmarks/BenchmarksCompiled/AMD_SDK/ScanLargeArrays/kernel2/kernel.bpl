...
implementation {:source_name "prefixSum"} {:kernel} $prefixSum($__bugle_length: bv32)
{
  ...
  $for.cond:
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($d.0, BV32_LSHR($__bugle_length, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($d.0, BV32_LSHR($__bugle_length, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($d.0, BV32_LSHR($__bugle_length, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($d.0, BV32_LSHR($__bugle_length, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $d.0);
    assert {:block_sourceloc} {:sourceloc_num 6} true;
    assert {:originated_from_invariant} {:sourceloc_num 7} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _WRITE_HAS_OCCURRED_$$block then 1bv1 else 0bv1))) != 0bv32 ==> v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 8} {:thread 1} (if BV32_AND(BV1_ZEXT32((if $d.0 == 0bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if _READ_HAS_OCCURRED_$$block then 1bv1 else 0bv1))) != 0bv32 ==> v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  $for.cond.46:
    ...
    assert {:tag "relationalPow2"} _b85 ==> ($offset.1 == 0bv32 && $d45.0 == 2bv32) || BV32_MUL($d45.0, $offset.1) == 1bv32;
    assert {:tag "relationalPow2"} _b84 ==> BV32_MUL($d45.0, $offset.1) == 1bv32;
    assert {:tag "relationalPow2"} _b83 ==> ($offset.1 == 0bv32 && $d45.0 == 4bv32) || BV32_MUL($d45.0, $offset.1) == 2bv32;
    assert {:tag "relationalPow2"} _b82 ==> BV32_MUL($d45.0, $offset.1) == 2bv32;
    assert {:tag "relationalPow2"} _b81 ==> ($offset.1 == 0bv32 && $d45.0 == 8bv32) || BV32_MUL($d45.0, $offset.1) == 4bv32;
    assert {:tag "relationalPow2"} _b80 ==> BV32_MUL($d45.0, $offset.1) == 4bv32;
    assert {:tag "relationalPow2"} _b79 ==> ($offset.1 == 0bv32 && $d45.0 == 16bv32) || BV32_MUL($d45.0, $offset.1) == 8bv32;
    assert {:tag "relationalPow2"} _b78 ==> BV32_MUL($d45.0, $offset.1) == 8bv32;
    assert {:tag "relationalPow2"} _b77 ==> ($offset.1 == 0bv32 && $d45.0 == 32bv32) || BV32_MUL($d45.0, $offset.1) == 16bv32;
    assert {:tag "relationalPow2"} _b76 ==> BV32_MUL($d45.0, $offset.1) == 16bv32;
    assert {:tag "relationalPow2"} _b75 ==> ($offset.1 == 0bv32 && $d45.0 == 64bv32) || BV32_MUL($d45.0, $offset.1) == 32bv32;
    assert {:tag "relationalPow2"} _b74 ==> BV32_MUL($d45.0, $offset.1) == 32bv32;
    assert {:tag "relationalPow2"} _b73 ==> ($offset.1 == 0bv32 && $d45.0 == 128bv32) || BV32_MUL($d45.0, $offset.1) == 64bv32;
    assert {:tag "relationalPow2"} _b72 ==> BV32_MUL($d45.0, $offset.1) == 64bv32;
    assert {:tag "relationalPow2"} _b71 ==> ($offset.1 == 0bv32 && $d45.0 == 256bv32) || BV32_MUL($d45.0, $offset.1) == 128bv32;
    assert {:tag "relationalPow2"} _b70 ==> BV32_MUL($d45.0, $offset.1) == 128bv32;
    assert {:tag "relationalPow2"} _b69 ==> ($offset.1 == 0bv32 && $d45.0 == 512bv32) || BV32_MUL($d45.0, $offset.1) == 256bv32;
    assert {:tag "relationalPow2"} _b68 ==> BV32_MUL($d45.0, $offset.1) == 256bv32;
    assert {:tag "relationalPow2"} _b67 ==> ($offset.1 == 0bv32 && $d45.0 == 1024bv32) || BV32_MUL($d45.0, $offset.1) == 512bv32;
    assert {:tag "relationalPow2"} _b66 ==> BV32_MUL($d45.0, $offset.1) == 512bv32;
    assert {:tag "relationalPow2"} _b65 ==> ($offset.1 == 0bv32 && $d45.0 == 2048bv32) || BV32_MUL($d45.0, $offset.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b64 ==> BV32_MUL($d45.0, $offset.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b63 ==> ($offset.1 == 0bv32 && $d45.0 == 4096bv32) || BV32_MUL($d45.0, $offset.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b62 ==> BV32_MUL($d45.0, $offset.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b61 ==> ($offset.1 == 0bv32 && $d45.0 == 8192bv32) || BV32_MUL($d45.0, $offset.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b60 ==> BV32_MUL($d45.0, $offset.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b59 ==> ($offset.1 == 0bv32 && $d45.0 == 16384bv32) || BV32_MUL($d45.0, $offset.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b58 ==> BV32_MUL($d45.0, $offset.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b57 ==> ($offset.1 == 0bv32 && $d45.0 == 32768bv32) || BV32_MUL($d45.0, $offset.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b56 ==> BV32_MUL($d45.0, $offset.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b55 ==> ($offset.1 == 0bv32 && $d45.0 == 65536bv32) || BV32_MUL($d45.0, $offset.1) == 32768bv32;
    assert {:tag "relationalPow2"} _b54 ==> BV32_MUL($d45.0, $offset.1) == 32768bv32;
    assert {:tag "pow2NotZero"} _b53 ==> v10 != 0bv32;
    assert {:tag "pow2"} _b52 ==> v10 == 0bv32 || BV32_AND(v10, BV32_SUB(v10, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b51 ==> $d45.0 != 0bv32;
    assert {:tag "pow2"} _b50 ==> $d45.0 == 0bv32 || BV32_AND($d45.0, BV32_SUB($d45.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_UGE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_ULE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SGE($d45.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SLE($d45.0, 1bv32);
  ...
  __partitioned_block_$falsebb2_1:
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 35} _CHECK_WRITE_$$output(true, BV32_MUL(2bv32, v0$2), v17$2);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 37} _CHECK_WRITE_$$output(true, BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32), v18$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
  ...
  __partitioned_block_$truebb2_1:
    call {:sourceloc_num 23} $bugle_barrier_duplicated_1(1bv1, 0bv1);
    v11$1 := BV32_SLT(v0$1, $d45.0);
    v11$2 := BV32_SLT(v0$2, $d45.0);
    ...
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$block(p5$1, v12$1, $$block[1bv1][v12$1]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$block(p5$2, v12$2, $$block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v12$2]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 26} _CHECK_READ_$$block(p5$2, v13$2, $$block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v13$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$block"} true;
    ...
    call {:sourceloc} {:sourceloc_num 27} _LOG_WRITE_$$block(p5$1, v12$1, v15$1, $$block[1bv1][v12$1]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 27} _CHECK_WRITE_$$block(p5$2, v12$2, v15$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$block"} true;
    ...
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$block(p5$1, v13$1, $$block[1bv1][v13$1]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$block(p5$2, v13$2, $$block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v13$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$block"} true;
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$block(p5$1, v13$1, FADD32(v16$1, v14$1), $$block[1bv1][v13$1]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$block(p5$2, v13$2, FADD32(v16$2, v14$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$block"} true;
  ...
  __partitioned_block_$truebb_1:
    call {:sourceloc_num 10} $bugle_barrier_duplicated_2(1bv1, 0bv1);
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_READ_$$block(p1$1, BV32_SUB(BV32_MUL($offset.0, BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32)), 1bv32), $$block[1bv1][BV32_SUB(BV32_MUL($offset.0, BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32)), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 12} _CHECK_READ_$$block(p1$2, BV32_SUB(BV32_MUL($offset.0, BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32)), 1bv32), $$block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(BV32_MUL($offset.0, BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32)), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$block"} true;
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_READ_$$block(p1$1, v5$1, $$block[1bv1][v5$1]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 13} _CHECK_READ_$$block(p1$2, v5$2, $$block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v5$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$block"} true;
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$block(p1$1, v5$1, FADD32(v7$1, v6$1), $$block[1bv1][v5$1]);
    ...
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$block(p1$2, v5$2, FADD32(v7$2, v6$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$block"} true;
