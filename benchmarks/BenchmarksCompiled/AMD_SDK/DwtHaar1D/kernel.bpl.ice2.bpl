...
assert  my_inv (  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  (  BV32_SLE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32)) ) ,  (  BV32_SGE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32)) ) ,  (  BV32_ULE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32)) ) ,  (  BV32_UGE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32)) ) ,  (  $activeThreads.0 == 0bv32 || BV32_AND($activeThreads.0, BV32_SUB($activeThreads.0, 1bv32)) == 0bv32 ) ,  (  $activeThreads.0 != 0bv32 ) ,  (  $midOutPos.0$1 == 0bv32 || BV32_AND($midOutPos.0$1, BV32_SUB($midOutPos.0$1, 1bv32)) == 0bv32 ) ,  (  $midOutPos.0$1 != 0bv32 ) ,  (  $midOutPos.0$2 == 0bv32 || BV32_AND($midOutPos.0$2, BV32_SUB($midOutPos.0$2, 1bv32)) == 0bv32 ) ,  (  $midOutPos.0$2 != 0bv32 ) ,  (  $midOutPos.1$1 == 0bv32 || BV32_AND($midOutPos.1$1, BV32_SUB($midOutPos.1$1, 1bv32)) == 0bv32 ) ,  (  $midOutPos.1$1 != 0bv32 ) ,  (  $midOutPos.1$2 == 0bv32 || BV32_AND($midOutPos.1$2, BV32_SUB($midOutPos.1$2, 1bv32)) == 0bv32 ) ,  (  $midOutPos.1$2 != 0bv32 ) ,  (  !_WRITE_HAS_OCCURRED_$$coefsSignal ) ,  (  !_READ_HAS_OCCURRED_$$sharedArray ) ,  (  !_WRITE_HAS_OCCURRED_$$sharedArray ) ,  (  _READ_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == BV32_MUL(2bv32, local_id_x$1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(2bv32, local_id_x$1), 1bv32) ) ,  (  _WRITE_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
