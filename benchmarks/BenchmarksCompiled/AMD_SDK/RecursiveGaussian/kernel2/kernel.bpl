...
implementation {:source_name "RecursiveGaussian_kernel"} {:kernel} $RecursiveGaussian_kernel($width: bv32, $height: bv32, $a0: bv32, $a1: bv32, $a2: bv32, $a3: bv32, $b1: bv32, $b2: bv32, $coefp: bv32, $coefn: bv32)
{
  ...
  var _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond: bool;
  var _READ_HAS_OCCURRED_$$output$ghost$$for.cond.35: bool;
  var _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond.35: bool;
  ...
  $entry:
    ...
    _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$output;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond;

  $for.cond:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b21 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$output;
    assert {:tag "accessBreak"} _b20 ==> _WRITE_HAS_OCCURRED_$$output ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_MUL(group_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b19 ==> _WRITE_HAS_OCCURRED_$$output ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 4bv32), group_size_x), BV32_DIV(local_id_x$1, group_size_x));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b18 ==> _WRITE_HAS_OCCURRED_$$output ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32));
    assume {:predicate "p2"} {:dominator_predicate "p1"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _WRITE_HAS_OCCURRED_$$output ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width) && BV32_SLT($y.0$1, $height) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $width) && BV32_SLT($y.0$2, $height) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b5 ==> p2$1 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b5 ==> p2$2 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $width);
  ...
  __partitioned_block_$for.cond.tail_1:
    ...
    $xn.0$1, $xa.0$1, $yn.0$1, $ya.0$1, $y34.0$1 := (if p1$1 then 0bv128 else $xn.0$1), (if p1$1 then 0bv128 else $xa.0$1), (if p1$1 then 0bv128 else $yn.0$1), (if p1$1 then 0bv128 else $ya.0$1), (if p1$1 then BV32_SUB($height, 1bv32) else $y34.0$1);
    $xn.0$2, $xa.0$2, $yn.0$2, $ya.0$2, $y34.0$2 := (if p1$2 then 0bv128 else $xn.0$2), (if p1$2 then 0bv128 else $xa.0$2), (if p1$2 then 0bv128 else $yn.0$2), (if p1$2 then 0bv128 else $ya.0$2), (if p1$2 then BV32_SUB($height, 1bv32) else $y34.0$2);
    p4$1 := (if p1$1 then true else p4$1);
    p4$2 := (if p1$2 then true else p4$2);
    _READ_HAS_OCCURRED_$$output$ghost$$for.cond.35 := _READ_HAS_OCCURRED_$$output;
    _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond.35 := _WRITE_HAS_OCCURRED_$$output;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $for.cond.35;

  $for.cond.35:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$output$ghost$$for.cond.35 == _WRITE_HAS_OCCURRED_$$output;
    assert {:tag "disabledMaintainsInstrumentation"} _b28 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$output$ghost$$for.cond.35 == _READ_HAS_OCCURRED_$$output;
    assert {:tag "accessBreak"} _b27 ==> _WRITE_HAS_OCCURRED_$$output ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_MUL(group_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b26 ==> _WRITE_HAS_OCCURRED_$$output ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 4bv32), group_size_x), BV32_DIV(local_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b25 ==> _READ_HAS_OCCURRED_$$output ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_MUL(group_id_x$1, group_size_x));
    assert {:tag "accessBreak"} _b24 ==> _READ_HAS_OCCURRED_$$output ==> group_id_x$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 4bv32), group_size_x), BV32_DIV(local_id_x$1, group_size_x));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _WRITE_HAS_OCCURRED_$$output ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _READ_HAS_OCCURRED_$$output ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(4294967295bv32, $width), 4bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_SUB($height, 1bv32), $width), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32));
    assume {:predicate "p4"} {:dominator_predicate "p1"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _WRITE_HAS_OCCURRED_$$output ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _READ_HAS_OCCURRED_$$output ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b15 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width) && BV32_SGT($y34.0$1, 4294967295bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b15 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $width) && BV32_SGT($y34.0$2, 4294967295bv32) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b14 ==> p4$1 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b14 ==> p4$2 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $width);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b13 ==> BV32_UGE($y34.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b13 ==> BV32_UGE($y34.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b12 ==> BV32_ULE($y34.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b12 ==> BV32_ULE($y34.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b11 ==> BV32_SGE($y34.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b11 ==> BV32_SGE($y34.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b10 ==> BV32_SLE($y34.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b10 ==> BV32_SLE($y34.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} p4$1 ==> _b9 ==> BV32_SLE(0bv32, $y34.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p4$2 ==> _b9 ==> BV32_SLE(0bv32, $y34.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b8 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y34.0$1) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($height, 1bv32));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b8 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y34.0$2) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($height, 1bv32));
    assert {:block_sourceloc} {:sourceloc_num 30} p4$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 31} {:thread 1} (if _WRITE_HAS_OCCURRED_$$output ==> BV32_UREM(BV32_UDIV(_WATCHED_OFFSET, 4bv32), $width) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 32} {:thread 1} (if _READ_HAS_OCCURRED_$$output ==> BV32_UREM(BV32_UDIV(_WATCHED_OFFSET, 4bv32), $width) == v0$1 then 1bv1 else 0bv1) != 0bv1;
    v28$1 := (if p4$1 then BV32_SGT($y34.0$1, 4294967295bv32) else v28$1);
    v28$2 := (if p4$2 then BV32_SGT($y34.0$2, 4294967295bv32) else v28$2);
    p5$1 := false;
    p5$2 := false;
    ...
    v29$1 := (if p5$1 then BV32_ADD(v0$1, BV32_MUL($y34.0$1, $width)) else v29$1);
    v29$2 := (if p5$2 then BV32_ADD(v0$2, BV32_MUL($y34.0$2, $width)) else v29$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc} {:sourceloc_num 50} _LOG_READ_$$output(p5$1, BV32_MUL(v29$1, 4bv32), $$output[BV32_MUL(v29$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 50} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 50} _CHECK_READ_$$output(p5$2, BV32_MUL(v29$2, 4bv32), $$output[BV32_MUL(v29$2, 4bv32)]);
    ...
    call {:sourceloc} {:sourceloc_num 51} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 51} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 51} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 52} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 52} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 52} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 53} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 53} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 53} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 54} _LOG_READ_$$output(p5$1, BV32_MUL(v29$1, 4bv32), $$output[BV32_MUL(v29$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 54} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 54} _CHECK_READ_$$output(p5$2, BV32_MUL(v29$2, 4bv32), $$output[BV32_MUL(v29$2, 4bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    v54$1 := (if p5$1 then $$output[BV32_MUL(v29$1, 4bv32)] else v54$1);
    v54$2 := (if p5$2 then $$output[BV32_MUL(v29$2, 4bv32)] else v54$2);
    call {:sourceloc} {:sourceloc_num 55} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 55} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 55} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 56} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 56} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 56} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 57} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 57} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 57} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 58} _LOG_READ_$$output(p5$1, BV32_MUL(v29$1, 4bv32), $$output[BV32_MUL(v29$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 58} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 58} _CHECK_READ_$$output(p5$2, BV32_MUL(v29$2, 4bv32), $$output[BV32_MUL(v29$2, 4bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    v58$1 := (if p5$1 then $$output[BV32_MUL(v29$1, 4bv32)] else v58$1);
    v58$2 := (if p5$2 then $$output[BV32_MUL(v29$2, 4bv32)] else v58$2);
    call {:sourceloc} {:sourceloc_num 59} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 59} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 59} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 60} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 60} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 60} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 61} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 61} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 61} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 62} _LOG_READ_$$output(p5$1, BV32_MUL(v29$1, 4bv32), $$output[BV32_MUL(v29$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 62} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 62} _CHECK_READ_$$output(p5$2, BV32_MUL(v29$2, 4bv32), $$output[BV32_MUL(v29$2, 4bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    v62$1 := (if p5$1 then $$output[BV32_MUL(v29$1, 4bv32)] else v62$1);
    v62$2 := (if p5$2 then $$output[BV32_MUL(v29$2, 4bv32)] else v62$2);
    call {:sourceloc} {:sourceloc_num 63} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 63} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 63} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 64} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 64} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 64} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 65} _LOG_READ_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 65} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 65} _CHECK_READ_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32), $$output[BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 66} _LOG_WRITE_$$output(p5$1, BV32_MUL(v29$1, 4bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v50$1), v46$1)), $$output[BV32_MUL(v29$1, 4bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p5$2, BV32_MUL(v29$2, 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 66} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 66} _CHECK_WRITE_$$output(p5$2, BV32_MUL(v29$2, 4bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v50$2), v46$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 67} _LOG_WRITE_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v55$1), v47$1)), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 67} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 67} _CHECK_WRITE_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 1bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v55$2), v47$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 68} _LOG_WRITE_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v60$1), v48$1)), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 2bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32));
    assume {:do_not_predicate} {:check_id "check_state_18"} {:captureState "check_state_18"} {:sourceloc} {:sourceloc_num 68} true;
    call {:check_id "check_state_18"} {:sourceloc} {:sourceloc_num 68} _CHECK_WRITE_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 2bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v60$2), v48$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    ...
    call {:sourceloc} {:sourceloc_num 69} _LOG_WRITE_$$output(p5$1, BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v65$1), v49$1)), $$output[BV32_ADD(BV32_MUL(v29$1, 4bv32), 3bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32));
    assume {:do_not_predicate} {:check_id "check_state_19"} {:captureState "check_state_19"} {:sourceloc} {:sourceloc_num 69} true;
    call {:check_id "check_state_19"} {:sourceloc} {:sourceloc_num 69} _CHECK_WRITE_$$output(p5$2, BV32_ADD(BV32_MUL(v29$2, 4bv32), 3bv32), FP32_TO_UI8(FADD32(UI8_TO_FP32(v65$2), v49$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    ...
    $xn.0$1, $xa.0$1, $yn.0$1, $ya.0$1, $y34.0$1 := (if p5$1 then UI8_TO_FP32(v45$1) ++ UI8_TO_FP32(v40$1) ++ UI8_TO_FP32(v35$1) ++ UI8_TO_FP32(v30$1) else $xn.0$1), (if p5$1 then $xn.0$1 else $xa.0$1), (if p5$1 then v49$1 ++ v48$1 ++ v47$1 ++ v46$1 else $yn.0$1), (if p5$1 then $yn.0$1 else $ya.0$1), (if p5$1 then BV32_ADD($y34.0$1, 4294967295bv32) else $y34.0$1);
    $xn.0$2, $xa.0$2, $yn.0$2, $ya.0$2, $y34.0$2 := (if p5$2 then UI8_TO_FP32(v45$2) ++ UI8_TO_FP32(v40$2) ++ UI8_TO_FP32(v35$2) ++ UI8_TO_FP32(v30$2) else $xn.0$2), (if p5$2 then $xn.0$2 else $xa.0$2), (if p5$2 then v49$2 ++ v48$2 ++ v47$2 ++ v46$2 else $yn.0$2), (if p5$2 then $yn.0$2 else $ya.0$2), (if p5$2 then BV32_ADD($y34.0$2, 4294967295bv32) else $y34.0$2);
