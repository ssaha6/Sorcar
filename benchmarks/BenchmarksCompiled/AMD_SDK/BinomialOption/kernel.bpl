...
implementation {:source_name "binomial_options"} {:kernel} $binomial_options($numSteps: bv32)
{
  ...
  __partitioned_block_$entry_0:
    ...
    $cond$1 := (if p0$1 then v44$1 else $cond$1);
    $cond$2 := (if p0$2 then v44$2 else $cond$2);
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$callA(true, BV32_MUL(v0$1, 4bv32), $cond$1, $$callA[1bv1][BV32_MUL(v0$1, 4bv32)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$callA(true, BV32_MUL(v0$2, 4bv32), $cond$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$callA"} true;
    $$callA[1bv1][BV32_MUL(v0$1, 4bv32)] := $cond$1;
    $$callA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(v0$2, 4bv32)] := $cond$2;
    ...
    $cond36$1 := (if p2$1 then v45$1 else $cond36$1);
    $cond36$2 := (if p2$2 then v45$2 else $cond36$2);
    $cond36$1 := (if p3$1 then 0bv32 else $cond36$1);
    $cond36$2 := (if p3$2 then 0bv32 else $cond36$2);
    ...
    call {:sourceloc} {:sourceloc_num 24} _LOG_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32), $cond36$1, $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 24} _CHECK_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 1bv32), $cond36$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$callA"} true;
    $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32)] := $cond36$1;
    $$callA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 4bv32), 1bv32)] := $cond36$2;
    ...
    $cond43$1 := (if p4$1 then v46$1 else $cond43$1);
    $cond43$2 := (if p4$2 then v46$2 else $cond43$2);
    $cond43$1 := (if p5$1 then 0bv32 else $cond43$1);
    $cond43$2 := (if p5$2 then 0bv32 else $cond43$2);
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32), $cond43$1, $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 2bv32));
    assume {:do_not_predicate} {:check_id "check_state_22"} {:captureState "check_state_22"} {:sourceloc} {:sourceloc_num 36} true;
    call {:check_id "check_state_22"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 2bv32), $cond43$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$callA"} true;
    $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32)] := $cond43$1;
    $$callA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 4bv32), 2bv32)] := $cond43$2;
    ...
    $cond50$1 := (if p6$1 then v47$1 else $cond50$1);
    $cond50$2 := (if p6$2 then v47$2 else $cond50$2);
    $cond50$1 := (if p7$1 then 0bv32 else $cond50$1);
    $cond50$2 := (if p7$2 then 0bv32 else $cond50$2);
    ...
    call {:sourceloc} {:sourceloc_num 48} _LOG_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32), $cond50$1, $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 3bv32));
    assume {:do_not_predicate} {:check_id "check_state_31"} {:captureState "check_state_31"} {:sourceloc} {:sourceloc_num 48} true;
    call {:check_id "check_state_31"} {:sourceloc} {:sourceloc_num 48} _CHECK_WRITE_$$callA(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 3bv32), $cond50$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$callA"} true;
    $$callA[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32)] := $cond50$1;
    $$callA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 4bv32), 3bv32)] := $cond50$2;
