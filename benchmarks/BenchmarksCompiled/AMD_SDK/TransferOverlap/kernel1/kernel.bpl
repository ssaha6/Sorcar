...
implementation {:source_name "readKernel"} {:kernel} $readKernel($ni: bv32, $val: bv32, $nk: bv32)
{
  ...
  __partitioned_block_$0_0:
    ...
    call {:sourceloc} {:sourceloc_num 2} _LOG_WRITE_$$readKernel.lcount(p0$1, 0bv32, 0bv32, _abstracted_call_arg_2$1);
  ...
  __partitioned_block_$falsebb0_0:
    assume {:partition} !v1;
    call {:sourceloc} {:sourceloc_num 37} _LOG_ATOMIC_$$readKernel.lcount(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 37} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 37} _CHECK_ATOMIC_$$readKernel.lcount(true, 0bv32);
  ...
  __partitioned_block_$falsebb0_1:
    ...
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    _abstracted_call_arg_0$1 := (if p10$1 then _HAVOC_bv32$1 else _abstracted_call_arg_0$1);
    _abstracted_call_arg_0$2 := (if p10$2 then _HAVOC_bv32$2 else _abstracted_call_arg_0$2);
    call {:sourceloc} {:sourceloc_num 40} _LOG_READ_$$readKernel.lcount(p10$1, 0bv32, _abstracted_call_arg_0$1);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 40} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    _abstracted_call_arg_1$1 := (if p10$1 then _HAVOC_bv32$1 else _abstracted_call_arg_1$1);
    _abstracted_call_arg_1$2 := (if p10$2 then _HAVOC_bv32$2 else _abstracted_call_arg_1$2);
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 40} _CHECK_READ_$$readKernel.lcount(p10$2, 0bv32, _abstracted_call_arg_1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$readKernel.lcount"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v25$1 := (if p10$1 then _HAVOC_bv32$1 else v25$1);
    v25$2 := (if p10$2 then _HAVOC_bv32$2 else v25$2);
    ...
    v26$1 := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0bv32;
    v26$2 := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0bv32;
  ...
  $truebb0:
    assume {:partition} v1;
    $pcount.1$1, $i.0, $idx.0$1 := $pcount.0$1, 0bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
