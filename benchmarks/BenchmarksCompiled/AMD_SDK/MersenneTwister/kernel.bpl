...
implementation {:source_name "gaussianRand"} {:kernel} $gaussianRand($width: bv32, $mulFactor: bv32)
{
  ...
  $for.cond.83:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 106} {:thread 1} (if _WRITE_HAS_OCCURRED_$$gaussianRand ==> BV32_UGE(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 16bv32), v92$1) then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 107} {:thread 1} (if _WRITE_HAS_OCCURRED_$$gaussianRand ==> BV32_ULT(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 16bv32), BV32_ADD(v92$1, $mulFactor)) then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb0:
    ...
    v102$1 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v94$1), 1065353216bv32), 1333788672bv32))));
    v102$2 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v94$2), 1065353216bv32), 1333788672bv32))));
    v103$1 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v95$1), 1065353216bv32), 1333788672bv32))));
    v103$2 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v95$2), 1065353216bv32), 1333788672bv32))));
    v104$1 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v96$1), 1065353216bv32), 1333788672bv32))));
    v104$2 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v96$2), 1065353216bv32), 1333788672bv32))));
    v105$1 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v97$1), 1065353216bv32), 1333788672bv32))));
    v105$2 := FSQRT32(FMUL32(3221225472bv32, FLOG32(FDIV32(FMUL32(UI32_TO_FP32(v97$2), 1065353216bv32), 1333788672bv32))));
    ...
    call {:sourceloc} {:sourceloc_num 117} _LOG_WRITE_$$gaussianRand(true, BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), FMUL32(v102$1, FCOS32(v106$1)), $$gaussianRand[BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 117} _CHECK_WRITE_$$gaussianRand(true, BV32_MUL(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 4bv32), FMUL32(v102$2, FCOS32(v106$2)));
    ...
    call {:sourceloc} {:sourceloc_num 118} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 1bv32), FMUL32(v103$1, FCOS32(v107$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 118} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 4bv32), 1bv32), FMUL32(v103$2, FCOS32(v107$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 119} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 2bv32), FMUL32(v104$1, FCOS32(v108$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 119} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 4bv32), 2bv32), FMUL32(v104$2, FCOS32(v108$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 120} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 3bv32), FMUL32(v105$1, FCOS32(v109$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 120} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 4bv32), 3bv32), FMUL32(v105$2, FCOS32(v109$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 121} _LOG_WRITE_$$gaussianRand(true, BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), FMUL32(v102$1, FSIN32(v106$1)), $$gaussianRand[BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 121} _CHECK_WRITE_$$gaussianRand(true, BV32_MUL(BV32_ADD(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), FMUL32(v102$2, FSIN32(v106$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 122} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 1bv32), FMUL32(v103$1, FSIN32(v107$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 122} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 1bv32), FMUL32(v103$2, FSIN32(v107$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 123} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 2bv32), FMUL32(v104$1, FSIN32(v108$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 123} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 2bv32), FMUL32(v104$2, FSIN32(v108$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
    ...
    call {:sourceloc} {:sourceloc_num 124} _LOG_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 3bv32), FMUL32(v105$1, FSIN32(v109$1)), $$gaussianRand[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$1, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 124} _CHECK_WRITE_$$gaussianRand(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v92$2, BV32_MUL($i.1, 2bv32)), 1bv32), 4bv32), 3bv32), FMUL32(v105$2, FSIN32(v109$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$gaussianRand"} true;
