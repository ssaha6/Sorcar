...
implementation {:source_name "box_filter_horizontal_local"} {:kernel} $box_filter_horizontal_local($filterWidth: bv32)
{
  ...
  $6:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$lds ==> !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$lds ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32))) && BV32_SLE($X.0$1, BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32))) && BV32_SLE($X.0$2, BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b5 ==> p7$1 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b5 ==> p7$2 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)));
