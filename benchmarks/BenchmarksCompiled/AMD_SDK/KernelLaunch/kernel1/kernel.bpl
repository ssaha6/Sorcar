...
implementation {:source_name "read_kernel"} {:kernel} $read_kernel($ni: bv32, $val: bv32, $nk: bv32)
{
  ...
  __partitioned_block_$falsebb_0:
    ...
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$read_kernel.lcount(p0$1, 0bv32, 0bv32, _abstracted_call_arg_2$1);
  ...
  __partitioned_block_$falsebb1_0:
    assume {:partition} !v2;
    call {:sourceloc} {:sourceloc_num 39} _LOG_ATOMIC_$$read_kernel.lcount(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 39} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 39} _CHECK_ATOMIC_$$read_kernel.lcount(true, 0bv32);
  ...
  __partitioned_block_$falsebb1_1:
    ...
    call {:sourceloc} {:sourceloc_num 42} _LOG_READ_$$read_kernel.lcount(p10$1, 0bv32, _abstracted_call_arg_0$1);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 42} _CHECK_READ_$$read_kernel.lcount(p10$2, 0bv32, _abstracted_call_arg_1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$read_kernel.lcount"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v26$1 := (if p10$1 then _HAVOC_bv32$1 else v26$1);
    v26$2 := (if p10$2 then _HAVOC_bv32$2 else v26$2);
