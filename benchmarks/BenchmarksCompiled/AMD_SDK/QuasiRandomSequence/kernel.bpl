...
implementation {:source_name "QuasiRandomSequence"} {:kernel} $QuasiRandomSequence()
{
  ...
  var _WRITE_HAS_OCCURRED_$$shared$ghost$$for.cond: bool;
  ...
  $entry:
    ...
    _WRITE_HAS_OCCURRED_$$shared$ghost$$for.cond := _WRITE_HAS_OCCURRED_$$shared;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond;

  $for.cond:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b14 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$shared$ghost$$for.cond == _WRITE_HAS_OCCURRED_$$shared;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _WRITE_HAS_OCCURRED_$$shared ==> local_id_x$1 == 0bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b11 ==> local_id_x$1 == 0bv32 && BV32_SLT($i.0$1, 8bv32) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b11 ==> local_id_x$2 == 0bv32 && BV32_SLT($i.0$2, 8bv32) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b10 ==> p1$1 ==> local_id_x$1 == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b10 ==> p1$2 ==> local_id_x$2 == 0bv32;
