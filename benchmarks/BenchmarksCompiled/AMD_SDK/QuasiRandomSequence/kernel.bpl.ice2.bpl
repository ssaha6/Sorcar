...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$shared ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32)) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$shared$ghost$$2 == _WRITE_HAS_OCCURRED_$$shared ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  ( p1$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p1$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p1$1 ==> BV32_SLE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_SLE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_SGE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_SGE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_ULE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_ULE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_UGE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_UGE($i.0$2, 0bv32) ) ,  ( p1$1 ==> p1$1 ==> local_id_x$1 == 0bv32 )  && ( p1$2 ==> p1$2 ==> local_id_x$2 == 0bv32 ) ,  (  local_id_x$1 == 0bv32 && BV32_SLT($i.0$1, 8bv32) ==> p1$1 )  && (  local_id_x$2 == 0bv32 && BV32_SLT($i.0$2, 8bv32) ==> p1$2 ) ,  (  _WRITE_HAS_OCCURRED_$$shared ==> local_id_x$1 == 0bv32 ) ,  true ,  true ,  true  ); 
