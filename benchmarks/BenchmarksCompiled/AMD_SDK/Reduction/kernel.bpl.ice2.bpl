...
implementation {:source_name "reduce"} {:kernel} $reduce()
{
  ...
  __partitioned_block_$0_0:
    ...
    v1$1 := group_id_x$1;
    v1$2 := group_id_x$2;
    v2$1 := BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 2bv32);
    v2$2 := BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 2bv32);
    havoc v3$1, v3$2;
    havoc v4$1, v4$2;
    havoc v5$1, v5$2;
    havoc v6$1, v6$2;
