...
implementation {:source_name "write_kernel"} {:kernel} $write_kernel($np: bv32, $val: bv32, $nk: bv32)
{
  ...
  $5:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b4 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_y, num_groups_y), 1bv32), $idx.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_y, num_groups_y), 1bv32), BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b4 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_y, num_groups_y), 1bv32), $idx.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_y, num_groups_y), 1bv32), BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2));
