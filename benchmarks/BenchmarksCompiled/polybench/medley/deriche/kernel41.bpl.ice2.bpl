...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p7$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$7 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p7$1 ==> _READ_HAS_OCCURRED_$$kernel41.shared_c2$ghost$$7 == _READ_HAS_OCCURRED_$$kernel41.shared_c2 ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p9$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$9 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel41.shared_c2$ghost$$9 == _READ_HAS_OCCURRED_$$kernel41.shared_c2 )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p10$1 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$1) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$1) )  && ( p10$2 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$2) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$2) ) ,  ( p10$1 ==> BV64_SLE(0bv64, $c3.0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $c3.0$2) ) ,  ( p10$1 ==> BV64_SLE(0bv64, $0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $0$2) ) ,  ( p10$1 ==> BV64_SLE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_SLE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_SGE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_SGE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_ULE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_ULE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_UGE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_UGE($c3.0$2, v3$2) ) ,  ( p10$1 ==> p10$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) )  && ( p10$2 ==> p10$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1_0.0$2, BV32_SEXT64($h)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) && BV64_SLE($c3.0$1, $0$1) ==> p10$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1_0.0$2, BV32_SEXT64($h)) && BV64_SLE($c3.0$2, $0$2) ==> p10$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$kernel41.shared_c2(p13$1, 0bv32, $$kernel41.shared_c2[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$kernel41.shared_c2(p13$2, 0bv32, $$kernel41.shared_c2[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
