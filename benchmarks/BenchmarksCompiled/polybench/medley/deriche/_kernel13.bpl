...
var {:source_name "a2"} {:global} $$a2: [bv32]bv32;
...
var {:source_name "a6"} {:global} $$a6: [bv32]bv32;
...
procedure {:source_name "kernel13"} {:kernel} $kernel13($alpha: bv32, $h: bv32, $w: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$a6, _WRITE_READ_BENIGN_FLAG_$$a6, _WRITE_READ_BENIGN_FLAG_$$a6, _WRITE_HAS_OCCURRED_$$a2, _WRITE_READ_BENIGN_FLAG_$$a2, _WRITE_READ_BENIGN_FLAG_$$a2;



implementation {:source_name "kernel13"} {:kernel} $kernel13($alpha: bv32, $h: bv32, $w: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    havoc v0$1, v0$2;
    v1$1 := FMUL32(FMUL32(v0$1, FEXP32(FMUL32(FSUB32(2147483648bv32, $alpha), 1069066811bv32))), FSUB32($alpha, 1065353216bv32));
    v1$2 := FMUL32(FMUL32(v0$2, FEXP32(FMUL32(FSUB32(2147483648bv32, $alpha), 1069066811bv32))), FSUB32($alpha, 1065353216bv32));
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a6(true, 0bv32, v1$1, $$a6[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a6(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a6(true, 0bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a6"} true;
    $$a6[0bv32] := v1$1;
    $$a6[0bv32] := v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a2(true, 0bv32, v1$1, $$a2[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a2(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a2(true, 0bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a2"} true;
    $$a2[0bv32] := v1$1;
    $$a2[0bv32] := v1$2;
    return;
}
