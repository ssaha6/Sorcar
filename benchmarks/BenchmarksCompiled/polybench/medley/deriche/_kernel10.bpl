...
var {:source_name "a3"} {:global} $$a3: [bv32]bv32;
...
var {:source_name "a7"} {:global} $$a7: [bv32]bv32;
...
procedure {:source_name "kernel10"} {:kernel} $kernel10($alpha: bv32, $h: bv32, $w: bv32);
...
implementation {:source_name "kernel10"} {:kernel} $kernel10($alpha: bv32, $h: bv32, $w: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    havoc v0$1, v0$2;
    v1$1 := FMUL32(FMUL32(v0$1, FEXP32(FMUL32(FSUB32(2147483648bv32, $alpha), 1069066811bv32))), FADD32($alpha, 1065353216bv32));
    v1$2 := FMUL32(FMUL32(v0$2, FEXP32(FMUL32(FSUB32(2147483648bv32, $alpha), 1069066811bv32))), FADD32($alpha, 1065353216bv32));
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a7(true, 0bv32, v1$1, $$a7[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a7(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a7(true, 0bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a7"} true;
    $$a7[0bv32] := v1$1;
    $$a7[0bv32] := v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a3(true, 0bv32, v1$1, $$a3[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a3(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a3(true, 0bv32, v1$2);
