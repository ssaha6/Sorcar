...
procedure {:source_name "kernel7"} {:kernel} $kernel7($h: bv32, $w: bv32, $c0: bv64);
...
implementation {:source_name "kernel7"} {:kernel} $kernel7($h: bv32, $w: bv32, $c0: bv64)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$xm1(true, 0bv32, 0bv32, $$xm1[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$xm1(true, 0bv32, 0bv32);
