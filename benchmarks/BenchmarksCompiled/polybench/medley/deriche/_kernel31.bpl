...
procedure {:source_name "kernel31"} {:kernel} $kernel31($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64);
...
implementation {:source_name "kernel31"} {:kernel} $kernel31($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64)
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$ym1(true, 0bv32, v0$1, $$ym1[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$ym1(true, 0bv32, v0$2);
