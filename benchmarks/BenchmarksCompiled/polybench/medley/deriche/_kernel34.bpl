...
procedure {:source_name "kernel34"} {:kernel} $kernel34($h: bv32, $w: bv32, $c0: bv64);
...
implementation {:source_name "kernel34"} {:kernel} $kernel34($h: bv32, $w: bv32, $c0: bv64)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$yp1(true, 0bv32, 0bv32, $$yp1[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$yp1(true, 0bv32, 0bv32);
