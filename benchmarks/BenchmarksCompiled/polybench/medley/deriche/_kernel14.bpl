...
var {:source_name "c1"} {:global} $$c1: [bv32]bv32;
...
procedure {:source_name "kernel14"} {:kernel} $kernel14($h: bv32, $w: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$c2, _WRITE_READ_BENIGN_FLAG_$$c2, _WRITE_READ_BENIGN_FLAG_$$c2, _WRITE_HAS_OCCURRED_$$c1, _WRITE_READ_BENIGN_FLAG_$$c1, _WRITE_READ_BENIGN_FLAG_$$c1;



implementation {:source_name "kernel14"} {:kernel} $kernel14($h: bv32, $w: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$c2(true, 0bv32, 1065353216bv32, $$c2[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$c2(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$c2(true, 0bv32, 1065353216bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$c2"} true;
    $$c2[0bv32] := 1065353216bv32;
    $$c2[0bv32] := 1065353216bv32;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$c1(true, 0bv32, 1065353216bv32, $$c1[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$c1(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$c1(true, 0bv32, 1065353216bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$c1"} true;
    $$c1[0bv32] := 1065353216bv32;
    $$c1[0bv32] := 1065353216bv32;
    return;
}
