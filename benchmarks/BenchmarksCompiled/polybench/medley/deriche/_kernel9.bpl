...
var {:source_name "a4"} {:global} $$a4: [bv32]bv32;
...
var {:source_name "a8"} {:global} $$a8: [bv32]bv32;
...
procedure {:source_name "kernel9"} {:kernel} $kernel9($alpha: bv32, $h: bv32, $w: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$a8, _WRITE_READ_BENIGN_FLAG_$$a8, _WRITE_READ_BENIGN_FLAG_$$a8, _WRITE_HAS_OCCURRED_$$a4, _WRITE_READ_BENIGN_FLAG_$$a4, _WRITE_READ_BENIGN_FLAG_$$a4;



implementation {:source_name "kernel9"} {:kernel} $kernel9($alpha: bv32, $h: bv32, $w: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    havoc v0$1, v0$2;
    v1$1 := FMUL32(FSUB32(2147483648bv32, v0$1), FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32)));
    v1$2 := FMUL32(FSUB32(2147483648bv32, v0$2), FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32)));
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a8(true, 0bv32, v1$1, $$a8[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a8(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a8(true, 0bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a8"} true;
    $$a8[0bv32] := v1$1;
    $$a8[0bv32] := v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a4(true, 0bv32, v1$1, $$a4[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a4(true, 0bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a4"} true;
    $$a4[0bv32] := v1$1;
    $$a4[0bv32] := v1$2;
    return;
}
