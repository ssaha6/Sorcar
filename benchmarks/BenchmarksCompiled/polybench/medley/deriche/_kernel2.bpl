...
procedure {:source_name "kernel2"} {:kernel} $kernel2($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64)
{
  var v0$1: bv32;
  var v0$2: bv32;
