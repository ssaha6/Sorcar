...
var {:source_name "b1"} {:global} $$b1: [bv32]bv32;
...
procedure {:source_name "kernel6"} {:kernel} $kernel6($alpha: bv32, $h: bv32, $w: bv32);
...
implementation {:source_name "kernel6"} {:kernel} $kernel6($alpha: bv32, $h: bv32, $w: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$b1(true, 0bv32, FPOW32(1073741824bv32, FSUB32(2147483648bv32, $alpha)), $$b1[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$b1(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$b1(true, 0bv32, FPOW32(1073741824bv32, FSUB32(2147483648bv32, $alpha)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b1"} true;
    $$b1[0bv32] := FPOW32(1073741824bv32, FSUB32(2147483648bv32, $alpha));
    $$b1[0bv32] := FPOW32(1073741824bv32, FSUB32(2147483648bv32, $alpha));
    return;
}
