...
var {:source_name "shared_c1"} {:group_shared} $$kernel24.shared_c1: [bv1][bv32]bv32;
...
procedure {:source_name "kernel24"} {:kernel} $kernel24($h: bv32, $w: bv32);
...
implementation {:source_name "kernel24"} {:kernel} $kernel24($h: bv32, $w: bv32)
{
  var $c0.0$1: bv64;
  var $c0.0$2: bv64;
  var $c1_0.0$1: bv64;
  ...
  __partitioned_block_$0_0:
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$kernel24.shared_c1(p1$1, 0bv32, v6$1, $$kernel24.shared_c1[1bv1][0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel24.shared_c1(p1$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$kernel24.shared_c1(p1$2, 0bv32, v6$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel24.shared_c1"} true;
    $$kernel24.shared_c1[1bv1][0bv32] := (if p1$1 then v6$1 else $$kernel24.shared_c1[1bv1][0bv32]);
    $$kernel24.shared_c1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p1$2 then v6$2 else $$kernel24.shared_c1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
...
assert  my_inv (  ( p4$1 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c0.0$1) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_MUL(32bv64, v0$1)) )  && ( p4$2 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c0.0$2) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_MUL(32bv64, v0$2)) ) ,  ( p4$1 ==> BV64_SLE(0bv64, $c0.0$1) )  && ( p4$2 ==> BV64_SLE(0bv64, $c0.0$2) ) ,  ( p4$1 ==> BV64_SLE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p4$2 ==> BV64_SLE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p4$1 ==> BV64_SGE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p4$2 ==> BV64_SGE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p4$1 ==> BV64_ULE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p4$2 ==> BV64_ULE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p4$1 ==> BV64_UGE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p4$2 ==> BV64_UGE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($w)) ==> p4$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($w)) ==> p4$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0bv32 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p7$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$7 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p7$1 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1$ghost$$7 == _READ_HAS_OCCURRED_$$kernel24.shared_c1 ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p8$1 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c1_0.0$1) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_MUL(32bv64, v1$1)) )  && ( p8$2 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c1_0.0$2) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_MUL(32bv64, v1$2)) ) ,  ( p8$1 ==> BV64_SLE(0bv64, $c1_0.0$1) )  && ( p8$2 ==> BV64_SLE(0bv64, $c1_0.0$2) ) ,  ( p8$1 ==> BV64_SLE($c1_0.0$1, BV64_MUL(32bv64, v1$1)) )  && ( p8$2 ==> BV64_SLE($c1_0.0$2, BV64_MUL(32bv64, v1$2)) ) ,  ( p8$1 ==> BV64_SGE($c1_0.0$1, BV64_MUL(32bv64, v1$1)) )  && ( p8$2 ==> BV64_SGE($c1_0.0$2, BV64_MUL(32bv64, v1$2)) ) ,  ( p8$1 ==> BV64_ULE($c1_0.0$1, BV64_MUL(32bv64, v1$1)) )  && ( p8$2 ==> BV64_ULE($c1_0.0$2, BV64_MUL(32bv64, v1$2)) ) ,  ( p8$1 ==> BV64_UGE($c1_0.0$1, BV64_MUL(32bv64, v1$1)) )  && ( p8$2 ==> BV64_UGE($c1_0.0$2, BV64_MUL(32bv64, v1$2)) ) ,  ( p8$1 ==> p8$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) )  && ( p8$2 ==> p8$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) ==> p8$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1_0.0$2, BV32_SEXT64($h)) ==> p8$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p9$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$9 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0bv32 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1$ghost$$9 == _READ_HAS_OCCURRED_$$kernel24.shared_c1 )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p10$1 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$1) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$1) )  && ( p10$2 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$2) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$2) ) ,  ( p10$1 ==> BV64_SLE(0bv64, $c3.0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $c3.0$2) ) ,  ( p10$1 ==> BV64_SLE(0bv64, $0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $0$2) ) ,  ( p10$1 ==> BV64_SLE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_SLE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_SGE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_SGE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_ULE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_ULE($c3.0$2, v3$2) ) ,  ( p10$1 ==> BV64_UGE($c3.0$1, v3$1) )  && ( p10$2 ==> BV64_UGE($c3.0$2, v3$2) ) ,  ( p10$1 ==> p10$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) )  && ( p10$2 ==> p10$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1_0.0$2, BV32_SEXT64($h)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) && BV64_SLE($c3.0$1, $0$1) ==> p10$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($w)) && BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1_0.0$2, BV32_SEXT64($h)) && BV64_SLE($c3.0$2, $0$2) ==> p10$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SLT($c0.0$1, BV32_SEXT64($w)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> BV64_SLT($c1_0.0$1, BV32_SEXT64($h)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$kernel24.shared_c1(p13$1, 0bv32, $$kernel24.shared_c1[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$kernel24.shared_c1(p13$2, 0bv32, $$kernel24.shared_c1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel24.shared_c1"} true;
    v12$1 := (if p13$1 then $$kernel24.shared_c1[1bv1][0bv32] else v12$1);
    v12$2 := (if p13$2 then $$kernel24.shared_c1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v12$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
...
const _WATCHED_VALUE_$$c1: bv32;

procedure {:inline 1} _LOG_READ_$$c1(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$c1;



implementation {:inline 1} _LOG_READ_$$c1(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$c1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$c1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$c1, _WRITE_READ_BENIGN_FLAG_$$c1;



implementation {:inline 1} _LOG_WRITE_$$c1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$c1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$c1(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$c1;



implementation {:inline 1} _LOG_ATOMIC_$$c1(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$c1(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$c1(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$c1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$c1(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$kernel24.shared_c1: bv32;

procedure {:inline 1} _LOG_READ_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$kernel24.shared_c1;



implementation {:inline 1} _LOG_READ_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$kernel24.shared_c1, _WRITE_READ_BENIGN_FLAG_$$kernel24.shared_c1;



implementation {:inline 1} _LOG_WRITE_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$kernel24.shared_c1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel24.shared_c1(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel24.shared_c1;



implementation {:inline 1} _LOG_ATOMIC_$$kernel24.shared_c1(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$kernel24.shared_c1(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel24.shared_c1(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel24.shared_c1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel24.shared_c1(_P: bool, _offset: bv32)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$kernel24.shared_c1;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$kernel24.shared_c1;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$kernel24.shared_c1;
    goto anon1;
