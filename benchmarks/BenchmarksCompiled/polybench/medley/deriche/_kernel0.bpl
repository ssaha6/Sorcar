...
var {:source_name "b2"} {:global} $$b2: [bv32]bv32;
...
procedure {:source_name "kernel0"} {:kernel} $kernel0($alpha: bv32, $h: bv32, $w: bv32);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($alpha: bv32, $h: bv32, $w: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$b2(true, 0bv32, FSUB32(2147483648bv32, FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32))), $$b2[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$b2(true, 0bv32, FSUB32(2147483648bv32, FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b2"} true;
    $$b2[0bv32] := FSUB32(2147483648bv32, FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32)));
    $$b2[0bv32] := FSUB32(2147483648bv32, FEXP32(FMUL32(FMUL32(3221225472bv32, $alpha), 1069066811bv32)));
    return;
}
