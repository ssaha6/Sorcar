...
var {:source_name "tp1"} {:global} $$tp1: [bv32]bv32;
...
procedure {:source_name "kernel32"} {:kernel} $kernel32($h: bv32, $w: bv32, $c0: bv64);
...
implementation {:source_name "kernel32"} {:kernel} $kernel32($h: bv32, $w: bv32, $c0: bv64)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$tp1(true, 0bv32, 0bv32, $$tp1[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$tp1(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$tp1(true, 0bv32, 0bv32);
