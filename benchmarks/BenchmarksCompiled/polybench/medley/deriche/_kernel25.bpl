...
var {:source_name "ym1"} {:global} $$ym1: [bv32]bv32;
...
procedure {:source_name "kernel25"} {:kernel} $kernel25($h: bv32, $w: bv32, $c0: bv64);
  ...
  modifies _WRITE_HAS_OCCURRED_$$ym1, _WRITE_READ_BENIGN_FLAG_$$ym1, _WRITE_READ_BENIGN_FLAG_$$ym1;



implementation {:source_name "kernel25"} {:kernel} $kernel25($h: bv32, $w: bv32, $c0: bv64)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$ym1(true, 0bv32, 0bv32, $$ym1[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$ym1(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$ym1(true, 0bv32, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$ym1"} true;
    $$ym1[0bv32] := 0bv32;
    $$ym1[0bv32] := 0bv32;
    return;
}
