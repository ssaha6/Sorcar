...
var {:source_name "xp1"} {:global} $$xp1: [bv32]bv32;
...
procedure {:source_name "kernel22"} {:kernel} $kernel22($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64);
...
implementation {:source_name "kernel22"} {:kernel} $kernel22($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64)
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$xp1(true, 0bv32, v0$1, $$xp1[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$xp1(true, 0bv32, v0$2);
