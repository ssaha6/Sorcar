...
procedure {:source_name "kernel19"} {:kernel} $kernel19($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64);
...
implementation {:source_name "kernel19"} {:kernel} $kernel19($h: bv32, $w: bv32, $c0: bv64, $c1_0: bv64)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    ...
    havoc v6$1, v6$2;
    havoc v7$1, v7$2;
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$y2(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0], FADD32(FMUL32(v6$1, v7$1), FADD32(FMUL32(v4$1, v5$1), FADD32(FMUL32(v0$1, v1$1), FMUL32(v2$1, v3$1)))), $$y2[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$y2(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$y2(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0], FADD32(FMUL32(v6$2, v7$2), FADD32(FMUL32(v4$2, v5$2), FADD32(FMUL32(v0$2, v1$2), FMUL32(v2$2, v3$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$y2"} true;
    $$y2[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0]] := FADD32(FMUL32(v6$1, v7$1), FADD32(FMUL32(v4$1, v5$1), FADD32(FMUL32(v0$1, v1$1), FMUL32(v2$1, v3$1))));
    $$y2[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0bv64, $c1_0))[32:0]] := FADD32(FMUL32(v6$2, v7$2), FADD32(FMUL32(v4$2, v5$2), FADD32(FMUL32(v0$2, v1$2), FMUL32(v2$2, v3$2))));
    return;
}
...
const _WATCHED_VALUE_$$a3: bv32;

procedure {:inline 1} _LOG_READ_$$a3(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$a3;



implementation {:inline 1} _LOG_READ_$$a3(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$a3(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$a3(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$a3, _WRITE_READ_BENIGN_FLAG_$$a3;



implementation {:inline 1} _LOG_WRITE_$$a3(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$a3(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$a3(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$a3;



implementation {:inline 1} _LOG_ATOMIC_$$a3(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$a3(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a3(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$a3;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a3(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$a4: bv32;

procedure {:inline 1} _LOG_READ_$$a4(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$a4;



implementation {:inline 1} _LOG_READ_$$a4(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$a4(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$a4(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$a4, _WRITE_READ_BENIGN_FLAG_$$a4;



implementation {:inline 1} _LOG_WRITE_$$a4(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$a4(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$a4(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$a4;



implementation {:inline 1} _LOG_ATOMIC_$$a4(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$a4(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$a4;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$xp1: bv32;

procedure {:inline 1} _LOG_READ_$$xp1(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$xp1;



implementation {:inline 1} _LOG_READ_$$xp1(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$xp1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$xp1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$xp1, _WRITE_READ_BENIGN_FLAG_$$xp1;



implementation {:inline 1} _LOG_WRITE_$$xp1(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$xp1(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$xp1(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$xp1;



implementation {:inline 1} _LOG_ATOMIC_$$xp1(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$xp1(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$xp1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(_P: bool, _offset: bv32)
{
