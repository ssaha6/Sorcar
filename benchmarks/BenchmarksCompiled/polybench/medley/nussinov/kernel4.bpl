...
implementation {:source_name "kernel4"} {:kernel} $kernel4($n: bv32, $c0: bv64)
{
  ...
  $13:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV64_SLT($c1.0$1, BV64_SDIV(BV64_ADD($c0, 2bv64), 4bv64)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV64_SLT($c1.0$2, BV64_SDIV(BV64_ADD($c0, 2bv64), 4bv64)) ==> p6$2;
