...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: bv32, $c0: bv64)
{
  ...
  $if.then:
    ...
    $cond$1 := (if p0$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 93bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $cond$1);
    $cond$2 := (if p0$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 93bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $cond$2);
    $cond$1 := (if p1$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 93bv64), 3145728bv64) else $cond$1);
    $cond$2 := (if p1$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 93bv64), 3145728bv64) else $cond$2);
    ...
    $cond93$1 := (if p4$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 93bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $cond93$1);
    $cond93$2 := (if p4$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 93bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $cond93$2);
    $cond93$1 := (if p5$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 93bv64), 3145728bv64) else $cond93$1);
    $cond93$2 := (if p5$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 93bv64), 3145728bv64) else $cond93$2);
  ...
  $for.cond:
    ...
    $cond178$1 := (if p14$1 then v16$1 else $cond178$1);
    $cond178$2 := (if p14$2 then v16$2 else $cond178$2);
    ...
    $cond178$1 := (if p15$1 then v15$1 else $cond178$1);
    $cond178$2 := (if p15$2 then v15$2 else $cond178$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$table(p13$1, BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)))[32:0], $cond178$1, $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)))[32:0]]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$table(p13$2, BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)))[32:0], $cond178$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$table"} true;
    $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)))[32:0]] := (if p13$1 then $cond178$1 else $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)))[32:0]]);
    $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)))[32:0]] := (if p13$2 then $cond178$2 else $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)))[32:0]]);
