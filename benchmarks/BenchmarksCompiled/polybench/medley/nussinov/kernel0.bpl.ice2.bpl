...
procedure {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $c0: bv64);
  ...
  requires {:sourceloc_num 1} {:thread 1} (if BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV64_SGE($c0, 5bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64(BV32_MUL(4bv32, $n)), BV64_ADD($c0, 3bv64)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $c0: bv64)
{
  ...
  $0:
    ...
    v2 := BV64_SGE(BV32_SEXT64(BV32_ADD($n, 3bv32)), $c0);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  $falsebb:
    assume {:partition} !v2;
    v3 := BV64_SGE($c0, BV32_SEXT64(BV32_ADD($n, 4bv32)));
  ...
  $truebb0:
    assume {:partition} v3;
    v4 := BV64_SGE(BV64_MUL(4bv64, BV64_SDIV(BV64_ADD(BV32_SEXT64($n), BV64_MUL(2bv64, $c0)), 3bv64)), BV64_ADD(BV64_MUL(3bv64, $c0), 1bv64));
...
assert  my_inv (  ( p6$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $1$1) )  && ( p6$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $1$2) ) ,  ( p6$1 ==> BV64_SLE(0bv64, $c1.0$1) )  && ( p6$2 ==> BV64_SLE(0bv64, $c1.0$2) ) ,  ( p6$1 ==> BV64_SLE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_SLE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_SGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_SGE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_ULE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_ULE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_UGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_UGE($c1.0$2, $1$2) ) ,  (  BV64_SLE($c1.0$1, BV64_SDIV(BV64_SUB($c0, 1bv64), 4bv64)) ==> p6$1 )  && (  BV64_SLE($c1.0$2, BV64_SDIV(BV64_SUB($c0, 1bv64), 4bv64)) ==> p6$2 ) ,  (  _READ_HAS_OCCURRED_$$table ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$table ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) )  ); 
    ...
    v8$1 := (if p6$1 then BV64_SLE($c1.0$1, BV64_SDIV(BV64_SUB($c0, 1bv64), 4bv64)) else v8$1);
    v8$2 := (if p6$2 then BV64_SLE($c1.0$2, BV64_SDIV(BV64_SUB($c0, 1bv64), 4bv64)) else v8$2);
    p7$1 := false;
    p7$2 := false;
    p8$1 := false;
    p8$2 := false;
    ...
    v10$1 := (if p9$1 then BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), BV64_MUL(3bv64, v1$1)), BV64_MUL(3bv64, $c1.0$1)), $c0) else v10$1);
    v10$2 := (if p9$2 then BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), BV64_MUL(3bv64, v1$2)), BV64_MUL(3bv64, $c1.0$2)), $c0) else v10$2);
    p11$1 := (if p9$1 && v10$1 then v10$1 else p11$1);
    p11$2 := (if p9$2 && v10$2 then v10$2 else p11$2);
    v11$1 := (if p11$1 then BV64_SGE($c0, BV64_ADD(BV64_ADD(BV64_MUL(4bv64, v1$1), BV64_MUL(4bv64, $c1.0$1)), 1bv64)) else v11$1);
    v11$2 := (if p11$2 then BV64_SGE($c0, BV64_ADD(BV64_ADD(BV64_MUL(4bv64, v1$2), BV64_MUL(4bv64, $c1.0$2)), 1bv64)) else v11$2);
    p13$1 := (if p11$1 && v11$1 then v11$1 else p13$1);
    p13$2 := (if p11$2 && v11$2 then v11$2 else p13$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$table(p13$1, BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 1bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 1bv64))[32:0], $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 1bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 1bv64))[32:0]]);
    ...
    v12$1 := (if p13$1 then $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 1bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 1bv64))[32:0]] else v12$1);
    v12$2 := (if p13$2 then $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), 1bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)), 1bv64))[32:0]] else v12$2);
