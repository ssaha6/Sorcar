...
implementation {:source_name "kernel4"} {:kernel} $kernel4($n: bv32, $c0: bv64)
{
  ...
  $3:
    ...
    $0$1 := (if p0$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 95bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $0$1);
    $0$2 := (if p0$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 95bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $0$2);
    $0$1 := (if p1$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 95bv64), 3145728bv64) else $0$1);
    $0$2 := (if p1$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 95bv64), 3145728bv64) else $0$2);
    ...
    $2$1 := (if p4$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 95bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $2$1);
    $2$2 := (if p4$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 95bv64)), 3145728bv64), 1bv64), 3145728bv64)) else $2$2);
    $2$1 := (if p5$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$1)), $c0), 95bv64), 3145728bv64) else $2$1);
    $2$2 := (if p5$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(96bv64, v0$2)), $c0), 95bv64), 3145728bv64) else $2$2);
...
assert  my_inv (  ( p6$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $1$1) )  && ( p6$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $1$2) ) ,  ( p6$1 ==> BV64_SLE(0bv64, $c1.0$1) )  && ( p6$2 ==> BV64_SLE(0bv64, $c1.0$2) ) ,  ( p6$1 ==> BV64_SLE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_SLE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_SGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_SGE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_ULE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_ULE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV64_UGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV64_UGE($c1.0$2, $1$2) ) ,  (  BV64_SLT($c1.0$1, BV64_SDIV(BV64_ADD($c0, 2bv64), 4bv64)) ==> p6$1 )  && (  BV64_SLT($c1.0$2, BV64_SDIV(BV64_ADD($c0, 2bv64), 4bv64)) ==> p6$2 ) ,  (  _READ_HAS_OCCURRED_$$table ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$table ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) )  ); 
    ...
    $3$1 := (if p14$1 then BV32_ADD(v18$1, (if BV32_ADD(BV8_SEXT32(v19$1), BV8_SEXT32(v20$1)) == 3bv32 then 1bv32 else 0bv32)) else $3$1);
    $3$2 := (if p14$2 then BV32_ADD(v18$2, (if BV32_ADD(BV8_SEXT32(v19$2), BV8_SEXT32(v20$2)) == 3bv32 then 1bv32 else 0bv32)) else $3$2);
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_WRITE_$$table(p13$1, BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 2bv64))[32:0], $3$1, $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 2bv64))[32:0]]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 34} _CHECK_WRITE_$$table(p13$2, BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)), 2bv64))[32:0], $3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$table"} true;
    $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 2bv64))[32:0]] := (if p13$1 then $3$1 else $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$1), $c0), BV64_MUL(4bv64, $c1.0$1)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$1), $c0), BV64_MUL(3bv64, $c1.0$1)), 2bv64))[32:0]]);
    $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)), 2bv64))[32:0]] := (if p13$2 then $3$2 else $$table[BV64_ADD(BV64_MUL(BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551612bv64, v1$2), $c0), BV64_MUL(4bv64, $c1.0$2)), 2bv64), BV32_SEXT64($n)), BV64_SUB(BV64_SUB(BV64_ADD(BV64_MUL(18446744073709551613bv64, v1$2), $c0), BV64_MUL(3bv64, $c1.0$2)), 2bv64))[32:0]]);
