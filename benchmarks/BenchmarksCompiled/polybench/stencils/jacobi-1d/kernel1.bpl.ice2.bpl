...
procedure {:source_name "kernel1"} {:kernel} $kernel1($tsteps: bv32, $n: bv32, $c0: bv64);
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($tsteps: bv32, $n: bv32, $c0: bv64)
{
  var $c1.0$1: bv64;
  var $c1.0$2: bv64;
  var v1$1: bv64;
...
assert  my_inv (  ( p0$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SLE(0bv64, $c1.0$1) )  && ( p0$2 ==> BV64_SLE(0bv64, $c1.0$2) ) ,  ( p0$1 ==> BV64_SLE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SLE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SGE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SGE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_ULE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_ULE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_UGE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_UGE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$A(p5$1, BV64_ADD(v1$1, $c1.0$1)[32:0], FMUL64(4599676359373071550bv64, FADD64(FADD64(v5$1, v6$1), v7$1)), $$A[BV64_ADD(v1$1, $c1.0$1)[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p5$2, BV64_ADD(v1$2, $c1.0$2)[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$A(p5$2, BV64_ADD(v1$2, $c1.0$2)[32:0], FMUL64(4599676359373071550bv64, FADD64(FADD64(v5$2, v6$2), v7$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV64_ADD(v1$1, $c1.0$1)[32:0]] := (if p5$1 then FMUL64(4599676359373071550bv64, FADD64(FADD64(v5$1, v6$1), v7$1)) else $$A[BV64_ADD(v1$1, $c1.0$1)[32:0]]);
    $$A[BV64_ADD(v1$2, $c1.0$2)[32:0]] := (if p5$2 then FMUL64(4599676359373071550bv64, FADD64(FADD64(v5$2, v6$2), v7$2)) else $$A[BV64_ADD(v1$2, $c1.0$2)[32:0]]);
