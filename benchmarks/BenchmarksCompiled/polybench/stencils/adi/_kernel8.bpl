...
procedure {:source_name "kernel8"} {:kernel} $kernel8($n: bv32, $tsteps: bv32);
...
implementation {:source_name "kernel8"} {:kernel} $kernel8($n: bv32, $tsteps: bv32)
{
  var v0$1: bv64;
  var v0$2: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, v0$1), 4611686018427387904bv64), $$a[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, v0$2), 4611686018427387904bv64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a"} true;
    $$a[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, v0$1), 4611686018427387904bv64);
    $$a[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, v0$2), 4611686018427387904bv64);
    return;
}
