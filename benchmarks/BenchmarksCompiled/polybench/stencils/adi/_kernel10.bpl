...
procedure {:source_name "kernel10"} {:kernel} $kernel10($n: bv32, $tsteps: bv32);
...
implementation {:source_name "kernel10"} {:kernel} $kernel10($n: bv32, $tsteps: bv32)
{
  var v0$1: bv64;
  var v0$2: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$f(true, 0bv32, v0$1, $$f[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$f(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$f(true, 0bv32, v0$2);
