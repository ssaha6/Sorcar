...
implementation {:source_name "kernel22"} {:kernel} $kernel22($n: bv32, $tsteps: bv32, $c0: bv64)
{
  ...
  var _READ_HAS_OCCURRED_$$v$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.25: bool;
  var _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.33: bool;
  var _READ_HAS_OCCURRED_$$v$ghost$$for.cond.79: bool;
  var _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.79: bool;
  var _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.79: bool;
  ...
  $for.cond:
    ...
    assert {:tag "accessBreak"} _b82 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b81 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b80 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(BV64_ADD(0bv64, 31bv64)[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b79 ==> !_WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "noread"} _b78 ==> !_READ_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b77 ==> _WRITE_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b76 ==> _READ_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "nowrite"} _b75 ==> !_WRITE_HAS_OCCURRED_$$v;
    assert {:tag "noread"} _b74 ==> !_READ_HAS_OCCURRED_$$v;
    assert {:tag "predicatedEquality"} _b73 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    ...
    assert {:tag "predicatedEquality"} _b68 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    ...
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b63 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b61 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b60 ==> p0$1 && p0$2 ==> $c4.0$1 == $c4.0$2;
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> $cond78$1 == $cond78$2;
    ...
    _READ_HAS_OCCURRED_$$v$ghost$$for.cond.25 := _READ_HAS_OCCURRED_$$v;
    _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.25 := _WRITE_HAS_OCCURRED_$$v;
    _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25 := _READ_HAS_OCCURRED_$$kernel22.shared_p;
    _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25 := _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.25;

  $for.cond.25:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b114 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25 == _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "disabledMaintainsInstrumentation"} _b113 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.25 == _READ_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "accessBreak"} _b112 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b111 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b110 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(BV64_ADD(0bv64, 31bv64)[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b109 ==> !_WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "noread"} _b108 ==> !_READ_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "disabledMaintainsInstrumentation"} _b107 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.25 == _WRITE_HAS_OCCURRED_$$v;
    assert {:tag "disabledMaintainsInstrumentation"} _b106 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$v$ghost$$for.cond.25 == _READ_HAS_OCCURRED_$$v;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b105 ==> _WRITE_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b104 ==> _READ_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "nowrite"} _b103 ==> !_WRITE_HAS_OCCURRED_$$v;
    assert {:tag "noread"} _b102 ==> !_READ_HAS_OCCURRED_$$v;
    assert {:tag "predicatedEquality"} _b101 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b100 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b99 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b98 ==> p2$1 && p2$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b97 ==> p2$1 && p2$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b96 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b95 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b94 ==> p2$1 && p2$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b93 ==> p2$1 && p2$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b92 ==> p2$1 && p2$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b91 ==> p2$1 && p2$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b90 ==> p2$1 && p2$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b89 ==> p2$1 && p2$2 ==> $c4.0$1 == $c4.0$2;
    assert {:tag "predicatedEquality"} _b88 ==> p2$1 && p2$2 ==> $cond78$1 == $cond78$2;
    assert {:tag "predicatedEquality"} _b87 ==> p2$1 && p2$2 ==> $cond$1 == $cond$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b21 ==> _WRITE_HAS_OCCURRED_$$v ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _READ_HAS_OCCURRED_$$v ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    ...
    _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.33 := _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $for.cond.33;

  $for.cond.33:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b116 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.33 == _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b115 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b52 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), $c2.0$1), 30bv64), BV32_ZEXT64(local_id_x$1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b51 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c2.0$1, 0bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b50 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b49 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$1, 0bv64) && BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), $c2.0$1), 30bv64), BV32_ZEXT64(local_id_x$1)) && BV64_SLE($c3.0$1, $cond$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b49 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$2, 0bv64) && BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), $c2.0$2), 30bv64), BV32_ZEXT64(local_id_x$2)) && BV64_SLE($c3.0$2, $cond$2) ==> p6$2;
    ...
    $cond$1 := (if p7$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$1), 2bv64) else $cond$1);
    $cond$2 := (if p7$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$2), 2bv64) else $cond$2);
    $cond$1 := (if p8$1 then 31bv64 else $cond$1);
    $cond$2 := (if p8$2 then 31bv64 else $cond$2);
    v7$1 := (if p6$1 then BV64_SLE($c3.0$1, $cond$1) else v7$1);
    v7$2 := (if p6$2 then BV64_SLE($c3.0$2, $cond$2) else v7$2);
    ...
    goto $for.cond.33.backedge, __partitioned_block_$for.cond.33.tail_0;

  __partitioned_block_$for.cond.33.tail_0:
    assume !p6$1 && !p6$2;
    goto __partitioned_block_$for.cond.33.tail_1;

  __partitioned_block_$for.cond.33.tail_1:
    ...
    $cond78$1 := (if p14$1 then BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), $c2.0$1), 2bv64) else $cond78$1);
    $cond78$2 := (if p14$2 then BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), $c2.0$2), 2bv64) else $cond78$2);
    $cond78$1 := (if p15$1 then 0bv64 else $cond78$1);
    $cond78$2 := (if p15$2 then 0bv64 else $cond78$2);
    $c4.0$1 := (if p13$1 then $cond78$1 else $c4.0$1);
    $c4.0$2 := (if p13$2 then $cond78$2 else $c4.0$2);
    p16$1 := (if p13$1 then true else p16$1);
    p16$2 := (if p13$2 then true else p16$2);
    _READ_HAS_OCCURRED_$$v$ghost$$for.cond.79 := _READ_HAS_OCCURRED_$$v;
    _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.79 := _WRITE_HAS_OCCURRED_$$v;
    _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.79 := _READ_HAS_OCCURRED_$$kernel22.shared_p;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.79;

  $for.cond.79:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b123 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$for.cond.79 == _READ_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "accessBreak"} _b122 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b121 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(BV64_ADD(0bv64, 31bv64)[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "disabledMaintainsInstrumentation"} _b120 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$v$ghost$$for.cond.79 == _WRITE_HAS_OCCURRED_$$v;
    assert {:tag "disabledMaintainsInstrumentation"} _b119 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$v$ghost$$for.cond.79 == _READ_HAS_OCCURRED_$$v;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b118 ==> _WRITE_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b117 ==> _READ_HAS_OCCURRED_$$v ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel22.shared_p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _WRITE_HAS_OCCURRED_$$v ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$v ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _WRITE_HAS_OCCURRED_$$v ==> BV64_SLT($c2.0$1, 0bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _WRITE_HAS_OCCURRED_$$v ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _READ_HAS_OCCURRED_$$v ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b36 ==> _READ_HAS_OCCURRED_$$v ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _READ_HAS_OCCURRED_$$v ==> BV64_SLT($c2.0$1, 0bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _READ_HAS_OCCURRED_$$v ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b33 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c2.0$1, 0bv64);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    ...
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b27 ==> BV64_UGE($c4.0$1, $cond78$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b27 ==> BV64_UGE($c4.0$2, $cond78$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b26 ==> BV64_ULE($c4.0$1, $cond78$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b26 ==> BV64_ULE($c4.0$2, $cond78$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b25 ==> BV64_SGE($c4.0$1, $cond78$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b25 ==> BV64_SGE($c4.0$2, $cond78$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b24 ==> BV64_SLE($c4.0$1, $cond78$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b24 ==> BV64_SLE($c4.0$2, $cond78$2);
    ...
    goto $for.cond.79.backedge, __partitioned_block_$for.cond.79.tail_0;

  __partitioned_block_$for.cond.79.tail_0:
    assume !p16$1 && !p16$2;
    goto __partitioned_block_$for.cond.79.tail_1;

  __partitioned_block_$for.cond.79.tail_1:
    ...
    goto $for.cond.25.backedge, $for.cond.25.tail;
  ...
  $for.cond.79.backedge:
    assume {:backedge} p16$1 || p16$2;
    assume {:captureState "loop_back_edge_state_2_0"} true;
    goto $for.cond.79;

  $for.cond.33.backedge:
