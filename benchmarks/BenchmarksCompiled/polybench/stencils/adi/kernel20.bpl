...
implementation {:source_name "kernel20"} {:kernel} $kernel20($n: bv32, $tsteps: bv32, $c0: bv64)
{
  ...
  $for.cond:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$u ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
