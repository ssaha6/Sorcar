...
implementation {:source_name "kernel25"} {:kernel} $kernel25($n: bv32, $tsteps: bv32, $c0: bv64)
{
  ...
  $for.cond:
    ...
    assert {:tag "predicatedEquality"} _b69 ==> p2$1 && p2$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b68 ==> p2$1 && p2$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b67 ==> p2$1 && p2$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b66 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b65 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b64 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b63 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b62 ==> p2$1 && p2$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b61 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
  ...
  $for.cond.23:
    ...
    assert {:tag "predicatedEquality"} _b89 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b88 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b87 ==> p4$1 && p4$2 ==> v16$1 == v16$2;
    ...
    assert {:tag "predicatedEquality"} _b82 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b81 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
