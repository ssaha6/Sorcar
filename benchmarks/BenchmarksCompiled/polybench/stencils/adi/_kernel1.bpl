...
var {:source_name "DY"} {:global} $$DY: [bv32]bv64;
...
procedure {:source_name "kernel1"} {:kernel} $kernel1($n: bv32, $tsteps: bv32);
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: bv32, $tsteps: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$DY(true, 0bv32, FDIV64(4607182418800017408bv64, SI32_TO_FP64($n)), $$DY[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$DY(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$DY(true, 0bv32, FDIV64(4607182418800017408bv64, SI32_TO_FP64($n)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$DY"} true;
    $$DY[0bv32] := FDIV64(4607182418800017408bv64, SI32_TO_FP64($n));
    $$DY[0bv32] := FDIV64(4607182418800017408bv64, SI32_TO_FP64($n));
    return;
}
