...
procedure {:source_name "kernel18"} {:kernel} $kernel18($n: bv32, $tsteps: bv32, $c0: bv64);
...
implementation {:source_name "kernel18"} {:kernel} $kernel18($n: bv32, $tsteps: bv32, $c0: bv64)
{
  var $c1.0$1: bv64;
  var $c1.0$2: bv64;
  var v0$1: bv64;
...
assert  my_inv (  ( p0$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SLE(0bv64, $c1.0$1) )  && ( p0$2 ==> BV64_SLE(0bv64, $c1.0$2) ) ,  ( p0$1 ==> BV64_SLE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SLE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SGE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SGE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_ULE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_ULE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_UGE($c1.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_UGE($c1.0$2, BV64_MUL(32bv64, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$q ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$q(p5$1, BV64_MUL(BV64_ADD(v1$1, $c1.0$1), BV32_SEXT64($n))[32:0], v5$1, $$q[BV64_MUL(BV64_ADD(v1$1, $c1.0$1), BV32_SEXT64($n))[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$q(p5$2, BV64_MUL(BV64_ADD(v1$2, $c1.0$2), BV32_SEXT64($n))[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$q(p5$2, BV64_MUL(BV64_ADD(v1$2, $c1.0$2), BV32_SEXT64($n))[32:0], v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[BV64_MUL(BV64_ADD(v1$1, $c1.0$1), BV32_SEXT64($n))[32:0]] := (if p5$1 then v5$1 else $$q[BV64_MUL(BV64_ADD(v1$1, $c1.0$1), BV32_SEXT64($n))[32:0]]);
    $$q[BV64_MUL(BV64_ADD(v1$2, $c1.0$2), BV32_SEXT64($n))[32:0]] := (if p5$2 then v5$2 else $$q[BV64_MUL(BV64_ADD(v1$2, $c1.0$2), BV32_SEXT64($n))[32:0]]);
