...
procedure {:source_name "kernel15"} {:kernel} $kernel15($n: bv32, $tsteps: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$e, _WRITE_READ_BENIGN_FLAG_$$e, _WRITE_READ_BENIGN_FLAG_$$e;



implementation {:source_name "kernel15"} {:kernel} $kernel15($n: bv32, $tsteps: bv32)
{
  var v0$1: bv64;
  var v0$2: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$e(true, 0bv32, FADD64(4607182418800017408bv64, v0$1), $$e[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$e(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$e(true, 0bv32, FADD64(4607182418800017408bv64, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$e"} true;
    $$e[0bv32] := FADD64(4607182418800017408bv64, v0$1);
    $$e[0bv32] := FADD64(4607182418800017408bv64, v0$2);
    return;
}
