...
implementation {:source_name "kernel12"} {:kernel} $kernel12($n: bv32, $tsteps: bv32, $c0: bv64)
{
  ...
  var _READ_HAS_OCCURRED_$$u$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.25: bool;
  var _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25: bool;
  var _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.34: bool;
  var _READ_HAS_OCCURRED_$$u$ghost$$for.cond.80: bool;
  var _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.80: bool;
  var _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.80: bool;
  ...
  $for.cond:
    ...
    assert {:tag "predicatedEquality"} _b65 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    ...
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> $cond79$1 == $cond79$2;
    ...
    _READ_HAS_OCCURRED_$$u$ghost$$for.cond.25 := _READ_HAS_OCCURRED_$$u;
    _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.25 := _WRITE_HAS_OCCURRED_$$u;
    _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25 := _READ_HAS_OCCURRED_$$kernel12.shared_p;
    _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25 := _WRITE_HAS_OCCURRED_$$kernel12.shared_p;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.25;

  $for.cond.25:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b114 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25 == _WRITE_HAS_OCCURRED_$$kernel12.shared_p;
    assert {:tag "disabledMaintainsInstrumentation"} _b113 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.25 == _READ_HAS_OCCURRED_$$kernel12.shared_p;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b107 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.25 == _WRITE_HAS_OCCURRED_$$u;
    assert {:tag "disabledMaintainsInstrumentation"} _b106 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$u$ghost$$for.cond.25 == _READ_HAS_OCCURRED_$$u;
    ...
    assert {:tag "predicatedEquality"} _b100 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    ...
    assert {:tag "predicatedEquality"} _b94 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b93 ==> p2$1 && p2$2 ==> v4$1 == v4$2;
    ...
    assert {:tag "predicatedEquality"} _b88 ==> p2$1 && p2$2 ==> $cond79$1 == $cond79$2;
    ...
    _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.34 := _WRITE_HAS_OCCURRED_$$kernel12.shared_p;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $for.cond.34;

  $for.cond.34:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b116 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.34 == _WRITE_HAS_OCCURRED_$$kernel12.shared_p;
    ...
    goto $for.cond.34.backedge, __partitioned_block_$for.cond.34.tail_0;

  __partitioned_block_$for.cond.34.tail_0:
    assume !p6$1 && !p6$2;
    goto __partitioned_block_$for.cond.34.tail_1;

  __partitioned_block_$for.cond.34.tail_1:
    ...
    $cond79$1 := (if p14$1 then BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), $c2.0$1), 2bv64) else $cond79$1);
    $cond79$2 := (if p14$2 then BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), $c2.0$2), 2bv64) else $cond79$2);
    $cond79$1 := (if p15$1 then 0bv64 else $cond79$1);
    $cond79$2 := (if p15$2 then 0bv64 else $cond79$2);
    $c4.0$1 := (if p13$1 then $cond79$1 else $c4.0$1);
    $c4.0$2 := (if p13$2 then $cond79$2 else $c4.0$2);
    p16$1 := (if p13$1 then true else p16$1);
    p16$2 := (if p13$2 then true else p16$2);
    _READ_HAS_OCCURRED_$$u$ghost$$for.cond.80 := _READ_HAS_OCCURRED_$$u;
    _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.80 := _WRITE_HAS_OCCURRED_$$u;
    _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.80 := _READ_HAS_OCCURRED_$$kernel12.shared_p;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.80;

  $for.cond.80:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b123 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$kernel12.shared_p$ghost$$for.cond.80 == _READ_HAS_OCCURRED_$$kernel12.shared_p;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b120 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$u$ghost$$for.cond.80 == _WRITE_HAS_OCCURRED_$$u;
    assert {:tag "disabledMaintainsInstrumentation"} _b119 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$u$ghost$$for.cond.80 == _READ_HAS_OCCURRED_$$u;
    ...
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b27 ==> BV64_UGE($c4.0$1, $cond79$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b27 ==> BV64_UGE($c4.0$2, $cond79$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b26 ==> BV64_ULE($c4.0$1, $cond79$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b26 ==> BV64_ULE($c4.0$2, $cond79$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b25 ==> BV64_SGE($c4.0$1, $cond79$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b25 ==> BV64_SGE($c4.0$2, $cond79$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b24 ==> BV64_SLE($c4.0$1, $cond79$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b24 ==> BV64_SLE($c4.0$2, $cond79$2);
    ...
    goto $for.cond.80.backedge, __partitioned_block_$for.cond.80.tail_0;

  __partitioned_block_$for.cond.80.tail_0:
    assume !p16$1 && !p16$2;
    goto __partitioned_block_$for.cond.80.tail_1;

  __partitioned_block_$for.cond.80.tail_1:
