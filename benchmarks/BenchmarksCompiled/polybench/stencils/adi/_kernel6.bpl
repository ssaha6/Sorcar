...
var {:source_name "B1"} {:global} $$B1: [bv32]bv64;
...
procedure {:source_name "kernel6"} {:kernel} $kernel6($n: bv32, $tsteps: bv32);
...
implementation {:source_name "kernel6"} {:kernel} $kernel6($n: bv32, $tsteps: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$B1(true, 0bv32, 4611686018427387904bv64, $$B1[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$B1(true, 0bv32, 4611686018427387904bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B1"} true;
    $$B1[0bv32] := 4611686018427387904bv64;
    $$B1[0bv32] := 4611686018427387904bv64;
    return;
}
