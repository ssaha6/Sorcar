...
procedure {:source_name "kernel4"} {:kernel} $kernel4($n: bv32, $tsteps: bv32);
...
implementation {:source_name "kernel4"} {:kernel} $kernel4($n: bv32, $tsteps: bv32)
{
  var v0$1: bv64;
  var v0$2: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$d(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, v0$1), 4611686018427387904bv64), $$d[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$d(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, v0$2), 4611686018427387904bv64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d"} true;
    $$d[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, v0$1), 4611686018427387904bv64);
    $$d[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, v0$2), 4611686018427387904bv64);
    return;
}
