...
var {:source_name "DT"} {:global} $$DT: [bv32]bv64;
...
procedure {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $tsteps: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$DT, _WRITE_READ_BENIGN_FLAG_$$DT, _WRITE_READ_BENIGN_FLAG_$$DT;



implementation {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $tsteps: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$DT(true, 0bv32, FDIV64(4607182418800017408bv64, SI32_TO_FP64($tsteps)), $$DT[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$DT(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$DT(true, 0bv32, FDIV64(4607182418800017408bv64, SI32_TO_FP64($tsteps)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$DT"} true;
    $$DT[0bv32] := FDIV64(4607182418800017408bv64, SI32_TO_FP64($tsteps));
    $$DT[0bv32] := FDIV64(4607182418800017408bv64, SI32_TO_FP64($tsteps));
    return;
}
