...
implementation {:source_name "kernel1"} {:kernel} $kernel1($ny: bv32, $tmax: bv32, $nx: bv32, $c0: bv64)
{
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b43 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$ey$ghost$$5 == _WRITE_HAS_OCCURRED_$$ey;
    assert {:tag "disabledMaintainsInstrumentation"} _b42 ==> !p5$1 ==> _READ_HAS_OCCURRED_$$ey$ghost$$5 == _READ_HAS_OCCURRED_$$ey;
  ...
  $7:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b47 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$ey$ghost$$7 == _WRITE_HAS_OCCURRED_$$ey;
    assert {:tag "disabledMaintainsInstrumentation"} _b46 ==> !p7$1 ==> _READ_HAS_OCCURRED_$$ey$ghost$$7 == _READ_HAS_OCCURRED_$$ey;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b29 ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64)) && BV64_SLT($c2.0$1, BV32_SEXT64($ny)) && BV64_SLE($c4.0$1, $0$1) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b29 ==> BV64_SLT($c1.0$2, BV32_SEXT64($nx)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64)) && BV64_SLT($c2.0$2, BV32_SEXT64($ny)) && BV64_SLE($c4.0$2, $0$2) ==> p8$2;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p8$1 ==> _b23 ==> BV64_SLE(0bv64, $0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p8$2 ==> _b23 ==> BV64_SLE(0bv64, $0$2);
