...
implementation {:source_name "kernel4"} {:kernel} $kernel4($eps: bv64, $m: bv32, $n: bv32)
{
  var $c0.0$1: bv64;
  var $c0.0$2: bv64;
  var $0$1: bv64;
...
assert  my_inv (  ( p0$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c0.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c0.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SLE(0bv64, $c0.0$1) )  && ( p0$2 ==> BV64_SLE(0bv64, $c0.0$2) ) ,  ( p0$1 ==> BV64_SLE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SLE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SGE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SGE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_ULE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_ULE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_UGE($c0.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_UGE($c0.0$2, BV64_MUL(32bv64, v0$2)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($m)) ==> p0$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($m)) ==> p0$2 ) ,  (  _READ_HAS_OCCURRED_$$stddev ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$stddev ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_READ_$$stddev(p3$1, BV64_ADD(v1$1, $c0.0$1)[32:0], $$stddev[BV64_ADD(v1$1, $c0.0$1)[32:0]]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_READ_$$stddev(p3$2, BV64_ADD(v1$2, $c0.0$2)[32:0], $$stddev[BV64_ADD(v1$2, $c0.0$2)[32:0]]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$stddev"} true;
    v4$1 := (if p3$1 then $$stddev[BV64_ADD(v1$1, $c0.0$1)[32:0]] else v4$1);
    v4$2 := (if p3$2 then $$stddev[BV64_ADD(v1$2, $c0.0$2)[32:0]] else v4$2);
    $$private_stddev$0bv32$1 := (if p3$1 then v4$1 else $$private_stddev$0bv32$1);
    $$private_stddev$0bv32$2 := (if p3$2 then v4$2 else $$private_stddev$0bv32$2);
    v5$1 := (if p3$1 then $$private_stddev$0bv32$1 else v5$1);
    v5$2 := (if p3$2 then $$private_stddev$0bv32$2 else v5$2);
    $$private_stddev$0bv32$1 := (if p3$1 then FSQRT64(v5$1) else $$private_stddev$0bv32$1);
    $$private_stddev$0bv32$2 := (if p3$2 then FSQRT64(v5$2) else $$private_stddev$0bv32$2);
    v6$1 := (if p3$1 then $$private_stddev$0bv32$1 else v6$1);
    v6$2 := (if p3$2 then $$private_stddev$0bv32$2 else v6$2);
    ...
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$stddev(p3$2, BV64_ADD(v1$2, $c0.0$2)[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 20} _CHECK_WRITE_$$stddev(p3$2, BV64_ADD(v1$2, $c0.0$2)[32:0], v9$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$stddev"} true;
    $$stddev[BV64_ADD(v1$1, $c0.0$1)[32:0]] := (if p3$1 then v9$1 else $$stddev[BV64_ADD(v1$1, $c0.0$1)[32:0]]);
    $$stddev[BV64_ADD(v1$2, $c0.0$2)[32:0]] := (if p3$2 then v9$2 else $$stddev[BV64_ADD(v1$2, $c0.0$2)[32:0]]);
