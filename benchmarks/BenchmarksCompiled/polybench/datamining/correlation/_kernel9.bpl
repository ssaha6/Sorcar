...
procedure {:source_name "kernel9"} {:kernel} $kernel9($m: bv32, $n: bv32);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$corr ==> BV32_AND(BV1_ZEXT32((if BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), (if BV32_SGE($m, 2bv32) then $m else 1bv32)), (if BV32_SGE($m, 2bv32) then $m else 1bv32)), 1bv32) == $m then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), (if BV32_SGE($m, 2bv32) then $m else 1bv32)), 1bv32) == $m then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel9"} {:kernel} $kernel9($m: bv32, $n: bv32)
{
  var $0: bv32;
  var v0: bool;
  ...
  $3:
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$corr(true, BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32)), 4607182418800017408bv64, $$corr[BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$corr(true, BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$corr(true, BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32)), 4607182418800017408bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$corr"} true;
    $$corr[BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32))] := 4607182418800017408bv64;
    $$corr[BV32_ADD(BV32_MUL(BV32_SUB($m, 1bv32), $0), BV32_SUB($m, 1bv32))] := 4607182418800017408bv64;
    return;
