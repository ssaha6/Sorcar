...
procedure {:source_name "kernel2"} {:kernel} $kernel2($nl: bv32, $nj: bv32, $nm: bv32, $nk: bv32, $ni: bv32);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($nl: bv32, $nj: bv32, $nm: bv32, $nk: bv32, $ni: bv32)
{
  var $c0.0$1: bv64;
  var $c0.0$2: bv64;
  var $c1.0$1: bv64;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$G ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p3$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$4 == _WRITE_HAS_OCCURRED_$$G ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$G ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p5$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$6 == _WRITE_HAS_OCCURRED_$$G )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p6$1 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$1) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$1) )  && ( p6$2 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c3.0$2) == BV64_AND(BV64_SUB(16bv64, 1bv64), v3$2) ) ,  ( p6$1 ==> BV64_SLE(0bv64, $c3.0$1) )  && ( p6$2 ==> BV64_SLE(0bv64, $c3.0$2) ) ,  ( p6$1 ==> BV64_SLE(0bv64, $0$1) )  && ( p6$2 ==> BV64_SLE(0bv64, $0$2) ) ,  ( p6$1 ==> BV64_SLE($c3.0$1, v3$1) )  && ( p6$2 ==> BV64_SLE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV64_SGE($c3.0$1, v3$1) )  && ( p6$2 ==> BV64_SGE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV64_ULE($c3.0$1, v3$1) )  && ( p6$2 ==> BV64_ULE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV64_UGE($c3.0$1, v3$1) )  && ( p6$2 ==> BV64_UGE($c3.0$2, v3$2) ) ,  ( p6$1 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) )  && ( p6$2 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $0$1) ==> p6$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $0$2) ==> p6$2 ) ,  (  _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) ) ,  (  _WRITE_HAS_OCCURRED_$$G ==> BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) ) ,  (  _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c1.0$1, BV32_SEXT64($nl)) ) ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_WRITE_$$G(p9$1, BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1))[32:0], 0bv64, $$G[BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1))[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(p9$2, BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2))[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 18} _CHECK_WRITE_$$G(p9$2, BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2))[32:0], 0bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1))[32:0]] := (if p9$1 then 0bv64 else $$G[BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1))[32:0]]);
    $$G[BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2))[32:0]] := (if p9$2 then 0bv64 else $$G[BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2))[32:0]]);
