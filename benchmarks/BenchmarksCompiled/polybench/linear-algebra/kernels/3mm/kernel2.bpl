...
implementation {:source_name "kernel2"} {:kernel} $kernel2($nl: bv32, $nj: bv32, $nm: bv32, $nk: bv32, $ni: bv32)
{
  ...
  var p10$1: bool;
  var p10$2: bool;
  var _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.47: bool;
  var _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.52: bool;
  ...
  $for.cond:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b29 ==> _WRITE_HAS_OCCURRED_$$G ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    ...
    _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.47 := _WRITE_HAS_OCCURRED_$$G;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.47;

  $for.cond.47:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.47 == _WRITE_HAS_OCCURRED_$$G;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b30 ==> _WRITE_HAS_OCCURRED_$$G ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assume {:predicate "p4"} {:dominator_predicate "p3"} true;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni));
    ...
    _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.52 := _WRITE_HAS_OCCURRED_$$G;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.52;

  $for.cond.52:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b33 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$for.cond.52 == _WRITE_HAS_OCCURRED_$$G;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b32 ==> _WRITE_HAS_OCCURRED_$$G ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assume {:predicate "p6"} {:dominator_predicate "p5"} true;
    assert p6$1 ==> p4$1;
    assert p6$2 ==> p4$2;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b25 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $cond$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b25 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $cond$2) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b24 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b24 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl));
    ...
    goto $for.cond.52.backedge, $for.cond.52.tail;
  ...
  $for.cond.52.tail:
    ...
    goto $for.cond.47.backedge, $for.cond.47.tail;
