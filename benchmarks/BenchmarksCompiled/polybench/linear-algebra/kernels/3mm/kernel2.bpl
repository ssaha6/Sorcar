...
implementation {:source_name "kernel2"} {:kernel} $kernel2($nl: bv32, $nj: bv32, $nm: bv32, $nk: bv32, $ni: bv32)
{
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$4 == _WRITE_HAS_OCCURRED_$$G;
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b33 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$6 == _WRITE_HAS_OCCURRED_$$G;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b25 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $0$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b25 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $0$2) ==> p6$2;
