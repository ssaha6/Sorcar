...
implementation {:source_name "kernel1"} {:kernel} $kernel1($np: bv32, $nq: bv32, $nr: bv32, $c0: bv64, $c1: bv64)
{
  ...
  var _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0: bool;
  var _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0: bool;
  var _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.69: bool;
  ...
  $for.cond:
    ...
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b49 ==> p0$1 && p0$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    ...
    assert {:tag "predicatedEquality"} _b39 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b38 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    ...
    _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0 := _READ_HAS_OCCURRED_$$kernel1.shared_A;
    _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0 := _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto __partitioned_block_$for.cond.40_0;

  __partitioned_block_$for.cond.40_0:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b79 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b78 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$for.cond.40_0 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    ...
    assert {:tag "predicatedEquality"} _b73 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    ...
    assert {:tag "predicatedEquality"} _b67 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    ...
    goto __partitioned_block_$for.cond.40_1;

  __partitioned_block_$for.cond.40_1:
    ...
    _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.69 := _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.69;

  $for.cond.69:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b81 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.69 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1bv64)) && BV64_SLE($c5.0$1, $cond$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c2.0$2), 1bv64)) && BV64_SLE($c5.0$2, $cond$2) ==> p10$2;
    ...
    $cond$1 := (if p11$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$1), 1bv64) else $cond$1);
    $cond$2 := (if p11$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$2), 1bv64) else $cond$2);
    $cond$1 := (if p12$1 then 31bv64 else $cond$1);
    $cond$2 := (if p12$2 then 31bv64 else $cond$2);
    v11$1 := (if p10$1 then BV64_SLE($c5.0$1, $cond$1) else v11$1);
    v11$2 := (if p10$2 then BV64_SLE($c5.0$2, $cond$2) else v11$2);
    ...
    goto $for.cond.69.backedge, __partitioned_block_$for.cond.69.tail_0;

  __partitioned_block_$for.cond.69.tail_0:
    assume !p10$1 && !p10$2;
    goto __partitioned_block_$for.cond.69.tail_1;

  __partitioned_block_$for.cond.69.tail_1:
    ...
    goto $for.cond.40.backedge, __partitioned_block_$for.cond.40.tail_0;

  __partitioned_block_$for.cond.40.tail_0:
    assume !p4$1 && !p4$2;
    ...
    goto __partitioned_block_$for.cond.40.tail_1;

  __partitioned_block_$for.cond.40.tail_1:
