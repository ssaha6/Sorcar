...
assert  my_inv (  ( p0$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c2.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c2.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SLE(0bv64, $c2.0$1) )  && ( p0$2 ==> BV64_SLE(0bv64, $c2.0$2) ) ,  ( p0$1 ==> BV64_SUB($c2.0$1, BV64_MUL(32bv64, v0$1)) == BV64_SUB($c2.0$2, BV64_MUL(32bv64, v0$2)) )  && ( p0$2 ==> BV64_SUB($c2.0$2, BV64_MUL(32bv64, v0$2)) == BV64_SUB($c2.0$1, BV64_MUL(32bv64, v0$1)) ) ,  ( p0$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c2.0$1, BV64_MUL(32bv64, v0$1)) == BV64_SUB($c2.0$2, BV64_MUL(32bv64, v0$2)) )  && ( p0$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c2.0$2, BV64_MUL(32bv64, v0$2)) == BV64_SUB($c2.0$1, BV64_MUL(32bv64, v0$1)) ) ,  ( p0$1 ==> BV64_SLE($c2.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SLE($c2.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_SGE($c2.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_SGE($c2.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_ULE($c2.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_ULE($c2.0$2, BV64_MUL(32bv64, v0$2)) ) ,  ( p0$1 ==> BV64_UGE($c2.0$1, BV64_MUL(32bv64, v0$1)) )  && ( p0$2 ==> BV64_UGE($c2.0$2, BV64_MUL(32bv64, v0$2)) ) ,  (  BV64_SLT($c2.0$1, BV32_SEXT64($np)) ==> p0$1 )  && (  BV64_SLT($c2.0$2, BV32_SEXT64($np)) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  p0$1 == p0$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2 ) ,  (  p0$1 && p0$2 ==> $c2.0$1 == $c2.0$2 ) ,  (  p0$1 && p0$2 ==> $c3.0$1 == $c3.0$2 ) ,  (  p0$1 && p0$2 ==> $c5.0$1 == $c5.0$2 ) ,  (  p0$1 && p0$2 ==> $0$1 == $0$2 ) ,  (  p0$1 && p0$2 ==> v3$1 == v3$2 ) ,  (  p0$1 && p0$2 ==> v4$1 == v4$2 ) ,  (  p0$1 && p0$2 ==> v5$1 == v5$2 ) ,  (  p0$1 && p0$2 ==> v6$1 == v6$2 ) ,  (  p0$1 && p0$2 ==> v7$1 == v7$2 ) ,  (  p0$1 && p0$2 ==> v8$1 == v8$2 ) ,  (  p0$1 && p0$2 ==> v9$1 == v9$2 ) ,  (  p0$1 && p0$2 ==> v10$1 == v10$2 ) ,  (  p0$1 && p0$2 ==> v11$1 == v11$2 ) ,  (  p0$1 && p0$2 ==> v12$1 == v12$2 ) ,  (  p0$1 && p0$2 ==> v13$1 == v13$2 ) ,  (  p0$1 && p0$2 ==> v14$1 == v14$2 ) ,  (  p0$1 && p0$2 ==> v15$1 == v15$2 ) ,  (  p0$1 && p0$2 ==> v16$1 == v16$2 ) ,  (  !_READ_HAS_OCCURRED_$$sum ) ,  (  !_WRITE_HAS_OCCURRED_$$sum ) ,  (  _READ_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !_READ_HAS_OCCURRED_$$kernel1.shared_A ) ,  (  !_WRITE_HAS_OCCURRED_$$kernel1.shared_A ) ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET == local_id_x$1 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> BV64_AND(BV64_SUB(32bv64, 1bv64), $c3.0$1) == BV64_AND(BV64_SUB(32bv64, 1bv64), 0bv64) )  && ( p4$2 ==> BV64_AND(BV64_SUB(32bv64, 1bv64), $c3.0$2) == BV64_AND(BV64_SUB(32bv64, 1bv64), 0bv64) ) ,  ( p4$1 ==> BV64_SLE(0bv64, $c3.0$1) )  && ( p4$2 ==> BV64_SLE(0bv64, $c3.0$2) ) ,  ( p4$1 ==> BV64_SUB($c3.0$1, 0bv64) == BV64_SUB($c3.0$2, 0bv64) )  && ( p4$2 ==> BV64_SUB($c3.0$2, 0bv64) == BV64_SUB($c3.0$1, 0bv64) ) ,  ( p4$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c3.0$1, 0bv64) == BV64_SUB($c3.0$2, 0bv64) )  && ( p4$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c3.0$2, 0bv64) == BV64_SUB($c3.0$1, 0bv64) ) ,  ( p4$1 ==> BV64_SLE($c3.0$1, 0bv64) )  && ( p4$2 ==> BV64_SLE($c3.0$2, 0bv64) ) ,  ( p4$1 ==> BV64_SGE($c3.0$1, 0bv64) )  && ( p4$2 ==> BV64_SGE($c3.0$2, 0bv64) ) ,  ( p4$1 ==> BV64_ULE($c3.0$1, 0bv64) )  && ( p4$2 ==> BV64_ULE($c3.0$2, 0bv64) ) ,  ( p4$1 ==> BV64_UGE($c3.0$1, 0bv64) )  && ( p4$2 ==> BV64_UGE($c3.0$2, 0bv64) ) ,  ( p4$1 ==> p4$1 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) )  && ( p4$2 ==> p4$2 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) ) ,  (  BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) ==> p4$1 )  && (  BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) ) ,  (  _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$10 == _READ_HAS_OCCURRED_$$kernel1.shared_A )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p10$1 ==> BV64_SLE(0bv64, $c5.0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $c5.0$2) ) ,  ( p10$1 ==> BV64_SLE(0bv64, $0$1) )  && ( p10$2 ==> BV64_SLE(0bv64, $0$2) ) ,  ( p10$1 ==> BV64_SLE($c5.0$1, 0bv64) )  && ( p10$2 ==> BV64_SLE($c5.0$2, 0bv64) ) ,  ( p10$1 ==> BV64_SGE($c5.0$1, 0bv64) )  && ( p10$2 ==> BV64_SGE($c5.0$2, 0bv64) ) ,  ( p10$1 ==> BV64_ULE($c5.0$1, 0bv64) )  && ( p10$2 ==> BV64_ULE($c5.0$2, 0bv64) ) ,  ( p10$1 ==> BV64_UGE($c5.0$1, 0bv64) )  && ( p10$2 ==> BV64_UGE($c5.0$2, 0bv64) ) ,  ( p10$1 ==> p10$1 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1bv64)) )  && ( p10$2 ==> p10$2 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c2.0$2), 1bv64)) ) ,  (  BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1bv64)) && BV64_SLE($c5.0$1, $0$1) ==> p10$1 )  && (  BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c2.0$2), 1bv64)) && BV64_SLE($c5.0$2, $0$2) ==> p10$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) ) ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c3.0$1, BV32_SEXT64($np)) ) ,  (  _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1bv64)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    $$private_sum$0bv32$1 := (if p13$1 then FADD64(v14$1, FMUL64(v12$1, v13$1)) else $$private_sum$0bv32$1);
    $$private_sum$0bv32$2 := (if p13$2 then FADD64(v14$2, FMUL64(v12$2, v13$2)) else $$private_sum$0bv32$2);
