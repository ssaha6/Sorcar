...
procedure {:source_name "kernel0"} {:kernel} $kernel0($np: bv32, $nq: bv32, $nr: bv32, $c0: bv64, $c1: bv64);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($np: bv32, $nq: bv32, $nr: bv32, $c0: bv64, $c1: bv64)
{
  var $c2.0$1: bv64;
  var $c2.0$2: bv64;
  var v0$1: bv64;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b5 ==> BV64_UGE($c2.0$1, BV64_MUL(32bv64, v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b5 ==> BV64_UGE($c2.0$2, BV64_MUL(32bv64, v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV64_ULE($c2.0$1, BV64_MUL(32bv64, v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV64_ULE($c2.0$2, BV64_MUL(32bv64, v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV64_SGE($c2.0$1, BV64_MUL(32bv64, v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV64_SGE($c2.0$2, BV64_MUL(32bv64, v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV64_SLE($c2.0$1, BV64_MUL(32bv64, v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV64_SLE($c2.0$2, BV64_MUL(32bv64, v0$2));
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$sum(p3$1, BV64_ADD(v1$1, $c2.0$1)[32:0], 0bv64, $$sum[BV64_ADD(v1$1, $c2.0$1)[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$sum(p3$2, BV64_ADD(v1$2, $c2.0$2)[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$sum(p3$2, BV64_ADD(v1$2, $c2.0$2)[32:0], 0bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sum"} true;
    $$sum[BV64_ADD(v1$1, $c2.0$1)[32:0]] := (if p3$1 then 0bv64 else $$sum[BV64_ADD(v1$1, $c2.0$1)[32:0]]);
    $$sum[BV64_ADD(v1$2, $c2.0$2)[32:0]] := (if p3$2 then 0bv64 else $$sum[BV64_ADD(v1$2, $c2.0$2)[32:0]]);
