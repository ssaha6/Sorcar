...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16: bool;
  var _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16: bool;
  var _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.27: bool;
  var _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.57: bool;
  ...
  $for.cond:
    ...
    assert {:tag "accessBreak"} _b75 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b74 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b73 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b72 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "noread"} _b71 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b70 ==> _WRITE_HAS_OCCURRED_$$x1 ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _READ_HAS_OCCURRED_$$x1 ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "nowrite"} _b68 ==> !_WRITE_HAS_OCCURRED_$$x1;
    assert {:tag "noread"} _b67 ==> !_READ_HAS_OCCURRED_$$x1;
    assert {:tag "predicatedEquality"} _b66 ==> p0$1 && p0$2 ==> v17$1 == v17$2;
    ...
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v18$1 == v18$2;
    ...
    assert {:tag "predicatedEquality"} _b51 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> $cond69$1 == $cond69$2;
    ...
    _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16 := _READ_HAS_OCCURRED_$$kernel1.shared_A;
    _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16 := _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.16;

  $for.cond.16:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b100 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b99 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.16 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessBreak"} _b98 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b97 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b96 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b95 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "noread"} _b94 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "predicatedEquality"} _b93 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b92 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b91 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b90 ==> p4$1 && p4$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b89 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    ...
    assert {:tag "predicatedEquality"} _b85 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b84 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b83 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b82 ==> p4$1 && p4$2 ==> $cond69$1 == $cond69$2;
    assert {:tag "predicatedEquality"} _b81 ==> p4$1 && p4$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b80 ==> p4$1 && p4$2 ==> $cond$1 == $cond$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    ...
    _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.27 := _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $for.cond.27;

  $for.cond.27:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b102 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.27 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b101 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b42 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c1.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b39 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64)) && BV64_SLE($c2.0$1, $cond$1) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b39 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64)) && BV64_SLE($c2.0$2, $cond$2) ==> p8$2;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p8$1 ==> _b33 ==> BV64_SLE(0bv64, $cond$1);
    assert {:tag "guardNonNeg"} {:thread 2} p8$2 ==> _b33 ==> BV64_SLE(0bv64, $cond$2);
    ...
    $cond$1 := (if p9$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c0.0$1), 1bv64) else $cond$1);
    $cond$2 := (if p9$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c0.0$2), 1bv64) else $cond$2);
    $cond$1 := (if p10$1 then 31bv64 else $cond$1);
    $cond$2 := (if p10$2 then 31bv64 else $cond$2);
    v9$1 := (if p8$1 then BV64_SLE($c2.0$1, $cond$1) else v9$1);
    v9$2 := (if p8$2 then BV64_SLE($c2.0$2, $cond$2) else v9$2);
  ...
  __partitioned_block_$for.cond.27.tail_1:
    ...
    _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.57 := _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.57;

  $for.cond.57:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b105 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$for.cond.57 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessBreak"} _b104 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b103 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c1.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLE($c3.0$1, $cond69$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLE($c3.0$2, $cond69$2) ==> p14$2;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p14$1 ==> _b22 ==> BV64_SLE(0bv64, $cond69$1);
    assert {:tag "guardNonNeg"} {:thread 2} p14$2 ==> _b22 ==> BV64_SLE(0bv64, $cond69$2);
    ...
    $cond69$1 := (if p15$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$1), 1bv64) else $cond69$1);
    $cond69$2 := (if p15$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$2), 1bv64) else $cond69$2);
    $cond69$1 := (if p16$1 then 31bv64 else $cond69$1);
    $cond69$2 := (if p16$2 then 31bv64 else $cond69$2);
    v13$1 := (if p14$1 then BV64_SLE($c3.0$1, $cond69$1) else v13$1);
    v13$2 := (if p14$2 then BV64_SLE($c3.0$2, $cond69$2) else v13$2);
