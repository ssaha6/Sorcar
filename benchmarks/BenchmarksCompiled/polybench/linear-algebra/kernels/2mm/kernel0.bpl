...
implementation {:source_name "kernel0"} {:kernel} $kernel0($alpha: bv64, $nj: bv32, $nl: bv32, $nk: bv32, $ni: bv32)
{
  ...
  $1:
    ...
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> $1$1 == $1$2;
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b152 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$3 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b151 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$3 == _READ_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b145 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$tmp$ghost$$3 == _WRITE_HAS_OCCURRED_$$tmp;
    ...
    assert {:tag "predicatedEquality"} _b142 ==> p2$1 && p2$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b141 ==> p2$1 && p2$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b140 ==> p2$1 && p2$2 ==> v31$1 == v31$2;
    ...
    assert {:tag "predicatedEquality"} _b133 ==> p2$1 && p2$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b132 ==> p2$1 && p2$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b131 ==> p2$1 && p2$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b130 ==> p2$1 && p2$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b129 ==> p2$1 && p2$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b128 ==> p2$1 && p2$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b127 ==> p2$1 && p2$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b126 ==> p2$1 && p2$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b125 ==> p2$1 && p2$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b124 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b123 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b122 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b121 ==> p2$1 && p2$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b120 ==> p2$1 && p2$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b119 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b118 ==> p2$1 && p2$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b117 ==> p2$1 && p2$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b116 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b115 ==> p2$1 && p2$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b114 ==> p2$1 && p2$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b113 ==> p2$1 && p2$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b112 ==> p2$1 && p2$2 ==> $0$1 == $0$2;
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b184 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$5 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b183 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$5 == _READ_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    assert {:tag "predicatedEquality"} _b177 ==> p4$1 && p4$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b176 ==> p4$1 && p4$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b175 ==> p4$1 && p4$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b174 ==> p4$1 && p4$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b173 ==> p4$1 && p4$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b172 ==> p4$1 && p4$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b171 ==> p4$1 && p4$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b170 ==> p4$1 && p4$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b169 ==> p4$1 && p4$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b168 ==> p4$1 && p4$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b167 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b166 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b165 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b164 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b163 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b162 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b161 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b160 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b159 ==> p4$1 && p4$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b158 ==> p4$1 && p4$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b157 ==> p4$1 && p4$2 ==> $0$1 == $0$2;
  ...
  $8:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b187 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$8 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b57 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SLT($c1.0$1, BV32_SEXT64($nj)) && BV64_SLT($c2.0$1, BV32_SEXT64($nk)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLE($c4.0$1, $0$1) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b57 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SLT($c1.0$2, BV32_SEXT64($nj)) && BV64_SLT($c2.0$2, BV32_SEXT64($nk)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLE($c4.0$2, $0$2) ==> p8$2;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p8$1 ==> _b51 ==> BV64_SLE(0bv64, $0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p8$2 ==> _b51 ==> BV64_SLE(0bv64, $0$2);
  ...
  $22:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b189 ==> !p15$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$22 == _READ_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p20$1 ==> _b37 ==> BV64_SLE(0bv64, $1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p20$2 ==> _b37 ==> BV64_SLE(0bv64, $1$2);
    ...
    $$private_tmp$0bv32$1 := (if p23$1 then FADD64(FMUL64(FMUL64($alpha, v18$1), v19$1), v20$1) else $$private_tmp$0bv32$1);
    $$private_tmp$0bv32$2 := (if p23$2 then FADD64(FMUL64(FMUL64($alpha, v18$2), v19$2), v20$2) else $$private_tmp$0bv32$2);
    ...
    $$private_tmp$1bv32$1 := (if p25$1 then FADD64(FMUL64(FMUL64($alpha, v22$1), v23$1), v24$1) else $$private_tmp$1bv32$1);
    $$private_tmp$1bv32$2 := (if p25$2 then FADD64(FMUL64(FMUL64($alpha, v22$2), v23$2), v24$2) else $$private_tmp$1bv32$2);
