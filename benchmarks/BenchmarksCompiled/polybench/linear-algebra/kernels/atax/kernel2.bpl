...
implementation {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $m: bv32)
{
  ...
  __partitioned_block_$5_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b79 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_tmp$ghost$__partitioned_block_$5_0 == _WRITE_HAS_OCCURRED_$$kernel2.shared_tmp;
    assert {:tag "disabledMaintainsInstrumentation"} _b78 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel2.shared_tmp$ghost$__partitioned_block_$5_0 == _READ_HAS_OCCURRED_$$kernel2.shared_tmp;
  ...
  $10:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b81 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel2.shared_tmp$ghost$$10 == _READ_HAS_OCCURRED_$$kernel2.shared_tmp;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($m)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLE($c3.0$1, $0$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($m)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLE($c3.0$2, $0$2) ==> p10$2;
