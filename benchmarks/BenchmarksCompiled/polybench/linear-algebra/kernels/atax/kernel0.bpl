...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $m: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22: bool;
  var _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22: bool;
  var _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.32: bool;
  var _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.65: bool;
  ...
  $for.cond:
    ...
    assert {:tag "accessBreak"} _b74 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b73 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b72 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b71 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "noread"} _b70 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _WRITE_HAS_OCCURRED_$$tmp ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "nowrite"} _b68 ==> !_WRITE_HAS_OCCURRED_$$tmp;
    assert {:tag "predicatedEquality"} _b67 ==> p0$1 && p0$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b66 ==> p0$1 && p0$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b65 ==> p0$1 && p0$2 ==> v15$1 == v15$2;
    ...
    assert {:tag "predicatedEquality"} _b56 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    ...
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> $cond77$1 == $cond77$2;
    ...
    _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22 := _READ_HAS_OCCURRED_$$kernel0.shared_A;
    _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22 := _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.22;

  $for.cond.22:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b100 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b99 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.22 == _READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessBreak"} _b98 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b97 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b96 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "nowrite"} _b95 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "noread"} _b94 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    assert {:tag "predicatedEquality"} _b89 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b88 ==> p2$1 && p2$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b87 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b86 ==> p2$1 && p2$2 ==> v5$1 == v5$2;
    ...
    assert {:tag "predicatedEquality"} _b81 ==> p2$1 && p2$2 ==> $cond77$1 == $cond77$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b18 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b18 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p2$2;
    ...
    _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.32 := _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assume {:captureState "loop_entry_state_3_0"} true;
    goto $for.cond.32;

  $for.cond.32:
    assume {:captureState "loop_head_state_3"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b102 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.32 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b101 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv64[32:0], 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv64[32:0], 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c1.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b39 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64)) && BV64_SLE($c2.0$1, $cond$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b39 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64)) && BV64_SLE($c2.0$2, $cond$2) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b38 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b38 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64));
    ...
    $cond$1 := (if p7$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($m), $c0.0$1), 1bv64) else $cond$1);
    $cond$2 := (if p7$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($m), $c0.0$2), 1bv64) else $cond$2);
  ...
  __partitioned_block_$for.cond.32.tail_0:
    assume !p6$1 && !p6$2;
    goto __partitioned_block_$for.cond.32.tail_1;

  __partitioned_block_$for.cond.32.tail_1:
    ...
    _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.65 := _READ_HAS_OCCURRED_$$kernel0.shared_A;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.65;

  $for.cond.65:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b105 ==> !p11$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A$ghost$$for.cond.65 == _READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessBreak"} _b104 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b103 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), BV32_ADD(0bv64[32:0], BV32_MUL(local_id_x$1, 32bv32)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c1.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64)) && BV64_SLE($c3.0$1, $cond77$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64)) && BV64_SLE($c3.0$2, $cond77$2) ==> p14$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p14$1 ==> _b27 ==> p14$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1bv64));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p14$2 ==> _b27 ==> p14$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1bv64));
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p14$1 ==> _b22 ==> BV64_SLE(0bv64, $cond77$1);
    assert {:tag "guardNonNeg"} {:thread 2} p14$2 ==> _b22 ==> BV64_SLE(0bv64, $cond77$2);
    ...
    $cond77$1 := (if p15$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$1), 1bv64) else $cond77$1);
    $cond77$2 := (if p15$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c1.0$2), 1bv64) else $cond77$2);
    $cond77$1 := (if p16$1 then 31bv64 else $cond77$1);
    $cond77$2 := (if p16$2 then 31bv64 else $cond77$2);
    v12$1 := (if p14$1 then BV64_SLE($c3.0$1, $cond77$1) else v12$1);
    v12$2 := (if p14$2 then BV64_SLE($c3.0$2, $cond77$2) else v12$2);
  ...
  __partitioned_block_$for.cond.65.tail_1:
    ...
    goto $for.cond.22.backedge, __partitioned_block_$for.cond.22.tail_0;

  __partitioned_block_$for.cond.22.tail_0:
    assume !p2$1 && !p2$2;
    ...
    goto __partitioned_block_$for.cond.22.tail_1;

  __partitioned_block_$for.cond.22.tail_1:
    ...
    goto __partitioned_block_$for.cond.22.tail_2;

  __partitioned_block_$for.cond.22.tail_2:
    ...
    goto __partitioned_block_$for.cond.22.tail_3;

  __partitioned_block_$for.cond.22.tail_3:
