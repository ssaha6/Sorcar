...
procedure {:source_name "kernel7"} {:kernel} $kernel7($n: bv32, $c0: bv64);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _READ_HAS_OCCURRED_$$y ==> BV64_ADD(BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)), $c0) == 0bv64 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel7"} {:kernel} $kernel7($n: bv32, $c0: bv64)
{
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$w(true, 0bv32, v0$1, $$w[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$w(true, 0bv32, v0$2);
