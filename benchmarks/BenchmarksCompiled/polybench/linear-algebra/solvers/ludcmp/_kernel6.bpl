...
procedure {:source_name "kernel6"} {:kernel} $kernel6($n: bv32, $c0: bv64);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$y ==> $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel6"} {:kernel} $kernel6($n: bv32, $c0: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
