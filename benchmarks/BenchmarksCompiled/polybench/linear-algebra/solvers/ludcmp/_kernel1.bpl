...
procedure {:source_name "kernel1"} {:kernel} $kernel1($n: bv32, $c0: bv64, $c1: bv64, $c2: bv64);
  requires {:sourceloc_num 0} {:thread 1} (if $n == 256bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:sourceloc_num 1} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($n), BV64_ADD($c0, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c0, BV64_ADD($c1, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c1, BV64_ADD($c2, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c2, 0bv64) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_OR(BV32_AND(BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c2 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n)) then 1bv1 else 0bv1))), BV32_AND(BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c2 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1)))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: bv32, $c0: bv64, $c1: bv64, $c2: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
  var v1$1: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_READ_$$w(true, 0bv32, $$w[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_READ_$$w(true, 0bv32, $$w[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$w"} true;
    v2$1 := $$w[0bv32];
    v2$2 := $$w[0bv32];
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$w(true, 0bv32, FSUB64(v2$1, FMUL64(v0$1, v1$1)), $$w[0bv32]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$w(true, 0bv32, FSUB64(v2$2, FMUL64(v0$2, v1$2)));
