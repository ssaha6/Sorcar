...
procedure {:source_name "kernel8"} {:kernel} $kernel8($n: bv32, $c0: bv64, $c1: bv64);
  requires {:sourceloc_num 0} {:thread 1} (if $n == 256bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:sourceloc_num 1} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV64_SLE($c0, 0bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV64_ADD($c0, $c1), 1bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($n), BV64_ADD($c1, 1bv64)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV1_ZEXT32((if BV64_ADD(BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n)), $c0) == 0bv64 then 1bv1 else 0bv1)), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$x ==> $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1) != 0bv1;
  ...
  modifies _READ_HAS_OCCURRED_$$w, _WRITE_HAS_OCCURRED_$$w, _WRITE_READ_BENIGN_FLAG_$$w, _WRITE_READ_BENIGN_FLAG_$$w;



implementation {:source_name "kernel8"} {:kernel} $kernel8($n: bv32, $c0: bv64, $c1: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
  var v1$1: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_READ_$$w(true, 0bv32, $$w[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 7} _CHECK_READ_$$w(true, 0bv32, $$w[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$w"} true;
    v2$1 := $$w[0bv32];
    v2$2 := $$w[0bv32];
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$w(true, 0bv32, FSUB64(v2$1, FMUL64(v0$1, v1$1)), $$w[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$w(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$w(true, 0bv32, FSUB64(v2$2, FMUL64(v0$2, v1$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$w"} true;
    $$w[0bv32] := FSUB64(v2$1, FMUL64(v0$1, v1$1));
    $$w[0bv32] := FSUB64(v2$2, FMUL64(v0$2, v1$2));
    return;
}
