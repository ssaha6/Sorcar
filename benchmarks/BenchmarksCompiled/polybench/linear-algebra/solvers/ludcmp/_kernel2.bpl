...
procedure {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $c0: bv64, $c1: bv64);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $c0: bv64, $c1: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
  var v1$1: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_READ_$$A(true, BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0], $$A[BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0]]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_READ_$$A(true, BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0], $$A[BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0]]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v1$1 := $$A[BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0]];
    v1$2 := $$A[BV64_ADD(BV64_MUL($c1, BV32_SEXT64($n)), $c1)[32:0]];
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$A(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], FDIV64(v0$1, v1$1), $$A[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$A(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], FDIV64(v0$2, v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]] := FDIV64(v0$1, v1$1);
    $$A[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]] := FDIV64(v0$2, v1$2);
    return;
}
