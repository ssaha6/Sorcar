...
assert  my_inv (  ( p2$1 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$1), $c0), 2097091bv64), 2097152bv64)))) )  && ( p2$2 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$2), $c0), 2097091bv64), 2097152bv64)))) ) ,  ( p2$1 ==> BV64_SLE(0bv64, $c1.0$1) )  && ( p2$2 ==> BV64_SLE(0bv64, $c1.0$2) ) ,  ( p2$1 ==> BV64_SLE($c1.0$1, BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$1), $c0), 2097091bv64), 2097152bv64)))) )  && ( p2$2 ==> BV64_SLE($c1.0$2, BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$2), $c0), 2097091bv64), 2097152bv64)))) ) ,  ( p2$1 ==> BV64_SGE($c1.0$1, BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$1), $c0), 2097091bv64), 2097152bv64)))) )  && ( p2$2 ==> BV64_SGE($c1.0$2, BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$2), $c0), 2097091bv64), 2097152bv64)))) ) ,  ( p2$1 ==> BV64_ULE($c1.0$1, BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$1), $c0), 2097091bv64), 2097152bv64)))) )  && ( p2$2 ==> BV64_ULE($c1.0$2, BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$2), $c0), 2097091bv64), 2097152bv64)))) ) ,  ( p2$1 ==> BV64_UGE($c1.0$1, BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$1), $c0), 2097091bv64), 2097152bv64)))) )  && ( p2$2 ==> BV64_UGE($c1.0$2, BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551552bv64, v0$2), $c0), 2097091bv64), 2097152bv64)))) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p2$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p2$2 ) ,  (  _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) ) ,  (  _READ_HAS_OCCURRED_$$kernel0.shared_A_1 ==> _WATCHED_OFFSET == 0bv32 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 15} _LOG_READ_$$kernel0.shared_A_1(p7$1, 0bv32, $$kernel0.shared_A_1[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 15} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 15} _CHECK_READ_$$kernel0.shared_A_1(p7$2, 0bv32, $$kernel0.shared_A_1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
