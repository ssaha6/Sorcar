...
implementation {:source_name "kernel4"} {:kernel} $kernel4($n: bv32, $c0: bv64)
{
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$sum(true, 0bv32, 0bv64, $$sum[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$sum(true, 0bv32, 0bv64);
