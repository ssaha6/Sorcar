...
procedure {:source_name "kernel3"} {:kernel} $kernel3($n: bv32);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$y ==> BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), (if BV32_SGE($n, 2bv32) then $n else 1bv32)) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$r ==> BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), (if BV32_SGE($n, 2bv32) then $n else 1bv32)) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: bv32)
{
  var v0$1: bv64;
  var v0$2: bv64;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$y(true, 0bv32, FSUB64(9223372036854775808bv64, v0$1), $$y[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$y(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$y(true, 0bv32, FSUB64(9223372036854775808bv64, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$y"} true;
    $$y[0bv32] := FSUB64(9223372036854775808bv64, v0$1);
    $$y[0bv32] := FSUB64(9223372036854775808bv64, v0$2);
    return;
}
