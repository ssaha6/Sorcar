...
procedure {:source_name "kernel5"} {:kernel} $kernel5($n: bv32);
...
implementation {:source_name "kernel5"} {:kernel} $kernel5($n: bv32)
{

  $0:
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$beta(true, 0bv32, 4607182418800017408bv64, $$beta[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$beta(true, 0bv32, 4607182418800017408bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$beta"} true;
    $$beta[0bv32] := 4607182418800017408bv64;
    $$beta[0bv32] := 4607182418800017408bv64;
    return;
}
