...
procedure {:source_name "kernel7"} {:kernel} $kernel7($n: bv32, $c0: bv64);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _READ_HAS_OCCURRED_$$r ==> $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), (if BV32_SGE($n, 2bv32) then $n else 1bv32))) then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel7"} {:kernel} $kernel7($n: bv32, $c0: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
  var v1$1: bv64;
  ...
  $0:
    ...
    havoc v1$1, v1$2;
    havoc v2$1, v2$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$alpha(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, FADD64(v0$1, v1$1)), v2$1), $$alpha[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$alpha(true, 0bv32, FDIV64(FSUB64(9223372036854775808bv64, FADD64(v0$2, v1$2)), v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$alpha"} true;
    $$alpha[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, FADD64(v0$1, v1$1)), v2$1);
    $$alpha[0bv32] := FDIV64(FSUB64(9223372036854775808bv64, FADD64(v0$2, v1$2)), v2$2);
    return;
}
