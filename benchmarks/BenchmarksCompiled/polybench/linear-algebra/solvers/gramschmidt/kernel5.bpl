...
implementation {:source_name "kernel5"} {:kernel} $kernel5($n: bv32, $m: bv32)
{
  ...
  var p14$1: bool;
  var p14$2: bool;
  var _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.27: bool;
  var _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.82: bool;
  ...
  $for.cond:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _WRITE_HAS_OCCURRED_$$R ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) ==> p0$2;
    ...
    _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.27 := _WRITE_HAS_OCCURRED_$$R;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.27;

  $for.cond.27:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.27 == _WRITE_HAS_OCCURRED_$$R;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$R ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assume {:predicate "p2"} {:dominator_predicate "p1"} true;
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b14 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$1, BV32_SEXT64($n)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b14 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$2, BV32_SEXT64($n)) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b13 ==> p2$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b13 ==> p2$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b12 ==> BV64_UGE($c2.0$1, BV64_ADD(BV64_MUL(32bv64, v1$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$1), $c1.0$1), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b12 ==> BV64_UGE($c2.0$2, BV64_ADD(BV64_MUL(32bv64, v1$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$2), $c1.0$2), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b11 ==> BV64_ULE($c2.0$1, BV64_ADD(BV64_MUL(32bv64, v1$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$1), $c1.0$1), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b11 ==> BV64_ULE($c2.0$2, BV64_ADD(BV64_MUL(32bv64, v1$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$2), $c1.0$2), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b10 ==> BV64_SGE($c2.0$1, BV64_ADD(BV64_MUL(32bv64, v1$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$1), $c1.0$1), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b10 ==> BV64_SGE($c2.0$2, BV64_ADD(BV64_MUL(32bv64, v1$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$2), $c1.0$2), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b9 ==> BV64_SLE($c2.0$1, BV64_ADD(BV64_MUL(32bv64, v1$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$1), $c1.0$1), 8161bv64), 8192bv64))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b9 ==> BV64_SLE($c2.0$2, BV64_ADD(BV64_MUL(32bv64, v1$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$2), $c1.0$2), 8161bv64), 8192bv64))));
    assert {:tag "guardNonNeg"} {:thread 1} p2$1 ==> _b8 ==> BV64_SLE(0bv64, $c2.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p2$2 ==> _b8 ==> BV64_SLE(0bv64, $c2.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b7 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c2.0$1) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_ADD(BV64_MUL(32bv64, v1$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$1), $c1.0$1), 8161bv64), 8192bv64))));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b7 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c2.0$2) == BV64_AND(BV64_SUB(8192bv64, 1bv64), BV64_ADD(BV64_MUL(32bv64, v1$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551584bv64, v1$2), $c1.0$2), 8161bv64), 8192bv64))));
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$R ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0bv64) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 8191bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n), 0bv32) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n), 1bv32)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE($n, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 1bv32)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 8192bv32)), BV64_MUL(32bv64, BV32_ZEXT64(group_id_y$1))) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_y$1)), 31bv64), BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 8192bv32))) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n))), 8192bv64) == 0bv64 then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_y$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n))), 16bv64) == 0bv64 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    ...
    $cond$1 := (if p4$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(v2$1, v3$1), $c1.0$1), $c2.0$1), 16bv64) else $cond$1);
    $cond$2 := (if p4$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(v2$2, v3$2), $c1.0$2), $c2.0$2), 16bv64) else $cond$2);
    $cond$1 := (if p5$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(v2$1, v3$1), $c1.0$1), $c2.0$1)), 16bv64), 1bv64), 16bv64)) else $cond$1);
    $cond$2 := (if p5$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(v2$2, v3$2), $c1.0$2), $c2.0$2)), 16bv64), 1bv64), 16bv64)) else $cond$2);
    ...
    $cond81$1 := (if p6$1 then v3$1 else $cond81$1);
    $cond81$2 := (if p6$2 then v3$2 else $cond81$2);
    ...
    $cond76$1 := (if p8$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(v2$1, v3$1), $c1.0$1), $c2.0$1), 16bv64) else $cond76$1);
    $cond76$2 := (if p8$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(v2$2, v3$2), $c1.0$2), $c2.0$2), 16bv64) else $cond76$2);
    $cond76$1 := (if p9$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(v2$1, v3$1), $c1.0$1), $c2.0$1)), 16bv64), 1bv64), 16bv64)) else $cond76$1);
    $cond76$2 := (if p9$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(v2$2, v3$2), $c1.0$2), $c2.0$2)), 16bv64), 1bv64), 16bv64)) else $cond76$2);
    $cond81$1 := (if p7$1 then BV64_ADD(BV64_ADD(v3$1, BV64_MUL(16bv64, $cond76$1)), 16bv64) else $cond81$1);
    $cond81$2 := (if p7$2 then BV64_ADD(BV64_ADD(v3$2, BV64_MUL(16bv64, $cond76$2)), 16bv64) else $cond81$2);
    $c4.0$1 := (if p3$1 then $cond81$1 else $c4.0$1);
    $c4.0$2 := (if p3$2 then $cond81$2 else $c4.0$2);
    p10$1 := (if p3$1 then true else p10$1);
    p10$2 := (if p3$2 then true else p10$2);
    _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.82 := _WRITE_HAS_OCCURRED_$$R;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.82;

  $for.cond.82:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$R$ghost$$for.cond.82 == _WRITE_HAS_OCCURRED_$$R;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b30 ==> _WRITE_HAS_OCCURRED_$$R ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assume {:predicate "p10"} {:dominator_predicate "p3"} true;
    assert p10$1 ==> p2$1;
    assert p10$2 ==> p2$2;
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c2.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b24 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$1, BV32_SEXT64($n)) && BV64_SLE($c4.0$1, $cond94$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b24 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$2, BV32_SEXT64($n)) && BV64_SLE($c4.0$2, $cond94$2) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b23 ==> p10$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$1, BV32_SEXT64($n));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b23 ==> p10$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1bv32))) && BV64_SLT($c2.0$2, BV32_SEXT64($n));
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b22 ==> BV64_UGE($c4.0$1, $cond81$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b22 ==> BV64_UGE($c4.0$2, $cond81$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b21 ==> BV64_ULE($c4.0$1, $cond81$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b21 ==> BV64_ULE($c4.0$2, $cond81$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b20 ==> BV64_SGE($c4.0$1, $cond81$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b20 ==> BV64_SGE($c4.0$2, $cond81$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b19 ==> BV64_SLE($c4.0$1, $cond81$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b19 ==> BV64_SLE($c4.0$2, $cond81$2);
    assert {:tag "guardNonNeg"} {:thread 1} p10$1 ==> _b18 ==> BV64_SLE(0bv64, $cond94$1);
    assert {:tag "guardNonNeg"} {:thread 2} p10$2 ==> _b18 ==> BV64_SLE(0bv64, $cond94$2);
    assert {:tag "guardNonNeg"} {:thread 1} p10$1 ==> _b17 ==> BV64_SLE(0bv64, $c4.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p10$2 ==> _b17 ==> BV64_SLE(0bv64, $c4.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p10$1 ==> _b16 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c4.0$1) == BV64_AND(BV64_SUB(16bv64, 1bv64), $cond81$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p10$2 ==> _b16 ==> BV64_AND(BV64_SUB(16bv64, 1bv64), $c4.0$2) == BV64_AND(BV64_SUB(16bv64, 1bv64), $cond81$2);
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$R ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0bv64) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 8191bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n), 0bv32) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n), 1bv32)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_UGE($n, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 1bv32)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 8192bv32)), BV64_MUL(32bv64, BV32_ZEXT64(group_id_y$1))) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_y$1)), 31bv64), BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), 8192bv32))) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32bv64, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $n))), 8192bv64) == 0bv64 then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_y$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n))), 16bv64) == 0bv64 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    ...
    $cond94$1 := (if p11$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c2.0$1), 1bv64) else $cond94$1);
    $cond94$2 := (if p11$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($n), $c2.0$2), 1bv64) else $cond94$2);
    $cond94$1 := (if p12$1 then 31bv64 else $cond94$1);
    $cond94$2 := (if p12$2 then 31bv64 else $cond94$2);
    v10$1 := (if p10$1 then BV64_SLE($c4.0$1, $cond94$1) else v10$1);
    v10$2 := (if p10$2 then BV64_SLE($c4.0$2, $cond94$2) else v10$2);
    ...
    goto $for.cond.82.backedge, $for.cond.82.tail;
