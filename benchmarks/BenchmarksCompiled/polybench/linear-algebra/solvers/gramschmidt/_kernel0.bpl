...
procedure {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $m: bv32, $c0: bv64, $c1: bv64);
  ...
  requires {:sourceloc_num 2} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_SLE($m, 2147483647bv32) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64(BV32_MUL(5bv32, $n)), BV64_ADD($c0, 4bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c0, 1bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($m), BV64_ADD($c1, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c1, 0bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SREM(BV64_SUB($c0, 1bv64), 5bv64) == 0bv64 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_ADD(BV32_MUL(5bv32, BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)), 1bv32)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $m)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $m: bv32, $c0: bv64, $c1: bv64)
{
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_READ_$$nrm(true, 0bv32, $$nrm[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 7} _CHECK_READ_$$nrm(true, 0bv32, $$nrm[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$nrm"} true;
    v2$1 := $$nrm[0bv32];
    v2$2 := $$nrm[0bv32];
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$nrm(true, 0bv32, FADD64(v2$1, FMUL64(v0$1, v1$1)), $$nrm[0bv32]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$nrm(true, 0bv32, FADD64(v2$2, FMUL64(v0$2, v1$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$nrm"} true;
    $$nrm[0bv32] := FADD64(v2$1, FMUL64(v0$1, v1$1));
    $$nrm[0bv32] := FADD64(v2$2, FMUL64(v0$2, v1$2));
    return;
}
