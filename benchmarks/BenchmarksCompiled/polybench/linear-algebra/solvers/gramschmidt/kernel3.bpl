...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: bv32, $m: bv32, $c0: bv64)
{
  ...
  var _READ_HAS_OCCURRED_$$A$ghost$$for.cond.169: bool;
  var _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.169: bool;
  var _READ_HAS_OCCURRED_$$A$ghost$$for.cond.174: bool;
  var _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.174: bool;
  ...
  $if.then:
    ...
    $cond$1 := (if p0$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$1)), $c0), 64bv64)), 16384bv64), 1bv64), 16384bv64)) else $cond$1);
    $cond$2 := (if p0$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$2)), $c0), 64bv64)), 16384bv64), 1bv64), 16384bv64)) else $cond$2);
    $cond$1 := (if p1$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$1)), $c0), 64bv64), 16384bv64) else $cond$1);
    $cond$2 := (if p1$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$2)), $c0), 64bv64), 16384bv64) else $cond$2);
    v9$1 := BV64_SGT(BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(8192bv64, $cond$1)), 8192bv64), BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551520bv64, v0$1), $c0), 24480bv64), 24576bv64))));
    v9$2 := BV64_SGT(BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(8192bv64, $cond$2)), 8192bv64), BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551520bv64, v0$2), $c0), 24480bv64), 24576bv64))));
    ...
    $cond126$1 := (if p3$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$1)), $c0), 64bv64)), 16384bv64), 1bv64), 16384bv64)) else $cond126$1);
    $cond126$2 := (if p3$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$2)), $c0), 64bv64)), 16384bv64), 1bv64), 16384bv64)) else $cond126$2);
    $cond126$1 := (if p4$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$1)), $c0), 64bv64), 16384bv64) else $cond126$1);
    $cond126$2 := (if p4$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(64bv64, v0$2)), $c0), 64bv64), 16384bv64) else $cond126$2);
    $cond139$1 := (if p2$1 then BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(8192bv64, $cond126$1)), 8192bv64) else $cond139$1);
    $cond139$2 := (if p2$2 then BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(8192bv64, $cond126$2)), 8192bv64) else $cond139$2);
    $cond139$1 := (if p5$1 then BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551520bv64, v0$1), $c0), 24480bv64), 24576bv64))) else $cond139$1);
    $cond139$2 := (if p5$2 then BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(8192bv64, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(18446744073709551520bv64, v0$2), $c0), 24480bv64), 24576bv64))) else $cond139$2);
    $c1.0$1 := $cond139$1;
    $c1.0$2 := $cond139$2;
    p6$1 := true;
    p6$2 := true;
  ...
  $for.cond:
    ...
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b5 ==> BV64_UGE($c1.0$1, $cond139$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b5 ==> BV64_UGE($c1.0$2, $cond139$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b4 ==> BV64_ULE($c1.0$1, $cond139$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b4 ==> BV64_ULE($c1.0$2, $cond139$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b3 ==> BV64_SGE($c1.0$1, $cond139$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b3 ==> BV64_SGE($c1.0$2, $cond139$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b2 ==> BV64_SLE($c1.0$1, $cond139$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b2 ==> BV64_SLE($c1.0$2, $cond139$2);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b0 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(8192bv64, 1bv64), $cond139$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b0 ==> BV64_AND(BV64_SUB(8192bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(8192bv64, 1bv64), $cond139$2);
    ...
    _READ_HAS_OCCURRED_$$A$ghost$$for.cond.169 := _READ_HAS_OCCURRED_$$A;
    _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.169 := _WRITE_HAS_OCCURRED_$$A;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $for.cond.169;

  $for.cond.169:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b47 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.169 == _WRITE_HAS_OCCURRED_$$A;
    assert {:tag "disabledMaintainsInstrumentation"} _b46 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$A$ghost$$for.cond.169 == _READ_HAS_OCCURRED_$$A;
    ...
    _READ_HAS_OCCURRED_$$A$ghost$$for.cond.174 := _READ_HAS_OCCURRED_$$A;
    _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.174 := _WRITE_HAS_OCCURRED_$$A;
    assume {:captureState "loop_entry_state_2_0"} true;
    goto $for.cond.174;

  $for.cond.174:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b51 ==> !p15$1 ==> _WRITE_HAS_OCCURRED_$$A$ghost$$for.cond.174 == _WRITE_HAS_OCCURRED_$$A;
    assert {:tag "disabledMaintainsInstrumentation"} _b50 ==> !p15$1 ==> _READ_HAS_OCCURRED_$$A$ghost$$for.cond.174 == _READ_HAS_OCCURRED_$$A;
    ...
    assert {:tag "guardNonNeg"} {:thread 1} p16$1 ==> _b25 ==> BV64_SLE(0bv64, $cond186$1);
    assert {:tag "guardNonNeg"} {:thread 2} p16$2 ==> _b25 ==> BV64_SLE(0bv64, $cond186$2);
    ...
    $cond186$1 := (if p17$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($m), $c2.0$1), 1bv64) else $cond186$1);
    $cond186$2 := (if p17$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($m), $c2.0$2), 1bv64) else $cond186$2);
    $cond186$1 := (if p18$1 then 31bv64 else $cond186$1);
    $cond186$2 := (if p18$2 then 31bv64 else $cond186$2);
    v17$1 := (if p16$1 then BV64_SLE($c4.0$1, $cond186$1) else v17$1);
    v17$2 := (if p16$2 then BV64_SLE($c4.0$2, $cond186$2) else v17$2);
    ...
    goto $for.cond.174.backedge, $for.cond.174.tail;
  ...
  $for.cond.174.tail:
    ...
    goto $for.cond.169.backedge, $for.cond.169.tail;
  ...
  $for.cond.169.backedge:
    assume {:backedge} p14$1 || p14$2;
    assume {:captureState "loop_back_edge_state_1_0"} true;
    goto $for.cond.169;

  $for.cond.174.backedge:
