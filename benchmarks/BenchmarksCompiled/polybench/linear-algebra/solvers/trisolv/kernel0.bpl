...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $c0: bv64)
{
  ...
  $entry:
    ...
    $cond$1 := (if p0$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$1)), $c0), 32bv64)), 1048576bv64), 1bv64), 1048576bv64)) else $cond$1);
    $cond$2 := (if p0$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$2)), $c0), 32bv64)), 1048576bv64), 1bv64), 1048576bv64)) else $cond$2);
    $cond$1 := (if p1$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$1)), $c0), 32bv64), 1048576bv64) else $cond$1);
    $cond$2 := (if p1$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$2)), $c0), 32bv64), 1048576bv64) else $cond$2);
    ...
    $cond80$1 := (if p2$1 then BV64_MUL(32bv64, v0$1) else $cond80$1);
    $cond80$2 := (if p2$2 then BV64_MUL(32bv64, v0$2) else $cond80$2);
    ...
    $cond75$1 := (if p4$1 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$1)), $c0), 32bv64)), 1048576bv64), 1bv64), 1048576bv64)) else $cond75$1);
    $cond75$2 := (if p4$2 then BV64_SUB(0bv64, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0bv64, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$2)), $c0), 32bv64)), 1048576bv64), 1bv64), 1048576bv64)) else $cond75$2);
    $cond75$1 := (if p5$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$1)), $c0), 32bv64), 1048576bv64) else $cond75$1);
    $cond75$2 := (if p5$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0bv32, $n)), BV64_MUL(32bv64, v0$2)), $c0), 32bv64), 1048576bv64) else $cond75$2);
    $cond80$1 := (if p3$1 then BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$1), BV64_MUL(1048576bv64, $cond75$1)), 1048576bv64) else $cond80$1);
    $cond80$2 := (if p3$2 then BV64_ADD(BV64_ADD(BV64_MUL(32bv64, v0$2), BV64_MUL(1048576bv64, $cond75$2)), 1048576bv64) else $cond80$2);
    $c1.0$1 := $cond80$1;
    $c1.0$2 := $cond80$2;
    p6$1 := true;
    p6$2 := true;
  ...
  __partitioned_block_$for.cond_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b32 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_x_0 ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV64_ADD(BV64_SUB(0bv64, BV32_ZEXT64(local_id_x$1)), 31bv64)[32:0];
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b31 ==> _READ_HAS_OCCURRED_$$kernel0.shared_x_0 ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV64_ADD(BV64_SUB(0bv64, BV32_ZEXT64(local_id_x$1)), 31bv64)[32:0];
    assert {:tag "nowrite"} _b30 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_x_0;
    assert {:tag "noread"} _b29 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_x_0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$x ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _READ_HAS_OCCURRED_$$x ==> BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]) || BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1bv64[32:0], 1bv32), 0bv64[32:0]);
    assert {:tag "nowrite"} _b26 ==> !_WRITE_HAS_OCCURRED_$$x;
    assert {:tag "noread"} _b25 ==> !_READ_HAS_OCCURRED_$$x;
    assert {:tag "predicatedEquality"} _b24 ==> p6$1 && p6$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b23 ==> p6$1 && p6$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b22 ==> p6$1 && p6$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b21 ==> p6$1 && p6$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b20 ==> p6$1 && p6$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b19 ==> p6$1 && p6$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b18 ==> p6$1 && p6$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b17 ==> p6$1 && p6$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b16 ==> p6$1 && p6$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b15 ==> p6$1 && p6$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b14 ==> p6$1 && p6$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b13 ==> p6$1 && p6$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b12 ==> p6$1 && p6$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b11 ==> p6$1 && p6$2 ==> $c1.0$1 == $c1.0$2;
    assert {:tag "loopPredicateEquality"} _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p6$1 == p6$2;
    assert {:tag "loopPredicateEquality"} _b9 ==> p6$1 == p6$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b8 ==> BV64_SLT($c1.0$1, BV64_SDIV($c0, 2bv64)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b8 ==> BV64_SLT($c1.0$2, BV64_SDIV($c0, 2bv64)) ==> p6$2;
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b7 ==> BV64_UGE($c1.0$1, $cond80$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b7 ==> BV64_UGE($c1.0$2, $cond80$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b6 ==> BV64_ULE($c1.0$1, $cond80$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b6 ==> BV64_ULE($c1.0$2, $cond80$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b5 ==> BV64_SGE($c1.0$1, $cond80$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b5 ==> BV64_SGE($c1.0$2, $cond80$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b4 ==> BV64_SLE($c1.0$1, $cond80$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b4 ==> BV64_SLE($c1.0$2, $cond80$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p6$1 ==> _b3 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c1.0$1, $cond80$1) == BV64_SUB($c1.0$2, $cond80$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p6$2 ==> _b3 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV64_SUB($c1.0$2, $cond80$2) == BV64_SUB($c1.0$1, $cond80$1);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p6$1 ==> _b2 ==> BV64_SUB($c1.0$1, $cond80$1) == BV64_SUB($c1.0$2, $cond80$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p6$2 ==> _b2 ==> BV64_SUB($c1.0$2, $cond80$2) == BV64_SUB($c1.0$1, $cond80$1);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b0 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$1) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $cond80$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b0 ==> BV64_AND(BV64_SUB(1048576bv64, 1bv64), $c1.0$2) == BV64_AND(BV64_SUB(1048576bv64, 1bv64), $cond80$2);
