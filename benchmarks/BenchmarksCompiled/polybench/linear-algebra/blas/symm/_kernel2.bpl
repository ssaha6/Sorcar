...
procedure {:source_name "kernel2"} {:kernel} $kernel2($alpha: bv64, $beta: bv64, $n: bv32, $m: bv32, $c0: bv64, $c1: bv64);
  ...
  requires {:sourceloc_num 2} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_SLE($m, 2147483647bv32) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($m), BV64_ADD($c0, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c0, 0bv64) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($n), BV64_ADD($c1, 1bv64)) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV64_SGE($c1, 0bv64) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$C ==> BV32_AND(BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $m)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 4} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV1_ZEXT32((if BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $m) == BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $m), $m) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $m), $m)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 5} {:thread 1} (if _READ_HAS_OCCURRED_$$C ==> BV32_AND(BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $m)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 6} {:thread 1} (if _READ_HAS_OCCURRED_$$B ==> BV32_AND(BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n), $m)) then 1bv1 else 0bv1)), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8bv32, _WATCHED_OFFSET), 8bv32), $n)) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($alpha: bv64, $beta: bv64, $n: bv32, $m: bv32, $c0: bv64, $c1: bv64)
{
  var v0$1: bv64;
  var v0$2: bv64;
  var v1$1: bv64;
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 8} _LOG_READ_$$C(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_READ_$$C(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$C"} true;
    v0$1 := $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]];
    v0$2 := $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]];
    havoc v1$1, v1$2;
    havoc v2$1, v2$2;
    havoc v3$1, v3$2;
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$C(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], FADD64(FMUL64($alpha, v3$1), FADD64(FMUL64($beta, v0$1), FMUL64(FMUL64($alpha, v1$1), v2$1))), $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$C(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$C(true, BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0], FADD64(FMUL64($alpha, v3$2), FADD64(FMUL64($beta, v0$2), FMUL64(FMUL64($alpha, v1$2), v2$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$C"} true;
    $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]] := FADD64(FMUL64($alpha, v3$1), FADD64(FMUL64($beta, v0$1), FMUL64(FMUL64($alpha, v1$1), v2$1)));
    $$C[BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1)[32:0]] := FADD64(FMUL64($alpha, v3$2), FADD64(FMUL64($beta, v0$2), FMUL64(FMUL64($alpha, v1$2), v2$2)));
    return;
}
...
const _WATCHED_VALUE_$$temp2: bv64;

procedure {:inline 1} _LOG_READ_$$temp2(_P: bool, _offset: bv32, _value: bv64);
  modifies _READ_HAS_OCCURRED_$$temp2;



implementation {:inline 1} _LOG_READ_$$temp2(_P: bool, _offset: bv32, _value: bv64)
{
...
procedure _CHECK_READ_$$temp2(_P: bool, _offset: bv32, _value: bv64);
...
procedure {:inline 1} _LOG_WRITE_$$temp2(_P: bool, _offset: bv32, _value: bv64, _value_old: bv64);
  modifies _WRITE_HAS_OCCURRED_$$temp2, _WRITE_READ_BENIGN_FLAG_$$temp2;



implementation {:inline 1} _LOG_WRITE_$$temp2(_P: bool, _offset: bv32, _value: bv64, _value_old: bv64)
{
...
procedure _CHECK_WRITE_$$temp2(_P: bool, _offset: bv32, _value: bv64);
...
procedure {:inline 1} _LOG_ATOMIC_$$temp2(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$temp2;



implementation {:inline 1} _LOG_ATOMIC_$$temp2(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$temp2(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$temp2(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$temp2;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$temp2(_P: bool, _offset: bv32)
{
