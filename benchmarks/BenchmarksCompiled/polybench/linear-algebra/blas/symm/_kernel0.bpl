...
procedure {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $m: bv32, $c0: bv64, $c1: bv64);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $m: bv32, $c0: bv64, $c1: bv64)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$temp2(true, 0bv32, 0bv64, $$temp2[0bv32]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$temp2(true, 0bv32, 0bv64);
