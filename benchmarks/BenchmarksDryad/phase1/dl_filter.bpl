...
invariant b0140 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0141 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0142 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0143 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0144 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0145 ==> ((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0146 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0147 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0148 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0149 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0150 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0151 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0152 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0153 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0154 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0155 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant b0156 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0157 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0158 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0159 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0160 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0161 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0162 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant b0163 ==> ((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0164 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0165 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0166 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0167 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0168 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0169 ==> (($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0170 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0171 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0172 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0173 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0174 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0175 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0176 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0177 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0178 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0179 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#res,^d_node))));
invariant b0180 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0181 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0182 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0183 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0184 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0185 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0186 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#x,^d_node))));
invariant b0187 ==> (($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
