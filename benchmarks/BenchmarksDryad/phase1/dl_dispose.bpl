...
invariant b0064 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0065 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0066 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0067 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0068 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0069 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0070 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0071 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0072 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0073 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0074 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0075 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0076 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0077 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0078 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))));
invariant b0079 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0080 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))));
invariant b0081 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0082 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0083 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0084 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0085 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0086 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0087 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0088 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))));
invariant b0089 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0090 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0091 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))));
invariant b0092 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0093 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))));
invariant b0094 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))));
invariant b0095 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0096 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0097 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))));
invariant b0098 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))));
invariant b0099 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))));
...
invariant b0140 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0141 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0142 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0143 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0144 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0145 ==> ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0146 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0147 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0148 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0149 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0150 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0151 ==> ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0152 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0153 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0154 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0155 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))))));
invariant b0156 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0157 ==> ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0158 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0159 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0160 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0161 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant b0162 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))))));
invariant b0163 ==> ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))))));
invariant b0164 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0165 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0166 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0167 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0168 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0169 ==> (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0170 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0171 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0172 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0173 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0174 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0175 ==> (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0176 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0177 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0178 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0179 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0180 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0181 ==> (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0182 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0183 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0184 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0185 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0186 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0187 ==> (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node))));
