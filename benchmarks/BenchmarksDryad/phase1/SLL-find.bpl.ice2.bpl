...
invariant (p0140 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0141 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0142 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0143 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0144 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0145 == ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0146 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0147 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0148 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0149 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0150 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0151 == ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0152 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0153 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0154 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0155 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#t,^s_node)))))));
invariant (p0156 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0157 == ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0158 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0159 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0160 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0161 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))))));
invariant (p0162 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))))));
invariant (p0163 == ((!($oset_in($phys_ptr_cast(L#t,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))))));
invariant (p0164 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0165 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0166 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
invariant (p0167 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0168 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
invariant (p0169 == (($is_null($phys_ptr_cast(P#h,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0170 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0171 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0172 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0173 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0174 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0175 == (($is_null($phys_ptr_cast(L#i,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0176 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
invariant (p0177 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0178 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0179 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(L#t,^s_node)))));
invariant (p0180 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0181 == (($is_null($phys_ptr_cast(L#j,^s_node)) ==> ($phys_ptr_cast(L#t,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
invariant (p0182 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
invariant (p0183 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(P#h,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0184 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0185 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(L#i,^s_node) == $phys_ptr_cast(L#j,^s_node)))));
invariant (p0186 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(P#h,^s_node)))));
invariant (p0187 == (($is_null($phys_ptr_cast(L#t,^s_node)) ==> ($phys_ptr_cast(L#j,^s_node) == $phys_ptr_cast(L#i,^s_node)))));
