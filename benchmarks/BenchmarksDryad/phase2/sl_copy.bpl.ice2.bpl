...
invariant (p0063 == ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#cp,^s_node)))))));
invariant (p0064 == ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(L#curr,^s_node)))))));
invariant (p0065 == ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#cp,^s_node)))))));
invariant (p0066 == ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(P#lst,^s_node)))))));
invariant (p0067 == ((!($oset_in($phys_ptr_cast(L#cp,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))))));
invariant (p0068 == ((!($oset_in($phys_ptr_cast(L#cp,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))))));
invariant (p0069 == (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#cp,^s_node)))));
invariant (p0070 == (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#cp,^s_node) == $phys_ptr_cast(L#curr,^s_node)))));
invariant (p0071 == (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#cp,^s_node)))));
invariant (p0072 == (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#cp,^s_node) == $phys_ptr_cast(P#lst,^s_node)))));
invariant (p0073 == (($is_null($phys_ptr_cast(L#cp,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#curr,^s_node)))));
invariant (p0074 == (($is_null($phys_ptr_cast(L#cp,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#lst,^s_node)))));
invariant (p0075 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0076 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)))));
invariant (p0077 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0078 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)))));
invariant (p0079 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0080 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0081 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
invariant (p0082 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0083 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
invariant (p0084 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0085 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0086 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0087 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0088 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0089 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0090 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0091 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0092 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0093 == ((F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0094 == ((F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0095 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0096 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0097 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0098 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0099 == ((F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0100 == ((F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0101 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0102 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0103 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0104 == ((F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0105 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0106 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0107 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0108 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0109 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0110 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0111 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0112 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0113 == ((F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0114 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0115 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0116 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#47,$phys_ptr_cast(L#cp,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
...
invariant (p0118 == ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#cp,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node))))));
...
invariant (p0120 == ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#cp,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0121 == ((($non_null($phys_ptr_cast(L#cp,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0122 == ((($non_null($phys_ptr_cast(L#cp,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
...
invariant (p0124 == ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#cp,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node))))));
...
invariant (p0126 == ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#cp,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0127 == ((($non_null($phys_ptr_cast(L#cp,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0128 == ((($non_null($phys_ptr_cast(L#cp,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#cp,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
