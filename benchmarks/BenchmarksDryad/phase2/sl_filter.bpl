...
invariant b0140 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0141 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0142 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0143 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0144 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0145 ==> ((!($oset_in($phys_ptr_cast(P#x,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0146 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0147 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0148 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0149 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0150 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0151 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0152 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0153 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0154 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0155 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))))));
invariant b0156 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0157 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0158 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0159 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0160 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0161 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0162 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))))));
invariant b0163 ==> ((!($oset_in($phys_ptr_cast(L#res,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0164 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0165 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0166 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0167 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0168 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0169 ==> (($is_null($phys_ptr_cast(P#x,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0170 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0171 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0172 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0173 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0174 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0175 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0176 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0177 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0178 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0179 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#res,^s_node))));
invariant b0180 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0181 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#res,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0182 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0183 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0184 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0185 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0186 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0187 ==> (($is_null($phys_ptr_cast(L#res,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0188 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0189 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0190 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0191 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0192 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0193 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0194 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0195 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0196 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0197 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0198 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0199 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0200 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0201 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0202 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0203 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0204 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0205 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0206 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0207 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0208 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0209 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0210 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0211 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0212 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0213 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0214 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0215 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0216 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0217 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0218 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0219 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0220 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0221 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0222 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0223 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0224 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0225 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0226 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0227 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0228 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0229 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0230 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0231 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0232 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0233 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0234 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0235 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0236 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0237 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0238 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0239 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0240 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0241 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#res,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0242 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0243 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0244 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0245 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0246 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0247 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0248 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0249 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0250 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0251 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0252 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0253 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0254 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0255 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0256 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0257 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0258 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0259 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0260 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0261 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0262 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0263 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0264 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0265 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0266 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0267 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0268 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0269 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0270 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0271 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0272 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0273 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0274 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0275 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0276 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0277 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0278 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0279 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0280 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0281 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0282 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0283 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0284 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0285 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0286 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0287 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0288 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0289 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0290 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0291 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0292 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0293 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0294 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0295 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0296 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0297 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0298 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0299 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0300 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0301 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0302 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0303 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0304 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0305 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0306 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0307 ==> ((F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0308 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0309 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0310 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0311 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0312 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0313 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0314 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0315 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0316 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0317 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0318 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0319 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0320 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0321 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0322 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0323 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0324 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0325 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0326 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0327 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0328 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0329 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0330 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0331 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0332 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0333 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0334 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0335 ==> ((F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0336 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0337 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#res,^s_node)))));
invariant b0338 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0339 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0340 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0341 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0342 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0343 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#49,$phys_ptr_cast(L#res,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
