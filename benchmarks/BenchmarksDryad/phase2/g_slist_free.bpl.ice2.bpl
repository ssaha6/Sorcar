...
invariant (p0022 == ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))));
invariant (p0023 == ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
invariant (p0024 == ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))))));
invariant (p0025 == ((F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0026 == ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))))));
invariant (p0027 == ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0028 == ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node))))));
invariant (p0029 == ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0030 == ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node))))));
invariant (p0031 == ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
