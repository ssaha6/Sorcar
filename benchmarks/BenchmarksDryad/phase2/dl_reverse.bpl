...
invariant b0063 ==> ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
invariant b0064 ==> ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0065 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
invariant b0066 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
invariant b0067 ==> ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0068 ==> ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
invariant b0069 ==> (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#rev,^d_node))));
invariant b0070 ==> (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0071 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#rev,^d_node))));
invariant b0072 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
invariant b0073 ==> (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0074 ==> (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
