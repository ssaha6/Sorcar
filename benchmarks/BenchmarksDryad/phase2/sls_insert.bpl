...
invariant b0063 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0064 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node))))));
invariant b0065 ==> ((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0066 ==> ((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0067 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node))))));
invariant b0068 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
...
invariant b0093 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0094 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0095 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0096 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0097 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0098 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0099 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0100 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0101 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0102 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0103 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0104 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0105 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0106 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0107 ==> ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0108 ==> ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0109 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0110 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0111 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0112 ==> ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0113 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0114 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0115 ==> ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0116 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
...
invariant b0129 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0130 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0131 ==> (((F#srtl($s,$phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0132 ==> (((F#srtl($s,$phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0133 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0134 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0135 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0136 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0137 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0138 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0139 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0140 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0141 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0142 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0143 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0144 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0145 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0146 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0147 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0148 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0149 ==> (((F#srtl($s,$phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0150 ==> (((F#srtl($s,$phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#elt,^s_node)))));
invariant b0151 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0152 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0153 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)))));
invariant b0154 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0155 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0156 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0157 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0158 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)))));
invariant b0159 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)))));
invariant b0160 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0161 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0162 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#elt,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0163 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#elt,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#elt,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0164 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#elt,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)))));
