...
invariant (p0063 == ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)))))));
invariant (p0064 == ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)))))));
invariant (p0065 == ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)))))));
invariant (p0066 == ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)))))));
invariant (p0067 == ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))))));
invariant (p0068 == ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))))));
invariant (p0069 == (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#rev,^d_node)))));
invariant (p0070 == (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(L#curr,^d_node)))));
invariant (p0071 == (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#rev,^d_node)))));
invariant (p0072 == (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(P#lst,^d_node)))));
invariant (p0073 == (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node)))));
invariant (p0074 == (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node)))));
