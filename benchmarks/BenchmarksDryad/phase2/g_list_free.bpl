...
invariant b0022 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#x,^d_node))));
invariant b0023 ==> ((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0024 ==> ((F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)))));
invariant b0025 ==> ((F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0026 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)))));
invariant b0027 ==> ((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0028 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)))));
invariant b0029 ==> ((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0030 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)))));
invariant b0031 ==> ((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
