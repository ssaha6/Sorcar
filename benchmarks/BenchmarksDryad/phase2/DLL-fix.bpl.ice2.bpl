...
// INV:OLD: loopState#3
  ...
  anon29:
    ...
    loopState#3 := $s;
    assume true;
p0000 := (F#dll($s,$phys_ptr_cast(P#h,^d_node)));
p0001 := (F#dll($s,$phys_ptr_cast(L#i,^d_node)));
p0002 := (F#dll($s,$phys_ptr_cast(L#j,^d_node)));
p0003 := (F#sll($s,$phys_ptr_cast(P#h,^d_node)));
p0004 := (F#sll($s,$phys_ptr_cast(L#i,^d_node)));
p0005 := (F#sll($s,$phys_ptr_cast(L#j,^d_node)));
p0006 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node))));
p0007 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node))));
p0008 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node))));
p0009 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node))));
p0010 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node))));
p0011 := ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node))));

    while (true)

invariant (p0000 == (F#dll($s,$phys_ptr_cast(P#h,^d_node))));
invariant (p0001 == (F#dll($s,$phys_ptr_cast(L#i,^d_node))));
invariant (p0002 == (F#dll($s,$phys_ptr_cast(L#j,^d_node))));
invariant (p0003 == (F#sll($s,$phys_ptr_cast(P#h,^d_node))));
invariant (p0004 == (F#sll($s,$phys_ptr_cast(L#i,^d_node))));
invariant (p0005 == (F#sll($s,$phys_ptr_cast(L#j,^d_node))));
invariant (p0006 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node)))));
invariant (p0007 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node)))));
invariant (p0008 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node)))));
invariant (p0009 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node)))));
invariant (p0010 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node)))));
invariant (p0011 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node)))));
