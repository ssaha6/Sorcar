...
invariant b0022 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
invariant b0023 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
invariant b0024 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
invariant b0025 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
invariant b0026 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet));
invariant b0027 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet));
