...
p0140 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0141 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0142 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0143 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0144 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0145 := ((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0146 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0147 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0148 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0149 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0150 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0151 := ((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0152 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0153 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0154 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0155 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))))));
p0156 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0157 := ((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0158 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0159 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0160 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0161 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
p0162 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))))));
p0163 := ((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))))));
p0164 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0165 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0166 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node))));
p0167 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0168 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
p0169 := (($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0170 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0171 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0172 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0173 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0174 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0175 := (($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0176 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
p0177 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0178 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0179 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node))));
p0180 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0181 := (($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
p0182 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node))));
p0183 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0184 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0185 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node))));
p0186 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node))));
p0187 := (($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node))));
...
(F#dll($s,$phys_ptr_cast(L#prv,^d_node))), 
(F#dll($s,$phys_ptr_cast(local.a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
...
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
...
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))), 
($non_null($phys_ptr_cast(P#a,^d_node))), 
($non_null($phys_ptr_cast(P#b,^d_node))), 
($non_null($phys_ptr_cast(L#prv,^d_node))), 
($non_null($phys_ptr_cast(local.a,^d_node))), 
($is_null($phys_ptr_cast(P#a,^d_node))), 
($is_null($phys_ptr_cast(P#b,^d_node))), 
($is_null($phys_ptr_cast(L#prv,^d_node))), 
($is_null($phys_ptr_cast(local.a,^d_node))), 
(($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node))), 
(($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
(($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node))), 
(($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node))), 
(($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
(($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node))), 
(($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node))), 
(($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node))), 
(($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
...
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(local.a,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node)))), 
...
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(local.a,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))))), 
((!($oset_in($phys_ptr_cast(local.a,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($is_null($phys_ptr_cast(P#a,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(P#b,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node)))), 
(($is_null($phys_ptr_cast(local.a,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node)))), 
true ) ;
