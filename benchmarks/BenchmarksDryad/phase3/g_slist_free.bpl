...
invariant b0022 ==> ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))));
invariant b0023 ==> ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
invariant b0024 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))));
invariant b0025 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
invariant b0026 ==> ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))));
invariant b0027 ==> ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
invariant b0028 ==> ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)))));
invariant b0029 ==> ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
invariant b0030 ==> ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)))));
invariant b0031 ==> ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
