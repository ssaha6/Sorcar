...
invariant b0038 ==> (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)))));
invariant b0039 ==> (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)))));
invariant b0040 ==> (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)))));
invariant b0041 ==> (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)))));
...
invariant b0044 ==> ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0045 ==> ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0046 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0047 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0048 ==> ((P#n < 2147483647));
invariant b0049 ==> ((local.n < 2147483647));
invariant b0050 ==> ((P#n < 2147483647));
invariant b0051 ==> ((local.n < 2147483647));
invariant b0052 ==> ((P#n < 4294967295));
invariant b0053 ==> ((local.n < 4294967295));
invariant b0054 ==> ((P#n < 4294967295));
invariant b0055 ==> ((local.n < 4294967295));
invariant b0056 ==> ((P#n >= 0));
invariant b0057 ==> ((local.n >= 0));
invariant b0058 ==> ((P#n >= 0));
invariant b0059 ==> ((local.n >= 0));
invariant b0060 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n)));
invariant b0061 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n)));
invariant b0062 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n)));
invariant b0063 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n)));
...
invariant b0068 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n));
invariant b0069 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n));
invariant b0070 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n));
invariant b0071 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n));
invariant b0072 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n));
invariant b0073 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n));
invariant b0074 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n));
invariant b0075 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n));
invariant b0076 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
invariant b0077 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
invariant b0078 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
invariant b0079 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
invariant b0080 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
invariant b0081 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
invariant b0082 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
invariant b0083 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
invariant b0084 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n));
invariant b0085 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n));
invariant b0086 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n));
invariant b0087 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n));
invariant b0088 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n)));
invariant b0089 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n)));
invariant b0090 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n)));
invariant b0091 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n)));
