...
invariant (p0188 == ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0189 == ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))))));
invariant (p0190 == ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))))));
invariant (p0191 == ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0192 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))));
invariant (p0193 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))))));
invariant (p0194 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0195 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0196 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))))));
invariant (p0197 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0198 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0199 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))));
invariant (p0200 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0201 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0202 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))));
invariant (p0203 == ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))))));
invariant (p0204 == ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant (p0205 == ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0206 == ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant (p0207 == ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant (p0208 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0209 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0210 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0211 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant (p0212 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0213 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0214 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant (p0215 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0216 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0217 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant (p0218 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0219 == ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0220 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0221 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0222 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0223 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0224 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0225 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0226 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0227 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0228 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0229 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0230 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0231 == (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0232 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0233 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant (p0234 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant (p0235 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant (p0236 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant (p0237 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant (p0238 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant (p0239 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0240 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant (p0241 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant (p0242 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0243 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant (p0244 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0245 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0246 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0247 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0248 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))));
invariant (p0249 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0250 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))));
invariant (p0251 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0252 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant (p0253 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0254 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant (p0255 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L
#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0352 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0353 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
...
invariant (p0355 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0356 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0357 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0358 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0359 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0360 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
...
invariant (p0362 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0363 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0364 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0365 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0366 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0367 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0368 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0369 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0370 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0371 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0372 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0373 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0374 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0375 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0376 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0377 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0378 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0379 == ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0380 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0381 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0382 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0383 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0384 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0385 == ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0386 == ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0387 == ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0388 == ((L#list_key < 2147483647)));
invariant (p0389 == ((L#list_key < 2147483647)));
invariant (p0390 == ((L#list_key < 2147483647)));
invariant (p0391 == ((L#list_key < 2147483647)));
invariant (p0392 == ((L#list_key < 4294967295)));
invariant (p0393 == ((L#list_key < 4294967295)));
invariant (p0394 == ((L#list_key < 4294967295)));
invariant (p0395 == ((L#list_key < 4294967295)));
invariant (p0396 == ((L#list_key >= 0)));
invariant (p0397 == ((L#list_key >= 0)));
invariant (p0398 == ((L#list_key >= 0)));
invariant (p0399 == ((L#list_key >= 0)));
invariant (p0400 == (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#list_key))));
invariant (p0401 == (($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) < L#list_key))));
invariant (p0402 == (($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) < L#list_key))));
invariant (p0403 == (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#list_key))));
invariant (p0404 == ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0405 == ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
...
invariant (p0407 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0408 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0409 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0410 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0411 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0412 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))));
...
invariant (p0414 == ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0415 == ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0416 == ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0417 == ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
...
invariant (p0419 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0420 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0421 == ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))));
invariant (p0422 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))));
invariant (p0423 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0424 == ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))));
...
invariant (p0426 == ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))));
invariant (p0427 == ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))));
invariant (p0428 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#list_key)));
invariant (p0429 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)));
invariant (p0430 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) == L#list_key)));
invariant (p0431 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#list_key)));
invariant (p0432 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)));
invariant (p0433 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)));
invariant (p0434 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)));
invariant (p0435 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)));
invariant (p0436 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)));
invariant (p0437 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)));
invariant (p0438 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)));
invariant (p0439 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)));
invariant (p0440 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)));
invariant (p0441 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)));
invariant (p0442 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)));
invariant (p0443 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)));
invariant (p0444 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)));
invariant (p0445 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)));
invariant (p0446 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)));
invariant (p0447 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)));
invariant (p0448 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)));
invariant (p0449 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)));
invariant (p0450 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)));
invariant (p0451 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)));
invariant (p0452 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)));
invariant (p0453 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)));
invariant (p0454 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)));
invariant (p0455 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)));
