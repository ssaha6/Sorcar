...
invariant (p0237 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == P#n)));
invariant (p0238 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#res)));
invariant (p0239 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == local.n)));
invariant (p0240 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == P#n)));
invariant (p0241 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == L#res)));
invariant (p0242 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == local.n)));
invariant (p0243 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == P#n)));
invariant (p0244 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#res)));
invariant (p0245 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == local.n)));
invariant (p0246 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == P#n)));
invariant (p0247 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == L#res)));
invariant (p0248 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == local.n)));
invariant (p0249 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == P#n)));
invariant (p0250 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#res)));
invariant (p0251 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == local.n)));
invariant (p0252 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == P#n)));
invariant (p0253 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#res)));
invariant (p0254 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == local.n)));
invariant (p0255 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == P#n)));
invariant (p0256 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#res)));
invariant (p0257 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == local.n)));
invariant (p0258 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == P#n)));
invariant (p0259 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#res)));
invariant (p0260 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == local.n)));
invariant (p0261 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == P#n)));
invariant (p0262 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == L#res)));
invariant (p0263 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == local.n)));
invariant (p0264 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (P#n - L#res))));
invariant (p0265 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (P#n - local.n))));
invariant (p0266 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (L#res - P#n))));
invariant (p0267 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (L#res - local.n))));
invariant (p0268 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (local.n - P#n))));
invariant (p0269 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == (local.n - L#res))));
invariant (p0270 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - L#res))));
invariant (p0271 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - local.n))));
invariant (p0272 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - P#n))));
invariant (p0273 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - local.n))));
invariant (p0274 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - P#n))));
invariant (p0275 == ((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - L#res))));
invariant (p0276 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (P#n - L#res))));
invariant (p0277 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (P#n - local.n))));
invariant (p0278 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (L#res - P#n))));
invariant (p0279 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (L#res - local.n))));
invariant (p0280 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (local.n - P#n))));
invariant (p0281 == ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == (local.n - L#res))));
invariant (p0282 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - L#res))));
invariant (p0283 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - local.n))));
invariant (p0284 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - P#n))));
invariant (p0285 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - local.n))));
invariant (p0286 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - P#n))));
invariant (p0287 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - L#res))));
invariant (p0288 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (P#n - L#res))));
invariant (p0289 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (P#n - local.n))));
invariant (p0290 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (L#res - P#n))));
invariant (p0291 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (L#res - local.n))));
invariant (p0292 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (local.n - P#n))));
invariant (p0293 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (local.n - L#res))));
invariant (p0294 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (P#n - L#res))));
invariant (p0295 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (P#n - local.n))));
invariant (p0296 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (L#res - P#n))));
invariant (p0297 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (L#res - local.n))));
invariant (p0298 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (local.n - P#n))));
invariant (p0299 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (local.n - L#res))));
invariant (p0300 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (P#n - L#res))));
invariant (p0301 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (P#n - local.n))));
invariant (p0302 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (L#res - P#n))));
invariant (p0303 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (L#res - local.n))));
invariant (p0304 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (local.n - P#n))));
invariant (p0305 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == (local.n - L#res))));
invariant (p0306 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (P#n - L#res))));
invariant (p0307 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (P#n - local.n))));
invariant (p0308 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (L#res - P#n))));
invariant (p0309 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (L#res - local.n))));
invariant (p0310 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (local.n - P#n))));
invariant (p0311 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == (local.n - L#res))));
invariant (p0312 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - L#res))));
invariant (p0313 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (P#n - local.n))));
invariant (p0314 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - P#n))));
invariant (p0315 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (L#res - local.n))));
invariant (p0316 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - P#n))));
invariant (p0317 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(OP#ret_list,^s_node)) == (local.n - L#res))));
invariant (p0318 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == P#n)));
invariant (p0319 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == L#res)));
invariant (p0320 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == local.n)));
invariant (p0321 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == P#n)));
invariant (p0322 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#res)));
invariant (p0323 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == local.n)));
invariant (p0324 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == P#n)));
invariant (p0325 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#res)));
invariant (p0326 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == local.n)));
invariant (p0327 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == P#n)));
invariant (p0328 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#res)));
invariant (p0329 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == local.n)));
invariant (p0330 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == P#n)));
invariant (p0331 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#res)));
invariant (p0332 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == local.n)));
invariant (p0333 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == P#n)));
invariant (p0334 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == L#res)));
invariant (p0335 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == local.n)));
invariant (p0336 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (P#n - L#res))));
invariant (p0337 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (P#n - local.n))));
invariant (p0338 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (L#res - P#n))));
invariant (p0339 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (L#res - local.n))));
invariant (p0340 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (local.n - P#n))));
invariant (p0341 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (local.n - L#res))));
invariant (p0342 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (P#n - L#res))));
invariant (p0343 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (P#n - local.n))));
invariant (p0344 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (L#res - P#n))));
invariant (p0345 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (L#res - local.n))));
invariant (p0346 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (local.n - P#n))));
invariant (p0347 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (local.n - L#res))));
invariant (p0348 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (P#n - L#res))));
invariant (p0349 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (P#n - local.n))));
invariant (p0350 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (L#res - P#n))));
invariant (p0351 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (L#res - local.n))));
invariant (p0352 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (local.n - P#n))));
invariant (p0353 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (local.n - L#res))));
invariant (p0354 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (P#n - L#res))));
invariant (p0355 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (P#n - local.n))));
invariant (p0356 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (L#res - P#n))));
invariant (p0357 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (L#res - local.n))));
invariant (p0358 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (local.n - P#n))));
invariant (p0359 == (((F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == (local.n - L#res))));
invariant (p0360 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (P#n - L#res))));
invariant (p0361 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (P#n - local.n))));
invariant (p0362 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (L#res - P#n))));
invariant (p0363 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (L#res - local.n))));
invariant (p0364 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (local.n - P#n))));
invariant (p0365 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == (local.n - L#res))));
invariant (p0366 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (P#n - L#res))));
invariant (p0367 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (P#n - local.n))));
invariant (p0368 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (L#res - P#n))));
invariant (p0369 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (L#res - local.n))));
invariant (p0370 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (local.n - P#n))));
invariant (p0371 == (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(OP#ret_list,^s_node))) == (local.n - L#res))));
