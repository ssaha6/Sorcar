...
p0022 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
p0023 := ((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
p0024 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
p0025 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
p0026 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet));
p0027 := (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet));
...
invariant (p0022 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) == L#nondet)));
invariant (p0023 == ((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) == L#nondet)));
invariant (p0024 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet)));
invariant (p0025 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet)));
invariant (p0026 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet)));
invariant (p0027 == (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet)));
