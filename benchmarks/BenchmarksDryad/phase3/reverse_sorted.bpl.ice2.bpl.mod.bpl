...
(F#srtl($s,$phys_ptr_cast(L#r,^s_node))), 
(F#srtl($s,$phys_ptr_cast(local.l,^s_node))), 
(F#rsrtl($s,$phys_ptr_cast(P#l,^s_node))), 
(F#rsrtl($s,$phys_ptr_cast(L#r,^s_node))), 
(F#rsrtl($s,$phys_ptr_cast(local.l,^s_node))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(L#r,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(local.l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#r,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#r,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(local.l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(local.l,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(local.l,^s_node)),F#rsrtl_reach($s,$phys_ptr_cast(L#r,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#r,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#r,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#r,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
((($non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
((($non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
((($non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
((($non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#r,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(local.l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node)) && ($phys_ptr_cast(L#r,^s_node) != $phys_ptr_cast(local.l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#r,^s_node),$phys_ptr_cast(local.l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#r,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#r,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node)) && ($phys_ptr_cast(local.l,^s_node) != $phys_ptr_cast(L#r,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.l,^s_node),$phys_ptr_cast(L#r,^s_node))))), 
true ) ;
