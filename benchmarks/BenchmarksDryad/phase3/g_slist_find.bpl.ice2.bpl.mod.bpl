...
p0030 := (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
p0031 := (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
...
p0042 := ((P#data >= 0));
p0043 := ((P#data >= 0));
p0044 := (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < P#data)));
p0045 := (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < P#data)));
...
p0050 := ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == P#data));
p0051 := ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == P#data));
p0052 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == P#data));
p0053 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == P#data));
p0054 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == P#data));
p0055 := (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == P#data));
