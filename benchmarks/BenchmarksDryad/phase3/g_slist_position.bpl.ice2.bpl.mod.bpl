...
(F#sll($s,$phys_ptr_cast(P#link,^s_node))), 
(F#sll($s,$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($non_null($phys_ptr_cast(P#list,^s_node))), 
($non_null($phys_ptr_cast(P#link,^s_node))), 
($non_null($phys_ptr_cast(local.list,^s_node))), 
($is_null($phys_ptr_cast(P#list,^s_node))), 
($is_null($phys_ptr_cast(P#link,^s_node))), 
($is_null($phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node))), 
(($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node))), 
(($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))), 
(($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node))), 
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#link,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node)))), 
...
(($non_null($phys_ptr_cast(P#link,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.list,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node) == $phys_ptr_cast(P#link,^s_node)))), 
...
(($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
...
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.list,^s_node),^s_node) == $phys_ptr_cast(P#link,^s_node)))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#link,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#link,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node)))), 
(($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))))), 
((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))))), 
($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))), 
($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
...
($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
(((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))), 
...
(((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))), 
(((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))), 
...
(((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
...
((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
...
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
...
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
...
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))), 
((L#i < 2147483647)), 
((L#i < 2147483647)), 
((L#i < 2147483647)), 
((L#i < 4294967295)), 
...
(($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) < L#i))), 
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#i))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node))))), 
...
((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))), 
((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
...
((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))), 
((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
...
((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) == L#i)), 
((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i)), 
true ) ;
