...
invariant b0038 ==> (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)))));
invariant b0039 ==> (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)))));
invariant b0040 ==> (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)))));
invariant b0041 ==> (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)))));
invariant b0042 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0043 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0044 ==> ((F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0045 ==> ((F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0046 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0047 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0048 ==> ((P#data < 2147483647));
invariant b0049 ==> ((L#length < 2147483647));
invariant b0050 ==> ((P#data < 2147483647));
invariant b0051 ==> ((L#length < 2147483647));
invariant b0052 ==> ((P#data < 4294967295));
invariant b0053 ==> ((L#length < 4294967295));
invariant b0054 ==> ((P#data < 4294967295));
invariant b0055 ==> ((L#length < 4294967295));
invariant b0056 ==> ((P#data >= 0));
invariant b0057 ==> ((L#length >= 0));
invariant b0058 ==> ((P#data >= 0));
invariant b0059 ==> ((L#length >= 0));
invariant b0060 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#data)));
invariant b0061 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < L#length)));
invariant b0062 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#data)));
invariant b0063 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < L#length)));
invariant b0064 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0065 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0066 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0067 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0068 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#data));
invariant b0069 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == L#length));
invariant b0070 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#data));
invariant b0071 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == L#length));
invariant b0072 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#data));
invariant b0073 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#length));
invariant b0074 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#data));
invariant b0075 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#length));
invariant b0076 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length)));
invariant b0077 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data)));
invariant b0078 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length)));
invariant b0079 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data)));
invariant b0080 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length)));
invariant b0081 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data)));
invariant b0082 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length)));
invariant b0083 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data)));
invariant b0084 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#data));
invariant b0085 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#length));
invariant b0086 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#data));
invariant b0087 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#length));
invariant b0088 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#data - L#length)));
invariant b0089 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (L#length - P#data)));
invariant b0090 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#data - L#length)));
invariant b0091 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (L#length - P#data)));
