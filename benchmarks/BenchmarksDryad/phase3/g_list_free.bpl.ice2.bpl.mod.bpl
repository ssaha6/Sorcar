...
p0022 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#x,^d_node))));
p0023 := ((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
p0024 := ((F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)))));
p0025 := ((F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0026 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)))));
p0027 := ((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0028 := ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)))));
p0029 := ((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
p0030 := ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)))));
p0031 := ((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
...
(F#dll_lseg($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#x,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#x,^d_node),$phys_ptr_cast(P#list,^d_node))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#x,^d_node),$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))), 
($non_null($phys_ptr_cast(P#list,^d_node))), 
($non_null($phys_ptr_cast(L#x,^d_node))), 
($is_null($phys_ptr_cast(P#list,^d_node))), 
($is_null($phys_ptr_cast(L#x,^d_node))), 
(($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#x,^d_node))), 
(($phys_ptr_cast(L#x,^d_node) == $phys_ptr_cast(P#list,^d_node))), 
(($non_null($phys_ptr_cast(P#list,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#list,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(L#x,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#x,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(P#list,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#list,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(L#x,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#x,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#list,^d_node),^d_node) == $phys_ptr_cast(L#x,^d_node)))), 
(($non_null($phys_ptr_cast(L#x,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#x,^d_node),^d_node) == $phys_ptr_cast(P#list,^d_node)))), 
((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)))), 
((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))), 
((F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node))))), 
((F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#x,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(L#x,^d_node)) == $intset_union(F#dll_keys(loopState#15,$phys_ptr_cast(L#x,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node))))), 
((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node))))), 
((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#x,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node))))), 
((($non_null($phys_ptr_cast(L#x,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#x,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node))))), 
true ) ;
