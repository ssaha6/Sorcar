...
invariant (p0050 == ((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) == P#k)));
invariant (p0051 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) == P#k)));
invariant (p0052 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#k)));
invariant (p0053 == ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#k)));
invariant (p0054 == (((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#k)));
invariant (p0055 == (((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#k)));
