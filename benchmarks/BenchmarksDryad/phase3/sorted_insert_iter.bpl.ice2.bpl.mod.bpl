...
p0063 := ((!($oset_in($phys_ptr_cast(P#l,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))))));
p0064 := ((!($oset_in($phys_ptr_cast(P#l,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))))));
p0065 := ((!($oset_in($phys_ptr_cast(L#prev,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))))));
p0066 := ((!($oset_in($phys_ptr_cast(L#prev,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))))));
p0067 := ((!($oset_in($phys_ptr_cast(L#next,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))))));
p0068 := ((!($oset_in($phys_ptr_cast(L#next,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))))));
p0069 := (($is_null($phys_ptr_cast(P#l,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#next,^s_node))));
p0070 := (($is_null($phys_ptr_cast(P#l,^s_node)) ==> ($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
p0071 := (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#next,^s_node))));
p0072 := (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(P#l,^s_node))));
p0073 := (($is_null($phys_ptr_cast(L#next,^s_node)) ==> ($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
p0074 := (($is_null($phys_ptr_cast(L#next,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#l,^s_node))));
p0075 := ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))));
p0076 := ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))));
p0077 := ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))));
p0078 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))))));
p0079 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))))));
p0080 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))))));
p0081 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))))));
p0082 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))))));
p0083 := ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))))));
p0084 := ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
p0085 := ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))));
p0086 := ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))));
p0087 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))));
p0088 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))));
p0089 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))));
p0090 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))));
p0091 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))));
p0092 := ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))));
p0093 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)))));
p0094 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)))));
p0095 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)))));
p0096 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)))));
p0097 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)))));
p0098 := (((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)))));
p0099 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))));
p0100 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))));
p0101 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
p0102 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))));
p0103 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
p0104 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))));
p0105 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))));
p0106 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))));
p0107 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))));
p0108 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))));
p0109 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))));
p0110 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))));
p0111 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0112 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0113 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0114 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0115 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0116 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0117 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0118 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0119 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0120 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0121 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0122 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0123 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0124 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0125 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0126 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0127 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0128 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0129 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0130 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0131 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0132 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0133 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0134 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0135 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0136 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0137 := ((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0138 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))));
p0139 := ((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0140 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))));
p0141 := ((P#k < 2147483647));
p0142 := ((P#k < 2147483647));
p0143 := ((P#k < 2147483647));
p0144 := ((P#k < 4294967295));
p0145 := ((P#k < 4294967295));
p0146 := ((P#k < 4294967295));
p0147 := ((P#k >= 0));
p0148 := ((P#k >= 0));
p0149 := ((P#k >= 0));
p0150 := (($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) < P#k)));
p0151 := (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) < P#k)));
p0152 := (($non_null($phys_ptr_cast(L#next,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) < P#k)));
p0153 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0154 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0155 := ((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0156 := ((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0157 := ((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0158 := ((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0159 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0160 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0161 := ((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0162 := ((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0163 := ((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0164 := ((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0165 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= P#k)));
p0166 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= P#k)));
p0167 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= P#k)));
p0168 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= P#k)));
p0169 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= P#k)));
p0170 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= P#k)));
p0171 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= P#k)));
p0172 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= P#k)));
p0173 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= P#k)));
p0174 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node)))));
p0175 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node)))));
p0176 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node)))));
p0177 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0178 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0179 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0180 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0181 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0182 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0183 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0184 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0185 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0186 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0187 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0188 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0189 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0190 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0191 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0192 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0193 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0194 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0195 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0196 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0197 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)))));
p0198 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0199 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)))));
p0200 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0201 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node)))));
p0202 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node)))));
p0203 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node)))));
p0204 := (((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node)))));
p0205 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node)))));
p0206 := (((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node)))));
p0207 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0208 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0209 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0210 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0211 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0212 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0213 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0214 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0215 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0216 := (((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))));
p0217 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))));
p0218 := (((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
p0219 := ((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) == P#k));
p0220 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) == P#k));
p0221 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) == P#k));
p0222 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) == P#k));
p0223 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) == P#k));
p0224 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) == P#k));
p0225 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) == P#k));
p0226 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) == P#k));
p0227 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) == P#k));
p0228 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node))) == P#k));
p0229 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node))) == P#k));
p0230 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node))) == P#k));
p0231 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node))) == P#k));
p0232 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node))) == P#k));
p0233 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node))) == P#k));
...
invariant my_inv ((F#srtl($s,$phys_ptr_cast(P#l,^s_node))), 
(F#srtl($s,$phys_ptr_cast(L#prev,^s_node))), 
(F#srtl($s,$phys_ptr_cast(L#next,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#next,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#next,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#next,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
($non_null($phys_ptr_cast(P#l,^s_node))), 
($non_null($phys_ptr_cast(L#prev,^s_node))), 
($non_null($phys_ptr_cast(L#next,^s_node))), 
($is_null($phys_ptr_cast(P#l,^s_node))), 
($is_null($phys_ptr_cast(L#prev,^s_node))), 
($is_null($phys_ptr_cast(L#next,^s_node))), 
(($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#prev,^s_node))), 
(($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#next,^s_node))), 
(($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#l,^s_node))), 
(($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#next,^s_node))), 
(($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(P#l,^s_node))), 
(($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(L#prev,^s_node))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#prev,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#next,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#next,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#prev,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#next,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#next,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#prev,^s_node)))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#next,^s_node)))), 
(($non_null($phys_ptr_cast(L#prev,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#prev,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node)))), 
(($non_null($phys_ptr_cast(L#prev,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#prev,^s_node),^s_node) == $phys_ptr_cast(L#next,^s_node)))), 
(($non_null($phys_ptr_cast(L#next,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#next,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node)))), 
(($non_null($phys_ptr_cast(L#next,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#next,^s_node),^s_node) == $phys_ptr_cast(L#prev,^s_node)))), 
((!($oset_in($phys_ptr_cast(P#l,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#l,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#prev,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#prev,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#next,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#next,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))))), 
(($is_null($phys_ptr_cast(P#l,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#next,^s_node)))), 
(($is_null($phys_ptr_cast(P#l,^s_node)) ==> ($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(L#prev,^s_node)))), 
(($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#next,^s_node)))), 
(($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(L#next,^s_node) == $phys_ptr_cast(P#l,^s_node)))), 
(($is_null($phys_ptr_cast(L#next,^s_node)) ==> ($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#prev,^s_node)))), 
(($is_null($phys_ptr_cast(L#next,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#l,^s_node)))), 
((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))))), 
((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))))), 
((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))))), 
($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))), 
($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))), 
($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
...
($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#next,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prev,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#next,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#next,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prev,^s_node))))), 
((P#k < 2147483647)), 
((P#k < 2147483647)), 
((P#k < 2147483647)), 
((P#k < 4294967295)), 
...
((P#k >= 0)), 
((P#k >= 0)), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) < P#k))), 
(($non_null($phys_ptr_cast(L#prev,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) < P#k))), 
(($non_null($phys_ptr_cast(L#next,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) < P#k))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= P#k))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= P#k))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= P#k))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= P#k))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node))) ==> (P#k <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#next,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#next,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) && ($phys_ptr_cast(L#prev,^s_node) != $phys_ptr_cast(L#next,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#prev,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prev,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) && ($phys_ptr_cast(L#next,^s_node) != $phys_ptr_cast(L#prev,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node))))), 
((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) == P#k)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) == P#k)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#prev,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#next,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#l,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#next,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(P#l,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#next,^s_node),$phys_ptr_cast(L#prev,^s_node)) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#l,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#next,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prev,^s_node))) == P#k)), 
true ) ;
