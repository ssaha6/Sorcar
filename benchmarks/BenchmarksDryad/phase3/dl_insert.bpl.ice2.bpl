...
invariant (p0063 == ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(L#curr,^d_node)))))));
invariant (p0064 == ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#elt,^d_node)))))));
invariant (p0065 == ((!($oset_in($phys_ptr_cast(P#elt,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))))));
invariant (p0066 == ((!($oset_in($phys_ptr_cast(P#elt,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))))));
invariant (p0067 == ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(P#elt,^d_node)))))));
invariant (p0068 == ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(P#lst,^d_node)))))));
invariant (p0069 == (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(P#elt,^d_node) == $phys_ptr_cast(L#curr,^d_node)))));
invariant (p0070 == (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#elt,^d_node)))));
invariant (p0071 == (($is_null($phys_ptr_cast(P#elt,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node)))));
invariant (p0072 == (($is_null($phys_ptr_cast(P#elt,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node)))));
invariant (p0073 == (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(P#elt,^d_node)))));
invariant (p0074 == (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#elt,^d_node) == $phys_ptr_cast(P#lst,^d_node)))));
invariant (p0075 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) == L#nondet)));
invariant (p0076 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) == L#nondet)));
invariant (p0077 == ((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) == L#nondet)));
invariant (p0078 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(P#elt,^d_node)) == L#nondet)));
invariant (p0079 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet)));
invariant (p0080 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet)));
invariant (p0081 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet)));
invariant (p0082 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet)));
invariant (p0083 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#elt,^d_node)) == L#nondet)));
invariant (p0084 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node))) == L#nondet)));
invariant (p0085 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet)));
invariant (p0086 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet)));
invariant (p0087 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet)));
invariant (p0088 == (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet)));
invariant (p0089 == (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node))) == L#nondet)));
