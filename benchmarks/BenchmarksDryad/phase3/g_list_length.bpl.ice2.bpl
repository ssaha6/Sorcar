...
invariant (p0038 == (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0039 == (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0040 == (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0041 == (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0042 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant (p0043 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant (p0044 == ((F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0045 == ((F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0046 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0047 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0048 == ((P#data < 2147483647)));
invariant (p0049 == ((L#length < 2147483647)));
invariant (p0050 == ((P#data < 2147483647)));
invariant (p0051 == ((L#length < 2147483647)));
invariant (p0052 == ((P#data < 4294967295)));
invariant (p0053 == ((L#length < 4294967295)));
invariant (p0054 == ((P#data < 4294967295)));
invariant (p0055 == ((L#length < 4294967295)));
invariant (p0056 == ((P#data >= 0)));
invariant (p0057 == ((L#length >= 0)));
invariant (p0058 == ((P#data >= 0)));
invariant (p0059 == ((L#length >= 0)));
invariant (p0060 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#data))));
invariant (p0061 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < L#length))));
invariant (p0062 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#data))));
invariant (p0063 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < L#length))));
invariant (p0064 == ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0065 == ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0066 == ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0067 == ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0068 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#data)));
invariant (p0069 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == L#length)));
invariant (p0070 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#data)));
invariant (p0071 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == L#length)));
invariant (p0072 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#data)));
invariant (p0073 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#length)));
invariant (p0074 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#data)));
invariant (p0075 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#length)));
invariant (p0076 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length))));
invariant (p0077 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data))));
invariant (p0078 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length))));
invariant (p0079 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data))));
invariant (p0080 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length))));
invariant (p0081 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data))));
invariant (p0082 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length))));
invariant (p0083 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data))));
invariant (p0084 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#data)));
invariant (p0085 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#length)));
invariant (p0086 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#data)));
invariant (p0087 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#length)));
invariant (p0088 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#data - L#length))));
invariant (p0089 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (L#length - P#data))));
invariant (p0090 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#data - L#length))));
invariant (p0091 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (L#length - P#data))));
