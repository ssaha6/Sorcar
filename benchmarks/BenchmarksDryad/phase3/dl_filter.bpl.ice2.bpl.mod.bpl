...
invariant my_inv ((F#dll($s,$phys_ptr_cast(P#x,^d_node))), 
(F#dll($s,$phys_ptr_cast(L#prv,^d_node))), 
(F#dll($s,$phys_ptr_cast(L#curr,^d_node))), 
(F#dll($s,$phys_ptr_cast(L#res,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))), 
($non_null($phys_ptr_cast(P#x,^d_node))), 
($non_null($phys_ptr_cast(L#prv,^d_node))), 
($non_null($phys_ptr_cast(L#curr,^d_node))), 
($non_null($phys_ptr_cast(L#res,^d_node))), 
($is_null($phys_ptr_cast(P#x,^d_node))), 
($is_null($phys_ptr_cast(L#prv,^d_node))), 
($is_null($phys_ptr_cast(L#curr,^d_node))), 
($is_null($phys_ptr_cast(L#res,^d_node))), 
(($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
(($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#curr,^d_node))), 
(($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#res,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#x,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#curr,^d_node))), 
(($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#res,^d_node))), 
(($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#x,^d_node))), 
(($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
(($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#res,^d_node))), 
(($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(P#x,^d_node))), 
(($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#prv,^d_node))), 
(($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#curr,^d_node))), 
(($non_null($phys_ptr_cast(P#x,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#x,^d_node),^d_node)))), 
...
(($non_null($phys_ptr_cast(L#res,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#res,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(P#x,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#x,^d_node),^d_node)))), 
...
(($non_null($phys_ptr_cast(L#res,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#res,^d_node),^d_node)))), 
(($non_null($phys_ptr_cast(P#x,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#x,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($non_null($phys_ptr_cast(P#x,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#x,^d_node),^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($non_null($phys_ptr_cast(P#x,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#x,^d_node),^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($non_null($phys_ptr_cast(L#curr,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#curr,^d_node),^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($non_null($phys_ptr_cast(L#curr,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#curr,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($non_null($phys_ptr_cast(L#curr,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#curr,^d_node),^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($non_null($phys_ptr_cast(L#res,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#res,^d_node),^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($non_null($phys_ptr_cast(L#res,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#res,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($non_null($phys_ptr_cast(L#res,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#res,^d_node),^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#x,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#prv,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#res,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(P#x,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#prv,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#res,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#res,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(P#x,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#x,^d_node)))), 
(($is_null($phys_ptr_cast(L#res,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#prv,^d_node)))), 
true ) ;
