...
invariant my_inv ((F#dll($s,$phys_ptr_cast(P#h,^d_node))), 
(F#dll($s,$phys_ptr_cast(L#i,^d_node))), 
(F#dll($s,$phys_ptr_cast(L#j,^d_node))), 
(F#sll($s,$phys_ptr_cast(P#h,^d_node))), 
(F#sll($s,$phys_ptr_cast(L#i,^d_node))), 
(F#sll($s,$phys_ptr_cast(L#j,^d_node))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#h,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#i,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#j,^d_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^d_node)))), 
true ) ;
