...
p0050 := ((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) == P#k));
p0051 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) == P#k));
p0052 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#k));
p0053 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#k));
p0054 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#k));
p0055 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#k));
...
((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))))), 
((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))))), 
((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))))), 
($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))), 
($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))), 
($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))), 
($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))), 
(((!($intset_in(P#k,F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node))))), 
(((!($intset_in(P#k,F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node))))), 
...
((F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))))), 
((F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))))), 
((P#k < 2147483647)), 
((P#k < 2147483647)), 
((P#k < 4294967295)), 
((P#k < 4294967295)), 
((P#k >= 0)), 
((P#k >= 0)), 
(($non_null($phys_ptr_cast(P#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) < P#k))), 
(($non_null($phys_ptr_cast(L#i,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) < P#k))), 
...
((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))))), 
((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))))), 
((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) == P#k)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#k)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#k)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#k)), 
true ) ;
