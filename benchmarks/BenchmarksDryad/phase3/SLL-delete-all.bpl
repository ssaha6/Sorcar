...
invariant b0022 ==> ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))))));
invariant b0023 ==> ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))))));
invariant b0024 ==> ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))))));
invariant b0025 ==> ((!($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))))));
invariant b0026 ==> ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0027 ==> ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0028 ==> ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0029 ==> ($intset_in(P#k,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0030 ==> (((!($intset_in(P#k,F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node)))));
invariant b0031 ==> (((!($intset_in(P#k,F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node)))));
invariant b0032 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0033 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0034 ==> ((F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0035 ==> ((F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0036 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#5,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0037 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#5,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0038 ==> ((P#k < 2147483647));
invariant b0039 ==> ((P#k < 2147483647));
invariant b0040 ==> ((P#k < 4294967295));
invariant b0041 ==> ((P#k < 4294967295));
invariant b0042 ==> ((P#k >= 0));
invariant b0043 ==> ((P#k >= 0));
invariant b0044 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) < P#k)));
invariant b0045 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) < P#k)));
invariant b0046 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0047 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0048 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0049 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0050 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) == P#k));
invariant b0051 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) == P#k));
invariant b0052 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#k));
invariant b0053 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#k));
invariant b0054 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#k));
invariant b0055 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#k));
