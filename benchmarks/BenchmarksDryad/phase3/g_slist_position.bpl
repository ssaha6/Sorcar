...
invariant b0063 ==> ((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0064 ==> ((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0065 ==> ((!($oset_in($phys_ptr_cast(P#link,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0066 ==> ((!($oset_in($phys_ptr_cast(P#link,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0067 ==> ((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0068 ==> ((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0069 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0070 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0071 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0072 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0073 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0074 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0075 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant b0076 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))));
invariant b0077 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant b0078 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0079 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0080 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0081 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0082 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0083 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0084 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0085 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0086 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0087 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0088 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0089 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0090 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0091 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0092 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0093 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
invariant b0094 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
invariant b0095 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)))));
invariant b0096 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)))));
invariant b0097 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
invariant b0098 ==> (((!($intset_in(L#i,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
invariant b0099 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0100 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0101 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0102 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0103 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0104 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0105 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0106 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0107 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0108 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0109 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0110 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0111 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0112 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0113 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0114 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0115 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0116 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0117 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
...
invariant b0119 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0120 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
...
invariant b0122 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0123 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0124 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0125 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0126 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0127 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0128 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0129 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
...
invariant b0131 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0132 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
...
invariant b0134 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0135 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0136 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0137 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0138 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0139 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0140 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
...
invariant b0150 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#i)));
invariant b0151 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) < L#i)));
invariant b0152 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#i)));
invariant b0153 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0154 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0155 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0156 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0157 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0158 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0159 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0160 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0161 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0162 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0163 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0164 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0165 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0166 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0167 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0168 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0169 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0170 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0171 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0172 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0173 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0174 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i));
invariant b0175 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i));
invariant b0176 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i));
invariant b0177 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i));
invariant b0178 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i));
invariant b0179 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i));
