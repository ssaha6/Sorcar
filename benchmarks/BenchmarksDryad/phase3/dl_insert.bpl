...
invariant b0075 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
invariant b0076 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) == L#nondet));
invariant b0077 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
invariant b0078 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(P#elt,^d_node)) == L#nondet));
invariant b0079 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
invariant b0080 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
invariant b0081 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#elt,^d_node),$phys_ptr_cast(L#curr,^d_node)) == L#nondet));
invariant b0082 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)) == L#nondet));
invariant b0083 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#elt,^d_node)) == L#nondet));
invariant b0084 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node))) == L#nondet));
invariant b0085 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet));
invariant b0086 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet));
invariant b0087 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node))) == L#nondet));
invariant b0088 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#lst,^d_node))) == L#nondet));
invariant b0089 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(L#curr,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#elt,^d_node))) == L#nondet));
