...
invariant b0385 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))))));
invariant b0386 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))))));
invariant b0387 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))))));
invariant b0388 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
invariant b0389 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))))));
invariant b0390 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))))));
invariant b0391 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))))));
invariant b0392 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))))));
invariant b0393 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))))));
invariant b0394 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))))));
invariant b0395 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))))));
invariant b0396 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))))));
invariant b0397 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))))));
invariant b0398 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))))));
invariant b0399 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))))));
invariant b0400 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))))));
invariant b0401 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))))));
invariant b0402 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))))));
invariant b0403 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))))));
invariant b0404 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))))));
invariant b0405 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))))));
invariant b0406 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))))));
invariant b0407 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))))));
invariant b0408 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))))));
invariant b0409 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))))));
invariant b0410 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))));
invariant b0411 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))));
invariant b0412 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))));
invariant b0413 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0414 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))));
invariant b0415 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0416 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0417 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0418 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0419 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0420 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0421 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0422 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0423 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0424 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0425 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0426 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0427 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0428 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0429 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0430 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0431 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0432 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0433 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0434 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0435 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0436 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0437 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0438 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0439 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0440 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0441 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0442 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0443 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)))));
invariant b0444 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)))));
invariant b0445 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)))));
invariant b0446 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)))));
invariant b0447 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
invariant b0448 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
invariant b0449 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
invariant b0450 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
invariant b0451 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0452 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0453 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0454 ==> (((!($intset_in(P#data,F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0455 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))));
invariant b0456 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))));
invariant b0457 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0458 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))));
invariant b0459 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))));
invariant b0460 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))));
invariant b0461 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0462 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))));
invariant b0463 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))));
invariant b0464 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))));
invariant b0465 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0466 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))));
invariant b0467 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))));
invariant b0468 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))));
invariant b0469 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))));
invariant b0470 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node))));
invariant b0471 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node))));
invariant b0472 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node))));
invariant b0473 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#node,^s_node))));
invariant b0474 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0475 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0476 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0477 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0478 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0479 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0480 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0481 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0482 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0483 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0484 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0485 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0486 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0487 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0488 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0489 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0490 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0491 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0492 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0493 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0494 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0495 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0496 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0497 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0498 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0499 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0500 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0501 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0502 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0503 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0504 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0505 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0506 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0507 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0508 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0509 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0510 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0511 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0512 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0513 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0514 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0515 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0516 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0517 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0518 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0519 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0520 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0521 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0522 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0523 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0524 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0525 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0526 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0527 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0528 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0529 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0530 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0531 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0532 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0533 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0534 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0535 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0536 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0537 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0538 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0539 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0540 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0541 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0542 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0543 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0544 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0545 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0546 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0547 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0548 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0549 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0550 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0551 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0552 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0553 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0554 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0555 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0556 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0557 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0558 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0559 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0560 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0561 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0562 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0563 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0564 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0565 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0566 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0567 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0568 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0569 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0570 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0571 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0572 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0573 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0574 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0575 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0576 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0577 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0578 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0579 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0580 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0581 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0582 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0583 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0584 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0585 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0586 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0587 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0588 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0589 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0590 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0591 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0592 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0593 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0594 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0595 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0596 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0597 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0598 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0599 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0600 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0601 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0602 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0603 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0604 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0605 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0606 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0607 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0608 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0609 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0610 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0611 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0612 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0613 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0614 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0615 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0616 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0617 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0618 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0619 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0620 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0621 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0622 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node))));
invariant b0623 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0624 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0625 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0626 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0627 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0628 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0629 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0630 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0631 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0632 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0633 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0634 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0635 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0636 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0637 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0638 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0639 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0640 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0641 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0642 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0643 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0644 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0645 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0646 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0647 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0648 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0649 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0650 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0651 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0652 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node))));
invariant b0653 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node))));
invariant b0654 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node))));
invariant b0655 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0656 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0657 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0658 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0659 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0660 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0661 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0662 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0663 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0664 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0665 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0666 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0667 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0668 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0669 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0670 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0671 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0672 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0673 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0674 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0675 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0676 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0677 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0678 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0679 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0680 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0681 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0682 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0683 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0684 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0685 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0686 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0687 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0688 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0689 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0690 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0691 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0692 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0693 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0694 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0695 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0696 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0697 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0698 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0699 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0700 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0701 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0702 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0703 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0704 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0705 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0706 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0707 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0708 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0709 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0710 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0711 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0712 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0713 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0714 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0715 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0716 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0717 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0718 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0719 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0720 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0721 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0722 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0723 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0724 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0725 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0726 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0727 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0728 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0729 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0730 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0731 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0732 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0733 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0734 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0735 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0736 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0737 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0738 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0739 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0740 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0741 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0742 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0743 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0744 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0745 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0746 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0747 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0748 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0749 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0750 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0751 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0752 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0753 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0754 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0755 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0756 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0757 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0758 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0759 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0760 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0761 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0762 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0763 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0764 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0765 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0766 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0767 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0768 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0769 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0770 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0771 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0772 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0773 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0774 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0775 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0776 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0777 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0778 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0779 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0780 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0781 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0782 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0783 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0784 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0785 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0786 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0787 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0788 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0789 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0790 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0791 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0792 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0793 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0794 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0795 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0796 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0797 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0798 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0799 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0800 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0801 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0802 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0803 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0804 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0805 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0806 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0807 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0808 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0809 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0810 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0811 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0812 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0813 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0814 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0815 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0816 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0817 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0818 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0819 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0820 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0821 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0822 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0823 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0824 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0825 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0826 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0827 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0828 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0829 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0830 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0831 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0832 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0833 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0834 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0835 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0836 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0837 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0838 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#sibling,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0839 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0840 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0841 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0842 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0843 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0844 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0845 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0846 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0847 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0848 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0849 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0850 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#node,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0851 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0852 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0853 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0854 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0855 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0856 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0857 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0858 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0859 ==> ((F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0860 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0861 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0862 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0863 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0864 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0865 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0866 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0867 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0868 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0869 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0870 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0871 ==> ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)))));
invariant b0872 ==> ((F#sll_keys($s,$phys_ptr_cast(P#slist,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0873 ==> ((F#sll_keys($s,$phys_ptr_cast(P#sibling,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0874 ==> ((F#sll_keys($s,$phys_ptr_cast(L#node,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.slist,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
invariant b0875 ==> ((P#data < 2147483647));
invariant b0876 ==> ((P#data < 2147483647));
invariant b0877 ==> ((P#data < 2147483647));
invariant b0878 ==> ((P#data < 2147483647));
invariant b0879 ==> ((P#data < 2147483647));
invariant b0880 ==> ((P#data < 4294967295));
invariant b0881 ==> ((P#data < 4294967295));
invariant b0882 ==> ((P#data < 4294967295));
invariant b0883 ==> ((P#data < 4294967295));
invariant b0884 ==> ((P#data < 4294967295));
invariant b0885 ==> ((P#data >= 0));
invariant b0886 ==> ((P#data >= 0));
invariant b0887 ==> ((P#data >= 0));
invariant b0888 ==> ((P#data >= 0));
invariant b0889 ==> ((P#data >= 0));
invariant b0890 ==> (($non_null($phys_ptr_cast(P#slist,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) < P#data)));
invariant b0891 ==> (($non_null($phys_ptr_cast(P#sibling,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) < P#data)));
invariant b0892 ==> (($non_null($phys_ptr_cast(L#node,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) < P#data)));
invariant b0893 ==> (($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) < P#data)));
invariant b0894 ==> (($non_null($phys_ptr_cast(local.slist,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) < P#data)));
invariant b0895 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0896 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0897 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0898 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0899 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0900 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0901 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0902 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0903 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0904 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0905 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0906 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0907 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0908 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0909 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0910 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0911 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0912 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0913 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0914 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0915 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0916 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0917 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0918 ==> ((($non_null($phys_ptr_cast(P#slist,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0919 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0920 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0921 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0922 ==> ((($non_null($phys_ptr_cast(P#sibling,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0923 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0924 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0925 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0926 ==> ((($non_null($phys_ptr_cast(L#node,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0927 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0928 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0929 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0930 ==> ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)))));
invariant b0931 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(P#slist,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#slist,^s_node)))));
invariant b0932 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(P#sibling,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#sibling,^s_node)))));
invariant b0933 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(L#node,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#node,^s_node)))));
invariant b0934 ==> ((($non_null($phys_ptr_cast(local.slist,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.slist,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
invariant b0935 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node)) == P#data));
invariant b0936 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node)) == P#data));
invariant b0937 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node)) == P#data));
invariant b0938 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) == P#data));
invariant b0939 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node)) == P#data));
invariant b0940 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == P#data));
invariant b0941 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == P#data));
invariant b0942 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == P#data));
invariant b0943 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#slist,^s_node),$phys_ptr_cast(local.slist,^s_node)) == P#data));
invariant b0944 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(P#slist,^s_node)) == P#data));
invariant b0945 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#node,^s_node)) == P#data));
invariant b0946 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(L#last,^s_node)) == P#data));
invariant b0947 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#sibling,^s_node),$phys_ptr_cast(local.slist,^s_node)) == P#data));
invariant b0948 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#slist,^s_node)) == P#data));
invariant b0949 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == P#data));
invariant b0950 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(L#last,^s_node)) == P#data));
invariant b0951 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#node,^s_node),$phys_ptr_cast(local.slist,^s_node)) == P#data));
invariant b0952 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#slist,^s_node)) == P#data));
invariant b0953 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == P#data));
invariant b0954 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#node,^s_node)) == P#data));
invariant b0955 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.slist,^s_node)) == P#data));
invariant b0956 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#slist,^s_node)) == P#data));
invariant b0957 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(P#sibling,^s_node)) == P#data));
invariant b0958 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#node,^s_node)) == P#data));
invariant b0959 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.slist,^s_node),$phys_ptr_cast(L#last,^s_node)) == P#data));
invariant b0960 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node))) == P#data));
invariant b0961 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node))) == P#data));
invariant b0962 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == P#data));
invariant b0963 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node))) == P#data));
invariant b0964 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node))) == P#data));
invariant b0965 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node))) == P#data));
invariant b0966 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == P#data));
invariant b0967 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node))) == P#data));
invariant b0968 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node))) == P#data));
invariant b0969 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node))) == P#data));
invariant b0970 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == P#data));
invariant b0971 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node))) == P#data));
invariant b0972 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node))) == P#data));
invariant b0973 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node))) == P#data));
invariant b0974 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node))) == P#data));
invariant b0975 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node))) == P#data));
invariant b0976 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#slist,^s_node))) == P#data));
invariant b0977 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#sibling,^s_node))) == P#data));
invariant b0978 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#node,^s_node))) == P#data));
invariant b0979 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.slist,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == P#data));
