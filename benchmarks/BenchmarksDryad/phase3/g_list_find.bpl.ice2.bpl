...
invariant (p0030 == (((!($intset_in(P#data,F#dll_keys(loopState#14,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#14,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0031 == (((!($intset_in(P#data,F#dll_keys(loopState#14,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#14,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0032 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant (p0033 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant (p0034 == ((F#dll_keys(loopState#14,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0035 == ((F#dll_keys(loopState#14,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0036 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#14,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0037 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#14,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0038 == ((P#data < 2147483647)));
invariant (p0039 == ((P#data < 2147483647)));
invariant (p0040 == ((P#data < 4294967295)));
invariant (p0041 == ((P#data < 4294967295)));
invariant (p0042 == ((P#data >= 0)));
invariant (p0043 == ((P#data >= 0)));
invariant (p0044 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#data))));
invariant (p0045 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#data))));
...
invariant (p0048 == ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0049 == ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0050 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#data)));
invariant (p0051 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#data)));
invariant (p0052 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#data)));
invariant (p0053 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#data)));
invariant (p0054 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#data)));
invariant (p0055 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#data)));
