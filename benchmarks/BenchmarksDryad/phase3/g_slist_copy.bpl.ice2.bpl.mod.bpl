...
p0188 := ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
p0189 := ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))));
p0190 := ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))));
p0191 := ((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
p0192 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))))));
p0193 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))))));
p0194 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
p0195 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
p0196 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))))));
p0197 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
p0198 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))))));
p0199 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))))));
p0200 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))))));
p0201 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
p0202 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))))));
p0203 := ((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))))));
p0204 := ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
p0205 := ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))));
p0206 := ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
p0207 := ($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
p0208 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0209 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0210 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0211 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0212 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0213 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0214 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0215 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0216 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0217 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0218 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0219 := ($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0220 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
p0221 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
p0222 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
p0223 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)))));
p0224 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)))));
p0225 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)))));
p0226 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
p0227 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
p0228 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)))));
p0229 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
p0230 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
p0231 := (((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
p0232 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))));
p0233 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
p0234 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
p0235 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
p0236 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
p0237 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
p0238 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
p0239 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))));
p0240 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
p0241 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
p0242 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))));
p0243 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))));
p0244 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0245 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0246 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0247 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0248 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0249 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0250 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0251 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0252 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0253 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0254 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0255 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0256 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0257 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0258 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0259 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0260 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0261 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0262 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0263 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0264 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0265 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0266 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0267 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0268 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0269 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0270 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0271 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0272 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0273 := ((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0274 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0275 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0276 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0277 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0278 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0279 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0280 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0281 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0282 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0283 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0284 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0285 := ((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0286 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0287 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0288 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))));
p0289 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0290 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))));
p0291 := ((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))));
p0292 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0293 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0294 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0295 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0296 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0297 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0298 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0299 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0300 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0301 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0302 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0303 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0304 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0305 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0306 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0307 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0308 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0309 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0310 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0311 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0312 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0313 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0314 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0315 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0316 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0317 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
...
p0319 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0320 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0321 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0322 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0323 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0324 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
...
p0326 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0327 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0328 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0329 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0330 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0331 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0332 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0333 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0334 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0335 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0336 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0337 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0338 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0339 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0340 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0341 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0342 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0343 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0344 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0345 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0346 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0347 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0348 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0349 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0350 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0351 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0352 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0353 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
...
p0355 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0356 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0357 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0358 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0359 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0360 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
...
p0362 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0363 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0364 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0365 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0366 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0367 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0368 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0369 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0370 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0371 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0372 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0373 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0374 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0375 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0376 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0377 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0378 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0379 := ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0380 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0381 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
p0382 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0383 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
p0384 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0385 := ((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))));
p0386 := ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0387 := ((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))));
p0388 := ((L#list_key < 2147483647));
p0389 := ((L#list_key < 2147483647));
p0390 := ((L#list_key < 2147483647));
p0391 := ((L#list_key < 2147483647));
p0392 := ((L#list_key < 4294967295));
p0393 := ((L#list_key < 4294967295));
p0394 := ((L#list_key < 4294967295));
p0395 := ((L#list_key < 4294967295));
p0396 := ((L#list_key >= 0));
p0397 := ((L#list_key >= 0));
p0398 := ((L#list_key >= 0));
p0399 := ((L#list_key >= 0));
p0400 := (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#list_key)));
p0401 := (($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) < L#list_key)));
p0402 := (($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) < L#list_key)));
p0403 := (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#list_key)));
p0404 := ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0405 := ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
...
p0407 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
p0408 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
p0409 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
p0410 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
p0411 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0412 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
...
p0414 := ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0415 := ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
p0416 := ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0417 := ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
...
p0419 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
p0420 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
p0421 := ((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
p0422 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
p0423 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0424 := ((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
...
p0426 := ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)))));
p0427 := ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)))));
p0428 := ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#list_key));
p0429 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) == L#list_key));
p0430 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) == L#list_key));
p0431 := ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#list_key));
p0432 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key));
p0433 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key));
p0434 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key));
p0435 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key));
p0436 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key));
p0437 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key));
p0438 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key));
p0439 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key));
p0440 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key));
p0441 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key));
p0442 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key));
p0443 := ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key));
p0444 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key));
p0445 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key));
p0446 := (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key));
p0447 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key));
p0448 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key));
p0449 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key));
p0450 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key));
p0451 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key));
p0452 := (((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key));
p0453 := (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key));
p0454 := (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key));
p0455 := (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key));
...
(F#sll($s,$phys_ptr_cast(L#new_list,^s_node))), 
(F#sll($s,$phys_ptr_cast(L#last,^s_node))), 
(F#sll($s,$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#new_list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($non_null($phys_ptr_cast(P#list,^s_node))), 
($non_null($phys_ptr_cast(L#new_list,^s_node))), 
($non_null($phys_ptr_cast(L#last,^s_node))), 
($non_null($phys_ptr_cast(local.list,^s_node))), 
($is_null($phys_ptr_cast(P#list,^s_node))), 
($is_null($phys_ptr_cast(L#new_list,^s_node))), 
($is_null($phys_ptr_cast(L#last,^s_node))), 
($is_null($phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#new_list,^s_node))), 
(($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#last,^s_node))), 
(($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(P#list,^s_node))), 
(($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(L#last,^s_node))), 
(($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(P#list,^s_node))), 
(($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(L#new_list,^s_node))), 
(($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(local.list,^s_node))), 
(($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))), 
(($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#new_list,^s_node))), 
(($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#last,^s_node))), 
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#new_list,^s_node),^s_node)))), 
...
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#new_list,^s_node),^s_node)))), 
...
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
...
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#new_list,^s_node),^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#new_list,^s_node),^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#new_list,^s_node),^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#last,^s_node),^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#last,^s_node),^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#last,^s_node),^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
...
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.list,^s_node),^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.list,^s_node),^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#new_list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#last,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($oset_in($phys_ptr_cast(local.list,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(local.list,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(L#last,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#new_list,^s_node) == $phys_ptr_cast(L#last,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(P#list,^s_node)))), 
(($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#last,^s_node) == $phys_ptr_cast(L#new_list,^s_node)))), 
((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))))), 
((!($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))))), 
($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))), 
($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))), 
($intset_in(L#list_key,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
...
($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
($intset_in(L#list_key,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))), 
(((!($intset_in(L#list_key,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)))), 
((F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
...
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
...
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
...
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
...
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#new_list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#last,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#last,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#new_list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#last,^s_node))))), 
((L#list_key < 2147483647)), 
((L#list_key < 2147483647)), 
((L#list_key < 2147483647)), 
((L#list_key < 2147483647)), 
((L#list_key < 4294967295)), 
((L#list_key < 4294967295)), 
((L#list_key < 4294967295)), 
((L#list_key < 4294967295)), 
((L#list_key >= 0)), 
...
((L#list_key >= 0)), 
((L#list_key >= 0)), 
(($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#list_key))), 
(($non_null($phys_ptr_cast(L#new_list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) < L#list_key))), 
(($non_null($phys_ptr_cast(L#last,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) < L#list_key))), 
(($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#list_key))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))), 
...
((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))), 
((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))), 
((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))), 
((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))), 
((($non_null($phys_ptr_cast(L#last,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
...
((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))), 
((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))), 
((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node))))), 
((($non_null($phys_ptr_cast(L#new_list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node))))), 
...
((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#new_list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#new_list,^s_node))))), 
((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(L#last,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#last,^s_node))))), 
((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#list_key)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) == L#list_key)), 
((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#new_list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#new_list,^s_node)) == L#list_key)), 
((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#last,^s_node)) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#new_list,^s_node))) == L#list_key)), 
(((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#last,^s_node))) == L#list_key)), 
true ) ;
