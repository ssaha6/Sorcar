...
invariant b0140 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0141 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0142 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0143 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0144 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0145 ==> ((!($oset_in($phys_ptr_cast(P#list,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0146 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0147 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0148 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0149 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0150 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0151 ==> ((!($oset_in($phys_ptr_cast(L#last_prev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0152 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0153 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0154 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0155 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant b0156 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0157 ==> ((!($oset_in($phys_ptr_cast(L#last,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0158 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0159 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0160 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0161 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))))));
invariant b0162 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0163 ==> ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))))));
invariant b0164 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0165 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0166 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0167 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0168 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0169 ==> (($is_null($phys_ptr_cast(P#list,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0170 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0171 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0172 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0173 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0174 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0175 ==> (($is_null($phys_ptr_cast(L#last_prev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0176 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0177 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0178 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0179 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant b0180 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0181 ==> (($is_null($phys_ptr_cast(L#last,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0182 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0183 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0184 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0185 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#last_prev,^d_node) == $phys_ptr_cast(L#last,^d_node))));
invariant b0186 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0187 ==> (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#last,^d_node) == $phys_ptr_cast(L#last_prev,^d_node))));
invariant b0188 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0189 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last,^d_node))));
invariant b0190 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node))));
invariant b0191 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0192 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last,^d_node))));
invariant b0193 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node))));
invariant b0194 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0195 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0196 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node))));
invariant b0197 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0198 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0199 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_keys($s,$phys_ptr_cast(L#last,^d_node))));
invariant b0200 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0201 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0202 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0203 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0204 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0205 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0206 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0207 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0208 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0209 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0210 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0211 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0212 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0213 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0214 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0215 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0216 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0217 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0218 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0219 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0220 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0221 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0222 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0223 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0224 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0225 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0226 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0227 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0228 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0229 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0230 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0231 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0232 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0233 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0234 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0235 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0236 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0237 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0238 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant b0239 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0240 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0241 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#curr,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0242 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0243 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0244 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last,^d_node))));
invariant b0245 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last_prev,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0246 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(L#last_prev,^d_node))));
invariant b0247 ==> ((F#dll_lseg_keys($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#last,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(L#last_prev,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0248 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0249 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0250 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0251 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0252 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0253 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0254 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0255 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0256 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0257 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0258 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0259 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0260 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0261 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0262 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0263 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0264 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0265 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0266 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0267 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0268 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0269 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0270 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0271 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0272 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0273 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0274 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0275 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0276 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0277 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0278 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0279 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0280 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0281 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0282 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0283 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0284 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0285 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0286 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0287 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0288 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0289 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0290 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0291 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0292 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0293 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0294 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0295 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0296 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0297 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0298 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0299 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0300 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0301 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0302 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0303 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0304 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0305 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0306 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0307 ==> ((F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0308 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0309 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0310 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0311 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0312 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0313 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0314 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0315 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0316 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0317 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0318 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0319 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0320 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0321 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0322 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0323 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0324 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0325 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0326 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0327 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0328 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0329 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0330 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0331 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last_prev,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0332 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0333 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0334 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0335 ==> ((F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0336 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0337 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#last,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0338 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0339 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0340 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0341 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0342 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0343 ==> ((F#dll_keys($s,$phys_ptr_cast(L#last_prev,^d_node)) == $intset_union(F#dll_keys(loopState#22,$phys_ptr_cast(L#curr,^d_node)),F#dll_keys($s,$phys_ptr_cast(L#last,^d_node)))));
invariant b0344 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0345 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
invariant b0346 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0347 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0348 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
invariant b0349 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0350 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0351 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0352 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0353 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0354 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0355 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
invariant b0356 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0357 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
invariant b0358 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0359 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0360 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
invariant b0361 ==> ((($non_null($phys_ptr_cast(L#last_prev,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0362 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0363 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0364 ==> ((($non_null($phys_ptr_cast(L#last,^d_node)) && $non_null($phys_ptr_cast(L#curr,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0365 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0366 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(L#last_prev,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last_prev,^d_node)))));
invariant b0367 ==> ((($non_null($phys_ptr_cast(L#curr,^d_node)) && $non_null($phys_ptr_cast(L#last,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(L#curr,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(L#last,^d_node)))));
