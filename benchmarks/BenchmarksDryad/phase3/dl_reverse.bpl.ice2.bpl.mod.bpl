...
p0063 := ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
p0064 := ((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
p0065 := ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
p0066 := ((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
p0067 := ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
p0068 := ((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
p0069 := (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#rev,^d_node))));
p0070 := (($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
p0071 := (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#rev,^d_node))));
p0072 := (($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
p0073 := (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
p0074 := (($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
...
(F#dll($s,$phys_ptr_cast(L#rev,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node))), 
(F#dll_lseg($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
...
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
...
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))), 
($non_null($phys_ptr_cast(P#lst,^d_node))), 
($non_null($phys_ptr_cast(L#curr,^d_node))), 
($non_null($phys_ptr_cast(L#rev,^d_node))), 
($is_null($phys_ptr_cast(P#lst,^d_node))), 
($is_null($phys_ptr_cast(L#curr,^d_node))), 
($is_null($phys_ptr_cast(L#rev,^d_node))), 
(($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node))), 
(($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#rev,^d_node))), 
(($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node))), 
(($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#rev,^d_node))), 
(($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(P#lst,^d_node))), 
(($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(L#curr,^d_node))), 
...
(($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#rev,^d_node),^d_node)))), 
...
(($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#rev,^d_node),^d_node)))), 
...
(($non_null($phys_ptr_cast(P#lst,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#lst,^d_node),^d_node) == $phys_ptr_cast(L#rev,^d_node)))), 
...
(($non_null($phys_ptr_cast(L#curr,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#curr,^d_node),^d_node) == $phys_ptr_cast(L#rev,^d_node)))), 
(($non_null($phys_ptr_cast(L#rev,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#rev,^d_node),^d_node) == $phys_ptr_cast(P#lst,^d_node)))), 
(($non_null($phys_ptr_cast(L#rev,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#rev,^d_node),^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)))))), 
((!($oset_in($phys_ptr_cast(P#lst,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))))), 
((!($oset_in($phys_ptr_cast(L#rev,^d_node),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))))), 
(($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#rev,^d_node)))), 
(($is_null($phys_ptr_cast(P#lst,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#rev,^d_node)))), 
(($is_null($phys_ptr_cast(L#curr,^d_node)) ==> ($phys_ptr_cast(L#rev,^d_node) == $phys_ptr_cast(P#lst,^d_node)))), 
(($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node)))), 
(($is_null($phys_ptr_cast(L#rev,^d_node)) ==> ($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node)))), 
true ) ;
