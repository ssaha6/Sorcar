...
p0005 := ((!($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))))));
p0006 := ((!($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))))));
p0007 := ($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))));
p0008 := ($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))));
p0009 := ((P#sz < 2147483647));
p0010 := ((local.sz < 2147483647));
p0011 := ((P#sz < 4294967295));
p0012 := ((local.sz < 4294967295));
p0013 := ((P#sz >= 0));
p0014 := ((local.sz >= 0));
p0015 := (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < P#sz)));
p0016 := (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < local.sz)));
p0017 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == P#sz));
p0018 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == local.sz));
p0019 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (P#sz - local.sz)));
p0020 := ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (local.sz - P#sz)));
...
invariant (p0005 == ((!($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))))));
invariant (p0006 == ((!($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))))));
invariant (p0007 == ($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))));
invariant (p0008 == ($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))));
invariant (p0009 == ((P#sz < 2147483647)));
invariant (p0010 == ((local.sz < 2147483647)));
invariant (p0011 == ((P#sz < 4294967295)));
invariant (p0012 == ((local.sz < 4294967295)));
invariant (p0013 == ((P#sz >= 0)));
invariant (p0014 == ((local.sz >= 0)));
invariant (p0015 == (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < P#sz))));
invariant (p0016 == (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < local.sz))));
invariant (p0017 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == P#sz)));
invariant (p0018 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == local.sz)));
invariant (p0019 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (P#sz - local.sz))));
invariant (p0020 == ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (local.sz - P#sz))));
