...
p0063 := ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
p0064 := ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node))))));
p0065 := ((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
p0066 := ((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
p0067 := ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node))))));
p0068 := ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
...
p0093 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0094 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0095 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0096 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0097 := ((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0098 := ((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0099 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0100 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0101 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0102 := ((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0103 := ((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0104 := ((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0105 := ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0106 := ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0107 := ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0108 := ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0109 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0110 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0111 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
p0112 := ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0113 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0114 := ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0115 := ((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0116 := ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)))));
...
(F#sll($s,$phys_ptr_cast(P#elt,^s_node))), 
(F#sll($s,$phys_ptr_cast(L#curr,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
...
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#elt,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#elt,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#elt,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)))), 
...
((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(L#curr,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#elt,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#elt,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(P#elt,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#elt,^s_node),$phys_ptr_cast(P#lst,^s_node)))))), 
...
((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(P#elt,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#50,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#elt,^s_node))))), 
