...
invariant (p0038 == (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0039 == (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0040 == (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0041 == (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))));
...
invariant (p0044 == ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0045 == ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0046 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0047 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0048 == ((P#n < 2147483647)));
invariant (p0049 == ((local.n < 2147483647)));
invariant (p0050 == ((P#n < 2147483647)));
invariant (p0051 == ((local.n < 2147483647)));
invariant (p0052 == ((P#n < 4294967295)));
invariant (p0053 == ((local.n < 4294967295)));
invariant (p0054 == ((P#n < 4294967295)));
invariant (p0055 == ((local.n < 4294967295)));
invariant (p0056 == ((P#n >= 0)));
invariant (p0057 == ((local.n >= 0)));
invariant (p0058 == ((P#n >= 0)));
invariant (p0059 == ((local.n >= 0)));
invariant (p0060 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n))));
invariant (p0061 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n))));
invariant (p0062 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n))));
invariant (p0063 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n))));
...
invariant (p0068 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n)));
invariant (p0069 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n)));
invariant (p0070 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n)));
invariant (p0071 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n)));
invariant (p0072 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n)));
invariant (p0073 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n)));
invariant (p0074 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n)));
invariant (p0075 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n)));
invariant (p0076 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n))));
invariant (p0077 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n))));
invariant (p0078 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n))));
invariant (p0079 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n))));
invariant (p0080 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n))));
invariant (p0081 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n))));
invariant (p0082 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n))));
invariant (p0083 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n))));
invariant (p0084 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n)));
invariant (p0085 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n)));
invariant (p0086 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n)));
invariant (p0087 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n)));
invariant (p0088 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n))));
invariant (p0089 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n))));
invariant (p0090 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n))));
invariant (p0091 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n))));
