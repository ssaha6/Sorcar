...
p0038 := (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)))));
p0039 := (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)))));
p0040 := (((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)))));
p0041 := (((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)))));
...
p0044 := ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0045 := ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0046 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0047 := ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0048 := ((P#n < 2147483647));
p0049 := ((local.n < 2147483647));
p0050 := ((P#n < 2147483647));
p0051 := ((local.n < 2147483647));
p0052 := ((P#n < 4294967295));
p0053 := ((local.n < 4294967295));
p0054 := ((P#n < 4294967295));
p0055 := ((local.n < 4294967295));
p0056 := ((P#n >= 0));
p0057 := ((local.n >= 0));
p0058 := ((P#n >= 0));
p0059 := ((local.n >= 0));
p0060 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n)));
p0061 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n)));
p0062 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n)));
p0063 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n)));
...
p0068 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n));
p0069 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n));
p0070 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n));
p0071 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n));
p0072 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n));
p0073 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n));
p0074 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n));
p0075 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n));
p0076 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
p0077 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
p0078 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
p0079 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
p0080 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
p0081 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
p0082 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
p0083 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
p0084 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n));
p0085 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n));
p0086 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n));
p0087 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n));
p0088 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n)));
p0089 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n)));
p0090 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n)));
p0091 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n)));
...
($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))), 
($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))), 
(((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))), 
(((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node))))), 
(((!($intset_in(P#n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))), 
(((!($intset_in(local.n,F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node))))), 
...
((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))), 
((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((P#n < 2147483647)), 
((local.n < 2147483647)), 
((P#n < 2147483647)), 
((local.n < 2147483647)), 
