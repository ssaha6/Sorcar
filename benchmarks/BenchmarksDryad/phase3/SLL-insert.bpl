...
invariant b0063 ==> ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))))));
invariant b0064 ==> ((!($oset_in($phys_ptr_cast(P#h,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))))));
invariant b0065 ==> ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))))));
invariant b0066 ==> ((!($oset_in($phys_ptr_cast(L#i,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))))));
invariant b0067 ==> ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))))));
invariant b0068 ==> ((!($oset_in($phys_ptr_cast(L#j,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))))));
...
invariant b0075 ==> ((!($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))))));
invariant b0076 ==> ((!($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))))));
invariant b0077 ==> ((!($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))))));
invariant b0078 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))))));
invariant b0079 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))))));
invariant b0080 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))))));
invariant b0081 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))))));
invariant b0082 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))))));
invariant b0083 ==> ((!($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))))));
invariant b0084 ==> ($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0085 ==> ($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0086 ==> ($intset_in(P#v,F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))));
invariant b0087 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0088 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0089 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0090 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0091 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0092 ==> ($intset_in(P#v,F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0093 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)))));
invariant b0094 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)))));
invariant b0095 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)))));
invariant b0096 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)))));
invariant b0097 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)))));
invariant b0098 ==> (((!($intset_in(P#v,F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)))));
invariant b0099 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0100 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))));
invariant b0101 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0102 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))));
invariant b0103 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0104 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0105 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0106 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0107 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0108 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0109 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0110 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0111 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0112 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0113 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0114 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0115 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0116 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0117 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0118 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0119 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0120 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0121 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0122 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0123 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0124 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0125 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0126 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0127 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0128 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0129 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0130 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0131 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0132 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0133 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0134 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0135 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0136 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#h,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0137 ==> ((F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0138 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#i,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0139 ==> ((F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0140 ==> ((F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#j,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0141 ==> ((P#v < 2147483647));
invariant b0142 ==> ((P#v < 2147483647));
invariant b0143 ==> ((P#v < 2147483647));
invariant b0144 ==> ((P#v < 4294967295));
invariant b0145 ==> ((P#v < 4294967295));
invariant b0146 ==> ((P#v < 4294967295));
invariant b0147 ==> ((P#v >= 0));
invariant b0148 ==> ((P#v >= 0));
invariant b0149 ==> ((P#v >= 0));
invariant b0150 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) < P#v)));
invariant b0151 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) < P#v)));
invariant b0152 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) < P#v)));
invariant b0153 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0154 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0155 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0156 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0157 ==> ((($non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0158 ==> ((($non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0159 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0160 ==> ((($non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0161 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0162 ==> ((($non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0163 ==> ((($non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0164 ==> ((($non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0165 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#h,^s_node)) <= P#v)));
invariant b0166 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#i,^s_node)) <= P#v)));
invariant b0167 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#j,^s_node)) <= P#v)));
invariant b0168 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) <= P#v)));
invariant b0169 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) <= P#v)));
invariant b0170 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) <= P#v)));
invariant b0171 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) <= P#v)));
invariant b0172 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) <= P#v)));
invariant b0173 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) <= P#v)));
invariant b0174 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (P#v <= F#sll_min_key($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0175 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (P#v <= F#sll_min_key($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0176 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (P#v <= F#sll_min_key($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0177 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0178 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0179 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0180 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0181 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0182 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node))) ==> (P#v <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0183 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0184 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0185 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0186 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0187 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0188 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0189 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0190 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0191 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0192 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0193 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0194 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0195 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0196 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0197 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0198 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0199 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0200 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0201 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0202 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0203 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0204 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0205 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0206 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0207 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0208 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0209 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0210 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0211 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0212 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0213 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0214 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(P#h,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0215 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#j,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0216 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && ($phys_ptr_cast(L#i,^s_node) != $phys_ptr_cast(L#j,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0217 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(P#h,^s_node)) && $non_null($phys_ptr_cast(L#i,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0218 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && ($phys_ptr_cast(L#j,^s_node) != $phys_ptr_cast(L#i,^s_node)) && $non_null($phys_ptr_cast(P#h,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0219 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) == P#v));
invariant b0220 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) == P#v));
invariant b0221 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#j,^s_node)) == P#v));
invariant b0222 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#v));
invariant b0223 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) == P#v));
invariant b0224 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#v));
invariant b0225 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) == P#v));
invariant b0226 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#v));
invariant b0227 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#v));
invariant b0228 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#v));
invariant b0229 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#j,^s_node))) == P#v));
invariant b0230 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#v));
invariant b0231 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#j,^s_node))) == P#v));
invariant b0232 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#j,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#h,^s_node))) == P#v));
invariant b0233 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#j,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#i,^s_node))) == P#v));
