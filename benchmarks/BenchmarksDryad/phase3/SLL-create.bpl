...
invariant b0005 ==> ((!($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))))));
invariant b0006 ==> ((!($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))))));
invariant b0007 ==> ($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))));
invariant b0008 ==> ($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node))));
invariant b0009 ==> ((P#sz < 2147483647));
invariant b0010 ==> ((local.sz < 2147483647));
invariant b0011 ==> ((P#sz < 4294967295));
invariant b0012 ==> ((local.sz < 4294967295));
invariant b0013 ==> ((P#sz >= 0));
invariant b0014 ==> ((local.sz >= 0));
invariant b0015 ==> (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < P#sz)));
invariant b0016 ==> (($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < local.sz)));
invariant b0017 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == P#sz));
invariant b0018 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == local.sz));
invariant b0019 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (P#sz - local.sz)));
invariant b0020 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (local.sz - P#sz)));
