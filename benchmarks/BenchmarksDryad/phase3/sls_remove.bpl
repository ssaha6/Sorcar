...
invariant b0140 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0141 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0142 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0143 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0144 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0145 ==> ((!($oset_in($phys_ptr_cast(P#lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0146 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0147 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0148 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0149 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0150 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0151 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0152 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0153 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0154 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0155 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0156 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0157 ==> ((!($oset_in($phys_ptr_cast(L#prv,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0158 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0159 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0160 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0161 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0162 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0163 ==> ((!($oset_in($phys_ptr_cast(local.lst,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0164 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0165 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0166 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0167 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0168 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0169 ==> (($is_null($phys_ptr_cast(P#lst,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0170 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0171 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0172 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0173 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0174 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0175 ==> (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0176 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0177 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0178 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0179 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant b0180 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0181 ==> (($is_null($phys_ptr_cast(L#prv,^s_node)) ==> ($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0182 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0183 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0184 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0185 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#prv,^s_node))));
invariant b0186 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0187 ==> (($is_null($phys_ptr_cast(local.lst,^s_node)) ==> ($phys_ptr_cast(L#prv,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0188 ==> ((!($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant b0189 ==> ((!($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant b0190 ==> ((!($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))))));
invariant b0191 ==> ((!($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))))));
invariant b0192 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0193 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0194 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0195 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0196 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0197 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0198 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0199 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0200 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant b0201 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant b0202 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0203 ==> ((!($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))))));
invariant b0204 ==> ($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0205 ==> ($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0206 ==> ($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0207 ==> ($intset_in(P#value,F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))));
invariant b0208 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0209 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0210 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0211 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0212 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0213 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0214 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0215 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0216 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0217 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0218 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0219 ==> ($intset_in(P#value,F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0220 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0221 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0222 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0223 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0224 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0225 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0226 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0227 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0228 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0229 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0230 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0231 ==> (((!($intset_in(P#value,F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0232 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0233 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0234 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))));
invariant b0235 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0236 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0237 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))));
invariant b0238 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0239 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0240 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))));
invariant b0241 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0242 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0243 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node))));
invariant b0244 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0245 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0246 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0247 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0248 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0249 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0250 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0251 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0252 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0253 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0254 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0255 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0256 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0257 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0258 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0259 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0260 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0261 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0262 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0263 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0264 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0265 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0266 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0267 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0268 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0269 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0270 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0271 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0272 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0273 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0274 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0275 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0276 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0277 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0278 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0279 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0280 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0281 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0282 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant b0283 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0284 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0285 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0286 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0287 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0288 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node))));
invariant b0289 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0290 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0291 ==> ((F#sll_lseg_keys($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant b0292 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0293 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0294 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0295 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0296 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0297 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0298 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0299 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0300 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0301 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0302 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0303 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0304 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0305 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0306 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0307 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0308 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0309 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0310 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0311 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0312 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0313 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0314 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0315 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0316 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0317 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0318 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0319 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0320 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0321 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0322 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0323 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0324 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0325 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0326 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0327 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0328 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0329 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0330 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0331 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0332 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0333 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0334 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0335 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0336 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0337 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0338 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0339 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0340 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0341 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0342 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0343 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0344 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0345 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0346 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0347 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0348 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0349 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0350 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0351 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0352 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0353 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0354 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0355 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0356 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0357 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0358 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0359 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0360 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0361 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0362 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0363 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0364 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0365 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0366 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0367 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0368 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0369 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0370 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0371 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0372 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0373 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0374 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0375 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0376 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0377 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0378 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0379 ==> ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0380 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0381 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#prv,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0382 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0383 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0384 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0385 ==> ((F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0386 ==> ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0387 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0388 ==> ((P#value < 2147483647));
invariant b0389 ==> ((P#value < 2147483647));
invariant b0390 ==> ((P#value < 2147483647));
invariant b0391 ==> ((P#value < 2147483647));
invariant b0392 ==> ((P#value < 4294967295));
invariant b0393 ==> ((P#value < 4294967295));
invariant b0394 ==> ((P#value < 4294967295));
invariant b0395 ==> ((P#value < 4294967295));
invariant b0396 ==> ((P#value >= 0));
invariant b0397 ==> ((P#value >= 0));
invariant b0398 ==> ((P#value >= 0));
invariant b0399 ==> ((P#value >= 0));
invariant b0400 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) < P#value)));
invariant b0401 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) < P#value)));
invariant b0402 ==> (($non_null($phys_ptr_cast(L#prv,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) < P#value)));
invariant b0403 ==> (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) < P#value)));
invariant b0404 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0405 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0406 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0407 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0408 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0409 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0410 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0411 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0412 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0413 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0414 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0415 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0416 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0417 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0418 ==> ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0419 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0420 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0421 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0422 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0423 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0424 ==> ((($non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0425 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0426 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0427 ==> ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0428 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= P#value)));
invariant b0429 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= P#value)));
invariant b0430 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prv,^s_node)) <= P#value)));
invariant b0431 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= P#value)));
invariant b0432 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= P#value)));
invariant b0433 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= P#value)));
invariant b0434 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= P#value)));
invariant b0435 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= P#value)));
invariant b0436 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= P#value)));
invariant b0437 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= P#value)));
invariant b0438 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= P#value)));
invariant b0439 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= P#value)));
invariant b0440 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= P#value)));
invariant b0441 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= P#value)));
invariant b0442 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= P#value)));
invariant b0443 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= P#value)));
invariant b0444 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (P#value <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0445 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (P#value <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0446 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (P#value <= F#sll_min_key($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0447 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (P#value <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0448 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0449 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0450 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0451 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0452 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0453 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0454 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0455 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0456 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0457 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0458 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0459 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node))) ==> (P#value <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0460 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0461 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0462 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0463 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0464 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0465 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0466 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0467 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0468 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0469 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0470 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0471 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0472 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0473 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0474 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0475 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0476 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0477 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0478 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0479 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0480 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
...
invariant b0482 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0483 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0484 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0485 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0486 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0487 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0488 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0489 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0490 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0491 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0492 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0493 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0494 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0495 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0496 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0497 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0498 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0499 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0500 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0501 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0502 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0503 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
...
invariant b0505 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0506 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0507 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0508 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0509 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0510 ==> (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0511 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0512 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0513 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0514 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0515 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0516 ==> (((F#srtl($s,$phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#prv,^s_node)))));
invariant b0517 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0518 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0519 ==> (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0520 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0521 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0522 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0523 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0524 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0525 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0526 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0527 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0528 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0529 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0530 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0531 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0532 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0533 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0534 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0535 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0536 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0537 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0538 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0539 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0540 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0541 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0542 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0543 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0544 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0545 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0546 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0547 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0548 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0549 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(L#prv,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
invariant b0550 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0551 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0552 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0553 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#prv,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#prv,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0554 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0555 ==> (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(L#prv,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)))));
invariant b0556 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node)) == P#value));
invariant b0557 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node)) == P#value));
invariant b0558 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node)) == P#value));
invariant b0559 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node)) == P#value));
invariant b0560 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == P#value));
invariant b0561 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == P#value));
invariant b0562 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) == P#value));
invariant b0563 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)) == P#value));
invariant b0564 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#prv,^s_node)) == P#value));
invariant b0565 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(local.lst,^s_node)) == P#value));
invariant b0566 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(P#lst,^s_node)) == P#value));
invariant b0567 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(L#curr,^s_node)) == P#value));
invariant b0568 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#prv,^s_node),$phys_ptr_cast(local.lst,^s_node)) == P#value));
invariant b0569 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) == P#value));
invariant b0570 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#curr,^s_node)) == P#value));
invariant b0571 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(L#prv,^s_node)) == P#value));
invariant b0572 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node))) == P#value));
invariant b0573 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node))) == P#value));
invariant b0574 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node))) == P#value));
invariant b0575 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node))) == P#value));
invariant b0576 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node))) == P#value));
invariant b0577 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node))) == P#value));
invariant b0578 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node))) == P#value));
invariant b0579 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node))) == P#value));
invariant b0580 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node))) == P#value));
invariant b0581 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#lst,^s_node))) == P#value));
invariant b0582 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#curr,^s_node))) == P#value));
invariant b0583 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.lst,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(L#prv,^s_node))) == P#value));
