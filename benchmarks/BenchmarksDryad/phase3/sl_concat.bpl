...
invariant b0063 ==> ((!($oset_in($phys_ptr_cast(P#a,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0064 ==> ((!($oset_in($phys_ptr_cast(P#a,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))))));
invariant b0065 ==> ((!($oset_in($phys_ptr_cast(P#b,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant b0066 ==> ((!($oset_in($phys_ptr_cast(P#b,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))))));
invariant b0067 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))))));
invariant b0068 ==> ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))))));
...
invariant b0093 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0094 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0095 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0096 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0097 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0098 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0099 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0100 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0101 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0102 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0103 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0104 ==> ((F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0105 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0106 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0107 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0108 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0109 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0110 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0111 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0112 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0113 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0114 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0115 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0116 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#46,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
