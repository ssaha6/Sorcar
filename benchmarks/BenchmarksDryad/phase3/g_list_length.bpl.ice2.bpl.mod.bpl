...
p0038 := (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)))));
p0039 := (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)))));
p0040 := (((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)))));
p0041 := (((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)))));
p0042 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
p0043 := ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
p0044 := ((F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0045 := ((F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0046 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0047 := ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0048 := ((P#data < 2147483647));
p0049 := ((L#length < 2147483647));
p0050 := ((P#data < 2147483647));
p0051 := ((L#length < 2147483647));
p0052 := ((P#data < 4294967295));
p0053 := ((L#length < 4294967295));
p0054 := ((P#data < 4294967295));
p0055 := ((L#length < 4294967295));
p0056 := ((P#data >= 0));
p0057 := ((L#length >= 0));
p0058 := ((P#data >= 0));
p0059 := ((L#length >= 0));
p0060 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#data)));
p0061 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < L#length)));
p0062 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#data)));
p0063 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < L#length)));
p0064 := ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
p0065 := ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
p0066 := ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
p0067 := ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
p0068 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#data));
p0069 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == L#length));
p0070 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#data));
p0071 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == L#length));
p0072 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#data));
p0073 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#length));
p0074 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#data));
p0075 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#length));
p0076 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length)));
p0077 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data)));
p0078 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length)));
p0079 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data)));
p0080 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length)));
p0081 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data)));
p0082 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length)));
p0083 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data)));
p0084 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#data));
p0085 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#length));
p0086 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#data));
p0087 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#length));
p0088 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#data - L#length)));
p0089 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (L#length - P#data)));
p0090 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#data - L#length)));
p0091 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (L#length - P#data)));
...
((!($intset_in(L#length,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))))), 
((!($intset_in(P#data,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))))), 
((!($intset_in(L#length,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))))), 
((!($intset_in(P#data,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))))), 
((!($intset_in(L#length,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))))), 
((!($intset_in(P#data,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))))), 
((!($intset_in(L#length,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))))), 
($intset_in(P#data,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))), 
($intset_in(L#length,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))), 
($intset_in(P#data,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))), 
($intset_in(L#length,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))), 
...
($intset_in(P#data,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))), 
($intset_in(L#length,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))), 
(((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))), 
(((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node))))), 
(((!($intset_in(P#data,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))), 
(((!($intset_in(L#length,F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))) ==> (F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node))))), 
...
((F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))), 
((F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))), 
((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#18,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))), 
((P#data < 2147483647)), 
((L#length < 2147483647)), 
((P#data < 2147483647)), 
((L#length < 2147483647)), 
...
(($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < L#length))), 
(($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#data))), 
(($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < L#length))), 
...
((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == L#length)), 
((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#data)), 
((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == L#length)), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#data)), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#length)), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#data)), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#length)), 
((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length))), 
((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data))), 
((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length))), 
((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data))), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#data - L#length))), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (L#length - P#data))), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#data - L#length))), 
((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (L#length - P#data))), 
(((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#data)), 
(((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#length)), 
(((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#data)), 
(((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#length)), 
(((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#data - L#length))), 
(((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (L#length - P#data))), 
(((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#data - L#length))), 
(((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (L#length - P#data))), 
true ) ;
