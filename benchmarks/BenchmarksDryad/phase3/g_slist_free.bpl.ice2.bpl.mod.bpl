...
p0022 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))));
p0023 := ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
p0024 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))));
p0025 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0026 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))));
p0027 := ((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0028 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)))));
p0029 := ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0030 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)))));
p0031 := ((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
...
invariant my_inv ((F#sll($s,$phys_ptr_cast(P#l,^s_node))), 
(F#sll($s,$phys_ptr_cast(L#x,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#x,^s_node))), 
(F#sll_lseg($s,$phys_ptr_cast(L#x,^s_node),$phys_ptr_cast(P#l,^s_node))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)))), 
($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)))), 
($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#x,^s_node),$phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)))), 
($non_null($phys_ptr_cast(P#l,^s_node))), 
($non_null($phys_ptr_cast(L#x,^s_node))), 
($is_null($phys_ptr_cast(P#l,^s_node))), 
($is_null($phys_ptr_cast(L#x,^s_node))), 
(($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#x,^s_node))), 
(($phys_ptr_cast(L#x,^s_node) == $phys_ptr_cast(P#l,^s_node))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#x,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#x,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#x,^s_node)))), 
(($non_null($phys_ptr_cast(L#x,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#x,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node))))), 
((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node))))), 
((($non_null($phys_ptr_cast(L#x,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))), 
true ) ;
