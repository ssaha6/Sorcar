...
invariant my_inv ((F#sll($s,$phys_ptr_cast(L#h,^s_node))), 
($non_null($phys_ptr_cast(L#h,^s_node))), 
($is_null($phys_ptr_cast(L#h,^s_node))), 
(($non_null($phys_ptr_cast(L#h,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#h,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#h,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#h,^s_node),^s_node)))), 
((!($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))))), 
((!($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))))), 
($intset_in(P#sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))), 
($intset_in(local.sz,F#sll_keys($s,$phys_ptr_cast(L#h,^s_node)))), 
((P#sz < 2147483647)), 
((local.sz < 2147483647)), 
...
((P#sz >= 0)), 
((local.sz >= 0)), 
(($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < P#sz))), 
(($non_null($phys_ptr_cast(L#h,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#h,^s_node)) < local.sz))), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == P#sz)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == local.sz)), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (P#sz - local.sz))), 
((F#sll_list_len_next($s,$phys_ptr_cast(L#h,^s_node)) == (local.sz - P#sz))), 
true ) ;
