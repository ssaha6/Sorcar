...
p0063 := ((!($oset_in($phys_ptr_cast(P#a,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
p0064 := ((!($oset_in($phys_ptr_cast(P#a,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))))));
p0065 := ((!($oset_in($phys_ptr_cast(P#b,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
p0066 := ((!($oset_in($phys_ptr_cast(P#b,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))))));
p0067 := ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))))));
p0068 := ((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))))));
p0069 := (($is_null($phys_ptr_cast(P#a,^s_node)) ==> ($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
p0070 := (($is_null($phys_ptr_cast(P#a,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#b,^s_node))));
p0071 := (($is_null($phys_ptr_cast(P#b,^s_node)) ==> ($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
p0072 := (($is_null($phys_ptr_cast(P#b,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#a,^s_node))));
p0073 := (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(P#b,^s_node))));
p0074 := (($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(P#a,^s_node))));
p0075 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))));
p0076 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
p0077 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))));
p0078 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
p0079 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))));
p0080 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))));
p0081 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))));
p0082 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))));
p0083 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))));
p0084 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))));
p0085 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))));
p0086 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))));
p0087 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0088 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0089 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0090 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0091 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0092 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0093 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0094 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0095 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0096 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0097 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0098 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0099 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0100 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0101 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0102 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0103 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0104 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0105 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0106 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0107 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0108 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0109 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0110 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0111 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0112 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0113 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0114 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0115 := ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
p0116 := ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
p0117 := ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0118 := ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0119 := ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0120 := ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0121 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0122 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0123 := ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0124 := ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0125 := ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0126 := ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0127 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0128 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0129 := (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0130 := (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0131 := (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0132 := (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0133 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0134 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0135 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0136 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0137 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0138 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0139 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0140 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0141 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0142 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0143 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0144 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0145 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
p0146 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
p0147 := (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node)))));
p0148 := (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node)))));
p0149 := (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node)))));
p0150 := (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node)))));
p0151 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
p0152 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
p0153 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
p0154 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0155 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
p0156 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0157 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
p0158 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
p0159 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
p0160 := (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0161 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
p0162 := (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0163 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
p0164 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
...
invariant my_inv ((F#srtl($s,$phys_ptr_cast(P#a,^s_node))), 
(F#srtl($s,$phys_ptr_cast(P#b,^s_node))), 
(F#srtl($s,$phys_ptr_cast(L#curr,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))), 
(F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))), 
($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))), 
($non_null($phys_ptr_cast(P#a,^s_node))), 
($non_null($phys_ptr_cast(P#b,^s_node))), 
($non_null($phys_ptr_cast(L#curr,^s_node))), 
($is_null($phys_ptr_cast(P#a,^s_node))), 
($is_null($phys_ptr_cast(P#b,^s_node))), 
($is_null($phys_ptr_cast(L#curr,^s_node))), 
(($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(P#b,^s_node))), 
(($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(L#curr,^s_node))), 
(($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(P#a,^s_node))), 
(($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(L#curr,^s_node))), 
(($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#a,^s_node))), 
(($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#b,^s_node))), 
(($non_null($phys_ptr_cast(P#a,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#a,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#b,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#b,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#a,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#a,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#b,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#b,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node)))), 
(($non_null($phys_ptr_cast(P#a,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#a,^s_node),^s_node) == $phys_ptr_cast(P#b,^s_node)))), 
(($non_null($phys_ptr_cast(P#a,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#a,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node)))), 
(($non_null($phys_ptr_cast(P#b,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#b,^s_node),^s_node) == $phys_ptr_cast(P#a,^s_node)))), 
(($non_null($phys_ptr_cast(P#b,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#b,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node)))), 
(($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(P#a,^s_node)))), 
(($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(P#b,^s_node)))), 
((!($oset_in($phys_ptr_cast(P#a,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#a,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))))), 
((!($oset_in($phys_ptr_cast(P#b,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))))), 
((!($oset_in($phys_ptr_cast(L#curr,^s_node),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))))), 
(($is_null($phys_ptr_cast(P#a,^s_node)) ==> ($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(L#curr,^s_node)))), 
(($is_null($phys_ptr_cast(P#a,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#b,^s_node)))), 
(($is_null($phys_ptr_cast(P#b,^s_node)) ==> ($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(L#curr,^s_node)))), 
(($is_null($phys_ptr_cast(P#b,^s_node)) ==> ($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#a,^s_node)))), 
(($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#a,^s_node) == $phys_ptr_cast(P#b,^s_node)))), 
(($is_null($phys_ptr_cast(L#curr,^s_node)) ==> ($phys_ptr_cast(P#b,^s_node) == $phys_ptr_cast(P#a,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))))), 
((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))))), 
((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))))), 
(((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))))), 
true ) ;
