...
invariant b0030 ==> (((!($intset_in(L#length,F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)))));
invariant b0031 ==> (((!($intset_in(L#length,F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node))))) ==> (F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)))));
invariant b0032 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0033 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0034 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0035 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0036 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0037 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0038 ==> ((L#length < 2147483647));
invariant b0039 ==> ((L#length < 2147483647));
invariant b0040 ==> ((L#length < 4294967295));
invariant b0041 ==> ((L#length < 4294967295));
invariant b0042 ==> ((L#length >= 0));
invariant b0043 ==> ((L#length >= 0));
invariant b0044 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#length)));
invariant b0045 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#length)));
...
invariant b0048 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0049 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0050 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#length));
invariant b0051 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#length));
invariant b0052 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#length));
invariant b0053 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#length));
invariant b0054 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#length));
invariant b0055 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#length));
