...
var {:source_name "t"} $$t$1: [int]int;

var {:source_name "t"} $$t$2: [int]int;
...
implementation {:source_name "wsm5_gpu"} {:kernel} $_Z8wsm5_gpuPfS_S_S_S_S_S_S_S_S_S_S_S_S_S_fS_iiiiiiiiiiiiiiiiii($delt: int, $ids: int, $ide: int, $jds: int, $jde: int, $kds: int, $kde: int, $ims: int, $ime: int, $jms: int, $jme: int, $kms: int, $kme: int, $ips: int, $ipe: int, $jps: int, $jpe: int, $kps: int, $kpe: int)
{
  var $k.0$1: int;
  var $k.0$2: int;
  var v0$1: bool;
  ...
  $0:
    v0$1 := BV32_ULT(BV32_SUB(BV32_ADD(BV32_ADD(local_id_x$1, BV32_MUL(group_id_x$1, group_size_x)), $ips), $ims), BV32_ADD(BV32_SUB($ide, $ids), 1));
    v0$2 := BV32_ULT(BV32_SUB(BV32_ADD(BV32_ADD(local_id_x$2, BV32_MUL(group_id_x$2, group_size_x)), $ips), $ims), BV32_ADD(BV32_SUB($ide, $ids), 1));
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    v1$1 := (if p0$1 then BV32_ULT(BV32_SUB(BV32_ADD(BV32_ADD(local_id_y$1, BV32_MUL(group_id_y$1, group_size_y)), $jps), $jms), BV32_ADD(BV32_SUB($jde, $jds), 1)) else v1$1);
    v1$2 := (if p0$2 then BV32_ULT(BV32_SUB(BV32_ADD(BV32_ADD(local_id_y$2, BV32_MUL(group_id_y$2, group_size_y)), $jps), $jms), BV32_ADD(BV32_SUB($jde, $jds), 1)) else v1$2);
    p1$1 := (if p0$1 && v1$1 then v1$1 else p1$1);
    p1$2 := (if p0$2 && v1$2 then v1$2 else p1$2);
    call {:sourceloc_num 3} v2$1, v2$2 := $pow(4778730805012725760, 4599676419421066581, p1$1, p1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$pow"} true;
    call {:sourceloc_num 4} v3$1, v3$2 := $pow(4608443426566832126, 4608683618675807573, p1$1, p1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$pow"} true;
    call {:sourceloc_num 5} v4$1, v4$2 := $pow(4557750909289998844, 4620693217682128896, p1$1, p1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$pow"} true;
    $k.0$1 := (if p1$1 then BV32_SUB($kps, 1) else $k.0$1);
    $k.0$2 := (if p1$2 then BV32_SUB($kps, 1) else $k.0$2);
  ...
  $3:
    ...
    v5$1 := (if p2$1 then BV32_SLE($k.0$1, BV32_SUB($kpe, 1)) else v5$1);
    v5$2 := (if p2$2 then BV32_SLE($k.0$2, BV32_SUB($kpe, 1)) else v5$2);
    p3$1 := false;
    p3$2 := false;
    ...
    $k.0$1 := (if p3$1 then BV32_ADD($k.0$1, 1) else $k.0$1);
    $k.0$2 := (if p3$2 then BV32_ADD($k.0$2, 1) else $k.0$2);
...
procedure {:source_name "pow"} $pow($0: int, $1: int, _P$1: bool, _P$2: bool) returns ($ret$1: int, $ret$2: int);
...
const _WATCHED_VALUE_$$th: int;

procedure {:inline 1} _LOG_READ_$$th(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$th;



implementation {:inline 1} _LOG_READ_$$th(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$th(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$th(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$th, _WRITE_READ_BENIGN_FLAG_$$th;



implementation {:inline 1} _LOG_WRITE_$$th(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$th(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$th(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$th;



implementation {:inline 1} _LOG_ATOMIC_$$th(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$th(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$th(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$th;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$th(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$pii: int;

procedure {:inline 1} _LOG_READ_$$pii(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$pii;



implementation {:inline 1} _LOG_READ_$$pii(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$pii(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$pii(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$pii, _WRITE_READ_BENIGN_FLAG_$$pii;



implementation {:inline 1} _LOG_WRITE_$$pii(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$pii(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$pii(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$pii;



implementation {:inline 1} _LOG_ATOMIC_$$pii(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$pii(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$pii(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$pii;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$pii(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$qc: int;

procedure {:inline 1} _LOG_READ_$$qc(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$qc;



implementation {:inline 1} _LOG_READ_$$qc(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$qc(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$qc(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$qc, _WRITE_READ_BENIGN_FLAG_$$qc;



implementation {:inline 1} _LOG_WRITE_$$qc(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$qc(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$qc(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$qc;



implementation {:inline 1} _LOG_ATOMIC_$$qc(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$qc(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qc(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$qc;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qc(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$qi: int;

procedure {:inline 1} _LOG_READ_$$qi(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$qi;



implementation {:inline 1} _LOG_READ_$$qi(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$qi(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$qi(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$qi, _WRITE_READ_BENIGN_FLAG_$$qi;



implementation {:inline 1} _LOG_WRITE_$$qi(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$qi(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$qi(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$qi;



implementation {:inline 1} _LOG_ATOMIC_$$qi(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$qi(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qi(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$qi;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qi(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$qr: int;

procedure {:inline 1} _LOG_READ_$$qr(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$qr;



implementation {:inline 1} _LOG_READ_$$qr(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$qr(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$qr(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$qr, _WRITE_READ_BENIGN_FLAG_$$qr;



implementation {:inline 1} _LOG_WRITE_$$qr(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$qr(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$qr(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$qr;



implementation {:inline 1} _LOG_ATOMIC_$$qr(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$qr(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qr(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$qr;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qr(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$qs: int;

procedure {:inline 1} _LOG_READ_$$qs(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$qs;



implementation {:inline 1} _LOG_READ_$$qs(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$qs(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$qs(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$qs, _WRITE_READ_BENIGN_FLAG_$$qs;



implementation {:inline 1} _LOG_WRITE_$$qs(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$qs(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$qs(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$qs;



implementation {:inline 1} _LOG_ATOMIC_$$qs(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$qs(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qs(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$qs;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$qs(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$den: int;

procedure {:inline 1} _LOG_READ_$$den(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$den;



implementation {:inline 1} _LOG_READ_$$den(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$den(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$den(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$den, _WRITE_READ_BENIGN_FLAG_$$den;



implementation {:inline 1} _LOG_WRITE_$$den(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$den(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$den(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$den;



implementation {:inline 1} _LOG_ATOMIC_$$den(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$den(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$den(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$den;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$den(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$delz: int;

procedure {:inline 1} _LOG_READ_$$delz(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$delz;



implementation {:inline 1} _LOG_READ_$$delz(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$delz(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$delz(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$delz, _WRITE_READ_BENIGN_FLAG_$$delz;



implementation {:inline 1} _LOG_WRITE_$$delz(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$delz(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$delz(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$delz;



implementation {:inline 1} _LOG_ATOMIC_$$delz(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$delz(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$delz(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$delz;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$delz(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$rain: int;

procedure {:inline 1} _LOG_READ_$$rain(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$rain;



implementation {:inline 1} _LOG_READ_$$rain(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$rain(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$rain(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$rain, _WRITE_READ_BENIGN_FLAG_$$rain;



implementation {:inline 1} _LOG_WRITE_$$rain(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$rain(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$rain(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$rain;



implementation {:inline 1} _LOG_ATOMIC_$$rain(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$rain(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$rain(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$rain;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$rain(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$rainncv: int;

procedure {:inline 1} _LOG_READ_$$rainncv(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$rainncv;



implementation {:inline 1} _LOG_READ_$$rainncv(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$rainncv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$rainncv(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$rainncv, _WRITE_READ_BENIGN_FLAG_$$rainncv;



implementation {:inline 1} _LOG_WRITE_$$rainncv(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$rainncv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$rainncv(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$rainncv;



implementation {:inline 1} _LOG_ATOMIC_$$rainncv(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$rainncv(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$rainncv(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$rainncv;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$rainncv(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$sr: int;

procedure {:inline 1} _LOG_READ_$$sr(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$sr;



implementation {:inline 1} _LOG_READ_$$sr(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$sr(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$sr(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$sr, _WRITE_READ_BENIGN_FLAG_$$sr;



implementation {:inline 1} _LOG_WRITE_$$sr(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$sr(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$sr(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$sr;



implementation {:inline 1} _LOG_ATOMIC_$$sr(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$sr(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$sr(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$sr;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$sr(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$snow: int;

procedure {:inline 1} _LOG_READ_$$snow(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$snow;



implementation {:inline 1} _LOG_READ_$$snow(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$snow(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$snow(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$snow, _WRITE_READ_BENIGN_FLAG_$$snow;



implementation {:inline 1} _LOG_WRITE_$$snow(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$snow(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$snow(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$snow;



implementation {:inline 1} _LOG_ATOMIC_$$snow(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$snow(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$snow(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$snow;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$snow(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$snowncv: int;

procedure {:inline 1} _LOG_READ_$$snowncv(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$snowncv;



implementation {:inline 1} _LOG_READ_$$snowncv(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$snowncv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$snowncv(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$snowncv, _WRITE_READ_BENIGN_FLAG_$$snowncv;



implementation {:inline 1} _LOG_WRITE_$$snowncv(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$snowncv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$snowncv(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$snowncv;



implementation {:inline 1} _LOG_ATOMIC_$$snowncv(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$snowncv(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$snowncv(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$snowncv;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$snowncv(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$retvals: int;

procedure {:inline 1} _LOG_READ_$$retvals(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$retvals;



implementation {:inline 1} _LOG_READ_$$retvals(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$retvals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$retvals(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$retvals, _WRITE_READ_BENIGN_FLAG_$$retvals;



implementation {:inline 1} _LOG_WRITE_$$retvals(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$retvals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$retvals(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$retvals;



implementation {:inline 1} _LOG_ATOMIC_$$retvals(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$retvals(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$retvals(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$retvals;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$retvals(_P: bool, _offset: int)
{
