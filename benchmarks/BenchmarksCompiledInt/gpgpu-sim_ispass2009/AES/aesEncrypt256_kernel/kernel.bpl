...
implementation {:source_name "aesEncrypt256"} {:kernel} $_Z13aesEncrypt256PjS_i($inputSize: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _WRITE_HAS_OCCURRED_$$_ZZ13aesEncrypt256PjS_iE10tBox3Block ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$_ZZ13aesEncrypt256PjS_iE10tBox2Block ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b6 ==> _WRITE_HAS_OCCURRED_$$_ZZ13aesEncrypt256PjS_iE10tBox1Block ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(BV32_ADD(0, local_id_x$1), 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 3) mod BV32_MUL(1, 4);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b5 ==> _WRITE_HAS_OCCURRED_$$_ZZ13aesEncrypt256PjS_iE10tBox0Block ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1;
