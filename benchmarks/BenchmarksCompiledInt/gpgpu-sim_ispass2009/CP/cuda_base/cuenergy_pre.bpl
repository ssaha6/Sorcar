...
{
  var $atomid.0: int;
  var $energyval.0$1: int;
  var $energyval.0$2: int;
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  var v1$2: int;
  ...
  $truebb:
    assume {:partition} v3;
    v4$1 := $$atominfo$1[BV32_MUL($atomid.0, 4)];
    v4$2 := $$atominfo$2[BV32_MUL($atomid.0, 4)];
    v5$1 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v0$1)), v4$1);
    v5$2 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v0$2)), v4$2);
    v6$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4), 1)];
    v6$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4), 1)];
    v7$1 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v1$1)), v6$1);
    v7$2 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v1$2)), v6$2);
    v8$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4), 2)];
    v8$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4), 2)];
    v9$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4), 3)];
    v9$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4), 3)];
    $atomid.0, $energyval.0$1 := BV32_ADD($atomid.0, 1), FADD32($energyval.0$1, FMUL32(v9$1, FDIV32(1065353216, FSQRT32(FADD32(FADD32(FMUL32(v5$1, v5$1), FMUL32(v7$1, v7$1)), v8$1)))));
    $energyval.0$2 := FADD32($energyval.0$2, FMUL32(v9$2, FDIV32(1065353216, FSQRT32(FADD32(FADD32(FMUL32(v5$2, v5$2), FMUL32(v7$2, v7$2)), v8$2)))));
