...
implementation {:source_name "executeThirdLayer"} {:kernel} $_Z17executeThirdLayerPfS_S_()
{
  ...
  $0:
    v0$1 := BV32_MUL(group_id_x$1, 1251);
    v0$2 := BV32_MUL(group_id_x$2, 1251);
    havoc v1$1, v1$2;
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$1, BV32_MUL(100, group_id_y$1)), FP64_CONV32(FMUL64(4610406545773251946, FP32_CONV64(v5$1))), $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$1, BV32_MUL(100, group_id_y$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$2, BV32_MUL(100, group_id_y$2)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$2, BV32_MUL(100, group_id_y$2)), FP64_CONV32(FMUL64(4610406545773251946, FP32_CONV64(v5$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$Layer4_Neurons_GPU"} true;
    $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$1, BV32_MUL(100, group_id_y$1))] := FP64_CONV32(FMUL64(4610406545773251946, FP32_CONV64(v5$1)));
    $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$2, BV32_MUL(100, group_id_y$2))] := FP64_CONV32(FMUL64(4610406545773251946, FP32_CONV64(v5$2)));
    return;
...
const _WATCHED_VALUE_$$Layer3_Weights_GPU: int;

procedure {:inline 1} _LOG_READ_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_READ_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU, _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU(_P: bool, _offset: int)
{
