...
implementation {:source_name "Pathcalc_Portfolio_KernelGPU"} {:kernel} $_Z28Pathcalc_Portfolio_KernelGPUPfS_()
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$d_Lb ==> _WATCHED_OFFSET mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) mod BV32_MUL(group_size_x, num_groups_x);
