...
var {:source_name "B_b.i"} $$B_b.i$1: [int]int;

var {:source_name "B_b.i"} $$B_b.i$2: [int]int;

axiom {:array_info "$$B_b.i"} {:elem_width 32} {:source_name "B_b.i"} {:source_elem_width 32} {:source_dimensions "40"} true;

var {:source_name "S_b.i"} $$S_b.i$1: [int]int;

var {:source_name "S_b.i"} $$S_b.i$2: [int]int;
...
var {:source_name "L2"} $$L2$1: [int]int;

var {:source_name "L2"} $$L2$2: [int]int;
...
assert  my_inv (  ( p0$1 ==> $path.0$1 mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) mod BV32_MUL(group_size_x, num_groups_x) )  && ( p0$2 ==> $path.0$2 mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2) mod BV32_MUL(group_size_x, num_groups_x) ) ,  ( p0$1 ==> BV32_SLE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SLE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SGE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SGE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_ULE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_ULE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_UGE($path.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_UGE($path.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  (  BV32_SLT($path.0$1, 4096) ==> p0$1 )  && (  BV32_SLT($path.0$2, 4096) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$d_v ==> _WATCHED_OFFSET mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) mod BV32_MUL(group_size_x, num_groups_x) ) ,  (  _WRITE_HAS_OCCURRED_$$d_Lb ==> _WATCHED_OFFSET mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) mod BV32_MUL(group_size_x, num_groups_x) )  ); 
  ...
  $3.tail:
    assume !p2$1 && !p2$2;
    $i.i.0$1 := (if p1$1 then 0 else $i.i.0$1);
    $i.i.0$2 := (if p1$2 then 0 else $i.i.0$2);
  ...
  $7:
    ...
    v3$1 := (if p4$1 then $$N$1[0] else v3$1);
    v3$2 := (if p4$2 then $$N$2[0] else v3$2);
    ...
    $i.i.0$1 := (if p5$1 then BV32_ADD($i.i.0$1, 1) else $i.i.0$1);
    $i.i.0$2 := (if p5$2 then BV32_ADD($i.i.0$2, 1) else $i.i.0$2);
  ...
  $10:
    ...
    v6$1 := (if p6$1 then $$Nmat$1[0] else v6$1);
    v6$2 := (if p6$2 then $$Nmat$2[0] else v6$2);
    ...
    v8$1 := (if p7$1 then $$delta$1[0] else v8$1);
    v8$2 := (if p7$2 then $$delta$2[0] else v8$2);
    v9$1 := (if p7$1 then $$z$1[$n.i.0$1] else v9$1);
    v9$2 := (if p7$2 then $$z$2[$n.i.0$2] else v9$2);
    $i.i.1$1, $v.i.0$1 := (if p7$1 then BV32_ADD($n.i.0$1, 1) else $i.i.1$1), (if p7$1 then 0 else $v.i.0$1);
    $i.i.1$2, $v.i.0$2 := (if p7$2 then BV32_ADD($n.i.0$2, 1) else $i.i.1$2), (if p7$2 then 0 else $v.i.0$2);
  ...
  $12:
    ...
    v10$1 := (if p8$1 then $$N$1[0] else v10$1);
    v10$2 := (if p8$2 then $$N$2[0] else v10$2);
    ...
    v12$1 := (if p9$1 then $$lambda$1[BV32_SUB(BV32_SUB($i.i.1$1, $n.i.0$1), 1)] else v12$1);
    v12$2 := (if p9$2 then $$lambda$2[BV32_SUB(BV32_SUB($i.i.1$2, $n.i.0$2), 1)] else v12$2);
    v13$1 := (if p9$1 then $$delta$1[0] else v13$1);
    v13$2 := (if p9$2 then $$delta$2[0] else v13$2);
    ...
    v16$1 := (if p9$1 then $$delta$1[0] else v16$1);
    v16$2 := (if p9$2 then $$delta$2[0] else v16$2);
    v17$1 := (if p9$1 then $$L$1[$i.i.1$1] else v17$1);
    v17$2 := (if p9$2 then $$L$2[$i.i.1$2] else v17$2);
    call {:sourceloc_num 29} v18$1, v18$2 := $__fdividef(p9$1, FMUL32(v14$1, v15$1), FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v16$1, v17$1)))), p9$2, FMUL32(v14$2, v15$2), FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v16$2, v17$2)))));
    ...
    call {:sourceloc_num 30} v20$1, v20$2 := $__expf(p9$1, FP64_CONV32(FADD64(FP32_CONV64(FMUL32(v14$1, v19$1)), FMUL64(FP32_CONV64(v12$1), FSUB64(FP32_CONV64(FP64_CONV32(FMUL64(FSQRT64(FP32_CONV64(v8$1)), FP32_CONV64(v9$1)))), FMUL64(4602678819172646912, FP32_CONV64(v14$1)))))), p9$2, FP64_CONV32(FADD64(FP32_CONV64(FMUL32(v14$2, v19$2)), FMUL64(FP32_CONV64(v12$2), FSUB64(FP32_CONV64(FP64_CONV32(FMUL64(FSQRT64(FP32_CONV64(v8$2)), FP32_CONV64(v9$2)))), FMUL64(4602678819172646912, FP32_CONV64(v14$2)))))));
    ...
    v23$1 := (if p9$1 then $$N$1[0] else v23$1);
    v23$2 := (if p9$2 then $$N$2[0] else v23$2);
    $$L2$1[BV32_ADD($i.i.1$1, BV32_MUL(BV32_ADD($n.i.0$1, 1), v23$1))] := (if p9$1 then v22$1 else $$L2$1[BV32_ADD($i.i.1$1, BV32_MUL(BV32_ADD($n.i.0$1, 1), v23$1))]);
    $$L2$2[BV32_ADD($i.i.1$2, BV32_MUL(BV32_ADD($n.i.0$2, 1), v23$2))] := (if p9$2 then v22$2 else $$L2$2[BV32_ADD($i.i.1$2, BV32_MUL(BV32_ADD($n.i.0$2, 1), v23$2))]);
    $i.i.1$1, $v.i.0$1 := (if p9$1 then BV32_ADD($i.i.1$1, 1) else $i.i.1$1), (if p9$1 then v19$1 else $v.i.0$1);
    $i.i.1$2, $v.i.0$2 := (if p9$2 then BV32_ADD($i.i.1$2, 1) else $i.i.1$2), (if p9$2 then v19$2 else $v.i.0$2);
  ...
  $12.tail:
    assume !p8$1 && !p8$2;
    $n.i.0$1 := (if p7$1 then BV32_ADD($n.i.0$1, 1) else $n.i.0$1);
    $n.i.0$2 := (if p7$2 then BV32_ADD($n.i.0$2, 1) else $n.i.0$2);
  ...
  $10.tail:
    assume !p6$1 && !p6$2;
    $s.i.0$1, $b.i.0$1, $m.i.0$1 := (if p1$1 then 0 else $s.i.0$1), (if p1$1 then 1065353216 else $b.i.0$1), (if p1$1 then 0 else $m.i.0$1);
    $s.i.0$2, $b.i.0$2, $m.i.0$2 := (if p1$2 then 0 else $s.i.0$2), (if p1$2 then 1065353216 else $b.i.0$2), (if p1$2 then 0 else $m.i.0$2);
  ...
  $15:
    ...
    v24$1 := (if p10$1 then $$N$1[0] else v24$1);
    v24$2 := (if p10$2 then $$N$2[0] else v24$2);
    v25$1 := (if p10$1 then $$Nmat$1[0] else v25$1);
    v25$2 := (if p10$2 then $$Nmat$2[0] else v25$2);
    ...
    v27$1 := (if p11$1 then $$Nmat$1[0] else v27$1);
    v27$2 := (if p11$2 then $$Nmat$2[0] else v27$2);
    v28$1 := (if p11$1 then $$delta$1[0] else v28$1);
    v28$2 := (if p11$2 then $$delta$2[0] else v28$2);
    v29$1 := (if p11$1 then $$L$1[BV32_ADD($m.i.0$1, v27$1)] else v29$1);
    v29$2 := (if p11$2 then $$L$2[BV32_ADD($m.i.0$2, v27$2)] else v29$2);
    call {:sourceloc_num 45} v30$1, v30$2 := $__fdividef(p11$1, $b.i.0$1, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v28$1, v29$1)))), p11$2, $b.i.0$2, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v28$2, v29$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "$__fdividef"} true;
    v31$1 := (if p11$1 then $$delta$1[0] else v31$1);
    v31$2 := (if p11$2 then $$delta$2[0] else v31$2);
    ...
    $s.i.0$1, $b.i.0$1, $m.i.0$1 := (if p11$1 then v32$1 else $s.i.0$1), (if p11$1 then v30$1 else $b.i.0$1), (if p11$1 then BV32_ADD($m.i.0$1, 1) else $m.i.0$1);
    $s.i.0$2, $b.i.0$2, $m.i.0$2 := (if p11$2 then v32$2 else $s.i.0$2), (if p11$2 then v30$2 else $b.i.0$2), (if p11$2 then BV32_ADD($m.i.0$2, 1) else $m.i.0$2);
  ...
  $15.tail:
    assume !p10$1 && !p10$2;
    $m.i.1$1 := (if p1$1 then 0 else $m.i.1$1);
    $m.i.1$2 := (if p1$2 then 0 else $m.i.1$2);
  ...
  $18:
    ...
    v33$1 := (if p12$1 then $$N$1[0] else v33$1);
    v33$2 := (if p12$2 then $$N$2[0] else v33$2);
    v34$1 := (if p12$1 then $$Nmat$1[0] else v34$1);
    v34$2 := (if p12$2 then $$Nmat$2[0] else v34$2);
    ...
    $$B_b.i$1[$m.i.1$1] := (if p13$1 then 0 else $$B_b.i$1[$m.i.1$1]);
    $$B_b.i$2[$m.i.1$2] := (if p13$2 then 0 else $$B_b.i$2[$m.i.1$2]);
    $$S_b.i$1[$m.i.1$1] := (if p13$1 then 0 else $$S_b.i$1[$m.i.1$1]);
    $$S_b.i$2[$m.i.1$2] := (if p13$2 then 0 else $$S_b.i$2[$m.i.1$2]);
    $m.i.1$1 := (if p13$1 then BV32_ADD($m.i.1$1, 1) else $m.i.1$1);
    $m.i.1$2 := (if p13$2 then BV32_ADD($m.i.1$2, 1) else $m.i.1$2);
  ...
  $18.tail:
    assume !p12$1 && !p12$2;
    $n.i1.0$1, $v.i2.0$1 := (if p1$1 then 0 else $n.i1.0$1), (if p1$1 then 0 else $v.i2.0$1);
    $n.i1.0$2, $v.i2.0$2 := (if p1$2 then 0 else $n.i1.0$2), (if p1$2 then 0 else $v.i2.0$2);
  ...
  $21:
    ...
    v36$1 := (if p14$1 then $$Nopt$1[0] else v36$1);
    v36$2 := (if p14$2 then $$Nopt$2[0] else v36$2);
    ...
    v39$1 := (if p15$1 then BV32_SUB(v38$1, 1) else v39$1);
    v39$2 := (if p15$2 then BV32_SUB(v38$2, 1) else v39$2);
    ...
    v43$1 := (if p15$1 then FP64_CONV32(FSUB64(FP32_CONV64(FADD32(v40$1, FMUL32(v41$1, v42$1))), 4607182418800017408)) else v43$1);
    v43$2 := (if p15$2 then FP64_CONV32(FSUB64(FP32_CONV64(FADD32(v40$2, FMUL32(v41$2, v42$2))), 4607182418800017408)) else v43$2);
    v44$1 := (if p15$1 then FLT32(v43$1, 0) else v44$1);
    v44$2 := (if p15$2 then FLT32(v43$2, 0) else v44$2);
    ...
    $$S_b.i$1[v39$1] := (if p17$1 then FADD32(v46$1, FMUL32(-1027080192, v45$1)) else $$S_b.i$1[v39$1]);
    $$S_b.i$2[v39$2] := (if p17$2 then FADD32(v46$2, FMUL32(-1027080192, v45$2)) else $$S_b.i$2[v39$2]);
    v47$1 := (if p17$1 then $$B_b.i$1[v39$1] else v47$1);
    v47$2 := (if p17$2 then $$B_b.i$2[v39$2] else v47$2);
    $$B_b.i$1[v39$1] := (if p17$1 then FADD32(v47$1, -1027080192) else $$B_b.i$1[v39$1]);
    $$B_b.i$2[v39$2] := (if p17$2 then FADD32(v47$2, -1027080192) else $$B_b.i$2[v39$2]);
    $v.i2.1$1 := (if p17$1 then FADD32($v.i2.0$1, FMUL32(-1027080192, v43$1)) else $v.i2.1$1);
    $v.i2.1$2 := (if p17$2 then FADD32($v.i2.0$2, FMUL32(-1027080192, v43$2)) else $v.i2.1$2);
    $n.i1.0$1, $v.i2.0$1 := (if p15$1 then BV32_ADD($n.i1.0$1, 1) else $n.i1.0$1), (if p15$1 then $v.i2.1$1 else $v.i2.0$1);
    $n.i1.0$2, $v.i2.0$2 := (if p15$2 then BV32_ADD($n.i1.0$2, 1) else $n.i1.0$2), (if p15$2 then $v.i2.1$2 else $v.i2.0$2);
  ...
  $21.tail:
    assume !p14$1 && !p14$2;
    v48$1 := (if p1$1 then $$N$1[0] else v48$1);
    v48$2 := (if p1$2 then $$N$2[0] else v48$2);
    v49$1 := (if p1$1 then $$Nmat$1[0] else v49$1);
    v49$2 := (if p1$2 then $$Nmat$2[0] else v49$2);
    $m.i.2$1 := (if p1$1 then BV32_SUB(BV32_SUB(v48$1, v49$1), 1) else $m.i.2$1);
    $m.i.2$2 := (if p1$2 then BV32_SUB(BV32_SUB(v48$2, v49$2), 1) else $m.i.2$2);
  ...
  $26:
    ...
    v50$1 := (if p18$1 then BV32_SGE($m.i.2$1, 0) else v50$1);
    v50$2 := (if p18$2 then BV32_SGE($m.i.2$2, 0) else v50$2);
    p19$1 := false;
    p19$2 := false;
    p20$1 := false;
    p20$2 := false;
    ...
    v51$1 := (if p19$1 then $$Nmat$1[0] else v51$1);
    v51$2 := (if p19$2 then $$Nmat$2[0] else v51$2);
    v52$1 := (if p19$1 then BV32_ADD($m.i.2$1, v51$1) else v52$1);
    v52$2 := (if p19$2 then BV32_ADD($m.i.2$2, v51$2) else v52$2);
    v53$1 := (if p19$1 then $$delta$1[0] else v53$1);
    v53$2 := (if p19$2 then $$delta$2[0] else v53$2);
    ...
    v58$1 := (if p19$1 then $$delta$1[0] else v58$1);
    v58$2 := (if p19$2 then $$delta$2[0] else v58$2);
    v59$1 := (if p19$1 then $$delta$1[0] else v59$1);
    v59$2 := (if p19$2 then $$delta$2[0] else v59$2);
    v60$1 := (if p19$1 then $$L$1[v52$1] else v60$1);
    v60$2 := (if p19$2 then $$L$2[v52$2] else v60$2);
    call {:sourceloc_num 86} v61$1, v61$2 := $__fdividef(p19$1, v58$1, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v59$1, v60$1)))), p19$2, v58$2, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v59$2, v60$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "$__fdividef"} true;
    $$L$1[v52$1] := (if p19$1 then FMUL32(FMUL32(FSUB32(-2147483648, v56$1), v57$1), v61$1) else $$L$1[v52$1]);
    $$L$2[v52$2] := (if p19$2 then FMUL32(FMUL32(FSUB32(-2147483648, v56$2), v57$2), v61$2) else $$L$2[v52$2]);
    v62$1 := (if p19$1 then BV32_SGT($m.i.2$1, 0) else v62$1);
    v62$2 := (if p19$2 then BV32_SGT($m.i.2$2, 0) else v62$2);
    ...
    v64$1 := (if p21$1 then BV32_SUB($m.i.2$1, 1) else v64$1);
    v64$2 := (if p21$2 then BV32_SUB($m.i.2$2, 1) else v64$2);
    ...
    v67$1 := (if p21$1 then $$delta$1[0] else v67$1);
    v67$2 := (if p21$2 then $$delta$2[0] else v67$2);
    v68$1 := (if p21$1 then $$L$1[v52$1] else v68$1);
    v68$2 := (if p21$2 then $$L$2[v52$2] else v68$2);
    call {:sourceloc_num 95} v69$1, v69$2 := $__fdividef(p21$1, v66$1, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v67$1, v68$1)))), p21$2, v66$2, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v67$2, v68$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "$__fdividef"} true;
    v70$1 := (if p21$1 then BV32_SUB($m.i.2$1, 1) else v70$1);
    v70$2 := (if p21$2 then BV32_SUB($m.i.2$2, 1) else v70$2);
    ...
    $m.i.2$1 := (if p19$1 then BV32_ADD($m.i.2$1, -1) else $m.i.2$1);
    $m.i.2$2 := (if p19$2 then BV32_ADD($m.i.2$2, -1) else $m.i.2$2);
  ...
  $31:
    ...
    v72$1 := (if p22$1 then $$Nmat$1[0] else v72$1);
    v72$2 := (if p22$2 then $$Nmat$2[0] else v72$2);
    ...
    v74$1 := (if p23$1 then $$delta$1[0] else v74$1);
    v74$2 := (if p23$2 then $$delta$2[0] else v74$2);
    v75$1 := (if p23$1 then $$L$1[$n.i1.1$1] else v75$1);
    v75$2 := (if p23$2 then $$L$2[$n.i1.1$2] else v75$2);
    $b.i.1$1, $n.i1.1$1 := (if p23$1 then FP64_CONV32(FDIV64(FP32_CONV64($b.i.1$1), FADD64(4607182418800017408, FP32_CONV64(FMUL32(v74$1, v75$1))))) else $b.i.1$1), (if p23$1 then BV32_ADD($n.i1.1$1, 1) else $n.i1.1$1);
    $b.i.1$2, $n.i1.1$2 := (if p23$2 then FP64_CONV32(FDIV64(FP32_CONV64($b.i.1$2), FADD64(4607182418800017408, FP32_CONV64(FMUL32(v74$2, v75$2))))) else $b.i.1$2), (if p23$2 then BV32_ADD($n.i1.1$2, 1) else $n.i1.1$2);
  ...
  $31.tail:
    ...
    $n.i1.2$1 := (if p1$1 then 0 else $n.i1.2$1);
    $n.i1.2$2 := (if p1$2 then 0 else $n.i1.2$2);
  ...
  $34:
    ...
    v77$1 := (if p24$1 then $$Nmat$1[0] else v77$1);
    v77$2 := (if p24$2 then $$Nmat$2[0] else v77$2);
    ...
    v79$1 := (if p25$1 then $$delta$1[0] else v79$1);
    v79$2 := (if p25$2 then $$delta$2[0] else v79$2);
    v80$1 := (if p25$1 then $$delta$1[0] else v80$1);
    v80$2 := (if p25$2 then $$delta$2[0] else v80$2);
    v81$1 := (if p25$1 then $$L$1[$n.i1.2$1] else v81$1);
    v81$2 := (if p25$2 then $$L$2[$n.i1.2$2] else v81$2);
    $$L$1[$n.i1.2$1] := (if p25$1 then FP64_CONV32(FDIV64(FP32_CONV64(FMUL32(FSUB32(-2147483648, v76$1), v79$1)), FADD64(4607182418800017408, FP32_CONV64(FMUL32(v80$1, v81$1))))) else $$L$1[$n.i1.2$1]);
    $$L$2[$n.i1.2$2] := (if p25$2 then FP64_CONV32(FDIV64(FP32_CONV64(FMUL32(FSUB32(-2147483648, v76$2), v79$2)), FADD64(4607182418800017408, FP32_CONV64(FMUL32(v80$2, v81$2))))) else $$L$2[$n.i1.2$2]);
    $n.i1.2$1 := (if p25$1 then BV32_ADD($n.i1.2$1, 1) else $n.i1.2$1);
    $n.i1.2$2 := (if p25$2 then BV32_ADD($n.i1.2$2, 1) else $n.i1.2$2);
  ...
  $34.tail:
    assume !p24$1 && !p24$2;
    v82$1 := (if p1$1 then $$Nmat$1[0] else v82$1);
    v82$2 := (if p1$2 then $$Nmat$2[0] else v82$2);
  ...
  $37:
    ...
    v83$1 := (if p26$1 then $$N$1[0] else v83$1);
    v83$2 := (if p26$2 then $$N$2[0] else v83$2);
    ...
    $n.i1.3$1 := (if p27$1 then BV32_ADD($n.i1.3$1, 1) else $n.i1.3$1);
    $n.i1.3$2 := (if p27$2 then BV32_ADD($n.i1.3$2, 1) else $n.i1.3$2);
  ...
  $37.tail:
    ...
    v86$1 := (if p1$1 then $$Nmat$1[0] else v86$1);
    v86$2 := (if p1$2 then $$Nmat$2[0] else v86$2);
    $n.i4.0$1 := (if p1$1 then BV32_SUB(v86$1, 1) else $n.i4.0$1);
    $n.i4.0$2 := (if p1$2 then BV32_SUB(v86$2, 1) else $n.i4.0$2);
  ...
  $39:
    ...
    v87$1 := (if p28$1 then BV32_SGE($n.i4.0$1, 0) else v87$1);
    v87$2 := (if p28$2 then BV32_SGE($n.i4.0$2, 0) else v87$2);
    p29$1 := false;
    p29$2 := false;
    p30$1 := false;
    p30$2 := false;
    ...
    v88$1 := (if p29$1 then $$N$1[0] else v88$1);
    v88$2 := (if p29$2 then $$N$2[0] else v88$2);
    $v1.i.0$1, $i.i3.0$1 := (if p29$1 then 0 else $v1.i.0$1), (if p29$1 then BV32_SUB(v88$1, 1) else $i.i3.0$1);
    $v1.i.0$2, $i.i3.0$2 := (if p29$2 then 0 else $v1.i.0$2), (if p29$2 then BV32_SUB(v88$2, 1) else $i.i3.0$2);
  ...
  $41:
    ...
    v90$1 := (if p31$1 then $$lambda$1[BV32_SUB(BV32_SUB($i.i3.0$1, $n.i4.0$1), 1)] else v90$1);
    v90$2 := (if p31$2 then $$lambda$2[BV32_SUB(BV32_SUB($i.i3.0$2, $n.i4.0$2), 1)] else v90$2);
    v91$1 := (if p31$1 then $$N$1[0] else v91$1);
    v91$2 := (if p31$2 then $$N$2[0] else v91$2);
    v92$1 := (if p31$1 then $$L2$1[BV32_ADD($i.i3.0$1, BV32_MUL(BV32_ADD($n.i4.0$1, 1), v91$1))] else v92$1);
    v92$2 := (if p31$2 then $$L2$2[BV32_ADD($i.i3.0$2, BV32_MUL(BV32_ADD($n.i4.0$2, 1), v91$2))] else v92$2);
    ...
    v95$1 := (if p31$1 then $$delta$1[0] else v95$1);
    v95$2 := (if p31$2 then $$delta$2[0] else v95$2);
    v96$1 := (if p31$1 then $$delta$1[0] else v96$1);
    v96$2 := (if p31$2 then $$delta$2[0] else v96$2);
    v97$1 := (if p31$1 then $$N$1[0] else v97$1);
    v97$2 := (if p31$2 then $$N$2[0] else v97$2);
    ...
    call {:sourceloc_num 136} v99$1, v99$2 := $__fdividef(p31$1, v95$1, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v96$1, v98$1)))), p31$2, v95$2, FP64_CONV32(FADD64(4607182418800017408, FP32_CONV64(FMUL32(v96$2, v98$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "$__fdividef"} true;
    v100$1 := (if p31$1 then $$L$1[$i.i3.0$1] else v100$1);
    v100$2 := (if p31$2 then $$L$2[$i.i3.0$2] else v100$2);
    v101$1 := (if p31$1 then $$N$1[0] else v101$1);
    v101$2 := (if p31$2 then $$N$2[0] else v101$2);
    v102$1 := (if p31$1 then $$L2$1[BV32_ADD($i.i3.0$1, BV32_MUL(BV32_ADD($n.i4.0$1, 1), v101$1))] else v102$1);
    v102$2 := (if p31$2 then $$L2$2[BV32_ADD($i.i3.0$2, BV32_MUL(BV32_ADD($n.i4.0$2, 1), v101$2))] else v102$2);
    v103$1 := (if p31$1 then $$N$1[0] else v103$1);
    v103$2 := (if p31$2 then $$N$2[0] else v103$2);
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "$__fdividef"} true;
    v106$1 := (if p31$1 then $$lambda$1[BV32_SUB(BV32_SUB($i.i3.0$1, $n.i4.0$1), 1)] else v106$1);
    v106$2 := (if p31$2 then $$lambda$2[BV32_SUB(BV32_SUB($i.i3.0$2, $n.i4.0$2), 1)] else v106$2);
    ...
    $v1.i.0$1, $i.i3.0$1 := (if p31$1 then v94$1 else $v1.i.0$1), (if p31$1 then BV32_ADD($i.i3.0$1, -1) else $i.i3.0$1);
    $v1.i.0$2, $i.i3.0$2 := (if p31$2 then v94$2 else $v1.i.0$2), (if p31$2 then BV32_ADD($i.i3.0$2, -1) else $i.i3.0$2);
  ...
  $41.tail:
    assume !p30$1 && !p30$2;
    $n.i4.0$1 := (if p29$1 then BV32_ADD($n.i4.0$1, -1) else $n.i4.0$1);
    $n.i4.0$2 := (if p29$2 then BV32_ADD($n.i4.0$2, -1) else $n.i4.0$2);
  ...
  $39.tail:
    assume !p28$1 && !p28$2;
    v107$1 := (if p1$1 then $$L$1[79] else v107$1);
    v107$2 := (if p1$2 then $$L$2[79] else v107$2);
...
const _WATCHED_VALUE_$$d_Lb: int;

procedure {:inline 1} _LOG_READ_$$d_Lb(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$d_Lb;



implementation {:inline 1} _LOG_READ_$$d_Lb(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$d_Lb(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$d_Lb(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$d_Lb, _WRITE_READ_BENIGN_FLAG_$$d_Lb;



implementation {:inline 1} _LOG_WRITE_$$d_Lb(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$d_Lb(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$d_Lb(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$d_Lb;



implementation {:inline 1} _LOG_ATOMIC_$$d_Lb(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$d_Lb(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Lb(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$d_Lb;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Lb(_P: bool, _offset: int)
{
