...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_graph_mask$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_graph_mask ) ,  (  !p1$1 ==> _READ_HAS_OCCURRED_$$g_graph_visited$ghost$$3 == _READ_HAS_OCCURRED_$$g_graph_visited ) ,  (  _READ_HAS_OCCURRED_$$g_cost ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1) ) ,  (  !p1$1 ==> _READ_HAS_OCCURRED_$$g_cost$ghost$$3 == _READ_HAS_OCCURRED_$$g_cost ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_cost$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_cost ) ,  (  _WRITE_HAS_OCCURRED_$$g_over ==> _WATCHED_OFFSET == 0 ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_over$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_over )  ); 
...
assert  my_inv (  ( p2$1 ==> $i.0$1 mod 1 == v4$1 mod 1 )  && ( p2$2 ==> $i.0$2 mod 1 == v4$2 mod 1 ) ,  ( p2$1 ==> BV32_SLE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_SLE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_SGE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_SGE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_ULE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_ULE($i.0$2, v4$2) ) ,  ( p2$1 ==> BV32_UGE($i.0$1, v4$1) )  && ( p2$2 ==> BV32_UGE($i.0$2, v4$2) ) ,  ( p2$1 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) && BV_EXTRACT(v2$1, 1, 0) == 1 )  && ( p2$2 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256), local_id_x$2), $no_of_nodes) && BV_EXTRACT(v2$2, 1, 0) == 1 ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) && BV_EXTRACT(v2$1, 1, 0) == 1 && BV32_SLT($i.0$1, BV32_ADD(v5$1, v6$1)) ==> p2$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256), local_id_x$2), $no_of_nodes) && BV_EXTRACT(v2$2, 1, 0) == 1 && BV32_SLT($i.0$2, BV32_ADD(v5$2, v6$2)) ==> p2$2 ) ,  (  _READ_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) ) ,  (  _READ_HAS_OCCURRED_$$g_cost ==> BV_EXTRACT(v2$1, 1, 0) == 1 ) ,  (  _READ_HAS_OCCURRED_$$g_graph_visited ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) ) ,  (  _READ_HAS_OCCURRED_$$g_graph_visited ==> BV_EXTRACT(v2$1, 1, 0) == 1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_cost ==> BV_EXTRACT(v2$1, 1, 0) == 1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_graph_mask ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_graph_mask ==> BV_EXTRACT(v2$1, 1, 0) == 1 ) ,  (  _WRITE_HAS_OCCURRED_$$g_over ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) ) ,  (  _WRITE_HAS_OCCURRED_$$g_over ==> BV_EXTRACT(v2$1, 1, 0) == 1 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
