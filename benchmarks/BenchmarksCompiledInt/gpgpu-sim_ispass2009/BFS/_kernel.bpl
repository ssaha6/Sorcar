...
implementation {:source_name "Kernel"} {:kernel} $_Z6KernelP4NodePiPbS2_S1_S2_i($no_of_nodes: int)
{
  var $i.0$1: int;
  var $i.0$2: int;
  var v0$1: int;
  ...
  var p7$1: bool;
  var p7$2: bool;
  var _WRITE_HAS_OCCURRED_$$g_graph_mask$ghost$$3: bool;
  var _READ_HAS_OCCURRED_$$g_graph_visited$ghost$$3: bool;
  var _READ_HAS_OCCURRED_$$g_cost$ghost$$3: bool;
  var _WRITE_HAS_OCCURRED_$$g_cost$ghost$$3: bool;
  var _WRITE_HAS_OCCURRED_$$g_over$ghost$$3: bool;


  $0:
    v0$1 := BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1);
    v0$2 := BV32_ADD(BV32_MUL(group_id_x$2, 256), local_id_x$2);
    ...
    v3$1 := (if p0$1 then BV_EXTRACT(v2$1, 1, 0) == 1 else v3$1);
    v3$2 := (if p0$2 then BV_EXTRACT(v2$2, 1, 0) == 1 else v3$2);
    p1$1 := (if p0$1 && v3$1 then v3$1 else p1$1);
    p1$2 := (if p0$2 && v3$2 then v3$2 else p1$2);
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$g_graph_mask(p1$1, v0$1, 0, $$g_graph_mask[v0$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$g_graph_mask(p1$2, v0$2, 0);
    ...
    _WRITE_HAS_OCCURRED_$$g_graph_mask$ghost$$3 := _WRITE_HAS_OCCURRED_$$g_graph_mask;
    _READ_HAS_OCCURRED_$$g_graph_visited$ghost$$3 := _READ_HAS_OCCURRED_$$g_graph_visited;
    ...
    _WRITE_HAS_OCCURRED_$$g_over$ghost$$3 := _WRITE_HAS_OCCURRED_$$g_over;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $3;

  $3:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b23 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_over$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_over;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _WRITE_HAS_OCCURRED_$$g_over ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b21 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_cost$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b20 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$g_cost$ghost$$3 == _READ_HAS_OCCURRED_$$g_cost;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$g_cost ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1);
    assert {:tag "disabledMaintainsInstrumentation"} _b18 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$g_graph_visited$ghost$$3 == _READ_HAS_OCCURRED_$$g_graph_visited;
    assert {:tag "disabledMaintainsInstrumentation"} _b17 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_graph_mask$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_graph_mask;
    assume {:predicate "p2"} {:dominator_predicate "p1"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _WRITE_HAS_OCCURRED_$$g_over ==> BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$g_over ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$g_graph_mask ==> BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$g_graph_mask ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _WRITE_HAS_OCCURRED_$$g_cost ==> BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b11 ==> _WRITE_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b10 ==> _READ_HAS_OCCURRED_$$g_graph_visited ==> BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _READ_HAS_OCCURRED_$$g_graph_visited ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$g_cost ==> BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$g_cost ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) && BV_EXTRACT(v2$1, 1, 0) == 1 && BV32_SLT($i.0$1, BV32_ADD(v5$1, v6$1)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256), local_id_x$2), $no_of_nodes) && BV_EXTRACT(v2$2, 1, 0) == 1 && BV32_SLT($i.0$2, BV32_ADD(v5$2, v6$2)) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b5 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, 256), local_id_x$1), $no_of_nodes) && BV_EXTRACT(v2$1, 1, 0) == 1;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b5 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, 256), local_id_x$2), $no_of_nodes) && BV_EXTRACT(v2$2, 1, 0) == 1;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b0 ==> $i.0$1 mod 1 == v4$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b0 ==> $i.0$2 mod 1 == v4$2 mod 1;
    ...
    v10$1 := (if p3$1 then BV_EXTRACT(v9$1, 1, 0) == 1 else v10$1);
    v10$2 := (if p3$2 then BV_EXTRACT(v9$2, 1, 0) == 1 else v10$2);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 15} _CHECK_WRITE_$$g_cost(p4$2, v8$2, BV32_ADD(v11$2, 1));
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$g_graph_mask(p4$1, v8$1, 1, $$g_graph_mask[v8$1]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$g_graph_mask(p4$2, v8$2, 1);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_graph_mask"} true;
    $$g_graph_mask[v8$1] := (if p4$1 then 1 else $$g_graph_mask[v8$1]);
    $$g_graph_mask[v8$2] := (if p4$2 then 1 else $$g_graph_mask[v8$2]);
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$g_over(p4$1, 0, 1, $$g_over[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_over(p4$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$g_over(p4$2, 0, 1);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_over"} true;
    $$g_over[0] := (if p4$1 then 1 else $$g_over[0]);
    $$g_over[0] := (if p4$2 then 1 else $$g_over[0]);
