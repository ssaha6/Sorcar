...
implementation {:source_name "MaxwellsGPU_SURF_Kernel3D"} {:kernel} $_Z25MaxwellsGPU_SURF_Kernel3DPfS_()
{
  ...
  $7:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b10 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$_ZZ25MaxwellsGPU_SURF_Kernel3DPfS_E7s_fluxQ$ghost$$7 == _READ_HAS_OCCURRED_$$_ZZ25MaxwellsGPU_SURF_Kernel3DPfS_E7s_fluxQ;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _READ_HAS_OCCURRED_$$_ZZ25MaxwellsGPU_SURF_Kernel3DPfS_E7s_fluxQ ==> _WATCHED_OFFSET mod 4 == 0 mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 112) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 224) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 336) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 448) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 560) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 1) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 113) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 225) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 337) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 449) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 561) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 2) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 114) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 226) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 338) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 450) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 562) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 3) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 115) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 227) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 339) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 451) mod 4 || _WATCHED_OFFSET mod 4 == BV32_ADD(0, 563) mod 4;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ25MaxwellsGPU_SURF_Kernel3DPfS_E7s_fluxQ ==> BV32_SLT(local_id_x$1, 84);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLT(local_id_x$1, 84) && BV32_SUB(112, $m.0$1) != 0 ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLT(local_id_x$2, 84) && BV32_SUB(112, $m.0$2) != 0 ==> p5$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b6 ==> p5$1 ==> BV32_SLT(local_id_x$1, 84);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b6 ==> p5$2 ==> BV32_SLT(local_id_x$2, 84);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b5 ==> BV32_UGE($m.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b5 ==> BV32_UGE($m.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b4 ==> BV32_ULE($m.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b4 ==> BV32_ULE($m.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b3 ==> BV32_SGE($m.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b3 ==> BV32_SGE($m.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b2 ==> BV32_SLE($m.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b2 ==> BV32_SLE($m.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p5$1 ==> _b1 ==> $sk.0$1 mod 84 == local_id_x$1 mod 84;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p5$2 ==> _b1 ==> $sk.0$2 mod 84 == local_id_x$2 mod 84;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p5$1 ==> _b0 ==> $m.0$1 mod 4 == 0 mod 4;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p5$2 ==> _b0 ==> $m.0$2 mod 4 == 0 mod 4;
