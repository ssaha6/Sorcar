...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> _WATCHED_OFFSET mod 1 == 1 mod 1 || _WATCHED_OFFSET mod 1 == 1 mod 1 || _WATCHED_OFFSET mod 1 == 1 mod 1 ) ,  (  !p20$1 ==> _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T$ghost$$24 == _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> _WATCHED_OFFSET == 0 ) ,  (  !p20$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj$ghost$$24 == _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj )  ); 
...
assert  my_inv (  ( p21$1 ==> $i.0$1 mod 1 == 1 mod 1 )  && ( p21$2 ==> $i.0$2 mod 1 == 1 mod 1 ) ,  ( p21$1 ==> BV32_SLE($i.0$1, 1) )  && ( p21$2 ==> BV32_SLE($i.0$2, 1) ) ,  ( p21$1 ==> BV32_SGE($i.0$1, 1) )  && ( p21$2 ==> BV32_SGE($i.0$2, 1) ) ,  ( p21$1 ==> BV32_ULE($i.0$1, 1) )  && ( p21$2 ==> BV32_ULE($i.0$2, 1) ) ,  ( p21$1 ==> BV32_UGE($i.0$1, 1) )  && ( p21$2 ==> BV32_UGE($i.0$2, 1) ) ,  ( p21$1 ==> p21$1 ==> BV32_ULT(group_id_x$1, $imageW) && BV32_ULT(group_id_y$1, $imageH) && BV32_ULT(local_id_x$1, 4) && local_id_x$1 == 0 )  && ( p21$2 ==> p21$2 ==> BV32_ULT(group_id_x$2, $imageW) && BV32_ULT(group_id_y$2, $imageH) && BV32_ULT(local_id_x$2, 4) && local_id_x$2 == 0 ) ,  (  BV32_ULT(group_id_x$1, $imageW) && BV32_ULT(group_id_y$1, $imageH) && BV32_ULT(local_id_x$1, 4) && local_id_x$1 == 0 && BV32_SLT($i.0$1, 4) ==> p21$1 )  && (  BV32_ULT(group_id_x$2, $imageW) && BV32_ULT(group_id_y$2, $imageH) && BV32_ULT(local_id_x$2, 4) && local_id_x$2 == 0 && BV32_SLT($i.0$2, 4) ==> p21$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> BV32_ULT(group_id_x$1, $imageW) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> BV32_ULT(group_id_y$1, $imageH) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> BV32_ULT(local_id_x$1, 4) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE1T ==> local_id_x$1 == 0 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> BV32_ULT(group_id_x$1, $imageW) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> BV32_ULT(group_id_y$1, $imageH) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> BV32_ULT(local_id_x$1, 4) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ11renderPixelPjP4NodejjffE3Obj ==> local_id_x$1 == 0 ) ,  true ,  true ,  true ,  true  ); 
