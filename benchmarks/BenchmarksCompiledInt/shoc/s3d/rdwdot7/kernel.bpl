...
procedure {:source_name "rdwdot7_kernel"} {:kernel} $rdwdot7_kernel($rateconv: int);
...
implementation {:source_name "rdwdot7_kernel"} {:kernel} $rdwdot7_kernel($rateconv: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
