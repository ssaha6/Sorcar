...
assert  my_inv (  (  BV32_SLE($k.0, 1bv32) ) ,  (  BV32_SGE($k.0, 1bv32) ) ,  (  BV32_ULE($k.0, 1bv32) ) ,  (  BV32_UGE($k.0, 1bv32) ) ,  (  _READ_HAS_OCCURRED_$$C ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _READ_HAS_OCCURRED_$$C ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$C ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$C ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _READ_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 13824bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _WRITE_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 13824bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) )  ); 
