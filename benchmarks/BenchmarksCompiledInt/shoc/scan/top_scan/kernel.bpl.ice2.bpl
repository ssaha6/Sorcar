...
assert  my_inv (  (  BV32_SLE($i.i.0, 1) ) ,  (  BV32_SGE($i.i.0, 1) ) ,  (  BV32_ULE($i.i.0, 1) ) ,  (  BV32_UGE($i.i.0, 1) ) ,  (  $i.i.0 == 0 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1)) == 0 ) ,  (  $i.i.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) )  ); 
