...
procedure {:source_name "readImg"} {:kernel} $readImg($n: int, $samp: int, $w: int, $h: int);
...
implementation {:source_name "readImg"} {:kernel} $readImg($n: int, $samp: int, $w: int, $h: int)
{
  var $ridx.0$1: int;
  var $ridx.0$2: int;
  var $sum.0$1: int;
  ...
  $truebb:
    ...
    havoc v10$1, v10$2;
    havoc v11$1, v11$2;
    $ridx.0$1, $sum.0$1, $i.0 := BV_CONCAT(BV_EXTRACT($ridx.0$1, 64, 32), BV32_AND(BV32_ADD(BV_EXTRACT($ridx.0$1, 32, 0), 1), BV32_SUB($w, 1))), FADD32($sum.0$1, v8$1), BV32_ADD($i.0, 1);
    $ridx.0$2, $sum.0$2 := BV_CONCAT(BV_EXTRACT($ridx.0$2, 64, 32), BV32_AND(BV32_ADD(BV_EXTRACT($ridx.0$2, 32, 0), 1), BV32_SUB($w, 1))), FADD32($sum.0$2, v8$2);
