...
assert  my_inv (  ( p0$1 ==> $j.0$1 mod 1 == 0 mod 1 )  && ( p0$2 ==> $j.0$2 mod 1 == 0 mod 1 ) ,  ( p0$1 ==> BV32_SLE($j.0$1, 0) )  && ( p0$2 ==> BV32_SLE($j.0$2, 0) ) ,  ( p0$1 ==> BV32_SGE($j.0$1, 0) )  && ( p0$2 ==> BV32_SGE($j.0$2, 0) ) ,  ( p0$1 ==> BV32_ULE($j.0$1, 0) )  && ( p0$2 ==> BV32_ULE($j.0$2, 0) ) ,  ( p0$1 ==> BV32_UGE($j.0$1, 0) )  && ( p0$2 ==> BV32_UGE($j.0$2, 0) ) ,  (  $0$1 == 1 ==> p0$1 )  && (  $0$2 == 1 ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p5$1 ==> $j.1$1 mod 1 == $j.0$1 mod 1 )  && ( p5$2 ==> $j.1$2 mod 1 == $j.0$2 mod 1 ) ,  ( p5$1 ==> $i.0$1 mod 1 == 0 mod 1 )  && ( p5$2 ==> $i.0$2 mod 1 == 0 mod 1 ) ,  ( p5$1 ==> BV32_SLE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_SLE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_SGE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_SGE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_ULE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_ULE($j.1$2, $j.0$2) ) ,  ( p5$1 ==> BV32_UGE($j.1$1, $j.0$1) )  && ( p5$2 ==> BV32_UGE($j.1$2, $j.0$2) ) ,  (  BV32_SLT($j.1$1, BV32_SDIV(4096, group_size_x)) ==> p5$1 )  && (  BV32_SLT($j.1$2, BV32_SDIV(4096, group_size_x)) ==> p5$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $j.2 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($j.2, 0) ) ,  (  BV32_SGE($j.2, 0) ) ,  (  BV32_ULE($j.2, 0) ) ,  (  BV32_UGE($j.2, 0) ) ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$readLocalMemory.lbuf ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
