...
procedure {:source_name "readGlobalMemoryCoalesced"} {:kernel} $readGlobalMemoryCoalesced($size: int);
...
implementation {:source_name "readGlobalMemoryCoalesced"} {:kernel} $readGlobalMemoryCoalesced($size: int)
{
  var $j.0: int;
  var $sum.0$1: int;
  var $sum.0$2: int;
  ...
  $0:
    ...
    $j.0, $sum.0$1, $s.0$1 := 0, 0, v0$1;
    $sum.0$2, $s.0$2 := 0, v0$2;
  ...
  $truebb:
    ...
    havoc v16$1, v16$2;
    havoc v17$1, v17$2;
    $j.0, $sum.0$1, $s.0$1 := BV32_ADD($j.0, 1), FADD32($sum.0$1, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v2$1, v3$1), v4$1), v5$1), v6$1), v7$1), v8$1), v9$1), v10$1), v11$1), v12$1), v13$1), v14$1), v15$1), v16$1), v17$1)), BV32_AND(BV32_ADD($s.0$1, 163840), BV32_SUB($size, 1));
    $sum.0$2, $s.0$2 := FADD32($sum.0$2, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v2$2, v3$2), v4$2), v5$2), v6$2), v7$2), v8$2), v9$2), v10$2), v11$2), v12$2), v13$2), v14$2), v15$2), v16$2), v17$2)), BV32_AND(BV32_ADD($s.0$2, 163840), BV32_SUB($size, 1));
