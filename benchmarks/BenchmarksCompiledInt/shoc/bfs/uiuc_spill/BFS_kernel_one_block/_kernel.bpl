...
implementation {:source_name "BFS_kernel_one_block"} {:kernel} $BFS_kernel_one_block($frontier_len: int, $numVertices: int, $numEdges: int, $max_local_mem: int)
{
  ...
  __partitioned_block_$3_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b82 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b81 ==> _WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0;
    assert {:tag "noatomic"} _b80 ==> !_ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset;
    assert {:tag "nowrite"} _b79 ==> !_WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b78 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b77 ==> _WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b76 ==> _READ_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "noatomic"} _b75 ==> !_ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length;
    assert {:tag "nowrite"} _b74 ==> !_WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length;
    assert {:tag "noread"} _b73 ==> !_READ_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b72 ==> _WRITE_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == v16$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b71 ==> _READ_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b70 ==> !_WRITE_HAS_OCCURRED_$$b_q2;
    assert {:tag "noread"} _b69 ==> !_READ_HAS_OCCURRED_$$b_q2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b68 ==> _WRITE_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b67 ==> _READ_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b66 ==> !_WRITE_HAS_OCCURRED_$$b_q;
    assert {:tag "noread"} _b65 ==> !_READ_HAS_OCCURRED_$$b_q;
    assert {:tag "noatomic"} _b64 ==> !_ATOMIC_HAS_OCCURRED_$$cost;
    assert {:tag "noread"} _b63 ==> !_READ_HAS_OCCURRED_$$cost;
    assert {:tag "noatomic"} _b62 ==> !_ATOMIC_HAS_OCCURRED_$$visited;
    assert {:tag "nowrite"} _b61 ==> !_WRITE_HAS_OCCURRED_$$visited;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b60 ==> _WRITE_HAS_OCCURRED_$$frontier ==> _WATCHED_OFFSET == v18$1;
    assert {:tag "nowrite"} _b59 ==> !_WRITE_HAS_OCCURRED_$$frontier;
    assert {:tag "predicatedEquality"} _b58 ==> p2$1 && p2$2 ==> _abstracted_call_arg_22$1 == _abstracted_call_arg_22$2;
    assert {:tag "predicatedEquality"} _b57 ==> p2$1 && p2$2 ==> _abstracted_call_arg_21$1 == _abstracted_call_arg_21$2;
    assert {:tag "predicatedEquality"} _b56 ==> p2$1 && p2$2 ==> _abstracted_call_arg_20$1 == _abstracted_call_arg_20$2;
    assert {:tag "predicatedEquality"} _b55 ==> p2$1 && p2$2 ==> _abstracted_call_arg_19$1 == _abstracted_call_arg_19$2;
    assert {:tag "predicatedEquality"} _b54 ==> p2$1 && p2$2 ==> _abstracted_call_arg_18$1 == _abstracted_call_arg_18$2;
    assert {:tag "predicatedEquality"} _b53 ==> p2$1 && p2$2 ==> _abstracted_call_arg_17$1 == _abstracted_call_arg_17$2;
    assert {:tag "predicatedEquality"} _b52 ==> p2$1 && p2$2 ==> _abstracted_call_arg_16$1 == _abstracted_call_arg_16$2;
    assert {:tag "predicatedEquality"} _b51 ==> p2$1 && p2$2 ==> _abstracted_call_arg_7$1 == _abstracted_call_arg_7$2;
    assert {:tag "predicatedEquality"} _b50 ==> p2$1 && p2$2 ==> _abstracted_call_arg_6$1 == _abstracted_call_arg_6$2;
    assert {:tag "predicatedEquality"} _b49 ==> p2$1 && p2$2 ==> _abstracted_call_arg_5$1 == _abstracted_call_arg_5$2;
    assert {:tag "predicatedEquality"} _b48 ==> p2$1 && p2$2 ==> _abstracted_call_arg_4$1 == _abstracted_call_arg_4$2;
    assert {:tag "predicatedEquality"} _b47 ==> p2$1 && p2$2 ==> _abstracted_call_arg_3$1 == _abstracted_call_arg_3$2;
    assert {:tag "predicatedEquality"} _b46 ==> p2$1 && p2$2 ==> _abstracted_call_arg_2$1 == _abstracted_call_arg_2$2;
    assert {:tag "predicatedEquality"} _b45 ==> p2$1 && p2$2 ==> _abstracted_call_arg_1$1 == _abstracted_call_arg_1$2;
    assert {:tag "predicatedEquality"} _b44 ==> p2$1 && p2$2 ==> _abstracted_call_arg_0$1 == _abstracted_call_arg_0$2;
    assert {:tag "predicatedEquality"} _b43 ==> p2$1 && p2$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b42 ==> p2$1 && p2$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b41 ==> p2$1 && p2$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b40 ==> p2$1 && p2$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b39 ==> p2$1 && p2$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b38 ==> p2$1 && p2$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b37 ==> p2$1 && p2$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b36 ==> p2$1 && p2$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b35 ==> p2$1 && p2$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b34 ==> p2$1 && p2$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b33 ==> p2$1 && p2$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b32 ==> p2$1 && p2$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b31 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b30 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b29 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b28 ==> p2$1 && p2$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b27 ==> p2$1 && p2$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b26 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b25 ==> p2$1 && p2$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b24 ==> p2$1 && p2$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b23 ==> p2$1 && p2$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b22 ==> p2$1 && p2$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b21 ==> p2$1 && p2$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b20 ==> p2$1 && p2$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b19 ==> p2$1 && p2$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b18 ==> p2$1 && p2$2 ==> $offset.0$1 == $offset.0$2;
    assert {:tag "predicatedEquality"} _b17 ==> p2$1 && p2$2 ==> $f_len.0$1 == $f_len.0$2;
    assert {:tag "loopPredicateEquality"} _b16 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p2$1 == p2$2;
    assert {:tag "loopPredicateEquality"} _b15 ==> p2$1 == p2$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b4 ==> v21$1 != 0 ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b4 ==> v21$2 != 0 ==> p2$2;
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b3 ==> BV32_UGE($f_len.0$1, $frontier_len);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b3 ==> BV32_UGE($f_len.0$2, $frontier_len);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b2 ==> BV32_ULE($f_len.0$1, $frontier_len);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b2 ==> BV32_ULE($f_len.0$2, $frontier_len);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b1 ==> BV32_SGE($f_len.0$1, $frontier_len);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b1 ==> BV32_SGE($f_len.0$2, $frontier_len);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b0 ==> BV32_SLE($f_len.0$1, $frontier_len);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b0 ==> BV32_SLE($f_len.0$2, $frontier_len);
  ...
  $7:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b93 ==> !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b92 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b91 ==> !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b90 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b89 ==> !p6$1 ==> _WRITE_HAS_OCCURRED_$$b_q2$ghost$$7 == _WRITE_HAS_OCCURRED_$$b_q2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b88 ==> _WRITE_HAS_OCCURRED_$$b_q2 ==> _WATCHED_OFFSET == v16$1;
    assert {:tag "disabledMaintainsInstrumentation"} _b87 ==> !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$cost$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b86 ==> !p6$1 ==> _READ_HAS_OCCURRED_$$cost$ghost$$7 == _READ_HAS_OCCURRED_$$cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b85 ==> !p6$1 ==> _ATOMIC_HAS_OCCURRED_$$visited$ghost$$7 == _ATOMIC_HAS_OCCURRED_$$visited;
    assert {:tag "disabledMaintainsInstrumentation"} _b84 ==> !p6$1 ==> _WRITE_HAS_OCCURRED_$$frontier$ghost$$7 == _WRITE_HAS_OCCURRED_$$frontier;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b83 ==> _WRITE_HAS_OCCURRED_$$frontier ==> _WATCHED_OFFSET == v18$1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$BFS_kernel_one_block.b_offset ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$BFS_kernel_one_block.b_q_length ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p7$1 ==> p2$1;
    assert p7$2 ==> p2$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$b_q2 ==> BV32_ULT(local_id_x$1, $f_len.0$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$frontier ==> BV32_ULT(local_id_x$1, $f_len.0$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _READ_HAS_OCCURRED_$$cost ==> BV32_ULT(local_id_x$1, $f_len.0$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b11 ==> BV32_ULT(local_id_x$1, $f_len.0$1) && BV32_ULT($offset.0$1, v7$1) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b11 ==> BV32_ULT(local_id_x$2, $f_len.0$2) && BV32_ULT($offset.0$2, v7$2) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b10 ==> p7$1 ==> BV32_ULT(local_id_x$1, $f_len.0$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b10 ==> p7$2 ==> BV32_ULT(local_id_x$2, $f_len.0$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b9 ==> BV32_UGE($offset.0$1, v6$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b9 ==> BV32_UGE($offset.0$2, v6$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b8 ==> BV32_ULE($offset.0$1, v6$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b8 ==> BV32_ULE($offset.0$2, v6$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b7 ==> BV32_SGE($offset.0$1, v6$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b7 ==> BV32_SGE($offset.0$2, v6$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b6 ==> BV32_SLE($offset.0$1, v6$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b6 ==> BV32_SLE($offset.0$2, v6$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b5 ==> $offset.0$1 mod 1 == v6$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b5 ==> $offset.0$2 mod 1 == v6$2 mod 1;
