...
implementation {:source_name "BFS_kernel_multi_block"} {:kernel} $BFS_kernel_multi_block($frontier_len: int, $numVertices: int, $numEdges: int, $max_local_mem: int)
{
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b20 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _ATOMIC_HAS_OCCURRED_$$BFS_kernel_multi_block.b_q_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b18 ==> !p2$1 ==> _WRITE_HAS_OCCURRED_$$b_q$ghost$$4 == _WRITE_HAS_OCCURRED_$$b_q;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _WRITE_HAS_OCCURRED_$$b_q ==> _WATCHED_OFFSET == v15$1;
    assert {:tag "disabledMaintainsInstrumentation"} _b16 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$frontier_length$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$frontier_length;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _ATOMIC_HAS_OCCURRED_$$frontier_length ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b14 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$cost$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b13 ==> !p2$1 ==> _READ_HAS_OCCURRED_$$cost$ghost$$4 == _READ_HAS_OCCURRED_$$cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b12 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$visited$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$visited;
    assert {:tag "disabledMaintainsInstrumentation"} _b11 ==> !p2$1 ==> _WRITE_HAS_OCCURRED_$$frontier2$ghost$$4 == _WRITE_HAS_OCCURRED_$$frontier2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _WRITE_HAS_OCCURRED_$$frontier2 ==> _WATCHED_OFFSET == v17$1;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _WRITE_HAS_OCCURRED_$$b_q ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _WRITE_HAS_OCCURRED_$$frontier2 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$cost ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len) && BV32_ULT($offset.0$1, v6$1) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $frontier_len) && BV32_ULT($offset.0$2, v6$2) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b5 ==> p3$1 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $frontier_len);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b5 ==> p3$2 ==> BV32_ULT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $frontier_len);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b4 ==> BV32_UGE($offset.0$1, v5$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b4 ==> BV32_UGE($offset.0$2, v5$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b3 ==> BV32_ULE($offset.0$1, v5$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b3 ==> BV32_ULE($offset.0$2, v5$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b2 ==> BV32_SGE($offset.0$1, v5$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b2 ==> BV32_SGE($offset.0$2, v5$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b1 ==> BV32_SLE($offset.0$1, v5$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b1 ==> BV32_SLE($offset.0$2, v5$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p3$1 ==> _b0 ==> $offset.0$1 mod 1 == v5$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p3$2 ==> _b0 ==> $offset.0$2 mod 1 == v5$2 mod 1;
