...
implementation {:source_name "BFS_kernel_warp"} {:kernel} $BFS_kernel_warp($W_SZ: int, $CHUNK_SZ: int, $numVertices: int, $curr: int)
{
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b42 ==> _WRITE_HAS_OCCURRED_$$flag ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b35 ==> _READ_HAS_OCCURRED_$$levels ==> _WATCHED_OFFSET mod 1 == v1$1 mod 1;
    ...
    assert {:tag "predicatedEquality"} _b32 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b31 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b30 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b29 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b28 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b27 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b26 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b25 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b24 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b23 ==> p4$1 && p4$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b22 ==> p4$1 && p4$2 ==> $i.0$1 == $i.0$2;
    assert {:tag "predicatedEquality"} _b21 ==> p4$1 && p4$2 ==> $v.0$1 == $v.0$2;
    assert {:tag "loopPredicateEquality"} _b20 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b19 ==> p4$1 == p4$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLT($v.0$2, BV32_ADD(BV32_SUB($chk_sz.1$2, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $W_SZ), $CHUNK_SZ))) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b4 ==> BV32_UGE($v.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b4 ==> BV32_UGE($v.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b3 ==> BV32_ULE($v.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b3 ==> BV32_ULE($v.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b2 ==> BV32_SGE($v.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b2 ==> BV32_SGE($v.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b1 ==> BV32_SLE($v.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b1 ==> BV32_SLE($v.0$2, v1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b0 ==> $v.0$1 mod 1 == v1$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b0 ==> $v.0$2 mod 1 == v1$2 mod 1;
  ...
  $8:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b61 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$flag$ghost$$8 == _WRITE_HAS_OCCURRED_$$flag;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b60 ==> _WRITE_HAS_OCCURRED_$$flag ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b53 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$levels$ghost$$8 == _WRITE_HAS_OCCURRED_$$levels;
    assert {:tag "disabledMaintainsInstrumentation"} _b52 ==> !p7$1 ==> _READ_HAS_OCCURRED_$$levels$ghost$$8 == _READ_HAS_OCCURRED_$$levels;
    ...
    assert {:tag "predicatedEquality"} _b49 ==> p8$1 && p8$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b48 ==> p8$1 && p8$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b47 ==> p8$1 && p8$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b46 ==> p8$1 && p8$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b45 ==> p8$1 && p8$2 ==> $i.0$1 == $i.0$2;
    assert {:tag "loopPredicateEquality"} _b44 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p8$1 == p8$2;
    assert {:tag "loopPredicateEquality"} _b43 ==> p8$1 == p8$2;
    assume {:predicate "p8"} {:dominator_predicate "p7"} true;
    assert p8$1 ==> p4$1;
    assert p8$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$flag ==> v6$1 == $curr;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _WRITE_HAS_OCCURRED_$$flag ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _WRITE_HAS_OCCURRED_$$levels ==> v6$1 == $curr;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$levels ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$levels ==> v6$1 == $curr;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$levels ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) && v6$1 == $curr && BV32_ULT($i.0$1, BV32_SUB(v8$1, v9$1)) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLT($v.0$2, BV32_ADD(BV32_SUB($chk_sz.1$2, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $W_SZ), $CHUNK_SZ))) && v6$2 == $curr && BV32_ULT($i.0$2, BV32_SUB(v8$2, v9$2)) ==> p8$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b11 ==> p8$1 ==> BV32_SLT($v.0$1, BV32_ADD(BV32_SUB($chk_sz.1$1, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $W_SZ), $CHUNK_SZ))) && v6$1 == $curr;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b11 ==> p8$2 ==> BV32_SLT($v.0$2, BV32_ADD(BV32_SUB($chk_sz.1$2, 1), BV32_MUL(BV32_SDIV(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $W_SZ), $CHUNK_SZ))) && v6$2 == $curr;
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b10 ==> BV32_UGE($i.0$1, BV32_SREM(v0$1, $W_SZ));
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b10 ==> BV32_UGE($i.0$2, BV32_SREM(v0$2, $W_SZ));
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b9 ==> BV32_ULE($i.0$1, BV32_SREM(v0$1, $W_SZ));
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b9 ==> BV32_ULE($i.0$2, BV32_SREM(v0$2, $W_SZ));
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b8 ==> BV32_SGE($i.0$1, BV32_SREM(v0$1, $W_SZ));
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b8 ==> BV32_SGE($i.0$2, BV32_SREM(v0$2, $W_SZ));
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b7 ==> BV32_SLE($i.0$1, BV32_SREM(v0$1, $W_SZ));
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b7 ==> BV32_SLE($i.0$2, BV32_SREM(v0$2, $W_SZ));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p8$1 ==> _b6 ==> $i.0$1 mod $W_SZ == BV32_SREM(v0$1, $W_SZ) mod $W_SZ;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p8$2 ==> _b6 ==> $i.0$2 mod $W_SZ == BV32_SREM(v0$2, $W_SZ) mod $W_SZ;
