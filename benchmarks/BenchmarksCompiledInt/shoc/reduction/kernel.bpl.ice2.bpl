...
assert  my_inv (  ( p0$1 ==> $i.0$1 mod BV32_MUL(BV32_MUL(group_size_x, 2), num_groups_x) == BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2)), v0$1) mod BV32_MUL(BV32_MUL(group_size_x, 2), num_groups_x) )  && ( p0$2 ==> $i.0$2 mod BV32_MUL(BV32_MUL(group_size_x, 2), num_groups_x) == BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2)), v0$2) mod BV32_MUL(BV32_MUL(group_size_x, 2), num_groups_x) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2)), v0$1)) )  && ( p0$2 ==> BV32_SLE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2)), v0$2)) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2)), v0$1)) )  && ( p0$2 ==> BV32_SGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2)), v0$2)) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2)), v0$1)) )  && ( p0$2 ==> BV32_ULE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2)), v0$2)) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2)), v0$1)) )  && ( p0$2 ==> BV32_UGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2)), v0$2)) ) ,  (  BV32_ULT($i.0$1, $n) ==> p0$1 )  && (  BV32_ULT($i.0$2, $n) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($s.0, BV32_UDIV(v1, 2)) ) ,  (  BV32_SGE($s.0, BV32_UDIV(v1, 2)) ) ,  (  BV32_ULE($s.0, BV32_UDIV(v1, 2)) ) ,  (  BV32_UGE($s.0, BV32_UDIV(v1, 2)) ) ,  true ,  true ,  (  $s.0 == 0 || BV32_AND($s.0, BV32_SUB($s.0, 1)) == 0 ) ,  (  $s.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$sdata ) ,  (  !_WRITE_HAS_OCCURRED_$$sdata ) ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
