...
implementation {:source_name "StencilKernel"} {:kernel} $StencilKernel($alignment: int, $wCenter: int, $wCardinal: int, $wDiagonal: int)
{
  ...
  $4:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _WRITE_HAS_OCCURRED_$$sh ==> _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 1)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2));
  ...
  $9:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$sh$ghost$$9 == _WRITE_HAS_OCCURRED_$$sh;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$sh ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p1"} {:dominator_predicate "p0"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _WRITE_HAS_OCCURRED_$$sh ==> local_id_y$1 == 0;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b25 ==> local_id_y$1 == 0 && BV32_SLT($i1.0$1, 10) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b25 ==> local_id_y$2 == 0 && BV32_SLT($i1.0$2, 10) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b24 ==> p1$1 ==> local_id_y$1 == 0;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b24 ==> p1$2 ==> local_id_y$2 == 0;
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b23 ==> BV32_UGE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b23 ==> BV32_UGE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b22 ==> BV32_ULE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b22 ==> BV32_ULE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b21 ==> BV32_SGE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b21 ==> BV32_SGE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b20 ==> BV32_SLE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b20 ==> BV32_SLE($i1.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p1$1 ==> _b19 ==> $i1.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p1$2 ==> _b19 ==> $i1.0$2 mod 1 == 0 mod 1;
  ...
  $15:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b31 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$sh$ghost$$15 == _WRITE_HAS_OCCURRED_$$sh;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b30 ==> _WRITE_HAS_OCCURRED_$$sh ==> _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 2)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p5"} {:dominator_predicate "p4"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$sh ==> local_id_y$1 == BV32_SUB(group_size_y, 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _WRITE_HAS_OCCURRED_$$sh ==> local_id_y$1 != 0;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> local_id_y$1 != 0 && local_id_y$1 == BV32_SUB(group_size_y, 1) && BV32_SLT($i4.0$1, 10) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> local_id_y$2 != 0 && local_id_y$2 == BV32_SUB(group_size_y, 1) && BV32_SLT($i4.0$2, 10) ==> p5$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b15 ==> p5$1 ==> local_id_y$1 != 0 && local_id_y$1 == BV32_SUB(group_size_y, 1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b15 ==> p5$2 ==> local_id_y$2 != 0 && local_id_y$2 == BV32_SUB(group_size_y, 1);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b14 ==> BV32_UGE($i4.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b14 ==> BV32_UGE($i4.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b13 ==> BV32_ULE($i4.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b13 ==> BV32_ULE($i4.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b12 ==> BV32_SGE($i4.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b12 ==> BV32_SGE($i4.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b11 ==> BV32_SLE($i4.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b11 ==> BV32_SLE($i4.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p5$1 ==> _b10 ==> $i4.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p5$2 ==> _b10 ==> $i4.0$2 mod 1 == 0 mod 1;
  ...
  $21:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b34 ==> _READ_HAS_OCCURRED_$$sh ==> _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(0, local_id_x$1), 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 1)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 1)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(0, BV32_ADD(local_id_x$1, 1)), 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 1)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(0, local_id_x$1), 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 2)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 2)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(0, BV32_ADD(local_id_x$1, 1)), 1), BV32_ADD(group_size_y, 2)), BV32_ADD(local_id_y$1, 2)) mod BV32_MUL(1, BV32_ADD(group_size_y, 2)) || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessUpperBoundBlock"} _b33 ==> _WRITE_HAS_OCCURRED_$$newData ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(group_id_y$1, 1), group_size_y), local_id_y$1), 1));
    assert {:tag "accessLowerBoundBlock"} _b32 ==> _WRITE_HAS_OCCURRED_$$newData ==> BV32_SLE(BV32_ADD(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 1), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sh ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($i7.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($i7.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($i7.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($i7.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b5 ==> $i7.0 mod 1 == 0 mod 1;
