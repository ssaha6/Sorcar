...
var {:source_name "histogram"} $$histogram$1: [int]int;

var {:source_name "histogram"} $$histogram$2: [int]int;

axiom {:array_info "$$histogram"} {:elem_width 32} {:source_name "histogram"} {:source_elem_width 32} {:source_dimensions "16"} true;

var {:source_name "l_block_counts"} {:group_shared} $$bottom_scan.l_block_counts: [bv1][int]int;
...
var {:source_name "l_scanned_seeds"} {:group_shared} $$bottom_scan.l_scanned_seeds: [bv1][int]int;
...
implementation {:source_name "bottom_scan"} {:kernel} $bottom_scan($n: int, $shift: int)
{
  var $0$1: int;
  var $0$2: int;
  var $i.0$1: int;
  ...
  __partitioned_block_$0_0:
    ...
    v4$1 := BV32_ULT(local_id_x$1, 16);
    v4$2 := BV32_ULT(local_id_x$2, 16);
    p2$1 := (if v4$1 then v4$1 else p2$1);
    p2$2 := (if v4$2 then v4$2 else p2$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_WRITE_$$bottom_scan.l_block_counts(p2$1, local_id_x$1, 0, $$bottom_scan.l_block_counts[1bv1][local_id_x$1]);
    ...
    call {:check_id "check_state_20"} {:sourceloc} {:sourceloc_num 22} _CHECK_WRITE_$$bottom_scan.l_block_counts(p2$2, local_id_x$2, 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$bottom_scan.l_block_counts"} true;
    $$bottom_scan.l_block_counts[1bv1][local_id_x$1] := (if p2$1 then 0 else $$bottom_scan.l_block_counts[1bv1][local_id_x$1]);
    $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p2$2 then 0 else $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
  ...
  __partitioned_block_$0_1:
    call {:sourceloc_num 26} $bugle_barrier_duplicated_0(-1, 0);
    havoc v6$1, v6$2;
    havoc v7$1, v7$2;
  ...
  $6:
    ...
    assert {:tag "noread"} _b114 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b113 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b112 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b111 ==> !_WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "noread"} _b110 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b109 ==> _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b108 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(local_id_x$1, group_size_x), 1) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b107 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b106 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "nowrite"} _b105 ==> !_WRITE_HAS_OCCURRED_$$out;
    assert {:tag "predicatedEquality"} _b104 ==> p4$1 && p4$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b103 ==> p4$1 && p4$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b102 ==> p4$1 && p4$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b101 ==> p4$1 && p4$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b100 ==> p4$1 && p4$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b99 ==> p4$1 && p4$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b98 ==> p4$1 && p4$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b97 ==> p4$1 && p4$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b96 ==> p4$1 && p4$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b95 ==> p4$1 && p4$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b94 ==> p4$1 && p4$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b93 ==> p4$1 && p4$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b92 ==> p4$1 && p4$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b91 ==> p4$1 && p4$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b90 ==> p4$1 && p4$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b89 ==> p4$1 && p4$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b88 ==> p4$1 && p4$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b87 ==> p4$1 && p4$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b86 ==> p4$1 && p4$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b85 ==> p4$1 && p4$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b84 ==> p4$1 && p4$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b83 ==> p4$1 && p4$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b82 ==> p4$1 && p4$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b81 ==> p4$1 && p4$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b80 ==> p4$1 && p4$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b79 ==> p4$1 && p4$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b78 ==> p4$1 && p4$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b77 ==> p4$1 && p4$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b76 ==> p4$1 && p4$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b75 ==> p4$1 && p4$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b74 ==> p4$1 && p4$2 ==> v25$1 == v25$2;
    ...
    assert {:tag "predicatedEquality"} _b58 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b57 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b56 ==> p4$1 && p4$2 ==> $q1.0$1 == $q1.0$2;
    assert {:tag "predicatedEquality"} _b55 ==> p4$1 && p4$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "predicatedEquality"} _b54 ==> p4$1 && p4$2 ==> $digit.0$1 == $digit.0$2;
    assert {:tag "predicatedEquality"} _b53 ==> p4$1 && p4$2 ==> $key_4.1$1 == $key_4.1$2;
    assert {:tag "predicatedEquality"} _b52 ==> p4$1 && p4$2 ==> $val_4.1$1 == $val_4.1$2;
    assert {:tag "predicatedEquality"} _b51 ==> p4$1 && p4$2 ==> $q.0$1 == $q.0$2;
    assert {:tag "predicatedEquality"} _b50 ==> p4$1 && p4$2 ==> $key_4.0$1 == $key_4.0$2;
    assert {:tag "predicatedEquality"} _b49 ==> p4$1 && p4$2 ==> $val_4.0$1 == $val_4.0$2;
    assert {:tag "predicatedEquality"} _b48 ==> p4$1 && p4$2 ==> $window.0$1 == $window.0$2;
    assert {:tag "predicatedEquality"} _b47 ==> p4$1 && p4$2 ==> $i.0$1 == $i.0$2;
    assert {:tag "loopPredicateEquality"} _b46 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b45 ==> p4$1 == p4$2;
    assert {:tag "pow2NotZero"} _b44 ==> $i.i.0$2 != 0;
    assert {:tag "pow2"} _b43 ==> $i.i.0$2 == 0 || BV32_AND($i.i.0$2, BV32_SUB($i.i.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b42 ==> $i.i.0$1 != 0;
    assert {:tag "pow2"} _b41 ==> $i.i.0$1 == 0 || BV32_AND($i.i.0$1, BV32_SUB($i.i.0$1, 1)) == 0;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b10 ==> BV32_SLT($window.0$1, $0$1) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b10 ==> BV32_SLT($window.0$2, $0$2) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b9 ==> BV32_UGE($i.0$1, BV32_ADD(v2$1, local_id_x$1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b9 ==> BV32_UGE($i.0$2, BV32_ADD(v2$2, local_id_x$2));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b8 ==> BV32_ULE($i.0$1, BV32_ADD(v2$1, local_id_x$1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b8 ==> BV32_ULE($i.0$2, BV32_ADD(v2$2, local_id_x$2));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b7 ==> BV32_SGE($i.0$1, BV32_ADD(v2$1, local_id_x$1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b7 ==> BV32_SGE($i.0$2, BV32_ADD(v2$2, local_id_x$2));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b6 ==> BV32_SLE($i.0$1, BV32_ADD(v2$1, local_id_x$1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b6 ==> BV32_SLE($i.0$2, BV32_ADD(v2$2, local_id_x$2));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b5 ==> BV32_UGE($window.0$1, v2$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b5 ==> BV32_UGE($window.0$2, v2$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b4 ==> BV32_ULE($window.0$1, v2$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b4 ==> BV32_ULE($window.0$2, v2$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b3 ==> BV32_SGE($window.0$1, v2$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b3 ==> BV32_SGE($window.0$2, v2$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b2 ==> BV32_SLE($window.0$1, v2$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b2 ==> BV32_SLE($window.0$2, v2$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b1 ==> $window.0$1 mod group_size_x == v2$1 mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b1 ==> $window.0$2 mod group_size_x == v2$2 mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b0 ==> $i.0$1 mod group_size_x == BV32_ADD(v2$1, local_id_x$1) mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b0 ==> $i.0$2 mod group_size_x == BV32_ADD(v2$2, local_id_x$2) mod group_size_x;
    ...
    $q.0$1 := (if p5$1 then 0 else $q.0$1);
    $q.0$2 := (if p5$2 then 0 else $q.0$2);
  ...
  $8:
    ...
    v9$1 := (if p6$1 then BV32_SLT($q.0$1, 16) else v9$1);
    v9$2 := (if p6$2 then BV32_SLT($q.0$2, 16) else v9$2);
    p7$1 := false;
    p7$2 := false;
    p8$1 := false;
    p8$2 := false;
    ...
    $$histogram$1[$q.0$1] := (if p7$1 then 0 else $$histogram$1[$q.0$1]);
    $$histogram$2[$q.0$2] := (if p7$2 then 0 else $$histogram$2[$q.0$2]);
    $q.0$1 := (if p7$1 then BV32_ADD($q.0$1, 1) else $q.0$1);
    $q.0$2 := (if p7$2 then BV32_ADD($q.0$2, 1) else $q.0$2);
  ...
  $8.tail:
    ...
    v15$1 := (if p9$1 then BV32_AND(BV32_LSHR(v11$1, BV32_AND($shift, 31)), 15) else v15$1);
    v15$2 := (if p9$2 then BV32_AND(BV32_LSHR(v11$2, BV32_AND($shift, 31)), 15) else v15$2);
    v16$1 := (if p9$1 then BV32_AND(BV32_LSHR(v12$1, BV32_AND($shift, 31)), 15) else v16$1);
    v16$2 := (if p9$2 then BV32_AND(BV32_LSHR(v12$2, BV32_AND($shift, 31)), 15) else v16$2);
    v17$1 := (if p9$1 then BV32_AND(BV32_LSHR(v13$1, BV32_AND($shift, 31)), 15) else v17$1);
    v17$2 := (if p9$2 then BV32_AND(BV32_LSHR(v13$2, BV32_AND($shift, 31)), 15) else v17$2);
    v18$1 := (if p9$1 then BV32_AND(BV32_LSHR(v14$1, BV32_AND($shift, 31)), 15) else v18$1);
    v18$2 := (if p9$2 then BV32_AND(BV32_LSHR(v14$2, BV32_AND($shift, 31)), 15) else v18$2);
    v19$1 := (if p9$1 then $$histogram$1[v15$1] else v19$1);
    v19$2 := (if p9$2 then $$histogram$2[v15$2] else v19$2);
    $$histogram$1[v15$1] := (if p9$1 then BV32_ADD(v19$1, 1) else $$histogram$1[v15$1]);
    $$histogram$2[v15$2] := (if p9$2 then BV32_ADD(v19$2, 1) else $$histogram$2[v15$2]);
    v20$1 := (if p9$1 then $$histogram$1[v16$1] else v20$1);
    v20$2 := (if p9$2 then $$histogram$2[v16$2] else v20$2);
    $$histogram$1[v16$1] := (if p9$1 then BV32_ADD(v20$1, 1) else $$histogram$1[v16$1]);
    $$histogram$2[v16$2] := (if p9$2 then BV32_ADD(v20$2, 1) else $$histogram$2[v16$2]);
    v21$1 := (if p9$1 then $$histogram$1[v17$1] else v21$1);
    v21$2 := (if p9$2 then $$histogram$2[v17$2] else v21$2);
    $$histogram$1[v17$1] := (if p9$1 then BV32_ADD(v21$1, 1) else $$histogram$1[v17$1]);
    $$histogram$2[v17$2] := (if p9$2 then BV32_ADD(v21$2, 1) else $$histogram$2[v17$2]);
    v22$1 := (if p9$1 then $$histogram$1[v18$1] else v22$1);
    v22$2 := (if p9$2 then $$histogram$2[v18$2] else v22$2);
    $$histogram$1[v18$1] := (if p9$1 then BV32_ADD(v22$1, 1) else $$histogram$1[v18$1]);
    $$histogram$2[v18$2] := (if p9$2 then BV32_ADD(v22$2, 1) else $$histogram$2[v18$2]);
    $val_4.1$1, $key_4.1$1 := (if p9$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v14$1, v13$1), v12$1), v11$1) else $val_4.1$1), (if p9$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v18$1, v17$1), v16$1), v15$1) else $key_4.1$1);
    $val_4.1$2, $key_4.1$2 := (if p9$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v14$2, v13$2), v12$2), v11$2) else $val_4.1$2), (if p9$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v18$2, v17$2), v16$2), v15$2) else $key_4.1$2);
    $digit.0$1 := (if p5$1 then 0 else $digit.0$1);
    $digit.0$2 := (if p5$2 then 0 else $digit.0$2);
  ...
  __partitioned_block_$14_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b136 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$14_0 == _WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "disabledMaintainsInstrumentation"} _b135 ==> !p5$1 ==> _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$14_0 == _READ_HAS_OCCURRED_$$lmem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b134 ==> _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b133 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(local_id_x$1, group_size_x), 1) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b132 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b131 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "predicatedEquality"} _b130 ==> p10$1 && p10$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b129 ==> p10$1 && p10$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b128 ==> p10$1 && p10$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b127 ==> p10$1 && p10$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b126 ==> p10$1 && p10$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b125 ==> p10$1 && p10$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b124 ==> p10$1 && p10$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b123 ==> p10$1 && p10$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b122 ==> p10$1 && p10$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "predicatedEquality"} _b121 ==> p10$1 && p10$2 ==> $digit.0$1 == $digit.0$2;
    assert {:tag "loopPredicateEquality"} _b120 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p10$1 == p10$2;
    assert {:tag "loopPredicateEquality"} _b119 ==> p10$1 == p10$2;
    assert {:tag "pow2NotZero"} _b118 ==> $i.i.0$2 != 0;
    assert {:tag "pow2"} _b117 ==> $i.i.0$2 == 0 || BV32_AND($i.i.0$2, BV32_SUB($i.i.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b116 ==> $i.i.0$1 != 0;
    assert {:tag "pow2"} _b115 ==> $i.i.0$1 == 0 || BV32_AND($i.i.0$1, BV32_SUB($i.i.0$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p10$1 ==> p4$1;
    assert p10$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _WRITE_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b17 ==> BV32_SLT($window.0$1, $0$1) && BV32_SLT($digit.0$1, 16) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b17 ==> BV32_SLT($window.0$2, $0$2) && BV32_SLT($digit.0$2, 16) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b16 ==> p10$1 ==> BV32_SLT($window.0$1, $0$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b16 ==> p10$2 ==> BV32_SLT($window.0$2, $0$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b15 ==> BV32_UGE($digit.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b15 ==> BV32_UGE($digit.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b14 ==> BV32_ULE($digit.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b14 ==> BV32_ULE($digit.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b13 ==> BV32_SGE($digit.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b13 ==> BV32_SGE($digit.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b12 ==> BV32_SLE($digit.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b12 ==> BV32_SLE($digit.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p10$1 ==> _b11 ==> $digit.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p10$2 ==> _b11 ==> $digit.0$2 mod 1 == 0 mod 1;
    assert {:block_sourceloc} {:sourceloc_num 48} p10$1 ==> true;
    v23$1 := (if p10$1 then BV32_SLT($digit.0$1, 16) else v23$1);
    v23$2 := (if p10$2 then BV32_SLT($digit.0$2, 16) else v23$2);
    p11$1 := false;
    p11$2 := false;
    p12$1 := false;
    p12$2 := false;
    ...
    call {:sourceloc} {:sourceloc_num 51} _LOG_WRITE_$$lmem(p11$1, v25$1, 0, $$lmem[1bv1][v25$1]);
    ...
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 51} _CHECK_WRITE_$$lmem(p11$2, v25$2, 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$lmem"} true;
    $$lmem[1bv1][v25$1] := (if p11$1 then 0 else $$lmem[1bv1][v25$1]);
    $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v25$2] := (if p11$2 then 0 else $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v25$2]);
  ...
  __partitioned_block_$14_1:
    call {:sourceloc_num 53} $bugle_barrier_duplicated_3(-1, 0, p11$1, p11$2);
    $i.i.0$1 := (if p11$1 then 1 else $i.i.0$1);
    $i.i.0$2 := (if p11$2 then 1 else $i.i.0$2);
  ...
  __partitioned_block_$16_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b152 ==> !p11$1 ==> _WRITE_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$16_0 == _WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "disabledMaintainsInstrumentation"} _b151 ==> !p11$1 ==> _READ_HAS_OCCURRED_$$lmem$ghost$__partitioned_block_$16_0 == _READ_HAS_OCCURRED_$$lmem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b150 ==> _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b149 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x);
    assert {:tag "nowrite"} _b148 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b147 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "predicatedEquality"} _b146 ==> p12$1 && p12$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b145 ==> p12$1 && p12$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b144 ==> p12$1 && p12$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b143 ==> p12$1 && p12$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "loopPredicateEquality"} _b142 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p12$1 == p12$2;
    assert {:tag "loopPredicateEquality"} _b141 ==> p12$1 == p12$2;
    assert {:tag "pow2NotZero"} _b140 ==> $i.i.0$2 != 0;
    assert {:tag "pow2"} _b139 ==> $i.i.0$2 == 0 || BV32_AND($i.i.0$2, BV32_SUB($i.i.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b138 ==> $i.i.0$1 != 0;
    assert {:tag "pow2"} _b137 ==> $i.i.0$1 == 0 || BV32_AND($i.i.0$1, BV32_SUB($i.i.0$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p10$1 ==> p4$1;
    assert p10$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$lmem ==> BV32_SLT($digit.0$1, 16);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _WRITE_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _READ_HAS_OCCURRED_$$lmem ==> BV32_SLT($digit.0$1, 16);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _READ_HAS_OCCURRED_$$lmem ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b36 ==> BV32_SLT($window.0$1, $0$1) && BV32_SLT($digit.0$1, 16) && BV32_ULT($i.i.0$1, group_size_x) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b36 ==> BV32_SLT($window.0$2, $0$2) && BV32_SLT($digit.0$2, 16) && BV32_ULT($i.i.0$2, group_size_x) ==> p12$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p12$1 ==> _b35 ==> p12$1 ==> BV32_SLT($window.0$1, $0$1) && BV32_SLT($digit.0$1, 16);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p12$2 ==> _b35 ==> p12$2 ==> BV32_SLT($window.0$2, $0$2) && BV32_SLT($digit.0$2, 16);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b34 ==> BV32_UGE($i.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b34 ==> BV32_UGE($i.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b33 ==> BV32_ULE($i.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b33 ==> BV32_ULE($i.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b32 ==> BV32_SGE($i.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b32 ==> BV32_SGE($i.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b31 ==> BV32_SLE($i.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b31 ==> BV32_SLE($i.i.0$2, 1);
  ...
  __partitioned_block_$16_1:
    call {:sourceloc_num 57} $bugle_barrier_duplicated_5(-1, 0, p13$1, p13$2);
  ...
  __partitioned_block_$16_2:
    call {:sourceloc_num 60} $bugle_barrier_duplicated_6(-1, 0, p13$1, p13$2);
    $i.i.0$1 := (if p13$1 then BV32_MUL($i.i.0$1, 2) else $i.i.0$1);
    $i.i.0$2 := (if p13$2 then BV32_MUL($i.i.0$2, 2) else $i.i.0$2);
  ...
  __partitioned_block_$16.tail_0:
    assume !p12$1 && !p12$2;
    call {:sourceloc} {:sourceloc_num 62} _LOG_READ_$$lmem(p11$1, BV32_SUB(v26$1, 1), $$lmem[1bv1][BV32_SUB(v26$1, 1)]);
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 62} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 62} _CHECK_READ_$$lmem(p11$2, BV32_SUB(v26$2, 1), $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(v26$2, 1)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$lmem"} true;
    v30$1 := (if p11$1 then $$lmem[1bv1][BV32_SUB(v26$1, 1)] else v30$1);
    v30$2 := (if p11$2 then $$lmem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(v26$2, 1)] else v30$2);
  ...
  __partitioned_block_$16.tail_1:
    call {:sourceloc_num 64} $bugle_barrier_duplicated_4(-1, 0, p11$1, p11$2);
    $digit.0$1 := (if p11$1 then BV32_ADD($digit.0$1, 1) else $digit.0$1);
    $digit.0$2 := (if p11$2 then BV32_ADD($digit.0$2, 1) else $digit.0$2);
  ...
  __partitioned_block_$14.tail_0:
    ...
    v32$1 := (if p15$1 then $$histogram$1[BV_EXTRACT($key_4.1$1, 32, 0)] else v32$1);
    v32$2 := (if p15$2 then $$histogram$2[BV_EXTRACT($key_4.1$2, 32, 0)] else v32$2);
    call {:sourceloc} {:sourceloc_num 69} _LOG_READ_$$bottom_scan.l_scanned_seeds(p15$1, BV_EXTRACT($key_4.1$1, 32, 0), $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 69} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 69} _CHECK_READ_$$bottom_scan.l_scanned_seeds(p15$2, BV_EXTRACT($key_4.1$2, 32, 0), $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_scanned_seeds"} true;
    v33$1 := (if p15$1 then $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 32, 0)] else v33$1);
    v33$2 := (if p15$2 then $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 32, 0)] else v33$2);
    call {:sourceloc} {:sourceloc_num 70} _LOG_READ_$$bottom_scan.l_block_counts(p15$1, BV_EXTRACT($key_4.1$1, 32, 0), $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 70} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 70} _CHECK_READ_$$bottom_scan.l_block_counts(p15$2, BV_EXTRACT($key_4.1$2, 32, 0), $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_block_counts"} true;
    v34$1 := (if p15$1 then $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 32, 0)] else v34$1);
    v34$2 := (if p15$2 then $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 32, 0)] else v34$2);
    call {:sourceloc} {:sourceloc_num 71} _LOG_WRITE_$$out(p15$1, BV32_ADD(BV32_ADD(v32$1, v33$1), v34$1), BV_EXTRACT($val_4.1$1, 32, 0), $$out[BV32_ADD(BV32_ADD(v32$1, v33$1), v34$1)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 71} _CHECK_WRITE_$$out(p15$2, BV32_ADD(BV32_ADD(v32$2, v33$2), v34$2), BV_EXTRACT($val_4.1$2, 32, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_ADD(v32$1, v33$1), v34$1)] := (if p15$1 then BV_EXTRACT($val_4.1$1, 32, 0) else $$out[BV32_ADD(BV32_ADD(v32$1, v33$1), v34$1)]);
    $$out[BV32_ADD(BV32_ADD(v32$2, v33$2), v34$2)] := (if p15$2 then BV_EXTRACT($val_4.1$2, 32, 0) else $$out[BV32_ADD(BV32_ADD(v32$2, v33$2), v34$2)]);
    v35$1 := (if p15$1 then BV_EXTRACT($key_4.1$1, 32, 0) else v35$1);
    v35$2 := (if p15$2 then BV_EXTRACT($key_4.1$2, 32, 0) else v35$2);
    v36$1 := (if p15$1 then $$histogram$1[v35$1] else v36$1);
    v36$2 := (if p15$2 then $$histogram$2[v35$2] else v36$2);
    $$histogram$1[v35$1] := (if p15$1 then BV32_ADD(v36$1, 1) else $$histogram$1[v35$1]);
    $$histogram$2[v35$2] := (if p15$2 then BV32_ADD(v36$2, 1) else $$histogram$2[v35$2]);
    v37$1 := (if p15$1 then $$histogram$1[BV_EXTRACT($key_4.1$1, 64, 32)] else v37$1);
    v37$2 := (if p15$2 then $$histogram$2[BV_EXTRACT($key_4.1$2, 64, 32)] else v37$2);
    call {:sourceloc} {:sourceloc_num 75} _LOG_READ_$$bottom_scan.l_scanned_seeds(p15$1, BV_EXTRACT($key_4.1$1, 64, 32), $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 64, 32)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 75} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 75} _CHECK_READ_$$bottom_scan.l_scanned_seeds(p15$2, BV_EXTRACT($key_4.1$2, 64, 32), $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 64, 32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_scanned_seeds"} true;
    v38$1 := (if p15$1 then $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 64, 32)] else v38$1);
    v38$2 := (if p15$2 then $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 64, 32)] else v38$2);
    call {:sourceloc} {:sourceloc_num 76} _LOG_READ_$$bottom_scan.l_block_counts(p15$1, BV_EXTRACT($key_4.1$1, 64, 32), $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 64, 32)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 76} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 76} _CHECK_READ_$$bottom_scan.l_block_counts(p15$2, BV_EXTRACT($key_4.1$2, 64, 32), $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 64, 32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_block_counts"} true;
    v39$1 := (if p15$1 then $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 64, 32)] else v39$1);
    v39$2 := (if p15$2 then $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 64, 32)] else v39$2);
    call {:sourceloc} {:sourceloc_num 77} _LOG_WRITE_$$out(p15$1, BV32_ADD(BV32_ADD(v37$1, v38$1), v39$1), BV_EXTRACT($val_4.1$1, 64, 32), $$out[BV32_ADD(BV32_ADD(v37$1, v38$1), v39$1)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 77} _CHECK_WRITE_$$out(p15$2, BV32_ADD(BV32_ADD(v37$2, v38$2), v39$2), BV_EXTRACT($val_4.1$2, 64, 32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_ADD(v37$1, v38$1), v39$1)] := (if p15$1 then BV_EXTRACT($val_4.1$1, 64, 32) else $$out[BV32_ADD(BV32_ADD(v37$1, v38$1), v39$1)]);
    $$out[BV32_ADD(BV32_ADD(v37$2, v38$2), v39$2)] := (if p15$2 then BV_EXTRACT($val_4.1$2, 64, 32) else $$out[BV32_ADD(BV32_ADD(v37$2, v38$2), v39$2)]);
    v40$1 := (if p15$1 then BV_EXTRACT($key_4.1$1, 64, 32) else v40$1);
    v40$2 := (if p15$2 then BV_EXTRACT($key_4.1$2, 64, 32) else v40$2);
    v41$1 := (if p15$1 then $$histogram$1[v40$1] else v41$1);
    v41$2 := (if p15$2 then $$histogram$2[v40$2] else v41$2);
    $$histogram$1[v40$1] := (if p15$1 then BV32_ADD(v41$1, 1) else $$histogram$1[v40$1]);
    $$histogram$2[v40$2] := (if p15$2 then BV32_ADD(v41$2, 1) else $$histogram$2[v40$2]);
    v42$1 := (if p15$1 then $$histogram$1[BV_EXTRACT($key_4.1$1, 96, 64)] else v42$1);
    v42$2 := (if p15$2 then $$histogram$2[BV_EXTRACT($key_4.1$2, 96, 64)] else v42$2);
    call {:sourceloc} {:sourceloc_num 81} _LOG_READ_$$bottom_scan.l_scanned_seeds(p15$1, BV_EXTRACT($key_4.1$1, 96, 64), $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 96, 64)]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 81} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 81} _CHECK_READ_$$bottom_scan.l_scanned_seeds(p15$2, BV_EXTRACT($key_4.1$2, 96, 64), $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 96, 64)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_scanned_seeds"} true;
    v43$1 := (if p15$1 then $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 96, 64)] else v43$1);
    v43$2 := (if p15$2 then $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 96, 64)] else v43$2);
    call {:sourceloc} {:sourceloc_num 82} _LOG_READ_$$bottom_scan.l_block_counts(p15$1, BV_EXTRACT($key_4.1$1, 96, 64), $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 96, 64)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 82} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 82} _CHECK_READ_$$bottom_scan.l_block_counts(p15$2, BV_EXTRACT($key_4.1$2, 96, 64), $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 96, 64)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_block_counts"} true;
    v44$1 := (if p15$1 then $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 96, 64)] else v44$1);
    v44$2 := (if p15$2 then $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 96, 64)] else v44$2);
    call {:sourceloc} {:sourceloc_num 83} _LOG_WRITE_$$out(p15$1, BV32_ADD(BV32_ADD(v42$1, v43$1), v44$1), BV_EXTRACT($val_4.1$1, 96, 64), $$out[BV32_ADD(BV32_ADD(v42$1, v43$1), v44$1)]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 83} _CHECK_WRITE_$$out(p15$2, BV32_ADD(BV32_ADD(v42$2, v43$2), v44$2), BV_EXTRACT($val_4.1$2, 96, 64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_ADD(v42$1, v43$1), v44$1)] := (if p15$1 then BV_EXTRACT($val_4.1$1, 96, 64) else $$out[BV32_ADD(BV32_ADD(v42$1, v43$1), v44$1)]);
    $$out[BV32_ADD(BV32_ADD(v42$2, v43$2), v44$2)] := (if p15$2 then BV_EXTRACT($val_4.1$2, 96, 64) else $$out[BV32_ADD(BV32_ADD(v42$2, v43$2), v44$2)]);
    v45$1 := (if p15$1 then BV_EXTRACT($key_4.1$1, 96, 64) else v45$1);
    v45$2 := (if p15$2 then BV_EXTRACT($key_4.1$2, 96, 64) else v45$2);
    v46$1 := (if p15$1 then $$histogram$1[v45$1] else v46$1);
    v46$2 := (if p15$2 then $$histogram$2[v45$2] else v46$2);
    $$histogram$1[v45$1] := (if p15$1 then BV32_ADD(v46$1, 1) else $$histogram$1[v45$1]);
    $$histogram$2[v45$2] := (if p15$2 then BV32_ADD(v46$2, 1) else $$histogram$2[v45$2]);
    v47$1 := (if p15$1 then $$histogram$1[BV_EXTRACT($key_4.1$1, 128, 96)] else v47$1);
    v47$2 := (if p15$2 then $$histogram$2[BV_EXTRACT($key_4.1$2, 128, 96)] else v47$2);
    call {:sourceloc} {:sourceloc_num 87} _LOG_READ_$$bottom_scan.l_scanned_seeds(p15$1, BV_EXTRACT($key_4.1$1, 128, 96), $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 128, 96)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 87} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 87} _CHECK_READ_$$bottom_scan.l_scanned_seeds(p15$2, BV_EXTRACT($key_4.1$2, 128, 96), $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 128, 96)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_scanned_seeds"} true;
    v48$1 := (if p15$1 then $$bottom_scan.l_scanned_seeds[1bv1][BV_EXTRACT($key_4.1$1, 128, 96)] else v48$1);
    v48$2 := (if p15$2 then $$bottom_scan.l_scanned_seeds[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 128, 96)] else v48$2);
    call {:sourceloc} {:sourceloc_num 88} _LOG_READ_$$bottom_scan.l_block_counts(p15$1, BV_EXTRACT($key_4.1$1, 128, 96), $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 128, 96)]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 88} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 88} _CHECK_READ_$$bottom_scan.l_block_counts(p15$2, BV_EXTRACT($key_4.1$2, 128, 96), $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 128, 96)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$bottom_scan.l_block_counts"} true;
    v49$1 := (if p15$1 then $$bottom_scan.l_block_counts[1bv1][BV_EXTRACT($key_4.1$1, 128, 96)] else v49$1);
    v49$2 := (if p15$2 then $$bottom_scan.l_block_counts[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($key_4.1$2, 128, 96)] else v49$2);
    call {:sourceloc} {:sourceloc_num 89} _LOG_WRITE_$$out(p15$1, BV32_ADD(BV32_ADD(v47$1, v48$1), v49$1), BV_EXTRACT($val_4.1$1, 128, 96), $$out[BV32_ADD(BV32_ADD(v47$1, v48$1), v49$1)]);
    ...
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 89} _CHECK_WRITE_$$out(p15$2, BV32_ADD(BV32_ADD(v47$2, v48$2), v49$2), BV_EXTRACT($val_4.1$2, 128, 96));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_ADD(v47$1, v48$1), v49$1)] := (if p15$1 then BV_EXTRACT($val_4.1$1, 128, 96) else $$out[BV32_ADD(BV32_ADD(v47$1, v48$1), v49$1)]);
    $$out[BV32_ADD(BV32_ADD(v47$2, v48$2), v49$2)] := (if p15$2 then BV_EXTRACT($val_4.1$2, 128, 96) else $$out[BV32_ADD(BV32_ADD(v47$2, v48$2), v49$2)]);
    v50$1 := (if p15$1 then BV_EXTRACT($key_4.1$1, 128, 96) else v50$1);
    v50$2 := (if p15$2 then BV_EXTRACT($key_4.1$2, 128, 96) else v50$2);
    v51$1 := (if p15$1 then $$histogram$1[v50$1] else v51$1);
    v51$2 := (if p15$2 then $$histogram$2[v50$2] else v51$2);
    $$histogram$1[v50$1] := (if p15$1 then BV32_ADD(v51$1, 1) else $$histogram$1[v50$1]);
    $$histogram$2[v50$2] := (if p15$2 then BV32_ADD(v51$2, 1) else $$histogram$2[v50$2]);
    goto __partitioned_block_$14.tail_1;

  __partitioned_block_$14.tail_1:
    call {:sourceloc_num 93} $bugle_barrier_duplicated_1(-1, 0, p5$1, p5$2);
    v52$1 := (if p5$1 then local_id_x$1 == BV32_SUB(group_size_x, 1) else v52$1);
    v52$2 := (if p5$2 then local_id_x$2 == BV32_SUB(group_size_x, 1) else v52$2);
    p17$1 := (if p5$1 && v52$1 then v52$1 else p17$1);
    p17$2 := (if p5$2 && v52$2 then v52$2 else p17$2);
    $q1.0$1 := (if p17$1 then 0 else $q1.0$1);
    $q1.0$2 := (if p17$2 then 0 else $q1.0$2);
  ...
  $23:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b156 ==> !p17$1 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$23 == _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "disabledMaintainsInstrumentation"} _b155 ==> !p17$1 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts$ghost$$23 == _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b154 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b153 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p18$1 ==> p4$1;
    assert p18$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> local_id_x$1 == BV32_SUB(group_size_x, 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> local_id_x$1 == BV32_SUB(group_size_x, 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts ==> BV32_SLT($window.0$1, $0$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> BV32_SLT($window.0$1, $0$1) && local_id_x$1 == BV32_SUB(group_size_x, 1) && BV32_SLT($q1.0$1, 16) ==> p18$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> BV32_SLT($window.0$2, $0$2) && local_id_x$2 == BV32_SUB(group_size_x, 1) && BV32_SLT($q1.0$2, 16) ==> p18$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p18$1 ==> _b25 ==> p18$1 ==> BV32_SLT($window.0$1, $0$1) && local_id_x$1 == BV32_SUB(group_size_x, 1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p18$2 ==> _b25 ==> p18$2 ==> BV32_SLT($window.0$2, $0$2) && local_id_x$2 == BV32_SUB(group_size_x, 1);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b24 ==> BV32_UGE($q1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b24 ==> BV32_UGE($q1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b23 ==> BV32_ULE($q1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b23 ==> BV32_ULE($q1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b22 ==> BV32_SGE($q1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b22 ==> BV32_SGE($q1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b21 ==> BV32_SLE($q1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b21 ==> BV32_SLE($q1.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p18$1 ==> _b20 ==> $q1.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p18$2 ==> _b20 ==> $q1.0$2 mod 1 == 0 mod 1;
    assert {:block_sourceloc} {:sourceloc_num 95} p18$1 ==> true;
    v53$1 := (if p18$1 then BV32_SLT($q1.0$1, 16) else v53$1);
    v53$2 := (if p18$2 then BV32_SLT($q1.0$2, 16) else v53$2);
    p19$1 := false;
    p19$2 := false;
    ...
    $q1.0$1 := (if p19$1 then BV32_ADD($q1.0$1, 1) else $q1.0$1);
    $q1.0$2 := (if p19$2 then BV32_ADD($q1.0$2, 1) else $q1.0$2);
  ...
  __partitioned_block_$23.tail_1:
    call {:sourceloc_num 103} $bugle_barrier_duplicated_2(-1, 0, p5$1, p5$2);
...
const _WATCHED_VALUE_$$bottom_scan.l_block_counts: int;

procedure {:inline 1} _LOG_READ_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;



implementation {:inline 1} _LOG_READ_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts, _WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_block_counts;



implementation {:inline 1} _LOG_WRITE_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$bottom_scan.l_block_counts(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$bottom_scan.l_block_counts(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts;



implementation {:inline 1} _LOG_ATOMIC_$$bottom_scan.l_block_counts(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$bottom_scan.l_block_counts(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_block_counts(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_block_counts;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_block_counts(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$bottom_scan.l_scanned_seeds: int;

procedure {:inline 1} _LOG_READ_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;



implementation {:inline 1} _LOG_READ_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds, _WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_scanned_seeds;



implementation {:inline 1} _LOG_WRITE_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;



implementation {:inline 1} _LOG_ATOMIC_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_scanned_seeds;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$bottom_scan.l_scanned_seeds(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon1:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    goto anon2;

  anon2:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    goto anon3;
...
implementation {:inline 1} $bugle_barrier_duplicated_1($0: int, $1: int, _P$1: bool, _P$2: bool)
{
  ...
  anon1:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$bottom_scan.l_block_counts;
    goto anon2;

  anon2:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$bottom_scan.l_scanned_seeds;
    goto anon3;
