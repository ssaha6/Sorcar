...
implementation {:source_name "reduce"} {:kernel} $reduce($n: int, $shift: int)
{
  ...
  $7:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == 0 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b16 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b15 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$isums ==> _WATCHED_OFFSET mod BV32_MUL(1, num_groups_x) == BV32_ADD(BV32_MUL(0, num_groups_x), group_id_x$1) mod BV32_MUL(1, num_groups_x);
    assert {:tag "accessUpperBoundBlock"} _b13 ==> _WRITE_HAS_OCCURRED_$$isums ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(group_id_x$1, 1));
    ...
    assert {:tag "pow2NotZero"} _b10 ==> $s.0 != 0;
    assert {:tag "pow2"} _b9 ==> $s.0 == 0 || BV32_AND($s.0, BV32_SUB($s.0, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $9:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b22 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b21 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "pow2NotZero"} _b20 ==> $s.0 != 0;
    assert {:tag "pow2"} _b19 ==> $s.0 == 0 || BV32_AND($s.0, BV32_SUB($s.0, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_UGE($s.0, BV32_UDIV(group_size_x, 2));
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_ULE($s.0, BV32_UDIV(group_size_x, 2));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SGE($s.0, BV32_UDIV(group_size_x, 2));
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SLE($s.0, BV32_UDIV(group_size_x, 2));
