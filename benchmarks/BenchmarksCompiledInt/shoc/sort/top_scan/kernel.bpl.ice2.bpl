...
assert  my_inv (  (  $d.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($d.0, 0) ) ,  (  BV32_SGE($d.0, 0) ) ,  (  BV32_ULE($d.0, 0) ) ,  (  BV32_UGE($d.0, 0) ) ,  true ,  true ,  true ,  true ,  (  $i.i.0 == 0 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1)) == 0 ) ,  (  $i.i.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$isums ) ,  (  !_WRITE_HAS_OCCURRED_$$isums ) ,  (  _READ_HAS_OCCURRED_$$isums ==> _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n) ) ,  (  _WRITE_HAS_OCCURRED_$$isums ==> _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n) ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(local_id_x$1, group_size_x), 1) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) ) ,  (  !_READ_HAS_OCCURRED_$$top_scan.s_seed ) ,  (  !_WRITE_HAS_OCCURRED_$$top_scan.s_seed ) ,  (  _READ_HAS_OCCURRED_$$top_scan.s_seed ==> _WATCHED_OFFSET == 0 ) ,  (  _WRITE_HAS_OCCURRED_$$top_scan.s_seed ==> _WATCHED_OFFSET == 0 ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($i.i.0, 1) ) ,  (  BV32_SGE($i.i.0, 1) ) ,  (  BV32_ULE($i.i.0, 1) ) ,  (  BV32_UGE($i.i.0, 1) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $i.i.0 == 0 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1)) == 0 ) ,  (  $i.i.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$lmem ) ,  (  !_WRITE_HAS_OCCURRED_$$lmem ) ,  (  _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x) )  ); 
