...
implementation {:source_name "BFS_kernel"} {:kernel} $BFS_kernel($no_of_nodes: int, $gray_shade: int, $k: int)
{
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b21 ==> !p2$1 ==> _WRITE_HAS_OCCURRED_$$local_q$ghost$$4 == _WRITE_HAS_OCCURRED_$$local_q;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _WRITE_HAS_OCCURRED_$$local_q ==> _WATCHED_OFFSET == v22$1;
    assert {:tag "disabledMaintainsInstrumentation"} _b19 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$local_q_tail$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$local_q_tail;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b18 ==> _ATOMIC_HAS_OCCURRED_$$local_q_tail ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b17 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$g_cost$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$g_cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b16 ==> !p2$1 ==> _ATOMIC_HAS_OCCURRED_$$g_color$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$g_color;
    assert {:tag "disabledMaintainsInstrumentation"} _b15 ==> !p2$1 ==> _READ_HAS_OCCURRED_$$g_color$ghost$$4 == _READ_HAS_OCCURRED_$$g_color;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$local_q ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$g_color ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes) && BV32_SLT($i.0$1, BV32_ADD(v6$1, v5$1)) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes) && BV32_SLT($i.0$2, BV32_ADD(v6$2, v5$2)) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b11 ==> p3$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b11 ==> p3$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b10 ==> BV32_UGE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b10 ==> BV32_UGE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b9 ==> BV32_ULE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b9 ==> BV32_ULE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b8 ==> BV32_SGE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b8 ==> BV32_SGE($i.0$2, v7$2);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b7 ==> BV32_SLE($i.0$1, v7$1);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b7 ==> BV32_SLE($i.0$2, v7$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p3$1 ==> _b6 ==> $i.0$1 mod 1 == v7$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p3$2 ==> _b6 ==> $i.0$2 mod 1 == v7$2 mod 1;
  ...
  $17:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b24 ==> _READ_HAS_OCCURRED_$$shift ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _READ_HAS_OCCURRED_$$local_q ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _READ_HAS_OCCURRED_$$local_q_tail ==> _WATCHED_OFFSET == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$shift ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$shift ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$shift ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$local_q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$local_q_tail ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$local_q_tail ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLT($local_shift.0$1, v26$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLT($local_shift.0$2, v26$2) ==> p14$2;
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b4 ==> BV32_UGE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b4 ==> BV32_UGE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b3 ==> BV32_ULE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b3 ==> BV32_ULE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b2 ==> BV32_SGE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b2 ==> BV32_SGE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b1 ==> BV32_SLE($local_shift.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b1 ==> BV32_SLE($local_shift.0$2, local_id_x$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p14$1 ==> _b0 ==> $local_shift.0$1 mod group_size_x == local_id_x$1 mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p14$2 ==> _b0 ==> $local_shift.0$2 mod group_size_x == local_id_x$2 mod group_size_x;
