...
function  BV16_ADD(x: int, y: int) : int
{
  x + y
}
...
assert  my_inv (  ( p0$1 ==> $search_pos.0$1 mod 32 == local_id_x$1 mod 32 )  && ( p0$2 ==> $search_pos.0$2 mod 32 == local_id_x$2 mod 32 ) ,  ( p0$1 ==> BV32_SLE($search_pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($search_pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($search_pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($search_pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($search_pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($search_pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($search_pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($search_pos.0$2, local_id_x$2) ) ,  (  BV32_SLT($search_pos.0$1, 545) ==> p0$1 )  && (  BV32_SLT($search_pos.0$2, 545) ==> p0$2 ) ,  (  _READ_HAS_OCCURRED_$$blk_sad ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 )  ); 
