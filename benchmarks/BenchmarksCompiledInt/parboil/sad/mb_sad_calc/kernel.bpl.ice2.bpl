...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$blk_sad$ghost$$5 == _WRITE_HAS_OCCURRED_$$blk_sad )  ); 
...
assert  my_inv (  ( p4$1 ==> $search_pos.0$1 mod 1 == v13$1 mod 1 )  && ( p4$2 ==> $search_pos.0$2 mod 1 == v13$2 mod 1 ) ,  ( p4$1 ==> BV32_SLE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_SLE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_SGE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_SGE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_ULE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_ULE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> BV32_UGE($search_pos.0$1, v13$1) )  && ( p4$2 ==> BV32_UGE($search_pos.0$2, v13$2) ) ,  ( p4$1 ==> p4$1 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61), 1), group_id_x$1), 2), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61), 1), group_id_y$1), 2), $mb_height) )  && ( p4$2 ==> p4$2 ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61), 1), group_id_x$2), 2), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61), 1), group_id_y$2), 2), $mb_height) ) ,  (  BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61), 1), group_id_x$1), 2), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61), 1), group_id_y$1), 2), $mb_height) && BV32_SLT($search_pos.0$1, $search_pos_end.0$1) ==> p4$1 )  && (  BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$2, 61), 1), group_id_x$2), 2), $mb_width) && BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$2, 61), 1), group_id_y$2), 2), $mb_height) && BV32_SLT($search_pos.0$2, $search_pos_end.0$2) ==> p4$2 ) ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UREM(BV32_UDIV(local_id_x$1, 61), 1), group_id_x$1), 2), $mb_width) ) ,  (  _WRITE_HAS_OCCURRED_$$blk_sad ==> BV32_SLT(BV32_ASHR(BV32_ADD(BV32_UDIV(BV32_UDIV(local_id_x$1, 61), 1), group_id_y$1), 2), $mb_height) ) ,  true ,  true  ); 
