...
assert  my_inv (  ( p0$1 ==> $i.i.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p0$2 ==> $i.i.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p0$1 ==> BV32_SLE($i.i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($i.i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($i.i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($i.i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($i.i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($i.i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($i.i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($i.i.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.i.0$1, 6144) ==> p0$1 )  && (  BV32_SLT($i.i.0$2, 6144) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_histo$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$global_histo ) ,  (  !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$global_overflow ) ,  (  !p3$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$4 == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $local_scan_load.0$1 mod BV32_MUL(group_size_x, num_groups_x) == v3$1 mod BV32_MUL(group_size_x, num_groups_x) )  && ( p4$2 ==> $local_scan_load.0$2 mod BV32_MUL(group_size_x, num_groups_x) == v3$2 mod BV32_MUL(group_size_x, num_groups_x) ) ,  ( p4$1 ==> BV32_SLE($local_scan_load.0$1, v3$1) )  && ( p4$2 ==> BV32_SLE($local_scan_load.0$2, v3$2) ) ,  ( p4$1 ==> BV32_SGE($local_scan_load.0$1, v3$1) )  && ( p4$2 ==> BV32_SGE($local_scan_load.0$2, v3$2) ) ,  ( p4$1 ==> BV32_ULE($local_scan_load.0$1, v3$1) )  && ( p4$2 ==> BV32_ULE($local_scan_load.0$2, v3$2) ) ,  ( p4$1 ==> BV32_UGE($local_scan_load.0$1, v3$1) )  && ( p4$2 ==> BV32_UGE($local_scan_load.0$2, v3$2) ) ,  ( p4$1 ==> p4$1 ==> group_id_y$1 == 0 )  && ( p4$2 ==> p4$2 ==> group_id_y$2 == 0 ) ,  (  group_id_y$1 == 0 && BV32_ULT($local_scan_load.0$1, $num_elements) ==> p4$1 )  && (  group_id_y$2 == 0 && BV32_ULT($local_scan_load.0$2, $num_elements) ==> p4$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$global_overflow$ghost$$36 == _ATOMIC_HAS_OCCURRED_$$global_overflow ) ,  (  !p41$1 ==> _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo$ghost$$36 == _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p42$1 ==> $local_scan_load.1$1 mod BV32_MUL(group_size_x, num_groups_x) == v3$1 mod BV32_MUL(group_size_x, num_groups_x) )  && ( p42$2 ==> $local_scan_load.1$2 mod BV32_MUL(group_size_x, num_groups_x) == v3$2 mod BV32_MUL(group_size_x, num_groups_x) ) ,  ( p42$1 ==> BV32_SLE($local_scan_load.1$1, v3$1) )  && ( p42$2 ==> BV32_SLE($local_scan_load.1$2, v3$2) ) ,  ( p42$1 ==> BV32_SGE($local_scan_load.1$1, v3$1) )  && ( p42$2 ==> BV32_SGE($local_scan_load.1$2, v3$2) ) ,  ( p42$1 ==> BV32_ULE($local_scan_load.1$1, v3$1) )  && ( p42$2 ==> BV32_ULE($local_scan_load.1$2, v3$2) ) ,  ( p42$1 ==> BV32_UGE($local_scan_load.1$1, v3$1) )  && ( p42$2 ==> BV32_UGE($local_scan_load.1$2, v3$2) ) ,  ( p42$1 ==> p42$1 ==> group_id_y$1 != 0 )  && ( p42$2 ==> p42$2 ==> group_id_y$2 != 0 ) ,  (  group_id_y$1 != 0 && BV32_ULT($local_scan_load.1$1, $num_elements) ==> p42$1 )  && (  group_id_y$2 != 0 && BV32_ULT($local_scan_load.1$2, $num_elements) ==> p42$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p72$1 ==> $i.i28.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p72$2 ==> $i.i28.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p72$1 ==> BV32_SLE($i.i28.0$1, local_id_x$1) )  && ( p72$2 ==> BV32_SLE($i.i28.0$2, local_id_x$2) ) ,  ( p72$1 ==> BV32_SGE($i.i28.0$1, local_id_x$1) )  && ( p72$2 ==> BV32_SGE($i.i28.0$2, local_id_x$2) ) ,  ( p72$1 ==> BV32_ULE($i.i28.0$1, local_id_x$1) )  && ( p72$2 ==> BV32_ULE($i.i28.0$2, local_id_x$2) ) ,  ( p72$1 ==> BV32_UGE($i.i28.0$1, local_id_x$1) )  && ( p72$2 ==> BV32_UGE($i.i28.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.i28.0$1, 6144) ==> p72$1 )  && (  BV32_SLT($i.i28.0$2, 6144) ==> p72$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _ATOMIC_HAS_OCCURRED_$$global_subhisto ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x || _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x || _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x || _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x )  ); 
