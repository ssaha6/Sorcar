...
implementation {:source_name "histo_prescan_kernel"} {:kernel} $histo_prescan_kernel($size: int)
{
  ...
  $7:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$histo_prescan_kernel.StdDev ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _READ_HAS_OCCURRED_$$histo_prescan_kernel.StdDev ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    ...
    assert {:tag "nowrite"} _b17 ==> !_WRITE_HAS_OCCURRED_$$histo_prescan_kernel.StdDev;
    assert {:tag "noread"} _b16 ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.StdDev;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    ...
    assert {:tag "nowrite"} _b11 ==> !_WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    assert {:tag "noread"} _b10 ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride1.0, 256);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride1.0, 256);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride1.0, 256);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride1.0, 256);
