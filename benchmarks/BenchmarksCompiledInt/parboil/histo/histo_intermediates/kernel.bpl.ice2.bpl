...
assert  my_inv (  (  $load_bin.0$1 mod BV32_MUL($input_pitch, 2) == BV32_ADD(BV32_MUL(BV32_MUL(v2$1, $input_pitch), 2), BV32_MUL(v0$1, 2)) mod BV32_MUL($input_pitch, 2) )  && (  $load_bin.0$2 mod BV32_MUL($input_pitch, 2) == BV32_ADD(BV32_MUL(BV32_MUL(v2$2, $input_pitch), 2), BV32_MUL(v0$2, 2)) mod BV32_MUL($input_pitch, 2) ) ,  (  $store.0$1 mod $width == BV32_ADD(BV32_MUL(v2$1, $width), v0$1) mod $width )  && (  $store.0$2 mod $width == BV32_ADD(BV32_MUL(v2$2, $width), v0$2) mod $width ) ,  (  $i.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  (  _WRITE_HAS_OCCURRED_$$sm_mappings ==> _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4), 1) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4), 2) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), 4), 3) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4), 1) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4), 2) mod BV32_MUL($width, 4) || _WATCHED_OFFSET mod BV32_MUL($width, 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(v2$1, $width), v0$1), group_size_x), 4), 3) mod BV32_MUL($width, 4) )  ); 
