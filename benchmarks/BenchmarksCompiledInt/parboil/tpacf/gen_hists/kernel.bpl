...
implementation {:source_name "gen_hists"} {:kernel} $gen_hists($NUM_SETS: int, $NUM_ELEMENTS: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b32 ==> _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($w.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($w.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($w.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($w.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> $w.0 mod 256 == 0 mod 256;
  ...
  $10:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($j.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b5 ==> $j.0 mod 256 == 0 mod 256;
  ...
  $37:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b50 ==> _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b49 ==> _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert {:tag "pow2NotZero"} _b40 ==> $offset.0 != 0;
    assert {:tag "pow2"} _b39 ==> $offset.0 == 0 || BV32_AND($offset.0, BV32_SUB($offset.0, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_UGE($offset.0, 64);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_ULE($offset.0, 64);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SGE($offset.0, 64);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SLE($offset.0, 64);
  ...
  $39:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b60 ==> _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b59 ==> _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert {:tag "nowrite"} _b56 ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "noread"} _b55 ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_UGE($bin_base.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_ULE($bin_base.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SGE($bin_base.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_SLE($bin_base.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b14 ==> $bin_base.0 mod 4 == 0 mod 4;
  ...
  $14:
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b90 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_MUL(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_MUL(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$all_x_data;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b89 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_MUL(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_MUL(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$all_x_data;
    ...
    assert {:tag "predicatedEquality"} _b86 ==> p6$1 && p6$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b85 ==> p6$1 && p6$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b84 ==> p6$1 && p6$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b83 ==> p6$1 && p6$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b82 ==> p6$1 && p6$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b81 ==> p6$1 && p6$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b80 ==> p6$1 && p6$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b79 ==> p6$1 && p6$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b78 ==> p6$1 && p6$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b77 ==> p6$1 && p6$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b76 ==> p6$1 && p6$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b75 ==> p6$1 && p6$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b74 ==> p6$1 && p6$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b73 ==> p6$1 && p6$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b72 ==> p6$1 && p6$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b71 ==> p6$1 && p6$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b70 ==> p6$1 && p6$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b69 ==> p6$1 && p6$2 ==> $max.1$1 == $max.1$2;
    assert {:tag "predicatedEquality"} _b68 ==> p6$1 && p6$2 ==> $min.1$1 == $min.1$2;
    assert {:tag "predicatedEquality"} _b67 ==> p6$1 && p6$2 ==> $max.0$1 == $max.0$2;
    assert {:tag "predicatedEquality"} _b66 ==> p6$1 && p6$2 ==> $min.0$1 == $min.0$2;
    assert {:tag "predicatedEquality"} _b65 ==> p6$1 && p6$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b64 ==> p6$1 && p6$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b63 ==> p6$1 && p6$2 ==> $k.0$1 == $k.0$2;
    assert {:tag "loopPredicateEquality"} _b62 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p6$1 == p6$2;
    assert {:tag "loopPredicateEquality"} _b61 ==> p6$1 == p6$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b25 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && $0$1 == 1 ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b25 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && $0$2 == 1 ==> p6$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b23 ==> BV32_UGE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b23 ==> BV32_UGE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b22 ==> BV32_ULE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b22 ==> BV32_ULE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b21 ==> BV32_SGE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b21 ==> BV32_SGE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b20 ==> BV32_SLE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b20 ==> BV32_SLE($k.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b19 ==> $k.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b19 ==> $k.0$2 mod 1 == 0 mod 1;
