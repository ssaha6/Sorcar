...
implementation {:source_name "opencl_cutoff_potential_lattice"} {:kernel} $opencl_cutoff_potential_lattice($binDim_x: int, $binDim_y: int, $offset: int, $h: int, $cutoff2: int, $inv_cutoff2: int, $zRegionIndex: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b104 ==> _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 16) mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b103 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
    assert {:tag "nowrite"} _b102 ==> !_WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "noread"} _b101 ==> !_READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b100 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> _WATCHED_OFFSET == 0 || _WATCHED_OFFSET == 1 || _WATCHED_OFFSET == 2 || _WATCHED_OFFSET == 3;
    assert {:tag "noread"} _b99 ==> !_READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex;
    ...
    assert {:tag "predicatedEquality"} _b79 ==> p0$1 && p0$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b78 ==> p0$1 && p0$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b77 ==> p0$1 && p0$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b76 ==> p0$1 && p0$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b75 ==> p0$1 && p0$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b74 ==> p0$1 && p0$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b73 ==> p0$1 && p0$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b72 ==> p0$1 && p0$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b71 ==> p0$1 && p0$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b69 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
    ...
    assert {:tag "pow2NotZero"} _b35 ==> $nbrid.0$2 != 0;
    assert {:tag "pow2"} _b34 ==> $nbrid.0$2 == 0 || BV32_AND($nbrid.0$2, BV32_SUB($nbrid.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b33 ==> $nbrid.0$1 != 0;
    assert {:tag "pow2"} _b32 ==> $nbrid.0$1 == 0 || BV32_AND($nbrid.0$1, BV32_SUB($nbrid.0$1, 1)) == 0;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b4 ==> BV32_SLT($totalbins.0$1, v6$1) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b4 ==> BV32_SLT($totalbins.0$2, v6$2) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_UGE($totalbins.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_UGE($totalbins.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_ULE($totalbins.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_ULE($totalbins.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b1 ==> BV32_SGE($totalbins.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b1 ==> BV32_SGE($totalbins.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b0 ==> BV32_SLE($totalbins.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b0 ==> BV32_SLE($totalbins.0$2, 0);
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b107 ==> _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 16) mod 1;
    assert {:tag "disabledMaintainsInstrumentation"} _b106 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex$ghost$$3 == _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b105 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> _WATCHED_OFFSET == 0 || _WATCHED_OFFSET == 1 || _WATCHED_OFFSET == 2 || _WATCHED_OFFSET == 3;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLT($totalbins.0$1, v6$1) && $0$1 == 1 ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLT($totalbins.0$2, v6$2) && $0$2 == 1 ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b11 ==> p2$1 ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b11 ==> p2$2 ==> BV32_SLT($totalbins.0$2, v6$2);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b10 ==> BV32_UGE($bincnt.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b10 ==> BV32_UGE($bincnt.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b9 ==> BV32_ULE($bincnt.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b9 ==> BV32_ULE($bincnt.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b8 ==> BV32_SGE($bincnt.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b8 ==> BV32_SGE($bincnt.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b7 ==> BV32_SLE($bincnt.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b7 ==> BV32_SLE($bincnt.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b6 ==> $bincnt.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b6 ==> $bincnt.0$2 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b5 ==> $nbrid.1$1 mod 8 == $nbrid.0$1 mod 8;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b5 ==> $nbrid.1$2 mod 8 == $nbrid.0$2 mod 8;
  ...
  $11:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b110 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache$ghost$$11 == _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b109 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p8$1 ==> p0$1;
    assert p8$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_SLT($totalbins.0$1, v6$1) && BV32_SLT($bincnt.1$1, $numbins.1$1) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_SLT($totalbins.0$2, v6$2) && BV32_SLT($bincnt.1$2, $numbins.1$2) ==> p8$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b20 ==> p8$1 ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b20 ==> p8$2 ==> BV32_SLT($totalbins.0$2, v6$2);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b19 ==> BV32_UGE($bincnt.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b19 ==> BV32_UGE($bincnt.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b18 ==> BV32_ULE($bincnt.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b18 ==> BV32_ULE($bincnt.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b17 ==> BV32_SGE($bincnt.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b17 ==> BV32_SGE($bincnt.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b16 ==> BV32_SLE($bincnt.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b16 ==> BV32_SLE($bincnt.1$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p8$1 ==> _b15 ==> $bincnt.1$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p8$2 ==> _b15 ==> $bincnt.1$2 mod 1 == 0 mod 1;
  ...
  $13:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b112 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache$ghost$$13 == _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b111 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p8$1 ==> p0$1;
    assert p8$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($bincnt.1$1, $numbins.1$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v6$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b29 ==> BV32_SLT($totalbins.0$1, v6$1) && BV32_SLT($bincnt.1$1, $numbins.1$1) && BV32_SLT($i1.0$1, 8) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b29 ==> BV32_SLT($totalbins.0$2, v6$2) && BV32_SLT($bincnt.1$2, $numbins.1$2) && BV32_SLT($i1.0$2, 8) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b28 ==> p10$1 ==> BV32_SLT($totalbins.0$1, v6$1) && BV32_SLT($bincnt.1$1, $numbins.1$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b28 ==> p10$2 ==> BV32_SLT($totalbins.0$2, v6$2) && BV32_SLT($bincnt.1$2, $numbins.1$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b27 ==> BV32_UGE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b27 ==> BV32_UGE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b26 ==> BV32_ULE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b26 ==> BV32_ULE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b25 ==> BV32_SGE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b25 ==> BV32_SGE($i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b24 ==> BV32_SLE($i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b24 ==> BV32_SLE($i1.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p10$1 ==> _b23 ==> $i1.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p10$2 ==> _b23 ==> $i1.0$2 mod 1 == 0 mod 1;
