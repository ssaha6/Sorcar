...
implementation {:source_name "splitSort"} {:kernel} $splitSort($numElems: bv32, $iter: bv32)
{
  ...
  $5:
    ...
    assert {:tag "pow2NotZero"} _b18 ==> $d1.i.0 != 0bv32;
    assert {:tag "pow2"} _b17 ==> $d1.i.0 == 0bv32 || BV32_AND($d1.i.0, BV32_SUB($d1.i.0, 1bv32)) == 0bv32;
  ...
  $14:
    ...
    assert {:tag "relationalPow2"} _b106 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 2bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 1bv32;
    assert {:tag "relationalPow2"} _b105 ==> BV32_MUL($d1.i.0, $stride.i.1) == 1bv32;
    assert {:tag "relationalPow2"} _b104 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 4bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 2bv32;
    assert {:tag "relationalPow2"} _b103 ==> BV32_MUL($d1.i.0, $stride.i.1) == 2bv32;
    assert {:tag "relationalPow2"} _b102 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 8bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 4bv32;
    assert {:tag "relationalPow2"} _b101 ==> BV32_MUL($d1.i.0, $stride.i.1) == 4bv32;
    assert {:tag "relationalPow2"} _b100 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 16bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 8bv32;
    assert {:tag "relationalPow2"} _b99 ==> BV32_MUL($d1.i.0, $stride.i.1) == 8bv32;
    assert {:tag "relationalPow2"} _b98 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 32bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 16bv32;
    assert {:tag "relationalPow2"} _b97 ==> BV32_MUL($d1.i.0, $stride.i.1) == 16bv32;
    assert {:tag "relationalPow2"} _b96 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 64bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 32bv32;
    assert {:tag "relationalPow2"} _b95 ==> BV32_MUL($d1.i.0, $stride.i.1) == 32bv32;
    assert {:tag "relationalPow2"} _b94 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 128bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 64bv32;
    assert {:tag "relationalPow2"} _b93 ==> BV32_MUL($d1.i.0, $stride.i.1) == 64bv32;
    assert {:tag "relationalPow2"} _b92 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 256bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 128bv32;
    assert {:tag "relationalPow2"} _b91 ==> BV32_MUL($d1.i.0, $stride.i.1) == 128bv32;
    assert {:tag "relationalPow2"} _b90 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 512bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 256bv32;
    assert {:tag "relationalPow2"} _b89 ==> BV32_MUL($d1.i.0, $stride.i.1) == 256bv32;
    assert {:tag "relationalPow2"} _b88 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 1024bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 512bv32;
    assert {:tag "relationalPow2"} _b87 ==> BV32_MUL($d1.i.0, $stride.i.1) == 512bv32;
    assert {:tag "relationalPow2"} _b86 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 2048bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b85 ==> BV32_MUL($d1.i.0, $stride.i.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b84 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 4096bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b83 ==> BV32_MUL($d1.i.0, $stride.i.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b82 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 8192bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b81 ==> BV32_MUL($d1.i.0, $stride.i.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b80 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 16384bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b79 ==> BV32_MUL($d1.i.0, $stride.i.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b78 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 32768bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b77 ==> BV32_MUL($d1.i.0, $stride.i.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b76 ==> ($stride.i.1 == 0bv32 && $d1.i.0 == 65536bv32) || BV32_MUL($d1.i.0, $stride.i.1) == 32768bv32;
    assert {:tag "relationalPow2"} _b75 ==> BV32_MUL($d1.i.0, $stride.i.1) == 32768bv32;
    ...
    assert {:tag "pow2NotZero"} _b70 ==> $d1.i.0 != 0bv32;
    assert {:tag "pow2"} _b69 ==> $d1.i.0 == 0bv32 || BV32_AND($d1.i.0, BV32_SUB($d1.i.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$splitSort.flags ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$splitSort.flags ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$splitSort.flags ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$splitSort.histo_s ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$splitSort.histo_s ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$splitSort.histo_s ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_UGE($d1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_ULE($d1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SGE($d1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SLE($d1.i.0, 1bv32);
