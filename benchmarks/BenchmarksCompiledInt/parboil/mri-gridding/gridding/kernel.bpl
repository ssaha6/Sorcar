...
implementation {:source_name "gridding_GPU"} {:kernel} $gridding_GPU($beta: int)
{
  ...
  $19:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b93 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 3) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 5);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b92 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_MUL(0, 6) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 1) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 5) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6);
    assert {:tag "nowrite"} _b91 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b90 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b89 ==> p12$1 && p12$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b88 ==> p12$1 && p12$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b87 ==> p12$1 && p12$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b86 ==> p12$1 && p12$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b85 ==> p12$1 && p12$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b84 ==> p12$1 && p12$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b83 ==> p12$1 && p12$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b82 ==> p12$1 && p12$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b81 ==> p12$1 && p12$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b80 ==> p12$1 && p12$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b79 ==> p12$1 && p12$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b78 ==> p12$1 && p12$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b77 ==> p12$1 && p12$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b76 ==> p12$1 && p12$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b75 ==> p12$1 && p12$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b74 ==> p12$1 && p12$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b73 ==> p12$1 && p12$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b72 ==> p12$1 && p12$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b71 ==> p12$1 && p12$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b70 ==> p12$1 && p12$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b69 ==> p12$1 && p12$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b68 ==> p12$1 && p12$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b67 ==> p12$1 && p12$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b66 ==> p12$1 && p12$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b65 ==> p12$1 && p12$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b64 ==> p12$1 && p12$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b63 ==> p12$1 && p12$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b62 ==> p12$1 && p12$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b61 ==> p12$1 && p12$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b60 ==> p12$1 && p12$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b59 ==> p12$1 && p12$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b58 ==> p12$1 && p12$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b57 ==> p12$1 && p12$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b56 ==> p12$1 && p12$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b55 ==> p12$1 && p12$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b54 ==> p12$1 && p12$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b53 ==> p12$1 && p12$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b52 ==> p12$1 && p12$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b51 ==> p12$1 && p12$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b50 ==> p12$1 && p12$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b49 ==> p12$1 && p12$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b48 ==> p12$1 && p12$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b47 ==> p12$1 && p12$2 ==> $6$1 == $6$2;
    assert {:tag "predicatedEquality"} _b46 ==> p12$1 && p12$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b45 ==> p12$1 && p12$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b44 ==> p12$1 && p12$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "predicatedEquality"} _b43 ==> p12$1 && p12$2 ==> $y.0$1 == $y.0$2;
    assert {:tag "predicatedEquality"} _b42 ==> p12$1 && p12$2 ==> $density.1$1 == $density.1$2;
    assert {:tag "predicatedEquality"} _b41 ==> p12$1 && p12$2 ==> $pt.1$1 == $pt.1$2;
    assert {:tag "predicatedEquality"} _b40 ==> p12$1 && p12$2 ==> $z.0$1 == $z.0$2;
    assert {:tag "predicatedEquality"} _b39 ==> p12$1 && p12$2 ==> $density.0$1 == $density.0$2;
    assert {:tag "predicatedEquality"} _b38 ==> p12$1 && p12$2 ==> $pt.0$1 == $pt.0$2;
    assert {:tag "loopPredicateEquality"} _b37 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p12$1 == p12$2;
    assert {:tag "loopPredicateEquality"} _b36 ==> p12$1 == p12$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLE($z.0$1, $5$1) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLE($z.0$2, $5$2) ==> p12$2;
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b4 ==> BV32_UGE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b4 ==> BV32_UGE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b3 ==> BV32_ULE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b3 ==> BV32_ULE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b2 ==> BV32_SGE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b2 ==> BV32_SGE($z.0$2, $4$2);
    assert {:tag "loopBound"} {:thread 1} p12$1 ==> _b1 ==> BV32_SLE($z.0$1, $4$1);
    assert {:tag "loopBound"} {:thread 2} p12$2 ==> _b1 ==> BV32_SLE($z.0$2, $4$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p12$1 ==> _b0 ==> $z.0$1 mod 1 == $4$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p12$2 ==> _b0 ==> $z.0$2 mod 1 == $4$2 mod 1;
  ...
  $21:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b149 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$21 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b148 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$21 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b147 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 3) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 5);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b146 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_MUL(0, 6) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 1) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 5) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6);
    assert {:tag "nowrite"} _b145 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b144 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b143 ==> p14$1 && p14$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b142 ==> p14$1 && p14$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b141 ==> p14$1 && p14$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b140 ==> p14$1 && p14$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b139 ==> p14$1 && p14$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b138 ==> p14$1 && p14$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b137 ==> p14$1 && p14$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b136 ==> p14$1 && p14$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b135 ==> p14$1 && p14$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b134 ==> p14$1 && p14$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b133 ==> p14$1 && p14$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b132 ==> p14$1 && p14$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b131 ==> p14$1 && p14$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b130 ==> p14$1 && p14$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b129 ==> p14$1 && p14$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b128 ==> p14$1 && p14$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b127 ==> p14$1 && p14$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b126 ==> p14$1 && p14$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b125 ==> p14$1 && p14$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b124 ==> p14$1 && p14$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b123 ==> p14$1 && p14$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b122 ==> p14$1 && p14$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b121 ==> p14$1 && p14$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b120 ==> p14$1 && p14$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b119 ==> p14$1 && p14$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b118 ==> p14$1 && p14$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b117 ==> p14$1 && p14$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b116 ==> p14$1 && p14$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b115 ==> p14$1 && p14$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b114 ==> p14$1 && p14$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b113 ==> p14$1 && p14$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b112 ==> p14$1 && p14$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b111 ==> p14$1 && p14$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b110 ==> p14$1 && p14$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b109 ==> p14$1 && p14$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b108 ==> p14$1 && p14$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b107 ==> p14$1 && p14$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b106 ==> p14$1 && p14$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b105 ==> p14$1 && p14$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b104 ==> p14$1 && p14$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b103 ==> p14$1 && p14$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b102 ==> p14$1 && p14$2 ==> $6$1 == $6$2;
    assert {:tag "predicatedEquality"} _b101 ==> p14$1 && p14$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b100 ==> p14$1 && p14$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b99 ==> p14$1 && p14$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "predicatedEquality"} _b98 ==> p14$1 && p14$2 ==> $y.0$1 == $y.0$2;
    assert {:tag "predicatedEquality"} _b97 ==> p14$1 && p14$2 ==> $density.1$1 == $density.1$2;
    assert {:tag "predicatedEquality"} _b96 ==> p14$1 && p14$2 ==> $pt.1$1 == $pt.1$2;
    assert {:tag "loopPredicateEquality"} _b95 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p14$1 == p14$2;
    assert {:tag "loopPredicateEquality"} _b94 ==> p14$1 == p14$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) ==> p14$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p14$1 ==> _b11 ==> p14$1 ==> BV32_SLE($z.0$1, $5$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p14$2 ==> _b11 ==> p14$2 ==> BV32_SLE($z.0$2, $5$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b10 ==> BV32_UGE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b10 ==> BV32_UGE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b9 ==> BV32_ULE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b9 ==> BV32_ULE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b8 ==> BV32_SGE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b8 ==> BV32_SGE($y.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p14$1 ==> _b7 ==> BV32_SLE($y.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p14$2 ==> _b7 ==> BV32_SLE($y.0$2, $2$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p14$1 ==> _b6 ==> $y.0$1 mod 1 == $2$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p14$2 ==> _b6 ==> $y.0$2 mod 1 == $2$2 mod 1;
  ...
  __partitioned_block_$23_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b196 ==> !p15$1 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$23_0 == _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "disabledMaintainsInstrumentation"} _b195 ==> !p15$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$__partitioned_block_$23_0 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b194 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 3) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, group_size_y), group_size_x), BV32_MUL(local_id_y$1, group_size_x)), local_id_x$1), 6), 5);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b193 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_MUL(0, 6) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 1) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 5) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6);
    assert {:tag "nowrite"} _b192 ==> !_WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "noread"} _b191 ==> !_READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "predicatedEquality"} _b190 ==> p16$1 && p16$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b189 ==> p16$1 && p16$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b188 ==> p16$1 && p16$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b187 ==> p16$1 && p16$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b186 ==> p16$1 && p16$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b185 ==> p16$1 && p16$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b184 ==> p16$1 && p16$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b183 ==> p16$1 && p16$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b182 ==> p16$1 && p16$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b181 ==> p16$1 && p16$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b180 ==> p16$1 && p16$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b179 ==> p16$1 && p16$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b178 ==> p16$1 && p16$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b177 ==> p16$1 && p16$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b176 ==> p16$1 && p16$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b175 ==> p16$1 && p16$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b174 ==> p16$1 && p16$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b173 ==> p16$1 && p16$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b172 ==> p16$1 && p16$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b171 ==> p16$1 && p16$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b170 ==> p16$1 && p16$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b169 ==> p16$1 && p16$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b168 ==> p16$1 && p16$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b167 ==> p16$1 && p16$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b166 ==> p16$1 && p16$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b165 ==> p16$1 && p16$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b164 ==> p16$1 && p16$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b163 ==> p16$1 && p16$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b162 ==> p16$1 && p16$2 ==> $density.4$1 == $density.4$2;
    assert {:tag "predicatedEquality"} _b161 ==> p16$1 && p16$2 ==> $pt.4$1 == $pt.4$2;
    assert {:tag "predicatedEquality"} _b160 ==> p16$1 && p16$2 ==> $density.5$1 == $density.5$2;
    assert {:tag "predicatedEquality"} _b159 ==> p16$1 && p16$2 ==> $pt.5$1 == $pt.5$2;
    assert {:tag "predicatedEquality"} _b158 ==> p16$1 && p16$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b157 ==> p16$1 && p16$2 ==> $density.3$1 == $density.3$2;
    assert {:tag "predicatedEquality"} _b156 ==> p16$1 && p16$2 ==> $pt.3$1 == $pt.3$2;
    assert {:tag "predicatedEquality"} _b155 ==> p16$1 && p16$2 ==> $6$1 == $6$2;
    assert {:tag "predicatedEquality"} _b154 ==> p16$1 && p16$2 ==> $x.0$1 == $x.0$2;
    assert {:tag "predicatedEquality"} _b153 ==> p16$1 && p16$2 ==> $density.2$1 == $density.2$2;
    assert {:tag "predicatedEquality"} _b152 ==> p16$1 && p16$2 ==> $pt.2$1 == $pt.2$2;
    assert {:tag "loopPredicateEquality"} _b151 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p16$1 == p16$2;
    assert {:tag "loopPredicateEquality"} _b150 ==> p16$1 == p16$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64), 1), 6)) ==> p16$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64), 1), 6)) ==> p16$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p16$1 ==> _b20 ==> p16$1 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p16$2 ==> _b20 ==> p16$2 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b19 ==> BV32_UGE($x.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b19 ==> BV32_UGE($x.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b18 ==> BV32_ULE($x.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b18 ==> BV32_ULE($x.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b17 ==> BV32_SGE($x.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b17 ==> BV32_SGE($x.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b16 ==> BV32_SLE($x.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b16 ==> BV32_SLE($x.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p16$1 ==> _b15 ==> $x.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p16$2 ==> _b15 ==> $x.0$2 mod 1 == 0 mod 1;
  ...
  $30:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b198 ==> !p17$1 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin$ghost$$30 == _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b197 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_MUL(0, 6) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 1) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 5) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 2) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 3) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6) || _WATCHED_OFFSET mod BV32_MUL(1, 6) == BV32_ADD(BV32_MUL(0, 6), 4) mod BV32_MUL(1, 6);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p14$1 ==> p12$1;
    assert p14$2 ==> p12$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64), 1), 6));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($y.0$1, $3$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b33 ==> _READ_HAS_OCCURRED_$$gridding_GPU.sharedBin ==> BV32_SLE($z.0$1, $5$1);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b32 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64), 1), 6)) && BV32_SLT($j.0$1, $6$1) ==> p22$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b32 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64), 1), 6)) && BV32_SLT($j.0$2, $6$2) ==> p22$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p22$1 ==> _b31 ==> p22$1 ==> BV32_SLE($z.0$1, $5$1) && BV32_SLE($y.0$1, $3$1) && BV32_ULT($x.0$1, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$1, v24$1), 64), 1), 6));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p22$2 ==> _b31 ==> p22$2 ==> BV32_SLE($z.0$2, $5$2) && BV32_SLE($y.0$2, $3$2) && BV32_ULT($x.0$2, BV32_LSHR(BV32_SUB(BV32_ADD(BV32_SUB(v25$2, v24$2), 64), 1), 6));
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b30 ==> BV32_UGE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b30 ==> BV32_UGE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b29 ==> BV32_ULE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b29 ==> BV32_ULE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b28 ==> BV32_SGE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b28 ==> BV32_SGE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p22$1 ==> _b27 ==> BV32_SLE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p22$2 ==> _b27 ==> BV32_SLE($j.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p22$1 ==> _b26 ==> $j.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p22$2 ==> _b26 ==> $j.0$2 mod 1 == 0 mod 1;
