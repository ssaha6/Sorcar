...
implementation {:source_name "scan_inter2_kernel"} {:kernel} $scan_inter2_kernel($iter: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b45 ==> _WRITE_HAS_OCCURRED_$$scan_inter2_kernel.s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b44 ==> _READ_HAS_OCCURRED_$$scan_inter2_kernel.s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert {:tag "relationalPow2"} _b41 ==> ($stride.0 == 0 && $d.0 == 2) || BV32_MUL($d.0, $stride.0) == 1;
    assert {:tag "relationalPow2"} _b40 ==> BV32_MUL($d.0, $stride.0) == 1;
    assert {:tag "relationalPow2"} _b39 ==> ($stride.0 == 0 && $d.0 == 4) || BV32_MUL($d.0, $stride.0) == 2;
    assert {:tag "relationalPow2"} _b38 ==> BV32_MUL($d.0, $stride.0) == 2;
    assert {:tag "relationalPow2"} _b37 ==> ($stride.0 == 0 && $d.0 == 8) || BV32_MUL($d.0, $stride.0) == 4;
    assert {:tag "relationalPow2"} _b36 ==> BV32_MUL($d.0, $stride.0) == 4;
    assert {:tag "relationalPow2"} _b35 ==> ($stride.0 == 0 && $d.0 == 16) || BV32_MUL($d.0, $stride.0) == 8;
    assert {:tag "relationalPow2"} _b34 ==> BV32_MUL($d.0, $stride.0) == 8;
    assert {:tag "relationalPow2"} _b33 ==> ($stride.0 == 0 && $d.0 == 32) || BV32_MUL($d.0, $stride.0) == 16;
    assert {:tag "relationalPow2"} _b32 ==> BV32_MUL($d.0, $stride.0) == 16;
    assert {:tag "relationalPow2"} _b31 ==> ($stride.0 == 0 && $d.0 == 64) || BV32_MUL($d.0, $stride.0) == 32;
    assert {:tag "relationalPow2"} _b30 ==> BV32_MUL($d.0, $stride.0) == 32;
    assert {:tag "relationalPow2"} _b29 ==> ($stride.0 == 0 && $d.0 == 128) || BV32_MUL($d.0, $stride.0) == 64;
    assert {:tag "relationalPow2"} _b28 ==> BV32_MUL($d.0, $stride.0) == 64;
    assert {:tag "relationalPow2"} _b27 ==> ($stride.0 == 0 && $d.0 == 256) || BV32_MUL($d.0, $stride.0) == 128;
    assert {:tag "relationalPow2"} _b26 ==> BV32_MUL($d.0, $stride.0) == 128;
    assert {:tag "relationalPow2"} _b25 ==> ($stride.0 == 0 && $d.0 == 512) || BV32_MUL($d.0, $stride.0) == 256;
    assert {:tag "relationalPow2"} _b24 ==> BV32_MUL($d.0, $stride.0) == 256;
    assert {:tag "relationalPow2"} _b23 ==> ($stride.0 == 0 && $d.0 == 1024) || BV32_MUL($d.0, $stride.0) == 512;
    assert {:tag "relationalPow2"} _b22 ==> BV32_MUL($d.0, $stride.0) == 512;
    assert {:tag "relationalPow2"} _b21 ==> ($stride.0 == 0 && $d.0 == 2048) || BV32_MUL($d.0, $stride.0) == 1024;
    assert {:tag "relationalPow2"} _b20 ==> BV32_MUL($d.0, $stride.0) == 1024;
    assert {:tag "relationalPow2"} _b19 ==> ($stride.0 == 0 && $d.0 == 4096) || BV32_MUL($d.0, $stride.0) == 2048;
    assert {:tag "relationalPow2"} _b18 ==> BV32_MUL($d.0, $stride.0) == 2048;
    assert {:tag "relationalPow2"} _b17 ==> ($stride.0 == 0 && $d.0 == 8192) || BV32_MUL($d.0, $stride.0) == 4096;
    assert {:tag "relationalPow2"} _b16 ==> BV32_MUL($d.0, $stride.0) == 4096;
    assert {:tag "relationalPow2"} _b15 ==> ($stride.0 == 0 && $d.0 == 16384) || BV32_MUL($d.0, $stride.0) == 8192;
    assert {:tag "relationalPow2"} _b14 ==> BV32_MUL($d.0, $stride.0) == 8192;
    assert {:tag "relationalPow2"} _b13 ==> ($stride.0 == 0 && $d.0 == 32768) || BV32_MUL($d.0, $stride.0) == 16384;
    assert {:tag "relationalPow2"} _b12 ==> BV32_MUL($d.0, $stride.0) == 16384;
    assert {:tag "relationalPow2"} _b11 ==> ($stride.0 == 0 && $d.0 == 65536) || BV32_MUL($d.0, $stride.0) == 32768;
    assert {:tag "relationalPow2"} _b10 ==> BV32_MUL($d.0, $stride.0) == 32768;
    assert {:tag "pow2NotZero"} _b9 ==> v13 != 0;
    assert {:tag "pow2"} _b8 ==> v13 == 0 || BV32_AND(v13, BV32_SUB(v13, 1)) == 0;
    assert {:tag "pow2NotZero"} _b7 ==> $d.0 != 0;
    assert {:tag "pow2"} _b6 ==> $d.0 == 0 || BV32_AND($d.0, BV32_SUB($d.0, 1)) == 0;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($d.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($d.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($d.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($d.0, 1);
