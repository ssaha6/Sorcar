...
implementation {:source_name "splitRearrange"} {:kernel} $splitRearrange($numElems: int, $iter: int)
{
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b6 ==> _READ_HAS_OCCURRED_$$splitRearrange.array_s ==> _WATCHED_OFFSET mod -1 == BV32_SUB(BV32_MUL(4, local_id_x$1), 1) mod -1;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SGE($i.0$1, 0) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SGE($i.0$2, 0) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b4 ==> BV32_UGE($i.0$1, BV32_SUB(BV32_MUL(4, local_id_x$1), 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b4 ==> BV32_UGE($i.0$2, BV32_SUB(BV32_MUL(4, local_id_x$2), 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b3 ==> BV32_ULE($i.0$1, BV32_SUB(BV32_MUL(4, local_id_x$1), 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b3 ==> BV32_ULE($i.0$2, BV32_SUB(BV32_MUL(4, local_id_x$2), 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b2 ==> BV32_SGE($i.0$1, BV32_SUB(BV32_MUL(4, local_id_x$1), 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b2 ==> BV32_SGE($i.0$2, BV32_SUB(BV32_MUL(4, local_id_x$2), 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b1 ==> BV32_SLE($i.0$1, BV32_SUB(BV32_MUL(4, local_id_x$1), 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b1 ==> BV32_SLE($i.0$2, BV32_SUB(BV32_MUL(4, local_id_x$2), 1));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b0 ==> $i.0$1 mod -1 == BV32_SUB(BV32_MUL(4, local_id_x$1), 1) mod -1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b0 ==> $i.0$2 mod -1 == BV32_SUB(BV32_MUL(4, local_id_x$2), 1) mod -1;
