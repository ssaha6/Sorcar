...
assert  my_inv (  (  BV32_SLE(0bv32, $tx.0) ) ,  (  BV32_SLE($tx.0, 0bv32) ) ,  (  BV32_SGE($tx.0, 0bv32) ) ,  (  BV32_ULE($tx.0, 0bv32) ) ,  (  BV32_UGE($tx.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$Qr ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 256bv32), BV32_DIV(BV32_MUL(local_id_x$1, 4bv32), 256bv32)) ) ,  (  _READ_HAS_OCCURRED_$$Qr ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_DIV(BV32_MUL(group_id_x$1, 256bv32), 4bv32)) ) ,  (  _READ_HAS_OCCURRED_$$Qi ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 256bv32), BV32_DIV(BV32_MUL(local_id_x$1, 4bv32), 256bv32)) ) ,  (  _READ_HAS_OCCURRED_$$Qi ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_DIV(BV32_MUL(group_id_x$1, 256bv32), 4bv32)) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE(0bv32, $tx2.0) ) ,  (  BV32_SLE($tx2.0, 0bv32) ) ,  (  BV32_SGE($tx2.0, 0bv32) ) ,  (  BV32_ULE($tx2.0, 0bv32) ) ,  (  BV32_UGE($tx2.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$Qr ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 256bv32), BV32_DIV(BV32_MUL(local_id_x$1, 4bv32), 256bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$Qr ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_DIV(BV32_MUL(group_id_x$1, 256bv32), 4bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$Qi ==> group_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 256bv32), BV32_DIV(BV32_MUL(local_id_x$1, 4bv32), 256bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$Qi ==> local_id_x$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 4bv32), BV32_DIV(BV32_MUL(group_id_x$1, 256bv32), 4bv32)) )  ); 
  ...
  $truebb3:
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 39} _CHECK_WRITE_$$Qr(true, v21$2, v22$2);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 41} _CHECK_WRITE_$$Qi(true, v21$2, v23$2);
