...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: int, $c0: int)
{
  ...
  $0:
    ...
    v2 := BV64_SGE(BV32_SEXT64(BV32_ADD($n, 2)), $c0);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  $falsebb:
    assume {:partition} !v2;
    v3 := BV64_SGE($c0, BV32_SEXT64(BV32_ADD($n, 3)));
  ...
  $truebb0:
    assume {:partition} v3;
    v4 := BV64_SGE(BV64_MUL(4, BV64_SDIV(BV64_ADD(BV64_ADD(BV32_SEXT64($n), BV64_MUL(2, $c0)), 2), 3)), BV64_ADD(BV64_MUL(3, $c0), 4));
  ...
  $3:
    v5$1 := BV64_SLT(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93), 0);
    v5$2 := BV64_SLT(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93), 0);
    ...
    $0$1 := (if p0$1 then BV64_SUB(0, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93)), 3145728), 1), 3145728)) else $0$1);
    $0$2 := (if p0$2 then BV64_SUB(0, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93)), 3145728), 1), 3145728)) else $0$2);
    $0$1 := (if p1$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93), 3145728) else $0$1);
    $0$2 := (if p1$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93), 3145728) else $0$2);
    ...
    v7$1 := (if p3$1 then BV64_SLT(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93), 0) else v7$1);
    v7$2 := (if p3$2 then BV64_SLT(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93), 0) else v7$2);
    ...
    $2$1 := (if p4$1 then BV64_SUB(0, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93)), 3145728), 1), 3145728)) else $2$1);
    $2$2 := (if p4$2 then BV64_SUB(0, BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(0, BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93)), 3145728), 1), 3145728)) else $2$2);
    $2$1 := (if p5$1 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$1)), $c0), 93), 3145728) else $2$1);
    $2$2 := (if p5$2 then BV64_SDIV(BV64_SUB(BV64_ADD(BV64_SUB(BV32_SEXT64(BV32_SUB(0, $n)), BV64_MUL(96, v0$2)), $c0), 93), 3145728) else $2$2);
...
assert  my_inv (  ( p6$1 ==> $c1.0$1 mod 1048576 == $1$1 mod 1048576 )  && ( p6$2 ==> $c1.0$2 mod 1048576 == $1$2 mod 1048576 ) ,  ( p6$1 ==> BV32_SLE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_SLE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_SGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_SGE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_ULE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_ULE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_UGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_UGE($c1.0$2, $1$2) ) ,  (  BV64_SLE($c1.0$1, BV64_SDIV($c0, 4)) ==> p6$1 )  && (  BV64_SLE($c1.0$2, BV64_SDIV($c0, 4)) ==> p6$2 ) ,  (  _READ_HAS_OCCURRED_$$table ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$table ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    v8$1 := (if p6$1 then BV64_SLE($c1.0$1, BV64_SDIV($c0, 4)) else v8$1);
    v8$2 := (if p6$2 then BV64_SLE($c1.0$2, BV64_SDIV($c0, 4)) else v8$2);
    p7$1 := false;
    p7$2 := false;
    p8$1 := false;
    p8$2 := false;
    ...
    v10$1 := (if p9$1 then BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), BV64_MUL(3, v1$1)), BV64_MUL(3, $c1.0$1)), BV64_ADD($c0, 1)) else v10$1);
    v10$2 := (if p9$2 then BV64_SGE(BV64_ADD(BV64_ADD(BV32_SEXT64($n), BV64_MUL(3, v1$2)), BV64_MUL(3, $c1.0$2)), BV64_ADD($c0, 1)) else v10$2);
    p11$1 := (if p9$1 && v10$1 then v10$1 else p11$1);
    p11$2 := (if p9$2 && v10$2 then v10$2 else p11$2);
    v11$1 := (if p11$1 then BV64_SGE($c0, BV64_ADD(BV64_MUL(4, v1$1), BV64_MUL(4, $c1.0$1))) else v11$1);
    v11$2 := (if p11$2 then BV64_SGE($c0, BV64_ADD(BV64_MUL(4, v1$2), BV64_MUL(4, $c1.0$2))) else v11$2);
    p13$1 := (if p11$1 && v11$1 then v11$1 else p13$1);
    p13$2 := (if p11$2 && v11$2 then v11$2 else p13$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$table(p13$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0), $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 22} _CHECK_READ_$$table(p13$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0), $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$table"} true;
    v12$1 := (if p13$1 then $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)] else v12$1);
    v12$2 := (if p13$2 then $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)] else v12$2);
    ...
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$table(p15$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0), $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$table(p15$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0), $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$table"} true;
    v15$1 := (if p15$1 then $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)] else v15$1);
    v15$2 := (if p15$2 then $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)] else v15$2);
    $3$1 := (if p15$1 then v15$1 else $3$1);
    $3$2 := (if p15$2 then v15$2 else $3$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$table(p13$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0), $3$1, $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$table(p13$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$table(p13$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0), $3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$table"} true;
    $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)] := (if p13$1 then $3$1 else $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$1), $c0), BV64_MUL(4, $c1.0$1)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$1), $c0), BV64_MUL(3, $c1.0$1))), 32, 0)]);
    $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)] := (if p13$2 then $3$2 else $$table[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SUB(BV64_ADD(BV64_MUL(-4, v1$2), $c0), BV64_MUL(4, $c1.0$2)), BV32_SEXT64($n)), BV64_SUB(BV64_ADD(BV64_MUL(-3, v1$2), $c0), BV64_MUL(3, $c1.0$2))), 32, 0)]);
