...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: int, $c0: int)
{
  ...
  $13:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV64_SLE($c1.0$1, BV64_SDIV($c0, 4)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV64_SLE($c1.0$2, BV64_SDIV($c0, 4)) ==> p6$2;
