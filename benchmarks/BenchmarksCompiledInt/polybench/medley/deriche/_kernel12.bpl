...
var {:source_name "a1"} {:global} $$a1: [int]int;
...
var {:source_name "a5"} {:global} $$a5: [int]int;
...
procedure {:source_name "kernel12"} {:kernel} $kernel12($h: int, $w: int);
...
implementation {:source_name "kernel12"} {:kernel} $kernel12($h: int, $w: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a5(true, 0, v0$1, $$a5[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a5(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a5(true, 0, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a5"} true;
    $$a5[0] := v0$1;
    $$a5[0] := v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a1(true, 0, v0$1, $$a1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a1(true, 0, v0$2);
