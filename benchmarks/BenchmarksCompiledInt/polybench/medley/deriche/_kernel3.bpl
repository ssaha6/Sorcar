...
implementation {:source_name "kernel3"} {:kernel} $kernel3($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$xm1(true, 0, v0$1, $$xm1[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$xm1(true, 0, v0$2);
