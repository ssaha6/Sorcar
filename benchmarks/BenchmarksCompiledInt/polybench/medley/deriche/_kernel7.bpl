...
procedure {:source_name "kernel7"} {:kernel} $kernel7($h: int, $w: int, $c0: int);
  ...
  modifies _WRITE_HAS_OCCURRED_$$xm1, _WRITE_READ_BENIGN_FLAG_$$xm1, _WRITE_READ_BENIGN_FLAG_$$xm1;



implementation {:source_name "kernel7"} {:kernel} $kernel7($h: int, $w: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$xm1(true, 0, 0, $$xm1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$xm1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$xm1(true, 0, 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$xm1"} true;
    $$xm1[0] := 0;
    $$xm1[0] := 0;
    return;
}
