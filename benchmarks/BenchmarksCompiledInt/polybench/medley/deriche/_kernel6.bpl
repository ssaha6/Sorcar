...
procedure {:source_name "kernel6"} {:kernel} $kernel6($alpha: int, $h: int, $w: int);
...
implementation {:source_name "kernel6"} {:kernel} $kernel6($alpha: int, $h: int, $w: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$b1(true, 0, FPOW32(1073741824, FSUB32(-2147483648, $alpha)), $$b1[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$b1(true, 0, FPOW32(1073741824, FSUB32(-2147483648, $alpha)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b1"} true;
    $$b1[0] := FPOW32(1073741824, FSUB32(-2147483648, $alpha));
    $$b1[0] := FPOW32(1073741824, FSUB32(-2147483648, $alpha));
    return;
}
