...
var {:source_name "a2"} {:global} $$a2: [int]int;
...
var {:source_name "a6"} {:global} $$a6: [int]int;
...
procedure {:source_name "kernel13"} {:kernel} $kernel13($alpha: int, $h: int, $w: int);
...
implementation {:source_name "kernel13"} {:kernel} $kernel13($alpha: int, $h: int, $w: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    havoc v0$1, v0$2;
    v1$1 := FMUL32(FMUL32(v0$1, FEXP32(FMUL32(FSUB32(-2147483648, $alpha), 1069066811))), FSUB32($alpha, 1065353216));
    v1$2 := FMUL32(FMUL32(v0$2, FEXP32(FMUL32(FSUB32(-2147483648, $alpha), 1069066811))), FSUB32($alpha, 1065353216));
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a6(true, 0, v1$1, $$a6[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a6(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a6(true, 0, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a6"} true;
    $$a6[0] := v1$1;
    $$a6[0] := v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a2(true, 0, v1$1, $$a2[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a2(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a2(true, 0, v1$2);
