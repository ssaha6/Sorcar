...
procedure {:source_name "kernel32"} {:kernel} $kernel32($h: int, $w: int, $c0: int);
...
implementation {:source_name "kernel32"} {:kernel} $kernel32($h: int, $w: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$tp1(true, 0, 0, $$tp1[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$tp1(true, 0, 0);
