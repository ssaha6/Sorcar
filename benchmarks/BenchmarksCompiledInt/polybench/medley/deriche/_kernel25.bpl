...
procedure {:source_name "kernel25"} {:kernel} $kernel25($h: int, $w: int, $c0: int);
...
implementation {:source_name "kernel25"} {:kernel} $kernel25($h: int, $w: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$ym1(true, 0, 0, $$ym1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$ym1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$ym1(true, 0, 0);
