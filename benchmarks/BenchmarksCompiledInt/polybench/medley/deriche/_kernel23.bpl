...
procedure {:source_name "kernel23"} {:kernel} $kernel23($h: int, $w: int, $c0: int, $c1_0: int);
...
implementation {:source_name "kernel23"} {:kernel} $kernel23($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$yp1(true, 0, v0$1, $$yp1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$yp1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$yp1(true, 0, v0$2);
