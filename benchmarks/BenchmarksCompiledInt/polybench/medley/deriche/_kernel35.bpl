...
procedure {:source_name "kernel35"} {:kernel} $kernel35($h: int, $w: int, $c0: int);
...
implementation {:source_name "kernel35"} {:kernel} $kernel35($h: int, $w: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$yp2(true, 0, 0, $$yp2[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$yp2(true, 0, 0);
