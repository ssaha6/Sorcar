...
procedure {:source_name "kernel37"} {:kernel} $kernel37($h: int, $w: int, $c0: int, $c1_0: int);
...
implementation {:source_name "kernel37"} {:kernel} $kernel37($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$tp2(true, 0, v0$1, $$tp2[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$tp2(true, 0, v0$2);
