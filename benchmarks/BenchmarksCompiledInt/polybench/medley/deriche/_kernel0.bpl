...
procedure {:source_name "kernel0"} {:kernel} $kernel0($alpha: int, $h: int, $w: int);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($alpha: int, $h: int, $w: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$b2(true, 0, FSUB32(-2147483648, FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811))), $$b2[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$b2(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$b2(true, 0, FSUB32(-2147483648, FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b2"} true;
    $$b2[0] := FSUB32(-2147483648, FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811)));
    $$b2[0] := FSUB32(-2147483648, FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811)));
    return;
}
