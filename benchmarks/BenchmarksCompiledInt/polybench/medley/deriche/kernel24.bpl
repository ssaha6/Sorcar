...
implementation {:source_name "kernel24"} {:kernel} $kernel24($h: int, $w: int)
{
  ...
  $4:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b31 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0;
  ...
  $7:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b35 ==> !p7$1 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1$ghost$$7 == _READ_HAS_OCCURRED_$$kernel24.shared_c1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b34 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w));
  ...
  $9:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b39 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1$ghost$$9 == _READ_HAS_OCCURRED_$$kernel24.shared_c1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b38 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> _WATCHED_OFFSET == 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c1_0.0$1, BV32_SEXT64($h));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SGE(BV32_SEXT64($w), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$kernel24.shared_c1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($w));
