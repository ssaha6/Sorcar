...
procedure {:source_name "kernel22"} {:kernel} $kernel22($h: int, $w: int, $c0: int, $c1_0: int);
  ...
  modifies _WRITE_HAS_OCCURRED_$$xp1, _WRITE_READ_BENIGN_FLAG_$$xp1, _WRITE_READ_BENIGN_FLAG_$$xp1;



implementation {:source_name "kernel22"} {:kernel} $kernel22($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$xp1(true, 0, v0$1, $$xp1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$xp1(true, 0, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$xp1"} true;
    $$xp1[0] := v0$1;
    $$xp1[0] := v0$2;
    return;
}
