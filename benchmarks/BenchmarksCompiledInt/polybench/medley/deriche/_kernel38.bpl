...
procedure {:source_name "kernel38"} {:kernel} $kernel38($h: int, $w: int, $c0: int, $c1_0: int);
...
implementation {:source_name "kernel38"} {:kernel} $kernel38($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
