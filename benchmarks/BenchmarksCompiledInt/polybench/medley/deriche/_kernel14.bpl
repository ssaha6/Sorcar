...
var {:source_name "c1"} {:global} $$c1: [int]int;
...
var {:source_name "c2"} {:global} $$c2: [int]int;
...
procedure {:source_name "kernel14"} {:kernel} $kernel14($h: int, $w: int);
...
implementation {:source_name "kernel14"} {:kernel} $kernel14($h: int, $w: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$c2(true, 0, 1065353216, $$c2[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$c2(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$c2(true, 0, 1065353216);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$c2"} true;
    $$c2[0] := 1065353216;
    $$c2[0] := 1065353216;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$c1(true, 0, 1065353216, $$c1[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$c1(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$c1(true, 0, 1065353216);
