...
procedure {:source_name "kernel19"} {:kernel} $kernel19($h: int, $w: int, $c0: int, $c1_0: int);
  ...
  requires {:sourceloc_num 2} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($h, 2147483647) then 1 else 0)), BV1_ZEXT32((if BV32_SLE($w, 2147483647) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($w), BV64_ADD($c0, 1)) then 1 else 0))), BV1_ZEXT32((if BV64_SGE($c0, 0) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV32_SEXT64($h), $c1_0), 1) then 1 else 0))), BV1_ZEXT32((if BV64_SLE($c1_0, 0) then 1 else 0))) != 0 then 1 else 0) != 0;
  ...
  requires !_READ_HAS_OCCURRED_$$a4 && !_WRITE_HAS_OCCURRED_$$a4 && !_ATOMIC_HAS_OCCURRED_$$a4;
  ...
  requires !_READ_HAS_OCCURRED_$$xp1 && !_WRITE_HAS_OCCURRED_$$xp1 && !_ATOMIC_HAS_OCCURRED_$$xp1;
...
implementation {:source_name "kernel19"} {:kernel} $kernel19($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    ...
    havoc v6$1, v6$2;
    havoc v7$1, v7$2;
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$y2(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0), FADD32(FMUL32(v6$1, v7$1), FADD32(FMUL32(v4$1, v5$1), FADD32(FMUL32(v0$1, v1$1), FMUL32(v2$1, v3$1)))), $$y2[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$y2(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$y2(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0), FADD32(FMUL32(v6$2, v7$2), FADD32(FMUL32(v4$2, v5$2), FADD32(FMUL32(v0$2, v1$2), FMUL32(v2$2, v3$2)))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$y2"} true;
    $$y2[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0)] := FADD32(FMUL32(v6$1, v7$1), FADD32(FMUL32(v4$1, v5$1), FADD32(FMUL32(v0$1, v1$1), FMUL32(v2$1, v3$1))));
    $$y2[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($h)), BV64_SUB(0, $c1_0)), 32, 0)] := FADD32(FMUL32(v6$2, v7$2), FADD32(FMUL32(v4$2, v5$2), FADD32(FMUL32(v0$2, v1$2), FMUL32(v2$2, v3$2))));
    return;
}
...
const _WATCHED_VALUE_$$a4: int;

procedure {:inline 1} _LOG_READ_$$a4(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$a4;



implementation {:inline 1} _LOG_READ_$$a4(_P: bool, _offset: int, _value: int)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$a4 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$a4 == _value then true else _READ_HAS_OCCURRED_$$a4);
    return;
}



procedure _CHECK_READ_$$a4(_P: bool, _offset: int, _value: int);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$a4);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset);



var _WRITE_READ_BENIGN_FLAG_$$a4: bool;

procedure {:inline 1} _LOG_WRITE_$$a4(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$a4, _WRITE_READ_BENIGN_FLAG_$$a4;



implementation {:inline 1} _LOG_WRITE_$$a4(_P: bool, _offset: int, _value: int, _value_old: int)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$a4 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$a4 == _value then true else _WRITE_HAS_OCCURRED_$$a4);
    _WRITE_READ_BENIGN_FLAG_$$a4 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$a4 == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$a4);
    return;
}



procedure _CHECK_WRITE_$$a4(_P: bool, _offset: int, _value: int);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$a4 != _value);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$a4 != _value);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _LOG_ATOMIC_$$a4(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$a4;



implementation {:inline 1} _LOG_ATOMIC_$$a4(_P: bool, _offset: int)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$a4 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$a4);
    return;
}



procedure _CHECK_ATOMIC_$$a4(_P: bool, _offset: int);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset);
  requires {:source_name "a4"} {:array "$$a4"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$a4;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(_P: bool, _offset: int)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$a4 := (if _P && _WRITE_HAS_OCCURRED_$$a4 && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$a4);
    return;
}
...
const _WATCHED_VALUE_$$xp1: int;

procedure {:inline 1} _LOG_READ_$$xp1(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$xp1;



implementation {:inline 1} _LOG_READ_$$xp1(_P: bool, _offset: int, _value: int)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$xp1 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$xp1 == _value then true else _READ_HAS_OCCURRED_$$xp1);
    return;
}



procedure _CHECK_READ_$$xp1(_P: bool, _offset: int, _value: int);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$xp1);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset);



var _WRITE_READ_BENIGN_FLAG_$$xp1: bool;

procedure {:inline 1} _LOG_WRITE_$$xp1(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$xp1, _WRITE_READ_BENIGN_FLAG_$$xp1;



implementation {:inline 1} _LOG_WRITE_$$xp1(_P: bool, _offset: int, _value: int, _value_old: int)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$xp1 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$xp1 == _value then true else _WRITE_HAS_OCCURRED_$$xp1);
    _WRITE_READ_BENIGN_FLAG_$$xp1 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$xp1 == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$xp1);
    return;
}



procedure _CHECK_WRITE_$$xp1(_P: bool, _offset: int, _value: int);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$xp1 != _value);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$xp1 != _value);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _LOG_ATOMIC_$$xp1(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$xp1;



implementation {:inline 1} _LOG_ATOMIC_$$xp1(_P: bool, _offset: int)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$xp1 := (if _P && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$xp1);
    return;
}



procedure _CHECK_ATOMIC_$$xp1(_P: bool, _offset: int);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset);
  requires {:source_name "xp1"} {:array "$$xp1"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$xp1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp1(_P: bool, _offset: int)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$xp1 := (if _P && _WRITE_HAS_OCCURRED_$$xp1 && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$xp1);
    return;
}



const _WATCHED_VALUE_$$xp2: int;

procedure {:inline 1} _LOG_READ_$$xp2(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$xp2;



implementation {:inline 1} _LOG_READ_$$xp2(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$xp2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$xp2(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$xp2, _WRITE_READ_BENIGN_FLAG_$$xp2;



implementation {:inline 1} _LOG_WRITE_$$xp2(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$xp2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$xp2(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$xp2;



implementation {:inline 1} _LOG_ATOMIC_$$xp2(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$xp2(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp2(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$xp2;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$xp2(_P: bool, _offset: int)
{
