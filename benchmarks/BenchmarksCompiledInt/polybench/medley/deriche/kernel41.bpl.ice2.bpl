...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p7$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$7 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> _WATCHED_OFFSET == 0 ) ,  (  !p7$1 ==> _READ_HAS_OCCURRED_$$kernel41.shared_c2$ghost$$7 == _READ_HAS_OCCURRED_$$kernel41.shared_c2 ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$imgOut ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p9$1 ==> _WRITE_HAS_OCCURRED_$$imgOut$ghost$$9 == _WRITE_HAS_OCCURRED_$$imgOut ) ,  (  _READ_HAS_OCCURRED_$$kernel41.shared_c2 ==> _WATCHED_OFFSET == 0 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel41.shared_c2$ghost$$9 == _READ_HAS_OCCURRED_$$kernel41.shared_c2 )  ); 
