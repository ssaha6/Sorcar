...
procedure {:source_name "kernel39"} {:kernel} $kernel39($h: int, $w: int, $c0: int, $c1_0: int);
...
implementation {:source_name "kernel39"} {:kernel} $kernel39($h: int, $w: int, $c0: int, $c1_0: int)
{
  var v0$1: int;
  var v0$2: int;
