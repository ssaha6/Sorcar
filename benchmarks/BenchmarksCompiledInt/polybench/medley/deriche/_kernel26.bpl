...
var {:source_name "ym2"} {:global} $$ym2: [int]int;
...
procedure {:source_name "kernel26"} {:kernel} $kernel26($h: int, $w: int, $c0: int);
...
implementation {:source_name "kernel26"} {:kernel} $kernel26($h: int, $w: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$ym2(true, 0, 0, $$ym2[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$ym2(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$ym2(true, 0, 0);
