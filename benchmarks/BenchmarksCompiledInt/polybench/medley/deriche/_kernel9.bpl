...
var {:source_name "a8"} {:global} $$a8: [int]int;
...
procedure {:source_name "kernel9"} {:kernel} $kernel9($alpha: int, $h: int, $w: int);
...
implementation {:source_name "kernel9"} {:kernel} $kernel9($alpha: int, $h: int, $w: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    havoc v0$1, v0$2;
    v1$1 := FMUL32(FSUB32(-2147483648, v0$1), FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811)));
    v1$2 := FMUL32(FSUB32(-2147483648, v0$2), FEXP32(FMUL32(FMUL32(-1073741824, $alpha), 1069066811)));
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a8(true, 0, v1$1, $$a8[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a8(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a8(true, 0, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a8"} true;
    $$a8[0] := v1$1;
    $$a8[0] := v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$a4(true, 0, v1$1, $$a4[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a4(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$a4(true, 0, v1$2);
