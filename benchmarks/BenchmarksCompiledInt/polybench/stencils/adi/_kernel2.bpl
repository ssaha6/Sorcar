...
procedure {:source_name "kernel2"} {:kernel} $kernel2($n: int, $tsteps: int);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($n: int, $tsteps: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$DT(true, 0, FDIV64(4607182418800017408, SI32_TO_FP64($tsteps)), $$DT[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$DT(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$DT(true, 0, FDIV64(4607182418800017408, SI32_TO_FP64($tsteps)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$DT"} true;
    $$DT[0] := FDIV64(4607182418800017408, SI32_TO_FP64($tsteps));
    $$DT[0] := FDIV64(4607182418800017408, SI32_TO_FP64($tsteps));
    return;
}
