...
procedure {:source_name "kernel16"} {:kernel} $kernel16($n: int, $tsteps: int, $c0: int);
...
implementation {:source_name "kernel16"} {:kernel} $kernel16($n: int, $tsteps: int, $c0: int)
{
  var $c1.0$1: int;
  var $c1.0$2: int;
  var v0$1: int;
...
assert  my_inv (  ( p0$1 ==> $c1.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c1.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$v ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$v(p5$1, BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$1, $c1.0$1)), 32, 0), 4607182418800017408, $$v[BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$1, $c1.0$1)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$v(p5$2, BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$2, $c1.0$2)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$v(p5$2, BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$2, $c1.0$2)), 32, 0), 4607182418800017408);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$v"} true;
    $$v[BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$1, $c1.0$1)), 32, 0)] := (if p5$1 then 4607182418800017408 else $$v[BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$1, $c1.0$1)), 32, 0)]);
    $$v[BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$2, $c1.0$2)), 32, 0)] := (if p5$2 then 4607182418800017408 else $$v[BV_EXTRACT(BV64_ADD(BV32_SEXT64(BV32_MUL(0, $n)), BV64_ADD(v1$2, $c1.0$2)), 32, 0)]);
