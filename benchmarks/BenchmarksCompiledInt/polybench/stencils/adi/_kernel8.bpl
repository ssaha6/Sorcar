...
procedure {:source_name "kernel8"} {:kernel} $kernel8($n: int, $tsteps: int);
...
implementation {:source_name "kernel8"} {:kernel} $kernel8($n: int, $tsteps: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$a(true, 0, FDIV64(FSUB64(-9223372036854775808, v0$1), 4611686018427387904), $$a[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$a(true, 0, FDIV64(FSUB64(-9223372036854775808, v0$2), 4611686018427387904));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a"} true;
    $$a[0] := FDIV64(FSUB64(-9223372036854775808, v0$1), 4611686018427387904);
    $$a[0] := FDIV64(FSUB64(-9223372036854775808, v0$2), 4611686018427387904);
    return;
}
