...
procedure {:source_name "kernel11"} {:kernel} $kernel11($n: int, $tsteps: int);
...
implementation {:source_name "kernel11"} {:kernel} $kernel11($n: int, $tsteps: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$b(true, 0, FADD64(4607182418800017408, v0$1), $$b[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$b(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$b(true, 0, FADD64(4607182418800017408, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b"} true;
    $$b[0] := FADD64(4607182418800017408, v0$1);
    $$b[0] := FADD64(4607182418800017408, v0$2);
    return;
}
