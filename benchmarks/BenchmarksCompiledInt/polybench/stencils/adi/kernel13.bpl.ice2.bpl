...
procedure {:source_name "kernel13"} {:kernel} $kernel13($n: int, $tsteps: int, $c0: int);
...
implementation {:source_name "kernel13"} {:kernel} $kernel13($n: int, $tsteps: int, $c0: int)
{
  var $c1.0$1: int;
  var $c1.0$2: int;
  var v0$1: int;
