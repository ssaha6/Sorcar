...
procedure {:source_name "kernel1"} {:kernel} $kernel1($n: int, $tsteps: int);
  ...
  modifies _WRITE_HAS_OCCURRED_$$DY, _WRITE_READ_BENIGN_FLAG_$$DY, _WRITE_READ_BENIGN_FLAG_$$DY;



implementation {:source_name "kernel1"} {:kernel} $kernel1($n: int, $tsteps: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$DY(true, 0, FDIV64(4607182418800017408, SI32_TO_FP64($n)), $$DY[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$DY(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$DY(true, 0, FDIV64(4607182418800017408, SI32_TO_FP64($n)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$DY"} true;
    $$DY[0] := FDIV64(4607182418800017408, SI32_TO_FP64($n));
    $$DY[0] := FDIV64(4607182418800017408, SI32_TO_FP64($n));
    return;
}
...
const _WATCHED_VALUE_$$DY: int;

procedure {:inline 1} _LOG_READ_$$DY(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$DY;



implementation {:inline 1} _LOG_READ_$$DY(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$DY(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$DY(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$DY, _WRITE_READ_BENIGN_FLAG_$$DY;



implementation {:inline 1} _LOG_WRITE_$$DY(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$DY(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$DY(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$DY;



implementation {:inline 1} _LOG_ATOMIC_$$DY(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$DY(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$DY(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$DY;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$DY(_P: bool, _offset: int)
{
