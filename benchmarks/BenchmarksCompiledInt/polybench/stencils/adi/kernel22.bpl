...
implementation {:source_name "kernel22"} {:kernel} $kernel22($n: bv32, $tsteps: bv32, $c0: bv64)
{
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b114 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$3 == _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
    assert {:tag "disabledMaintainsInstrumentation"} _b113 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$3 == _READ_HAS_OCCURRED_$$kernel22.shared_p;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b107 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$v$ghost$$3 == _WRITE_HAS_OCCURRED_$$v;
    assert {:tag "disabledMaintainsInstrumentation"} _b106 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$v$ghost$$3 == _READ_HAS_OCCURRED_$$v;
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b116 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$kernel22.shared_p$ghost$$6 == _WRITE_HAS_OCCURRED_$$kernel22.shared_p;
  ...
  $19:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b123 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$kernel22.shared_p$ghost$$19 == _READ_HAS_OCCURRED_$$kernel22.shared_p;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b120 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$v$ghost$$19 == _WRITE_HAS_OCCURRED_$$v;
    assert {:tag "disabledMaintainsInstrumentation"} _b119 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$v$ghost$$19 == _READ_HAS_OCCURRED_$$v;
