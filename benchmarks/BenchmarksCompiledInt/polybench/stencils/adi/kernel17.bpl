...
implementation {:source_name "kernel17"} {:kernel} $kernel17($n: int, $tsteps: int, $c0: int)
{
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b72 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b71 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_c;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b70 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b69 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b68 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b67 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_a;
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b103 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$5 == _READ_HAS_OCCURRED_$$kernel17.shared_c;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b102 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b101 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_c;
    assert {:tag "disabledMaintainsInstrumentation"} _b100 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$5 == _READ_HAS_OCCURRED_$$kernel17.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b99 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b98 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_b;
    assert {:tag "disabledMaintainsInstrumentation"} _b97 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$5 == _READ_HAS_OCCURRED_$$kernel17.shared_a;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b96 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b95 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_a;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
  ...
  $12:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b113 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_c;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b112 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b111 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b110 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b109 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_a;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b108 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> _WATCHED_OFFSET == 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
