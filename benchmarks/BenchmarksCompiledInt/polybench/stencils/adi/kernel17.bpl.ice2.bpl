...
var {:source_name "shared_a"} {:group_shared} $$kernel17.shared_a: [bv1][int]int;
...
var {:source_name "shared_b"} {:group_shared} $$kernel17.shared_b: [bv1][int]int;
...
var {:source_name "shared_c"} {:group_shared} $$kernel17.shared_c: [bv1][int]int;
...
procedure {:source_name "kernel17"} {:kernel} $kernel17($n: int, $tsteps: int, $c0: int);
...
implementation {:source_name "kernel17"} {:kernel} $kernel17($n: int, $tsteps: int, $c0: int)
{
  var $c1.0$1: int;
  var $c1.0$2: int;
  var $c2.0$1: int;
  ...
  var _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$5: bool;
  var _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$5: bool;
  var _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$5: bool;
  var _READ_HAS_OCCURRED_$$p$ghost$$12: bool;
  var _WRITE_HAS_OCCURRED_$$p$ghost$$12: bool;
  var _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$12: bool;
  var _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$12: bool;
  var _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$12: bool;
  ...
  __partitioned_block_$0_0:
    ...
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$kernel17.shared_a(p0$1, 0, v3$1, $$kernel17.shared_a[1bv1][0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_a(p0$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$kernel17.shared_a(p0$2, 0, v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel17.shared_a"} true;
    $$kernel17.shared_a[1bv1][0] := (if p0$1 then v3$1 else $$kernel17.shared_a[1bv1][0]);
    $$kernel17.shared_a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] := (if p0$2 then v3$2 else $$kernel17.shared_a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v4$1 := (if p0$1 then _HAVOC_int$1 else v4$1);
    v4$2 := (if p0$2 then _HAVOC_int$2 else v4$2);
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$kernel17.shared_b(p0$1, 0, v4$1, $$kernel17.shared_b[1bv1][0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_b(p0$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$kernel17.shared_b(p0$2, 0, v4$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel17.shared_b"} true;
    $$kernel17.shared_b[1bv1][0] := (if p0$1 then v4$1 else $$kernel17.shared_b[1bv1][0]);
    $$kernel17.shared_b[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] := (if p0$2 then v4$2 else $$kernel17.shared_b[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v5$1 := (if p0$1 then _HAVOC_int$1 else v5$1);
    v5$2 := (if p0$2 then _HAVOC_int$2 else v5$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$kernel17.shared_c(p0$1, 0, v5$1, $$kernel17.shared_c[1bv1][0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_c(p0$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$kernel17.shared_c(p0$2, 0, v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel17.shared_c"} true;
    $$kernel17.shared_c[1bv1][0] := (if p0$1 then v5$1 else $$kernel17.shared_c[1bv1][0]);
    $$kernel17.shared_c[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] := (if p0$2 then v5$2 else $$kernel17.shared_c[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
...
assert  my_inv (  ( p2$1 ==> $c1.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p2$2 ==> $c1.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p2$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p2$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p2$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p2$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p2$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p2$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p2$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p2$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ==> p2$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ==> p2$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  p2$1 == p2$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p2$1 == p2$2 ) ,  (  p2$1 && p2$2 ==> $c1.0$1 == $c1.0$2 ) ,  (  p2$1 && p2$2 ==> $c2.0$1 == $c2.0$2 ) ,  (  p2$1 && p2$2 ==> $0$1 == $0$2 ) ,  (  p2$1 && p2$2 ==> $c4.0$1 == $c4.0$2 ) ,  (  p2$1 && p2$2 ==> $1$1 == $1$2 ) ,  (  p2$1 && p2$2 ==> v6$1 == v6$2 ) ,  (  p2$1 && p2$2 ==> v7$1 == v7$2 ) ,  (  p2$1 && p2$2 ==> v8$1 == v8$2 ) ,  (  p2$1 && p2$2 ==> v9$1 == v9$2 ) ,  (  p2$1 && p2$2 ==> v10$1 == v10$2 ) ,  (  p2$1 && p2$2 ==> v11$1 == v11$2 ) ,  (  p2$1 && p2$2 ==> v12$1 == v12$2 ) ,  (  p2$1 && p2$2 ==> v13$1 == v13$2 ) ,  (  p2$1 && p2$2 ==> v14$1 == v14$2 ) ,  (  p2$1 && p2$2 ==> v15$1 == v15$2 ) ,  (  p2$1 && p2$2 ==> v16$1 == v16$2 ) ,  (  !_READ_HAS_OCCURRED_$$p ) ,  (  !_WRITE_HAS_OCCURRED_$$p ) ,  (  _READ_HAS_OCCURRED_$$p ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !_READ_HAS_OCCURRED_$$kernel17.shared_a ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> _WATCHED_OFFSET == 0 ) ,  (  !_READ_HAS_OCCURRED_$$kernel17.shared_b ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> _WATCHED_OFFSET == 0 ) ,  (  !_READ_HAS_OCCURRED_$$kernel17.shared_c ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> _WATCHED_OFFSET == 0 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$5 := _READ_HAS_OCCURRED_$$kernel17.shared_a;
    _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$5 := _READ_HAS_OCCURRED_$$kernel17.shared_b;
    _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$5 := _READ_HAS_OCCURRED_$$kernel17.shared_c;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $c2.0$1 mod 32 == 0 mod 32 )  && ( p4$2 ==> $c2.0$2 mod 32 == 0 mod 32 ) ,  ( p4$1 ==> BV32_SLE($c2.0$1, 0) )  && ( p4$2 ==> BV32_SLE($c2.0$2, 0) ) ,  ( p4$1 ==> BV32_SGE($c2.0$1, 0) )  && ( p4$2 ==> BV32_SGE($c2.0$2, 0) ) ,  ( p4$1 ==> BV32_ULE($c2.0$1, 0) )  && ( p4$2 ==> BV32_ULE($c2.0$2, 0) ) ,  ( p4$1 ==> BV32_UGE($c2.0$1, 0) )  && ( p4$2 ==> BV32_UGE($c2.0$2, 0) ) ,  ( p4$1 ==> p4$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) )  && ( p4$2 ==> p4$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ==> p4$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$12 := _READ_HAS_OCCURRED_$$kernel17.shared_a;
    _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$12 := _READ_HAS_OCCURRED_$$kernel17.shared_b;
    _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$12 := _READ_HAS_OCCURRED_$$kernel17.shared_c;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$p ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$p$ghost$$12 == _READ_HAS_OCCURRED_$$p ) ,  (  !p9$1 ==> _WRITE_HAS_OCCURRED_$$p$ghost$$12 == _WRITE_HAS_OCCURRED_$$p ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> _WATCHED_OFFSET == 0 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_a$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_a ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> _WATCHED_OFFSET == 0 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_b$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_b ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> _WATCHED_OFFSET == 0 ) ,  (  !p9$1 ==> _READ_HAS_OCCURRED_$$kernel17.shared_c$ghost$$12 == _READ_HAS_OCCURRED_$$kernel17.shared_c )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p12$1 ==> $c4.0$1 mod 1 == $0$1 mod 1 )  && ( p12$2 ==> $c4.0$2 mod 1 == $0$2 mod 1 ) ,  ( p12$1 ==> BV32_SLE($c4.0$1, $0$1) )  && ( p12$2 ==> BV32_SLE($c4.0$2, $0$2) ) ,  ( p12$1 ==> BV32_SGE($c4.0$1, $0$1) )  && ( p12$2 ==> BV32_SGE($c4.0$2, $0$2) ) ,  ( p12$1 ==> BV32_ULE($c4.0$1, $0$1) )  && ( p12$2 ==> BV32_ULE($c4.0$2, $0$2) ) ,  ( p12$1 ==> BV32_UGE($c4.0$1, $0$1) )  && ( p12$2 ==> BV32_UGE($c4.0$2, $0$2) ) ,  ( p12$1 ==> p12$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) )  && ( p12$2 ==> p12$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 2)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) && BV64_SLE($c4.0$1, $1$1) ==> p12$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 2)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1) && BV64_SLE($c4.0$2, $1$2) ==> p12$2 ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_c ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_a ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) ) ,  (  _READ_HAS_OCCURRED_$$p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$p ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$p ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) ) ,  (  _READ_HAS_OCCURRED_$$p ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) ) ,  (  _READ_HAS_OCCURRED_$$kernel17.shared_b ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2)) ) ,  (  _WRITE_HAS_OCCURRED_$$p ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$kernel17.shared_c(p15$1, 0, $$kernel17.shared_c[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$kernel17.shared_c(p15$2, 0, $$kernel17.shared_c[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel17.shared_c"} true;
    v13$1 := (if p15$1 then $$kernel17.shared_c[1bv1][0] else v13$1);
    v13$2 := (if p15$2 then $$kernel17.shared_c[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] else v13$2);
    call {:sourceloc} {:sourceloc_num 30} _LOG_READ_$$kernel17.shared_a(p15$1, 0, $$kernel17.shared_a[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 30} _CHECK_READ_$$kernel17.shared_a(p15$2, 0, $$kernel17.shared_a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel17.shared_a"} true;
    v14$1 := (if p15$1 then $$kernel17.shared_a[1bv1][0] else v14$1);
    v14$2 := (if p15$2 then $$kernel17.shared_a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] else v14$2);
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_READ_$$kernel17.shared_b(p15$1, 0, $$kernel17.shared_b[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 32} _CHECK_READ_$$kernel17.shared_b(p15$2, 0, $$kernel17.shared_b[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel17.shared_b"} true;
    v16$1 := (if p15$1 then $$kernel17.shared_b[1bv1][0] else v16$1);
    v16$2 := (if p15$2 then $$kernel17.shared_b[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] else v16$2);
...
const _WATCHED_VALUE_$$kernel17.shared_a: int;

procedure {:inline 1} _LOG_READ_$$kernel17.shared_a(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$kernel17.shared_a;



implementation {:inline 1} _LOG_READ_$$kernel17.shared_a(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$kernel17.shared_a(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$kernel17.shared_a(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$kernel17.shared_a, _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_a;



implementation {:inline 1} _LOG_WRITE_$$kernel17.shared_a(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$kernel17.shared_a(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel17.shared_a(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel17.shared_a;



implementation {:inline 1} _LOG_ATOMIC_$$kernel17.shared_a(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$kernel17.shared_a(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_a(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_a;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_a(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$kernel17.shared_b: int;

procedure {:inline 1} _LOG_READ_$$kernel17.shared_b(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$kernel17.shared_b;



implementation {:inline 1} _LOG_READ_$$kernel17.shared_b(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$kernel17.shared_b(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$kernel17.shared_b(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$kernel17.shared_b, _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_b;



implementation {:inline 1} _LOG_WRITE_$$kernel17.shared_b(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$kernel17.shared_b(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel17.shared_b(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel17.shared_b;



implementation {:inline 1} _LOG_ATOMIC_$$kernel17.shared_b(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$kernel17.shared_b(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_b(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_b;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_b(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$kernel17.shared_c: int;

procedure {:inline 1} _LOG_READ_$$kernel17.shared_c(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$kernel17.shared_c;



implementation {:inline 1} _LOG_READ_$$kernel17.shared_c(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$kernel17.shared_c(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$kernel17.shared_c(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$kernel17.shared_c, _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_c;



implementation {:inline 1} _LOG_WRITE_$$kernel17.shared_c(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$kernel17.shared_c(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel17.shared_c(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel17.shared_c;



implementation {:inline 1} _LOG_ATOMIC_$$kernel17.shared_c(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$kernel17.shared_c(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_c(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel17.shared_c;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel17.shared_c(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon0:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_a;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_a;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_a;
    goto anon1;

  anon1:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_b;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_b;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_b;
    goto anon2;

  anon2:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_c;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_c;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_c;
    goto anon3;
...
implementation {:inline 1} $bugle_barrier_duplicated_1($0: int, $1: int, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_a;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_a;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_a;
    goto anon1;

  anon1:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_b;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_b;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_b;
    goto anon2;

  anon2:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel17.shared_c;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel17.shared_c;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel17.shared_c;
    goto anon3;
