...
implementation {:source_name "kernel19"} {:kernel} $kernel19($n: int, $tsteps: int, $c0: int)
{
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b86 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b85 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_f;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b84 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b83 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_d;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b82 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b81 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b80 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b79 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_a;
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b127 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f$ghost$$5 == _READ_HAS_OCCURRED_$$kernel19.shared_f;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b126 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b125 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_f;
    assert {:tag "disabledMaintainsInstrumentation"} _b124 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d$ghost$$5 == _READ_HAS_OCCURRED_$$kernel19.shared_d;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b123 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b122 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_d;
    assert {:tag "disabledMaintainsInstrumentation"} _b121 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b$ghost$$5 == _READ_HAS_OCCURRED_$$kernel19.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b120 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b119 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_b;
    assert {:tag "disabledMaintainsInstrumentation"} _b118 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a$ghost$$5 == _READ_HAS_OCCURRED_$$kernel19.shared_a;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b117 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> _WATCHED_OFFSET == 0;
    assert {:tag "noread"} _b116 ==> !_READ_HAS_OCCURRED_$$kernel19.shared_a;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
  ...
  $12:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b139 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f$ghost$$12 == _READ_HAS_OCCURRED_$$kernel19.shared_f;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b138 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b137 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d$ghost$$12 == _READ_HAS_OCCURRED_$$kernel19.shared_d;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b136 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b135 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b$ghost$$12 == _READ_HAS_OCCURRED_$$kernel19.shared_b;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b134 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> _WATCHED_OFFSET == 0;
    assert {:tag "disabledMaintainsInstrumentation"} _b133 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a$ghost$$12 == _READ_HAS_OCCURRED_$$kernel19.shared_a;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b132 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> _WATCHED_OFFSET == 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b45 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b44 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b43 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b42 ==> _READ_HAS_OCCURRED_$$kernel19.shared_b ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b36 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b35 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b34 ==> _READ_HAS_OCCURRED_$$kernel19.shared_a ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b33 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel19.shared_f ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 2));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> BV64_SLT($c2.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b26 ==> _READ_HAS_OCCURRED_$$kernel19.shared_d ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1)));
