...
procedure {:source_name "kernel9"} {:kernel} $kernel9($n: int, $tsteps: int);
...
implementation {:source_name "kernel9"} {:kernel} $kernel9($n: int, $tsteps: int)
{
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    havoc v0$1, v0$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$c(true, 0, v0$1, $$c[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$c(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$c(true, 0, v0$2);
