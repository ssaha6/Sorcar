...
procedure {:source_name "kernel0"} {:kernel} $kernel0($n: int, $tsteps: int);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: int, $tsteps: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$B2(true, 0, 4607182418800017408, $$B2[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$B2(true, 0, 4607182418800017408);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B2"} true;
    $$B2[0] := 4607182418800017408;
    $$B2[0] := 4607182418800017408;
    return;
}
