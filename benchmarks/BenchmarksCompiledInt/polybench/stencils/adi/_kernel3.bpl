...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: int, $tsteps: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    ...
    havoc v2$1, v2$2;
    havoc v3$1, v3$2;
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$mul2(true, 0, FDIV64(FMUL64(v0$1, v1$1), FMUL64(v2$1, v3$1)), $$mul2[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$mul2(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$mul2(true, 0, FDIV64(FMUL64(v0$2, v1$2), FMUL64(v2$2, v3$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$mul2"} true;
    $$mul2[0] := FDIV64(FMUL64(v0$1, v1$1), FMUL64(v2$1, v3$1));
    $$mul2[0] := FDIV64(FMUL64(v0$2, v1$2), FMUL64(v2$2, v3$2));
    return;
}
