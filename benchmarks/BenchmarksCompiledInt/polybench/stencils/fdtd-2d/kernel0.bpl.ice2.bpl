...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$ex ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p3$1 ==> _READ_HAS_OCCURRED_$$ex$ghost$$4 == _READ_HAS_OCCURRED_$$ex ) ,  (  !p3$1 ==> _WRITE_HAS_OCCURRED_$$ex$ghost$$4 == _WRITE_HAS_OCCURRED_$$ex ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $c2.0$1 mod 8192 == BV64_MUL(32, v1$1) mod 8192 )  && ( p4$2 ==> $c2.0$2 mod 8192 == BV64_MUL(32, v1$2) mod 8192 ) ,  ( p4$1 ==> BV32_SLE($c2.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_SLE($c2.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_SGE($c2.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_SGE($c2.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_ULE($c2.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_ULE($c2.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_UGE($c2.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_UGE($c2.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> p4$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) )  && ( p4$2 ==> p4$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) && BV64_SLT($c2.0$1, BV32_SEXT64($ny)) ==> p4$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) && BV64_SLT($c2.0$2, BV32_SEXT64($ny)) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$ex ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) ) ,  (  _READ_HAS_OCCURRED_$$ex ==> BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$ex ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p5$1 ==> _READ_HAS_OCCURRED_$$ex$ghost$$9 == _READ_HAS_OCCURRED_$$ex ) ,  (  !p5$1 ==> _WRITE_HAS_OCCURRED_$$ex$ghost$$9 == _WRITE_HAS_OCCURRED_$$ex )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p8$1 ==> $c4.0$1 mod 16 == $0$1 mod 16 )  && ( p8$2 ==> $c4.0$2 mod 16 == $0$2 mod 16 ) ,  ( p8$1 ==> BV32_SLE($c4.0$1, $0$1) )  && ( p8$2 ==> BV32_SLE($c4.0$2, $0$2) ) ,  ( p8$1 ==> BV32_SGE($c4.0$1, $0$1) )  && ( p8$2 ==> BV32_SGE($c4.0$2, $0$2) ) ,  ( p8$1 ==> BV32_ULE($c4.0$1, $0$1) )  && ( p8$2 ==> BV32_ULE($c4.0$2, $0$2) ) ,  ( p8$1 ==> BV32_UGE($c4.0$1, $0$1) )  && ( p8$2 ==> BV32_UGE($c4.0$2, $0$2) ) ,  ( p8$1 ==> p8$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) && BV64_SLT($c2.0$1, BV32_SEXT64($ny)) )  && ( p8$2 ==> p8$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) && BV64_SLT($c2.0$2, BV32_SEXT64($ny)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) && BV64_SLT($c2.0$1, BV32_SEXT64($ny)) && BV64_SLE($c4.0$1, $1$1) ==> p8$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($nx)) && BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) && BV64_SLT($c2.0$2, BV32_SEXT64($ny)) && BV64_SLE($c4.0$2, $1$2) ==> p8$2 ) ,  (  _READ_HAS_OCCURRED_$$ex ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) ) ,  (  _READ_HAS_OCCURRED_$$ex ==> BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) ) ,  (  _READ_HAS_OCCURRED_$$ex ==> BV64_SLT($c2.0$1, BV32_SEXT64($ny)) ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> BV64_SLT($c1.0$1, BV32_SEXT64($nx)) ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> BV64_SGE(BV32_SEXT64($nx), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) ) ,  (  _WRITE_HAS_OCCURRED_$$ex ==> BV64_SLT($c2.0$1, BV32_SEXT64($ny)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
