...
procedure {:source_name "kernel1"} {:kernel} $kernel1($tsteps: int, $n: int, $c0: int);
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($tsteps: int, $n: int, $c0: int)
{
  var $c1.0$1: int;
  var $c1.0$2: int;
  var v1$1: int;
...
assert  my_inv (  ( p0$1 ==> $c1.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c1.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$A(p5$1, BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0), FMUL64(4599676359373071550, FADD64(FADD64(v5$1, v6$1), v7$1)), $$A[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p5$2, BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$A(p5$2, BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0), FMUL64(4599676359373071550, FADD64(FADD64(v5$2, v6$2), v7$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)] := (if p5$1 then FMUL64(4599676359373071550, FADD64(FADD64(v5$1, v6$1), v7$1)) else $$A[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)]);
    $$A[BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0)] := (if p5$2 then FMUL64(4599676359373071550, FADD64(FADD64(v5$2, v6$2), v7$2)) else $$A[BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0)]);
