...
implementation {:source_name "kernel0"} {:kernel} $kernel0($alpha: bv64, $beta: bv64, $n: bv32, $m: bv32)
{
  ...
  $1:
    ...
    assert {:tag "predicatedEquality"} _b113 ==> p0$1 && p0$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b112 ==> p0$1 && p0$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b111 ==> p0$1 && p0$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b110 ==> p0$1 && p0$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b109 ==> p0$1 && p0$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b108 ==> p0$1 && p0$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b107 ==> p0$1 && p0$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b106 ==> p0$1 && p0$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b105 ==> p0$1 && p0$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b104 ==> p0$1 && p0$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b103 ==> p0$1 && p0$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b102 ==> p0$1 && p0$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b101 ==> p0$1 && p0$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b100 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b184 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$3 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0;
    assert {:tag "disabledMaintainsInstrumentation"} _b183 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$3 == _READ_HAS_OCCURRED_$$kernel0.shared_A_0;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b177 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$C$ghost$$3 == _WRITE_HAS_OCCURRED_$$C;
    assert {:tag "disabledMaintainsInstrumentation"} _b176 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$C$ghost$$3 == _READ_HAS_OCCURRED_$$C;
    ...
    assert {:tag "predicatedEquality"} _b171 ==> p2$1 && p2$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b170 ==> p2$1 && p2$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b169 ==> p2$1 && p2$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b168 ==> p2$1 && p2$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b167 ==> p2$1 && p2$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b166 ==> p2$1 && p2$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b165 ==> p2$1 && p2$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b164 ==> p2$1 && p2$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b163 ==> p2$1 && p2$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b162 ==> p2$1 && p2$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b161 ==> p2$1 && p2$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b160 ==> p2$1 && p2$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b159 ==> p2$1 && p2$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b158 ==> p2$1 && p2$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b157 ==> p2$1 && p2$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b156 ==> p2$1 && p2$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b155 ==> p2$1 && p2$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b154 ==> p2$1 && p2$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b153 ==> p2$1 && p2$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b152 ==> p2$1 && p2$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b151 ==> p2$1 && p2$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b150 ==> p2$1 && p2$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b149 ==> p2$1 && p2$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b148 ==> p2$1 && p2$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b147 ==> p2$1 && p2$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b146 ==> p2$1 && p2$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b145 ==> p2$1 && p2$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b144 ==> p2$1 && p2$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b143 ==> p2$1 && p2$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b142 ==> p2$1 && p2$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b141 ==> p2$1 && p2$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b140 ==> p2$1 && p2$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b139 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b138 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b137 ==> p2$1 && p2$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b136 ==> p2$1 && p2$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b135 ==> p2$1 && p2$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b134 ==> p2$1 && p2$2 ==> v10$1 == v10$2;
    ...
    assert {:tag "predicatedEquality"} _b130 ==> p2$1 && p2$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b129 ==> p2$1 && p2$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b128 ==> p2$1 && p2$2 ==> $0$1 == $0$2;
  ...
  $10:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b222 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$10 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0;
    assert {:tag "disabledMaintainsInstrumentation"} _b221 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$10 == _READ_HAS_OCCURRED_$$kernel0.shared_A_0;
    ...
    assert {:tag "predicatedEquality"} _b215 ==> p10$1 && p10$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b214 ==> p10$1 && p10$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b213 ==> p10$1 && p10$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b212 ==> p10$1 && p10$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b211 ==> p10$1 && p10$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b210 ==> p10$1 && p10$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b209 ==> p10$1 && p10$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b208 ==> p10$1 && p10$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b207 ==> p10$1 && p10$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b206 ==> p10$1 && p10$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b205 ==> p10$1 && p10$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b204 ==> p10$1 && p10$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b203 ==> p10$1 && p10$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b202 ==> p10$1 && p10$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b201 ==> p10$1 && p10$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b200 ==> p10$1 && p10$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b199 ==> p10$1 && p10$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b198 ==> p10$1 && p10$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b197 ==> p10$1 && p10$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b196 ==> p10$1 && p10$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b195 ==> p10$1 && p10$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b194 ==> p10$1 && p10$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b193 ==> p10$1 && p10$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b192 ==> p10$1 && p10$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b191 ==> p10$1 && p10$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b190 ==> p10$1 && p10$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b189 ==> p10$1 && p10$2 ==> $0$1 == $0$2;
  ...
  $13:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b225 ==> !p13$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$13 == _WRITE_HAS_OCCURRED_$$kernel0.shared_A_0;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b58 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SLT($c2.0$1, BV32_SEXT64($m)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1bv64)) && BV64_SLE($c4.0$1, $0$1) ==> p14$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b58 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SLT($c2.0$2, BV32_SEXT64($m)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1bv64)) && BV64_SLE($c4.0$2, $0$2) ==> p14$2;
  ...
  $27:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b227 ==> !p21$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A_0$ghost$$27 == _READ_HAS_OCCURRED_$$kernel0.shared_A_0;
