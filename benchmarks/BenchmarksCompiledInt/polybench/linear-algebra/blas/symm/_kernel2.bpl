...
procedure {:source_name "kernel2"} {:kernel} $kernel2($alpha: int, $beta: int, $n: int, $m: int, $c0: int, $c1: int);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($alpha: int, $beta: int, $n: int, $m: int, $c0: int, $c1: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 8} _LOG_READ_$$C(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0), $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_READ_$$C(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0), $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$C"} true;
    v0$1 := $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)];
    v0$2 := $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)];
    havoc v1$1, v1$2;
    havoc v2$1, v2$2;
    havoc v3$1, v3$2;
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$C(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0), FADD64(FMUL64($alpha, v3$1), FADD64(FMUL64($beta, v0$1), FMUL64(FMUL64($alpha, v1$1), v2$1))), $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$C(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$C(true, BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0), FADD64(FMUL64($alpha, v3$2), FADD64(FMUL64($beta, v0$2), FMUL64(FMUL64($alpha, v1$2), v2$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$C"} true;
    $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)] := FADD64(FMUL64($alpha, v3$1), FADD64(FMUL64($beta, v0$1), FMUL64(FMUL64($alpha, v1$1), v2$1)));
    $$C[BV_EXTRACT(BV64_ADD(BV64_MUL($c0, BV32_SEXT64($n)), $c1), 32, 0)] := FADD64(FMUL64($alpha, v3$2), FADD64(FMUL64($beta, v0$2), FMUL64(FMUL64($alpha, v1$2), v2$2)));
    return;
}
