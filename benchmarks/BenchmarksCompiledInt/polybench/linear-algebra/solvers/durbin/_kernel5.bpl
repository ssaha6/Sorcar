...
procedure {:source_name "kernel5"} {:kernel} $kernel5($n: int);
  ...
  modifies _WRITE_HAS_OCCURRED_$$beta, _WRITE_READ_BENIGN_FLAG_$$beta, _WRITE_READ_BENIGN_FLAG_$$beta;



implementation {:source_name "kernel5"} {:kernel} $kernel5($n: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$beta(true, 0, 4607182418800017408, $$beta[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$beta(true, 0, 4607182418800017408);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$beta"} true;
    $$beta[0] := 4607182418800017408;
    $$beta[0] := 4607182418800017408;
    return;
}
