...
assert  my_inv (  ( p4$1 ==> $c1.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p4$2 ==> $c1.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p4$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p4$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p4$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p4$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p4$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p4$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p4$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p4$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c1.0$1, $c0) ==> p4$1 )  && (  BV64_SLT($c1.0$2, $c0) ==> p4$2 ) ,  (  p4$1 == p4$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2 ) ,  (  p4$1 && p4$2 ==> $c1.0$1 == $c1.0$2 ) ,  (  p4$1 && p4$2 ==> v6$1 == v6$2 ) ,  (  p4$1 && p4$2 ==> v7$1 == v7$2 ) ,  (  p4$1 && p4$2 ==> v8$1 == v8$2 ) ,  (  p4$1 && p4$2 ==> v9$1 == v9$2 ) ,  (  p4$1 && p4$2 ==> v10$1 == v10$2 ) ,  (  p4$1 && p4$2 ==> v11$1 == v11$2 ) ,  (  p4$1 && p4$2 ==> v12$1 == v12$2 ) ,  (  !_WRITE_HAS_OCCURRED_$$z ) ,  (  _WRITE_HAS_OCCURRED_$$z ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !_READ_HAS_OCCURRED_$$kernel9.shared_alpha ) ,  (  _READ_HAS_OCCURRED_$$kernel9.shared_alpha ==> _WATCHED_OFFSET == 0 ) ,  (  !_READ_HAS_OCCURRED_$$kernel9.shared_y_1 ) ,  (  !_WRITE_HAS_OCCURRED_$$kernel9.shared_y_1 ) ,  (  _READ_HAS_OCCURRED_$$kernel9.shared_y_1 ==> _WATCHED_OFFSET == BV_EXTRACT(BV64_ADD(BV64_SUB(0, BV32_ZEXT64(local_id_x$1)), 31), 32, 0) ) ,  (  _WRITE_HAS_OCCURRED_$$kernel9.shared_y_1 ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
