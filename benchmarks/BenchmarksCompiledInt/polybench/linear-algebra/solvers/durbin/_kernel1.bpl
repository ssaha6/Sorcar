...
var {:source_name "beta"} {:global} $$beta: [int]int;
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: int, $c0: int)
{
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_READ_$$beta(true, 0, $$beta[0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_READ_$$beta(true, 0, $$beta[0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$beta"} true;
    v2$1 := $$beta[0];
    v2$2 := $$beta[0];
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$beta(true, 0, FMUL64(FADD64(FMUL64(FSUB64(-9223372036854775808, v0$1), v1$1), 4607182418800017408), v2$1), $$beta[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$beta(true, 0);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$beta(true, 0, FMUL64(FADD64(FMUL64(FSUB64(-9223372036854775808, v0$2), v1$2), 4607182418800017408), v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$beta"} true;
    $$beta[0] := FMUL64(FADD64(FMUL64(FSUB64(-9223372036854775808, v0$1), v1$1), 4607182418800017408), v2$1);
    $$beta[0] := FMUL64(FADD64(FMUL64(FSUB64(-9223372036854775808, v0$2), v1$2), 4607182418800017408), v2$2);
    return;
}
