...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: int, $c0: int, $c1: int, $c2: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_READ_$$w(true, 0, $$w[0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_READ_$$w(true, 0, $$w[0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$w"} true;
    v2$1 := $$w[0];
    v2$2 := $$w[0];
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$w(true, 0, FSUB64(v2$1, FMUL64(v0$1, v1$1)), $$w[0]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$w(true, 0, FSUB64(v2$2, FMUL64(v0$2, v1$2)));
