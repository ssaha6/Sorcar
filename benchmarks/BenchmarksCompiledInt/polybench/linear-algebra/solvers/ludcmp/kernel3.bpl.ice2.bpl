...
assert  my_inv (  ( p0$1 ==> $c1.0$1 mod 1048576 == BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$1), $c0), 1048544), 1048576))) mod 1048576 )  && ( p0$2 ==> $c1.0$2 mod 1048576 == BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$2), $c0), 1048544), 1048576))) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$1), $c0), 1048544), 1048576)))) )  && ( p0$2 ==> BV32_SLE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$2), $c0), 1048544), 1048576)))) ) ,  ( p0$1 ==> BV32_SGE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$1), $c0), 1048544), 1048576)))) )  && ( p0$2 ==> BV32_SGE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$2), $c0), 1048544), 1048576)))) ) ,  ( p0$1 ==> BV32_ULE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$1), $c0), 1048544), 1048576)))) )  && ( p0$2 ==> BV32_ULE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$2), $c0), 1048544), 1048576)))) ) ,  ( p0$1 ==> BV32_UGE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$1), $c0), 1048544), 1048576)))) )  && ( p0$2 ==> BV32_UGE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v0$2), $c0), 1048544), 1048576)))) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p5$1 ==> _READ_HAS_OCCURRED_$$A$ghost$$5 == _READ_HAS_OCCURRED_$$A )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p6$1 ==> $c3.0$1 mod 1 == 1 mod 1 )  && ( p6$2 ==> $c3.0$2 mod 1 == 1 mod 1 ) ,  ( p6$1 ==> BV32_SLE($c3.0$1, 1) )  && ( p6$2 ==> BV32_SLE($c3.0$2, 1) ) ,  ( p6$1 ==> BV32_SGE($c3.0$1, 1) )  && ( p6$2 ==> BV32_SGE($c3.0$2, 1) ) ,  ( p6$1 ==> BV32_ULE($c3.0$1, 1) )  && ( p6$2 ==> BV32_ULE($c3.0$2, 1) ) ,  ( p6$1 ==> BV32_UGE($c3.0$1, 1) )  && ( p6$2 ==> BV32_UGE($c3.0$2, 1) ) ,  ( p6$1 ==> p6$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), $c0) )  && ( p6$2 ==> p6$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), $c0) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), $c0) && BV64_SLE($c3.0$1, $c0) ==> p6$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), 1)) && BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c1.0$2), $c0) && BV64_SLE($c3.0$2, $c0) ==> p6$2 ) ,  (  _READ_HAS_OCCURRED_$$A ==> BV64_SLT($c1.0$1, BV32_SEXT64($n)) ) ,  (  _READ_HAS_OCCURRED_$$A ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), 1)) ) ,  (  _READ_HAS_OCCURRED_$$A ==> BV64_SGE(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c1.0$1), $c0) ) ,  true ,  true ,  true ,  true  ); 
