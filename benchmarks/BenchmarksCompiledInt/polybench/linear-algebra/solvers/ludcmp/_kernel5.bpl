...
procedure {:source_name "kernel5"} {:kernel} $kernel5($n: int, $c0: int, $c1: int);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$y ==> $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n)) then 1 else 0) != 0;
...
implementation {:source_name "kernel5"} {:kernel} $kernel5($n: int, $c0: int, $c1: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
