...
procedure {:source_name "kernel9"} {:kernel} $kernel9($n: int, $c0: int);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$x ==> BV64_ADD(BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n)), $c0) == 0 then 1 else 0) != 0;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV1_ZEXT32((if BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n) == BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), $n) then 1 else 0)), BV1_ZEXT32((if BV64_ADD(BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), $n)), $c0) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
...
implementation {:source_name "kernel9"} {:kernel} $kernel9($n: int, $c0: int)
{
  ...
  $0:
    havoc v0$1, v0$2;
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$x(true, BV_EXTRACT(BV64_SUB(0, $c0), 32, 0), FDIV64(v0$1, v1$1), $$x[BV_EXTRACT(BV64_SUB(0, $c0), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$x(true, BV_EXTRACT(BV64_SUB(0, $c0), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$x(true, BV_EXTRACT(BV64_SUB(0, $c0), 32, 0), FDIV64(v0$2, v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$x"} true;
    $$x[BV_EXTRACT(BV64_SUB(0, $c0), 32, 0)] := FDIV64(v0$1, v1$1);
    $$x[BV_EXTRACT(BV64_SUB(0, $c0), 32, 0)] := FDIV64(v0$2, v1$2);
    return;
}
