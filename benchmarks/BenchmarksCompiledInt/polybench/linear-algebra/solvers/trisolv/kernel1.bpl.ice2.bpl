...
procedure {:source_name "kernel1"} {:kernel} $kernel1($n: int);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _READ_HAS_OCCURRED_$$b ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($n, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
...
assert  my_inv (  ( p0$1 ==> $c1.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c1.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p0$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$x ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$x(p3$1, BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0), v4$1, $$x[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$x(p3$2, BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$x(p3$2, BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0), v4$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$x"} true;
    $$x[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)] := (if p3$1 then v4$1 else $$x[BV_EXTRACT(BV64_ADD(v1$1, $c1.0$1), 32, 0)]);
    $$x[BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0)] := (if p3$2 then v4$2 else $$x[BV_EXTRACT(BV64_ADD(v1$2, $c1.0$2), 32, 0)]);
