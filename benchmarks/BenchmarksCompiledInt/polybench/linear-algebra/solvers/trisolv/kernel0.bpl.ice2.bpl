...
assert  my_inv (  ( p6$1 ==> $c1.0$1 mod 1048576 == $1$1 mod 1048576 )  && ( p6$2 ==> $c1.0$2 mod 1048576 == $1$2 mod 1048576 ) ,  ( p6$1 ==> BV32_SLE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_SLE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_SGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_SGE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_ULE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_ULE($c1.0$2, $1$2) ) ,  ( p6$1 ==> BV32_UGE($c1.0$1, $1$1) )  && ( p6$2 ==> BV32_UGE($c1.0$2, $1$2) ) ,  (  BV64_SLT($c1.0$1, BV64_SDIV($c0, 2)) ==> p6$1 )  && (  BV64_SLT($c1.0$2, BV64_SDIV($c0, 2)) ==> p6$2 ) ,  (  p6$1 == p6$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p6$1 == p6$2 ) ,  (  p6$1 && p6$2 ==> $c1.0$1 == $c1.0$2 ) ,  (  p6$1 && p6$2 ==> v6$1 == v6$2 ) ,  (  p6$1 && p6$2 ==> v7$1 == v7$2 ) ,  (  p6$1 && p6$2 ==> v8$1 == v8$2 ) ,  (  p6$1 && p6$2 ==> v9$1 == v9$2 ) ,  (  p6$1 && p6$2 ==> v10$1 == v10$2 ) ,  (  p6$1 && p6$2 ==> v11$1 == v11$2 ) ,  (  p6$1 && p6$2 ==> v12$1 == v12$2 ) ,  (  p6$1 && p6$2 ==> v13$1 == v13$2 ) ,  (  p6$1 && p6$2 ==> v14$1 == v14$2 ) ,  (  p6$1 && p6$2 ==> v15$1 == v15$2 ) ,  (  p6$1 && p6$2 ==> v16$1 == v16$2 ) ,  (  p6$1 && p6$2 ==> v17$1 == v17$2 ) ,  (  p6$1 && p6$2 ==> v18$1 == v18$2 ) ,  (  !_READ_HAS_OCCURRED_$$x ) ,  (  !_WRITE_HAS_OCCURRED_$$x ) ,  (  _READ_HAS_OCCURRED_$$x ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$x ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !_READ_HAS_OCCURRED_$$kernel0.shared_x_0 ) ,  (  !_WRITE_HAS_OCCURRED_$$kernel0.shared_x_0 ) ,  (  _READ_HAS_OCCURRED_$$kernel0.shared_x_0 ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV_EXTRACT(BV64_ADD(BV64_SUB(0, BV32_ZEXT64(local_id_x$1)), 31), 32, 0) ) ,  (  _WRITE_HAS_OCCURRED_$$kernel0.shared_x_0 ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV_EXTRACT(BV64_ADD(BV64_SUB(0, BV32_ZEXT64(local_id_x$1)), 31), 32, 0) )  ); 
