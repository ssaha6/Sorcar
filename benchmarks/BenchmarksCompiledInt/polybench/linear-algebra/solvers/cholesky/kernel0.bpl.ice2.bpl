...
assert  my_inv (  ( p0$1 ==> $c0.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c0.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($n)) ==> p0$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($n)) ==> p0$2 ) ,  (  _READ_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    v3$1 := (if p1$1 then BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(v1$1, $c0.0$1), 1)) else v3$1);
    v3$2 := (if p1$2 then BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(v1$2, $c0.0$2), 1)) else v3$2);
    p3$1 := (if p1$1 && v3$1 then v3$1 else p3$1);
    p3$2 := (if p1$2 && v3$2 then v3$2 else p3$2);
    call {:sourceloc} {:sourceloc_num 8} _LOG_READ_$$A(p3$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0), $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_READ_$$A(p3$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0), $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v4$1 := (if p3$1 then $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)] else v4$1);
    v4$2 := (if p3$2 then $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)] else v4$2);
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$A(p3$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0), v4$1, $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p3$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$A(p3$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0), v4$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)] := (if p3$1 then v4$1 else $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($n)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)]);
    $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)] := (if p3$2 then v4$2 else $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($n)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)]);
