...
procedure {:source_name "kernel3"} {:kernel} $kernel3($n: int, $c0: int);
  ...
  requires {:sourceloc_num 1} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SLE($n, 2147483647) then 1 else 0)), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64(BV32_MUL(3, $n)), BV64_ADD($c0, 3)) then 1 else 0))), BV1_ZEXT32((if BV64_SGE($c0, 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM($c0, 3) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$A ==> BV32_AND(BV1_ZEXT32((if BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n) == BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), $n) then 1 else 0)), BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_MUL(3, BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), $n))) then 1 else 0))) != 0 then 1 else 0) != 0;
...
implementation {:source_name "kernel3"} {:kernel} $kernel3($n: int, $c0: int)
{
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 5} _LOG_READ_$$A(true, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0), $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_READ_$$A(true, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0), $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v0$1 := $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)];
    v0$2 := $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)];
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$A(true, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0), FSQRT64(v0$1), $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$A(true, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0), FSQRT64(v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)] := FSQRT64(v0$1);
    $$A[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_SDIV($c0, 3), BV32_SEXT64($n)), BV64_SDIV($c0, 3)), 32, 0)] := FSQRT64(v0$2);
    return;
}
