...
assert  my_inv (  ( p2$1 ==> $c1.0$1 mod 1048576 == BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$1), $c0), 2097091), 2097152))) mod 1048576 )  && ( p2$2 ==> $c1.0$2 mod 1048576 == BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$2), $c0), 2097091), 2097152))) mod 1048576 ) ,  ( p2$1 ==> BV32_SLE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$1), $c0), 2097091), 2097152)))) )  && ( p2$2 ==> BV32_SLE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$2), $c0), 2097091), 2097152)))) ) ,  ( p2$1 ==> BV32_SGE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$1), $c0), 2097091), 2097152)))) )  && ( p2$2 ==> BV32_SGE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$2), $c0), 2097091), 2097152)))) ) ,  ( p2$1 ==> BV32_ULE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$1), $c0), 2097091), 2097152)))) )  && ( p2$2 ==> BV32_ULE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$2), $c0), 2097091), 2097152)))) ) ,  ( p2$1 ==> BV32_UGE($c1.0$1, BV64_ADD(BV64_MUL(32, v0$1), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$1), $c0), 2097091), 2097152)))) )  && ( p2$2 ==> BV32_UGE($c1.0$2, BV64_ADD(BV64_MUL(32, v0$2), BV64_MUL(1048576, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-64, v0$2), $c0), 2097091), 2097152)))) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p2$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p2$2 ) ,  (  _READ_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$A ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _READ_HAS_OCCURRED_$$kernel0.shared_A_1 ==> _WATCHED_OFFSET == 0 )  ); 
