...
implementation {:source_name "kernel4"} {:kernel} $kernel4($n: int, $m: int, $c0: int)
{

  $0:
    call {:sourceloc} {:sourceloc_num 4} _LOG_WRITE_$$nrm(true, 0, 0, $$nrm[0]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 4} _CHECK_WRITE_$$nrm(true, 0, 0);
