...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$R ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$R$ghost$$3 == _WRITE_HAS_OCCURRED_$$R ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p2$1 ==> $c2.0$1 mod 8192 == BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c1.0$1), 8161), 8192))) mod 8192 )  && ( p2$2 ==> $c2.0$2 mod 8192 == BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c1.0$2), 8161), 8192))) mod 8192 ) ,  ( p2$1 ==> BV32_SLE($c2.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c1.0$1), 8161), 8192)))) )  && ( p2$2 ==> BV32_SLE($c2.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c1.0$2), 8161), 8192)))) ) ,  ( p2$1 ==> BV32_SGE($c2.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c1.0$1), 8161), 8192)))) )  && ( p2$2 ==> BV32_SGE($c2.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c1.0$2), 8161), 8192)))) ) ,  ( p2$1 ==> BV32_ULE($c2.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c1.0$1), 8161), 8192)))) )  && ( p2$2 ==> BV32_ULE($c2.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c1.0$2), 8161), 8192)))) ) ,  ( p2$1 ==> BV32_UGE($c2.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c1.0$1), 8161), 8192)))) )  && ( p2$2 ==> BV32_UGE($c2.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c1.0$2), 8161), 8192)))) ) ,  ( p2$1 ==> p2$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) )  && ( p2$2 ==> p2$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64($n)) ==> p2$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64($n)) ==> p2$2 ) ,  (  _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$R ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p3$1 ==> _WRITE_HAS_OCCURRED_$$R$ghost$$14 == _WRITE_HAS_OCCURRED_$$R )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p10$1 ==> $c4.0$1 mod 16 == $1$1 mod 16 )  && ( p10$2 ==> $c4.0$2 mod 16 == $1$2 mod 16 ) ,  ( p10$1 ==> BV32_SLE($c4.0$1, $1$1) )  && ( p10$2 ==> BV32_SLE($c4.0$2, $1$2) ) ,  ( p10$1 ==> BV32_SGE($c4.0$1, $1$1) )  && ( p10$2 ==> BV32_SGE($c4.0$2, $1$2) ) ,  ( p10$1 ==> BV32_ULE($c4.0$1, $1$1) )  && ( p10$2 ==> BV32_ULE($c4.0$2, $1$2) ) ,  ( p10$1 ==> BV32_UGE($c4.0$1, $1$1) )  && ( p10$2 ==> BV32_UGE($c4.0$2, $1$2) ) ,  ( p10$1 ==> p10$1 ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64($n)) )  && ( p10$2 ==> p10$2 ==> BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64($n)) ) ,  (  BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$1, BV32_SEXT64($n)) && BV64_SLE($c4.0$1, $3$1) ==> p10$1 )  && (  BV64_SLT($c1.0$2, BV32_SEXT64(BV32_SUB($n, 1))) && BV64_SLT($c2.0$2, BV32_SEXT64($n)) && BV64_SLE($c4.0$2, $3$2) ==> p10$2 ) ,  (  _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c1.0$1, BV32_SEXT64(BV32_SUB($n, 1))) ) ,  (  _WRITE_HAS_OCCURRED_$$R ==> BV64_SLT($c2.0$1, BV32_SEXT64($n)) ) ,  true ,  true ,  true ,  true ,  true  ); 
