...
var {:source_name "x2"} {:global} $$x2: [int]int;
...
var {:source_name "shared_y_2"} {:group_shared} $$kernel0.shared_y_2: [bv1][int]int;
...
procedure {:source_name "kernel0"} {:kernel} $kernel0($n: int);
  ...
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 4} {:thread 1} (if _READ_HAS_OCCURRED_$$x2 ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($n, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b52 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b51 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b50 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "noread"} _b49 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b48 ==> _WRITE_HAS_OCCURRED_$$x2 ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b47 ==> _READ_HAS_OCCURRED_$$x2 ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b46 ==> !_WRITE_HAS_OCCURRED_$$x2;
    assert {:tag "noread"} _b45 ==> !_READ_HAS_OCCURRED_$$x2;
    assert {:tag "predicatedEquality"} _b44 ==> p0$1 && p0$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b43 ==> p0$1 && p0$2 ==> v14$1 == v14$2;
    ...
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> v15$1 == v15$2;
    ...
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$x2 ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($n, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $n))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_READ_$$x2(p3$1, BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0), $$x2[BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 10} _CHECK_READ_$$x2(p3$2, BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0), $$x2[BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$x2"} true;
    v5$1 := (if p3$1 then $$x2[BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0)] else v5$1);
    v5$2 := (if p3$2 then $$x2[BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0)] else v5$2);
    $$private_x2$0$1 := (if p3$1 then v5$1 else $$private_x2$0$1);
    $$private_x2$0$2 := (if p3$2 then v5$2 else $$private_x2$0$2);
  ...
  __partitioned_block_$5_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b72 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2$ghost$__partitioned_block_$5_0 == _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "disabledMaintainsInstrumentation"} _b71 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2$ghost$__partitioned_block_$5_0 == _READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b70 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b68 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "noread"} _b67 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    ...
    assert {:tag "predicatedEquality"} _b56 ==> p4$1 && p4$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b55 ==> p4$1 && p4$2 ==> $c1.0$1 == $c1.0$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) ==> p4$2;
  ...
  __partitioned_block_$5_1:
    call {:sourceloc_num 19} $bugle_barrier_duplicated_1(-1, -1, p5$1, p5$2);
  ...
  $10:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b74 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2$ghost$$10 == _READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b73 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_y_2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV64_SLT($c1.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLE($c3.0$1, $0$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLE($c3.0$2, $0$2) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b20 ==> p10$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($n)) && BV64_SLT($c1.0$1, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b20 ==> p10$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($n)) && BV64_SLT($c1.0$2, BV32_SEXT64($n)) && BV64_SGE(BV32_SEXT64($n), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1));
    ...
    v12$1 := (if p13$1 then $$private_x2$0$1 else v12$1);
    v12$2 := (if p13$2 then $$private_x2$0$2 else v12$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v13$1 := (if p13$1 then _HAVOC_int$1 else v13$1);
    v13$2 := (if p13$2 then _HAVOC_int$2 else v13$2);
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$kernel0.shared_y_2(p13$1, BV_EXTRACT($c3.0$1, 32, 0), $$kernel0.shared_y_2[1bv1][BV_EXTRACT($c3.0$1, 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$kernel0.shared_y_2(p13$2, BV_EXTRACT($c3.0$2, 32, 0), $$kernel0.shared_y_2[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($c3.0$2, 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_y_2"} true;
    v14$1 := (if p13$1 then $$kernel0.shared_y_2[1bv1][BV_EXTRACT($c3.0$1, 32, 0)] else v14$1);
    v14$2 := (if p13$2 then $$kernel0.shared_y_2[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($c3.0$2, 32, 0)] else v14$2);
    $$private_x2$0$1 := (if p13$1 then FADD64(FMUL64(v13$1, v14$1), v12$1) else $$private_x2$0$1);
    $$private_x2$0$2 := (if p13$2 then FADD64(FMUL64(v13$2, v14$2), v12$2) else $$private_x2$0$2);
  ...
  __partitioned_block_$10.tail_1:
    call {:sourceloc_num 33} $bugle_barrier_duplicated_2(-1, -1, p5$1, p5$2);
  ...
  __partitioned_block_$5.tail_0:
    ...
    v16$1 := (if p15$1 then $$private_x2$0$1 else v16$1);
    v16$2 := (if p15$2 then $$private_x2$0$2 else v16$2);
    call {:sourceloc} {:sourceloc_num 38} _LOG_WRITE_$$x2(p15$1, BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0), v16$1, $$x2[BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$x2(p15$2, BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 38} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 38} _CHECK_WRITE_$$x2(p15$2, BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0), v16$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$x2"} true;
    $$x2[BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0)] := (if p15$1 then v16$1 else $$x2[BV_EXTRACT(BV64_ADD(v2$1, $c0.0$1), 32, 0)]);
    $$x2[BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0)] := (if p15$2 then v16$2 else $$x2[BV_EXTRACT(BV64_ADD(v2$2, $c0.0$2), 32, 0)]);
    goto __partitioned_block_$5.tail_1;

  __partitioned_block_$5.tail_1:
    call {:sourceloc_num 40} $bugle_barrier_duplicated_0(-1, -1, p1$1, p1$2);
...
var $$private_x2$0$1: int;

var $$private_x2$0$2: int;
...
const _WATCHED_VALUE_$$x2: int;

procedure {:inline 1} _LOG_READ_$$x2(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$x2;



implementation {:inline 1} _LOG_READ_$$x2(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$x2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$x2(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$x2, _WRITE_READ_BENIGN_FLAG_$$x2;



implementation {:inline 1} _LOG_WRITE_$$x2(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$x2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$x2(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$x2;



implementation {:inline 1} _LOG_ATOMIC_$$x2(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$x2(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$x2(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$x2;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$x2(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$y_2: int;

procedure {:inline 1} _LOG_READ_$$y_2(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$y_2;



implementation {:inline 1} _LOG_READ_$$y_2(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$y_2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$y_2(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$y_2, _WRITE_READ_BENIGN_FLAG_$$y_2;



implementation {:inline 1} _LOG_WRITE_$$y_2(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$y_2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$y_2(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$y_2;



implementation {:inline 1} _LOG_ATOMIC_$$y_2(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$y_2(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$y_2(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$y_2;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$y_2(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$kernel0.shared_y_2: int;

procedure {:inline 1} _LOG_READ_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$kernel0.shared_y_2;



implementation {:inline 1} _LOG_READ_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2, _WRITE_READ_BENIGN_FLAG_$$kernel0.shared_y_2;



implementation {:inline 1} _LOG_WRITE_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$kernel0.shared_y_2(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel0.shared_y_2(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel0.shared_y_2;



implementation {:inline 1} _LOG_ATOMIC_$$kernel0.shared_y_2(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$kernel0.shared_y_2(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel0.shared_y_2(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel0.shared_y_2;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel0.shared_y_2(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel0.shared_y_2;
    goto anon1;
  ...
  anon3:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_READ_HAS_OCCURRED_$$x2;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$x2;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$x2;
    goto anon4;
