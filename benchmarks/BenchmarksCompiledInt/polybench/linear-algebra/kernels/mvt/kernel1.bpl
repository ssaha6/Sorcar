...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: bv32)
{
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b100 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$5 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b99 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$5 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    ...
    assert {:tag "predicatedEquality"} _b92 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b91 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b90 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b89 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b88 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b87 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b86 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b85 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b84 ==> p4$1 && p4$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b83 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
  ...
  $8:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b102 ==> !p7$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$$8 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
  ...
  $17:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b105 ==> !p13$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$17 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
