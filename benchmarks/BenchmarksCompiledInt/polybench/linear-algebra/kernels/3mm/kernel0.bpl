...
procedure {:source_name "kernel0"} {:kernel} $kernel0($nl: int, $nj: int, $nm: int, $nk: int, $ni: int);
...
implementation {:source_name "kernel0"} {:kernel} $kernel0($nl: int, $nj: int, $nm: int, $nk: int, $ni: int)
{
  var $c0.0$1: int;
  var $c0.0$2: int;
  var $c1.0$1: int;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b25 ==> _WRITE_HAS_OCCURRED_$$F ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) ==> p0$2;
    ...
    v5$1 := (if p1$1 then BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(v2$1, $c0.0$1), 1)) else v5$1);
    v5$2 := (if p1$2 then BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(v2$2, $c0.0$2), 1)) else v5$2);
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b27 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$F$ghost$$4 == _WRITE_HAS_OCCURRED_$$F;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b26 ==> _WRITE_HAS_OCCURRED_$$F ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p4"} {:dominator_predicate "p3"} true;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$F ==> BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b11 ==> p4$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b11 ==> p4$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1));
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$F$ghost$$6 == _WRITE_HAS_OCCURRED_$$F;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$F ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p6"} {:dominator_predicate "p5"} true;
    assert p6$1 ==> p4$1;
    assert p6$2 ==> p4$2;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _WRITE_HAS_OCCURRED_$$F ==> BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $0$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $0$2) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b20 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b20 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl));
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b19 ==> BV32_UGE($c3.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b19 ==> BV32_UGE($c3.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b18 ==> BV32_ULE($c3.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b18 ==> BV32_ULE($c3.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b17 ==> BV32_SGE($c3.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b17 ==> BV32_SGE($c3.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b16 ==> BV32_SLE($c3.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b16 ==> BV32_SLE($c3.0$2, v3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b15 ==> $c3.0$1 mod 16 == v3$1 mod 16;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b15 ==> $c3.0$2 mod 16 == v3$2 mod 16;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 6} {:thread 1} (if _WRITE_HAS_OCCURRED_$$F ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 8191) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($nj, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), $nj), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), $nj), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($nl, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), 8192)), BV64_MUL(32, BV32_ZEXT64(group_id_y$1))) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_y$1)), 31), BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), 8192))) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl), $nj))), 8192) == 0 then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_y$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $nl))), 16) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_WRITE_$$F(p9$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1)), 32, 0), 0, $$F[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$F(p9$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 18} _CHECK_WRITE_$$F(p9$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2)), 32, 0), 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$F"} true;
    $$F[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1)), 32, 0)] := (if p9$1 then 0 else $$F[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$1, $c0.0$1), BV32_SEXT64($nl)), BV64_ADD($c1.0$1, $c3.0$1)), 32, 0)]);
    $$F[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2)), 32, 0)] := (if p9$2 then 0 else $$F[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v2$2, $c0.0$2), BV32_SEXT64($nl)), BV64_ADD($c1.0$2, $c3.0$2)), 32, 0)]);
