...
implementation {:source_name "kernel2"} {:kernel} $kernel2($nl: int, $nj: int, $nm: int, $nk: int, $ni: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b25 ==> _WRITE_HAS_OCCURRED_$$G ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
  ...
  $4:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b27 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$4 == _WRITE_HAS_OCCURRED_$$G;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b26 ==> _WRITE_HAS_OCCURRED_$$G ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p4"} {:dominator_predicate "p3"} true;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni));
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p5$1 ==> _WRITE_HAS_OCCURRED_$$G$ghost$$6 == _WRITE_HAS_OCCURRED_$$G;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _WRITE_HAS_OCCURRED_$$G ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p6"} {:dominator_predicate "p5"} true;
    assert p6$1 ==> p4$1;
    assert p6$2 ==> p4$2;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$G ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $0$1) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $0$2) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b20 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b20 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($ni)) && BV64_SGE(BV32_SEXT64($ni), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl));
