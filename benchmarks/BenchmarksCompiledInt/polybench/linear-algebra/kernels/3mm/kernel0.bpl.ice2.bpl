...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$F ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p3$1 ==> _WRITE_HAS_OCCURRED_$$F$ghost$$4 == _WRITE_HAS_OCCURRED_$$F ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $c1.0$1 mod 8192 == BV64_MUL(32, v1$1) mod 8192 )  && ( p4$2 ==> $c1.0$2 mod 8192 == BV64_MUL(32, v1$2) mod 8192 ) ,  ( p4$1 ==> BV32_SLE($c1.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_SLE($c1.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_SGE($c1.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_SGE($c1.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_ULE($c1.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_ULE($c1.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> BV32_UGE($c1.0$1, BV64_MUL(32, v1$1)) )  && ( p4$2 ==> BV32_UGE($c1.0$2, BV64_MUL(32, v1$2)) ) ,  ( p4$1 ==> p4$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) )  && ( p4$2 ==> p4$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) ==> p4$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) ==> p4$2 ) ,  (  _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) ) ,  (  _WRITE_HAS_OCCURRED_$$F ==> BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$F ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p5$1 ==> _WRITE_HAS_OCCURRED_$$F$ghost$$6 == _WRITE_HAS_OCCURRED_$$F )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p6$1 ==> $c3.0$1 mod 16 == v3$1 mod 16 )  && ( p6$2 ==> $c3.0$2 mod 16 == v3$2 mod 16 ) ,  ( p6$1 ==> BV32_SLE($c3.0$1, v3$1) )  && ( p6$2 ==> BV32_SLE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV32_SGE($c3.0$1, v3$1) )  && ( p6$2 ==> BV32_SGE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV32_ULE($c3.0$1, v3$1) )  && ( p6$2 ==> BV32_ULE($c3.0$2, v3$2) ) ,  ( p6$1 ==> BV32_UGE($c3.0$1, v3$1) )  && ( p6$2 ==> BV32_UGE($c3.0$2, v3$2) ) ,  ( p6$1 ==> p6$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) )  && ( p6$2 ==> p6$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) && BV64_SLT($c1.0$1, BV32_SEXT64($nl)) && BV64_SLE($c3.0$1, $0$1) ==> p6$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($nj)) && BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c0.0$2), 1)) && BV64_SLT($c1.0$2, BV32_SEXT64($nl)) && BV64_SLE($c3.0$2, $0$2) ==> p6$2 ) ,  (  _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c0.0$1, BV32_SEXT64($nj)) ) ,  (  _WRITE_HAS_OCCURRED_$$F ==> BV64_SGE(BV32_SEXT64($nj), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c0.0$1), 1)) ) ,  (  _WRITE_HAS_OCCURRED_$$F ==> BV64_SLT($c1.0$1, BV32_SEXT64($nl)) ) ,  true ,  true ,  true ,  true ,  true  ); 
