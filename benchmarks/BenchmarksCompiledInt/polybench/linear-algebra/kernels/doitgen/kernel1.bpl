...
var {:source_name "shared_A"} {:group_shared} $$kernel1.shared_A: [bv1][int]int;
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($np: int, $nq: int, $nr: int, $c0: int, $c1: int)
{
  var $c2.0$1: int;
  var $c2.0$2: int;
  var $c3.0$1: int;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b52 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b51 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b50 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "noread"} _b49 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b48 ==> _WRITE_HAS_OCCURRED_$$sum ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b47 ==> _READ_HAS_OCCURRED_$$sum ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b46 ==> !_WRITE_HAS_OCCURRED_$$sum;
    assert {:tag "noread"} _b45 ==> !_READ_HAS_OCCURRED_$$sum;
    ...
    assert {:tag "predicatedEquality"} _b37 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b36 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b35 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b34 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b33 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b32 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b30 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b29 ==> p0$1 && p0$2 ==> $c5.0$1 == $c5.0$2;
    assert {:tag "predicatedEquality"} _b28 ==> p0$1 && p0$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "predicatedEquality"} _b27 ==> p0$1 && p0$2 ==> $c2.0$1 == $c2.0$2;
    ...
    v4$1 := (if p1$1 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$1, $c2.0$1), 1)) else v4$1);
    v4$2 := (if p1$2 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$2, $c2.0$2), 1)) else v4$2);
    p3$1 := (if p1$1 && v4$1 then v4$1 else p3$1);
    p3$2 := (if p1$2 && v4$2 then v4$2 else p3$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_READ_$$sum(p3$1, BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0), $$sum[BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_READ_$$sum(p3$2, BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0), $$sum[BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sum"} true;
    v5$1 := (if p3$1 then $$sum[BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0)] else v5$1);
    v5$2 := (if p3$2 then $$sum[BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0)] else v5$2);
    $$private_sum$0$1 := (if p3$1 then v5$1 else $$private_sum$0$1);
    $$private_sum$0$2 := (if p3$2 then v5$2 else $$private_sum$0$2);
    $c3.0$1 := (if p1$1 then 0 else $c3.0$1);
    $c3.0$2 := (if p1$2 then 0 else $c3.0$2);
  ...
  __partitioned_block_$5_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b72 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$5_0 == _WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "disabledMaintainsInstrumentation"} _b71 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$__partitioned_block_$5_0 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b70 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b68 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "noread"} _b67 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "predicatedEquality"} _b66 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b65 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b64 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b63 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b62 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b61 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b60 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b59 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b58 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b57 ==> p4$1 && p4$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b56 ==> p4$1 && p4$2 ==> $c5.0$1 == $c5.0$2;
    assert {:tag "predicatedEquality"} _b55 ==> p4$1 && p4$2 ==> $c3.0$1 == $c3.0$2;
    assert {:tag "loopPredicateEquality"} _b54 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b53 ==> p4$1 == p4$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b11 ==> p4$1 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b11 ==> p4$2 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b10 ==> BV32_UGE($c3.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b10 ==> BV32_UGE($c3.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b9 ==> BV32_ULE($c3.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b9 ==> BV32_ULE($c3.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b8 ==> BV32_SGE($c3.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b8 ==> BV32_SGE($c3.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b7 ==> BV32_SLE($c3.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b7 ==> BV32_SLE($c3.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b6 ==> $c3.0$1 mod 32 == 0 mod 32;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b6 ==> $c3.0$2 mod 32 == 0 mod 32;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 7} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0)), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $nq), $nr)) then 1 else 0))), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $nq)) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_x$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 32) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 6} {:thread 1} (if _READ_HAS_OCCURRED_$$C4 ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 5} {:thread 1} (if _READ_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 4} {:thread 1} (if _WRITE_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    ...
    v7$1 := (if p5$1 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$1, $c3.0$1), 1)) else v7$1);
    v7$2 := (if p5$2 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$2, $c3.0$2), 1)) else v7$2);
  ...
  __partitioned_block_$5_1:
    call {:sourceloc_num 21} $bugle_barrier_duplicated_1(-1, -1, p5$1, p5$2);
    v9$1 := (if p5$1 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$1, $c2.0$1), 1)) else v9$1);
    v9$2 := (if p5$2 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$2, $c2.0$2), 1)) else v9$2);
    p9$1 := (if p5$1 && v9$1 then v9$1 else p9$1);
    p9$2 := (if p5$2 && v9$2 then v9$2 else p9$2);
    $c5.0$1 := (if p9$1 then 0 else $c5.0$1);
    $c5.0$2 := (if p9$2 then 0 else $c5.0$2);
  ...
  $10:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b74 ==> !p9$1 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A$ghost$$10 == _READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b73 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c3.0$1, BV32_SEXT64($np));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> BV64_SLT($c2.0$1, BV32_SEXT64($np));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1)) && BV64_SLE($c5.0$1, $0$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c2.0$2), 1)) && BV64_SLE($c5.0$2, $0$2) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b20 ==> p10$1 ==> BV64_SLT($c2.0$1, BV32_SEXT64($np)) && BV64_SLT($c3.0$1, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$1), $c2.0$1), 1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b20 ==> p10$2 ==> BV64_SLT($c2.0$2, BV32_SEXT64($np)) && BV64_SLT($c3.0$2, BV32_SEXT64($np)) && BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(BV32_ZEXT64(local_id_x$2), $c2.0$2), 1));
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b19 ==> BV32_UGE($c5.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b19 ==> BV32_UGE($c5.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b18 ==> BV32_ULE($c5.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b18 ==> BV32_ULE($c5.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b17 ==> BV32_SGE($c5.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b17 ==> BV32_SGE($c5.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b16 ==> BV32_SLE($c5.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b16 ==> BV32_SLE($c5.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p10$1 ==> _b15 ==> $c5.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p10$2 ==> _b15 ==> $c5.0$2 mod 1 == 0 mod 1;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 7} {:thread 1} (if _READ_HAS_OCCURRED_$$A ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0)), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if $c0 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $nq), $nr)) then 1 else 0))), BV1_ZEXT32((if $c1 == BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $nq)) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_x$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 32) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 6} {:thread 1} (if _READ_HAS_OCCURRED_$$C4 ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 5} {:thread 1} (if _READ_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 4} {:thread 1} (if _WRITE_HAS_OCCURRED_$$sum ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($np, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np), 0) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $np))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:block_sourceloc} {:sourceloc_num 23} p10$1 ==> true;
    v10$1 := (if p10$1 then BV64_SLT(31, BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$1), 1)) else v10$1);
    v10$2 := (if p10$2 then BV64_SLT(31, BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$2), 1)) else v10$2);
    p11$1 := false;
    p11$2 := false;
    p12$1 := false;
    p12$2 := false;
    ...
    $0$1 := (if p11$1 then BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$1), 1) else $0$1);
    $0$2 := (if p11$2 then BV64_SUB(BV64_SUB(BV32_SEXT64($np), $c3.0$2), 1) else $0$2);
    ...
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$kernel1.shared_A(p13$1, BV_EXTRACT($c5.0$1, 32, 0), $$kernel1.shared_A[1bv1][BV_EXTRACT($c5.0$1, 32, 0)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$kernel1.shared_A(p13$2, BV_EXTRACT($c5.0$2, 32, 0), $$kernel1.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($c5.0$2, 32, 0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel1.shared_A"} true;
    v12$1 := (if p13$1 then $$kernel1.shared_A[1bv1][BV_EXTRACT($c5.0$1, 32, 0)] else v12$1);
    v12$2 := (if p13$2 then $$kernel1.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV_EXTRACT($c5.0$2, 32, 0)] else v12$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v13$1 := (if p13$1 then _HAVOC_int$1 else v13$1);
    v13$2 := (if p13$2 then _HAVOC_int$2 else v13$2);
    v14$1 := (if p13$1 then $$private_sum$0$1 else v14$1);
    v14$2 := (if p13$2 then $$private_sum$0$2 else v14$2);
    $$private_sum$0$1 := (if p13$1 then FADD64(v14$1, FMUL64(v12$1, v13$1)) else $$private_sum$0$1);
    $$private_sum$0$2 := (if p13$2 then FADD64(v14$2, FMUL64(v12$2, v13$2)) else $$private_sum$0$2);
    $c5.0$1 := (if p13$1 then BV64_ADD($c5.0$1, 1) else $c5.0$1);
    $c5.0$2 := (if p13$2 then BV64_ADD($c5.0$2, 1) else $c5.0$2);
  ...
  __partitioned_block_$10.tail_1:
    call {:sourceloc_num 35} $bugle_barrier_duplicated_2(-1, -1, p5$1, p5$2);
    $c3.0$1 := (if p5$1 then BV64_ADD($c3.0$1, 32) else $c3.0$1);
    $c3.0$2 := (if p5$2 then BV64_ADD($c3.0$2, 32) else $c3.0$2);
  ...
  __partitioned_block_$5.tail_0:
    assume !p4$1 && !p4$2;
    v15$1 := (if p1$1 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$1, $c2.0$1), 1)) else v15$1);
    v15$2 := (if p1$2 then BV64_SGE(BV32_SEXT64($np), BV64_ADD(BV64_ADD(v2$2, $c2.0$2), 1)) else v15$2);
    p15$1 := (if p1$1 && v15$1 then v15$1 else p15$1);
    p15$2 := (if p1$2 && v15$2 then v15$2 else p15$2);
    v16$1 := (if p15$1 then $$private_sum$0$1 else v16$1);
    v16$2 := (if p15$2 then $$private_sum$0$2 else v16$2);
    call {:sourceloc} {:sourceloc_num 40} _LOG_WRITE_$$sum(p15$1, BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0), v16$1, $$sum[BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$sum(p15$2, BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 40} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 40} _CHECK_WRITE_$$sum(p15$2, BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0), v16$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sum"} true;
    $$sum[BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0)] := (if p15$1 then v16$1 else $$sum[BV_EXTRACT(BV64_ADD(v2$1, $c2.0$1), 32, 0)]);
    $$sum[BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0)] := (if p15$2 then v16$2 else $$sum[BV_EXTRACT(BV64_ADD(v2$2, $c2.0$2), 32, 0)]);
    goto __partitioned_block_$5.tail_1;

  __partitioned_block_$5.tail_1:
    call {:sourceloc_num 42} $bugle_barrier_duplicated_0(-1, -1, p1$1, p1$2);
...
var $$private_sum$0$1: int;

var $$private_sum$0$2: int;
...
const _WATCHED_VALUE_$$C4: int;

procedure {:inline 1} _LOG_READ_$$C4(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$C4;



implementation {:inline 1} _LOG_READ_$$C4(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$C4(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$C4(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$C4, _WRITE_READ_BENIGN_FLAG_$$C4;



implementation {:inline 1} _LOG_WRITE_$$C4(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$C4(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$C4(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$C4;



implementation {:inline 1} _LOG_ATOMIC_$$C4(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$C4(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$C4(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$C4;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$C4(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$kernel1.shared_A: int;

procedure {:inline 1} _LOG_READ_$$kernel1.shared_A(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$kernel1.shared_A;



implementation {:inline 1} _LOG_READ_$$kernel1.shared_A(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$kernel1.shared_A(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$kernel1.shared_A(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$kernel1.shared_A, _WRITE_READ_BENIGN_FLAG_$$kernel1.shared_A;



implementation {:inline 1} _LOG_WRITE_$$kernel1.shared_A(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$kernel1.shared_A(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$kernel1.shared_A(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A;



implementation {:inline 1} _LOG_ATOMIC_$$kernel1.shared_A(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$kernel1.shared_A(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel1.shared_A(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$kernel1.shared_A;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel1.shared_A(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$kernel1.shared_A;
    goto anon1;
  ...
  anon3:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_READ_HAS_OCCURRED_$$sum;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$sum;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$sum;
    goto anon4;
