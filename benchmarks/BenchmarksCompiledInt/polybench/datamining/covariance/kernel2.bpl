...
implementation {:source_name "kernel2"} {:kernel} $kernel2($m: int, $n: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _WRITE_HAS_OCCURRED_$$cov ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b25 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$cov$ghost$$3 == _WRITE_HAS_OCCURRED_$$cov;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b24 ==> _WRITE_HAS_OCCURRED_$$cov ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p2"} {:dominator_predicate "p1"} true;
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _WRITE_HAS_OCCURRED_$$cov ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($m)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($m)) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b11 ==> p2$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b11 ==> p2$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b10 ==> BV32_UGE($c1.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c0.0$1), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b10 ==> BV32_UGE($c1.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c0.0$2), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b9 ==> BV32_ULE($c1.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c0.0$1), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b9 ==> BV32_ULE($c1.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c0.0$2), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b8 ==> BV32_SGE($c1.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c0.0$1), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b8 ==> BV32_SGE($c1.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c0.0$2), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b7 ==> BV32_SLE($c1.0$1, BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c0.0$1), 8160), 8192))));
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b7 ==> BV32_SLE($c1.0$2, BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c0.0$2), 8160), 8192))));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b6 ==> $c1.0$1 mod 8192 == BV64_ADD(BV64_MUL(32, v1$1), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$1), $c0.0$1), 8160), 8192))) mod 8192;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b6 ==> $c1.0$2 mod 8192 == BV64_ADD(BV64_MUL(32, v1$2), BV64_MUL(8192, BV64_SDIV(BV64_ADD(BV64_ADD(BV64_MUL(-32, v1$2), $c0.0$2), 8160), 8192))) mod 8192;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$cov ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 8191) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($m, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m)) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 8192)), BV64_MUL(32, BV32_ZEXT64(group_id_y$1))) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_y$1)), 31), BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 8192))) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m))), 8192) == 0 then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_y$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m))), 16) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
  ...
  $14:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b27 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$cov$ghost$$14 == _WRITE_HAS_OCCURRED_$$cov;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b26 ==> _WRITE_HAS_OCCURRED_$$cov ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assume {:predicate "p10"} {:dominator_predicate "p3"} true;
    assert p10$1 ==> p2$1;
    assert p10$2 ==> p2$2;
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$cov ==> BV64_SLT($c1.0$1, BV32_SEXT64($m));
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($m)) && BV64_SLE($c3.0$1, $3$1) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($m)) && BV64_SLE($c3.0$2, $3$2) ==> p10$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b19 ==> p10$1 ==> BV64_SLT($c0.0$1, BV32_SEXT64($m)) && BV64_SLT($c1.0$1, BV32_SEXT64($m));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b19 ==> p10$2 ==> BV64_SLT($c0.0$2, BV32_SEXT64($m)) && BV64_SLT($c1.0$2, BV32_SEXT64($m));
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b18 ==> BV32_UGE($c3.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b18 ==> BV32_UGE($c3.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b17 ==> BV32_ULE($c3.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b17 ==> BV32_ULE($c3.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b16 ==> BV32_SGE($c3.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b16 ==> BV32_SGE($c3.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b15 ==> BV32_SLE($c3.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b15 ==> BV32_SLE($c3.0$2, $1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p10$1 ==> _b14 ==> $c3.0$1 mod 16 == $1$1 mod 16;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p10$2 ==> _b14 ==> $c3.0$2 mod 16 == $1$2 mod 16;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$cov ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 8191) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($m, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 1)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m)) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 8192)), BV64_MUL(32, BV32_ZEXT64(group_id_y$1))) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_y$1)), 31), BV32_ZEXT64(BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), 8192))) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m), $m))), 8192) == 0 then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV32_ZEXT64(local_id_y$1), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), $m))), 16) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
