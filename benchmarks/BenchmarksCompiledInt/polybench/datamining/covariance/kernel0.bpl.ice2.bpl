...
assert  my_inv (  ( p0$1 ==> $c0.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c0.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($m)) ==> p0$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($m)) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$mean ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$mean(p3$1, BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0), 0, $$mean[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$mean(p3$2, BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0), 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$mean"} true;
    $$mean[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)] := (if p3$1 then 0 else $$mean[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)]);
    $$mean[BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0)] := (if p3$2 then 0 else $$mean[BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0)]);
