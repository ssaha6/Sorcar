...
procedure {:source_name "kernel1"} {:kernel} $kernel1($m: int, $n: int);
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($m: int, $n: int)
{
  var $c0.0$1: int;
  var $c0.0$2: int;
  var v0$1: int;
...
assert  my_inv (  ( p0$1 ==> $c0.0$1 mod 1048576 == BV64_MUL(32, v0$1) mod 1048576 )  && ( p0$2 ==> $c0.0$2 mod 1048576 == BV64_MUL(32, v0$2) mod 1048576 ) ,  ( p0$1 ==> BV32_SLE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SLE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_SGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_SGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_ULE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_ULE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  ( p0$1 ==> BV32_UGE($c0.0$1, BV64_MUL(32, v0$1)) )  && ( p0$2 ==> BV32_UGE($c0.0$2, BV64_MUL(32, v0$2)) ) ,  (  BV64_SLT($c0.0$1, BV32_SEXT64($m)) ==> p0$1 )  && (  BV64_SLT($c0.0$2, BV32_SEXT64($m)) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$stddev ==> _WATCHED_OFFSET mod 1 == 0 mod 1 )  ); 
    ...
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$stddev(p3$1, BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0), 0, $$stddev[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$stddev(p3$2, BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0), 0);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$stddev"} true;
    $$stddev[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)] := (if p3$1 then 0 else $$stddev[BV_EXTRACT(BV64_ADD(v1$1, $c0.0$1), 32, 0)]);
    $$stddev[BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0)] := (if p3$2 then 0 else $$stddev[BV_EXTRACT(BV64_ADD(v1$2, $c0.0$2), 32, 0)]);
