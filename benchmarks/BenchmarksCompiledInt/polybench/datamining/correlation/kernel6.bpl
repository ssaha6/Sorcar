...
implementation {:source_name "kernel6"} {:kernel} $kernel6($m: bv32, $n: bv32)
{
  ...
  $1:
    ...
    assert {:tag "predicatedEquality"} _b112 ==> p0$1 && p0$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b111 ==> p0$1 && p0$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b110 ==> p0$1 && p0$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b109 ==> p0$1 && p0$2 ==> v39$1 == v39$2;
  ...
  $3:
    ...
    assert {:tag "predicatedEquality"} _b162 ==> p2$1 && p2$2 ==> v40$1 == v40$2;
