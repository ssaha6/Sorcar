...
procedure {:source_name "kernel8"} {:kernel} $kernel8($m: int, $n: int);
  requires {:sourceloc_num 0} {:thread 1} (if $m == 512 then 1 else 0) != 0;
  requires {:sourceloc_num 1} {:thread 1} (if $n == 1024 then 1 else 0) != 0;
  requires {:sourceloc_num 2} {:thread 1} (if BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SGE($m, 2) then 1 else 0)), BV1_ZEXT32((if BV32_SLE($m, 2147483647) then 1 else 0))), BV1_ZEXT32((if BV32_SLE($n, 2147483647) then 1 else 0))), BV1_ZEXT32((if BV64_SGE(BV32_SEXT64($n), -2147483648) then 1 else 0))) != 0 then 1 else 0) != 0;
  requires {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$corr ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($m, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)), 2)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)) == BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
...
implementation {:source_name "kernel8"} {:kernel} $kernel8($m: int, $n: int)
{
  var $c0.0$1: int;
  var $c0.0$2: int;
  var $0$1: int;
  ...
  $1:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV64_SLT($c0.0$1, BV32_SEXT64(BV32_SUB($m, 1))) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV64_SLT($c0.0$2, BV32_SEXT64(BV32_SUB($m, 1))) ==> p0$2;
    ...
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$corr ==> BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV32_AND(BV1_ZEXT32((if BV64_SGE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 0) then 1 else 0)), BV1_ZEXT32((if BV64_SLE(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), 1048575) then 1 else 0))), BV1_ZEXT32((if BV32_UGE($m, BV32_ADD(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)), 2)) then 1 else 0))), BV1_ZEXT32((if BV32_UGE(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)), 0) then 1 else 0))), BV1_ZEXT32((if BV32_UREM(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)) == BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)) then 1 else 0))), BV1_ZEXT32((if BV64_SREM(BV64_SUB(BV64_ADD(BV64_MUL(32, BV32_ZEXT64(group_id_x$1)), BV32_ZEXT64(local_id_x$1)), BV32_ZEXT64(BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(8, _WATCHED_OFFSET), 8), (if BV32_SGE($m, 2) then $m else 1)), (if BV32_SGE($m, 2) then $m else 1)))), 1048576) == 0 then 1 else 0))) != 0 then 1 else 0) != 0;
    assert {:block_sourceloc} {:sourceloc_num 5} p0$1 ==> true;
    v2$1 := (if p0$1 then BV64_SLT($c0.0$1, BV32_SEXT64(BV32_SUB($m, 1))) else v2$1);
    v2$2 := (if p0$2 then BV64_SLT($c0.0$2, BV32_SEXT64(BV32_SUB($m, 1))) else v2$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
    ...
    v3$1 := (if p1$1 then BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(v1$1, $c0.0$1), 2)) else v3$1);
    v3$2 := (if p1$2 then BV64_SGE(BV32_SEXT64($m), BV64_ADD(BV64_ADD(v1$2, $c0.0$2), 2)) else v3$2);
    p3$1 := (if p1$1 && v3$1 then v3$1 else p3$1);
    p3$2 := (if p1$2 && v3$2 then v3$2 else p3$2);
    v4$1 := (if p3$1 then BV32_SGE($m, 2) else v4$1);
    v4$2 := (if p3$2 then BV32_SGE($m, 2) else v4$2);
    ...
    $0$1 := (if p4$1 then 1 else $0$1);
    $0$2 := (if p4$2 then 1 else $0$2);
    $0$1 := (if p5$1 then $m else $0$1);
    $0$2 := (if p5$2 then $m else $0$2);
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$corr(p3$1, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($0$1)), BV64_ADD(v1$1, $c0.0$1)), 32, 0), 4607182418800017408, $$corr[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($0$1)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$corr(p3$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($0$2)), BV64_ADD(v1$2, $c0.0$2)), 32, 0));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$corr(p3$2, BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($0$2)), BV64_ADD(v1$2, $c0.0$2)), 32, 0), 4607182418800017408);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$corr"} true;
    $$corr[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($0$1)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)] := (if p3$1 then 4607182418800017408 else $$corr[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$1, $c0.0$1), BV32_SEXT64($0$1)), BV64_ADD(v1$1, $c0.0$1)), 32, 0)]);
    $$corr[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($0$2)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)] := (if p3$2 then 4607182418800017408 else $$corr[BV_EXTRACT(BV64_ADD(BV64_MUL(BV64_ADD(v1$2, $c0.0$2), BV32_SEXT64($0$2)), BV64_ADD(v1$2, $c0.0$2)), 32, 0)]);
