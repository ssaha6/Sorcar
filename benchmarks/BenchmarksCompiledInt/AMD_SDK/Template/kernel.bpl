...
procedure {:source_name "templateKernel"} {:kernel} $templateKernel($multiplier: int);
...
implementation {:source_name "templateKernel"} {:kernel} $templateKernel($multiplier: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
