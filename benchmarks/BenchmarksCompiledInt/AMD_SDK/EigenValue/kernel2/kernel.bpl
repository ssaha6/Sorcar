...
implementation {:source_name "recalculateEigenIntervals"} {:kernel} $recalculateEigenIntervals($width: int, $tolerance: int)
{
  var $currentIndex.0$1: int;
  var $currentIndex.0$2: int;
  var $index.0$1: int;
  var $index.0$2: int;
  var $count.i.0$1: int;
  var $count.i.0$2: int;
  var $prev_diff.i.0$1: int;
  var $prev_diff.i.0$2: int;
  var $i.i.0$1: int;
  var $i.i.0$2: int;
  var $i.i3.0$1: int;
  var $i.i3.0$2: int;
  var $prev_diff.i2.0$1: int;
  var $prev_diff.i2.0$2: int;
  var $count.i1.0$1: int;
  var $count.i1.0$2: int;
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  var v1$2: int;
  ...
  $0:
    ...
    v1$1 := BV32_MUL(2, v0$1);
    v1$2 := BV32_MUL(2, v0$2);
    v2$1 := BV32_ADD(v1$1, 1);
    v2$2 := BV32_ADD(v1$2, 1);
    $currentIndex.0$1, $index.0$1 := v0$1, 0;
    $currentIndex.0$2, $index.0$2 := v0$2, 0;
    p0$1 := false;
    p0$2 := false;
    p4$1 := false;
    p4$2 := false;
  ...
  $1:
    ...
    $currentIndex.0$1, $index.0$1 := (if p1$1 then BV32_SUB($currentIndex.0$1, v5$1) else $currentIndex.0$1), (if p1$1 then BV32_ADD($index.0$1, 1) else $index.0$1);
    $currentIndex.0$2, $index.0$2 := (if p1$2 then BV32_SUB($currentIndex.0$2, v5$2) else $currentIndex.0$2), (if p1$2 then BV32_ADD($index.0$2, 1) else $index.0$2);
  ...
  $1.tail:
    assume !p0$1 && !p0$2;
    v6$1 := BV32_MUL(2, $index.0$1);
    v6$2 := BV32_MUL(2, $index.0$2);
    v7$1 := BV32_ADD(v6$1, 1);
    v7$2 := BV32_ADD(v6$2, 1);
    ...
    v12$1 := (if p3$1 then FDIV32(FADD32(v10$1, v11$1), 1073741824) else v12$1);
    v12$2 := (if p3$2 then FDIV32(FADD32(v10$2, v11$2), 1073741824) else v12$2);
    v13$1 := (if p3$1 then $$diagonal[0] else v13$1);
    v13$2 := (if p3$2 then $$diagonal[0] else v13$2);
    v14$1 := (if p3$1 then FSUB32(v13$1, v12$1) else v14$1);
    v14$2 := (if p3$2 then FSUB32(v13$2, v12$2) else v14$2);
    $count.i.0$1, $prev_diff.i.0$1, $i.i.0$1 := (if p3$1 then (if FLT32(v14$1, 0) then 1 else 0) else $count.i.0$1), (if p3$1 then v14$1 else $prev_diff.i.0$1), (if p3$1 then 1 else $i.i.0$1);
    $count.i.0$2, $prev_diff.i.0$2, $i.i.0$2 := (if p3$2 then (if FLT32(v14$2, 0) then 1 else 0) else $count.i.0$2), (if p3$2 then v14$2 else $prev_diff.i.0$2), (if p3$2 then 1 else $i.i.0$2);
  ...
  $5:
    ...
    v17$1 := (if p5$1 then $$offDiagonal[BV32_SUB($i.i.0$1, 1)] else v17$1);
    v17$2 := (if p5$2 then $$offDiagonal[BV32_SUB($i.i.0$2, 1)] else v17$2);
    v18$1 := (if p5$1 then $$offDiagonal[BV32_SUB($i.i.0$1, 1)] else v18$1);
    v18$2 := (if p5$2 then $$offDiagonal[BV32_SUB($i.i.0$2, 1)] else v18$2);
    ...
    $count.i.0$1, $prev_diff.i.0$1, $i.i.0$1 := (if p5$1 then BV32_ADD($count.i.0$1, (if FLT32(v19$1, 0) then 1 else 0)) else $count.i.0$1), (if p5$1 then v19$1 else $prev_diff.i.0$1), (if p5$1 then BV32_ADD($i.i.0$1, 1) else $i.i.0$1);
    $count.i.0$2, $prev_diff.i.0$2, $i.i.0$2 := (if p5$2 then BV32_ADD($count.i.0$2, (if FLT32(v19$2, 0) then 1 else 0)) else $count.i.0$2), (if p5$2 then v19$2 else $prev_diff.i.0$2), (if p5$2 then BV32_ADD($i.i.0$2, 1) else $i.i.0$2);
  ...
  $5.tail:
    ...
    v21$1 := (if p3$1 then $$diagonal[0] else v21$1);
    v21$2 := (if p3$2 then $$diagonal[0] else v21$2);
    v22$1 := (if p3$1 then FSUB32(v21$1, v20$1) else v22$1);
    v22$2 := (if p3$2 then FSUB32(v21$2, v20$2) else v22$2);
    $i.i3.0$1, $prev_diff.i2.0$1, $count.i1.0$1 := (if p3$1 then 1 else $i.i3.0$1), (if p3$1 then v22$1 else $prev_diff.i2.0$1), (if p3$1 then (if FLT32(v22$1, 0) then 1 else 0) else $count.i1.0$1);
    $i.i3.0$2, $prev_diff.i2.0$2, $count.i1.0$2 := (if p3$2 then 1 else $i.i3.0$2), (if p3$2 then v22$2 else $prev_diff.i2.0$2), (if p3$2 then (if FLT32(v22$2, 0) then 1 else 0) else $count.i1.0$2);
  ...
  $7:
    ...
    v25$1 := (if p7$1 then $$offDiagonal[BV32_SUB($i.i3.0$1, 1)] else v25$1);
    v25$2 := (if p7$2 then $$offDiagonal[BV32_SUB($i.i3.0$2, 1)] else v25$2);
    v26$1 := (if p7$1 then $$offDiagonal[BV32_SUB($i.i3.0$1, 1)] else v26$1);
    v26$2 := (if p7$2 then $$offDiagonal[BV32_SUB($i.i3.0$2, 1)] else v26$2);
    ...
    $i.i3.0$1, $prev_diff.i2.0$1, $count.i1.0$1 := (if p7$1 then BV32_ADD($i.i3.0$1, 1) else $i.i3.0$1), (if p7$1 then v27$1 else $prev_diff.i2.0$1), (if p7$1 then BV32_ADD($count.i1.0$1, (if FLT32(v27$1, 0) then 1 else 0)) else $count.i1.0$1);
    $i.i3.0$2, $prev_diff.i2.0$2, $count.i1.0$2 := (if p7$2 then BV32_ADD($i.i3.0$2, 1) else $i.i3.0$2), (if p7$2 then v27$2 else $prev_diff.i2.0$2), (if p7$2 then BV32_ADD($count.i1.0$2, (if FLT32(v27$2, 0) then 1 else 0)) else $count.i1.0$2);
  ...
  $7.tail:
    ...
    v33$1 := (if p9$1 then FEQ32(FSUB32(UI32_TO_FP32($count.i.0$1), UI32_TO_FP32($count.i1.0$1)), 0) else v33$1);
    v33$2 := (if p9$2 then FEQ32(FSUB32(UI32_TO_FP32($count.i.0$2), UI32_TO_FP32($count.i1.0$2)), 0) else v33$2);
...
const _WATCHED_VALUE_$$newEigenIntervals: int;

procedure {:inline 1} _LOG_READ_$$newEigenIntervals(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$newEigenIntervals;



implementation {:inline 1} _LOG_READ_$$newEigenIntervals(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$newEigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$newEigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$newEigenIntervals, _WRITE_READ_BENIGN_FLAG_$$newEigenIntervals;



implementation {:inline 1} _LOG_WRITE_$$newEigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$newEigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$newEigenIntervals(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$newEigenIntervals;



implementation {:inline 1} _LOG_ATOMIC_$$newEigenIntervals(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$newEigenIntervals(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$newEigenIntervals(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$newEigenIntervals;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$newEigenIntervals(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$eigenIntervals: int;

procedure {:inline 1} _LOG_READ_$$eigenIntervals(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$eigenIntervals;



implementation {:inline 1} _LOG_READ_$$eigenIntervals(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$eigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$eigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$eigenIntervals, _WRITE_READ_BENIGN_FLAG_$$eigenIntervals;



implementation {:inline 1} _LOG_WRITE_$$eigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$eigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$eigenIntervals(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$eigenIntervals;



implementation {:inline 1} _LOG_ATOMIC_$$eigenIntervals(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$eigenIntervals(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$eigenIntervals(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$eigenIntervals;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$eigenIntervals(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$numEigenIntervals: int;

procedure {:inline 1} _LOG_READ_$$numEigenIntervals(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$numEigenIntervals;



implementation {:inline 1} _LOG_READ_$$numEigenIntervals(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$numEigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$numEigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$numEigenIntervals, _WRITE_READ_BENIGN_FLAG_$$numEigenIntervals;



implementation {:inline 1} _LOG_WRITE_$$numEigenIntervals(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$numEigenIntervals(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$numEigenIntervals(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$numEigenIntervals;



implementation {:inline 1} _LOG_ATOMIC_$$numEigenIntervals(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$numEigenIntervals(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$numEigenIntervals(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$numEigenIntervals;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$numEigenIntervals(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$diagonal: int;

procedure {:inline 1} _LOG_READ_$$diagonal(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$diagonal;



implementation {:inline 1} _LOG_READ_$$diagonal(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$diagonal(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$diagonal(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$diagonal, _WRITE_READ_BENIGN_FLAG_$$diagonal;



implementation {:inline 1} _LOG_WRITE_$$diagonal(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$diagonal(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$diagonal(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$diagonal;



implementation {:inline 1} _LOG_ATOMIC_$$diagonal(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$diagonal(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$diagonal(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$diagonal;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$diagonal(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$offDiagonal: int;

procedure {:inline 1} _LOG_READ_$$offDiagonal(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$offDiagonal;



implementation {:inline 1} _LOG_READ_$$offDiagonal(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$offDiagonal(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$offDiagonal(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$offDiagonal, _WRITE_READ_BENIGN_FLAG_$$offDiagonal;



implementation {:inline 1} _LOG_WRITE_$$offDiagonal(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$offDiagonal(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$offDiagonal(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$offDiagonal;



implementation {:inline 1} _LOG_ATOMIC_$$offDiagonal(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$offDiagonal(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$offDiagonal(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$offDiagonal;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$offDiagonal(_P: bool, _offset: int)
{
