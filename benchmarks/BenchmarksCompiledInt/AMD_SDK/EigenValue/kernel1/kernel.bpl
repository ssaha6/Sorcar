...
implementation {:source_name "calNumEigenValueInterval"} {:kernel} $calNumEigenValueInterval($width: int)
{
  var $count.i.0$1: int;
  var $count.i.0$2: int;
  ...
  $0:
    ...
    $count.i.0$1, $prev_diff.i.0$1, $i.i.0 := (if FLT32(v5$1, 0) then 1 else 0), v5$1, 1;
    $count.i.0$2, $prev_diff.i.0$2 := (if FLT32(v5$2, 0) then 1 else 0), v5$2;
  ...
  $falsebb:
    ...
    $prev_diff.i2.0$1, $count.i1.0$1, $i.i3.0 := v12$1, (if FLT32(v12$1, 0) then 1 else 0), 1;
    $prev_diff.i2.0$2, $count.i1.0$2 := v12$2, (if FLT32(v12$2, 0) then 1 else 0);
  ...
  $truebb0:
    ...
    $prev_diff.i2.0$1, $count.i1.0$1, $i.i3.0 := v17$1, BV32_ADD($count.i1.0$1, (if FLT32(v17$1, 0) then 1 else 0)), BV32_ADD($i.i3.0, 1);
    $prev_diff.i2.0$2, $count.i1.0$2 := v17$2, BV32_ADD($count.i1.0$2, (if FLT32(v17$2, 0) then 1 else 0));
  ...
  $truebb:
    ...
    $count.i.0$1, $prev_diff.i.0$1, $i.i.0 := BV32_ADD($count.i.0$1, (if FLT32(v10$1, 0) then 1 else 0)), v10$1, BV32_ADD($i.i.0, 1);
    $count.i.0$2, $prev_diff.i.0$2 := BV32_ADD($count.i.0$2, (if FLT32(v10$2, 0) then 1 else 0)), v10$2;
