...
implementation {:source_name "write_kernel"} {:kernel} $write_kernel($ni: int, $val: int, $nk: int)
{
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _WRITE_HAS_OCCURRED_$$out ==> _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 1) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 2) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 3) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b5 ==> $idx.0$1 mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) mod BV32_MUL(group_size_x, num_groups_x);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b5 ==> $idx.0$2 mod BV32_MUL(group_size_x, num_groups_x) == BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) mod BV32_MUL(group_size_x, num_groups_x);
  ...
  $7:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _WRITE_HAS_OCCURRED_$$out ==> _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 1) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 2) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 4), 3) mod BV32_MUL(BV32_MUL(group_size_x, num_groups_x), 4);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($i.1, 0);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($i.1, 0);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($i.1, 0);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($i.1, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b10 ==> $i.1 mod 1 == 0 mod 1;
  ...
  $falsebb2:
    assume {:partition} !v3;
    $i.0, $idx.0$1 := BV32_ADD($i.1, 1), BV32_ADD($idx.0$1, BV32_MUL(group_size_x, num_groups_x));
  ...
  $truebb2:
    assume {:partition} v3;
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$out(true, BV32_MUL($idx.0$1, 4), $val, $$out[BV32_MUL($idx.0$1, 4)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$out(true, BV32_MUL($idx.0$2, 4), $val);
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4), 1), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4), 1)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4), 1), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL($idx.0$1, 4), 1)] := $val;
    $$out[BV32_ADD(BV32_MUL($idx.0$2, 4), 1)] := $val;
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4), 2), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4), 2)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4), 2), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL($idx.0$1, 4), 2)] := $val;
    $$out[BV32_ADD(BV32_MUL($idx.0$2, 4), 2)] := $val;
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4), 3), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4), 3)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4), 3), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
