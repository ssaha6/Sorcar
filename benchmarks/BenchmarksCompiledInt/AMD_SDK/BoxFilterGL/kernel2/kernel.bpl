...
implementation {:source_name "horizontalSAT0"} {:kernel} $horizontalSAT0($i: int, $r: int, $width: int)
{
  var $sum.0$1: int;
  var $sum.0$2: int;
  var $j.0$1: int;
  ...
  $0:
    ...
    v1$1 := BV32_ADD(v0$1, BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), $width));
    v1$2 := BV32_ADD(v0$2, BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), $width));
  ...
  $1:
    ...
    v4$1 := (if p1$1 then BV32_SLT(BV32_SUB(v0$1, BV32_MUL($j.0$1, v2)), 0) else v4$1);
    v4$2 := (if p1$2 then BV32_SLT(BV32_SUB(v0$2, BV32_MUL($j.0$2, v2)), 0) else v4$2);
    ...
    $sum.0$1, $j.0$1 := (if p2$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV32_ADD(BV_EXTRACT($sum.0$1, 128, 96), BV8_ZEXT32(v8$1)), BV32_ADD(BV_EXTRACT($sum.0$1, 96, 64), BV8_ZEXT32(v7$1))), BV32_ADD(BV_EXTRACT($sum.0$1, 64, 32), BV8_ZEXT32(v6$1))), BV32_ADD(BV_EXTRACT($sum.0$1, 32, 0), BV8_ZEXT32(v5$1))) else $sum.0$1), (if p2$1 then BV32_ADD($j.0$1, 1) else $j.0$1);
    $sum.0$2, $j.0$2 := (if p2$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV32_ADD(BV_EXTRACT($sum.0$2, 128, 96), BV8_ZEXT32(v8$2)), BV32_ADD(BV_EXTRACT($sum.0$2, 96, 64), BV8_ZEXT32(v7$2))), BV32_ADD(BV_EXTRACT($sum.0$2, 64, 32), BV8_ZEXT32(v6$2))), BV32_ADD(BV_EXTRACT($sum.0$2, 32, 0), BV8_ZEXT32(v5$2))) else $sum.0$2), (if p2$2 then BV32_ADD($j.0$2, 1) else $j.0$2);
  ...
  $1.tail:
    assume !p0$1 && !p0$2;
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$output(p3$1, BV32_MUL(v1$1, 4), BV_EXTRACT($sum.0$1, 32, 0), $$output[BV32_MUL(v1$1, 4)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p3$2, BV32_MUL(v1$2, 4));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$output(p3$2, BV32_MUL(v1$2, 4), BV_EXTRACT($sum.0$2, 32, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_MUL(v1$1, 4)] := (if p3$1 then BV_EXTRACT($sum.0$1, 32, 0) else $$output[BV32_MUL(v1$1, 4)]);
    $$output[BV32_MUL(v1$2, 4)] := (if p3$2 then BV_EXTRACT($sum.0$2, 32, 0) else $$output[BV32_MUL(v1$2, 4)]);
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$output(p3$1, BV32_ADD(BV32_MUL(v1$1, 4), 1), BV_EXTRACT($sum.0$1, 64, 32), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 1));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 1), BV_EXTRACT($sum.0$2, 64, 32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)] := (if p3$1 then BV_EXTRACT($sum.0$1, 64, 32) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 1)] := (if p3$2 then BV_EXTRACT($sum.0$2, 64, 32) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 1)]);
    call {:sourceloc} {:sourceloc_num 18} _LOG_WRITE_$$output(p3$1, BV32_ADD(BV32_MUL(v1$1, 4), 2), BV_EXTRACT($sum.0$1, 96, 64), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 18} _CHECK_WRITE_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 2), BV_EXTRACT($sum.0$2, 96, 64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)] := (if p3$1 then BV_EXTRACT($sum.0$1, 96, 64) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 2)] := (if p3$2 then BV_EXTRACT($sum.0$2, 96, 64) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 2)]);
    call {:sourceloc} {:sourceloc_num 19} _LOG_WRITE_$$output(p3$1, BV32_ADD(BV32_MUL(v1$1, 4), 3), BV_EXTRACT($sum.0$1, 128, 96), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 3));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 19} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 19} _CHECK_WRITE_$$output(p3$2, BV32_ADD(BV32_MUL(v1$2, 4), 3), BV_EXTRACT($sum.0$2, 128, 96));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)] := (if p3$1 then BV_EXTRACT($sum.0$1, 128, 96) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 3)] := (if p3$2 then BV_EXTRACT($sum.0$2, 128, 96) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 3)]);
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$output(p4$1, BV32_MUL(v1$1, 4), BV_EXTRACT($sum.0$1, 32, 0), $$output[BV32_MUL(v1$1, 4)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p4$2, BV32_MUL(v1$2, 4));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$output(p4$2, BV32_MUL(v1$2, 4), BV_EXTRACT($sum.0$2, 32, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_MUL(v1$1, 4)] := (if p4$1 then BV_EXTRACT($sum.0$1, 32, 0) else $$output[BV32_MUL(v1$1, 4)]);
    $$output[BV32_MUL(v1$2, 4)] := (if p4$2 then BV_EXTRACT($sum.0$2, 32, 0) else $$output[BV32_MUL(v1$2, 4)]);
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$output(p4$1, BV32_ADD(BV32_MUL(v1$1, 4), 1), BV_EXTRACT($sum.0$1, 64, 32), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 1));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 1), BV_EXTRACT($sum.0$2, 64, 32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)] := (if p4$1 then BV_EXTRACT($sum.0$1, 64, 32) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 1)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 1)] := (if p4$2 then BV_EXTRACT($sum.0$2, 64, 32) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 1)]);
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$output(p4$1, BV32_ADD(BV32_MUL(v1$1, 4), 2), BV_EXTRACT($sum.0$1, 96, 64), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 2));
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 2), BV_EXTRACT($sum.0$2, 96, 64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)] := (if p4$1 then BV_EXTRACT($sum.0$1, 96, 64) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 2)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 2)] := (if p4$2 then BV_EXTRACT($sum.0$2, 96, 64) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 2)]);
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$output(p4$1, BV32_ADD(BV32_MUL(v1$1, 4), 3), BV_EXTRACT($sum.0$1, 128, 96), $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 3));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$output(p4$2, BV32_ADD(BV32_MUL(v1$2, 4), 3), BV_EXTRACT($sum.0$2, 128, 96));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)] := (if p4$1 then BV_EXTRACT($sum.0$1, 128, 96) else $$output[BV32_ADD(BV32_MUL(v1$1, 4), 3)]);
    $$output[BV32_ADD(BV32_MUL(v1$2, 4), 3)] := (if p4$2 then BV_EXTRACT($sum.0$2, 128, 96) else $$output[BV32_ADD(BV32_MUL(v1$2, 4), 3)]);
    return;
