...
implementation {:source_name "binomial_options"} {:kernel} $binomial_options($numSteps: int)
{
  ...
  $13:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _WRITE_HAS_OCCURRED_$$callB ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _READ_HAS_OCCURRED_$$callB ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3) || _WATCHED_OFFSET == BV32_MUL(BV32_ADD(local_id_x$1, 1), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 3);
    assert {:tag "nowrite"} _b9 ==> !_WRITE_HAS_OCCURRED_$$callB;
    assert {:tag "noread"} _b8 ==> !_READ_HAS_OCCURRED_$$callB;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$callA ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b6 ==> _READ_HAS_OCCURRED_$$callA ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3) || _WATCHED_OFFSET == BV32_MUL(BV32_ADD(local_id_x$1, 1), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1), 4), 3);
    assert {:tag "nowrite"} _b5 ==> !_WRITE_HAS_OCCURRED_$$callA;
    assert {:tag "noread"} _b4 ==> !_READ_HAS_OCCURRED_$$callA;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($j.0, $numSteps);
