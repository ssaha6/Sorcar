...
assert  my_inv (  (  BV32_SLE($s.0, BV32_LSHR(group_size_x, 1)) ) ,  (  BV32_SGE($s.0, BV32_LSHR(group_size_x, 1)) ) ,  (  BV32_ULE($s.0, BV32_LSHR(group_size_x, 1)) ) ,  (  BV32_UGE($s.0, BV32_LSHR(group_size_x, 1)) ) ,  (  $s.0 == 0 || BV32_AND($s.0, BV32_SUB($s.0, 1)) == 0 ) ,  (  $s.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$sdata ) ,  (  !_WRITE_HAS_OCCURRED_$$sdata ) ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(BV32_ADD(0, local_id_x$1), 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_x$1), 4), 3) mod BV32_MUL(1, 4) || _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3) ) ,  (  _WRITE_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3) )  ); 
