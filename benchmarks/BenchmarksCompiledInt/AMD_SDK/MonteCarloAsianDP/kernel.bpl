...
implementation {:source_name "calPriceVega"} {:kernel} $calPriceVega($attrib.coerce0: int, $attrib.coerce1: int, $attrib.coerce2: int, $attrib.coerce3: int, $attrib.coerce4: int, $attrib.coerce5: int, $attrib.coerce6: int, $noOfSum: int, $width: int)
{
  ...
  $0:
    $$attrib$0$1 := BV_EXTRACT($attrib.coerce0, 64, 0);
    $$attrib$0$2 := BV_EXTRACT($attrib.coerce0, 64, 0);
    $$attrib$1$1 := BV_EXTRACT($attrib.coerce0, 128, 64);
    $$attrib$1$2 := BV_EXTRACT($attrib.coerce0, 128, 64);
    $$attrib$2$1 := BV_EXTRACT($attrib.coerce0, 192, 128);
    $$attrib$2$2 := BV_EXTRACT($attrib.coerce0, 192, 128);
    $$attrib$3$1 := BV_EXTRACT($attrib.coerce0, 256, 192);
    $$attrib$3$2 := BV_EXTRACT($attrib.coerce0, 256, 192);
    $$attrib$4$1 := BV_EXTRACT($attrib.coerce1, 64, 0);
    $$attrib$4$2 := BV_EXTRACT($attrib.coerce1, 64, 0);
    $$attrib$5$1 := BV_EXTRACT($attrib.coerce1, 128, 64);
    $$attrib$5$2 := BV_EXTRACT($attrib.coerce1, 128, 64);
    $$attrib$6$1 := BV_EXTRACT($attrib.coerce1, 192, 128);
    $$attrib$6$2 := BV_EXTRACT($attrib.coerce1, 192, 128);
    $$attrib$7$1 := BV_EXTRACT($attrib.coerce1, 256, 192);
    $$attrib$7$2 := BV_EXTRACT($attrib.coerce1, 256, 192);
    $$attrib$8$1 := BV_EXTRACT($attrib.coerce2, 64, 0);
    $$attrib$8$2 := BV_EXTRACT($attrib.coerce2, 64, 0);
    $$attrib$9$1 := BV_EXTRACT($attrib.coerce2, 128, 64);
    $$attrib$9$2 := BV_EXTRACT($attrib.coerce2, 128, 64);
    $$attrib$10$1 := BV_EXTRACT($attrib.coerce2, 192, 128);
    $$attrib$10$2 := BV_EXTRACT($attrib.coerce2, 192, 128);
    $$attrib$11$1 := BV_EXTRACT($attrib.coerce2, 256, 192);
    $$attrib$11$2 := BV_EXTRACT($attrib.coerce2, 256, 192);
    $$attrib$12$1 := BV_EXTRACT($attrib.coerce3, 64, 0);
    $$attrib$12$2 := BV_EXTRACT($attrib.coerce3, 64, 0);
    $$attrib$13$1 := BV_EXTRACT($attrib.coerce3, 128, 64);
    $$attrib$13$2 := BV_EXTRACT($attrib.coerce3, 128, 64);
    $$attrib$14$1 := BV_EXTRACT($attrib.coerce3, 192, 128);
    $$attrib$14$2 := BV_EXTRACT($attrib.coerce3, 192, 128);
    $$attrib$15$1 := BV_EXTRACT($attrib.coerce3, 256, 192);
    $$attrib$15$2 := BV_EXTRACT($attrib.coerce3, 256, 192);
    $$attrib$16$1 := BV_EXTRACT($attrib.coerce4, 64, 0);
    $$attrib$16$2 := BV_EXTRACT($attrib.coerce4, 64, 0);
    $$attrib$17$1 := BV_EXTRACT($attrib.coerce4, 128, 64);
    $$attrib$17$2 := BV_EXTRACT($attrib.coerce4, 128, 64);
    $$attrib$18$1 := BV_EXTRACT($attrib.coerce4, 192, 128);
    $$attrib$18$2 := BV_EXTRACT($attrib.coerce4, 192, 128);
    $$attrib$19$1 := BV_EXTRACT($attrib.coerce4, 256, 192);
    $$attrib$19$2 := BV_EXTRACT($attrib.coerce4, 256, 192);
    $$attrib$20$1 := BV_EXTRACT($attrib.coerce5, 64, 0);
    $$attrib$20$2 := BV_EXTRACT($attrib.coerce5, 64, 0);
    $$attrib$21$1 := BV_EXTRACT($attrib.coerce5, 128, 64);
    $$attrib$21$2 := BV_EXTRACT($attrib.coerce5, 128, 64);
    $$attrib$22$1 := BV_EXTRACT($attrib.coerce5, 192, 128);
    $$attrib$22$2 := BV_EXTRACT($attrib.coerce5, 192, 128);
    $$attrib$23$1 := BV_EXTRACT($attrib.coerce5, 256, 192);
    $$attrib$23$2 := BV_EXTRACT($attrib.coerce5, 256, 192);
    $$attrib$24$1 := BV_EXTRACT($attrib.coerce6, 64, 0);
    $$attrib$24$2 := BV_EXTRACT($attrib.coerce6, 64, 0);
    $$attrib$25$1 := BV_EXTRACT($attrib.coerce6, 128, 64);
    $$attrib$25$2 := BV_EXTRACT($attrib.coerce6, 128, 64);
    $$attrib$26$1 := BV_EXTRACT($attrib.coerce6, 192, 128);
    $$attrib$26$2 := BV_EXTRACT($attrib.coerce6, 192, 128);
    $$attrib$27$1 := BV_EXTRACT($attrib.coerce6, 256, 192);
    $$attrib$27$2 := BV_EXTRACT($attrib.coerce6, 256, 192);
    v0$1 := $$attrib$0$1;
    v0$2 := $$attrib$0$2;
    v1$1 := $$attrib$1$1;
    v1$2 := $$attrib$1$2;
  ...
  $falsebb:
    ...
    v117$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$1, 64, 0), v113), v0$1);
    v117$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$2, 64, 0), v113), v0$2);
    v118$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$1, 128, 64), v113), v1$1);
    v118$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$2, 128, 64), v113), v1$2);
    v119$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$1, 192, 128), v113), v2$1);
    v119$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$2, 192, 128), v113), v2$2);
    v120$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$1, 256, 192), v113), v3$1);
    v120$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice1.0$2, 256, 192), v113), v3$2);
    v121$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$1, 64, 0), v114), v0$1);
    v121$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$2, 64, 0), v114), v0$2);
    v122$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$1, 128, 64), v114), v1$1);
    v122$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$2, 128, 64), v114), v1$2);
    v123$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$1, 192, 128), v114), v2$1);
    v123$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$2, 192, 128), v114), v2$2);
    v124$1 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$1, 256, 192), v114), v3$1);
    v124$2 := FSUB64(FDIV64(BV_EXTRACT($sumPrice2.0$2, 256, 192), v114), v3$2);
    v125$1 := FLT64(0, v117$1);
    v125$2 := FLT64(0, v117$2);
    ...
    $temp3.i.0$1, $temp1.i1.0$1 := (if p0$1 then BV_CONCAT(0, v117$1) else $temp3.i.0$1), (if p0$1 then 4607182418800017408 else $temp1.i1.0$1);
    $temp3.i.0$2, $temp1.i1.0$2 := (if p0$2 then BV_CONCAT(0, v117$2) else $temp3.i.0$2), (if p0$2 then 4607182418800017408 else $temp1.i1.0$2);
    ...
    v126$1 := FLT64(0, v118$1);
    v126$2 := FLT64(0, v118$2);
    ...
    $temp3.i.1$1, $temp1.i1.1$1 := (if p2$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp3.i.0$1, 256, 192), BV_EXTRACT($temp3.i.0$1, 192, 128)), v118$1), BV_EXTRACT($temp3.i.0$1, 64, 0)) else $temp3.i.1$1), (if p2$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp1.i1.0$1, 256, 192), BV_EXTRACT($temp1.i1.0$1, 192, 128)), 4607182418800017408), BV_EXTRACT($temp1.i1.0$1, 64, 0)) else $temp1.i1.1$1);
    $temp3.i.1$2, $temp1.i1.1$2 := (if p2$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp3.i.0$2, 256, 192), BV_EXTRACT($temp3.i.0$2, 192, 128)), v118$2), BV_EXTRACT($temp3.i.0$2, 64, 0)) else $temp3.i.1$2), (if p2$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp1.i1.0$2, 256, 192), BV_EXTRACT($temp1.i1.0$2, 192, 128)), 4607182418800017408), BV_EXTRACT($temp1.i1.0$2, 64, 0)) else $temp1.i1.1$2);
    ...
    v127$1 := FLT64(0, v119$1);
    v127$2 := FLT64(0, v119$2);
    ...
    $temp3.i.2$1, $temp1.i1.2$1 := (if p4$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp3.i.1$1, 256, 192), v119$1), BV_EXTRACT($temp3.i.1$1, 128, 64)), BV_EXTRACT($temp3.i.1$1, 64, 0)) else $temp3.i.2$1), (if p4$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp1.i1.1$1, 256, 192), 4607182418800017408), BV_EXTRACT($temp1.i1.1$1, 128, 64)), BV_EXTRACT($temp1.i1.1$1, 64, 0)) else $temp1.i1.2$1);
    $temp3.i.2$2, $temp1.i1.2$2 := (if p4$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp3.i.1$2, 256, 192), v119$2), BV_EXTRACT($temp3.i.1$2, 128, 64)), BV_EXTRACT($temp3.i.1$2, 64, 0)) else $temp3.i.2$2), (if p4$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp1.i1.1$2, 256, 192), 4607182418800017408), BV_EXTRACT($temp1.i1.1$2, 128, 64)), BV_EXTRACT($temp1.i1.1$2, 64, 0)) else $temp1.i1.2$2);
    ...
    v128$1 := FLT64(0, v120$1);
    v128$2 := FLT64(0, v120$2);
    ...
    $temp3.i.3$1, $temp1.i1.3$1 := (if p6$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v120$1, BV_EXTRACT($temp3.i.2$1, 192, 128)), BV_EXTRACT($temp3.i.2$1, 128, 64)), BV_EXTRACT($temp3.i.2$1, 64, 0)) else $temp3.i.3$1), (if p6$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(4607182418800017408, BV_EXTRACT($temp1.i1.2$1, 192, 128)), BV_EXTRACT($temp1.i1.2$1, 128, 64)), BV_EXTRACT($temp1.i1.2$1, 64, 0)) else $temp1.i1.3$1);
    $temp3.i.3$2, $temp1.i1.3$2 := (if p6$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v120$2, BV_EXTRACT($temp3.i.2$2, 192, 128)), BV_EXTRACT($temp3.i.2$2, 128, 64)), BV_EXTRACT($temp3.i.2$2, 64, 0)) else $temp3.i.3$2), (if p6$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(4607182418800017408, BV_EXTRACT($temp1.i1.2$2, 192, 128)), BV_EXTRACT($temp1.i1.2$2, 128, 64)), BV_EXTRACT($temp1.i1.2$2, 64, 0)) else $temp1.i1.3$2);
    ...
    v129$1 := FLT64(0, v121$1);
    v129$2 := FLT64(0, v121$2);
    ...
    $temp4.i.0$1, $temp2.i2.0$1 := (if p8$1 then BV_CONCAT(0, v121$1) else $temp4.i.0$1), (if p8$1 then 4607182418800017408 else $temp2.i2.0$1);
    $temp4.i.0$2, $temp2.i2.0$2 := (if p8$2 then BV_CONCAT(0, v121$2) else $temp4.i.0$2), (if p8$2 then 4607182418800017408 else $temp2.i2.0$2);
    ...
    v130$1 := FLT64(0, v122$1);
    v130$2 := FLT64(0, v122$2);
    ...
    $temp4.i.1$1, $temp2.i2.1$1 := (if p10$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp4.i.0$1, 256, 192), BV_EXTRACT($temp4.i.0$1, 192, 128)), v122$1), BV_EXTRACT($temp4.i.0$1, 64, 0)) else $temp4.i.1$1), (if p10$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp2.i2.0$1, 256, 192), BV_EXTRACT($temp2.i2.0$1, 192, 128)), 4607182418800017408), BV_EXTRACT($temp2.i2.0$1, 64, 0)) else $temp2.i2.1$1);
    $temp4.i.1$2, $temp2.i2.1$2 := (if p10$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp4.i.0$2, 256, 192), BV_EXTRACT($temp4.i.0$2, 192, 128)), v122$2), BV_EXTRACT($temp4.i.0$2, 64, 0)) else $temp4.i.1$2), (if p10$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp2.i2.0$2, 256, 192), BV_EXTRACT($temp2.i2.0$2, 192, 128)), 4607182418800017408), BV_EXTRACT($temp2.i2.0$2, 64, 0)) else $temp2.i2.1$2);
    ...
    v131$1 := FLT64(0, v123$1);
    v131$2 := FLT64(0, v123$2);
    ...
    $temp4.i.2$1, $temp2.i2.2$1 := (if p12$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp4.i.1$1, 256, 192), v123$1), BV_EXTRACT($temp4.i.1$1, 128, 64)), BV_EXTRACT($temp4.i.1$1, 64, 0)) else $temp4.i.2$1), (if p12$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp2.i2.1$1, 256, 192), 4607182418800017408), BV_EXTRACT($temp2.i2.1$1, 128, 64)), BV_EXTRACT($temp2.i2.1$1, 64, 0)) else $temp2.i2.2$1);
    $temp4.i.2$2, $temp2.i2.2$2 := (if p12$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp4.i.1$2, 256, 192), v123$2), BV_EXTRACT($temp4.i.1$2, 128, 64)), BV_EXTRACT($temp4.i.1$2, 64, 0)) else $temp4.i.2$2), (if p12$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($temp2.i2.1$2, 256, 192), 4607182418800017408), BV_EXTRACT($temp2.i2.1$2, 128, 64)), BV_EXTRACT($temp2.i2.1$2, 64, 0)) else $temp2.i2.2$2);
    ...
    v132$1 := FLT64(0, v124$1);
    v132$2 := FLT64(0, v124$2);
    ...
    $temp4.i.3$1, $temp2.i2.3$1 := (if p14$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v124$1, BV_EXTRACT($temp4.i.2$1, 192, 128)), BV_EXTRACT($temp4.i.2$1, 128, 64)), BV_EXTRACT($temp4.i.2$1, 64, 0)) else $temp4.i.3$1), (if p14$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(4607182418800017408, BV_EXTRACT($temp2.i2.2$1, 192, 128)), BV_EXTRACT($temp2.i2.2$1, 128, 64)), BV_EXTRACT($temp2.i2.2$1, 64, 0)) else $temp2.i2.3$1);
    $temp4.i.3$2, $temp2.i2.3$2 := (if p14$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v124$2, BV_EXTRACT($temp4.i.2$2, 192, 128)), BV_EXTRACT($temp4.i.2$2, 128, 64)), BV_EXTRACT($temp4.i.2$2, 64, 0)) else $temp4.i.3$2), (if p14$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(4607182418800017408, BV_EXTRACT($temp2.i2.2$2, 192, 128)), BV_EXTRACT($temp2.i2.2$2, 128, 64)), BV_EXTRACT($temp2.i2.2$2, 64, 0)) else $temp2.i2.3$2);
    ...
    call {:sourceloc} {:sourceloc_num 147} _LOG_WRITE_$$priceSamples(true, BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), BV_EXTRACT($temp3.i.3$1, 64, 0), $$priceSamples[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 147} _CHECK_WRITE_$$priceSamples(true, BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), BV_EXTRACT($temp3.i.3$2, 64, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4)] := BV_EXTRACT($temp3.i.3$1, 64, 0);
    $$priceSamples[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4)] := BV_EXTRACT($temp3.i.3$2, 64, 0);
    call {:sourceloc} {:sourceloc_num 148} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1), BV_EXTRACT($temp3.i.3$1, 128, 64), $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 148} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 1), BV_EXTRACT($temp3.i.3$2, 128, 64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1)] := BV_EXTRACT($temp3.i.3$1, 128, 64);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 1)] := BV_EXTRACT($temp3.i.3$2, 128, 64);
    call {:sourceloc} {:sourceloc_num 149} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2), BV_EXTRACT($temp3.i.3$1, 192, 128), $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 149} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 2), BV_EXTRACT($temp3.i.3$2, 192, 128));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2)] := BV_EXTRACT($temp3.i.3$1, 192, 128);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 2)] := BV_EXTRACT($temp3.i.3$2, 192, 128);
    call {:sourceloc} {:sourceloc_num 150} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3), BV_EXTRACT($temp3.i.3$1, 256, 192), $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 150} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 3), BV_EXTRACT($temp3.i.3$2, 256, 192));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3)] := BV_EXTRACT($temp3.i.3$1, 256, 192);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 3)] := BV_EXTRACT($temp3.i.3$2, 256, 192);
    call {:sourceloc} {:sourceloc_num 151} _LOG_WRITE_$$priceSamples(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), BV_EXTRACT($temp4.i.3$1, 64, 0), $$priceSamples[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 151} _CHECK_WRITE_$$priceSamples(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), BV_EXTRACT($temp4.i.3$2, 64, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4)] := BV_EXTRACT($temp4.i.3$1, 64, 0);
    $$priceSamples[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4)] := BV_EXTRACT($temp4.i.3$2, 64, 0);
    call {:sourceloc} {:sourceloc_num 152} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1), BV_EXTRACT($temp4.i.3$1, 128, 64), $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 152} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 1), BV_EXTRACT($temp4.i.3$2, 128, 64));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1)] := BV_EXTRACT($temp4.i.3$1, 128, 64);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 1)] := BV_EXTRACT($temp4.i.3$2, 128, 64);
    call {:sourceloc} {:sourceloc_num 153} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2), BV_EXTRACT($temp4.i.3$1, 192, 128), $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 153} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 2), BV_EXTRACT($temp4.i.3$2, 192, 128));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2)] := BV_EXTRACT($temp4.i.3$1, 192, 128);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 2)] := BV_EXTRACT($temp4.i.3$2, 192, 128);
    call {:sourceloc} {:sourceloc_num 154} _LOG_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3), BV_EXTRACT($temp4.i.3$1, 256, 192), $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 154} _CHECK_WRITE_$$priceSamples(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 3), BV_EXTRACT($temp4.i.3$2, 256, 192));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$priceSamples"} true;
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3)] := BV_EXTRACT($temp4.i.3$1, 256, 192);
    $$priceSamples[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 3)] := BV_EXTRACT($temp4.i.3$2, 256, 192);
    call {:sourceloc} {:sourceloc_num 155} _LOG_WRITE_$$pathDeriv(true, BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 64, 0), v115), BV_EXTRACT($temp1.i1.3$1, 64, 0)), $$pathDeriv[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4)]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 155} _CHECK_WRITE_$$pathDeriv(true, BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 64, 0), v115), BV_EXTRACT($temp1.i1.3$2, 64, 0)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 64, 0), v115), BV_EXTRACT($temp1.i1.3$1, 64, 0));
    $$pathDeriv[BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 64, 0), v115), BV_EXTRACT($temp1.i1.3$2, 64, 0));
    call {:sourceloc} {:sourceloc_num 156} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 128, 64), v115), BV_EXTRACT($temp1.i1.3$1, 128, 64)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 156} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 1), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 128, 64), v115), BV_EXTRACT($temp1.i1.3$2, 128, 64)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 1)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 128, 64), v115), BV_EXTRACT($temp1.i1.3$1, 128, 64));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 1)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 128, 64), v115), BV_EXTRACT($temp1.i1.3$2, 128, 64));
    call {:sourceloc} {:sourceloc_num 157} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 192, 128), v115), BV_EXTRACT($temp1.i1.3$1, 192, 128)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2)]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 157} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 2), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 192, 128), v115), BV_EXTRACT($temp1.i1.3$2, 192, 128)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 2)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 192, 128), v115), BV_EXTRACT($temp1.i1.3$1, 192, 128));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 2)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 192, 128), v115), BV_EXTRACT($temp1.i1.3$2, 192, 128));
    call {:sourceloc} {:sourceloc_num 158} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 256, 192), v115), BV_EXTRACT($temp1.i1.3$1, 256, 192)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3)]);
    ...
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 158} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 3), FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 256, 192), v115), BV_EXTRACT($temp1.i1.3$2, 256, 192)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 4), 3)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$1, 256, 192), v115), BV_EXTRACT($temp1.i1.3$1, 256, 192));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 4), 3)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv1.0$2, 256, 192), v115), BV_EXTRACT($temp1.i1.3$2, 256, 192));
    call {:sourceloc} {:sourceloc_num 159} _LOG_WRITE_$$pathDeriv(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 64, 0), v116), BV_EXTRACT($temp2.i2.3$1, 64, 0)), $$pathDeriv[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4)]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 159} _CHECK_WRITE_$$pathDeriv(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 64, 0), v116), BV_EXTRACT($temp2.i2.3$2, 64, 0)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 64, 0), v116), BV_EXTRACT($temp2.i2.3$1, 64, 0));
    $$pathDeriv[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 64, 0), v116), BV_EXTRACT($temp2.i2.3$2, 64, 0));
    call {:sourceloc} {:sourceloc_num 160} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 128, 64), v116), BV_EXTRACT($temp2.i2.3$1, 128, 64)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1)]);
    ...
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 160} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 1), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 128, 64), v116), BV_EXTRACT($temp2.i2.3$2, 128, 64)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 1)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 128, 64), v116), BV_EXTRACT($temp2.i2.3$1, 128, 64));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 1)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 128, 64), v116), BV_EXTRACT($temp2.i2.3$2, 128, 64));
    call {:sourceloc} {:sourceloc_num 161} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 192, 128), v116), BV_EXTRACT($temp2.i2.3$1, 192, 128)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2)]);
    ...
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 161} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 2), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 192, 128), v116), BV_EXTRACT($temp2.i2.3$2, 192, 128)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 2)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 192, 128), v116), BV_EXTRACT($temp2.i2.3$1, 192, 128));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 2)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 192, 128), v116), BV_EXTRACT($temp2.i2.3$2, 192, 128));
    call {:sourceloc} {:sourceloc_num 162} _LOG_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 256, 192), v116), BV_EXTRACT($temp2.i2.3$1, 256, 192)), $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3)]);
    ...
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 162} _CHECK_WRITE_$$pathDeriv(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 3), FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 256, 192), v116), BV_EXTRACT($temp2.i2.3$2, 256, 192)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pathDeriv"} true;
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$1, $width), v29$1), 2), 1), 4), 3)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$1, 256, 192), v116), BV_EXTRACT($temp2.i2.3$1, 256, 192));
    $$pathDeriv[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(v30$2, $width), v29$2), 2), 1), 4), 3)] := FMUL64(FDIV64(BV_EXTRACT($sumDeriv2.0$2, 256, 192), v116), BV_EXTRACT($temp2.i2.3$2, 256, 192));
    return;
  ...
  $falsebb0:
    ...
    v87$1 := $$temp.i$1[7];
    v87$2 := $$temp.i$2[7];
    v88$1 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v80$1), 4751297606875873280)), 4604418534330597376)));
    v88$2 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v80$2), 4751297606875873280)), 4604418534330597376)));
    v89$1 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v81$1), 4751297606875873280)), 4604418534330597376)));
    v89$2 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v81$2), 4751297606875873280)), 4604418534330597376)));
    v90$1 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v82$1), 4751297606875873280)), 4604418534330597376)));
    v90$2 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v82$2), 4751297606875873280)), 4604418534330597376)));
    v91$1 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v83$1), 4751297606875873280)), 4604418534330597376)));
    v91$2 := FSQRT64(FMUL64(-4611686018427387904, FMUL64(FLOG64(FDIV64(UI32_TO_FP64(v83$2), 4751297606875873280)), 4604418534330597376)));
    v92$1 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v84$1), 4751297606875873280));
    v92$2 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v84$2), 4751297606875873280));
    v93$1 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v85$1), 4751297606875873280));
    v93$2 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v85$2), 4751297606875873280));
    v94$1 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v86$1), 4751297606875873280));
    v94$2 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v86$2), 4751297606875873280));
    v95$1 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v87$1), 4751297606875873280));
    v95$2 := FMUL64(4618760256179416337, FDIV64(UI32_TO_FP64(v87$2), 4751297606875873280));
    v96$1 := $$temp.i$1[8];
    v96$2 := $$temp.i$2[8];
    v97$1 := $$temp.i$1[9];
    v97$2 := $$temp.i$2[9];
    ...
    v99$1 := $$temp.i$1[11];
    v99$2 := $$temp.i$2[11];
    v100$1 := FMUL64(BV_EXTRACT($trajPrice1.0$1, 64, 0), FEXP64(FMUL64(FADD64(FMUL64(v8$1, FMUL64(v88$1, FCOS64(v92$1))), v4$1), 4609176140021203710)));
    v100$2 := FMUL64(BV_EXTRACT($trajPrice1.0$2, 64, 0), FEXP64(FMUL64(FADD64(FMUL64(v8$2, FMUL64(v88$2, FCOS64(v92$2))), v4$2), 4609176140021203710)));
    v101$1 := FMUL64(BV_EXTRACT($trajPrice1.0$1, 128, 64), FEXP64(FMUL64(FADD64(FMUL64(v9$1, FMUL64(v89$1, FCOS64(v93$1))), v5$1), 4609176140021203710)));
    v101$2 := FMUL64(BV_EXTRACT($trajPrice1.0$2, 128, 64), FEXP64(FMUL64(FADD64(FMUL64(v9$2, FMUL64(v89$2, FCOS64(v93$2))), v5$2), 4609176140021203710)));
    v102$1 := FMUL64(BV_EXTRACT($trajPrice1.0$1, 192, 128), FEXP64(FMUL64(FADD64(FMUL64(v10$1, FMUL64(v90$1, FCOS64(v94$1))), v6$1), 4609176140021203710)));
    v102$2 := FMUL64(BV_EXTRACT($trajPrice1.0$2, 192, 128), FEXP64(FMUL64(FADD64(FMUL64(v10$2, FMUL64(v90$2, FCOS64(v94$2))), v6$2), 4609176140021203710)));
    v103$1 := FMUL64(BV_EXTRACT($trajPrice1.0$1, 256, 192), FEXP64(FMUL64(FADD64(FMUL64(v11$1, FMUL64(v91$1, FCOS64(v95$1))), v7$1), 4609176140021203710)));
    v103$2 := FMUL64(BV_EXTRACT($trajPrice1.0$2, 256, 192), FEXP64(FMUL64(FADD64(FMUL64(v11$2, FMUL64(v91$2, FCOS64(v95$2))), v7$2), 4609176140021203710)));
    v104$1 := FMUL64(BV_EXTRACT($trajPrice2.0$1, 64, 0), FEXP64(FMUL64(FADD64(FMUL64(v8$1, FMUL64(v88$1, FSIN64(v92$1))), v4$1), 4609176140021203710)));
    v104$2 := FMUL64(BV_EXTRACT($trajPrice2.0$2, 64, 0), FEXP64(FMUL64(FADD64(FMUL64(v8$2, FMUL64(v88$2, FSIN64(v92$2))), v4$2), 4609176140021203710)));
    v105$1 := FMUL64(BV_EXTRACT($trajPrice2.0$1, 128, 64), FEXP64(FMUL64(FADD64(FMUL64(v9$1, FMUL64(v89$1, FSIN64(v93$1))), v5$1), 4609176140021203710)));
    v105$2 := FMUL64(BV_EXTRACT($trajPrice2.0$2, 128, 64), FEXP64(FMUL64(FADD64(FMUL64(v9$2, FMUL64(v89$2, FSIN64(v93$2))), v5$2), 4609176140021203710)));
    v106$1 := FMUL64(BV_EXTRACT($trajPrice2.0$1, 192, 128), FEXP64(FMUL64(FADD64(FMUL64(v10$1, FMUL64(v90$1, FSIN64(v94$1))), v6$1), 4609176140021203710)));
    v106$2 := FMUL64(BV_EXTRACT($trajPrice2.0$2, 192, 128), FEXP64(FMUL64(FADD64(FMUL64(v10$2, FMUL64(v90$2, FSIN64(v94$2))), v6$2), 4609176140021203710)));
    v107$1 := FMUL64(BV_EXTRACT($trajPrice2.0$1, 256, 192), FEXP64(FMUL64(FADD64(FMUL64(v11$1, FMUL64(v91$1, FSIN64(v95$1))), v7$1), 4609176140021203710)));
    v107$2 := FMUL64(BV_EXTRACT($trajPrice2.0$2, 256, 192), FEXP64(FMUL64(FADD64(FMUL64(v11$2, FMUL64(v91$2, FSIN64(v95$2))), v7$2), 4609176140021203710)));
    ...
    $nextRand.0$1, $trajPrice1.0$1, $trajPrice2.0$1, $sumPrice1.0$1, $sumPrice2.0$1, $sumDeriv1.0$1, $sumDeriv2.0$1, $i.0 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v99$1, v98$1), v97$1), v96$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v103$1, v102$1), v101$1), v100$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v107$1, v106$1), v105$1), v104$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(BV_EXTRACT($sumPrice1.0$1, 256, 192), v103$1), FADD64(BV_EXTRACT($sumPrice1.0$1, 192, 128), v102$1)), FADD64(BV_EXTRACT($sumPrice1.0$1, 128, 64), v101$1)), FADD64(BV_EXTRACT($sumPrice1.0$1, 64, 0), v100$1)), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(BV_EXTRACT($sumPrice2.0$1, 256, 192), v107$1), FADD64(BV_EXTRACT($sumPrice2.0$1, 192, 128), v106$1)), FADD64(BV_EXTRACT($sumPrice2.0$1, 128, 64), v105$1)), FADD64(BV_EXTRACT($sumPrice2.0$1, 64, 0), v104$1)), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(FMUL64(v103$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v103$1, v19$1)), 4604418534330597376), FSUB64(-9223372036854775808, v112$1)), v24$1)), BV_EXTRACT($sumDeriv1.0$1, 256, 192)), FADD64(FMUL64(v102$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v102$1, v18$1)), 4604418534330597376), FSUB64(-9223372036854775808, v111$1)), v23$1)), BV_EXTRACT($sumDeriv1.0$1, 192, 128))), FADD64(FMUL64(v101$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v101$1, v17$1)), 4604418534330597376), FSUB64(-9223372036854775808, v110$1)), v22$1)), BV_EXTRACT($sumDeriv1.0$1, 128, 64))), FADD64(FMUL64(v100$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v100$1, v16$1)), 4604418534330597376), FSUB64(-9223372036854775808, v109$1)), v21$1)), BV_EXTRACT($sumDeriv1.0$1, 64, 0))), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(FMUL64(v107$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v107$1, v19$1)), 4604418534330597376), FSUB64(-9223372036854775808, v112$1)), v24$1)), BV_EXTRACT($sumDeriv2.0$1, 256, 192)), FADD64(FMUL64(v106$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v106$1, v18$1)), 4604418534330597376), FSUB64(-9223372036854775808, v111$1)), v23$1)), BV_EXTRACT($sumDeriv2.0$1, 192, 128))), FADD64(FMUL64(v105$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v105$1, v17$1)), 4604418534330597376), FSUB64(-9223372036854775808, v110$1)), v22$1)), BV_EXTRACT($sumDeriv2.0$1, 128, 64))), FADD64(FMUL64(v104$1, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v104$1, v16$1)), 4604418534330597376), FSUB64(-9223372036854775808, v109$1)), v21$1)), BV_EXTRACT($sumDeriv2.0$1, 64, 0))), BV32_ADD($i.0, 1);
    $nextRand.0$2, $trajPrice1.0$2, $trajPrice2.0$2, $sumPrice1.0$2, $sumPrice2.0$2, $sumDeriv1.0$2, $sumDeriv2.0$2 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v99$2, v98$2), v97$2), v96$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v103$2, v102$2), v101$2), v100$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v107$2, v106$2), v105$2), v104$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(BV_EXTRACT($sumPrice1.0$2, 256, 192), v103$2), FADD64(BV_EXTRACT($sumPrice1.0$2, 192, 128), v102$2)), FADD64(BV_EXTRACT($sumPrice1.0$2, 128, 64), v101$2)), FADD64(BV_EXTRACT($sumPrice1.0$2, 64, 0), v100$2)), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(BV_EXTRACT($sumPrice2.0$2, 256, 192), v107$2), FADD64(BV_EXTRACT($sumPrice2.0$2, 192, 128), v106$2)), FADD64(BV_EXTRACT($sumPrice2.0$2, 128, 64), v105$2)), FADD64(BV_EXTRACT($sumPrice2.0$2, 64, 0), v104$2)), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(FMUL64(v103$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v103$2, v19$2)), 4604418534330597376), FSUB64(-9223372036854775808, v112$2)), v24$2)), BV_EXTRACT($sumDeriv1.0$2, 256, 192)), FADD64(FMUL64(v102$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v102$2, v18$2)), 4604418534330597376), FSUB64(-9223372036854775808, v111$2)), v23$2)), BV_EXTRACT($sumDeriv1.0$2, 192, 128))), FADD64(FMUL64(v101$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v101$2, v17$2)), 4604418534330597376), FSUB64(-9223372036854775808, v110$2)), v22$2)), BV_EXTRACT($sumDeriv1.0$2, 128, 64))), FADD64(FMUL64(v100$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v100$2, v16$2)), 4604418534330597376), FSUB64(-9223372036854775808, v109$2)), v21$2)), BV_EXTRACT($sumDeriv1.0$2, 64, 0))), BV_CONCAT(BV_CONCAT(BV_CONCAT(FADD64(FMUL64(v107$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v107$2, v19$2)), 4604418534330597376), FSUB64(-9223372036854775808, v112$2)), v24$2)), BV_EXTRACT($sumDeriv2.0$2, 256, 192)), FADD64(FMUL64(v106$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v106$2, v18$2)), 4604418534330597376), FSUB64(-9223372036854775808, v111$2)), v23$2)), BV_EXTRACT($sumDeriv2.0$2, 192, 128))), FADD64(FMUL64(v105$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v105$2, v17$2)), 4604418534330597376), FSUB64(-9223372036854775808, v110$2)), v22$2)), BV_EXTRACT($sumDeriv2.0$2, 128, 64))), FADD64(FMUL64(v104$2, FDIV64(FADD64(FMUL64(FLOG64(FDIV64(v104$2, v16$2)), 4604418534330597376), FSUB64(-9223372036854775808, v109$2)), v21$2)), BV_EXTRACT($sumDeriv2.0$2, 64, 0)));
