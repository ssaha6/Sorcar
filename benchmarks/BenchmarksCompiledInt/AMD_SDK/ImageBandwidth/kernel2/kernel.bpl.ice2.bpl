...
assert  my_inv (  (  $n.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($n.0, 0) ) ,  (  BV32_SGE($n.0, 0) ) ,  (  BV32_ULE($n.0, 0) ) ,  (  BV32_UGE($n.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  $i.0 mod 1 == 0 mod 1 ) ,  (  $idx.0$1 mod BV32_MUL(group_size_y, num_groups_y) == BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1) mod BV32_MUL(group_size_y, num_groups_y) )  && (  $idx.0$2 mod BV32_MUL(group_size_y, num_groups_y) == BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2) mod BV32_MUL(group_size_y, num_groups_y) ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) )  ); 
