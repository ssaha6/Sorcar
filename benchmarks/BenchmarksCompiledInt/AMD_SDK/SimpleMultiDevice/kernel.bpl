...
implementation {:source_name "multiDeviceKernel"} {:kernel} $multiDeviceKernel()
{
  ...
  $0:
    ...
    havoc v3$1, v3$2;
    havoc v4$1, v4$2;
    $a.0$1, $b.0$1, $i.0 := FADD32(FMUL32(v1$1, v2$1), 1065353216), FADD32(FMUL32(v3$1, v4$1), 1073741824), 0;
    $a.0$2, $b.0$2 := FADD32(FMUL32(v1$2, v2$2), 1065353216), FADD32(FMUL32(v3$2, v4$2), 1073741824);
  ...
  $truebb:
    ...
    $a.0$1, $b.0$1, $i.0 := v6$1, FSQRT32(FADD32(FMUL32(v6$1, v6$1), FMUL32($b.0$1, $b.0$1))), BV32_ADD($i.0, 1);
