...
implementation {:source_name "RecursiveGaussian_kernel"} {:kernel} $RecursiveGaussian_kernel($width: bv32, $height: bv32, $a0: bv32, $a1: bv32, $a2: bv32, $a3: bv32, $b1: bv32, $b2: bv32, $coefp: bv32, $coefn: bv32)
{
  ...
  var _WRITE_HAS_OCCURRED_$$output$ghost$$3: bool;
  var _READ_HAS_OCCURRED_$$output$ghost$$7: bool;
  var _WRITE_HAS_OCCURRED_$$output$ghost$$7: bool;
  ...
  $0:
    ...
    _WRITE_HAS_OCCURRED_$$output$ghost$$3 := _WRITE_HAS_OCCURRED_$$output;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $3;

  $3:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b21 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$output$ghost$$3 == _WRITE_HAS_OCCURRED_$$output;
  ...
  __partitioned_block_$3.tail_1:
    ...
    _READ_HAS_OCCURRED_$$output$ghost$$7 := _READ_HAS_OCCURRED_$$output;
    _WRITE_HAS_OCCURRED_$$output$ghost$$7 := _WRITE_HAS_OCCURRED_$$output;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $7;

  $7:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b29 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$output$ghost$$7 == _WRITE_HAS_OCCURRED_$$output;
    assert {:tag "disabledMaintainsInstrumentation"} _b28 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$output$ghost$$7 == _READ_HAS_OCCURRED_$$output;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b15 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $width) && BV32_SGT($y1.0$1, 4294967295bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b15 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $width) && BV32_SGT($y1.0$2, 4294967295bv32) ==> p4$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b13 ==> BV32_UGE($y1.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b13 ==> BV32_UGE($y1.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b12 ==> BV32_ULE($y1.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b12 ==> BV32_ULE($y1.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b11 ==> BV32_SGE($y1.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b11 ==> BV32_SGE($y1.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b10 ==> BV32_SLE($y1.0$1, BV32_SUB($height, 1bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b10 ==> BV32_SLE($y1.0$2, BV32_SUB($height, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} p4$1 ==> _b9 ==> BV32_SLE(0bv32, $y1.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p4$2 ==> _b9 ==> BV32_SLE(0bv32, $y1.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b8 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y1.0$1) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($height, 1bv32));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b8 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $y1.0$2) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_SUB($height, 1bv32));
