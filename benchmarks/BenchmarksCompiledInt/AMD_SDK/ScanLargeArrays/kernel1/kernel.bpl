...
var {:source_name "value"} {:group_shared} $$blockAddition.value: [bv1][int]int;
...
implementation {:source_name "blockAddition"} {:kernel} $blockAddition()
{
  ...
  __partitioned_block_$0_0:
    ...
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$blockAddition.value(p0$1, 0, v3$1, $$blockAddition.value[1bv1][0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$blockAddition.value(p0$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 3} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$blockAddition.value(p0$2, 0, v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$blockAddition.value"} true;
    $$blockAddition.value[1bv1][0] := (if p0$1 then v3$1 else $$blockAddition.value[1bv1][0]);
    $$blockAddition.value[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] := (if p0$2 then v3$2 else $$blockAddition.value[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    goto __partitioned_block_$0_1;

  __partitioned_block_$0_1:
    call {:sourceloc_num 5} $bugle_barrier_duplicated_0(-1, 0);
    call {:sourceloc} {:sourceloc_num 6} _LOG_READ_$$blockAddition.value(true, 0, $$blockAddition.value[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_READ_$$blockAddition.value(true, 0, $$blockAddition.value[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$blockAddition.value"} true;
    v4$1 := $$blockAddition.value[1bv1][0];
    v4$2 := $$blockAddition.value[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0];
...
const _WATCHED_VALUE_$$blockAddition.value: int;

procedure {:inline 1} _LOG_READ_$$blockAddition.value(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$blockAddition.value;



implementation {:inline 1} _LOG_READ_$$blockAddition.value(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$blockAddition.value(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$blockAddition.value(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$blockAddition.value, _WRITE_READ_BENIGN_FLAG_$$blockAddition.value;



implementation {:inline 1} _LOG_WRITE_$$blockAddition.value(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$blockAddition.value(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$blockAddition.value(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$blockAddition.value;



implementation {:inline 1} _LOG_ATOMIC_$$blockAddition.value(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$blockAddition.value(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$blockAddition.value(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$blockAddition.value;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$blockAddition.value(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon0:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$blockAddition.value;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$blockAddition.value;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$blockAddition.value;
    goto anon1;
