...
implementation {:source_name "box_filter_horizontal"} {:kernel} $box_filter_horizontal($filterWidth: int)
{
  var $sum.0$1: int;
  var $sum.0$2: int;
  var $X.0$1: int;
  ...
  $0:
    ...
    v2$1 := BV32_ADD(v0$1, BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), v1));
    v2$2 := BV32_ADD(v0$2, BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), v1));
    ...
    $sum.0$1, $X.0$1 := (if p4$1 then 0 else $sum.0$1), (if p4$1 then BV32_SUB(0, v3) else $X.0$1);
    $sum.0$2, $X.0$2 := (if p4$2 then 0 else $sum.0$2), (if p4$2 then BV32_SUB(0, v3) else $X.0$2);
  ...
  $4:
    ...
    $sum.0$1, $X.0$1 := (if p6$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$1, 128, 96), BV8_ZEXT32(v10$1)), BV8_ZEXT32(v14$1)), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$1, 96, 64), BV8_ZEXT32(v9$1)), BV8_ZEXT32(v13$1))), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$1, 64, 32), BV8_ZEXT32(v8$1)), BV8_ZEXT32(v12$1))), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$1, 32, 0), BV8_ZEXT32(v7$1)), BV8_ZEXT32(v11$1))) else $sum.0$1), (if p6$1 then BV32_ADD($X.0$1, 2) else $X.0$1);
    $sum.0$2, $X.0$2 := (if p6$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$2, 128, 96), BV8_ZEXT32(v10$2)), BV8_ZEXT32(v14$2)), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$2, 96, 64), BV8_ZEXT32(v9$2)), BV8_ZEXT32(v13$2))), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$2, 64, 32), BV8_ZEXT32(v8$2)), BV8_ZEXT32(v12$2))), BV32_ADD(BV32_ADD(BV_EXTRACT($sum.0$2, 32, 0), BV8_ZEXT32(v7$2)), BV8_ZEXT32(v11$2))) else $sum.0$2), (if p6$2 then BV32_ADD($X.0$2, 2) else $X.0$2);
