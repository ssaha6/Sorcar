...
implementation {:source_name "box_filter_horizontal_local"} {:kernel} $box_filter_horizontal_local($filterWidth: int)
{
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b10 ==> !p6$1 ==> _READ_HAS_OCCURRED_$$lds$ghost$$6 == _READ_HAS_OCCURRED_$$lds;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _READ_HAS_OCCURRED_$$lds ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$lds ==> !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$lds ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1), 2));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1), 2))) && BV32_SLE($X.0$1, BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1), 2))) && BV32_SLE($X.0$2, BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b5 ==> p7$1 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b5 ==> p7$2 ==> !BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)) && !BV32_SGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_SUB(BV32_MUL(group_size_x, num_groups_x), BV32_SDIV(BV32_SUB($filterWidth, 1), 2)));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b4 ==> BV32_UGE($X.0$1, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b4 ==> BV32_UGE($X.0$2, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b3 ==> BV32_ULE($X.0$1, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b3 ==> BV32_ULE($X.0$2, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b2 ==> BV32_SGE($X.0$1, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b2 ==> BV32_SGE($X.0$2, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b1 ==> BV32_SLE($X.0$1, BV32_SUB(0, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b1 ==> BV32_SLE($X.0$2, BV32_SUB(0, v2));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b0 ==> $X.0$1 mod 1 == BV32_SUB(0, v2) mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b0 ==> $X.0$2 mod 1 == BV32_SUB(0, v2) mod 1;
