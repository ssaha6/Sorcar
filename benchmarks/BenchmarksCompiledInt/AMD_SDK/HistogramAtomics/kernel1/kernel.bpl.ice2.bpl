...
procedure {:source_name "histogramKernel"} {:kernel} $histogramKernel($n4VectorsPerThread: bv32);
  ...
  modifies _USED_$$histogramKernel.subhists, _WRITE_HAS_OCCURRED_$$histogramKernel.subhists, _WRITE_READ_BENIGN_FLAG_$$histogramKernel.subhists, _WRITE_READ_BENIGN_FLAG_$$histogramKernel.subhists, $$Histogram, _TRACKING, _TRACKING, _READ_HAS_OCCURRED_$$histogramKernel.subhists, _WRITE_HAS_OCCURRED_$$Histogram, _WRITE_READ_BENIGN_FLAG_$$Histogram, _WRITE_READ_BENIGN_FLAG_$$Histogram, _ATOMIC_HAS_OCCURRED_$$histogramKernel.subhists;
...
implementation {:source_name "histogramKernel"} {:kernel} $histogramKernel($n4VectorsPerThread: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$histogramKernel.subhists$ghost$$21: bool;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32)) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$histogramKernel.subhists$ghost$$11 == _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p1$1 ==> BV32_SLE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_SLE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_SGE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_SGE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_ULE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_ULE($i.0$2, 0bv32) ) ,  ( p1$1 ==> BV32_UGE($i.0$1, 0bv32) )  && ( p1$2 ==> BV32_UGE($i.0$2, 0bv32) ) ,  ( p1$1 ==> p1$1 ==> BV32_ULT(local_id_x$1, $2) )  && ( p1$2 ==> p1$2 ==> BV32_ULT(local_id_x$2, $2) ) ,  (  BV32_ULT(local_id_x$1, $2) && BV32_ULT($i.0$1, BV32_UDIV(BV32_UDIV(4096bv32, $2), 4bv32)) ==> p1$1 )  && (  BV32_ULT(local_id_x$2, $2) && BV32_ULT($i.0$2, BV32_UDIV(BV32_UDIV(4096bv32, $2), 4bv32)) ==> p1$2 ) ,  (  _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_ULT(local_id_x$1, $2) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 15} _LOG_WRITE_$$histogramKernel.subhists(p2$1, BV32_MUL($idx.0$1, 4bv32), 0bv32, _abstracted_call_arg_2$1);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$histogramKernel.subhists(p2$2, BV32_MUL($idx.0$2, 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_18"} {:captureState "check_state_18"} {:sourceloc} {:sourceloc_num 15} true;
    call {:check_id "check_state_18"} {:sourceloc} {:sourceloc_num 15} _CHECK_WRITE_$$histogramKernel.subhists(p2$2, BV32_MUL($idx.0$2, 4bv32), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$histogramKernel.subhists"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    _abstracted_call_arg_3$1 := (if p2$1 then _HAVOC_bv32$1 else _abstracted_call_arg_3$1);
    _abstracted_call_arg_3$2 := (if p2$2 then _HAVOC_bv32$2 else _abstracted_call_arg_3$2);
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$histogramKernel.subhists(p2$1, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 1bv32), 0bv32, _abstracted_call_arg_3$1);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$histogramKernel.subhists(p2$2, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_19"} {:captureState "check_state_19"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_19"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$histogramKernel.subhists(p2$2, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 1bv32), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$histogramKernel.subhists"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$histogramKernel.subhists(p2$1, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 2bv32), 0bv32, _abstracted_call_arg_4$1);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$histogramKernel.subhists(p2$2, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 2bv32));
    assume {:do_not_predicate} {:check_id "check_state_20"} {:captureState "check_state_20"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_20"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$histogramKernel.subhists(p2$2, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 2bv32), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$histogramKernel.subhists"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_WRITE_$$histogramKernel.subhists(p2$1, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 3bv32), 0bv32, _abstracted_call_arg_5$1);
...
assert  my_inv (  (  BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $idx.1$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) )  && (  BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $idx.1$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) ) ,  (  BV32_SLE($i.1, 0bv32) ) ,  (  BV32_SGE($i.1, 0bv32) ) ,  (  BV32_ULE($i.1, 0bv32) ) ,  (  BV32_UGE($i.1, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  v9$1 == 0bv32 || BV32_AND(v9$1, BV32_SUB(v9$1, 1bv32)) == 0bv32 ) ,  (  v9$1 != 0bv32 ) ,  (  v9$2 == 0bv32 || BV32_AND(v9$2, BV32_SUB(v9$2, 1bv32)) == 0bv32 ) ,  (  v9$2 != 0bv32 ) ,  (  v10$1 == 0bv32 || BV32_AND(v10$1, BV32_SUB(v10$1, 1bv32)) == 0bv32 ) ,  (  v10$1 != 0bv32 ) ,  (  v10$2 == 0bv32 || BV32_AND(v10$2, BV32_SUB(v10$2, 1bv32)) == 0bv32 ) ,  (  v10$2 != 0bv32 ) ,  (  v11$1 == 0bv32 || BV32_AND(v11$1, BV32_SUB(v11$1, 1bv32)) == 0bv32 ) ,  (  v11$1 != 0bv32 ) ,  (  v11$2 == 0bv32 || BV32_AND(v11$2, BV32_SUB(v11$2, 1bv32)) == 0bv32 ) ,  (  v11$2 != 0bv32 ) ,  (  v12$1 == 0bv32 || BV32_AND(v12$1, BV32_SUB(v12$1, 1bv32)) == 0bv32 ) ,  (  v12$1 != 0bv32 ) ,  (  v12$2 == 0bv32 || BV32_AND(v12$2, BV32_SUB(v12$2, 1bv32)) == 0bv32 ) ,  (  v12$2 != 0bv32 ) ,  (  v18$1 == 0bv32 || BV32_AND(v18$1, BV32_SUB(v18$1, 1bv32)) == 0bv32 ) ,  (  v18$1 != 0bv32 ) ,  (  v18$2 == 0bv32 || BV32_AND(v18$2, BV32_SUB(v18$2, 1bv32)) == 0bv32 ) ,  (  v18$2 != 0bv32 ) ,  (  v17$1 == 0bv32 || BV32_AND(v17$1, BV32_SUB(v17$1, 1bv32)) == 0bv32 ) ,  (  v17$1 != 0bv32 ) ,  (  v17$2 == 0bv32 || BV32_AND(v17$2, BV32_SUB(v17$2, 1bv32)) == 0bv32 ) ,  (  v17$2 != 0bv32 ) ,  (  v19$1 == 0bv32 || BV32_AND(v19$1, BV32_SUB(v19$1, 1bv32)) == 0bv32 ) ,  (  v19$1 != 0bv32 ) ,  (  v19$2 == 0bv32 || BV32_AND(v19$2, BV32_SUB(v19$2, 1bv32)) == 0bv32 ) ,  (  v19$2 != 0bv32 ) ,  (  v20$1 == 0bv32 || BV32_AND(v20$1, BV32_SUB(v20$1, 1bv32)) == 0bv32 ) ,  (  v20$1 != 0bv32 ) ,  (  v20$2 == 0bv32 || BV32_AND(v20$2, BV32_SUB(v20$2, 1bv32)) == 0bv32 ) ,  (  v20$2 != 0bv32 ) ,  (  v25$1 == 0bv32 || BV32_AND(v25$1, BV32_SUB(v25$1, 1bv32)) == 0bv32 ) ,  (  v25$1 != 0bv32 ) ,  (  v25$2 == 0bv32 || BV32_AND(v25$2, BV32_SUB(v25$2, 1bv32)) == 0bv32 ) ,  (  v25$2 != 0bv32 ) ,  (  v26$1 == 0bv32 || BV32_AND(v26$1, BV32_SUB(v26$1, 1bv32)) == 0bv32 ) ,  (  v26$1 != 0bv32 ) ,  (  v26$2 == 0bv32 || BV32_AND(v26$2, BV32_SUB(v26$2, 1bv32)) == 0bv32 ) ,  (  v26$2 != 0bv32 ) ,  (  v27$1 == 0bv32 || BV32_AND(v27$1, BV32_SUB(v27$1, 1bv32)) == 0bv32 ) ,  (  v27$1 != 0bv32 ) ,  (  v27$2 == 0bv32 || BV32_AND(v27$2, BV32_SUB(v27$2, 1bv32)) == 0bv32 ) ,  (  v27$2 != 0bv32 ) ,  (  v28$1 == 0bv32 || BV32_AND(v28$1, BV32_SUB(v28$1, 1bv32)) == 0bv32 ) ,  (  v28$1 != 0bv32 ) ,  (  v28$2 == 0bv32 || BV32_AND(v28$2, BV32_SUB(v28$2, 1bv32)) == 0bv32 ) ,  (  v28$2 != 0bv32 ) ,  true ,  true  ); 
  ...
  __partitioned_block_$falsebb4_1:
    ...
    _READ_HAS_OCCURRED_$$histogramKernel.subhists$ghost$$21 := _READ_HAS_OCCURRED_$$histogramKernel.subhists;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32) ) ,  (  !p4$1 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists$ghost$$21 == _READ_HAS_OCCURRED_$$histogramKernel.subhists )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  ( p5$1 ==> BV32_SLE($i.2$1, 0bv32) )  && ( p5$2 ==> BV32_SLE($i.2$2, 0bv32) ) ,  ( p5$1 ==> BV32_SGE($i.2$1, 0bv32) )  && ( p5$2 ==> BV32_SGE($i.2$2, 0bv32) ) ,  ( p5$1 ==> BV32_ULE($i.2$1, 0bv32) )  && ( p5$2 ==> BV32_ULE($i.2$2, 0bv32) ) ,  ( p5$1 ==> BV32_UGE($i.2$1, 0bv32) )  && ( p5$2 ==> BV32_UGE($i.2$2, 0bv32) ) ,  ( p5$1 ==> p5$1 ==> BV32_ULT(local_id_x$1, 256bv32) )  && ( p5$2 ==> p5$2 ==> BV32_ULT(local_id_x$2, 256bv32) ) ,  (  BV32_ULT(local_id_x$1, 256bv32) && BV32_ULT($i.2$1, 16bv32) ==> p5$1 )  && (  BV32_ULT(local_id_x$2, 256bv32) && BV32_ULT($i.2$2, 16bv32) ==> p5$2 ) ,  (  _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_ULT(local_id_x$1, 256bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
    ...
    call {:sourceloc} {:sourceloc_num 51} _LOG_READ_$$histogramKernel.subhists(p6$1, BV32_ADD(BV32_MUL(v0$1, 16bv32), $i.2$1), _abstracted_call_arg_0$1);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 51} _CHECK_READ_$$histogramKernel.subhists(p6$2, BV32_ADD(BV32_MUL(v0$2, 16bv32), $i.2$2), _abstracted_call_arg_1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$histogramKernel.subhists"} true;
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v39$1 := (if p6$1 then _HAVOC_bv32$1 else v39$1);
    v39$2 := (if p6$2 then _HAVOC_bv32$2 else v39$2);
  ...
  $21.tail:
    ...
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 54} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 54} _CHECK_WRITE_$$Histogram(p4$2, BV32_ADD(BV32_MUL(group_id_x$2, 256bv32), v0$2), $bin.0$2);
  ...
  $truebb4:
    ...
    havoc v11$1, v11$2;
    havoc v12$1, v12$2;
    call {:sourceloc} {:sourceloc_num 29} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v9$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 29} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v9$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    ...
    call {:sourceloc} {:sourceloc_num 30} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v10$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 30} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v10$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v14$1, v14$2;
    ...
    call {:sourceloc} {:sourceloc_num 31} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v11$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 31} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v11$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v15$1, v15$2;
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v12$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 32} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v12$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v16$1, v16$2;
    ...
    call {:sourceloc} {:sourceloc_num 33} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v17$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 33} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 33} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v17$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v21$1, v21$2;
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v18$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 34} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 34} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v18$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v22$1, v22$2;
    ...
    call {:sourceloc} {:sourceloc_num 35} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v19$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 35} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v19$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v23$1, v23$2;
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v20$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 36} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 36} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v20$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v24$1, v24$2;
    ...
    call {:sourceloc} {:sourceloc_num 37} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v25$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 37} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 37} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v25$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v29$1, v29$2;
    ...
    call {:sourceloc} {:sourceloc_num 38} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v26$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 38} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 38} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v26$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v30$1, v30$2;
    ...
    call {:sourceloc} {:sourceloc_num 39} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v27$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 39} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 39} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v27$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v31$1, v31$2;
    ...
    call {:sourceloc} {:sourceloc_num 40} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v28$1, 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 40} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 40} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(v28$2, 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v32$1, v32$2;
    ...
    call {:sourceloc} {:sourceloc_num 41} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v25$1, 8bv32), 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 41} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 41} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v25$2, 8bv32), 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v33$1, v33$2;
    ...
    call {:sourceloc} {:sourceloc_num 42} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v26$1, 8bv32), 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 42} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 42} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v26$2, 8bv32), 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v34$1, v34$2;
    ...
    call {:sourceloc} {:sourceloc_num 43} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v27$1, 8bv32), 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 43} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 43} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v27$2, 8bv32), 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v35$1, v35$2;
    ...
    call {:sourceloc} {:sourceloc_num 44} _LOG_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v28$1, 8bv32), 255bv32), 16bv32), v1$1), 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 44} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 44} _CHECK_ATOMIC_$$histogramKernel.subhists(true, BV32_SDIV(BV32_MUL(BV32_ADD(BV32_MUL(BV32_AND(BV32_LSHR(v28$2, 8bv32), 255bv32), 16bv32), v1$2), 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$histogramKernel.subhists"} true;
    havoc v36$1, v36$2;
