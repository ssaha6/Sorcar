...
implementation {:source_name "histogramKernel"} {:kernel} $histogramKernel($n4VectorsPerThread: bv32)
{
  ...
  $16:
    ...
    assert {:tag "pow2"} _b49 ==> v20$1 == 0bv32 || BV32_AND(v20$1, BV32_SUB(v20$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b48 ==> v19$2 != 0bv32;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($i.1, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $idx.1$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $idx.1$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
  ...
  $21:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b70 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists$ghost$$21 == _READ_HAS_OCCURRED_$$histogramKernel.subhists;
    assert {:tag "accessBreak"} _b69 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p5"} {:dominator_predicate "p4"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b11 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_ULT(local_id_x$1, 256bv32);
    ...
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b9 ==> p5$1 ==> BV32_ULT(local_id_x$1, 256bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b9 ==> p5$2 ==> BV32_ULT(local_id_x$2, 256bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b8 ==> BV32_UGE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b8 ==> BV32_UGE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b7 ==> BV32_ULE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b7 ==> BV32_ULE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b6 ==> BV32_SGE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b6 ==> BV32_SGE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b5 ==> BV32_SLE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b5 ==> BV32_SLE($i.2$2, 0bv32);
