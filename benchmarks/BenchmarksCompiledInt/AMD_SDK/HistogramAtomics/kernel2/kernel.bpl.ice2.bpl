...
assert  my_inv (  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  (  _READ_HAS_OCCURRED_$$Histogram ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET) ) ,  (  _READ_HAS_OCCURRED_$$Histogram ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)) ) ,  (  _READ_HAS_OCCURRED_$$Histogram ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 256bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 256bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) ) ,  (  _READ_HAS_OCCURRED_$$Histogram ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, group_size_x) )  ); 
