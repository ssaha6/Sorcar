...

{
  ...
  __assume(d_common.in2_sqr_sub2_elem == 17161);
	...
	if(d_frame_no != 0){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh_sel, ((__write_offset_bytes(d_unique_d_in2_sub_cumh_sel) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh_sel))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh_sel, (__write_offset_bytes(d_unique_d_in2_sub_cumh_sel) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh_sel))/sizeof(fp) < d_common.in2_sub_cumh_sel_elem)),
              ei_new < d_common.in2_sub_cumh_sel_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sub2, ((__write_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub2, (__write_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              ei_new < d_common.in2_sub2_elem){
		...
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sub2, ((__write_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub2, (__write_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              __global_invariant(__read_implies(d_unique_d_in2_sub2, ((__read_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_unique_d_in2_sub2, (__read_offset_bytes(d_unique_d_in2_sub2) - __ptr_offset_bytes(d_unique_d_in2_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              ei_new < d_common.in2_sub2_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sqr, ((__write_offset_bytes(d_unique_d_in2_sqr) - __ptr_offset_bytes(d_unique_d_in2_sqr))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sqr, (__write_offset_bytes(d_unique_d_in2_sqr) - __ptr_offset_bytes(d_unique_d_in2_sqr))/sizeof(fp) < d_common.in2_sqr_elem)),
              ei_new < d_common.in2_sqr_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh_sel), ((__write_offset_bytes(d_unique_d_in2_sub_cumh_sel) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh_sel))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh_sel, (__write_offset_bytes(d_unique_d_in2_sub_cumh_sel) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh_sel))/sizeof(fp) < d_common.in2_sub_cumh_sel_elem)),
              ei_new < d_common.in2_sub_cumh_sel_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sqr_sub2, ((__write_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sqr_sub2, (__write_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              ei_new < d_common.in2_sub2_elem){
		...
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sqr_sub2, ((__write_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sqr_sub2, (__write_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              __global_invariant(__read_implies(d_unique_d_in2_sqr_sub2, ((__read_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_unique_d_in2_sqr_sub2, (__read_offset_bytes(d_unique_d_in2_sqr_sub2) - __ptr_offset_bytes(d_unique_d_in2_sqr_sub2))/sizeof(fp) < d_common.in2_sub2_elem)),
              ei_new < d_common.in2_sub2_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in_sqr, ((__write_offset_bytes(d_unique_d_in_sqr) - __ptr_offset_bytes(d_unique_d_in_sqr))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in_sqr, (__write_offset_bytes(d_unique_d_in_sqr) - __ptr_offset_bytes(d_unique_d_in_sqr))/sizeof(fp) < d_common.in_sqr_elem)),
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(in_partial_sum, ((__write_offset_bytes(in_partial_sum) - __ptr_offset_bytes(in_partial_sum))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(in_partial_sum, (__write_offset_bytes(in_partial_sum) - __ptr_offset_bytes(in_partial_sum))/sizeof(fp) < d_common.in_cols)),
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(in_sqr_partial_sum, ((__write_offset_bytes(in_sqr_partial_sum) - __ptr_offset_bytes(in_sqr_partial_sum))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(in_sqr_partial_sum, (__write_offset_bytes(in_sqr_partial_sum) - __ptr_offset_bytes(in_sqr_partial_sum))/sizeof(fp) < d_common.in_sqr_rows)),
              ei_new < d_common.in_sqr_rows){
