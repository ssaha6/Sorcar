...
var {:source_name "lastKnodeD"} {:global} $$lastKnodeD: [int]int;
...
var {:source_name "offset_2D"} {:global} $$offset_2D: [int]int;
...
var {:source_name "startD"} {:global} $$startD: [int]int;
...
var {:source_name "endD"} {:global} $$endD: [int]int;
...
var {:source_name "RecstartD"} {:global} $$RecstartD: [int]int;
...
var {:source_name "ReclenD"} {:global} $$ReclenD: [int]int;
...
procedure {:source_name "findRangeK"} {:kernel} $findRangeK($height: int, $knodes_elem: int);
...
implementation {:source_name "findRangeK"} {:kernel} $findRangeK($height: int, $knodes_elem: int)
{
  var $i.0: int;
  var v0$1: int;
  var v0$2: int;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _WRITE_HAS_OCCURRED_$$offset_2D ==> _WATCHED_OFFSET == group_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$offset_2D ==> _WATCHED_OFFSET == group_id_x$1;
    assert {:tag "nowrite"} _b18 ==> !_WRITE_HAS_OCCURRED_$$offset_2D;
    assert {:tag "noread"} _b17 ==> !_READ_HAS_OCCURRED_$$offset_2D;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _WRITE_HAS_OCCURRED_$$lastKnodeD ==> _WATCHED_OFFSET == group_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _READ_HAS_OCCURRED_$$lastKnodeD ==> _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1;
    assert {:tag "nowrite"} _b14 ==> !_WRITE_HAS_OCCURRED_$$lastKnodeD;
    assert {:tag "noread"} _b13 ==> !_READ_HAS_OCCURRED_$$lastKnodeD;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b12 ==> _WRITE_HAS_OCCURRED_$$offsetD ==> _WATCHED_OFFSET == group_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _READ_HAS_OCCURRED_$$offsetD ==> _WATCHED_OFFSET == group_id_x$1;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _READ_HAS_OCCURRED_$$currKnodeD ==> _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1 || _WATCHED_OFFSET == group_id_x$1;
  ...
  __partitioned_block_$falsebb_0:
    ...
    v57$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4))];
    v57$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4))];
    v58$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 1)];
    v58$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 1)];
    v59$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 2)];
    v59$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 2)];
    v60$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 3)];
    v60$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v56$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 3)];
    v61$1 := $$startD[v1$1];
    v61$2 := $$startD[v1$2];
    v62$1 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v60$1, v59$1), v58$1), v57$1) == v61$1;
    v62$2 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v60$2, v59$2), v58$2), v57$2) == v61$2;
    ...
    v64$1 := (if p14$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4))] else v64$1);
    v64$2 := (if p14$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4))] else v64$2);
    v65$1 := (if p14$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 1)] else v65$1);
    v65$2 := (if p14$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 1)] else v65$2);
    v66$1 := (if p14$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 2)] else v66$1);
    v66$2 := (if p14$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 2)] else v66$2);
    v67$1 := (if p14$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 3)] else v67$1);
    v67$2 := (if p14$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v63$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 3)] else v67$2);
    call {:sourceloc} {:sourceloc_num 83} _LOG_WRITE_$$RecstartD(p14$1, v1$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v67$1, v66$1), v65$1), v64$1), $$RecstartD[v1$1]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 83} _CHECK_WRITE_$$RecstartD(p14$2, v1$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(v67$2, v66$2), v65$2), v64$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$RecstartD"} true;
    $$RecstartD[v1$1] := (if p14$1 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v67$1, v66$1), v65$1), v64$1) else $$RecstartD[v1$1]);
    $$RecstartD[v1$2] := (if p14$2 then BV_CONCAT(BV_CONCAT(BV_CONCAT(v67$2, v66$2), v65$2), v64$2) else $$RecstartD[v1$2]);
    goto __partitioned_block_$falsebb_1;

  __partitioned_block_$falsebb_1:
    call {:sourceloc_num 85} $bugle_barrier_duplicated_0(-1, 0);
    ...
    v69$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4))];
    v69$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4))];
    v70$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 1)];
    v70$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 1)];
    v71$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 2)];
    v71$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 2)];
    v72$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 3)];
    v72$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v68$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 3)];
    v73$1 := $$endD[v1$1];
    v73$2 := $$endD[v1$2];
    v74$1 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v72$1, v71$1), v70$1), v69$1) == v73$1;
    v74$2 := BV_CONCAT(BV_CONCAT(BV_CONCAT(v72$2, v71$2), v70$2), v69$2) == v73$2;
    ...
    v76$1 := (if p16$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4))] else v76$1);
    v76$2 := (if p16$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4))] else v76$2);
    v77$1 := (if p16$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 1)] else v77$1);
    v77$2 := (if p16$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 1)] else v77$2);
    v78$1 := (if p16$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 2)] else v78$1);
    v78$2 := (if p16$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 2)] else v78$2);
    v79$1 := (if p16$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 3)] else v79$1);
    v79$2 := (if p16$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v75$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 3)] else v79$2);
    ...
    call {:sourceloc} {:sourceloc_num 99} _LOG_WRITE_$$ReclenD(p16$1, v1$1, BV32_ADD(BV32_SUB(BV_CONCAT(BV_CONCAT(BV_CONCAT(v79$1, v78$1), v77$1), v76$1), v80$1), 1), $$ReclenD[v1$1]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 99} _CHECK_WRITE_$$ReclenD(p16$2, v1$2, BV32_ADD(BV32_SUB(BV_CONCAT(BV_CONCAT(BV_CONCAT(v79$2, v78$2), v77$2), v76$2), v80$2), 1));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$ReclenD"} true;
    $$ReclenD[v1$1] := (if p16$1 then BV32_ADD(BV32_SUB(BV_CONCAT(BV_CONCAT(BV_CONCAT(v79$1, v78$1), v77$1), v76$1), v80$1), 1) else $$ReclenD[v1$1]);
    $$ReclenD[v1$2] := (if p16$2 then BV32_ADD(BV32_SUB(BV_CONCAT(BV_CONCAT(BV_CONCAT(v79$2, v78$2), v77$2), v76$2), v80$2), 1) else $$ReclenD[v1$2]);
    return;
  ...
  __partitioned_block_$truebb_0:
    ...
    call {:check_id "check_state_20"} {:sourceloc} {:sourceloc_num 30} _CHECK_WRITE_$$offsetD(p5$2, v1$2, BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v27$2, v26$2), v25$2), v24$2)));
    ...
    v29$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4))];
    v29$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4))];
    v30$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 1)];
    v30$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 1)];
    v31$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 2)];
    v31$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 2)];
    v32$1 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$1, 32, 0), 2068), 1032), BV32_MUL(v0$1, 4)), 3)];
    v32$2 := $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v28$2, 32, 0), 2068), 1032), BV32_MUL(v0$2, 4)), 3)];
    v33$1 := $$endD[v1$1];
    v33$2 := $$endD[v1$2];
    v34$1 := BV32_SLE(BV_CONCAT(BV_CONCAT(BV_CONCAT(v32$1, v31$1), v30$1), v29$1), v33$1);
    v34$2 := BV32_SLE(BV_CONCAT(BV_CONCAT(BV_CONCAT(v32$2, v31$2), v30$2), v29$2), v33$2);
    ...
    v36$1 := (if p7$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$1, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$1, 1), 4))] else v36$1);
    v36$2 := (if p7$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$2, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$2, 1), 4))] else v36$2);
    v37$1 := (if p7$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$1, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$1, 1), 4)), 1)] else v37$1);
    v37$2 := (if p7$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$2, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$2, 1), 4)), 1)] else v37$2);
    v38$1 := (if p7$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$1, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$1, 1), 4)), 2)] else v38$1);
    v38$2 := (if p7$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$2, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$2, 1), 4)), 2)] else v38$2);
    v39$1 := (if p7$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$1, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$1, 1), 4)), 3)] else v39$1);
    v39$2 := (if p7$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v35$2, 32, 0), 2068), 1032), BV32_MUL(BV32_ADD(v0$2, 1), 4)), 3)] else v39$2);
    v40$1 := (if p7$1 then $$endD[v1$1] else v40$1);
    v40$2 := (if p7$2 then $$endD[v1$2] else v40$2);
    v41$1 := (if p7$1 then BV32_SGT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v39$1, v38$1), v37$1), v36$1), v40$1) else v41$1);
    v41$2 := (if p7$2 then BV32_SGT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v39$2, v38$2), v37$2), v36$2), v40$2) else v41$2);
    ...
    v43$1 := (if p9$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4))] else v43$1);
    v43$2 := (if p9$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4))] else v43$2);
    v44$1 := (if p9$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 1)] else v44$1);
    v44$2 := (if p9$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 1)] else v44$2);
    v45$1 := (if p9$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 2)] else v45$1);
    v45$2 := (if p9$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 2)] else v45$2);
    v46$1 := (if p9$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 3)] else v46$1);
    v46$2 := (if p9$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v42$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 3)] else v46$2);
    v47$1 := (if p9$1 then BV64_SLT(BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v46$1, v45$1), v44$1), v43$1)), $knodes_elem) else v47$1);
    v47$2 := (if p9$2 then BV64_SLT(BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v46$2, v45$2), v44$2), v43$2)), $knodes_elem) else v47$2);
    ...
    v49$1 := (if p11$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4))] else v49$1);
    v49$2 := (if p11$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4))] else v49$2);
    v50$1 := (if p11$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 1)] else v50$1);
    v50$2 := (if p11$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 1)] else v50$2);
    v51$1 := (if p11$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 2)] else v51$1);
    v51$2 := (if p11$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 2)] else v51$2);
    v52$1 := (if p11$1 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$1, 32, 0), 2068), 4), BV32_MUL(v0$1, 4)), 3)] else v52$1);
    v52$2 := (if p11$2 then $$knodesD[BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(BV_EXTRACT(v48$2, 32, 0), 2068), 4), BV32_MUL(v0$2, 4)), 3)] else v52$2);
    call {:sourceloc} {:sourceloc_num 58} _LOG_WRITE_$$offset_2D(p11$1, v1$1, BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v52$1, v51$1), v50$1), v49$1)), $$offset_2D[v1$1]);
    ...
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 58} _CHECK_WRITE_$$offset_2D(p11$2, v1$2, BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v52$2, v51$2), v50$2), v49$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$offset_2D"} true;
    $$offset_2D[v1$1] := (if p11$1 then BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v52$1, v51$1), v50$1), v49$1)) else $$offset_2D[v1$1]);
    $$offset_2D[v1$2] := (if p11$2 then BV32_SEXT64(BV_CONCAT(BV_CONCAT(BV_CONCAT(v52$2, v51$2), v50$2), v49$2)) else $$offset_2D[v1$2]);
    goto __partitioned_block_$truebb_1;

  __partitioned_block_$truebb_1:
    call {:sourceloc_num 61} $bugle_barrier_duplicated_1(-1, 0);
    v53$1 := v0$1 == 0;
    v53$2 := v0$2 == 0;
  ...
  __partitioned_block_$truebb_2:
    call {:sourceloc_num 68} $bugle_barrier_duplicated_2(-1, 0);
    $i.0 := BV32_ADD($i.0, 1);
...
axiom (if num_groups_x == 6000 then 1 else 0) != 0;
...
const _WATCHED_VALUE_$$lastKnodeD: int;

procedure {:inline 1} _LOG_READ_$$lastKnodeD(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$lastKnodeD;



implementation {:inline 1} _LOG_READ_$$lastKnodeD(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$lastKnodeD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$lastKnodeD(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$lastKnodeD, _WRITE_READ_BENIGN_FLAG_$$lastKnodeD;



implementation {:inline 1} _LOG_WRITE_$$lastKnodeD(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$lastKnodeD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$lastKnodeD(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$lastKnodeD;



implementation {:inline 1} _LOG_ATOMIC_$$lastKnodeD(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$lastKnodeD(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$lastKnodeD(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$lastKnodeD;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$lastKnodeD(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$offset_2D: int;

procedure {:inline 1} _LOG_READ_$$offset_2D(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$offset_2D;



implementation {:inline 1} _LOG_READ_$$offset_2D(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$offset_2D(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$offset_2D(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$offset_2D, _WRITE_READ_BENIGN_FLAG_$$offset_2D;



implementation {:inline 1} _LOG_WRITE_$$offset_2D(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$offset_2D(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$offset_2D(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$offset_2D;



implementation {:inline 1} _LOG_ATOMIC_$$offset_2D(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$offset_2D(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$offset_2D(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$offset_2D;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$offset_2D(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$startD: int;

procedure {:inline 1} _LOG_READ_$$startD(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$startD;



implementation {:inline 1} _LOG_READ_$$startD(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$startD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$startD(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$startD, _WRITE_READ_BENIGN_FLAG_$$startD;



implementation {:inline 1} _LOG_WRITE_$$startD(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$startD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$startD(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$startD;



implementation {:inline 1} _LOG_ATOMIC_$$startD(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$startD(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$startD(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$startD;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$startD(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$endD: int;

procedure {:inline 1} _LOG_READ_$$endD(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$endD;



implementation {:inline 1} _LOG_READ_$$endD(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$endD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$endD(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$endD, _WRITE_READ_BENIGN_FLAG_$$endD;



implementation {:inline 1} _LOG_WRITE_$$endD(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$endD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$endD(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$endD;



implementation {:inline 1} _LOG_ATOMIC_$$endD(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$endD(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$endD(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$endD;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$endD(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$RecstartD: int;

procedure {:inline 1} _LOG_READ_$$RecstartD(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$RecstartD;



implementation {:inline 1} _LOG_READ_$$RecstartD(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$RecstartD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$RecstartD(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$RecstartD, _WRITE_READ_BENIGN_FLAG_$$RecstartD;



implementation {:inline 1} _LOG_WRITE_$$RecstartD(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$RecstartD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$RecstartD(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$RecstartD;



implementation {:inline 1} _LOG_ATOMIC_$$RecstartD(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$RecstartD(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$RecstartD(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$RecstartD;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$RecstartD(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$ReclenD: int;

procedure {:inline 1} _LOG_READ_$$ReclenD(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$ReclenD;



implementation {:inline 1} _LOG_READ_$$ReclenD(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$ReclenD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$ReclenD(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$ReclenD, _WRITE_READ_BENIGN_FLAG_$$ReclenD;



implementation {:inline 1} _LOG_WRITE_$$ReclenD(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$ReclenD(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$ReclenD(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$ReclenD;



implementation {:inline 1} _LOG_ATOMIC_$$ReclenD(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$ReclenD(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$ReclenD(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$ReclenD;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$ReclenD(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon2:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$lastKnodeD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$lastKnodeD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$lastKnodeD;
    goto anon3;

  anon3:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$offset_2D;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$offset_2D;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$offset_2D;
    goto anon4;

  anon4:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$RecstartD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$RecstartD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$RecstartD;
    goto anon5;

  anon5:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$ReclenD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$ReclenD;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$ReclenD;
    goto anon6;
