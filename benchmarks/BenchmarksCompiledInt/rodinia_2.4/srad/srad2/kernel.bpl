...
procedure {:source_name "srad2_kernel"} {:kernel} $srad2_kernel($d_lambda: int, $d_Nr: int, $d_Nc: int, $d_Ne: int);
...
implementation {:source_name "srad2_kernel"} {:kernel} $srad2_kernel($d_lambda: int, $d_Nr: int, $d_Nc: int, $d_Ne: int)
{
  var $row.0$1: int;
  var $row.0$2: int;
  var $col.0$1: int;
  ...
  $0:
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v13$1 := (if p2$1 then _HAVOC_int$1 else v13$1);
    v13$2 := (if p2$2 then _HAVOC_int$2 else v13$2);
    ...
    call {:sourceloc} {:sourceloc_num 15} _LOG_WRITE_$$d_I(p2$1, v0$1, FP64_CONV32(FADD64(FMUL64(FMUL64(4598175219545276416, FP32_CONV64($d_lambda)), FP32_CONV64(FADD32(FMUL32(v9$1, v13$1), FADD32(FMUL32(v7$1, v12$1), FADD32(FMUL32(v4$1, v10$1), FMUL32(v6$1, v11$1)))))), FP32_CONV64(v14$1))), $$d_I[v0$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 15} _CHECK_WRITE_$$d_I(p2$2, v0$2, FP64_CONV32(FADD64(FMUL64(FMUL64(4598175219545276416, FP32_CONV64($d_lambda)), FP32_CONV64(FADD32(FMUL32(v9$2, v13$2), FADD32(FMUL32(v7$2, v12$2), FADD32(FMUL32(v4$2, v10$2), FMUL32(v6$2, v11$2)))))), FP32_CONV64(v14$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_I"} true;
    $$d_I[v0$1] := (if p2$1 then FP64_CONV32(FADD64(FMUL64(FMUL64(4598175219545276416, FP32_CONV64($d_lambda)), FP32_CONV64(FADD32(FMUL32(v9$1, v13$1), FADD32(FMUL32(v7$1, v12$1), FADD32(FMUL32(v4$1, v10$1), FMUL32(v6$1, v11$1)))))), FP32_CONV64(v14$1))) else $$d_I[v0$1]);
    $$d_I[v0$2] := (if p2$2 then FP64_CONV32(FADD64(FMUL64(FMUL64(4598175219545276416, FP32_CONV64($d_lambda)), FP32_CONV64(FADD32(FMUL32(v9$2, v13$2), FADD32(FMUL32(v7$2, v12$2), FADD32(FMUL32(v4$2, v10$2), FMUL32(v6$2, v11$2)))))), FP32_CONV64(v14$2))) else $$d_I[v0$2]);
    return;
}
