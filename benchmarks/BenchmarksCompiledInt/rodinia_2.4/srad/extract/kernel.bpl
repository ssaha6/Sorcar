...
procedure {:source_name "extract_kernel"} {:kernel} $extract_kernel($d_Ne: int);
...
implementation {:source_name "extract_kernel"} {:kernel} $extract_kernel($d_Ne: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: bool;
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$d_I(p0$1, v0$1, FEXP32(FMUL32(FDIV32(v2$1, 1132396544), 1069066811)), $$d_I[v0$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$d_I(p0$2, v0$2, FEXP32(FMUL32(FDIV32(v2$2, 1132396544), 1069066811)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_I"} true;
    $$d_I[v0$1] := (if p0$1 then FEXP32(FMUL32(FDIV32(v2$1, 1132396544), 1069066811)) else $$d_I[v0$1]);
    $$d_I[v0$2] := (if p0$2 then FEXP32(FMUL32(FDIV32(v2$2, 1132396544), 1069066811)) else $$d_I[v0$2]);
    return;
}
