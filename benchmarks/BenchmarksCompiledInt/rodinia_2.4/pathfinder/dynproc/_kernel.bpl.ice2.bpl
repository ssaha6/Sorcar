...
assert  my_inv (  (  $i.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  (  !_WRITE_HAS_OCCURRED_$$outputBuffer ) ,  (  !_READ_HAS_OCCURRED_$$prev ) ,  (  !_WRITE_HAS_OCCURRED_$$prev ) ,  (  _READ_HAS_OCCURRED_$$prev ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$prev ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  !_READ_HAS_OCCURRED_$$result ) ,  (  !_WRITE_HAS_OCCURRED_$$result ) ,  (  _READ_HAS_OCCURRED_$$result ==> _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$result ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
