...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$coord_s ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p1$1 ==> _WRITE_HAS_OCCURRED_$$coord_s$ghost$$3 == _WRITE_HAS_OCCURRED_$$coord_s ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p2$1 ==> $i.0$1 mod 1 == 0 mod 1 )  && ( p2$2 ==> $i.0$2 mod 1 == 0 mod 1 ) ,  ( p2$1 ==> BV32_SLE($i.0$1, 0) )  && ( p2$2 ==> BV32_SLE($i.0$2, 0) ) ,  ( p2$1 ==> BV32_SGE($i.0$1, 0) )  && ( p2$2 ==> BV32_SGE($i.0$2, 0) ) ,  ( p2$1 ==> BV32_ULE($i.0$1, 0) )  && ( p2$2 ==> BV32_ULE($i.0$2, 0) ) ,  ( p2$1 ==> BV32_UGE($i.0$1, 0) )  && ( p2$2 ==> BV32_UGE($i.0$2, 0) ) ,  ( p2$1 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && local_id_x$1 == 0 )  && ( p2$2 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && local_id_x$2 == 0 ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && local_id_x$1 == 0 && BV32_SLT($i.0$1, $dim) ==> p2$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && local_id_x$2 == 0 && BV32_SLT($i.0$2, $dim) ==> p2$2 ) ,  (  _WRITE_HAS_OCCURRED_$$coord_s ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) ) ,  (  _WRITE_HAS_OCCURRED_$$coord_s ==> local_id_x$1 == 0 ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$coord_s ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !p0$1 ==> _READ_HAS_OCCURRED_$$coord_s$ghost$$8 == _READ_HAS_OCCURRED_$$coord_s )  ); 
...
assert  my_inv (  ( p5$1 ==> $i1.0$1 mod 1 == 0 mod 1 )  && ( p5$2 ==> $i1.0$2 mod 1 == 0 mod 1 ) ,  ( p5$1 ==> BV32_SLE($i1.0$1, 0) )  && ( p5$2 ==> BV32_SLE($i1.0$2, 0) ) ,  ( p5$1 ==> BV32_SGE($i1.0$1, 0) )  && ( p5$2 ==> BV32_SGE($i1.0$2, 0) ) ,  ( p5$1 ==> BV32_ULE($i1.0$1, 0) )  && ( p5$2 ==> BV32_ULE($i1.0$2, 0) ) ,  ( p5$1 ==> BV32_UGE($i1.0$1, 0) )  && ( p5$2 ==> BV32_UGE($i1.0$2, 0) ) ,  ( p5$1 ==> p5$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) )  && ( p5$2 ==> p5$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) && BV32_SLT($i1.0$1, $dim) ==> p5$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $num) && BV32_SLT($i1.0$2, $dim) ==> p5$2 ) ,  (  _READ_HAS_OCCURRED_$$coord_s ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $num) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
