...
implementation {:source_name "kernel_gpu_opencl"} {:kernel} $kernel_gpu_opencl($d_par_gpu.coerce: int, $d_dim_gpu.coerce0: int, $d_dim_gpu.coerce1: int, $d_dim_gpu.coerce2: int, $d_dim_gpu.coerce3: int, $d_dim_gpu.coerce4: int, $d_dim_gpu.coerce5: int, $d_dim_gpu.coerce6: int, $d_dim_gpu.coerce7: int, $d_dim_gpu.coerce8: int)
{
  ...
  $2:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b73 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$2 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b72 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($wtx.0$1, 100) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($wtx.0$2, 100) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b5 ==> p1$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b5 ==> p1$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b4 ==> BV32_UGE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b4 ==> BV32_UGE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b3 ==> BV32_ULE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b3 ==> BV32_ULE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b2 ==> BV32_SGE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b2 ==> BV32_SGE($wtx.0$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b1 ==> BV32_SLE($wtx.0$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b1 ==> BV32_SLE($wtx.0$2, v1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p1$1 ==> _b0 ==> $wtx.0$1 mod 128 == v1$1 mod 128;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p1$2 ==> _b0 ==> $wtx.0$2 mod 128 == v1$2 mod 128;
  ...
  $5:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b157 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$5 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b156 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$5 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b155 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> _WATCHED_OFFSET mod 128 == v1$1 mod 128;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b154 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b153 ==> !_WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "noread"} _b152 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b151 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$5 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b150 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$5 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b149 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b148 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    assert {:tag "nowrite"} _b147 ==> !_WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "noread"} _b146 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b145 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$5 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b144 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    assert {:tag "noread"} _b143 ==> !_READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "disabledMaintainsInstrumentation"} _b142 ==> !p0$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$5 == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b141 ==> !p0$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$5 == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "nowrite"} _b140 ==> !_WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "noread"} _b139 ==> !_READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "predicatedEquality"} _b138 ==> p3$1 && p3$2 ==> v84$1 == v84$2;
    assert {:tag "predicatedEquality"} _b137 ==> p3$1 && p3$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b136 ==> p3$1 && p3$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b135 ==> p3$1 && p3$2 ==> v81$1 == v81$2;
    assert {:tag "predicatedEquality"} _b134 ==> p3$1 && p3$2 ==> v80$1 == v80$2;
    assert {:tag "predicatedEquality"} _b133 ==> p3$1 && p3$2 ==> v79$1 == v79$2;
    assert {:tag "predicatedEquality"} _b132 ==> p3$1 && p3$2 ==> v78$1 == v78$2;
    assert {:tag "predicatedEquality"} _b131 ==> p3$1 && p3$2 ==> v77$1 == v77$2;
    assert {:tag "predicatedEquality"} _b130 ==> p3$1 && p3$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b129 ==> p3$1 && p3$2 ==> v75$1 == v75$2;
    assert {:tag "predicatedEquality"} _b128 ==> p3$1 && p3$2 ==> v74$1 == v74$2;
    assert {:tag "predicatedEquality"} _b127 ==> p3$1 && p3$2 ==> v73$1 == v73$2;
    assert {:tag "predicatedEquality"} _b126 ==> p3$1 && p3$2 ==> v72$1 == v72$2;
    assert {:tag "predicatedEquality"} _b125 ==> p3$1 && p3$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b124 ==> p3$1 && p3$2 ==> v70$1 == v70$2;
    assert {:tag "predicatedEquality"} _b123 ==> p3$1 && p3$2 ==> v69$1 == v69$2;
    assert {:tag "predicatedEquality"} _b122 ==> p3$1 && p3$2 ==> v68$1 == v68$2;
    ...
    assert {:tag "predicatedEquality"} _b118 ==> p3$1 && p3$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b117 ==> p3$1 && p3$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b116 ==> p3$1 && p3$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b115 ==> p3$1 && p3$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b114 ==> p3$1 && p3$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b113 ==> p3$1 && p3$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b112 ==> p3$1 && p3$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b111 ==> p3$1 && p3$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b110 ==> p3$1 && p3$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b109 ==> p3$1 && p3$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b108 ==> p3$1 && p3$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b107 ==> p3$1 && p3$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b106 ==> p3$1 && p3$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b105 ==> p3$1 && p3$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b104 ==> p3$1 && p3$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b103 ==> p3$1 && p3$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b102 ==> p3$1 && p3$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b101 ==> p3$1 && p3$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b100 ==> p3$1 && p3$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b99 ==> p3$1 && p3$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b98 ==> p3$1 && p3$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b97 ==> p3$1 && p3$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b96 ==> p3$1 && p3$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b95 ==> p3$1 && p3$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b94 ==> p3$1 && p3$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b93 ==> p3$1 && p3$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b92 ==> p3$1 && p3$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b91 ==> p3$1 && p3$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b90 ==> p3$1 && p3$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b89 ==> p3$1 && p3$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b88 ==> p3$1 && p3$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b87 ==> p3$1 && p3$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b86 ==> p3$1 && p3$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b85 ==> p3$1 && p3$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b84 ==> p3$1 && p3$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b83 ==> p3$1 && p3$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b82 ==> p3$1 && p3$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b81 ==> p3$1 && p3$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b80 ==> p3$1 && p3$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b79 ==> p3$1 && p3$2 ==> $wtx.3$1 == $wtx.3$2;
    assert {:tag "predicatedEquality"} _b78 ==> p3$1 && p3$2 ==> $wtx.2$1 == $wtx.2$2;
    assert {:tag "predicatedEquality"} _b77 ==> p3$1 && p3$2 ==> $pointer.0$1 == $pointer.0$2;
    assert {:tag "predicatedEquality"} _b76 ==> p3$1 && p3$2 ==> $k.0$1 == $k.0$2;
    assert {:tag "loopPredicateEquality"} _b75 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p3$1 == p3$2;
    assert {:tag "loopPredicateEquality"} _b74 ==> p3$1 == p3$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b21 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b14 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1))) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b14 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2))) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b13 ==> p3$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b13 ==> p3$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b12 ==> BV32_UGE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b12 ==> BV32_UGE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b11 ==> BV32_ULE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b11 ==> BV32_ULE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b10 ==> BV32_SGE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b10 ==> BV32_SGE($k.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b9 ==> BV32_SLE($k.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b9 ==> BV32_SLE($k.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p3$1 ==> _b8 ==> $k.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p3$2 ==> _b8 ==> $k.0$2 mod 1 == 0 mod 1;
  ...
  $10:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b161 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$10 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b160 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> _WATCHED_OFFSET mod 128 == v1$1 mod 128;
    assert {:tag "disabledMaintainsInstrumentation"} _b159 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$10 == _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b158 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p7$1 ==> p3$1;
    assert p7$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1))) && BV32_SLT($wtx.2$1, 100) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2))) && BV32_SLT($wtx.2$2, 100) ==> p7$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p7$1 ==> _b27 ==> p7$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p7$2 ==> _b27 ==> p7$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2)));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b26 ==> BV32_UGE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b26 ==> BV32_UGE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b25 ==> BV32_ULE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b25 ==> BV32_ULE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b24 ==> BV32_SGE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b24 ==> BV32_SGE($wtx.2$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b23 ==> BV32_SLE($wtx.2$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b23 ==> BV32_SLE($wtx.2$2, v1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b22 ==> $wtx.2$1 mod 128 == v1$1 mod 128;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b22 ==> $wtx.2$2 mod 128 == v1$2 mod 128;
  ...
  $13:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b169 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$13 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b168 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "disabledMaintainsInstrumentation"} _b167 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$13 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b166 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    assert {:tag "disabledMaintainsInstrumentation"} _b165 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$13 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b164 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    assert {:tag "disabledMaintainsInstrumentation"} _b163 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$13 == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b162 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$13 == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p9$1 ==> p3$1;
    assert p9$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b49 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b48 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b47 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b46 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b45 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b44 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b43 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b42 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b39 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1))) && BV32_SLT($wtx.3$1, 100) ==> p9$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b39 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2))) && BV32_SLT($wtx.3$2, 100) ==> p9$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p9$1 ==> _b38 ==> p9$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p9$2 ==> _b38 ==> p9$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2)));
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b37 ==> BV32_UGE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b37 ==> BV32_UGE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b36 ==> BV32_ULE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b36 ==> BV32_ULE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b35 ==> BV32_SGE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b35 ==> BV32_SGE($wtx.3$2, v1$2);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b34 ==> BV32_SLE($wtx.3$1, v1$1);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b34 ==> BV32_SLE($wtx.3$2, v1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p9$1 ==> _b33 ==> $wtx.3$1 mod 128 == v1$1 mod 128;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p9$2 ==> _b33 ==> $wtx.3$2 mod 128 == v1$2 mod 128;
  ...
  $15:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b177 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared$ghost$$15 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b176 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "disabledMaintainsInstrumentation"} _b175 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared$ghost$$15 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b174 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    assert {:tag "disabledMaintainsInstrumentation"} _b173 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared$ghost$$15 == _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b172 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_MUL(v1$1, 4) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 1) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 2) mod BV32_MUL(128, 4) || _WATCHED_OFFSET mod BV32_MUL(128, 4) == BV32_ADD(BV32_MUL(v1$1, 4), 3) mod BV32_MUL(128, 4);
    assert {:tag "disabledMaintainsInstrumentation"} _b171 ==> !p10$1 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu$ghost$$15 == _WRITE_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "disabledMaintainsInstrumentation"} _b170 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$d_fv_gpu$ghost$$15 == _READ_HAS_OCCURRED_$$d_fv_gpu;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p9$1 ==> p3$1;
    assert p9$2 ==> p3$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b71 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($wtx.3$1, 100);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b70 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b69 ==> _WRITE_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b68 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($wtx.3$1, 100);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b67 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b66 ==> _READ_HAS_OCCURRED_$$d_fv_gpu ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b65 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($wtx.3$1, 100);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b64 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b63 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.qB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b62 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($wtx.3$1, 100);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b61 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b60 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rB_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b59 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($wtx.3$1, 100);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b58 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1)));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b57 ==> _READ_HAS_OCCURRED_$$kernel_gpu_opencl.rA_shared ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0)));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b56 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1))) && BV32_SLT($wtx.3$1, 100) && BV32_SLT($j.0$1, 100) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b56 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2))) && BV32_SLT($wtx.3$2, 100) && BV32_SLT($j.0$2, 100) ==> p11$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p11$1 ==> _b55 ==> p11$1 ==> BV64_SLT(BV32_SEXT64(group_id_x$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$1, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$1, v29$1), v28$1), v27$1))) && BV32_SLT($wtx.3$1, 100);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p11$2 ==> _b55 ==> p11$2 ==> BV64_SLT(BV32_SEXT64(group_id_x$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_EXTRACT($d_dim_gpu.coerce4, 64, 56), BV_EXTRACT($d_dim_gpu.coerce4, 56, 48)), BV_EXTRACT($d_dim_gpu.coerce4, 48, 40)), BV_EXTRACT($d_dim_gpu.coerce4, 40, 32)), BV_EXTRACT($d_dim_gpu.coerce4, 32, 24)), BV_EXTRACT($d_dim_gpu.coerce4, 24, 16)), BV_EXTRACT($d_dim_gpu.coerce4, 16, 8)), BV_EXTRACT($d_dim_gpu.coerce4, 8, 0))) && BV32_SLT($k.0$2, BV32_ADD(1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v30$2, v29$2), v28$2), v27$2))) && BV32_SLT($wtx.3$2, 100);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b54 ==> BV32_UGE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b54 ==> BV32_UGE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b53 ==> BV32_ULE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b53 ==> BV32_ULE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b52 ==> BV32_SGE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b52 ==> BV32_SGE($j.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b51 ==> BV32_SLE($j.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b51 ==> BV32_SLE($j.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p11$1 ==> _b50 ==> $j.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p11$2 ==> _b50 ==> $j.0$2 mod 1 == 0 mod 1;
