...
implementation {:source_name "IMGVF_kernel"} {:kernel} $IMGVF_kernel($vx: int, $vy: int, $e: int, $max_iterations: int, $cutoff: int)
{
  ...
  $1:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLT($thread_block.0$1, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$1, v3$1), 256), 1), 256)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLT($thread_block.0$2, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$2, v3$2), 256), 1), 256)) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_UGE($thread_block.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_UGE($thread_block.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_ULE($thread_block.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_ULE($thread_block.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SGE($thread_block.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SGE($thread_block.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b1 ==> BV32_SLE($thread_block.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b1 ==> BV32_SLE($thread_block.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> $thread_block.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> $thread_block.0$2 mod 1 == 0 mod 1;
  ...
  $9:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b118 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_SUB(local_id_x$1, 256) || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b117 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_SUB(local_id_x$1, 256) || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b116 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "noread"} _b115 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b114 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.cell_converged ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b113 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.cell_converged ==> _WATCHED_OFFSET == 0;
    assert {:tag "nowrite"} _b112 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.cell_converged;
    assert {:tag "noread"} _b111 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.cell_converged;
    assert {:tag "nowrite"} _b110 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "noread"} _b109 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "predicatedEquality"} _b108 ==> p7$1 && p7$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b107 ==> p7$1 && p7$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b106 ==> p7$1 && p7$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b105 ==> p7$1 && p7$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b104 ==> p7$1 && p7$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b103 ==> p7$1 && p7$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b102 ==> p7$1 && p7$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b101 ==> p7$1 && p7$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b100 ==> p7$1 && p7$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b99 ==> p7$1 && p7$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b98 ==> p7$1 && p7$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b97 ==> p7$1 && p7$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b96 ==> p7$1 && p7$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b95 ==> p7$1 && p7$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b94 ==> p7$1 && p7$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b93 ==> p7$1 && p7$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b92 ==> p7$1 && p7$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b91 ==> p7$1 && p7$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b90 ==> p7$1 && p7$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b89 ==> p7$1 && p7$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b88 ==> p7$1 && p7$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b87 ==> p7$1 && p7$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b86 ==> p7$1 && p7$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b85 ==> p7$1 && p7$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b84 ==> p7$1 && p7$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b83 ==> p7$1 && p7$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b82 ==> p7$1 && p7$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b81 ==> p7$1 && p7$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b80 ==> p7$1 && p7$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b79 ==> p7$1 && p7$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b78 ==> p7$1 && p7$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b77 ==> p7$1 && p7$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b76 ==> p7$1 && p7$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b75 ==> p7$1 && p7$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b74 ==> p7$1 && p7$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b73 ==> p7$1 && p7$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b72 ==> p7$1 && p7$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b71 ==> p7$1 && p7$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b70 ==> p7$1 && p7$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b69 ==> p7$1 && p7$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b68 ==> p7$1 && p7$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b67 ==> p7$1 && p7$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b66 ==> p7$1 && p7$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b65 ==> p7$1 && p7$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b64 ==> p7$1 && p7$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b63 ==> p7$1 && p7$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b62 ==> p7$1 && p7$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b61 ==> p7$1 && p7$2 ==> $th.0$1 == $th.0$2;
    assert {:tag "predicatedEquality"} _b60 ==> p7$1 && p7$2 ==> $4$1 == $4$2;
    assert {:tag "predicatedEquality"} _b59 ==> p7$1 && p7$2 ==> $3$1 == $3$2;
    assert {:tag "predicatedEquality"} _b58 ==> p7$1 && p7$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b57 ==> p7$1 && p7$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b56 ==> p7$1 && p7$2 ==> $old_val.0$1 == $old_val.0$2;
    assert {:tag "predicatedEquality"} _b55 ==> p7$1 && p7$2 ==> $new_val.0$1 == $new_val.0$2;
    assert {:tag "predicatedEquality"} _b54 ==> p7$1 && p7$2 ==> $j.1$1 == $j.1$2;
    assert {:tag "predicatedEquality"} _b53 ==> p7$1 && p7$2 ==> $total_diff.0$1 == $total_diff.0$2;
    assert {:tag "predicatedEquality"} _b52 ==> p7$1 && p7$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b51 ==> p7$1 && p7$2 ==> $i.2$1 == $i.2$2;
    assert {:tag "predicatedEquality"} _b50 ==> p7$1 && p7$2 ==> $thread_block.1$1 == $thread_block.1$2;
    assert {:tag "predicatedEquality"} _b49 ==> p7$1 && p7$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b48 ==> p7$1 && p7$2 ==> $iterations.0$1 == $iterations.0$2;
    assert {:tag "predicatedEquality"} _b47 ==> p7$1 && p7$2 ==> $i.1$1 == $i.1$2;
    assert {:tag "loopPredicateEquality"} _b46 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p7$1 == p7$2;
    assert {:tag "loopPredicateEquality"} _b45 ==> p7$1 == p7$2;
    assert {:tag "pow2NotZero"} _b44 ==> $th.0$2 != 0;
    assert {:tag "pow2"} _b43 ==> $th.0$2 == 0 || BV32_AND($th.0$2, BV32_SUB($th.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b42 ==> $th.0$1 != 0;
    assert {:tag "pow2"} _b41 ==> $th.0$1 == 0 || BV32_AND($th.0$1, BV32_SUB($th.0$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.cell_converged ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> $0$1 == 1 ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> $0$2 == 1 ==> p7$2;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b6 ==> $iterations.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b6 ==> $iterations.0$2 mod 1 == 0 mod 1;
  ...
  __partitioned_block_$13_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b174 ==> !p10$1 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer$ghost$__partitioned_block_$13_0 == _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "disabledMaintainsInstrumentation"} _b173 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer$ghost$__partitioned_block_$13_0 == _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b172 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b171 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b170 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "noread"} _b169 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "disabledMaintainsInstrumentation"} _b168 ==> !p10$1 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF$ghost$__partitioned_block_$13_0 == _WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "disabledMaintainsInstrumentation"} _b167 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF$ghost$__partitioned_block_$13_0 == _READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "nowrite"} _b166 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "noread"} _b165 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF;
    assert {:tag "predicatedEquality"} _b164 ==> p11$1 && p11$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b163 ==> p11$1 && p11$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b162 ==> p11$1 && p11$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b161 ==> p11$1 && p11$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b160 ==> p11$1 && p11$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b159 ==> p11$1 && p11$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b158 ==> p11$1 && p11$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b157 ==> p11$1 && p11$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b156 ==> p11$1 && p11$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b155 ==> p11$1 && p11$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b154 ==> p11$1 && p11$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b153 ==> p11$1 && p11$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b152 ==> p11$1 && p11$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b151 ==> p11$1 && p11$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b150 ==> p11$1 && p11$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b149 ==> p11$1 && p11$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b148 ==> p11$1 && p11$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b147 ==> p11$1 && p11$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b146 ==> p11$1 && p11$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b145 ==> p11$1 && p11$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b144 ==> p11$1 && p11$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b143 ==> p11$1 && p11$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b142 ==> p11$1 && p11$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b141 ==> p11$1 && p11$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b140 ==> p11$1 && p11$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b139 ==> p11$1 && p11$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b138 ==> p11$1 && p11$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b137 ==> p11$1 && p11$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b136 ==> p11$1 && p11$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b135 ==> p11$1 && p11$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b134 ==> p11$1 && p11$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b133 ==> p11$1 && p11$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b132 ==> p11$1 && p11$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b131 ==> p11$1 && p11$2 ==> $4$1 == $4$2;
    assert {:tag "predicatedEquality"} _b130 ==> p11$1 && p11$2 ==> $3$1 == $3$2;
    assert {:tag "predicatedEquality"} _b129 ==> p11$1 && p11$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b128 ==> p11$1 && p11$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b127 ==> p11$1 && p11$2 ==> $old_val.0$1 == $old_val.0$2;
    assert {:tag "predicatedEquality"} _b126 ==> p11$1 && p11$2 ==> $new_val.0$1 == $new_val.0$2;
    assert {:tag "predicatedEquality"} _b125 ==> p11$1 && p11$2 ==> $j.1$1 == $j.1$2;
    assert {:tag "predicatedEquality"} _b124 ==> p11$1 && p11$2 ==> $total_diff.0$1 == $total_diff.0$2;
    assert {:tag "predicatedEquality"} _b123 ==> p11$1 && p11$2 ==> $j.0$1 == $j.0$2;
    assert {:tag "predicatedEquality"} _b122 ==> p11$1 && p11$2 ==> $i.2$1 == $i.2$2;
    assert {:tag "predicatedEquality"} _b121 ==> p11$1 && p11$2 ==> $thread_block.1$1 == $thread_block.1$2;
    assert {:tag "loopPredicateEquality"} _b120 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p11$1 == p11$2;
    assert {:tag "loopPredicateEquality"} _b119 ==> p11$1 == p11$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.cell_converged ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p11$1 ==> p7$1;
    assert p11$2 ==> p7$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b32 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> $0$1 == 1 && BV32_SLT($thread_block.1$1, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$1, v3$1), 256), 1), 256)) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> $0$2 == 1 && BV32_SLT($thread_block.1$2, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$2, v3$2), 256), 1), 256)) ==> p11$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p11$1 ==> _b27 ==> p11$1 ==> $0$1 == 1;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p11$2 ==> _b27 ==> p11$2 ==> $0$2 == 1;
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b26 ==> BV32_UGE($j.0$1, BV32_SUB(BV32_SREM(v5$1, v3$1), v14$1));
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b26 ==> BV32_UGE($j.0$2, BV32_SUB(BV32_SREM(v5$2, v3$2), v14$2));
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b25 ==> BV32_ULE($j.0$1, BV32_SUB(BV32_SREM(v5$1, v3$1), v14$1));
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b25 ==> BV32_ULE($j.0$2, BV32_SUB(BV32_SREM(v5$2, v3$2), v14$2));
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b24 ==> BV32_SGE($j.0$1, BV32_SUB(BV32_SREM(v5$1, v3$1), v14$1));
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b24 ==> BV32_SGE($j.0$2, BV32_SUB(BV32_SREM(v5$2, v3$2), v14$2));
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b23 ==> BV32_SLE($j.0$1, BV32_SUB(BV32_SREM(v5$1, v3$1), v14$1));
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b23 ==> BV32_SLE($j.0$2, BV32_SUB(BV32_SREM(v5$2, v3$2), v14$2));
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b22 ==> BV32_UGE($i.2$1, $i.1$1);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b22 ==> BV32_UGE($i.2$2, $i.1$2);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b21 ==> BV32_ULE($i.2$1, $i.1$1);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b21 ==> BV32_ULE($i.2$2, $i.1$2);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b20 ==> BV32_SGE($i.2$1, $i.1$1);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b20 ==> BV32_SGE($i.2$2, $i.1$2);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b19 ==> BV32_SLE($i.2$1, $i.1$1);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b19 ==> BV32_SLE($i.2$2, $i.1$2);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b18 ==> BV32_UGE($thread_block.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b18 ==> BV32_UGE($thread_block.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b17 ==> BV32_ULE($thread_block.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b17 ==> BV32_ULE($thread_block.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b16 ==> BV32_SGE($thread_block.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b16 ==> BV32_SGE($thread_block.1$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b15 ==> BV32_SLE($thread_block.1$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b15 ==> BV32_SLE($thread_block.1$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p11$1 ==> _b14 ==> $thread_block.1$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p11$2 ==> _b14 ==> $thread_block.1$2 mod 1 == 0 mod 1;
  ...
  __partitioned_block_$44_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b191 ==> !p10$1 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer$ghost$__partitioned_block_$44_0 == _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "disabledMaintainsInstrumentation"} _b190 ==> !p10$1 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer$ghost$__partitioned_block_$44_0 == _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b189 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b188 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b187 ==> !_WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "noread"} _b186 ==> !_READ_HAS_OCCURRED_$$IMGVF_kernel.buffer;
    assert {:tag "predicatedEquality"} _b185 ==> p35$1 && p35$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b184 ==> p35$1 && p35$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b183 ==> p35$1 && p35$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b182 ==> p35$1 && p35$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b181 ==> p35$1 && p35$2 ==> $th.0$1 == $th.0$2;
    assert {:tag "loopPredicateEquality"} _b180 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p35$1 == p35$2;
    assert {:tag "loopPredicateEquality"} _b179 ==> p35$1 == p35$2;
    assert {:tag "pow2NotZero"} _b178 ==> $th.0$2 != 0;
    assert {:tag "pow2"} _b177 ==> $th.0$2 == 0 || BV32_AND($th.0$2, BV32_SUB($th.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b176 ==> $th.0$1 != 0;
    assert {:tag "pow2"} _b175 ==> $th.0$1 == 0 || BV32_AND($th.0$1, BV32_SUB($th.0$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$IMGVF_kernel.cell_converged ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p35$1 ==> p7$1;
    assert p35$2 ==> p7$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _READ_HAS_OCCURRED_$$IMGVF_kernel.buffer ==> $0$1 == 1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b38 ==> $0$1 == 1 && BV32_SGT($th.0$1, 0) ==> p35$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b38 ==> $0$2 == 1 && BV32_SGT($th.0$2, 0) ==> p35$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p35$1 ==> _b37 ==> p35$1 ==> $0$1 == 1;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p35$2 ==> _b37 ==> p35$2 ==> $0$2 == 1;
    assert {:tag "loopBound"} {:thread 1} p35$1 ==> _b36 ==> BV32_UGE($th.0$1, 128);
    assert {:tag "loopBound"} {:thread 2} p35$2 ==> _b36 ==> BV32_UGE($th.0$2, 128);
    assert {:tag "loopBound"} {:thread 1} p35$1 ==> _b35 ==> BV32_ULE($th.0$1, 128);
    assert {:tag "loopBound"} {:thread 2} p35$2 ==> _b35 ==> BV32_ULE($th.0$2, 128);
    assert {:tag "loopBound"} {:thread 1} p35$1 ==> _b34 ==> BV32_SGE($th.0$1, 128);
    assert {:tag "loopBound"} {:thread 2} p35$2 ==> _b34 ==> BV32_SGE($th.0$2, 128);
    assert {:tag "loopBound"} {:thread 1} p35$1 ==> _b33 ==> BV32_SLE($th.0$1, 128);
    assert {:tag "loopBound"} {:thread 2} p35$2 ==> _b33 ==> BV32_SLE($th.0$2, 128);
  ...
  $55:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$IMGVF_kernel.IMGVF ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> BV32_SLT($thread_block.2$1, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$1, v3$1), 256), 1), 256)) ==> p43$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> BV32_SLT($thread_block.2$2, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_MUL(v2$2, v3$2), 256), 1), 256)) ==> p43$2;
    assert {:tag "loopBound"} {:thread 1} p43$1 ==> _b12 ==> BV32_UGE($thread_block.2$1, 0);
    assert {:tag "loopBound"} {:thread 2} p43$2 ==> _b12 ==> BV32_UGE($thread_block.2$2, 0);
    assert {:tag "loopBound"} {:thread 1} p43$1 ==> _b11 ==> BV32_ULE($thread_block.2$1, 0);
    assert {:tag "loopBound"} {:thread 2} p43$2 ==> _b11 ==> BV32_ULE($thread_block.2$2, 0);
    assert {:tag "loopBound"} {:thread 1} p43$1 ==> _b10 ==> BV32_SGE($thread_block.2$1, 0);
    assert {:tag "loopBound"} {:thread 2} p43$2 ==> _b10 ==> BV32_SGE($thread_block.2$2, 0);
    assert {:tag "loopBound"} {:thread 1} p43$1 ==> _b9 ==> BV32_SLE($thread_block.2$1, 0);
    assert {:tag "loopBound"} {:thread 2} p43$2 ==> _b9 ==> BV32_SLE($thread_block.2$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p43$1 ==> _b8 ==> $thread_block.2$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p43$2 ==> _b8 ==> $thread_block.2$2 mod 1 == 0 mod 1;
