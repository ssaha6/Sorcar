...
var {:source_name "c_sin_angle"} {:constant} $$c_sin_angle$1: [int]int;

var {:source_name "c_sin_angle"} {:constant} $$c_sin_angle$2: [int]int;

axiom {:array_info "$$c_sin_angle"} {:constant} {:elem_width 32} {:source_name "c_sin_angle"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:source_name "c_cos_angle"} {:constant} $$c_cos_angle$1: [int]int;

var {:source_name "c_cos_angle"} {:constant} $$c_cos_angle$2: [int]int;

axiom {:array_info "$$c_cos_angle"} {:constant} {:elem_width 32} {:source_name "c_cos_angle"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:source_name "c_tX"} {:constant} $$c_tX$1: [int]int;

var {:source_name "c_tX"} {:constant} $$c_tX$2: [int]int;

axiom {:array_info "$$c_tX"} {:constant} {:elem_width 32} {:source_name "c_tX"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:source_name "c_tY"} {:constant} $$c_tY$1: [int]int;

var {:source_name "c_tY"} {:constant} $$c_tY$2: [int]int;
...
procedure {:source_name "GICOV_kernel"} {:kernel} $GICOV_kernel($grad_m: int, $width: int, $height: int);
  requires {:sourceloc_num 0} {:thread 1} (if $grad_m == 219 then 1 else 0) != 0;
  requires {:sourceloc_num 1} {:thread 1} (if $width == 175 then 1 else 0) != 0;
  requires {:sourceloc_num 2} {:thread 1} (if $height == 596 then 1 else 0) != 0;
...
implementation {:source_name "GICOV_kernel"} {:kernel} $GICOV_kernel($grad_m: int, $width: int, $height: int)
{
  var $k.0$1: int;
  var $k.0$2: int;
  var $max_GICOV.0$1: int;
  var $max_GICOV.0$2: int;
  var $n.0$1: int;
  var $n.0$2: int;
  var $sum.0$1: int;
  var $sum.0$2: int;
  ...
  var $mean.0$1: int;
  var $mean.0$2: int;
  var $max_GICOV.1$1: int;
  var $max_GICOV.1$2: int;
  var v16$1: int;
  var v16$2: int;
  var v0$1: int;
  var v0$2: int;
  ...
  $0:
    ...
    v2$1 := (if p1$1 then BV32_ADD(BV32_SDIV(v0$1, $width), 22) else v2$1);
    v2$2 := (if p1$2 then BV32_ADD(BV32_SDIV(v0$2, $width), 22) else v2$2);
    v3$1 := (if p1$1 then BV32_ADD(BV32_SREM(v0$1, $width), 22) else v3$1);
    v3$2 := (if p1$2 then BV32_ADD(BV32_SREM(v0$2, $width), 22) else v3$2);
    $k.0$1, $max_GICOV.0$1 := (if p1$1 then 0 else $k.0$1), (if p1$1 then 0 else $max_GICOV.0$1);
    $k.0$2, $max_GICOV.0$2 := (if p1$2 then 0 else $k.0$2), (if p1$2 then 0 else $max_GICOV.0$2);
  ...
  $3:
    ...
    v4$1 := (if p2$1 then BV32_SLT($k.0$1, 7) else v4$1);
    v4$2 := (if p2$2 then BV32_SLT($k.0$2, 7) else v4$2);
    p3$1 := false;
    p3$2 := false;
    p4$1 := false;
    p4$2 := false;
    ...
    $n.0$1, $sum.0$1, $M2.0$1, $mean.0$1 := (if p3$1 then 0 else $n.0$1), (if p3$1 then 0 else $sum.0$1), (if p3$1 then 0 else $M2.0$1), (if p3$1 then 0 else $mean.0$1);
    $n.0$2, $sum.0$2, $M2.0$2, $mean.0$2 := (if p3$2 then 0 else $n.0$2), (if p3$2 then 0 else $sum.0$2), (if p3$2 then 0 else $M2.0$2), (if p3$2 then 0 else $mean.0$2);
  ...
  $5:
    ...
    v5$1 := (if p4$1 then BV32_SLT($n.0$1, 150) else v5$1);
    v5$2 := (if p4$2 then BV32_SLT($n.0$2, 150) else v5$2);
    p5$1 := false;
    p5$2 := false;
    p6$1 := false;
    p6$2 := false;
    ...
    v6$1 := (if p5$1 then $$c_tY$1[BV32_ADD(BV32_MUL($k.0$1, 150), $n.0$1)] else v6$1);
    v6$2 := (if p5$2 then $$c_tY$2[BV32_ADD(BV32_MUL($k.0$2, 150), $n.0$2)] else v6$2);
    v7$1 := (if p5$1 then $$c_tX$1[BV32_ADD(BV32_MUL($k.0$1, 150), $n.0$1)] else v7$1);
    v7$2 := (if p5$2 then $$c_tX$2[BV32_ADD(BV32_MUL($k.0$2, 150), $n.0$2)] else v7$2);
    ...
    v15$1 := (if p5$1 then FADD32($mean.0$1, FDIV32(v14$1, SI32_TO_FP32(BV32_ADD($n.0$1, 1)))) else v15$1);
    v15$2 := (if p5$2 then FADD32($mean.0$2, FDIV32(v14$2, SI32_TO_FP32(BV32_ADD($n.0$2, 1)))) else v15$2);
    $n.0$1, $sum.0$1, $M2.0$1, $mean.0$1 := (if p5$1 then BV32_ADD($n.0$1, 1) else $n.0$1), (if p5$1 then FADD32($sum.0$1, v13$1) else $sum.0$1), (if p5$1 then FADD32(FMUL32(v14$1, FSUB32(v13$1, v15$1)), $M2.0$1) else $M2.0$1), (if p5$1 then v15$1 else $mean.0$1);
    $n.0$2, $sum.0$2, $M2.0$2, $mean.0$2 := (if p5$2 then BV32_ADD($n.0$2, 1) else $n.0$2), (if p5$2 then FADD32($sum.0$2, v13$2) else $sum.0$2), (if p5$2 then FADD32(FMUL32(v14$2, FSUB32(v13$2, v15$2)), $M2.0$2) else $M2.0$2), (if p5$2 then v15$2 else $mean.0$2);
  ...
  $5.tail:
    assume !p4$1 && !p4$2;
    v16$1 := (if p3$1 then FDIV32($sum.0$1, 1125515264) else v16$1);
    v16$2 := (if p3$2 then FDIV32($sum.0$2, 1125515264) else v16$2);
    v17$1 := (if p3$1 then FDIV32($M2.0$1, 1125449728) else v17$1);
    v17$2 := (if p3$2 then FDIV32($M2.0$2, 1125449728) else v17$2);
    ...
    $k.0$1, $max_GICOV.0$1 := (if p3$1 then BV32_ADD($k.0$1, 1) else $k.0$1), (if p3$1 then $max_GICOV.1$1 else $max_GICOV.0$1);
    $k.0$2, $max_GICOV.0$2 := (if p3$2 then BV32_ADD($k.0$2, 1) else $k.0$2), (if p3$2 then $max_GICOV.1$2 else $max_GICOV.0$2);
...
const _WATCHED_VALUE_$$grad_x: int;

procedure {:inline 1} _LOG_READ_$$grad_x(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$grad_x;



implementation {:inline 1} _LOG_READ_$$grad_x(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$grad_x(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$grad_x(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$grad_x, _WRITE_READ_BENIGN_FLAG_$$grad_x;



implementation {:inline 1} _LOG_WRITE_$$grad_x(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$grad_x(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$grad_x(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$grad_x;



implementation {:inline 1} _LOG_ATOMIC_$$grad_x(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$grad_x(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$grad_x(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$grad_x;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$grad_x(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$grad_y: int;

procedure {:inline 1} _LOG_READ_$$grad_y(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$grad_y;



implementation {:inline 1} _LOG_READ_$$grad_y(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$grad_y(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$grad_y(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$grad_y, _WRITE_READ_BENIGN_FLAG_$$grad_y;



implementation {:inline 1} _LOG_WRITE_$$grad_y(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$grad_y(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$grad_y(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$grad_y;



implementation {:inline 1} _LOG_ATOMIC_$$grad_y(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$grad_y(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$grad_y(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$grad_y;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$grad_y(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$gicov: int;

procedure {:inline 1} _LOG_READ_$$gicov(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$gicov;



implementation {:inline 1} _LOG_READ_$$gicov(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$gicov(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$gicov(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$gicov, _WRITE_READ_BENIGN_FLAG_$$gicov;



implementation {:inline 1} _LOG_WRITE_$$gicov(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$gicov(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$gicov(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$gicov;



implementation {:inline 1} _LOG_ATOMIC_$$gicov(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$gicov(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$gicov(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$gicov;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$gicov(_P: bool, _offset: int)
{
