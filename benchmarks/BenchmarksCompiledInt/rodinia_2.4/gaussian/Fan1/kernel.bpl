...
implementation {:source_name "Fan1"} {:kernel} $Fan1($size: int, $t: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: bool;
  ...
  $0:
    ...
    v1$1 := BV32_SLT(v0$1, BV32_SUB(BV32_SUB($size, 1), $t));
    v1$2 := BV32_SLT(v0$2, BV32_SUB(BV32_SUB($size, 1), $t));
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$m_dev(p0$1, BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$1, $t), 1)), $t), FDIV32(v2$1, v3$1), $$m_dev[BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$1, $t), 1)), $t)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$m_dev(p0$2, BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$2, $t), 1)), $t));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$m_dev(p0$2, BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$2, $t), 1)), $t), FDIV32(v2$2, v3$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$m_dev"} true;
    $$m_dev[BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$1, $t), 1)), $t)] := (if p0$1 then FDIV32(v2$1, v3$1) else $$m_dev[BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$1, $t), 1)), $t)]);
    $$m_dev[BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$2, $t), 1)), $t)] := (if p0$2 then FDIV32(v2$2, v3$2) else $$m_dev[BV32_ADD(BV32_MUL($size, BV32_ADD(BV32_ADD(v0$2, $t), 1)), $t)]);
    return;
}
