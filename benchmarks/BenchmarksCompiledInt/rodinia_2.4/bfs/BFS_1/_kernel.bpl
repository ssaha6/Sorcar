...
implementation {:source_name "BFS_1"} {:kernel} $BFS_1($no_of_nodes: int)
{
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b16 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_cost$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_cost;
    assert {:tag "disabledMaintainsInstrumentation"} _b15 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$g_cost$ghost$$3 == _READ_HAS_OCCURRED_$$g_cost;
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b13 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$g_updating_graph_mask$ghost$$3 == _WRITE_HAS_OCCURRED_$$g_updating_graph_mask;
    assume {:predicate "p2"} {:dominator_predicate "p1"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _WRITE_HAS_OCCURRED_$$g_updating_graph_mask ==> BV8_SEXT32(v2$1) != 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b10 ==> _WRITE_HAS_OCCURRED_$$g_cost ==> BV8_SEXT32(v2$1) != 0;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$g_cost ==> BV8_SEXT32(v2$1) != 0;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes) && BV8_SEXT32(v2$1) != 0 && BV32_SLT($i.0$1, BV32_ADD(v5$1, v6$1)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes) && BV8_SEXT32(v2$2) != 0 && BV32_SLT($i.0$2, BV32_ADD(v5$2, v6$2)) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b5 ==> p2$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $no_of_nodes) && BV8_SEXT32(v2$1) != 0;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b5 ==> p2$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $no_of_nodes) && BV8_SEXT32(v2$2) != 0;
