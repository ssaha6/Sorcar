...
implementation {:source_name "likelihood_kernel"} {:kernel} $likelihood_kernel($Nparticles: bv32, $countOnes: bv32, $max_size: bv32, $k: bv32, $IszY: bv32, $Nfr: bv32)
{
  ...
  $4:
    ...
    assert {:tag "accessLowerBoundBlock"} _b31 ==> _WRITE_HAS_OCCURRED_$$ind ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $countOnes), _WATCHED_OFFSET);
    assert {:tag "accessUpperBoundBlock"} _b30 ==> _WRITE_HAS_OCCURRED_$$ind ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1), $countOnes));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$ind ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b13 ==> _READ_HAS_OCCURRED_$$arrayX ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _READ_HAS_OCCURRED_$$arrayY ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b11 ==> _READ_HAS_OCCURRED_$$ind ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b10 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles) && BV32_SLT($y.0$1, $countOnes) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b10 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $Nparticles) && BV32_SLT($y.0$2, $countOnes) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b9 ==> p3$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b9 ==> p3$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $Nparticles);
  ...
  $14:
    ...
    assert {:tag "accessLowerBoundBlock"} _b37 ==> _READ_HAS_OCCURRED_$$ind ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $countOnes), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p11"} {:dominator_predicate "p2"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$ind ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles) && BV32_SLT($x.i.0$1, $countOnes) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $Nparticles) && BV32_SLT($x.i.0$2, $countOnes) ==> p11$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p11$1 ==> _b20 ==> p11$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $Nparticles);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p11$2 ==> _b20 ==> p11$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $Nparticles);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b19 ==> BV32_UGE($x.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b19 ==> BV32_UGE($x.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b18 ==> BV32_ULE($x.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b18 ==> BV32_ULE($x.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b17 ==> BV32_SGE($x.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b17 ==> BV32_SGE($x.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b16 ==> BV32_SLE($x.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b16 ==> BV32_SLE($x.i.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p11$1 ==> _b15 ==> BV32_SLE(0bv32, $x.i.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p11$2 ==> _b15 ==> BV32_SLE(0bv32, $x.i.0$2);
  ...
  $19:
    ...
    assert {:tag "nowrite"} _b45 ==> !_WRITE_HAS_OCCURRED_$$buffer;
    assert {:tag "noread"} _b44 ==> !_READ_HAS_OCCURRED_$$buffer;
    assert {:tag "pow2NotZero"} _b43 ==> $s.0 != 0bv32;
    assert {:tag "pow2"} _b42 ==> $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$buffer ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
