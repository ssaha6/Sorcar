...
implementation {:source_name "normalize_weights_kernel"} {:kernel} $normalize_weights_kernel($Nparticles: int)
{
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b15 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$CDF$ghost$$6 == _WRITE_HAS_OCCURRED_$$CDF;
    assert {:tag "disabledMaintainsInstrumentation"} _b14 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$CDF$ghost$$6 == _READ_HAS_OCCURRED_$$CDF;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b13 ==> _WRITE_HAS_OCCURRED_$$CDF ==> _WATCHED_OFFSET mod 1 == 1 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b12 ==> _READ_HAS_OCCURRED_$$CDF ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "disabledMaintainsInstrumentation"} _b11 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$weights$ghost$$6 == _READ_HAS_OCCURRED_$$weights;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _READ_HAS_OCCURRED_$$weights ==> _WATCHED_OFFSET mod 1 == 1 mod 1;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _WRITE_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$CDF ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$weights ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0 && BV32_SLT($x.i.0$1, $Nparticles) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0 && BV32_SLT($x.i.0$2, $Nparticles) ==> p5$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b5 ==> p5$1 ==> BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) == 0;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b5 ==> p5$2 ==> BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) == 0;
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b4 ==> BV32_UGE($x.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b4 ==> BV32_UGE($x.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b3 ==> BV32_ULE($x.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b3 ==> BV32_ULE($x.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b2 ==> BV32_SGE($x.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b2 ==> BV32_SGE($x.i.0$2, 1);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b1 ==> BV32_SLE($x.i.0$1, 1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b1 ==> BV32_SLE($x.i.0$2, 1);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p5$1 ==> _b0 ==> $x.i.0$1 mod 1 == 1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p5$2 ==> _b0 ==> $x.i.0$2 mod 1 == 1 mod 1;
