...
assert  my_inv (  (  BV32_SLE($i.0, 1) ) ,  (  BV32_SGE($i.0, 1) ) ,  (  BV32_ULE($i.0, 1) ) ,  (  BV32_UGE($i.0, 1) ) ,  (  $i.0 == 0 || BV32_AND($i.0, BV32_SUB($i.0, 1)) == 0 ) ,  (  $i.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$weight_matrix ) ,  (  !_WRITE_HAS_OCCURRED_$$weight_matrix ) ,  (  _READ_HAS_OCCURRED_$$weight_matrix ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) || _WATCHED_OFFSET mod BV32_MUL(1, 16) == BV32_ADD(BV32_MUL(BV32_ADD(0, local_id_y$1), 16), local_id_x$1) mod BV32_MUL(1, 16) ) ,  (  _WRITE_HAS_OCCURRED_$$weight_matrix ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) )  ); 
