...
implementation {:source_name "lud_perimeter"} {:kernel} $lud_perimeter($matrix_dim: bv32, $offset: bv32)
{
  ...
  var _READ_HAS_OCCURRED_$$peri_row$ghost$$40: bool;
  var _WRITE_HAS_OCCURRED_$$m$ghost$$45: bool;
  var _READ_HAS_OCCURRED_$$peri_col$ghost$$45: bool;
  ...
  $2:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b95 ==> _WRITE_HAS_OCCURRED_$$dia ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b94 ==> _READ_HAS_OCCURRED_$$m ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b93 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.0$1, 8bv32) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b93 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.0$2, 8bv32) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b92 ==> p1$1 ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b92 ==> p1$2 ==> BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b91 ==> BV32_UGE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b91 ==> BV32_UGE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b90 ==> BV32_ULE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b90 ==> BV32_ULE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b89 ==> BV32_SGE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b89 ==> BV32_SGE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b88 ==> BV32_SLE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b88 ==> BV32_SLE($i.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p1$1 ==> _b87 ==> BV32_SLE(0bv32, $i.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p1$2 ==> _b87 ==> BV32_SLE(0bv32, $i.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p1$1 ==> _b86 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.0$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL($offset, $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p1$2 ==> _b86 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.0$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL($offset, $matrix_dim), $offset));
  ...
  $6:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b105 ==> _WRITE_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b104 ==> _READ_HAS_OCCURRED_$$m ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b103 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.1$1, 16bv32) ==> p3$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b103 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.1$2, 16bv32) ==> p3$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p3$1 ==> _b102 ==> p3$1 ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p3$2 ==> _b102 ==> p3$2 ==> BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b101 ==> BV32_UGE($i.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b101 ==> BV32_UGE($i.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b100 ==> BV32_ULE($i.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b100 ==> BV32_ULE($i.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b99 ==> BV32_SGE($i.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b99 ==> BV32_SGE($i.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p3$1 ==> _b98 ==> BV32_SLE($i.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p3$2 ==> _b98 ==> BV32_SLE($i.1$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p3$1 ==> _b97 ==> BV32_SLE(0bv32, $i.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p3$2 ==> _b97 ==> BV32_SLE(0bv32, $i.1$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p3$1 ==> _b96 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.1$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL($offset, $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p3$2 ==> _b96 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.1$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL($offset, $matrix_dim), $offset));
  ...
  $11:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _WRITE_HAS_OCCURRED_$$dia ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$m ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.2$1, 16bv32) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.2$2, 16bv32) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b6 ==> p6$1 ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b6 ==> p6$2 ==> !BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b5 ==> BV32_UGE($i.2$1, 8bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b5 ==> BV32_UGE($i.2$2, 8bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b4 ==> BV32_ULE($i.2$1, 8bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b4 ==> BV32_ULE($i.2$2, 8bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b3 ==> BV32_SGE($i.2$1, 8bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b3 ==> BV32_SGE($i.2$2, 8bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b2 ==> BV32_SLE($i.2$1, 8bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b2 ==> BV32_SLE($i.2$2, 8bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p6$1 ==> _b1 ==> BV32_SLE(0bv32, $i.2$1);
    assert {:tag "guardNonNeg"} {:thread 2} p6$2 ==> _b1 ==> BV32_SLE(0bv32, $i.2$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b0 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.2$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, 8bv32), $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b0 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.2$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, 8bv32), $matrix_dim), $offset));
  ...
  $15:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _WRITE_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$m ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b17 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.3$1, 16bv32) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b17 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.3$2, 16bv32) ==> p8$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b16 ==> p8$1 ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b16 ==> p8$2 ==> !BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b15 ==> BV32_UGE($i.3$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b15 ==> BV32_UGE($i.3$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b14 ==> BV32_ULE($i.3$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b14 ==> BV32_ULE($i.3$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b13 ==> BV32_SGE($i.3$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b13 ==> BV32_SGE($i.3$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b12 ==> BV32_SLE($i.3$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b12 ==> BV32_SLE($i.3$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p8$1 ==> _b11 ==> BV32_SLE(0bv32, $i.3$1);
    assert {:tag "guardNonNeg"} {:thread 2} p8$2 ==> _b11 ==> BV32_SLE(0bv32, $i.3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p8$1 ==> _b10 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.3$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, BV32_MUL(BV32_ADD(v0$1, 1bv32), 16bv32)), $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p8$2 ==> _b10 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.3$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, BV32_MUL(BV32_ADD(v0$2, 1bv32), 16bv32)), $matrix_dim), $offset));
  ...
  $21:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b72 ==> _WRITE_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b71 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b70 ==> _READ_HAS_OCCURRED_$$dia ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b69 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.4$1, 16bv32) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b69 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.4$2, 16bv32) ==> p11$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p11$1 ==> _b68 ==> p11$1 ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p11$2 ==> _b68 ==> p11$2 ==> BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b67 ==> BV32_UGE($i.4$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b67 ==> BV32_UGE($i.4$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b66 ==> BV32_ULE($i.4$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b66 ==> BV32_ULE($i.4$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b65 ==> BV32_SGE($i.4$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b65 ==> BV32_SGE($i.4$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b64 ==> BV32_SLE($i.4$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b64 ==> BV32_SLE($i.4$2, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p11$1 ==> _b63 ==> BV32_SLE(0bv32, $i.4$1);
    assert {:tag "guardNonNeg"} {:thread 2} p11$2 ==> _b63 ==> BV32_SLE(0bv32, $i.4$2);
  ...
  $23:
    ...
    assert p13$1 ==> p11$1;
    assert p13$2 ==> p11$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b85 ==> _WRITE_HAS_OCCURRED_$$peri_row ==> BV32_SLT($i.4$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b84 ==> _WRITE_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b83 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_SLT($i.4$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b82 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b81 ==> _READ_HAS_OCCURRED_$$dia ==> BV32_SLT($i.4$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b80 ==> _READ_HAS_OCCURRED_$$dia ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b79 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.4$1, 16bv32) && BV32_SLT($j.0$1, $i.4$1) ==> p13$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b79 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.4$2, 16bv32) && BV32_SLT($j.0$2, $i.4$2) ==> p13$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p13$1 ==> _b78 ==> p13$1 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.4$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p13$2 ==> _b78 ==> p13$2 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.4$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p13$1 ==> _b77 ==> BV32_UGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p13$2 ==> _b77 ==> BV32_UGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p13$1 ==> _b76 ==> BV32_ULE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p13$2 ==> _b76 ==> BV32_ULE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p13$1 ==> _b75 ==> BV32_SGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p13$2 ==> _b75 ==> BV32_SGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p13$1 ==> _b74 ==> BV32_SLE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p13$2 ==> _b74 ==> BV32_SLE($j.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p13$1 ==> _b73 ==> BV32_SLE(0bv32, $j.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p13$2 ==> _b73 ==> BV32_SLE(0bv32, $j.0$2);
  ...
  $30:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _WRITE_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b27 ==> _READ_HAS_OCCURRED_$$dia ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.5$1, 16bv32) ==> p16$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.5$2, 16bv32) ==> p16$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p16$1 ==> _b25 ==> p16$1 ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p16$2 ==> _b25 ==> p16$2 ==> !BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b24 ==> BV32_UGE($i.5$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b24 ==> BV32_UGE($i.5$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b23 ==> BV32_ULE($i.5$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b23 ==> BV32_ULE($i.5$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b22 ==> BV32_SGE($i.5$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b22 ==> BV32_SGE($i.5$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b21 ==> BV32_SLE($i.5$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b21 ==> BV32_SLE($i.5$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p16$1 ==> _b20 ==> BV32_SLE(0bv32, $i.5$1);
    assert {:tag "guardNonNeg"} {:thread 2} p16$2 ==> _b20 ==> BV32_SLE(0bv32, $i.5$2);
  ...
  $32:
    ...
    assert p18$1 ==> p16$1;
    assert p18$2 ==> p16$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b62 ==> _WRITE_HAS_OCCURRED_$$peri_col ==> BV32_SLT($i.5$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b61 ==> _WRITE_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b59 ==> _READ_HAS_OCCURRED_$$dia ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b58 ==> _READ_HAS_OCCURRED_$$peri_col ==> BV32_SLT($i.5$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b57 ==> _READ_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b56 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.5$1, 16bv32) && BV32_SLT($j.1$1, $i.5$1) ==> p18$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b56 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.5$2, 16bv32) && BV32_SLT($j.1$2, $i.5$2) ==> p18$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p18$1 ==> _b55 ==> p18$1 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.5$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p18$2 ==> _b55 ==> p18$2 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.5$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b54 ==> BV32_UGE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b54 ==> BV32_UGE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b53 ==> BV32_ULE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b53 ==> BV32_ULE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b52 ==> BV32_SGE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b52 ==> BV32_SGE($j.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b51 ==> BV32_SLE($j.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b51 ==> BV32_SLE($j.1$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p18$1 ==> _b50 ==> BV32_SLE(0bv32, $j.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p18$2 ==> _b50 ==> BV32_SLE(0bv32, $j.1$2);
  ...
  __partitioned_block_$30.tail_1:
    ...
    _READ_HAS_OCCURRED_$$peri_row$ghost$$40 := _READ_HAS_OCCURRED_$$peri_row;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $40;

  $40:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b135 ==> !p20$1 ==> _READ_HAS_OCCURRED_$$peri_row$ghost$$40 == _READ_HAS_OCCURRED_$$peri_row;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b134 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1));
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b49 ==> _WRITE_HAS_OCCURRED_$$m ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b48 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b47 ==> BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.6$1, 16bv32) ==> p21$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b47 ==> BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.6$2, 16bv32) ==> p21$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p21$1 ==> _b45 ==> BV32_UGE($i.6$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p21$2 ==> _b45 ==> BV32_UGE($i.6$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p21$1 ==> _b44 ==> BV32_ULE($i.6$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p21$2 ==> _b44 ==> BV32_ULE($i.6$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p21$1 ==> _b43 ==> BV32_SGE($i.6$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p21$2 ==> _b43 ==> BV32_SGE($i.6$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p21$1 ==> _b42 ==> BV32_SLE($i.6$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p21$2 ==> _b42 ==> BV32_SLE($i.6$2, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p21$1 ==> _b41 ==> BV32_SLE(0bv32, $i.6$1);
    assert {:tag "guardNonNeg"} {:thread 2} p21$2 ==> _b41 ==> BV32_SLE(0bv32, $i.6$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p21$1 ==> _b40 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.4$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, 1bv32), $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p21$2 ==> _b40 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.4$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, 1bv32), $matrix_dim), $offset));
    ...
    call {:sourceloc} {:sourceloc_num 81} _LOG_READ_$$peri_row(p22$1, BV32_ADD(BV32_MUL($i.6$1, 16bv32), v1$1), $$peri_row[1bv1][BV32_ADD(BV32_MUL($i.6$1, 16bv32), v1$1)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 81} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 81} _CHECK_READ_$$peri_row(p22$2, BV32_ADD(BV32_MUL($i.6$2, 16bv32), v1$2), $$peri_row[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($i.6$2, 16bv32), v1$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$peri_row"} true;
  ...
  $40.tail:
    ...
    _READ_HAS_OCCURRED_$$peri_col$ghost$$45 := _READ_HAS_OCCURRED_$$peri_col;
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $45;

  $45:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "disabledMaintainsInstrumentation"} _b137 ==> !p23$1 ==> _READ_HAS_OCCURRED_$$peri_col$ghost$$45 == _READ_HAS_OCCURRED_$$peri_col;
    assert {:tag "disabledMaintainsInstrumentation"} _b136 ==> !p23$1 ==> _WRITE_HAS_OCCURRED_$$m$ghost$$45 == _WRITE_HAS_OCCURRED_$$m;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$peri_col ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$peri_col ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$peri_col ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$peri_row ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _WRITE_HAS_OCCURRED_$$m ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b38 ==> _READ_HAS_OCCURRED_$$peri_col ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b37 ==> !BV32_SLT(local_id_x$1, 16bv32) && BV32_SLT($i.7$1, 16bv32) ==> p24$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b37 ==> !BV32_SLT(local_id_x$2, 16bv32) && BV32_SLT($i.7$2, 16bv32) ==> p24$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p24$1 ==> _b36 ==> p24$1 ==> !BV32_SLT(local_id_x$1, 16bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p24$2 ==> _b36 ==> p24$2 ==> !BV32_SLT(local_id_x$2, 16bv32);
    assert {:tag "loopBound"} {:thread 1} p24$1 ==> _b35 ==> BV32_UGE($i.7$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p24$2 ==> _b35 ==> BV32_UGE($i.7$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p24$1 ==> _b34 ==> BV32_ULE($i.7$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p24$2 ==> _b34 ==> BV32_ULE($i.7$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p24$1 ==> _b33 ==> BV32_SGE($i.7$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p24$2 ==> _b33 ==> BV32_SGE($i.7$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p24$1 ==> _b32 ==> BV32_SLE($i.7$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p24$2 ==> _b32 ==> BV32_SLE($i.7$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p24$1 ==> _b31 ==> BV32_SLE(0bv32, $i.7$1);
    assert {:tag "guardNonNeg"} {:thread 2} p24$2 ==> _b31 ==> BV32_SLE(0bv32, $i.7$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p24$1 ==> _b30 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.5$1) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, BV32_MUL(BV32_ADD(v0$1, 1bv32), 16bv32)), $matrix_dim), $offset));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p24$2 ==> _b30 ==> BV32_AND(BV32_SUB($matrix_dim, 1bv32), $array_offset.5$2) == BV32_AND(BV32_SUB($matrix_dim, 1bv32), BV32_ADD(BV32_MUL(BV32_ADD($offset, BV32_MUL(BV32_ADD(v0$2, 1bv32), 16bv32)), $matrix_dim), $offset));
    ...
    call {:sourceloc} {:sourceloc_num 91} _LOG_READ_$$peri_col(p25$1, BV32_ADD(BV32_MUL($i.7$1, 16bv32), v32$1), $$peri_col[1bv1][BV32_ADD(BV32_MUL($i.7$1, 16bv32), v32$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 91} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 91} _CHECK_READ_$$peri_col(p25$2, BV32_ADD(BV32_MUL($i.7$2, 16bv32), v32$2), $$peri_col[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($i.7$2, 16bv32), v32$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$peri_col"} true;
