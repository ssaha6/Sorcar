...
implementation {:source_name "MonteCarloOneBlockPerOption"} {:kernel} $_Z27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWi($pathN: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b37 ==> _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b34 ==> _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x;
    ...
    assert {:tag "predicatedEquality"} _b25 ==> p0$1 && p0$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b24 ==> p0$1 && p0$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b23 ==> p0$1 && p0$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b22 ==> p0$1 && p0$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b21 ==> p0$1 && p0$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b20 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    ...
    assert {:tag "predicatedEquality"} _b16 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b15 ==> p0$1 && p0$2 ==> $i.0$1 == $i.0$2;
    assert {:tag "predicatedEquality"} _b14 ==> p0$1 && p0$2 ==> $iSum.0$1 == $iSum.0$2;
    assert {:tag "loopPredicateEquality"} _b13 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b12 ==> p0$1 == p0$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLT($iSum.0$1, 256) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLT($iSum.0$2, 256) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_UGE($iSum.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_UGE($iSum.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_ULE($iSum.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_ULE($iSum.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SGE($iSum.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SGE($iSum.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b1 ==> BV32_SLE($iSum.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b1 ==> BV32_SLE($iSum.0$2, local_id_x$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> $iSum.0$1 mod group_size_x == local_id_x$1 mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> $iSum.0$2 mod group_size_x == local_id_x$2 mod group_size_x;
  ...
  __partitioned_block_$11_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b94 ==> _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b93 ==> _READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 32) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 16) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 8) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 4) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 2) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 1) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 64) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 128) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256;
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b91 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_MUL(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_MUL(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call;
    assert {:tag "nowrite"} _b90 ==> !_WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call;
    assert {:tag "noread"} _b89 ==> !_READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b88 ==> _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b87 ==> _READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 32) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 16) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 8) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 4) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 2) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 1) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 64) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256 || _WATCHED_OFFSET mod 256 == BV32_ADD(local_id_x$1, 128) mod 256 || _WATCHED_OFFSET mod 256 == local_id_x$1 mod 256;
    ...
    assert {:tag "nowrite"} _b84 ==> !_WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall;
    assert {:tag "noread"} _b83 ==> !_READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall;
    ...
    assert {:tag "predicatedEquality"} _b76 ==> p7$1 && p7$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b75 ==> p7$1 && p7$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b74 ==> p7$1 && p7$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b73 ==> p7$1 && p7$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b72 ==> p7$1 && p7$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b71 ==> p7$1 && p7$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b70 ==> p7$1 && p7$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b69 ==> p7$1 && p7$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b68 ==> p7$1 && p7$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b67 ==> p7$1 && p7$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b66 ==> p7$1 && p7$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b65 ==> p7$1 && p7$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b64 ==> p7$1 && p7$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b63 ==> p7$1 && p7$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b62 ==> p7$1 && p7$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b61 ==> p7$1 && p7$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b60 ==> p7$1 && p7$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b59 ==> p7$1 && p7$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b58 ==> p7$1 && p7$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b57 ==> p7$1 && p7$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b56 ==> p7$1 && p7$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b55 ==> p7$1 && p7$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b54 ==> p7$1 && p7$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b53 ==> p7$1 && p7$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b52 ==> p7$1 && p7$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b51 ==> p7$1 && p7$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b50 ==> p7$1 && p7$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b49 ==> p7$1 && p7$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b48 ==> p7$1 && p7$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b47 ==> p7$1 && p7$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b46 ==> p7$1 && p7$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b45 ==> p7$1 && p7$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b44 ==> p7$1 && p7$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b43 ==> p7$1 && p7$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b42 ==> p7$1 && p7$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b41 ==> p7$1 && p7$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b40 ==> p7$1 && p7$2 ==> $pos.i.0$1 == $pos.i.0$2;
    assert {:tag "loopPredicateEquality"} _b39 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p7$1 == p7$2;
    assert {:tag "loopPredicateEquality"} _b38 ==> p7$1 == p7$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE10s_Sum2Call ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ27MonteCarloOneBlockPerOptionP13__TOptionDataP14__TOptionValueP17curandStateXORWOWiE9s_SumCall ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b11 ==> BV32_SLT($pos.i.0$1, 256) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b11 ==> BV32_SLT($pos.i.0$2, 256) ==> p7$2;
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b10 ==> BV32_UGE($pos.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b10 ==> BV32_UGE($pos.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b9 ==> BV32_ULE($pos.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b9 ==> BV32_ULE($pos.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b8 ==> BV32_SGE($pos.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b8 ==> BV32_SGE($pos.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b7 ==> BV32_SLE($pos.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b7 ==> BV32_SLE($pos.i.0$2, local_id_x$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b6 ==> $pos.i.0$1 mod 256 == local_id_x$1 mod 256;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b6 ==> $pos.i.0$2 mod 256 == local_id_x$2 mod 256;
