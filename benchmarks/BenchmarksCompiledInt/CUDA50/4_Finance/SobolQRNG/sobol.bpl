...
implementation {:source_name "sobolGPU_kernel"} {:kernel} $_Z15sobolGPU_kerneljjPjPf($n_vectors: bv32, $n_dimensions: bv32)
{
  ...
  $9:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$_ZZ15sobolGPU_kerneljjPjPfE1v ==> _WATCHED_OFFSET == BV32_SUB(BV32_SUB(32bv32, v14$1), 1bv32);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p7$1 ==> _b5 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(v4$1, v5));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p7$2 ==> _b5 ==> BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(num_groups_x, group_size_x), 1bv32), BV32_ADD(v4$2, v5));
