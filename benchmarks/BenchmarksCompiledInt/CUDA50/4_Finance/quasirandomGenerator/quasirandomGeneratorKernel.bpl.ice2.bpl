...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SLE($pos.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SLE($pos.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_SGE($pos.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_SGE($pos.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_ULE($pos.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_ULE($pos.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  ( p0$1 ==> BV32_UGE($pos.0$1, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)) )  && ( p0$2 ==> BV32_UGE($pos.0$2, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)) ) ,  (  BV32_ULT($pos.0$1, $N) ==> p0$1 )  && (  BV32_ULT($pos.0$2, $N) ==> p0$2 ) ,  (  $data.0$1 == 0bv32 || BV32_AND($data.0$1, BV32_SUB($data.0$1, 1bv32)) == 0bv32 ) ,  (  $data.0$1 != 0bv32 ) ,  (  $data.0$2 == 0bv32 || BV32_AND($data.0$2, BV32_SUB($data.0$2, 1bv32)) == 0bv32 ) ,  (  $data.0$2 != 0bv32 ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), BV32_MUL(local_id_y$1, $N))) ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, $N) )  ); 
