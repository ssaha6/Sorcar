...
assert  my_inv (  ( p9$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos1.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) )  && ( p9$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos1.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$2) ) ,  ( p9$1 ==> BV32_SLE($pos1.0$1, v0$1) )  && ( p9$2 ==> BV32_SLE($pos1.0$2, v0$2) ) ,  ( p9$1 ==> BV32_SGE($pos1.0$1, v0$1) )  && ( p9$2 ==> BV32_SGE($pos1.0$2, v0$2) ) ,  ( p9$1 ==> BV32_ULE($pos1.0$1, v0$1) )  && ( p9$2 ==> BV32_ULE($pos1.0$2, v0$2) ) ,  ( p9$1 ==> BV32_UGE($pos1.0$1, v0$1) )  && ( p9$2 ==> BV32_UGE($pos1.0$2, v0$2) ) ,  ( p9$1 ==> p9$1 ==> MKPTR($arrayId$$d_Input, 0bv32) == MKPTR($arrayId$$null$, 0bv32) )  && ( p9$2 ==> p9$2 ==> MKPTR($arrayId$$d_Input, 0bv32) == MKPTR($arrayId$$null$, 0bv32) ) ,  (  MKPTR($arrayId$$d_Input, 0bv32) == MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos1.0$1, $pathN) ==> p9$1 )  && (  MKPTR($arrayId$$d_Input, 0bv32) == MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos1.0$2, $pathN) ==> p9$2 ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> MKPTR($arrayId$$d_Input, 0bv32) == MKPTR($arrayId$$null$, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) ) ,  true  ); 
    ...
    p17$1 := false;
    p17$2 := false;
    p10$1 := (if p9$1 && v13$1 then v13$1 else p10$1);
    ...
    v18$2 := (if p10$2 then FLT32(3201763901bv32, v17$2) else v18$2);
    p14$1 := (if p10$1 && v18$1 then v18$1 else p14$1);
    p14$2 := (if p10$2 && v18$2 then v18$2 else p14$2);
    p13$1 := (if p10$1 && !v18$1 then !v18$1 else p13$1);
    p13$2 := (if p10$2 && !v18$2 then !v18$2 else p13$2);
    call {:sourceloc_num 25} v20$1, v20$2 := $__logf(p13$1, v16$1, p13$2, v16$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$__logf"} true;
    call {:sourceloc_num 26} v21$1, v21$2 := $__logf(p13$1, FSUB32(2147483648bv32, v20$1), p13$2, FSUB32(2147483648bv32, v20$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$__logf"} true;
    $z.i.0$1 := (if p13$1 then FSUB32(2147483648bv32, FADD32(1051511190bv32, FMUL32(v21$1, FADD32(1064953398bv32, FMUL32(v21$1, FADD32(1042589753bv32, FMUL32(v21$1, FADD32(1021474156bv32, FMUL32(v21$1, FADD32(997962271bv32, FMUL32(v21$1, FADD32(969879925bv32, FMUL32(v21$1, FADD32(939980176bv32, FMUL32(v21$1, FADD32(882577068bv32, FMUL32(v21$1, 886349352bv32))))))))))))))))) else $z.i.0$1);
    $z.i.0$2 := (if p13$2 then FSUB32(2147483648bv32, FADD32(1051511190bv32, FMUL32(v21$2, FADD32(1064953398bv32, FMUL32(v21$2, FADD32(1042589753bv32, FMUL32(v21$2, FADD32(1021474156bv32, FMUL32(v21$2, FADD32(997962271bv32, FMUL32(v21$2, FADD32(969879925bv32, FMUL32(v21$2, FADD32(939980176bv32, FMUL32(v21$2, FADD32(882577068bv32, FMUL32(v21$2, 886349352bv32))))))))))))))))) else $z.i.0$2);
    v19$1 := (if p14$1 then FMUL32(v17$1, v17$1) else v19$1);
    v19$2 := (if p14$2 then FMUL32(v17$2, v17$2) else v19$2);
    $z.i.0$1 := (if p14$1 then FDIV32(FMUL32(v17$1, FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(3251341131bv32, v19$1), 1109758102bv32), v19$1), 3247762309bv32), v19$1), 1075866777bv32)), FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(1078484865bv32, v19$1), 3249045368bv32), v19$1), 1102621373bv32), v19$1), 3238499200bv32), v19$1), 1065353216bv32)) else $z.i.0$1);
    $z.i.0$2 := (if p14$2 then FDIV32(FMUL32(v17$2, FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(3251341131bv32, v19$2), 1109758102bv32), v19$2), 3247762309bv32), v19$2), 1075866777bv32)), FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(FADD32(FMUL32(1078484865bv32, v19$2), 3249045368bv32), v19$2), 1102621373bv32), v19$2), 3238499200bv32), v19$2), 1065353216bv32)) else $z.i.0$2);
    v22$1 := (if p10$1 then $negate.i.0$1[1:0] == 1bv1 else v22$1);
    v22$2 := (if p10$2 then $negate.i.0$2[1:0] == 1bv1 else v22$2);
    p16$1 := (if p10$1 && v22$1 then v22$1 else p16$1);
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $pos.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$2) ) ,  ( p0$1 ==> BV32_SLE($pos.0$1, v0$1) )  && ( p0$2 ==> BV32_SLE($pos.0$2, v0$2) ) ,  ( p0$1 ==> BV32_SGE($pos.0$1, v0$1) )  && ( p0$2 ==> BV32_SGE($pos.0$2, v0$2) ) ,  ( p0$1 ==> BV32_ULE($pos.0$1, v0$1) )  && ( p0$2 ==> BV32_ULE($pos.0$2, v0$2) ) ,  ( p0$1 ==> BV32_UGE($pos.0$1, v0$1) )  && ( p0$2 ==> BV32_UGE($pos.0$2, v0$2) ) ,  ( p0$1 ==> p0$1 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) )  && ( p0$2 ==> p0$2 ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) ) ,  (  MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos.0$1, $pathN) ==> p0$1 )  && (  MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) && BV32_ULT($pos.0$2, $pathN) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> MKPTR($arrayId$$d_Input, 0bv32) != MKPTR($arrayId$$null$, 0bv32) ) ,  true ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), v0$1) )  ); 
