...
function {:inline true} __add_noovfl_2(v0: int, v1: int) : int
{
  (if BV_EXTRACT(BV34_ADD(BV_CONCAT(0, v0), BV_CONCAT(0, v1)), 34, 32) == 0 then 1 else 0)
}
...
implementation {:source_name "compactVoxels"} {:kernel} $_Z13compactVoxelsPjS_S_j($numVoxels: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
...
const _WATCHED_VALUE_$$voxelOccupiedScan: int;

procedure {:inline 1} _LOG_READ_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$voxelOccupiedScan;



implementation {:inline 1} _LOG_READ_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$voxelOccupiedScan, _WRITE_READ_BENIGN_FLAG_$$voxelOccupiedScan;



implementation {:inline 1} _LOG_WRITE_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$voxelOccupiedScan(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$voxelOccupiedScan(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$voxelOccupiedScan;



implementation {:inline 1} _LOG_ATOMIC_$$voxelOccupiedScan(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$voxelOccupiedScan(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$voxelOccupiedScan(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$voxelOccupiedScan;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$voxelOccupiedScan(_P: bool, _offset: int)
{
