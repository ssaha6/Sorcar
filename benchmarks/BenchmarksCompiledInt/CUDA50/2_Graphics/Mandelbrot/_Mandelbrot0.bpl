...
implementation {:source_name "Mandelbrot0<float>"} {:kernel} $_Z11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiib($imageW: int, $imageH: int, $crunch: int, $xOff: int, $yOff: int, $xJP: int, $yJP: int, $scale: int, $colors.coerce0: int, $colors.coerce1: int, $colors.coerce2: int, $colors.coerce3: int, $frame: int, $animationFrame: int, $gridWidth: int, $numBlocks: int, $isJ: int)
{
  ...
  __partitioned_block_$1_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b175 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b174 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockY ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b171 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b170 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE6blockX ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b167 ==> _WRITE_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b166 ==> _READ_HAS_OCCURRED_$$_ZZ11Mandelbrot0IfEvP6uchar4iiiT_S2_S2_S2_S2_S0_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b163 ==> _ATOMIC_HAS_OCCURRED_$$blockCounter ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "predicatedEquality"} _b139 ==> p0$1 && p0$2 ==> v114$1 == v114$2;
    assert {:tag "predicatedEquality"} _b138 ==> p0$1 && p0$2 ==> v115$1 == v115$2;
    ...
    assert {:tag "predicatedEquality"} _b132 ==> p0$1 && p0$2 ==> v107$1 == v107$2;
    assert {:tag "predicatedEquality"} _b131 ==> p0$1 && p0$2 ==> v108$1 == v108$2;
    ...
    assert {:tag "predicatedEquality"} _b127 ==> p0$1 && p0$2 ==> v102$1 == v102$2;
    assert {:tag "predicatedEquality"} _b126 ==> p0$1 && p0$2 ==> v103$1 == v103$2;
    ...
    assert {:tag "predicatedEquality"} _b122 ==> p0$1 && p0$2 ==> v97$1 == v97$2;
    assert {:tag "predicatedEquality"} _b121 ==> p0$1 && p0$2 ==> v98$1 == v98$2;
    ...
    assert {:tag "predicatedEquality"} _b117 ==> p0$1 && p0$2 ==> v92$1 == v92$2;
    assert {:tag "predicatedEquality"} _b116 ==> p0$1 && p0$2 ==> v93$1 == v93$2;
    ...
    assert {:tag "predicatedEquality"} _b112 ==> p0$1 && p0$2 ==> v87$1 == v87$2;
    assert {:tag "predicatedEquality"} _b111 ==> p0$1 && p0$2 ==> v88$1 == v88$2;
    ...
    assert {:tag "predicatedEquality"} _b107 ==> p0$1 && p0$2 ==> v79$1 == v79$2;
    assert {:tag "predicatedEquality"} _b106 ==> p0$1 && p0$2 ==> v77$1 == v77$2;
    assert {:tag "predicatedEquality"} _b105 ==> p0$1 && p0$2 ==> v78$1 == v78$2;
    assert {:tag "predicatedEquality"} _b104 ==> p0$1 && p0$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b103 ==> p0$1 && p0$2 ==> v75$1 == v75$2;
    assert {:tag "predicatedEquality"} _b102 ==> p0$1 && p0$2 ==> v74$1 == v74$2;
    assert {:tag "predicatedEquality"} _b101 ==> p0$1 && p0$2 ==> v72$1 == v72$2;
    assert {:tag "predicatedEquality"} _b100 ==> p0$1 && p0$2 ==> v73$1 == v73$2;
    assert {:tag "predicatedEquality"} _b99 ==> p0$1 && p0$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b98 ==> p0$1 && p0$2 ==> v70$1 == v70$2;
    assert {:tag "predicatedEquality"} _b97 ==> p0$1 && p0$2 ==> v69$1 == v69$2;
    assert {:tag "predicatedEquality"} _b96 ==> p0$1 && p0$2 ==> v67$1 == v67$2;
    assert {:tag "predicatedEquality"} _b95 ==> p0$1 && p0$2 ==> v68$1 == v68$2;
    assert {:tag "predicatedEquality"} _b94 ==> p0$1 && p0$2 ==> v66$1 == v66$2;
    assert {:tag "predicatedEquality"} _b93 ==> p0$1 && p0$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b92 ==> p0$1 && p0$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b91 ==> p0$1 && p0$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b90 ==> p0$1 && p0$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b89 ==> p0$1 && p0$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b88 ==> p0$1 && p0$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b87 ==> p0$1 && p0$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b86 ==> p0$1 && p0$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b85 ==> p0$1 && p0$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b84 ==> p0$1 && p0$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b83 ==> p0$1 && p0$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b82 ==> p0$1 && p0$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b81 ==> p0$1 && p0$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b80 ==> p0$1 && p0$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b79 ==> p0$1 && p0$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b78 ==> p0$1 && p0$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b77 ==> p0$1 && p0$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b76 ==> p0$1 && p0$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b75 ==> p0$1 && p0$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b74 ==> p0$1 && p0$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b73 ==> p0$1 && p0$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b72 ==> p0$1 && p0$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b71 ==> p0$1 && p0$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b69 ==> p0$1 && p0$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b68 ==> p0$1 && p0$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b67 ==> p0$1 && p0$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b66 ==> p0$1 && p0$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b65 ==> p0$1 && p0$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b63 ==> p0$1 && p0$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b61 ==> p0$1 && p0$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b60 ==> p0$1 && p0$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b58 ==> p0$1 && p0$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b57 ==> p0$1 && p0$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b56 ==> p0$1 && p0$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b55 ==> p0$1 && p0$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b54 ==> p0$1 && p0$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b53 ==> p0$1 && p0$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b52 ==> p0$1 && p0$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b51 ==> p0$1 && p0$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b49 ==> p0$1 && p0$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b45 ==> p0$1 && p0$2 ==> v18$1 == v18$2;
    ...
    assert {:tag "predicatedEquality"} _b30 ==> p0$1 && p0$2 ==> v2$1 == v2$2;
    assert {:tag "predicatedEquality"} _b29 ==> p0$1 && p0$2 ==> v1$1 == v1$2;
    assert {:tag "predicatedEquality"} _b28 ==> p0$1 && p0$2 ==> v0$1 == v0$2;
    assert {:tag "predicatedEquality"} _b27 ==> p0$1 && p0$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b26 ==> p0$1 && p0$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b25 ==> p0$1 && p0$2 ==> v81$1 == v81$2;
    assert {:tag "predicatedEquality"} _b24 ==> p0$1 && p0$2 ==> v80$1 == v80$2;
    ...
    assert {:tag "pow2NotZero"} _b8 ==> v129$2 != 0;
    assert {:tag "pow2"} _b7 ==> v129$2 == 0 || BV32_AND(v129$2, BV32_SUB(v129$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b6 ==> v129$1 != 0;
    assert {:tag "pow2"} _b5 ==> v129$1 == 0 || BV32_AND(v129$1, BV32_SUB(v129$1, 1)) == 0;
    assert {:tag "pow2NotZero"} _b4 ==> v128$2 != 0;
    assert {:tag "pow2"} _b3 ==> v128$2 == 0 || BV32_AND(v128$2, BV32_SUB(v128$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b2 ==> v128$1 != 0;
    assert {:tag "pow2"} _b1 ==> v128$1 == 0 || BV32_AND(v128$1, BV32_SUB(v128$1, 1)) == 0;
