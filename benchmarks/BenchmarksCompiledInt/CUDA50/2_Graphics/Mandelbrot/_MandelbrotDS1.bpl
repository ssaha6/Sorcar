...
var {:source_name "blockIndex"} {:group_shared} $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex: [int]int;
...
var {:source_name "blockX"} {:group_shared} $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX: [int]int;
...
var {:source_name "blockY"} {:group_shared} $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY: [int]int;
...
procedure {:source_name "MandelbrotDS1"} {:kernel} $_Z13MandelbrotDS1P6uchar4iiifffffffS_iiiib($imageW: int, $imageH: int, $crunch: int, $xOff0: int, $xOff1: int, $yOff0: int, $yOff1: int, $xJP: int, $yJP: int, $scale: int, $colors.coerce0: int, $colors.coerce1: int, $colors.coerce2: int, $colors.coerce3: int, $frame: int, $animationFrame: int, $gridWidth: int, $numBlocks: int, $isJ: int);
...
implementation {:source_name "MandelbrotDS1"} {:kernel} $_Z13MandelbrotDS1P6uchar4iiifffffffS_iiiib($imageW: int, $imageH: int, $crunch: int, $xOff0: int, $xOff1: int, $yOff0: int, $yOff1: int, $xJP: int, $yJP: int, $scale: int, $colors.coerce0: int, $colors.coerce1: int, $colors.coerce2: int, $colors.coerce3: int, $frame: int, $animationFrame: int, $gridWidth: int, $numBlocks: int, $isJ: int)
{
  ...
  __partitioned_block_$1_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b269 ==> _WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b268 ==> _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b265 ==> _WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b264 ==> _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b261 ==> _WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b260 ==> _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b257 ==> _ATOMIC_HAS_OCCURRED_$$blockCounter ==> _WATCHED_OFFSET == 0;
    ...
    assert {:tag "predicatedEquality"} _b231 ==> p0$1 && p0$2 ==> v173$1 == v173$2;
    assert {:tag "predicatedEquality"} _b230 ==> p0$1 && p0$2 ==> v172$1 == v172$2;
    assert {:tag "predicatedEquality"} _b229 ==> p0$1 && p0$2 ==> v171$1 == v171$2;
    assert {:tag "predicatedEquality"} _b228 ==> p0$1 && p0$2 ==> v170$1 == v170$2;
    assert {:tag "predicatedEquality"} _b227 ==> p0$1 && p0$2 ==> v169$1 == v169$2;
    assert {:tag "predicatedEquality"} _b226 ==> p0$1 && p0$2 ==> v168$1 == v168$2;
    assert {:tag "predicatedEquality"} _b225 ==> p0$1 && p0$2 ==> v167$1 == v167$2;
    assert {:tag "predicatedEquality"} _b224 ==> p0$1 && p0$2 ==> v166$1 == v166$2;
    assert {:tag "predicatedEquality"} _b223 ==> p0$1 && p0$2 ==> v165$1 == v165$2;
    assert {:tag "predicatedEquality"} _b222 ==> p0$1 && p0$2 ==> v164$1 == v164$2;
    assert {:tag "predicatedEquality"} _b221 ==> p0$1 && p0$2 ==> v163$1 == v163$2;
    assert {:tag "predicatedEquality"} _b220 ==> p0$1 && p0$2 ==> v162$1 == v162$2;
    assert {:tag "predicatedEquality"} _b219 ==> p0$1 && p0$2 ==> v161$1 == v161$2;
    assert {:tag "predicatedEquality"} _b218 ==> p0$1 && p0$2 ==> v160$1 == v160$2;
    assert {:tag "predicatedEquality"} _b217 ==> p0$1 && p0$2 ==> v159$1 == v159$2;
    assert {:tag "predicatedEquality"} _b216 ==> p0$1 && p0$2 ==> v158$1 == v158$2;
    assert {:tag "predicatedEquality"} _b215 ==> p0$1 && p0$2 ==> v157$1 == v157$2;
    assert {:tag "predicatedEquality"} _b214 ==> p0$1 && p0$2 ==> v156$1 == v156$2;
    assert {:tag "predicatedEquality"} _b213 ==> p0$1 && p0$2 ==> v155$1 == v155$2;
    assert {:tag "predicatedEquality"} _b212 ==> p0$1 && p0$2 ==> v154$1 == v154$2;
    assert {:tag "predicatedEquality"} _b211 ==> p0$1 && p0$2 ==> v153$1 == v153$2;
    assert {:tag "predicatedEquality"} _b210 ==> p0$1 && p0$2 ==> v152$1 == v152$2;
    assert {:tag "predicatedEquality"} _b209 ==> p0$1 && p0$2 ==> v151$1 == v151$2;
    assert {:tag "predicatedEquality"} _b208 ==> p0$1 && p0$2 ==> v150$1 == v150$2;
    assert {:tag "predicatedEquality"} _b207 ==> p0$1 && p0$2 ==> v149$1 == v149$2;
    assert {:tag "predicatedEquality"} _b206 ==> p0$1 && p0$2 ==> v175$1 == v175$2;
    assert {:tag "predicatedEquality"} _b205 ==> p0$1 && p0$2 ==> v174$1 == v174$2;
    ...
    assert {:tag "predicatedEquality"} _b160 ==> p0$1 && p0$2 ==> v103$1 == v103$2;
    assert {:tag "predicatedEquality"} _b159 ==> p0$1 && p0$2 ==> v102$1 == v102$2;
    assert {:tag "predicatedEquality"} _b158 ==> p0$1 && p0$2 ==> v101$1 == v101$2;
    assert {:tag "predicatedEquality"} _b157 ==> p0$1 && p0$2 ==> v100$1 == v100$2;
    assert {:tag "predicatedEquality"} _b156 ==> p0$1 && p0$2 ==> v99$1 == v99$2;
    assert {:tag "predicatedEquality"} _b155 ==> p0$1 && p0$2 ==> v104$1 == v104$2;
    ...
    assert {:tag "predicatedEquality"} _b143 ==> p0$1 && p0$2 ==> v86$1 == v86$2;
    assert {:tag "predicatedEquality"} _b142 ==> p0$1 && p0$2 ==> v85$1 == v85$2;
    assert {:tag "predicatedEquality"} _b141 ==> p0$1 && p0$2 ==> v84$1 == v84$2;
    assert {:tag "predicatedEquality"} _b140 ==> p0$1 && p0$2 ==> v83$1 == v83$2;
    assert {:tag "predicatedEquality"} _b139 ==> p0$1 && p0$2 ==> v87$1 == v87$2;
    assert {:tag "predicatedEquality"} _b138 ==> p0$1 && p0$2 ==> v82$1 == v82$2;
    assert {:tag "predicatedEquality"} _b137 ==> p0$1 && p0$2 ==> v80$1 == v80$2;
    ...
    assert {:tag "predicatedEquality"} _b91 ==> p0$1 && p0$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b90 ==> p0$1 && p0$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b89 ==> p0$1 && p0$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b88 ==> p0$1 && p0$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b87 ==> p0$1 && p0$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b86 ==> p0$1 && p0$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b85 ==> p0$1 && p0$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b84 ==> p0$1 && p0$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b83 ==> p0$1 && p0$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b82 ==> p0$1 && p0$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b81 ==> p0$1 && p0$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b80 ==> p0$1 && p0$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b79 ==> p0$1 && p0$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b78 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    ...
    assert {:tag "predicatedEquality"} _b71 ==> p0$1 && p0$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b69 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b68 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b67 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b66 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b65 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b63 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b61 ==> p0$1 && p0$2 ==> v2$1 == v2$2;
    assert {:tag "predicatedEquality"} _b60 ==> p0$1 && p0$2 ==> v1$1 == v1$2;
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> v0$1 == v0$2;
    assert {:tag "predicatedEquality"} _b58 ==> p0$1 && p0$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b57 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b56 ==> p0$1 && p0$2 ==> v33$1 == v33$2;
    ...
    assert {:tag "pow2NotZero"} _b8 ==> v191$2 != 0;
    assert {:tag "pow2"} _b7 ==> v191$2 == 0 || BV32_AND(v191$2, BV32_SUB(v191$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b6 ==> v191$1 != 0;
    assert {:tag "pow2"} _b5 ==> v191$1 == 0 || BV32_AND(v191$1, BV32_SUB(v191$1, 1)) == 0;
    assert {:tag "pow2NotZero"} _b4 ==> v190$2 != 0;
    assert {:tag "pow2"} _b3 ==> v190$2 == 0 || BV32_AND(v190$2, BV32_SUB(v190$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b2 ==> v190$1 != 0;
    assert {:tag "pow2"} _b1 ==> v190$1 == 0 || BV32_AND(v190$1, BV32_SUB(v190$1, 1)) == 0;
  ...
  __partitioned_block_$1_1:
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$1, 0, v2$1, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_23"} {:captureState "check_state_23"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_23"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$2, 0, v2$2);
    ...
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] := (if p4$1 then v2$1 else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] := (if p4$2 then v2$2 else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$1, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    assume {:do_not_predicate} {:check_id "check_state_24"} {:captureState "check_state_24"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_24"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$2, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    ...
    v3$1 := (if p4$1 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v3$1);
    v3$2 := (if p4$2 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v3$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(p4$1, 0, BV32_UREM(v3$1, $gridWidth), $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(p4$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_25"} {:captureState "check_state_25"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_25"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(p4$2, 0, BV32_UREM(v3$2, $gridWidth));
    ...
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0] := (if p4$1 then BV32_UREM(v3$1, $gridWidth) else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0]);
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0] := (if p4$2 then BV32_UREM(v3$2, $gridWidth) else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0]);
    call {:sourceloc} {:sourceloc_num 13} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$1, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    assume {:do_not_predicate} {:check_id "check_state_26"} {:captureState "check_state_26"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_26"} {:sourceloc} {:sourceloc_num 13} _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p4$2, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex"} true;
    v4$1 := (if p4$1 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v4$1);
    v4$2 := (if p4$2 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v4$2);
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(p4$1, 0, BV32_UDIV(v4$1, $gridWidth), $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(p4$2, 0);
    assume {:do_not_predicate} {:check_id "check_state_27"} {:captureState "check_state_27"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_27"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(p4$2, 0, BV32_UDIV(v4$2, $gridWidth));
    ...
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0] := (if p4$1 then BV32_UDIV(v4$1, $gridWidth) else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0]);
    $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0] := (if p4$2 then BV32_UDIV(v4$2, $gridWidth) else $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0]);
    goto __partitioned_block_$1_2;

  __partitioned_block_$1_2:
    call {:sourceloc_num 16} $bugle_barrier_duplicated_1(-1, -1, p0$1, p0$2);
    call {:sourceloc} {:sourceloc_num 17} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p0$1, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 17} _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(p0$2, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex"} true;
    v5$1 := (if p0$1 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v5$1);
    v5$2 := (if p0$2 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex[0] else v5$2);
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(p5$1, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(p5$2, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0]);
    ...
    v7$1 := (if p5$1 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0] else v7$1);
    v7$2 := (if p5$2 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX[0] else v7$2);
    ...
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(p5$1, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(p5$2, 0, $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0]);
    ...
    v9$1 := (if p5$1 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0] else v9$1);
    v9$2 := (if p5$2 then $$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY[0] else v9$2);
    ...
    v83$1 := (if p59$1 then FADD32(FADD32(FADD32(FSUB32($xOff0, v82$1), FSUB32(v79$1, FSUB32(v81$1, v82$1))), 0), $xOff1) else v83$1);
    v83$2 := (if p59$2 then FADD32(FADD32(FADD32(FSUB32($xOff0, v82$2), FSUB32(v79$2, FSUB32(v81$2, v82$2))), 0), $xOff1) else v83$2);
    ...
    v88$1 := (if p59$1 then FADD32(FADD32(FADD32(FSUB32($yOff0, v87$1), FSUB32(v80$1, FSUB32(v86$1, v87$1))), 0), $yOff1) else v88$1);
    v88$2 := (if p59$2 then FADD32(FADD32(FADD32(FSUB32($yOff0, v87$2), FSUB32(v80$2, FSUB32(v86$2, v87$2))), 0), $yOff1) else v88$2);
    ...
    v91$1 := (if p59$1 then $isJ == 1 else v91$1);
    v91$2 := (if p59$2 then $isJ == 1 else v91$2);
    ...
    $y1.i.0$1, $y0.i.0$1, $x1.i.0$1, $x0.i.0$1, $yy1.i.0$1, $yy0.i.0$1, $xx1.i.0$1, $xx0.i.0$1, $xC0.i.0$1, $xC1.i.0$1, $yC0.i.0$1, $yC1.i.0$1 := (if p60$1 then 0 else $y1.i.0$1), (if p60$1 then 0 else $y0.i.0$1), (if p60$1 then 0 else $x1.i.0$1), (if p60$1 then 0 else $x0.i.0$1), (if p60$1 then 0 else $yy1.i.0$1), (if p60$1 then 0 else $yy0.i.0$1), (if p60$1 then 0 else $xx1.i.0$1), (if p60$1 then 0 else $xx0.i.0$1), (if p60$1 then v84$1 else $xC0.i.0$1), (if p60$1 then v85$1 else $xC1.i.0$1), (if p60$1 then v89$1 else $yC0.i.0$1), (if p60$1 then v90$1 else $yC1.i.0$1);
    $y1.i.0$2, $y0.i.0$2, $x1.i.0$2, $x0.i.0$2, $yy1.i.0$2, $yy0.i.0$2, $xx1.i.0$2, $xx0.i.0$2, $xC0.i.0$2, $xC1.i.0$2, $yC0.i.0$2, $yC1.i.0$2 := (if p60$2 then 0 else $y1.i.0$2), (if p60$2 then 0 else $y0.i.0$2), (if p60$2 then 0 else $x1.i.0$2), (if p60$2 then 0 else $x0.i.0$2), (if p60$2 then 0 else $yy1.i.0$2), (if p60$2 then 0 else $yy0.i.0$2), (if p60$2 then 0 else $xx1.i.0$2), (if p60$2 then 0 else $xx0.i.0$2), (if p60$2 then v84$2 else $xC0.i.0$2), (if p60$2 then v85$2 else $xC1.i.0$2), (if p60$2 then v89$2 else $yC0.i.0$2), (if p60$2 then v90$2 else $yC1.i.0$2);
    v92$1 := (if p61$1 then FMUL32(v89$1, 1174406144) else v92$1);
    v92$2 := (if p61$2 then FMUL32(v89$2, 1174406144) else v92$2);
    v93$1 := (if p61$1 then FMUL32(v89$1, 1174406144) else v93$1);
    v93$2 := (if p61$2 then FMUL32(v89$2, 1174406144) else v93$2);
    ...
    v104$1 := (if p61$1 then FMUL32(v84$1, 1174406144) else v104$1);
    v104$2 := (if p61$2 then FMUL32(v84$2, 1174406144) else v104$2);
    v105$1 := (if p61$1 then FMUL32(v84$1, 1174406144) else v105$1);
    v105$2 := (if p61$2 then FMUL32(v84$2, 1174406144) else v105$2);
  ...
  $65:
    ...
    v120$1 := (if p62$1 then BV32_ADD($i.i.0$1, -1) else v120$1);
    v120$2 := (if p62$2 then BV32_ADD($i.i.0$2, -1) else v120$2);
    v121$1 := (if p62$1 then v120$1 != 0 else v121$1);
    v121$2 := (if p62$2 then v120$2 != 0 else v121$2);
    p63$1 := false;
    p63$2 := false;
    p64$1 := false;
    p64$2 := false;
    ...
    $16$1 := (if p63$1 then 0 else $16$1);
    $16$2 := (if p63$2 then 0 else $16$2);
    $16$1 := (if p64$1 then (if FLT32(FADD32($sum0.i.0$1, $sum1.i.0$1), 1082130432) then 1 else 0) else $16$1);
    $16$2 := (if p64$2 then (if FLT32(FADD32($sum0.i.0$2, $sum1.i.0$2), 1082130432) then 1 else 0) else $16$2);
    v122$1 := (if p62$1 then $16$1 == 1 else v122$1);
    v122$2 := (if p62$2 then $16$2 == 1 else v122$2);
    ...
    v123$1 := (if p65$1 then FMUL32($x0.i.1$1, 1174406144) else v123$1);
    v123$2 := (if p65$2 then FMUL32($x0.i.1$2, 1174406144) else v123$2);
    v124$1 := (if p65$1 then FMUL32($y0.i.1$1, 1174406144) else v124$1);
    v124$2 := (if p65$2 then FMUL32($y0.i.1$2, 1174406144) else v124$2);
    ...
    v147$1 := (if p65$1 then FSUB32(FADD32(FADD32(FSUB32(FSUB32(-2147483648, $yy0.i.1$1), v146$1), FSUB32($xx0.i.1$1, FSUB32(v145$1, v146$1))), $xx1.i.1$1), $yy1.i.1$1) else v147$1);
    v147$2 := (if p65$2 then FSUB32(FADD32(FADD32(FSUB32(FSUB32(-2147483648, $yy0.i.1$2), v146$2), FSUB32($xx0.i.1$2, FSUB32(v145$2, v146$2))), $xx1.i.1$2), $yy1.i.1$2) else v147$2);
    ...
    v154$1 := (if p65$1 then FMUL32(v143$1, 1174406144) else v154$1);
    v154$2 := (if p65$2 then FMUL32(v143$2, 1174406144) else v154$2);
    v155$1 := (if p65$1 then FMUL32(v143$1, 1174406144) else v155$1);
    v155$2 := (if p65$2 then FMUL32(v143$2, 1174406144) else v155$2);
    ...
    v167$1 := (if p65$1 then FMUL32(v152$1, 1174406144) else v167$1);
    v167$2 := (if p65$2 then FMUL32(v152$2, 1174406144) else v167$2);
    v168$1 := (if p65$1 then FMUL32(v152$1, 1174406144) else v168$1);
    v168$2 := (if p65$2 then FMUL32(v152$2, 1174406144) else v168$2);
  ...
  $65.tail:
    assume !p62$1 && !p62$2;
    v184$1 := (if p59$1 then BV32_SGT(v120$1, 0) else v184$1);
    v184$2 := (if p59$2 then BV32_SGT(v120$2, 0) else v184$2);
    ...
    $17$1 := (if p66$1 then 0 else $17$1);
    $17$2 := (if p66$2 then 0 else $17$2);
    $17$1 := (if p67$1 then BV32_SUB($crunch, v120$1) else $17$1);
    $17$2 := (if p67$2 then BV32_SUB($crunch, v120$2) else $17$2);
    v185$1 := (if p59$1 then $17$1 != 0 else v185$1);
    v185$2 := (if p59$2 then $17$2 != 0 else v185$2);
    ...
    $$color$0$1 := (if p68$1 then 0 else $$color$0$1);
    $$color$0$2 := (if p68$2 then 0 else $$color$0$2);
    $$color$1$1 := (if p68$1 then 0 else $$color$1$1);
    $$color$1$2 := (if p68$2 then 0 else $$color$1$2);
    $$color$2$1 := (if p68$1 then 0 else $$color$2$1);
    $$color$2$2 := (if p68$2 then 0 else $$color$2$2);
    ...
    v187$1 := (if p69$1 then $$colors$0$1 else v187$1);
    v187$2 := (if p69$2 then $$colors$0$2 else v187$2);
    $$color$0$1 := (if p69$1 then BV_EXTRACT(BV32_MUL(v186$1, BV8_ZEXT32(v187$1)), 8, 0) else $$color$0$1);
    $$color$0$2 := (if p69$2 then BV_EXTRACT(BV32_MUL(v186$2, BV8_ZEXT32(v187$2)), 8, 0) else $$color$0$2);
    v188$1 := (if p69$1 then $$colors$1$1 else v188$1);
    v188$2 := (if p69$2 then $$colors$1$2 else v188$2);
    $$color$1$1 := (if p69$1 then BV_EXTRACT(BV32_MUL(v186$1, BV8_ZEXT32(v188$1)), 8, 0) else $$color$1$1);
    $$color$1$2 := (if p69$2 then BV_EXTRACT(BV32_MUL(v186$2, BV8_ZEXT32(v188$2)), 8, 0) else $$color$1$2);
    v189$1 := (if p69$1 then $$colors$2$1 else v189$1);
    v189$2 := (if p69$2 then $$colors$2$2 else v189$2);
    $$color$2$1 := (if p69$1 then BV_EXTRACT(BV32_MUL(v186$1, BV8_ZEXT32(v189$1)), 8, 0) else $$color$2$1);
    $$color$2$2 := (if p69$2 then BV_EXTRACT(BV32_MUL(v186$2, BV8_ZEXT32(v189$2)), 8, 0) else $$color$2$2);
    v190$1 := (if p59$1 then BV32_ADD($frame, 1) else v190$1);
    v190$2 := (if p59$2 then BV32_ADD($frame, 1) else v190$2);
    v191$1 := (if p59$1 then BV32_SDIV(v190$1, 2) else v191$1);
    v191$2 := (if p59$2 then BV32_SDIV(v190$2, 2) else v191$2);
    v192$1 := (if p59$1 then $$pixelColor$0$1 else v192$1);
    v192$2 := (if p59$2 then $$pixelColor$0$2 else v192$2);
    v193$1 := (if p59$1 then $$color$0$1 else v193$1);
    v193$2 := (if p59$2 then $$color$0$2 else v193$2);
    call {:sourceloc} {:sourceloc_num 138} _LOG_WRITE_$$dst(p59$1, BV32_MUL(v13$1, 4), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$1), $frame), BV8_ZEXT32(v193$1)), v191$1), v190$1), 8, 0), $$dst[BV32_MUL(v13$1, 4)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 138} _CHECK_WRITE_$$dst(p59$2, BV32_MUL(v13$2, 4), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$2), $frame), BV8_ZEXT32(v193$2)), v191$2), v190$2), 8, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_MUL(v13$1, 4)] := (if p59$1 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$1), $frame), BV8_ZEXT32(v193$1)), v191$1), v190$1), 8, 0) else $$dst[BV32_MUL(v13$1, 4)]);
    $$dst[BV32_MUL(v13$2, 4)] := (if p59$2 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v192$2), $frame), BV8_ZEXT32(v193$2)), v191$2), v190$2), 8, 0) else $$dst[BV32_MUL(v13$2, 4)]);
    v194$1 := (if p59$1 then $$pixelColor$1$1 else v194$1);
    v194$2 := (if p59$2 then $$pixelColor$1$2 else v194$2);
    v195$1 := (if p59$1 then $$color$1$1 else v195$1);
    v195$2 := (if p59$2 then $$color$1$2 else v195$2);
    call {:sourceloc} {:sourceloc_num 141} _LOG_WRITE_$$dst(p59$1, BV32_ADD(BV32_MUL(v13$1, 4), 1), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$1), $frame), BV8_ZEXT32(v195$1)), v191$1), v190$1), 8, 0), $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 1)]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 141} _CHECK_WRITE_$$dst(p59$2, BV32_ADD(BV32_MUL(v13$2, 4), 1), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$2), $frame), BV8_ZEXT32(v195$2)), v191$2), v190$2), 8, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 1)] := (if p59$1 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$1), $frame), BV8_ZEXT32(v195$1)), v191$1), v190$1), 8, 0) else $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 1)]);
    $$dst[BV32_ADD(BV32_MUL(v13$2, 4), 1)] := (if p59$2 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v194$2), $frame), BV8_ZEXT32(v195$2)), v191$2), v190$2), 8, 0) else $$dst[BV32_ADD(BV32_MUL(v13$2, 4), 1)]);
    v196$1 := (if p59$1 then $$pixelColor$2$1 else v196$1);
    v196$2 := (if p59$2 then $$pixelColor$2$2 else v196$2);
    v197$1 := (if p59$1 then $$color$2$1 else v197$1);
    v197$2 := (if p59$2 then $$color$2$2 else v197$2);
    call {:sourceloc} {:sourceloc_num 144} _LOG_WRITE_$$dst(p59$1, BV32_ADD(BV32_MUL(v13$1, 4), 2), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v196$1), $frame), BV8_ZEXT32(v197$1)), v191$1), v190$1), 8, 0), $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 2)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 144} _CHECK_WRITE_$$dst(p59$2, BV32_ADD(BV32_MUL(v13$2, 4), 2), BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v196$2), $frame), BV8_ZEXT32(v197$2)), v191$2), v190$2), 8, 0));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 2)] := (if p59$1 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v196$1), $frame), BV8_ZEXT32(v197$1)), v191$1), v190$1), 8, 0) else $$dst[BV32_ADD(BV32_MUL(v13$1, 4), 2)]);
    $$dst[BV32_ADD(BV32_MUL(v13$2, 4), 2)] := (if p59$2 then BV_EXTRACT(BV32_SDIV(BV32_ADD(BV32_ADD(BV32_MUL(BV8_ZEXT32(v196$2), $frame), BV8_ZEXT32(v197$2)), v191$2), v190$2), 8, 0) else $$dst[BV32_ADD(BV32_MUL(v13$2, 4), 2)]);
...
const _WATCHED_VALUE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex: int;

procedure {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;



implementation {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX: int;

procedure {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;



implementation {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY: int;

procedure {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;



implementation {:inline 1} _LOG_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE10blockIndex;
    goto anon1;

  anon1:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockX;
    goto anon2;

  anon2:
    assume _P$1 && $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;
    assume _P$1 && $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;
    assume _P$1 && $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ13MandelbrotDS1P6uchar4iiifffffffS_iiiibE6blockY;
    goto anon3;
