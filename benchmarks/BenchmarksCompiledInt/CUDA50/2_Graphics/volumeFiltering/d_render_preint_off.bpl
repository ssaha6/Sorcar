...
procedure {:source_name "d_render_preint_off"} {:kernel} $_Z19d_render_preint_offPjjjfffff($imageW: int, $imageH: int, $density: int, $brightness: int, $transferOffset: int, $transferScale: int, $transferWeight: int);
...
implementation {:source_name "d_render_preint_off"} {:kernel} $_Z19d_render_preint_offPjjjfffff($imageW: int, $imageH: int, $density: int, $brightness: int, $transferOffset: int, $transferScale: int, $transferWeight: int)
{
  var $tnear.i.0$1: int;
  var $tnear.i.0$2: int;
  var $t.i.0$1: int;
  ...
  $8:
    ...
    call {:sourceloc_num 907} v505$1, v505$2 := $_Z12tex2DLayeredI6float4ET_7textureIS1_Li242EL19cudaTextureReadMode0EEffi(p9$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v496$1, v495$1), v494$1), v493$1), v492$1), v491$1), v490$1), v489$1), v488$1), v487$1), v486$1), v485$1), v484$1), v483$1), v482$1), v481$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v500$1, v499$1), v498$1), v497$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v504$1, v503$1), v502$1), v501$1), v455$1, v455$1, BV1_ZEXT32((if FLT32(v456$1, 0) then 1 else 0)), p9$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v496$2, v495$2), v494$2), v493$2), v492$2), v491$2), v490$2), v489$2), v488$2), v487$2), v486$2), v485$2), v484$2), v483$2), v482$2), v481$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v500$2, v499$2), v498$2), v497$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v504$2, v503$2), v502$2), v501$2), v455$2, v455$2, BV1_ZEXT32((if FLT32(v456$2, 0) then 1 else 0)));
