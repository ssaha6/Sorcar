...
procedure {:source_name "d_render_preint"} {:kernel} $_Z15d_render_preintPjjjfffff($imageW: int, $imageH: int, $density: int, $brightness: int, $transferOffset: int, $transferScale: int, $transferWeight: int);
...
implementation {:source_name "d_render_preint"} {:kernel} $_Z15d_render_preintPjjjfffff($imageW: int, $imageH: int, $density: int, $brightness: int, $transferOffset: int, $transferScale: int, $transferWeight: int)
{
  var $tnear.i.0$1: int;
  var $tnear.i.0$2: int;
  var $t.i.0$1: int;
  var $t.i.0$2: int;
  var $lastsample.i.0$1: int;
  var $lastsample.i.0$2: int;
  var $i.i.0$1: int;
  var $i.i.0$2: int;
  var v65$1: int;
  var v65$2: int;
  ...
  $0:
    ...
    $$9$0$1 := (if p5$1 then FMUL32(v415$1, 1025758986) else $$9$0$1);
    $$9$0$2 := (if p5$2 then FMUL32(v415$2, 1025758986) else $$9$0$2);
    $$9$1$1 := (if p5$1 then FMUL32(v416$1, 1025758986) else $$9$1$1);
    $$9$1$2 := (if p5$2 then FMUL32(v416$2, 1025758986) else $$9$1$2);
    $$9$2$1 := (if p5$1 then FMUL32(v417$1, 1025758986) else $$9$2$1);
    $$9$2$2 := (if p5$2 then FMUL32(v417$2, 1025758986) else $$9$2$2);
    ...
    $t.i.0$1, $lastsample.i.0$1, $i.i.0$1 := (if p5$1 then $tnear.i.0$1 else $t.i.0$1), (if p5$1 then 0 else $lastsample.i.0$1), (if p5$1 then 0 else $i.i.0$1);
    $t.i.0$2, $lastsample.i.0$2, $i.i.0$2 := (if p5$2 then $tnear.i.0$2 else $t.i.0$2), (if p5$2 then 0 else $lastsample.i.0$2), (if p5$2 then 0 else $i.i.0$2);
  ...
  $8:
    ...
    call {:sourceloc_num 907} v505$1, v505$2 := $_Z12tex2DLayeredI6float4ET_7textureIS1_Li242EL19cudaTextureReadMode0EEffi(p9$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v496$1, v495$1), v494$1), v493$1), v492$1), v491$1), v490$1), v489$1), v488$1), v487$1), v486$1), v485$1), v484$1), v483$1), v482$1), v481$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v500$1, v499$1), v498$1), v497$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v504$1, v503$1), v502$1), v501$1), v455$1, $lastsample.i.0$1, BV1_ZEXT32((if FLT32(v456$1, 0) then 1 else 0)), p9$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v496$2, v495$2), v494$2), v493$2), v492$2), v491$2), v490$2), v489$2), v488$2), v487$2), v486$2), v485$2), v484$2), v483$2), v482$2), v481$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v500$2, v499$2), v498$2), v497$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v504$2, v503$2), v502$2), v501$2), v455$2, $lastsample.i.0$2, BV1_ZEXT32((if FLT32(v456$2, 0) then 1 else 0)));
    ...
    $$col.i$3$1 := (if p9$1 then FMUL32(v510$1, FMUL32($density, 1082130432)) else $$col.i$3$1);
    $$col.i$3$2 := (if p9$2 then FMUL32(v510$2, FMUL32($density, 1082130432)) else $$col.i$3$2);
    ...
    v573$1 := (if p10$1 then FADD32($t.i.0$1, 1025758986) else v573$1);
    v573$2 := (if p10$2 then FADD32($t.i.0$2, 1025758986) else v573$2);
    ...
    $t.i.0$1, $lastsample.i.0$1, $i.i.0$1 := (if p11$1 then v573$1 else $t.i.0$1), (if p11$1 then v455$1 else $lastsample.i.0$1), (if p11$1 then BV32_ADD($i.i.0$1, 1) else $i.i.0$1);
    $t.i.0$2, $lastsample.i.0$2, $i.i.0$2 := (if p11$2 then v573$2 else $t.i.0$2), (if p11$2 then v455$2 else $lastsample.i.0$2), (if p11$2 then BV32_ADD($i.i.0$2, 1) else $i.i.0$2);
...
const _WATCHED_VALUE_$$transferLayerPreintTex: int;

procedure {:inline 1} _LOG_READ_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$transferLayerPreintTex;



implementation {:inline 1} _LOG_READ_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$transferLayerPreintTex, _WRITE_READ_BENIGN_FLAG_$$transferLayerPreintTex;



implementation {:inline 1} _LOG_WRITE_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$transferLayerPreintTex(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$transferLayerPreintTex(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$transferLayerPreintTex;



implementation {:inline 1} _LOG_ATOMIC_$$transferLayerPreintTex(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$transferLayerPreintTex(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$transferLayerPreintTex(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$transferLayerPreintTex;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$transferLayerPreintTex(_P: bool, _offset: int)
{
