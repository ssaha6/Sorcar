...
implementation {:source_name "integrateBodies<float, false>"} {:kernel} $_Z15integrateBodiesIfLb0EEvPN4vec4IT_E4TypeES4_S4_jjffi($deviceOffset: int, $deviceNumBodies: int, $deltaTime: int, $damping: int, $totalNumBodies: int)
{
  ...
  __partitioned_block_$3_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b112 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$__smem$ghost$__partitioned_block_$3_0 == _WRITE_HAS_OCCURRED_$$__smem;
    assert {:tag "disabledMaintainsInstrumentation"} _b111 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$__smem$ghost$__partitioned_block_$3_0 == _READ_HAS_OCCURRED_$$__smem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b110 ==> _WRITE_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET == BV32_MUL(BV32_ADD(local_id_x$1, BV32_MUL(group_size_x, local_id_y$1)), 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, BV32_MUL(group_size_x, local_id_y$1)), 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, BV32_MUL(group_size_x, local_id_y$1)), 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, BV32_MUL(group_size_x, local_id_y$1)), 4), 3);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b109 ==> _READ_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    ...
    assert {:tag "predicatedEquality"} _b86 ==> p2$1 && p2$2 ==> v75$1 == v75$2;
    assert {:tag "predicatedEquality"} _b85 ==> p2$1 && p2$2 ==> v74$1 == v74$2;
    assert {:tag "predicatedEquality"} _b84 ==> p2$1 && p2$2 ==> v72$1 == v72$2;
    assert {:tag "predicatedEquality"} _b83 ==> p2$1 && p2$2 ==> v71$1 == v71$2;
    assert {:tag "predicatedEquality"} _b82 ==> p2$1 && p2$2 ==> v69$1 == v69$2;
    assert {:tag "predicatedEquality"} _b81 ==> p2$1 && p2$2 ==> v68$1 == v68$2;
    assert {:tag "predicatedEquality"} _b80 ==> p2$1 && p2$2 ==> v67$1 == v67$2;
    assert {:tag "predicatedEquality"} _b79 ==> p2$1 && p2$2 ==> v66$1 == v66$2;
    assert {:tag "predicatedEquality"} _b78 ==> p2$1 && p2$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b77 ==> p2$1 && p2$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b76 ==> p2$1 && p2$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b75 ==> p2$1 && p2$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b74 ==> p2$1 && p2$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b73 ==> p2$1 && p2$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b72 ==> p2$1 && p2$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b71 ==> p2$1 && p2$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b70 ==> p2$1 && p2$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b69 ==> p2$1 && p2$2 ==> v76$1 == v76$2;
    assert {:tag "predicatedEquality"} _b68 ==> p2$1 && p2$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b67 ==> p2$1 && p2$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b66 ==> p2$1 && p2$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b65 ==> p2$1 && p2$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b64 ==> p2$1 && p2$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b63 ==> p2$1 && p2$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b62 ==> p2$1 && p2$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b61 ==> p2$1 && p2$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b60 ==> p2$1 && p2$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b59 ==> p2$1 && p2$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b58 ==> p2$1 && p2$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b57 ==> p2$1 && p2$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b56 ==> p2$1 && p2$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b55 ==> p2$1 && p2$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b54 ==> p2$1 && p2$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b53 ==> p2$1 && p2$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b52 ==> p2$1 && p2$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b51 ==> p2$1 && p2$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b50 ==> p2$1 && p2$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b49 ==> p2$1 && p2$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b48 ==> p2$1 && p2$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b47 ==> p2$1 && p2$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b46 ==> p2$1 && p2$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b45 ==> p2$1 && p2$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b44 ==> p2$1 && p2$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b43 ==> p2$1 && p2$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b42 ==> p2$1 && p2$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b41 ==> p2$1 && p2$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b40 ==> p2$1 && p2$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b39 ==> p2$1 && p2$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b38 ==> p2$1 && p2$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b37 ==> p2$1 && p2$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b36 ==> p2$1 && p2$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b35 ==> p2$1 && p2$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b34 ==> p2$1 && p2$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b33 ==> p2$1 && p2$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b32 ==> p2$1 && p2$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b31 ==> p2$1 && p2$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b30 ==> p2$1 && p2$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b29 ==> p2$1 && p2$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b28 ==> p2$1 && p2$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b27 ==> p2$1 && p2$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b26 ==> p2$1 && p2$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b25 ==> p2$1 && p2$2 ==> v73$1 == v73$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _WRITE_HAS_OCCURRED_$$__smem ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b7 ==> _READ_HAS_OCCURRED_$$__smem ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies) && BV32_ULT($tile.i.0$1, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$1)) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $deviceNumBodies) && BV32_ULT($tile.i.0$2, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$2)) ==> p2$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b5 ==> p2$1 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b5 ==> p2$2 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $deviceNumBodies);
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b0 ==> $tile.i.0$1 mod 1 == group_id_y$1 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b0 ==> $tile.i.0$2 mod 1 == group_id_y$2 mod 1;
  ...
  $8:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b114 ==> !p3$1 ==> _READ_HAS_OCCURRED_$$__smem$ghost$$8 == _READ_HAS_OCCURRED_$$__smem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b113 ==> _READ_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$__smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$__smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$__smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$__smem ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies) && BV32_ULT($tile.i.0$1, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$1)) && BV32_ULT($counter.i.i.0$1, group_size_x) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $deviceNumBodies) && BV32_ULT($tile.i.0$2, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$2)) && BV32_ULT($counter.i.i.0$2, group_size_x) ==> p6$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b15 ==> p6$1 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $deviceNumBodies) && BV32_ULT($tile.i.0$1, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$1));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b15 ==> p6$2 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $deviceNumBodies) && BV32_ULT($tile.i.0$2, BV32_ADD(BV32_SDIV($totalNumBodies, BV32_MUL(group_size_x, group_size_y)), group_id_y$2));
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b14 ==> BV32_UGE($counter.i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b14 ==> BV32_UGE($counter.i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b13 ==> BV32_ULE($counter.i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b13 ==> BV32_ULE($counter.i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b12 ==> BV32_SGE($counter.i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b12 ==> BV32_SGE($counter.i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b11 ==> BV32_SLE($counter.i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b11 ==> BV32_SLE($counter.i.i.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b10 ==> $counter.i.i.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b10 ==> $counter.i.i.0$2 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p6$1 ==> _b9 ==> $j.i.i.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p6$2 ==> _b9 ==> $j.i.i.0$2 mod 1 == 0 mod 1;
