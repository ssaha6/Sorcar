...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $a.0$1) == BV32_AND(BV32_SUB(32bv32, 1bv32), v0$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $a.0$2) == BV32_AND(BV32_SUB(32bv32, 1bv32), v0$2) ) ,  ( p0$1 ==> BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), $b.0$1) == BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), BV32_MUL(32bv32, group_id_x$1)) )  && ( p0$2 ==> BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), $b.0$2) == BV32_AND(BV32_SUB(BV32_MUL(32bv32, $wB), 1bv32), BV32_MUL(32bv32, group_id_x$2)) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $a.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $a.0$2) ) ,  ( p0$1 ==> BV32_SUB($a.0$1, v0$1) == BV32_SUB($a.0$2, v0$2) )  && ( p0$2 ==> BV32_SUB($a.0$2, v0$2) == BV32_SUB($a.0$1, v0$1) ) ,  ( p0$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($a.0$1, v0$1) == BV32_SUB($a.0$2, v0$2) )  && ( p0$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> BV32_SUB($a.0$2, v0$2) == BV32_SUB($a.0$1, v0$1) ) ,  ( p0$1 ==> BV32_SLE($a.0$1, v0$1) )  && ( p0$2 ==> BV32_SLE($a.0$2, v0$2) ) ,  ( p0$1 ==> BV32_SGE($a.0$1, v0$1) )  && ( p0$2 ==> BV32_SGE($a.0$2, v0$2) ) ,  ( p0$1 ==> BV32_ULE($a.0$1, v0$1) )  && ( p0$2 ==> BV32_ULE($a.0$2, v0$2) ) ,  ( p0$1 ==> BV32_UGE($a.0$1, v0$1) )  && ( p0$2 ==> BV32_UGE($a.0$2, v0$2) ) ,  (  BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) ==> p0$1 )  && (  BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32)) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  p0$1 == p0$2 ) ,  (  group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2 ) ,  (  p0$1 && p0$2 ==> $Csub.0$1 == $Csub.0$2 ) ,  (  p0$1 && p0$2 ==> $a.0$1 == $a.0$2 ) ,  (  p0$1 && p0$2 ==> $b.0$1 == $b.0$2 ) ,  (  p0$1 && p0$2 ==> $Csub.1$1 == $Csub.1$2 ) ,  (  p0$1 && p0$2 ==> $k.0$1 == $k.0$2 ) ,  (  p0$1 && p0$2 ==> v1$1 == v1$2 ) ,  (  p0$1 && p0$2 ==> v2$1 == v2$2 ) ,  (  p0$1 && p0$2 ==> v3$1 == v3$2 ) ,  (  p0$1 && p0$2 ==> v4$1 == v4$2 ) ,  (  p0$1 && p0$2 ==> v5$1 == v5$2 ) ,  (  p0$1 && p0$2 ==> v6$1 == v6$2 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 32bv32), local_id_x$1) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 32bv32), local_id_x$1) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32) ) ,  (  !p1$1 ==> _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As$ghost$$3 == _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1)) ) ,  (  !p1$1 ==> _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs$ghost$$3 == _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p2$1 ==> BV32_SLE(0bv32, $k.0$1) )  && ( p2$2 ==> BV32_SLE(0bv32, $k.0$2) ) ,  ( p2$1 ==> BV32_SLE($k.0$1, 0bv32) )  && ( p2$2 ==> BV32_SLE($k.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_SGE($k.0$1, 0bv32) )  && ( p2$2 ==> BV32_SGE($k.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_ULE($k.0$1, 0bv32) )  && ( p2$2 ==> BV32_ULE($k.0$2, 0bv32) ) ,  ( p2$1 ==> BV32_UGE($k.0$1, 0bv32) )  && ( p2$2 ==> BV32_UGE($k.0$2, 0bv32) ) ,  ( p2$1 ==> p2$1 ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) )  && ( p2$2 ==> p2$2 ==> BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32)) ) ,  (  BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) && BV32_SLT($k.0$1, 32bv32) ==> p2$1 )  && (  BV32_SLE($a.0$2, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$2), $wA), 1bv32)) && BV32_SLT($k.0$2, 32bv32) ==> p2$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2As ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13matrixMulCUDAILi32EEvPfS0_S0_iiE2Bs ==> BV32_SLE($a.0$1, BV32_SUB(BV32_ADD(BV32_MUL(BV32_MUL($wA, 32bv32), group_id_y$1), $wA), 1bv32)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
