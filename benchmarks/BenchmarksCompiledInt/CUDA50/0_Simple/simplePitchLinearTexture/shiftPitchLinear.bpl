...
implementation {:source_name "shiftPitchLinear"} {:kernel} $_Z16shiftPitchLinearPfiiiii($pitch: int, $width: int, $height: int, $shiftX: int, $shiftY: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
...
const _WATCHED_VALUE_$$texRefPL: int;

procedure {:inline 1} _LOG_READ_$$texRefPL(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$texRefPL;



implementation {:inline 1} _LOG_READ_$$texRefPL(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$texRefPL(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$texRefPL(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$texRefPL, _WRITE_READ_BENIGN_FLAG_$$texRefPL;



implementation {:inline 1} _LOG_WRITE_$$texRefPL(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$texRefPL(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$texRefPL(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$texRefPL;



implementation {:inline 1} _LOG_ATOMIC_$$texRefPL(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$texRefPL(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$texRefPL(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$texRefPL;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$texRefPL(_P: bool, _offset: int)
{
