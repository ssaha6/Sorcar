...
var {:source_name "g_out"} {:global} $$g_out: [int]int;
...
procedure {:source_name "incKernel"} {:kernel} $_Z9incKernelPiS_ii($N: int, $inner_reps: int);
...
implementation {:source_name "incKernel"} {:kernel} $_Z9incKernelPiS_ii($N: int, $inner_reps: int)
{
  var $i.0$1: int;
  var $i.0$2: int;
  var v0$1: int;
  ...
  $2:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $N) && BV32_SLT($i.0$1, $inner_reps) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $N) && BV32_SLT($i.0$2, $inner_reps) ==> p1$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b5 ==> p1$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $N);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b5 ==> p1$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $N);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b4 ==> BV32_UGE($i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b4 ==> BV32_UGE($i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b3 ==> BV32_ULE($i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b3 ==> BV32_ULE($i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b2 ==> BV32_SGE($i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b2 ==> BV32_SGE($i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b1 ==> BV32_SLE($i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b1 ==> BV32_SLE($i.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p1$1 ==> _b0 ==> $i.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p1$2 ==> _b0 ==> $i.0$2 mod 1 == 0 mod 1;
    ...
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$g_out(p2$1, v0$1, BV32_ADD(v3$1, 1), $$g_out[v0$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$g_out(p2$2, v0$2, BV32_ADD(v3$2, 1));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_out"} true;
    $$g_out[v0$1] := (if p2$1 then BV32_ADD(v3$1, 1) else $$g_out[v0$1]);
    $$g_out[v0$2] := (if p2$2 then BV32_ADD(v3$2, 1) else $$g_out[v0$2]);
...
const _WATCHED_VALUE_$$g_out: int;

procedure {:inline 1} _LOG_READ_$$g_out(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$g_out;



implementation {:inline 1} _LOG_READ_$$g_out(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$g_out(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$g_out(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$g_out, _WRITE_READ_BENIGN_FLAG_$$g_out;



implementation {:inline 1} _LOG_WRITE_$$g_out(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$g_out(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$g_out(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$g_out;



implementation {:inline 1} _LOG_ATOMIC_$$g_out(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$g_out(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_out(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$g_out;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_out(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$g_in: int;

procedure {:inline 1} _LOG_READ_$$g_in(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$g_in;



implementation {:inline 1} _LOG_READ_$$g_in(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$g_in(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$g_in(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$g_in, _WRITE_READ_BENIGN_FLAG_$$g_in;



implementation {:inline 1} _LOG_WRITE_$$g_in(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$g_in(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$g_in(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$g_in;



implementation {:inline 1} _LOG_ATOMIC_$$g_in(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$g_in(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_in(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$g_in;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_in(_P: bool, _offset: int)
{
