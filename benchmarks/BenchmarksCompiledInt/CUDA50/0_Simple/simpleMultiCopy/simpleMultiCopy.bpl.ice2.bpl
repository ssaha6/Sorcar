...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$g_out ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) ) ,  (  !p0$1 ==> _WRITE_HAS_OCCURRED_$$g_out$ghost$$2 == _WRITE_HAS_OCCURRED_$$g_out )  ); 
...
assert  my_inv (  ( p1$1 ==> $i.0$1 mod 1 == 0 mod 1 )  && ( p1$2 ==> $i.0$2 mod 1 == 0 mod 1 ) ,  ( p1$1 ==> BV32_SLE($i.0$1, 0) )  && ( p1$2 ==> BV32_SLE($i.0$2, 0) ) ,  ( p1$1 ==> BV32_SGE($i.0$1, 0) )  && ( p1$2 ==> BV32_SGE($i.0$2, 0) ) ,  ( p1$1 ==> BV32_ULE($i.0$1, 0) )  && ( p1$2 ==> BV32_ULE($i.0$2, 0) ) ,  ( p1$1 ==> BV32_UGE($i.0$1, 0) )  && ( p1$2 ==> BV32_UGE($i.0$2, 0) ) ,  ( p1$1 ==> p1$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $N) )  && ( p1$2 ==> p1$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $N) ) ,  (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $N) && BV32_SLT($i.0$1, $inner_reps) ==> p1$1 )  && (  BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $N) && BV32_SLT($i.0$2, $inner_reps) ==> p1$2 ) ,  (  _WRITE_HAS_OCCURRED_$$g_out ==> BV32_SLT(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $N) ) ,  true ,  true  ); 
