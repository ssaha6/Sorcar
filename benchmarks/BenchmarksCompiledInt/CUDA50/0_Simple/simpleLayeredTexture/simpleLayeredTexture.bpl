...
procedure {:source_name "transformKernel"} {:kernel} $_Z15transformKernelPfiii($width: int, $height: int, $layer: int);
  ...
  requires {:sourceloc_num 2} {:thread 1} (if $layer == 1 then 1 else 0) != 0;
...
implementation {:source_name "transformKernel"} {:kernel} $_Z15transformKernelPfiii($width: int, $height: int, $layer: int)
{
  var v0$1: int;
  var v0$2: int;
  var v1$1: int;
  ...
  $0:
    ...
    v25$1 := $$0$11$1;
    v25$2 := $$0$11$2;
    call {:sourceloc_num 40} v26$1, v26$2 := $_Z12tex2DLayeredIfET_7textureIS0_Li242EL19cudaTextureReadMode0EEffi($layer, BV_CONCAT(BV_CONCAT(BV_CONCAT(v17$1, v16$1), v15$1), v14$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v21$1, v20$1), v19$1), v18$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v25$1, v24$1), v23$1), v22$1), FDIV32(FADD32(UI32_TO_FP32(v0$1), 1056964608), SI32_TO_FP32($width)), FDIV32(FADD32(UI32_TO_FP32(v1$1), 1056964608), SI32_TO_FP32($height)), BV_CONCAT(BV_CONCAT(BV_CONCAT(v17$2, v16$2), v15$2), v14$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v21$2, v20$2), v19$2), v18$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v25$2, v24$2), v23$2), v22$2), FDIV32(FADD32(UI32_TO_FP32(v0$2), 1056964608), SI32_TO_FP32($width)), FDIV32(FADD32(UI32_TO_FP32(v1$2), 1056964608), SI32_TO_FP32($height)));
    ...
    call {:sourceloc} {:sourceloc_num 41} _LOG_WRITE_$$g_odata(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL($layer, $width), $height), BV32_MUL(v1$1, $width)), v0$1), FADD32(FSUB32(-2147483648, v26$1), SI32_TO_FP32($layer)), $$g_odata[BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL($layer, $width), $height), BV32_MUL(v1$1, $width)), v0$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 41} _CHECK_WRITE_$$g_odata(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL($layer, $width), $height), BV32_MUL(v1$2, $width)), v0$2), FADD32(FSUB32(-2147483648, v26$2), SI32_TO_FP32($layer)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
    $$g_odata[BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL($layer, $width), $height), BV32_MUL(v1$1, $width)), v0$1)] := FADD32(FSUB32(-2147483648, v26$1), SI32_TO_FP32($layer));
    $$g_odata[BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL($layer, $width), $height), BV32_MUL(v1$2, $width)), v0$2)] := FADD32(FSUB32(-2147483648, v26$2), SI32_TO_FP32($layer));
    return;
}



procedure {:source_name "_Z12tex2DLayeredIfET_7textureIS0_Li242EL19cudaTextureReadMode0EEffi"} $_Z12tex2DLayeredIfET_7textureIS0_Li242EL19cudaTextureReadMode0EEffi($5: int, $0$1: int, $1$1: int, $2$1: int, $3$1: int, $4$1: int, $0$2: int, $1$2: int, $2$2: int, $3$2: int, $4$2: int) returns ($ret$1: int, $ret$2: int);
