...
procedure {:source_name "increment_kernel"} {:kernel} $_Z16increment_kernelPii($inc_value: int);
...
implementation {:source_name "increment_kernel"} {:kernel} $_Z16increment_kernelPii($inc_value: int)
{
  var v1$1: int;
  var v1$2: int;
  var v0$1: int;
