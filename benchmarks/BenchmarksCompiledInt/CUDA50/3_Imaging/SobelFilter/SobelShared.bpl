...
implementation {:source_name "SobelShared"} {:kernel} $_Z11SobelSharedP6uchar4tssssf($SobelPitch: int, $BlockWidth: int, $SharedPitch: int, $w: int, $h: int, $fScale: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
  ...
  $6:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b19 ==> !p3$1 ==> _WRITE_HAS_OCCURRED_$$LocalBlock$ghost$$6 == _WRITE_HAS_OCCURRED_$$LocalBlock;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b18 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $11:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 4) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 4) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 4) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 5) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 5) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 5) mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 2) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 3) mod 1;
    assert {:tag "accessUpperBoundBlock"} _b21 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV16_SEXT32(BV_EXTRACT(BV32_ADD(BV32_MUL(BV32_ADD(group_id_y$1, 1), group_size_y), local_id_y$1), 16, 0)), BV16_ZEXT32($SobelPitch)));
    assert {:tag "accessLowerBoundBlock"} _b20 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLE(BV32_MUL(BV16_SEXT32(BV_EXTRACT(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 16, 0)), BV16_ZEXT32($SobelPitch)), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
