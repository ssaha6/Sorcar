...
implementation {:source_name "d_recursiveGaussian_rgba"} {:kernel} $_Z24d_recursiveGaussian_rgbaPjS_iiffffffff($w: int, $h: int, $a0: int, $a1: int, $a2: int, $a3: int, $b1: int, $b2: int, $coefp: int, $coefn: int)
{
  ...
  $7:
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b10 ==> $.12$1 mod BV32_SUB(0, $w) == BV32_ADD($.01$1, v253$1) mod BV32_SUB(0, $w);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b10 ==> $.12$2 mod BV32_SUB(0, $w) == BV32_ADD($.01$2, v253$2) mod BV32_SUB(0, $w);
