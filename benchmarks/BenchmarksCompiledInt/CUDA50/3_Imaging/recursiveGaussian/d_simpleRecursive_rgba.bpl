...
implementation {:source_name "d_simpleRecursive_rgba"} {:kernel} $_Z22d_simpleRecursive_rgbaPjS_iif($w: int, $h: int, $a: int)
{
  ...
  $3:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b22 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$od$ghost$$3 == _WRITE_HAS_OCCURRED_$$od;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$od ==> _WATCHED_OFFSET mod $w == v0$1 mod $w;
    ...
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b6 ==> BV32_UGE($y.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b6 ==> BV32_UGE($y.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b5 ==> BV32_ULE($y.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b5 ==> BV32_ULE($y.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b4 ==> BV32_SGE($y.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b4 ==> BV32_SGE($y.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b3 ==> BV32_SLE($y.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b3 ==> BV32_SLE($y.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b2 ==> $y.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b2 ==> $y.0$2 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b1 ==> $.0$1 mod $w == v0$1 mod $w;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b1 ==> $.0$2 mod $w == v0$2 mod $w;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b0 ==> $.01$1 mod $w == v0$1 mod $w;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b0 ==> $.01$2 mod $w == v0$2 mod $w;
  ...
  $7:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b26 ==> !p1$1 ==> _WRITE_HAS_OCCURRED_$$od$ghost$$7 == _WRITE_HAS_OCCURRED_$$od;
    assert {:tag "disabledMaintainsInstrumentation"} _b25 ==> !p1$1 ==> _READ_HAS_OCCURRED_$$od$ghost$$7 == _READ_HAS_OCCURRED_$$od;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b24 ==> _WRITE_HAS_OCCURRED_$$od ==> _WATCHED_OFFSET mod BV32_SUB(0, $w) == BV32_ADD($.0$1, BV32_SUB(0, $w)) mod BV32_SUB(0, $w);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _READ_HAS_OCCURRED_$$od ==> _WATCHED_OFFSET mod BV32_SUB(0, $w) == BV32_ADD($.0$1, BV32_SUB(0, $w)) mod BV32_SUB(0, $w);
    assume {:predicate "p4"} {:dominator_predicate "p1"} true;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _WRITE_HAS_OCCURRED_$$od ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$od ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b18 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w) && BV32_SGE($y1.0$1, 0) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b18 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $w) && BV32_SGE($y1.0$2, 0) ==> p4$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b17 ==> p4$1 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $w);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b17 ==> p4$2 ==> !BV32_UGE(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $w);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b16 ==> BV32_UGE($y1.0$1, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b16 ==> BV32_UGE($y1.0$2, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b15 ==> BV32_ULE($y1.0$1, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b15 ==> BV32_ULE($y1.0$2, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b14 ==> BV32_SGE($y1.0$1, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b14 ==> BV32_SGE($y1.0$2, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b13 ==> BV32_SLE($y1.0$1, BV32_SUB($h, 1));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b13 ==> BV32_SLE($y1.0$2, BV32_SUB($h, 1));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b12 ==> $y1.0$1 mod -1 == BV32_SUB($h, 1) mod -1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b12 ==> $y1.0$2 mod -1 == BV32_SUB($h, 1) mod -1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b11 ==> $.1$1 mod BV32_SUB(0, $w) == BV32_ADD($.0$1, BV32_SUB(0, $w)) mod BV32_SUB(0, $w);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b11 ==> $.1$2 mod BV32_SUB(0, $w) == BV32_ADD($.0$2, BV32_SUB(0, $w)) mod BV32_SUB(0, $w);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b10 ==> $.12$1 mod BV32_SUB(0, $w) == BV32_ADD($.01$1, v113$1) mod BV32_SUB(0, $w);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b10 ==> $.12$2 mod BV32_SUB(0, $w) == BV32_ADD($.01$2, v113$2) mod BV32_SUB(0, $w);
