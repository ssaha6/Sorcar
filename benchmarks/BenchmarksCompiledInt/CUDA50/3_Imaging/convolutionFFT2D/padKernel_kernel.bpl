...
implementation {:source_name "padKernel_kernel"} {:kernel} $_Z16padKernel_kernelPfS_iiiiii($fftH: int, $fftW: int, $kernelH: int, $kernelW: int, $kernelY: int, $kernelX: int)
{
  var $ky.0$1: int;
  var $ky.0$2: int;
  var $kx.0$1: int;
  ...
  $0:
    ...
    v5$1 := (if p1$1 then BV32_SLT(v4$1, 0) else v5$1);
    v5$2 := (if p1$2 then BV32_SLT(v4$2, 0) else v5$2);
    ...
    v7$1 := (if p1$1 then BV32_SLT(v6$1, 0) else v7$1);
    v7$2 := (if p1$2 then BV32_SLT(v6$2, 0) else v7$2);
    ...
    $$0$0$1 := (if p1$1 then v8$1 else $$0$0$1);
    $$0$0$2 := (if p1$2 then v8$2 else $$0$0$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v9$1 := (if p1$1 then _HAVOC_int$1 else v9$1);
    v9$2 := (if p1$2 then _HAVOC_int$2 else v9$2);
    $$0$1$1 := (if p1$1 then v9$1 else $$0$1$1);
    $$0$1$2 := (if p1$2 then v9$2 else $$0$1$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v10$1 := (if p1$1 then _HAVOC_int$1 else v10$1);
    v10$2 := (if p1$2 then _HAVOC_int$2 else v10$2);
    $$0$2$1 := (if p1$1 then v10$1 else $$0$2$1);
    $$0$2$2 := (if p1$2 then v10$2 else $$0$2$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v11$1 := (if p1$1 then _HAVOC_int$1 else v11$1);
    v11$2 := (if p1$2 then _HAVOC_int$2 else v11$2);
    $$0$3$1 := (if p1$1 then v11$1 else $$0$3$1);
    $$0$3$2 := (if p1$2 then v11$2 else $$0$3$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v12$1 := (if p1$1 then _HAVOC_int$1 else v12$1);
    v12$2 := (if p1$2 then _HAVOC_int$2 else v12$2);
    $$0$4$1 := (if p1$1 then v12$1 else $$0$4$1);
    $$0$4$2 := (if p1$2 then v12$2 else $$0$4$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v13$1 := (if p1$1 then _HAVOC_int$1 else v13$1);
    v13$2 := (if p1$2 then _HAVOC_int$2 else v13$2);
    $$0$5$1 := (if p1$1 then v13$1 else $$0$5$1);
    $$0$5$2 := (if p1$2 then v13$2 else $$0$5$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v14$1 := (if p1$1 then _HAVOC_int$1 else v14$1);
    v14$2 := (if p1$2 then _HAVOC_int$2 else v14$2);
    $$0$6$1 := (if p1$1 then v14$1 else $$0$6$1);
    $$0$6$2 := (if p1$2 then v14$2 else $$0$6$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v15$1 := (if p1$1 then _HAVOC_int$1 else v15$1);
    v15$2 := (if p1$2 then _HAVOC_int$2 else v15$2);
    $$0$7$1 := (if p1$1 then v15$1 else $$0$7$1);
    $$0$7$2 := (if p1$2 then v15$2 else $$0$7$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v16$1 := (if p1$1 then _HAVOC_int$1 else v16$1);
    v16$2 := (if p1$2 then _HAVOC_int$2 else v16$2);
    $$0$8$1 := (if p1$1 then v16$1 else $$0$8$1);
    $$0$8$2 := (if p1$2 then v16$2 else $$0$8$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v17$1 := (if p1$1 then _HAVOC_int$1 else v17$1);
    v17$2 := (if p1$2 then _HAVOC_int$2 else v17$2);
    $$0$9$1 := (if p1$1 then v17$1 else $$0$9$1);
    $$0$9$2 := (if p1$2 then v17$2 else $$0$9$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v18$1 := (if p1$1 then _HAVOC_int$1 else v18$1);
    v18$2 := (if p1$2 then _HAVOC_int$2 else v18$2);
    $$0$10$1 := (if p1$1 then v18$1 else $$0$10$1);
    $$0$10$2 := (if p1$2 then v18$2 else $$0$10$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v19$1 := (if p1$1 then _HAVOC_int$1 else v19$1);
    v19$2 := (if p1$2 then _HAVOC_int$2 else v19$2);
    $$0$11$1 := (if p1$1 then v19$1 else $$0$11$1);
    $$0$11$2 := (if p1$2 then v19$2 else $$0$11$2);
    v20$1 := (if p1$1 then $$0$0$1 else v20$1);
    v20$2 := (if p1$2 then $$0$0$2 else v20$2);
    v21$1 := (if p1$1 then $$0$1$1 else v21$1);
    v21$2 := (if p1$2 then $$0$1$2 else v21$2);
    v22$1 := (if p1$1 then $$0$2$1 else v22$1);
    v22$2 := (if p1$2 then $$0$2$2 else v22$2);
    v23$1 := (if p1$1 then $$0$3$1 else v23$1);
    v23$2 := (if p1$2 then $$0$3$2 else v23$2);
    v24$1 := (if p1$1 then $$0$4$1 else v24$1);
    v24$2 := (if p1$2 then $$0$4$2 else v24$2);
    v25$1 := (if p1$1 then $$0$5$1 else v25$1);
    v25$2 := (if p1$2 then $$0$5$2 else v25$2);
    v26$1 := (if p1$1 then $$0$6$1 else v26$1);
    v26$2 := (if p1$2 then $$0$6$2 else v26$2);
    v27$1 := (if p1$1 then $$0$7$1 else v27$1);
    v27$2 := (if p1$2 then $$0$7$2 else v27$2);
    v28$1 := (if p1$1 then $$0$8$1 else v28$1);
    v28$2 := (if p1$2 then $$0$8$2 else v28$2);
    v29$1 := (if p1$1 then $$0$9$1 else v29$1);
    v29$2 := (if p1$2 then $$0$9$2 else v29$2);
    v30$1 := (if p1$1 then $$0$10$1 else v30$1);
    v30$2 := (if p1$2 then $$0$10$2 else v30$2);
    v31$1 := (if p1$1 then $$0$11$1 else v31$1);
    v31$2 := (if p1$2 then $$0$11$2 else v31$2);
    call {:sourceloc_num 45} v32$1, v32$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(p1$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v23$1, v22$1), v21$1), v20$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v27$1, v26$1), v25$1), v24$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v31$1, v30$1), v29$1), v28$1), BV32_ADD(BV32_MUL(v0$1, $kernelW), v1$1), p1$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(v23$2, v22$2), v21$2), v20$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v27$2, v26$2), v25$2), v24$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v31$2, v30$2), v29$2), v28$2), BV32_ADD(BV32_MUL(v0$2, $kernelW), v1$2));
