...
procedure {:source_name "spPostprocess2D_kernel"} {:kernel} $_Z22spPostprocess2D_kernelP6float2S0_jjjjf($DY: int, $DX: int, $threadCount: int, $padding: int, $phaseBase: int);
...
implementation {:source_name "spPostprocess2D_kernel"} {:kernel} $_Z22spPostprocess2D_kernelP6float2S0_jjjjf($DY: int, $DX: int, $threadCount: int, $padding: int, $phaseBase: int)
{
  var $0$1: int;
  var $0$2: int;
  var $1$1: int;
  ...
  $0:
    ...
    v14$1 := (if p6$1 then v3$1 != 0 else v14$1);
    v14$2 := (if p6$2 then v3$2 != 0 else v14$2);
    ...
    v16$1 := (if p6$1 then v6$1 != 0 else v16$1);
    v16$2 := (if p6$2 then v6$2 != 0 else v16$2);
    ...
    call {:sourceloc_num 118} v82$1, v82$2 := $_Z10tex1DfetchI6float2ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi(p6$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v73$1, v72$1), v71$1), v70$1), v69$1), v68$1), v67$1), v66$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v77$1, v76$1), v75$1), v74$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v81$1, v80$1), v79$1), v78$1), BV32_ADD(BV32_ADD(v11$1, BV32_MUL($0$1, $DX)), $1$1), p6$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(BV_CONCAT(v73$2, v72$2), v71$2), v70$2), v69$2), v68$2), v67$2), v66$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v77$2, v76$2), v75$2), v74$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v81$2, v80$2), v79$2), v78$2), BV32_ADD(BV32_ADD(v11$2, BV32_MUL($0$2, $DX)), $1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchI6float2ET_7textureIS1_Li1EL19cudaTextureReadMode0EEi"} true;
    ...
    v88$1 := (if p6$1 then FMUL32(1056964608, FADD32(v86$1, v87$1)) else v88$1);
    v88$2 := (if p6$2 then FMUL32(1056964608, FADD32(v86$2, v87$2)) else v88$2);
    ...
    v91$1 := (if p6$1 then FMUL32(1056964608, FSUB32(v89$1, v90$1)) else v91$1);
    v91$2 := (if p6$2 then FMUL32(1056964608, FSUB32(v89$2, v90$2)) else v91$2);
    ...
    v94$1 := (if p6$1 then FMUL32(1056964608, FADD32(v92$1, v93$1)) else v94$1);
    v94$2 := (if p6$2 then FMUL32(1056964608, FADD32(v92$2, v93$2)) else v94$2);
    ...
    v97$1 := (if p6$1 then FMUL32(1056964608, FSUB32(v95$1, v96$1)) else v97$1);
    v97$2 := (if p6$2 then FMUL32(1056964608, FSUB32(v95$2, v96$2)) else v97$2);
    ...
    $$D1$0$1 := (if p6$1 then FADD32(v88$1, FADD32(FMUL32(v94$1, v98$1), FMUL32(v97$1, v99$1))) else $$D1$0$1);
    $$D1$0$2 := (if p6$2 then FADD32(v88$2, FADD32(FMUL32(v94$2, v98$2), FMUL32(v97$2, v99$2))) else $$D1$0$2);
    v100$1 := (if p6$1 then $$twiddle$1$1 else v100$1);
    v100$2 := (if p6$2 then $$twiddle$1$2 else v100$2);
    v101$1 := (if p6$1 then $$twiddle$0$1 else v101$1);
    v101$2 := (if p6$2 then $$twiddle$0$2 else v101$2);
    $$D1$1$1 := (if p6$1 then FADD32(FSUB32(FMUL32(v94$1, v100$1), FMUL32(v97$1, v101$1)), v91$1) else $$D1$1$1);
    $$D1$1$2 := (if p6$2 then FADD32(FSUB32(FMUL32(v94$2, v100$2), FMUL32(v97$2, v101$2)), v91$2) else $$D1$1$2);
    ...
    $$D2$0$1 := (if p6$1 then FSUB32(v88$1, FADD32(FMUL32(v94$1, v102$1), FMUL32(v97$1, v103$1))) else $$D2$0$1);
    $$D2$0$2 := (if p6$2 then FSUB32(v88$2, FADD32(FMUL32(v94$2, v102$2), FMUL32(v97$2, v103$2))) else $$D2$0$2);
    v104$1 := (if p6$1 then $$twiddle$1$1 else v104$1);
    v104$2 := (if p6$2 then $$twiddle$1$2 else v104$2);
    v105$1 := (if p6$1 then $$twiddle$0$1 else v105$1);
    v105$2 := (if p6$2 then $$twiddle$0$2 else v105$2);
    $$D2$1$1 := (if p6$1 then FSUB32(FSUB32(FMUL32(v94$1, v104$1), FMUL32(v97$1, v105$1)), v91$1) else $$D2$1$1);
    $$D2$1$2 := (if p6$2 then FSUB32(FSUB32(FMUL32(v94$2, v104$2), FMUL32(v97$2, v105$2)), v91$2) else $$D2$1$2);
    v106$1 := (if p6$1 then $$D1$0$1 else v106$1);
    v106$2 := (if p6$2 then $$D1$0$2 else v106$2);
    call {:sourceloc} {:sourceloc_num 146} _LOG_WRITE_$$d_Dst(p6$1, BV32_MUL(v15$1, 2), v106$1, $$d_Dst[BV32_MUL(v15$1, 2)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p6$2, BV32_MUL(v15$2, 2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 146} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 146} _CHECK_WRITE_$$d_Dst(p6$2, BV32_MUL(v15$2, 2), v106$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_MUL(v15$1, 2)] := (if p6$1 then v106$1 else $$d_Dst[BV32_MUL(v15$1, 2)]);
    $$d_Dst[BV32_MUL(v15$2, 2)] := (if p6$2 then v106$2 else $$d_Dst[BV32_MUL(v15$2, 2)]);
    v107$1 := (if p6$1 then $$D1$1$1 else v107$1);
    v107$2 := (if p6$2 then $$D1$1$2 else v107$2);
    call {:sourceloc} {:sourceloc_num 148} _LOG_WRITE_$$d_Dst(p6$1, BV32_ADD(BV32_MUL(v15$1, 2), 1), v107$1, $$d_Dst[BV32_ADD(BV32_MUL(v15$1, 2), 1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p6$2, BV32_ADD(BV32_MUL(v15$2, 2), 1));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 148} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 148} _CHECK_WRITE_$$d_Dst(p6$2, BV32_ADD(BV32_MUL(v15$2, 2), 1), v107$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(BV32_MUL(v15$1, 2), 1)] := (if p6$1 then v107$1 else $$d_Dst[BV32_ADD(BV32_MUL(v15$1, 2), 1)]);
    $$d_Dst[BV32_ADD(BV32_MUL(v15$2, 2), 1)] := (if p6$2 then v107$2 else $$d_Dst[BV32_ADD(BV32_MUL(v15$2, 2), 1)]);
    v108$1 := (if p6$1 then $$D2$0$1 else v108$1);
    v108$2 := (if p6$2 then $$D2$0$2 else v108$2);
    call {:sourceloc} {:sourceloc_num 150} _LOG_WRITE_$$d_Dst(p6$1, BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2), v108$1, $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p6$2, BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 150} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 150} _CHECK_WRITE_$$d_Dst(p6$2, BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2), v108$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2)] := (if p6$1 then v108$1 else $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2)]);
    $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2)] := (if p6$2 then v108$2 else $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2)]);
    v109$1 := (if p6$1 then $$D2$1$1 else v109$1);
    v109$2 := (if p6$2 then $$D2$1$2 else v109$2);
    call {:sourceloc} {:sourceloc_num 152} _LOG_WRITE_$$d_Dst(p6$1, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2), 1), v109$1, $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2), 1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p6$2, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2), 1));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 152} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 152} _CHECK_WRITE_$$d_Dst(p6$2, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2), 1), v109$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2), 1)] := (if p6$1 then v109$1 else $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($2$1, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$1)), 2), 1)]);
    $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2), 1)] := (if p6$2 then v109$2 else $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($2$2, BV32_ADD($DX, $padding))), BV32_SUB($DX, v3$2)), 2), 1)]);
    ...
    v112$1 := (if p13$1 then BV32_ADD(BV32_ADD(v12$1, BV32_MUL(v6$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)) else v112$1);
    v112$2 := (if p13$2 then BV32_ADD(BV32_ADD(v12$2, BV32_MUL(v6$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)) else v112$2);
    ...
    v182$1 := (if p13$1 then FMUL32(1056964608, FADD32(v180$1, v181$1)) else v182$1);
    v182$2 := (if p13$2 then FMUL32(1056964608, FADD32(v180$2, v181$2)) else v182$2);
    ...
    v185$1 := (if p13$1 then FMUL32(1056964608, FSUB32(v183$1, v184$1)) else v185$1);
    v185$2 := (if p13$2 then FMUL32(1056964608, FSUB32(v183$2, v184$2)) else v185$2);
    ...
    v188$1 := (if p13$1 then FMUL32(1056964608, FADD32(v186$1, v187$1)) else v188$1);
    v188$2 := (if p13$2 then FMUL32(1056964608, FADD32(v186$2, v187$2)) else v188$2);
    ...
    v191$1 := (if p13$1 then FMUL32(1056964608, FSUB32(v189$1, v190$1)) else v191$1);
    v191$2 := (if p13$2 then FMUL32(1056964608, FSUB32(v189$2, v190$2)) else v191$2);
    ...
    $$D15$0$1 := (if p13$1 then FADD32(v182$1, FADD32(FMUL32(v188$1, v192$1), FMUL32(v191$1, v193$1))) else $$D15$0$1);
    $$D15$0$2 := (if p13$2 then FADD32(v182$2, FADD32(FMUL32(v188$2, v192$2), FMUL32(v191$2, v193$2))) else $$D15$0$2);
    v194$1 := (if p13$1 then $$twiddle7$1$1 else v194$1);
    v194$2 := (if p13$2 then $$twiddle7$1$2 else v194$2);
    v195$1 := (if p13$1 then $$twiddle7$0$1 else v195$1);
    v195$2 := (if p13$2 then $$twiddle7$0$2 else v195$2);
    $$D15$1$1 := (if p13$1 then FADD32(FSUB32(FMUL32(v188$1, v194$1), FMUL32(v191$1, v195$1)), v185$1) else $$D15$1$1);
    $$D15$1$2 := (if p13$2 then FADD32(FSUB32(FMUL32(v188$2, v194$2), FMUL32(v191$2, v195$2)), v185$2) else $$D15$1$2);
    ...
    $$D26$0$1 := (if p13$1 then FSUB32(v182$1, FADD32(FMUL32(v188$1, v196$1), FMUL32(v191$1, v197$1))) else $$D26$0$1);
    $$D26$0$2 := (if p13$2 then FSUB32(v182$2, FADD32(FMUL32(v188$2, v196$2), FMUL32(v191$2, v197$2))) else $$D26$0$2);
    v198$1 := (if p13$1 then $$twiddle7$1$1 else v198$1);
    v198$2 := (if p13$2 then $$twiddle7$1$2 else v198$2);
    v199$1 := (if p13$1 then $$twiddle7$0$1 else v199$1);
    v199$2 := (if p13$2 then $$twiddle7$0$2 else v199$2);
    $$D26$1$1 := (if p13$1 then FSUB32(FSUB32(FMUL32(v188$1, v198$1), FMUL32(v191$1, v199$1)), v185$1) else $$D26$1$1);
    $$D26$1$2 := (if p13$2 then FSUB32(FSUB32(FMUL32(v188$2, v198$2), FMUL32(v191$2, v199$2)), v185$2) else $$D26$1$2);
    ...
    call {:sourceloc} {:sourceloc_num 289} _LOG_WRITE_$$d_Dst(p13$1, BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), v202$1, $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p13$2, BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2));
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 289} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 289} _CHECK_WRITE_$$d_Dst(p13$2, BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), v202$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2)] := (if p13$1 then v202$1 else $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2)]);
    $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2)] := (if p13$2 then v202$2 else $$d_Dst[BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2)]);
    v203$1 := (if p13$1 then $$D26$1$1 else v203$1);
    v203$2 := (if p13$2 then $$D26$1$2 else v203$2);
    call {:sourceloc} {:sourceloc_num 291} _LOG_WRITE_$$d_Dst(p13$1, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1), v203$1, $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p13$2, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 291} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 291} _CHECK_WRITE_$$d_Dst(p13$2, BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1), v203$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1)] := (if p13$1 then v203$1 else $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$1, BV32_MUL($4$1, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1)]);
    $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1)] := (if p13$2 then v203$2 else $$d_Dst[BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(v12$2, BV32_MUL($4$2, BV32_ADD($DX, $padding))), BV32_UDIV($DX, 2)), 2), 1)]);
    return;
}
