...
procedure {:source_name "convolutionColumnsKernel"} {:kernel} $_Z24convolutionColumnsKernelPfii($imageW: int, $imageH: int);
...
implementation {:source_name "convolutionColumnsKernel"} {:kernel} $_Z24convolutionColumnsKernelPfii($imageW: int, $imageH: int)
{
  var $sum.0$1: int;
  var $sum.0$2: int;
  var $k.0$1: int;
  ...
  $4:
    ...
    call {:sourceloc_num 43} v29$1, v29$2 := $_Z5tex2DIfET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p6$1, BV_CONCAT(BV_CONCAT(BV_CONCAT(v20$1, v19$1), v18$1), v17$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v24$1, v23$1), v22$1), v21$1), BV_CONCAT(BV_CONCAT(BV_CONCAT(v28$1, v27$1), v26$1), v25$1), FADD32(SI32_TO_FP32(v0$1), 1056964608), FADD32(FADD32(SI32_TO_FP32(v1$1), 1056964608), SI32_TO_FP32($k.0$1)), p6$2, BV_CONCAT(BV_CONCAT(BV_CONCAT(v20$2, v19$2), v18$2), v17$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v24$2, v23$2), v22$2), v21$2), BV_CONCAT(BV_CONCAT(BV_CONCAT(v28$2, v27$2), v26$2), v25$2), FADD32(SI32_TO_FP32(v0$2), 1056964608), FADD32(FADD32(SI32_TO_FP32(v1$2), 1056964608), SI32_TO_FP32($k.0$2)));
