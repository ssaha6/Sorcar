...
assert  my_inv (  (  $dy.0 mod 1 == BV32_SUB(0, $r) mod 1 ) ,  (  BV32_SLE($dy.0, BV32_SUB(0, $r)) ) ,  (  BV32_SGE($dy.0, BV32_SUB(0, $r)) ) ,  (  BV32_ULE($dy.0, BV32_SUB(0, $r)) ) ,  (  BV32_UGE($dy.0, BV32_SUB(0, $r)) ) ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4) ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  $dx.0 mod 1 == BV32_SUB(0, $r) mod 1 ) ,  (  BV32_SLE($dx.0, BV32_SUB(0, $r)) ) ,  (  BV32_SGE($dx.0, BV32_SUB(0, $r)) ) ,  (  BV32_ULE($dx.0, BV32_SUB(0, $r)) ) ,  (  BV32_UGE($dx.0, BV32_SUB(0, $r)) ) ,  true ,  (  _READ_HAS_OCCURRED_$$sdata ==> _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_MUL(0, 4) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(1, 4) || _WATCHED_OFFSET mod BV32_MUL(1, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(1, 4) )  ); 
