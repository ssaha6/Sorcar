...
assert  my_inv (  (  $i.0 mod 1 == 1 mod 1 ) ,  (  BV32_SLE($i.0, 1) ) ,  (  BV32_SGE($i.0, 1) ) ,  (  BV32_ULE($i.0, 1) ) ,  (  BV32_UGE($i.0, 1) ) ,  (  BV32_SLE($num_threads.0$1, BV32_ASHR($bdim, 1)) )  && (  BV32_SLE($num_threads.0$2, BV32_ASHR($bdim, 1)) ) ,  (  BV32_SGE($num_threads.0$1, BV32_ASHR($bdim, 1)) )  && (  BV32_SGE($num_threads.0$2, BV32_ASHR($bdim, 1)) ) ,  (  BV32_ULE($num_threads.0$1, BV32_ASHR($bdim, 1)) )  && (  BV32_ULE($num_threads.0$2, BV32_ASHR($bdim, 1)) ) ,  (  BV32_UGE($num_threads.0$1, BV32_ASHR($bdim, 1)) )  && (  BV32_UGE($num_threads.0$2, BV32_ASHR($bdim, 1)) ) ,  (  $offset_neighbor.0$1 == 0 || BV32_AND($offset_neighbor.0$1, BV32_SUB($offset_neighbor.0$1, 1)) == 0 ) ,  (  $offset_neighbor.0$1 != 0 ) ,  (  $offset_neighbor.0$2 == 0 || BV32_AND($offset_neighbor.0$2, BV32_SUB($offset_neighbor.0$2, 1)) == 0 ) ,  (  $offset_neighbor.0$2 != 0 ) ,  (  $num_threads.0$1 == 0 || BV32_AND($num_threads.0$1, BV32_SUB($num_threads.0$1, 1)) == 0 ) ,  (  $num_threads.0$1 != 0 ) ,  (  $num_threads.0$2 == 0 || BV32_AND($num_threads.0$2, BV32_SUB($num_threads.0$2, 1)) == 0 ) ,  (  $num_threads.0$2 != 0 ) ,  (  $idata0.0$1 == 0 || BV32_AND($idata0.0$1, BV32_SUB($idata0.0$1, 1)) == 0 ) ,  (  $idata0.0$1 != 0 ) ,  (  $idata0.0$2 == 0 || BV32_AND($idata0.0$2, BV32_SUB($idata0.0$2, 1)) == 0 ) ,  (  $idata0.0$2 != 0 ) ,  (  $offset_neighbor.1$1 == 0 || BV32_AND($offset_neighbor.1$1, BV32_SUB($offset_neighbor.1$1, 1)) == 0 ) ,  (  $offset_neighbor.1$1 != 0 ) ,  (  $offset_neighbor.1$2 == 0 || BV32_AND($offset_neighbor.1$2, BV32_SUB($offset_neighbor.1$2, 1)) == 0 ) ,  (  $offset_neighbor.1$2 != 0 ) ,  (  $num_threads.1$1 == 0 || BV32_AND($num_threads.1$1, BV32_SUB($num_threads.1$1, 1)) == 0 ) ,  (  $num_threads.1$1 != 0 ) ,  (  $num_threads.1$2 == 0 || BV32_AND($num_threads.1$2, BV32_SUB($num_threads.1$2, 1)) == 0 ) ,  (  $num_threads.1$2 != 0 ) ,  (  $idata0.1$1 == 0 || BV32_AND($idata0.1$1, BV32_SUB($idata0.1$1, 1)) == 0 ) ,  (  $idata0.1$1 != 0 ) ,  (  $idata0.1$2 == 0 || BV32_AND($idata0.1$2, BV32_SUB($idata0.1$2, 1)) == 0 ) ,  (  $idata0.1$2 != 0 ) ,  (  !_WRITE_HAS_OCCURRED_$$od ) ,  (  !_READ_HAS_OCCURRED_$$shared ) ,  (  !_WRITE_HAS_OCCURRED_$$shared )  ); 
