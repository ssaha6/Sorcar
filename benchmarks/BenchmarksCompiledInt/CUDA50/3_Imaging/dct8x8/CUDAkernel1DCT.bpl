...
implementation {:source_name "CUDAkernel1DCT"} {:kernel} $_Z14CUDAkernel1DCTPfiii($ImgWidth: int, $OffsetXBlocks: int, $OffsetYBlocks: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _READ_HAS_OCCURRED_$$CurBlockLocal1 ==> _WATCHED_OFFSET mod 8 == local_id_x$1 mod 8;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> $DCTv8matrixIndex.0$1 mod 8 == local_id_y$1 mod 8;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> $DCTv8matrixIndex.0$2 mod 8 == local_id_y$2 mod 8;
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> _WATCHED_OFFSET mod 1 == BV32_SHL(local_id_y$1, 3) mod 1;
    assert {:tag "pow2NotZero"} _b18 ==> $CurBlockLocal2Index.0$2 != 0;
    assert {:tag "pow2"} _b17 ==> $CurBlockLocal2Index.0$2 == 0 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b16 ==> $CurBlockLocal2Index.0$1 != 0;
    assert {:tag "pow2"} _b15 ==> $CurBlockLocal2Index.0$1 == 0 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b7 ==> $DCTv8matrixIndex.1$1 mod 8 == local_id_x$1 mod 8;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b7 ==> $DCTv8matrixIndex.1$2 mod 8 == local_id_x$2 mod 8;
