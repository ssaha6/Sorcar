...
assert  my_inv (  (  $DCTv8matrixIndex.0$1 mod 1 == BV32_SHL(local_id_y$1, 3) mod 1 )  && (  $DCTv8matrixIndex.0$2 mod 1 == BV32_SHL(local_id_y$2, 3) mod 1 ) ,  (  $CurBlockLocal1Index.0$1 mod 8 == local_id_x$1 mod 8 )  && (  $CurBlockLocal1Index.0$2 mod 8 == local_id_x$2 mod 8 ) ,  (  $i.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $DCTv8matrixIndex.0$1 == 0 || BV32_AND($DCTv8matrixIndex.0$1, BV32_SUB($DCTv8matrixIndex.0$1, 1)) == 0 ) ,  (  $DCTv8matrixIndex.0$1 != 0 ) ,  (  $DCTv8matrixIndex.0$2 == 0 || BV32_AND($DCTv8matrixIndex.0$2, BV32_SUB($DCTv8matrixIndex.0$2, 1)) == 0 ) ,  (  $DCTv8matrixIndex.0$2 != 0 ) ,  (  _READ_HAS_OCCURRED_$$CurBlockLocal1 ==> _WATCHED_OFFSET mod 8 == local_id_x$1 mod 8 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $DCTv8matrixIndex.1$1 mod 1 == BV32_SHL(local_id_x$1, 3) mod 1 )  && (  $DCTv8matrixIndex.1$2 mod 1 == BV32_SHL(local_id_x$2, 3) mod 1 ) ,  (  $CurBlockLocal2Index.0$1 mod 1 == BV32_SHL(local_id_y$1, 3) mod 1 )  && (  $CurBlockLocal2Index.0$2 mod 1 == BV32_SHL(local_id_y$2, 3) mod 1 ) ,  (  $i1.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i1.0, 0) ) ,  (  BV32_SGE($i1.0, 0) ) ,  (  BV32_ULE($i1.0, 0) ) ,  (  BV32_UGE($i1.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  (  $DCTv8matrixIndex.1$1 == 0 || BV32_AND($DCTv8matrixIndex.1$1, BV32_SUB($DCTv8matrixIndex.1$1, 1)) == 0 ) ,  (  $DCTv8matrixIndex.1$1 != 0 ) ,  (  $DCTv8matrixIndex.1$2 == 0 || BV32_AND($DCTv8matrixIndex.1$2, BV32_SUB($DCTv8matrixIndex.1$2, 1)) == 0 ) ,  (  $DCTv8matrixIndex.1$2 != 0 ) ,  (  $CurBlockLocal2Index.0$1 == 0 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1)) == 0 ) ,  (  $CurBlockLocal2Index.0$1 != 0 ) ,  (  $CurBlockLocal2Index.0$2 == 0 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1)) == 0 ) ,  (  $CurBlockLocal2Index.0$2 != 0 ) ,  (  _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> _WATCHED_OFFSET mod 1 == BV32_SHL(local_id_y$1, 3) mod 1 )  ); 
