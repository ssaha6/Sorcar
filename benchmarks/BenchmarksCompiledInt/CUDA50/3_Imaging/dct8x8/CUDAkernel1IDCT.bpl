...
implementation {:source_name "CUDAkernel1IDCT"} {:kernel} $_Z15CUDAkernel1IDCTPfiii($ImgWidth: int, $OffsetXBlocks: int, $OffsetYBlocks: int)
{
  var $curelem.0$1: int;
  var $curelem.0$2: int;
  ...
  __partitioned_block_$0_1:
    ...
    $curelem.0$1, $DCTv8matrixIndex.0$1, $CurBlockLocal1Index.0$1, $i.0 := 0, BV32_SHL(local_id_y$1, 3), local_id_x$1, 0;
    $curelem.0$2, $DCTv8matrixIndex.0$2, $CurBlockLocal1Index.0$2 := 0, BV32_SHL(local_id_y$2, 3), local_id_x$2;
    assume {:captureState "loop_entry_state_1_0"} true;
    goto $1;

  $1:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b18 ==> _READ_HAS_OCCURRED_$$CurBlockLocal1 ==> _WATCHED_OFFSET mod 8 == local_id_x$1 mod 8;
    assert {:tag "pow2NotZero"} _b17 ==> $DCTv8matrixIndex.0$2 != 0;
    assert {:tag "pow2"} _b16 ==> $DCTv8matrixIndex.0$2 == 0 || BV32_AND($DCTv8matrixIndex.0$2, BV32_SUB($DCTv8matrixIndex.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b15 ==> $DCTv8matrixIndex.0$1 != 0;
    assert {:tag "pow2"} _b14 ==> $DCTv8matrixIndex.0$1 == 0 || BV32_AND($DCTv8matrixIndex.0$1, BV32_SUB($DCTv8matrixIndex.0$1, 1)) == 0;
    ...
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> $CurBlockLocal1Index.0$1 mod 8 == local_id_x$1 mod 8;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b1 ==> $CurBlockLocal1Index.0$2 mod 8 == local_id_x$2 mod 8;
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> $DCTv8matrixIndex.0$1 mod 1 == BV32_SHL(local_id_y$1, 3) mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> $DCTv8matrixIndex.0$2 mod 1 == BV32_SHL(local_id_y$2, 3) mod 1;
  ...
  __partitioned_block_$falsebb_1:
    ...
    $curelem.1$1, $DCTv8matrixIndex.1$1, $CurBlockLocal2Index.0$1, $i1.0 := 0, BV32_SHL(local_id_x$1, 3), BV32_SHL(local_id_y$1, 3), 0;
    $curelem.1$2, $DCTv8matrixIndex.1$2, $CurBlockLocal2Index.0$2 := 0, BV32_SHL(local_id_x$2, 3), BV32_SHL(local_id_y$2, 3);
    assume {:captureState "loop_entry_state_0_0"} true;
    goto $5;

  $5:
    assume {:captureState "loop_head_state_0"} true;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> _WATCHED_OFFSET mod 1 == BV32_SHL(local_id_y$1, 3) mod 1;
    assert {:tag "pow2NotZero"} _b26 ==> $CurBlockLocal2Index.0$2 != 0;
    assert {:tag "pow2"} _b25 ==> $CurBlockLocal2Index.0$2 == 0 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b24 ==> $CurBlockLocal2Index.0$1 != 0;
    assert {:tag "pow2"} _b23 ==> $CurBlockLocal2Index.0$1 == 0 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1)) == 0;
    assert {:tag "pow2NotZero"} _b22 ==> $DCTv8matrixIndex.1$2 != 0;
    assert {:tag "pow2"} _b21 ==> $DCTv8matrixIndex.1$2 == 0 || BV32_AND($DCTv8matrixIndex.1$2, BV32_SUB($DCTv8matrixIndex.1$2, 1)) == 0;
    assert {:tag "pow2NotZero"} _b20 ==> $DCTv8matrixIndex.1$1 != 0;
    assert {:tag "pow2"} _b19 ==> $DCTv8matrixIndex.1$1 == 0 || BV32_AND($DCTv8matrixIndex.1$1, BV32_SUB($DCTv8matrixIndex.1$1, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_UGE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_ULE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SGE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SLE($i1.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b9 ==> $i1.0 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b8 ==> $CurBlockLocal2Index.0$1 mod 1 == BV32_SHL(local_id_y$1, 3) mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b8 ==> $CurBlockLocal2Index.0$2 mod 1 == BV32_SHL(local_id_y$2, 3) mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b7 ==> $DCTv8matrixIndex.1$1 mod 1 == BV32_SHL(local_id_x$1, 3) mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b7 ==> $DCTv8matrixIndex.1$2 mod 1 == BV32_SHL(local_id_x$2, 3) mod 1;
  ...
  $truebb0:
    ...
    $curelem.1$1, $DCTv8matrixIndex.1$1, $CurBlockLocal2Index.0$1, $i1.0 := FADD32($curelem.1$1, FMUL32(v31$1, v32$1)), BV32_ADD($DCTv8matrixIndex.1$1, 1), BV32_ADD($CurBlockLocal2Index.0$1, 1), BV32_ADD($i1.0, 1);
    $curelem.1$2, $DCTv8matrixIndex.1$2, $CurBlockLocal2Index.0$2 := FADD32($curelem.1$2, FMUL32(v31$2, v32$2)), BV32_ADD($DCTv8matrixIndex.1$2, 1), BV32_ADD($CurBlockLocal2Index.0$2, 1);
  ...
  $truebb:
    ...
    $curelem.0$1, $DCTv8matrixIndex.0$1, $CurBlockLocal1Index.0$1, $i.0 := FADD32($curelem.0$1, FMUL32(v28$1, v29$1)), BV32_ADD($DCTv8matrixIndex.0$1, 1), BV32_ADD($CurBlockLocal1Index.0$1, 8), BV32_ADD($i.0, 1);
    $curelem.0$2, $DCTv8matrixIndex.0$2, $CurBlockLocal1Index.0$2 := FADD32($curelem.0$2, FMUL32(v28$2, v29$2)), BV32_ADD($DCTv8matrixIndex.0$2, 1), BV32_ADD($CurBlockLocal1Index.0$2, 8);
