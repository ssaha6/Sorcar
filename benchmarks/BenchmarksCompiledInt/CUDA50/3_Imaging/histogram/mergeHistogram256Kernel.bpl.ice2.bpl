...
assert  my_inv (  (  BV32_SLE($stride.0, 128) ) ,  (  BV32_SGE($stride.0, 128) ) ,  (  BV32_ULE($stride.0, 128) ) ,  (  BV32_UGE($stride.0, 128) ) ,  (  $stride.0 == 0 || BV32_AND($stride.0, BV32_SUB($stride.0, 1)) == 0 ) ,  (  $stride.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ) ,  (  _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
