...
var {:source_name "data"} {:group_shared} $$_ZZ23mergeHistogram256KernelPjS_jE4data: [bv1][int]int;
...
procedure {:source_name "mergeHistogram256Kernel"} {:kernel} $_Z23mergeHistogram256KernelPjS_j($histogramCount: int);
...
implementation {:source_name "mergeHistogram256Kernel"} {:kernel} $_Z23mergeHistogram256KernelPjS_j($histogramCount: int)
{
  var $sum.0$1: int;
  var $sum.0$2: int;
  var $i.0$1: int;
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride.0, 128);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride.0, 128);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride.0, 128);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride.0, 128);
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p5$1, 0, $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p5$2, 0, $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    v7$1 := (if p5$1 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][0] else v7$1);
    v7$2 := (if p5$2 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] else v7$2);
...
const _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data: int;

procedure {:inline 1} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;



implementation {:inline 1} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon0:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;
    goto anon1;
