...
implementation {:source_name "mergeHistogram64Kernel"} {:kernel} $_Z22mergeHistogram64KernelPjS_j($histogramCount: int)
{
  var $sum.0$1: int;
  var $sum.0$2: int;
  var $i.0$1: int;
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
