...
function  BV8_ADD(x: int, y: int) : int
{
  x + y
}
...
assert  my_inv (  (  $i.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(1, 64), 4) == BV32_MUL(BV32_ADD(BV32_MUL(0, 64), local_id_x$1), 4) mod BV32_MUL(BV32_MUL(1, 64), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(1, 64), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0, 64), local_id_x$1), 4), 1) mod BV32_MUL(BV32_MUL(1, 64), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(1, 64), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0, 64), local_id_x$1), 4), 2) mod BV32_MUL(BV32_MUL(1, 64), 4) || _WATCHED_OFFSET mod BV32_MUL(BV32_MUL(1, 64), 4) == BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(0, 64), local_id_x$1), 4), 3) mod BV32_MUL(BV32_MUL(1, 64), 4) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(local_id_x$1, 64)) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(BV32_ADD(0, 1), BV32_MUL(local_id_x$1, 64)) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(BV32_ADD(0, 2), BV32_MUL(local_id_x$1, 64)) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(BV32_ADD(0, 3), BV32_MUL(local_id_x$1, 64)) mod 1 ) ,  (  !p3$1 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist$ghost$$10 == _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $i2.0$1 mod 1 == 0 mod 1 )  && ( p4$2 ==> $i2.0$2 mod 1 == 0 mod 1 ) ,  ( p4$1 ==> BV32_SLE($i2.0$1, 0) )  && ( p4$2 ==> BV32_SLE($i2.0$2, 0) ) ,  ( p4$1 ==> BV32_SGE($i2.0$1, 0) )  && ( p4$2 ==> BV32_SGE($i2.0$2, 0) ) ,  ( p4$1 ==> BV32_ULE($i2.0$1, 0) )  && ( p4$2 ==> BV32_ULE($i2.0$2, 0) ) ,  ( p4$1 ==> BV32_UGE($i2.0$1, 0) )  && ( p4$2 ==> BV32_UGE($i2.0$2, 0) ) ,  ( p4$1 ==> p4$1 ==> BV32_ULT(local_id_x$1, 64) )  && ( p4$2 ==> p4$2 ==> BV32_ULT(local_id_x$2, 64) ) ,  (  BV32_ULT(local_id_x$1, 64) && BV32_ULT($i2.0$1, 16) ==> p4$1 )  && (  BV32_ULT(local_id_x$2, 64) && BV32_ULT($i2.0$2, 16) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> BV32_ULT(local_id_x$1, 64) ) ,  true ,  true ,  true ,  true ,  true  ); 
