...
var {:source_name "du"} {:group_shared} $$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du: [bv1][int]int;
...
var {:source_name "dv"} {:group_shared} $$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv: [bv1][int]int;
...
procedure {:source_name "JacobiIteration<32, 6>"} {:kernel} $_Z15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_($w: int, $h: int, $s: int, $alpha: int);
  requires {:sourceloc_num 0} {:thread 1} (if $w == 320 then 1 else 0) != 0;
  requires {:sourceloc_num 1} {:thread 1} (if $h == 240 then 1 else 0) != 0;
  requires {:sourceloc_num 2} {:thread 1} (if $s == 320 then 1 else 0) != 0;
...
implementation {:source_name "JacobiIteration<32, 6>"} {:kernel} $_Z15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_($w: int, $h: int, $s: int, $alpha: int)
{
  var $0$1: int;
  var $0$2: int;
  var $1$1: int;
  ...
  __partitioned_block_$0_0:
    ...
    v2$1 := BV32_SLT(v0$1, BV32_SUB($w, 1));
    v2$2 := BV32_SLT(v0$2, BV32_SUB($w, 1));
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    $0$1 := (if p1$1 then BV32_SUB($w, 1) else $0$1);
    $0$2 := (if p1$2 then BV32_SUB($w, 1) else $0$2);
    v3$1 := BV32_SLT(v1$1, BV32_SUB($h, 1));
    v3$2 := BV32_SLT(v1$2, BV32_SUB($h, 1));
    ...
    $1$1 := (if p3$1 then BV32_SUB($h, 1) else $1$1);
    $1$2 := (if p3$2 then BV32_SUB($h, 1) else $1$2);
    v4$1 := BV32_ADD($0$1, BV32_MUL($1$1, $s));
    v4$2 := BV32_ADD($0$2, BV32_MUL($1$2, $s));
    v5$1 := BV32_ADD(BV32_ADD(local_id_x$1, 1), BV32_MUL(BV32_ADD(local_id_y$1, 1), 34));
    v5$2 := BV32_ADD(BV32_ADD(local_id_x$2, 1), BV32_MUL(BV32_ADD(local_id_y$2, 1), 34));
    havoc v6$1, v6$2;
    ...
    v11$1 := (if p4$1 then BV32_ULT(BV32_ADD(v9$1, local_id_x$1), BV32_SUB($w, 1)) else v11$1);
    v11$2 := (if p4$2 then BV32_ULT(BV32_ADD(v9$2, local_id_x$2), BV32_SUB($w, 1)) else v11$2);
    ...
    $2$1 := (if p6$1 then BV32_SUB($w, 1) else $2$1);
    $2$2 := (if p6$2 then BV32_SUB($w, 1) else $2$2);
    v12$1 := (if p4$1 then BV32_SLT(BV32_SUB(v10$1, 1), 0) else v12$1);
    v12$2 := (if p4$2 then BV32_SLT(BV32_SUB(v10$2, 1), 0) else v12$2);
    ...
    $3$1 := (if p8$1 then BV32_SUB(v10$1, 1) else $3$1);
    $3$2 := (if p8$2 then BV32_SUB(v10$2, 1) else $3$2);
    v13$1 := (if p4$1 then BV32_ADD(BV32_MUL($3$1, $s), $2$1) else v13$1);
    v13$2 := (if p4$2 then BV32_ADD(BV32_MUL($3$2, $s), $2$2) else v13$2);
    v14$1 := (if p4$1 then BV32_ADD(local_id_x$1, 1) else v14$1);
    v14$2 := (if p4$2 then BV32_ADD(local_id_x$2, 1) else v14$2);
    ...
    v17$1 := (if p4$1 then BV32_SLT(BV32_ADD(v10$1, 6), BV32_SUB($h, 1)) else v17$1);
    v17$2 := (if p4$2 then BV32_SLT(BV32_ADD(v10$2, 6), BV32_SUB($h, 1)) else v17$2);
    ...
    $4$1 := (if p9$1 then BV32_ADD(v10$1, 6) else $4$1);
    $4$2 := (if p9$2 then BV32_ADD(v10$2, 6) else $4$2);
    $4$1 := (if p10$1 then BV32_SUB($h, 1) else $4$1);
    $4$2 := (if p10$2 then BV32_SUB($h, 1) else $4$2);
    v18$1 := (if p4$1 then BV32_ADD(local_id_x$1, 239) else v18$1);
    v18$2 := (if p4$2 then BV32_ADD(local_id_x$2, 239) else v18$2);
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v21$1 := (if p4$1 then _HAVOC_int$1 else v21$1);
    v21$2 := (if p4$2 then _HAVOC_int$2 else v21$2);
    ...
    v22$1 := (if p11$1 then local_id_y$1 == 1 else v22$1);
    v22$2 := (if p11$2 then local_id_y$2 == 1 else v22$2);
    ...
    v25$1 := (if p12$1 then BV32_ULT(BV32_ADD(v24$1, local_id_x$1), BV32_SUB($h, 1)) else v25$1);
    v25$2 := (if p12$2 then BV32_ULT(BV32_ADD(v24$2, local_id_x$2), BV32_SUB($h, 1)) else v25$2);
    ...
    $5$1 := (if p14$1 then BV32_SUB($h, 1) else $5$1);
    $5$2 := (if p14$2 then BV32_SUB($h, 1) else $5$2);
    v26$1 := (if p12$1 then BV32_SLT(BV32_SUB(v23$1, 1), 0) else v26$1);
    v26$2 := (if p12$2 then BV32_SLT(BV32_SUB(v23$2, 1), 0) else v26$2);
    ...
    $6$1 := (if p15$1 then 0 else $6$1);
    $6$2 := (if p15$2 then 0 else $6$2);
    $6$1 := (if p16$1 then BV32_SUB(v23$1, 1) else $6$1);
    $6$2 := (if p16$2 then BV32_SUB(v23$2, 1) else $6$2);
    v27$1 := (if p12$1 then BV32_MUL(local_id_x$1, 34) else v27$1);
    v27$2 := (if p12$2 then BV32_MUL(local_id_x$2, 34) else v27$2);
    v28$1 := (if p12$1 then BV32_ADD(34, v27$1) else v28$1);
    v28$2 := (if p12$2 then BV32_ADD(34, v27$2) else v28$2);
    v29$1 := (if p12$1 then BV32_ADD($6$1, BV32_MUL($5$1, $s)) else v29$1);
    v29$2 := (if p12$2 then BV32_ADD($6$2, BV32_MUL($5$2, $s)) else v29$2);
    v30$1 := (if p12$1 then BV32_ULT(local_id_x$1, 6) else v30$1);
    v30$2 := (if p12$2 then BV32_ULT(local_id_x$2, 6) else v30$2);
    p17$1 := (if p12$1 && v30$1 then v30$1 else p17$1);
    p17$2 := (if p12$2 && v30$2 then v30$2 else p17$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v31$1 := (if p17$1 then _HAVOC_int$1 else v31$1);
    v31$2 := (if p17$2 then _HAVOC_int$2 else v31$2);
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v32$1 := (if p17$1 then _HAVOC_int$1 else v32$1);
    v32$2 := (if p17$2 then _HAVOC_int$2 else v32$2);
    ...
    v33$1 := (if p17$1 then BV32_SLT(BV32_ADD(v23$1, 32), BV32_SUB($w, 1)) else v33$1);
    v33$2 := (if p17$2 then BV32_SLT(BV32_ADD(v23$2, 32), BV32_SUB($w, 1)) else v33$2);
    ...
    $7$1 := (if p18$1 then BV32_ADD(v23$1, 32) else $7$1);
    $7$2 := (if p18$2 then BV32_ADD(v23$2, 32) else $7$2);
    $7$1 := (if p19$1 then BV32_SUB($w, 1) else $7$1);
    $7$2 := (if p19$2 then BV32_SUB($w, 1) else $7$2);
    v34$1 := (if p17$1 then BV32_ADD(BV32_MUL($5$1, $s), $7$1) else v34$1);
    v34$2 := (if p17$2 then BV32_ADD(BV32_MUL($5$2, $s), $7$2) else v34$2);
    v35$1 := (if p17$1 then BV32_ADD(v27$1, 67) else v35$1);
    v35$2 := (if p17$2 then BV32_ADD(v27$2, 67) else v35$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v36$1 := (if p17$1 then _HAVOC_int$1 else v36$1);
    v36$2 := (if p17$2 then _HAVOC_int$2 else v36$2);
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v37$1 := (if p17$1 then _HAVOC_int$1 else v37$1);
    v37$2 := (if p17$2 then _HAVOC_int$2 else v37$2);
  ...
  __partitioned_block_$0_1:
    call {:sourceloc_num 54} $bugle_barrier_duplicated_0(-1, -1);
    ...
    v40$1 := (if p26$1 then BV32_SUB(v5$1, 1) else v40$1);
    v40$2 := (if p26$2 then BV32_SUB(v5$2, 1) else v40$2);
    v41$1 := (if p26$1 then BV32_ADD(v5$1, 1) else v41$1);
    v41$2 := (if p26$2 then BV32_ADD(v5$2, 1) else v41$2);
    v42$1 := (if p26$1 then BV32_ADD(v5$1, 34) else v42$1);
    v42$2 := (if p26$2 then BV32_ADD(v5$2, 34) else v42$2);
    v43$1 := (if p26$1 then BV32_SUB(BV32_SUB(v5$1, 32), 2) else v43$1);
    v43$2 := (if p26$2 then BV32_SUB(BV32_SUB(v5$2, 32), 2) else v43$2);
    ...
    v48$1 := (if p26$1 then FMUL32(FADD32(FADD32(FADD32(v44$1, v45$1), v46$1), v47$1), 1048576000) else v48$1);
    v48$2 := (if p26$2 then FMUL32(FADD32(FADD32(FADD32(v44$2, v45$2), v46$2), v47$2), 1048576000) else v48$2);
    ...
    v53$1 := (if p26$1 then FMUL32(FADD32(FADD32(FADD32(v49$1, v50$1), v51$1), v52$1), 1048576000) else v53$1);
    v53$2 := (if p26$2 then FMUL32(FADD32(FADD32(FADD32(v49$2, v50$2), v51$2), v52$2), 1048576000) else v53$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v54$1 := (if p26$1 then _HAVOC_int$1 else v54$1);
    v54$2 := (if p26$2 then _HAVOC_int$2 else v54$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v55$1 := (if p26$1 then _HAVOC_int$1 else v55$1);
    v55$2 := (if p26$2 then _HAVOC_int$2 else v55$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v56$1 := (if p26$1 then _HAVOC_int$1 else v56$1);
    v56$2 := (if p26$2 then _HAVOC_int$2 else v56$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v57$1 := (if p26$1 then _HAVOC_int$1 else v57$1);
    v57$2 := (if p26$2 then _HAVOC_int$2 else v57$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v58$1 := (if p26$1 then _HAVOC_int$1 else v58$1);
    v58$2 := (if p26$2 then _HAVOC_int$2 else v58$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v59$1 := (if p26$1 then _HAVOC_int$1 else v59$1);
    v59$2 := (if p26$2 then _HAVOC_int$2 else v59$2);
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v60$1 := (if p26$1 then _HAVOC_int$1 else v60$1);
    v60$2 := (if p26$2 then _HAVOC_int$2 else v60$2);
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v62$1 := (if p26$1 then _HAVOC_int$1 else v62$1);
    v62$2 := (if p26$2 then _HAVOC_int$2 else v62$2);
    ...
    havoc _HAVOC_int$1, _HAVOC_int$2;
    v63$1 := (if p26$1 then _HAVOC_int$1 else v63$1);
    v63$2 := (if p26$2 then _HAVOC_int$2 else v63$2);
...
const _WATCHED_VALUE_$$du0: int;

procedure {:inline 1} _LOG_READ_$$du0(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$du0;



implementation {:inline 1} _LOG_READ_$$du0(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$du0(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$du0(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$du0, _WRITE_READ_BENIGN_FLAG_$$du0;



implementation {:inline 1} _LOG_WRITE_$$du0(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$du0(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$du0(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$du0;



implementation {:inline 1} _LOG_ATOMIC_$$du0(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$du0(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$du0(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$du0;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$du0(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$dv0: int;

procedure {:inline 1} _LOG_READ_$$dv0(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$dv0;



implementation {:inline 1} _LOG_READ_$$dv0(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$dv0(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$dv0(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$dv0, _WRITE_READ_BENIGN_FLAG_$$dv0;



implementation {:inline 1} _LOG_WRITE_$$dv0(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$dv0(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$dv0(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$dv0;



implementation {:inline 1} _LOG_ATOMIC_$$dv0(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$dv0(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$dv0(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$dv0;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$dv0(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$du1: int;

procedure {:inline 1} _LOG_READ_$$du1(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$du1;



implementation {:inline 1} _LOG_READ_$$du1(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$du1(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$du1(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$du1, _WRITE_READ_BENIGN_FLAG_$$du1;



implementation {:inline 1} _LOG_WRITE_$$du1(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$du1(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$du1(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$du1;



implementation {:inline 1} _LOG_ATOMIC_$$du1(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$du1(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$du1(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$du1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$du1(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$dv1: int;

procedure {:inline 1} _LOG_READ_$$dv1(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$dv1;



implementation {:inline 1} _LOG_READ_$$dv1(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$dv1(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$dv1(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$dv1, _WRITE_READ_BENIGN_FLAG_$$dv1;



implementation {:inline 1} _LOG_WRITE_$$dv1(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$dv1(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$dv1(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$dv1;



implementation {:inline 1} _LOG_ATOMIC_$$dv1(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$dv1(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$dv1(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$dv1;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$dv1(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du: int;

procedure {:inline 1} _LOG_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;



implementation {:inline 1} _LOG_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv: int;

procedure {:inline 1} _LOG_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;



implementation {:inline 1} _LOG_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int, _value_old: int);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon0:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2du;
    goto anon1;

  anon1:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ15JacobiIterationILi32ELi6EEvPKfS1_S1_S1_S1_iiifPfS2_E2dv;
    goto anon2;
  ...
  anon5:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$du1;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$du1;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$du1;
    goto anon6;

  anon6:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_READ_HAS_OCCURRED_$$dv1;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_WRITE_HAS_OCCURRED_$$dv1;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$dv1;
    goto anon7;
