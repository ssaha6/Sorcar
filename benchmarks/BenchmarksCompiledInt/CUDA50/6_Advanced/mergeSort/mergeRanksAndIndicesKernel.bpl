...
var {:source_name "d_Limits"} {:global} $$d_Limits: [int]int;
...
var {:source_name "d_Ranks"} {:global} $$d_Ranks: [int]int;
...
procedure {:source_name "mergeRanksAndIndicesKernel"} {:kernel} $_Z26mergeRanksAndIndicesKernelPjS_jjj($stride: int, $N: int, $threadCount: int);
...
implementation {:source_name "mergeRanksAndIndicesKernel"} {:kernel} $_Z26mergeRanksAndIndicesKernelPjS_jjj($stride: int, $N: int, $threadCount: int)
{
  var $0$1: int;
  var $0$2: int;
  var $1$1: int;
  ...
  $0:
    ...
    v4$1 := (if p1$1 then BV32_MUL(BV32_SUB(v0$1, v2$1), 2) else v4$1);
    v4$2 := (if p1$2 then BV32_MUL(BV32_SUB(v0$2, v2$2), 2) else v4$2);
    v5$1 := (if p1$1 then BV32_MUL(BV32_SUB(v0$1, v2$1), 2) else v5$1);
    v5$2 := (if p1$2 then BV32_MUL(BV32_SUB(v0$2, v2$2), 2) else v5$2);
    ...
    call v11$1, v11$2 := BV32_CTLZ(false, p8$1, BV32_SUB($2$1, 1), p8$2, BV32_SUB($2$2, 1));
    assume {:captureState "call_return_state_0"} {:procedureName "BV32_CTLZ"} true;
    v12$1 := (if p8$1 then $2$1 == 0 else v12$1);
    v12$2 := (if p8$2 then $2$2 == 0 else v12$2);
    ...
    $pos.i3.0$1, $.02$1 := (if p10$1 then 0 else $pos.i3.0$1), (if p10$1 then BV32_SHL(1, BV32_SUB(32, v11$1)) else $.02$1);
    $pos.i3.0$2, $.02$2 := (if p10$2 then 0 else $pos.i3.0$2), (if p10$2 then BV32_SHL(1, BV32_SUB(32, v11$2)) else $.02$2);
  ...
  $13:
    ...
    v13$1 := (if p11$1 then BV32_UGT($.02$1, 0) else v13$1);
    v13$2 := (if p11$2 then BV32_UGT($.02$2, 0) else v13$2);
    p12$1 := false;
    p12$2 := false;
    p13$1 := false;
    p13$2 := false;
    ...
    v15$1 := (if p12$1 then $$d_Ranks[BV32_ADD(BV32_ADD(v4$1, $1$1), BV32_SUB($3$1, 1))] else v15$1);
    v15$2 := (if p12$2 then $$d_Ranks[BV32_ADD(BV32_ADD(v4$2, $1$2), BV32_SUB($3$2, 1))] else v15$2);
    ...
    $pos.i3.0$1, $.02$1 := (if p12$1 then $pos.i3.1$1 else $pos.i3.0$1), (if p12$1 then BV32_LSHR($.02$1, 1) else $.02$1);
    $pos.i3.0$2, $.02$2 := (if p12$2 then $pos.i3.1$2 else $pos.i3.0$2), (if p12$2 then BV32_LSHR($.02$2, 1) else $.02$2);
  ...
  $13.tail:
    ...
    call v20$1, v20$2 := BV32_CTLZ(false, p18$1, BV32_SUB($1$1, 1), p18$2, BV32_SUB($1$2, 1));
    assume {:captureState "call_return_state_0"} {:procedureName "BV32_CTLZ"} true;
    v21$1 := (if p18$1 then $1$1 == 0 else v21$1);
    v21$2 := (if p18$2 then $1$2 == 0 else v21$2);
    ...
    $.01$1, $pos.i.0$1 := (if p20$1 then BV32_SHL(1, BV32_SUB(32, v20$1)) else $.01$1), (if p20$1 then 0 else $pos.i.0$1);
    $.01$2, $pos.i.0$2 := (if p20$2 then BV32_SHL(1, BV32_SUB(32, v20$2)) else $.01$2), (if p20$2 then 0 else $pos.i.0$2);
  ...
  $25:
    ...
    v22$1 := (if p21$1 then BV32_UGT($.01$1, 0) else v22$1);
    v22$2 := (if p21$2 then BV32_UGT($.01$2, 0) else v22$2);
    p22$1 := false;
    p22$2 := false;
    p23$1 := false;
    p23$2 := false;
    ...
    v24$1 := (if p22$1 then $$d_Ranks[BV32_ADD(v4$1, BV32_SUB($4$1, 1))] else v24$1);
    v24$2 := (if p22$2 then $$d_Ranks[BV32_ADD(v4$2, BV32_SUB($4$2, 1))] else v24$2);
    ...
    $.01$1, $pos.i.0$1 := (if p22$1 then BV32_LSHR($.01$1, 1) else $.01$1), (if p22$1 then $pos.i.1$1 else $pos.i.0$1);
    $.01$2, $pos.i.0$2 := (if p22$2 then BV32_LSHR($.01$2, 1) else $.01$2), (if p22$2 then $pos.i.1$2 else $pos.i.0$2);
...
const _WATCHED_VALUE_$$d_Limits: int;

procedure {:inline 1} _LOG_READ_$$d_Limits(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$d_Limits;



implementation {:inline 1} _LOG_READ_$$d_Limits(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$d_Limits(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$d_Limits(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$d_Limits, _WRITE_READ_BENIGN_FLAG_$$d_Limits;



implementation {:inline 1} _LOG_WRITE_$$d_Limits(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$d_Limits(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$d_Limits(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$d_Limits;



implementation {:inline 1} _LOG_ATOMIC_$$d_Limits(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$d_Limits(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Limits(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$d_Limits;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Limits(_P: bool, _offset: int)
{
...
const _WATCHED_VALUE_$$d_Ranks: int;

procedure {:inline 1} _LOG_READ_$$d_Ranks(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$d_Ranks;



implementation {:inline 1} _LOG_READ_$$d_Ranks(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$d_Ranks(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$d_Ranks(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$d_Ranks, _WRITE_READ_BENIGN_FLAG_$$d_Ranks;



implementation {:inline 1} _LOG_WRITE_$$d_Ranks(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$d_Ranks(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$d_Ranks(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$d_Ranks;



implementation {:inline 1} _LOG_ATOMIC_$$d_Ranks(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$d_Ranks(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Ranks(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$d_Ranks;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Ranks(_P: bool, _offset: int)
{
