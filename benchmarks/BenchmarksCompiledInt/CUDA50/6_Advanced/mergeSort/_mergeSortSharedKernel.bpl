...
implementation {:source_name "mergeSortSharedKernel<1>"} {:kernel} $_Z21mergeSortSharedKernelILj1EEvPjS0_S0_S0_j($arrayLength: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b31 ==> _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b30 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val;
    assert {:tag "noread"} _b29 ==> !_READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b27 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key;
    assert {:tag "noread"} _b26 ==> !_READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key;
    assert {:tag "pow2NotZero"} _b25 ==> $.01 != 0;
    assert {:tag "pow2"} _b24 ==> $.01 == 0 || BV32_AND($.01, BV32_SUB($.01, 1)) == 0;
    assert {:tag "pow2NotZero"} _b23 ==> $.03 != 0;
    assert {:tag "pow2"} _b22 ==> $.03 == 0 || BV32_AND($.03, BV32_SUB($.03, 1)) == 0;
    assert {:tag "pow2NotZero"} _b21 ==> $stride.0 != 0;
    assert {:tag "pow2"} _b20 ==> $stride.0 == 0 || BV32_AND($stride.0, BV32_SUB($stride.0, 1)) == 0;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride.0, 1);
  ...
  $5:
    ...
    assert {:tag "pow2NotZero"} _b33 ==> $.03 != 0;
    assert {:tag "pow2"} _b32 ==> $.03 == 0 || BV32_AND($.03, BV32_SUB($.03, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_UGE($pos.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_UGE($pos.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_ULE($pos.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b10 ==> BV32_ULE($pos.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SGE($pos.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_SGE($pos.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_SLE($pos.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_SLE($pos.i.0$2, 0);
  ...
  $15:
    ...
    assert {:tag "pow2NotZero"} _b35 ==> $.01 != 0;
    assert {:tag "pow2"} _b34 ==> $.01 == 0 || BV32_AND($.01, BV32_SUB($.01, 1)) == 0;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21mergeSortSharedKernelILj1EEvPjS0_S0_S0_jE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_UGE($pos.i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b19 ==> BV32_UGE($pos.i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_ULE($pos.i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b18 ==> BV32_ULE($pos.i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SGE($pos.i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b17 ==> BV32_SGE($pos.i1.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SLE($pos.i1.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} _b16 ==> BV32_SLE($pos.i1.0$2, 0);
