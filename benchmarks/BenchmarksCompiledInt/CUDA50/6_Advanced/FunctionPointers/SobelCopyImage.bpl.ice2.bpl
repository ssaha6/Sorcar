...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($i.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.0$1, $w) ==> p0$1 )  && (  BV32_SLT($i.0$2, $w) ==> p0$2 ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLE(BV32_MUL(group_id_x$1, $Pitch), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), $Pitch)) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), BV32_ADD(local_id_x$1, BV32_MUL(group_id_x$1, $Pitch))) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $Pitch) )  ); 
    ...
    call {:sourceloc_num 40} v22$1, v22$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v13$1, v17$1 ++ v16$1 ++ v15$1 ++ v14$1, v21$1 ++ v20$1 ++ v19$1 ++ v18$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p1$2, v13$2, v17$2 ++ v16$2 ++ v15$2 ++ v14$2, v21$2 ++ v20$2 ++ v19$2 ++ v18$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    ...
    call {:sourceloc_num 76} v45$1, v45$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p2$1, v36$1, v40$1 ++ v39$1 ++ v38$1 ++ v37$1, v44$1 ++ v43$1 ++ v42$1 ++ v41$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p2$2, v36$2, v40$2 ++ v39$2 ++ v38$2 ++ v37$2, v44$2 ++ v43$2 ++ v42$2 ++ v41$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    ...
    call {:sourceloc_num 112} v68$1, v68$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p5$1, v59$1, v63$1 ++ v62$1 ++ v61$1 ++ v60$1, v67$1 ++ v66$1 ++ v65$1 ++ v64$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p5$2, v59$2, v63$2 ++ v62$2 ++ v61$2 ++ v60$2, v67$2 ++ v66$2 ++ v65$2 ++ v64$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    ...
    call {:sourceloc_num 148} v91$1, v91$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p6$1, v82$1, v86$1 ++ v85$1 ++ v84$1 ++ v83$1, v90$1 ++ v89$1 ++ v88$1 ++ v87$1, SI32_TO_FP32($i.0$1), UI32_TO_FP32(group_id_x$1), p6$2, v82$2, v86$2 ++ v85$2 ++ v84$2 ++ v83$2, v90$2 ++ v89$2 ++ v88$2 ++ v87$2, SI32_TO_FP32($i.0$2), UI32_TO_FP32(group_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    ...
    call {:sourceloc} {:sourceloc_num 152} _LOG_WRITE_$$pSobelOriginal(p1$1, BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1), FP32_TO_UI8($2$1), $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 152} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 152} _CHECK_WRITE_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2), FP32_TO_UI8($2$2));
