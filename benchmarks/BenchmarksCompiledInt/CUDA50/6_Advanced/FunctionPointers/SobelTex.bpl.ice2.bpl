...
implementation {:source_name "SobelTex"} {:kernel} $_Z8SobelTexPhjiifiPFhhfE($Pitch: bv32, $w: bv32, $h: bv32, $fScale: bv32, $blockOperation: bv32, $pPointOperation: functionPtr)
{
  ...
  var v198$1: bv8;
  var v198$2: bv8;
  var v199$1: functionPtr;
  var v199$2: functionPtr;
  var v200$1: bv8;
  var v200$2: bv8;
  var v201$1: bool;
  var v201$2: bool;
...
assert  my_inv (  ( p0$1 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) )  && ( p0$2 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2) ) ,  ( p0$1 ==> BV32_SLE(0bv32, $i.0$1) )  && ( p0$2 ==> BV32_SLE(0bv32, $i.0$2) ) ,  ( p0$1 ==> BV32_SLE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($i.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.0$1, $w) ==> p0$1 )  && (  BV32_SLT($i.0$2, $w) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLE(BV32_MUL(group_id_x$1, $Pitch), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), $Pitch)) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), BV32_ADD(local_id_x$1, BV32_MUL(group_id_x$1, $Pitch))) ) ,  (  _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $Pitch) )  ); 
    ...
    call {:sourceloc_num 75} v22$1, v22$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v13$1, v17$1 ++ v16$1 ++ v15$1 ++ v14$1, v21$1 ++ v20$1 ++ v19$1 ++ v18$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v13$2, v17$2 ++ v16$2 ++ v15$2 ++ v14$2, v21$2 ++ v20$2 ++ v19$2 ++ v18$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    ...
    call {:sourceloc_num 143} v66$1, v66$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v57$1, v61$1 ++ v60$1 ++ v59$1 ++ v58$1, v65$1 ++ v64$1 ++ v63$1 ++ v62$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v57$2, v61$2 ++ v60$2 ++ v59$2 ++ v58$2, v65$2 ++ v64$2 ++ v63$2 ++ v62$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 177} v88$1, v88$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v79$1, v83$1 ++ v82$1 ++ v81$1 ++ v80$1, v87$1 ++ v86$1 ++ v85$1 ++ v84$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v79$2, v83$2 ++ v82$2 ++ v81$2 ++ v80$2, v87$2 ++ v86$2 ++ v85$2 ++ v84$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 245} v132$1, v132$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v123$1, v127$1 ++ v126$1 ++ v125$1 ++ v124$1, v131$1 ++ v130$1 ++ v129$1 ++ v128$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v123$2, v127$2 ++ v126$2 ++ v125$2 ++ v124$2, v131$2 ++ v130$2 ++ v129$2 ++ v128$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 279} v154$1, v154$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v145$1, v149$1 ++ v148$1 ++ v147$1 ++ v146$1, v153$1 ++ v152$1 ++ v151$1 ++ v150$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v145$2, v149$2 ++ v148$2 ++ v147$2 ++ v146$2, v153$2 ++ v152$2 ++ v151$2 ++ v150$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    ...
    call {:sourceloc_num 347} v198$1, v198$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v189$1, v193$1 ++ v192$1 ++ v191$1 ++ v190$1, v197$1 ++ v196$1 ++ v195$1 ++ v194$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v189$2, v193$2 ++ v192$2 ++ v191$2 ++ v190$2, v197$2 ++ v196$2 ++ v195$2 ++ v194$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    v199$1 := (if p1$1 then $$blockFunction_table[$blockOperation] else v199$1);
    v199$2 := (if p1$2 then $$blockFunction_table[$blockOperation] else v199$2);
    p2$1 := (if p1$1 && v199$1 == $functionId$$_Z12ComputeSobelhhhhhhhhhf then v199$1 == $functionId$$_Z12ComputeSobelhhhhhhhhhf else p2$1);
    p2$2 := (if p1$2 && v199$2 == $functionId$$_Z12ComputeSobelhhhhhhhhhf then v199$2 == $functionId$$_Z12ComputeSobelhhhhhhhhhf else p2$2);
    p3$1 := (if p1$1 && v199$1 != $functionId$$_Z12ComputeSobelhhhhhhhhhf then v199$1 != $functionId$$_Z12ComputeSobelhhhhhhhhhf else p3$1);
    p3$2 := (if p1$2 && v199$2 != $functionId$$_Z12ComputeSobelhhhhhhhhhf then v199$2 != $functionId$$_Z12ComputeSobelhhhhhhhhhf else p3$2);
    call {:sourceloc_num 349} v200$1, v200$2 := $_Z12ComputeSobelhhhhhhhhhf(p2$1, v22$1, v44$1, v66$1, v88$1, v110$1, v132$1, v154$1, v176$1, v198$1, $fScale, p2$2, v22$2, v44$2, v66$2, v88$2, v110$2, v132$2, v154$2, v176$2, v198$2, $fScale);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z12ComputeSobelhhhhhhhhhf"} true;
    p5$1 := (if p3$1 && v199$1 == $functionId$$_Z10ComputeBoxhhhhhhhhhf then v199$1 == $functionId$$_Z10ComputeBoxhhhhhhhhhf else p5$1);
    p5$2 := (if p3$2 && v199$2 == $functionId$$_Z10ComputeBoxhhhhhhhhhf then v199$2 == $functionId$$_Z10ComputeBoxhhhhhhhhhf else p5$2);
    p4$1 := (if p3$1 && v199$1 != $functionId$$_Z10ComputeBoxhhhhhhhhhf then v199$1 != $functionId$$_Z10ComputeBoxhhhhhhhhhf else p4$1);
    p4$2 := (if p3$2 && v199$2 != $functionId$$_Z10ComputeBoxhhhhhhhhhf then v199$2 != $functionId$$_Z10ComputeBoxhhhhhhhhhf else p4$2);
    ...
    call {:sourceloc_num 350} v200$1, v200$2 := $_Z10ComputeBoxhhhhhhhhhf(p5$1, v22$1, v44$1, v66$1, v88$1, v110$1, v132$1, v154$1, v176$1, v198$1, $fScale, p5$2, v22$2, v44$2, v66$2, v88$2, v110$2, v132$2, v154$2, v176$2, v198$2, $fScale);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10ComputeBoxhhhhhhhhhf"} true;
    v201$1 := (if p1$1 then $pPointOperation != $functionId$$null$ else v201$1);
    v201$2 := (if p1$2 then $pPointOperation != $functionId$$null$ else v201$2);
    p7$1 := (if p1$1 && v201$1 then v201$1 else p7$1);
    p7$2 := (if p1$2 && v201$2 then v201$2 else p7$2);
    p6$1 := (if p1$1 && !v201$1 then !v201$1 else p6$1);
    p6$2 := (if p1$2 && !v201$2 then !v201$2 else p6$2);
    $tmp.0$1 := (if p6$1 then v200$1 else $tmp.0$1);
    $tmp.0$2 := (if p6$2 then v200$2 else $tmp.0$2);
    ...
    call {:sourceloc_num 353} v202$1, v202$2 := $_Z9Thresholdhf(p9$1, v200$1, 1125515264bv32, p9$2, v200$2, 1125515264bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z9Thresholdhf"} true;
    $tmp.0$1 := (if p7$1 then v202$1 else $tmp.0$1);
    $tmp.0$2 := (if p7$2 then v202$2 else $tmp.0$2);
