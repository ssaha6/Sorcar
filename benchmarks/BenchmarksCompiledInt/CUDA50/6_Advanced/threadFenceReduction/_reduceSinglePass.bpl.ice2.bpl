...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$g_odata ==> _WATCHED_OFFSET mod 128 == local_id_x$1 mod 128 ) ,  (  !p11$1 ==> _READ_HAS_OCCURRED_$$g_odata$ghost$$12 == _READ_HAS_OCCURRED_$$g_odata )  ); 
...
assert  my_inv (  ( p12$1 ==> $i.0$1 mod 128 == local_id_x$1 mod 128 )  && ( p12$2 ==> $i.0$2 mod 128 == local_id_x$2 mod 128 ) ,  ( p12$1 ==> BV32_SLE($i.0$1, local_id_x$1) )  && ( p12$2 ==> BV32_SLE($i.0$2, local_id_x$2) ) ,  ( p12$1 ==> BV32_SGE($i.0$1, local_id_x$1) )  && ( p12$2 ==> BV32_SGE($i.0$2, local_id_x$2) ) ,  ( p12$1 ==> BV32_ULE($i.0$1, local_id_x$1) )  && ( p12$2 ==> BV32_ULE($i.0$2, local_id_x$2) ) ,  ( p12$1 ==> BV32_UGE($i.0$1, local_id_x$1) )  && ( p12$2 ==> BV32_UGE($i.0$2, local_id_x$2) ) ,  ( p12$1 ==> p12$1 ==> BV32_UGT(num_groups_x, 1) && BV_EXTRACT(v23$1, 1, 0) == 1 )  && ( p12$2 ==> p12$2 ==> BV32_UGT(num_groups_x, 1) && BV_EXTRACT(v23$2, 1, 0) == 1 ) ,  (  BV32_UGT(num_groups_x, 1) && BV_EXTRACT(v23$1, 1, 0) == 1 && BV32_ULT($i.0$1, num_groups_x) ==> p12$1 )  && (  BV32_UGT(num_groups_x, 1) && BV_EXTRACT(v23$2, 1, 0) == 1 && BV32_ULT($i.0$2, num_groups_x) ==> p12$2 ) ,  (  _READ_HAS_OCCURRED_$$g_odata ==> BV32_UGT(num_groups_x, 1) ) ,  (  _READ_HAS_OCCURRED_$$g_odata ==> BV_EXTRACT(v23$1, 1, 0) == 1 ) ,  true ,  true  ); 
