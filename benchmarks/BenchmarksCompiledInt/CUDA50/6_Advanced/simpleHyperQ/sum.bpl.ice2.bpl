...
assert  my_inv (  ( p0$1 ==> $i.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p0$2 ==> $i.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p0$1 ==> BV32_SLE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($i.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($i.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($i.0$2, local_id_x$2) ) ,  (  BV32_SLT($i.0$1, $N) ==> p0$1 )  && (  BV32_SLT($i.0$2, $N) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$d_clocks ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($i1.0, 16) ) ,  (  BV32_SGE($i1.0, 16) ) ,  (  BV32_ULE($i1.0, 16) ) ,  (  BV32_UGE($i1.0, 16) ) ,  true ,  (  $i1.0 == 0 || BV32_AND($i1.0, BV32_SUB($i1.0, 1)) == 0 ) ,  (  $i1.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ) ,  (  _READ_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ3sumPjiE8s_clocks ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
