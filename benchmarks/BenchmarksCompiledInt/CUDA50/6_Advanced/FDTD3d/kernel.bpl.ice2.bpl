...
assert  my_inv (  (  $inputIndex.0$1 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == BV32_ADD(BV32_ADD(BV32_MUL(4, v2), 4), BV32_ADD(BV32_MUL(v1$1, v2), v0$1)) mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) )  && (  $inputIndex.0$2 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == BV32_ADD(BV32_ADD(BV32_MUL(4, v2), 4), BV32_ADD(BV32_MUL(v1$2, v2), v0$2)) mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) ) ,  (  $i.0 mod -1 == 2 mod -1 ) ,  (  BV32_SLE($i.0, 2) ) ,  (  BV32_SGE($i.0, 2) ) ,  (  BV32_ULE($i.0, 2) ) ,  (  BV32_UGE($i.0, 2) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  (  $inputIndex.2$1 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == $inputIndex.1$1 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) )  && (  $inputIndex.2$2 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == $inputIndex.1$2 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) ) ,  (  $outputIndex.0$1 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == $inputIndex.0$1 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) )  && (  $outputIndex.0$2 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == $inputIndex.0$2 mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) ) ,  (  $iz.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($iz.0, 0) ) ,  (  BV32_SGE($iz.0, 0) ) ,  (  BV32_ULE($iz.0, 0) ) ,  (  BV32_UGE($iz.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$output ) ,  (  _WRITE_HAS_OCCURRED_$$output ==> _WATCHED_OFFSET mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) == BV32_ADD($inputIndex.0$1, BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8))) mod BV32_MUL(BV32_ADD($dimx, 8), BV32_ADD($dimy, 8)) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ) ,  (  _READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> _WATCHED_OFFSET mod BV32_MUL(1, 40) == BV32_ADD(BV32_MUL(0, 40), BV32_ADD(local_id_x$1, 4)) mod BV32_MUL(1, 40) || _WATCHED_OFFSET mod BV32_MUL(1, 40) == BV32_ADD(BV32_MUL(BV32_ADD(1, BV32_ADD(local_id_y$1, 4)), 40), BV32_ADD(local_id_x$1, 4)) mod BV32_MUL(1, 40) || _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(BV32_ADD(local_id_y$1, 4), 40)) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(BV32_ADD(1, BV32_ADD(local_id_x$1, 4)), BV32_MUL(BV32_ADD(local_id_y$1, 4), 40)) mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 40), BV32_ADD(local_id_x$1, 4)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_ADD(local_id_y$1, group_size_y), 4), 40), BV32_ADD(local_id_x$1, 4)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4), 40), local_id_x$1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4), 40), BV32_ADD(BV32_ADD(local_id_x$1, group_size_x), 4)) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, 4), 40), BV32_ADD(local_id_x$1, 4)) ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $i4.0 mod 1 == 1 mod 1 ) ,  (  BV32_SLE($i4.0, 1) ) ,  (  BV32_SGE($i4.0, 1) ) ,  (  BV32_ULE($i4.0, 1) ) ,  (  BV32_UGE($i4.0, 1) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ23FiniteDifferencesKernelPfPKfiiiE4tile ==> _WATCHED_OFFSET mod BV32_MUL(1, 40) == BV32_ADD(BV32_MUL(0, 40), BV32_ADD(local_id_x$1, 4)) mod BV32_MUL(1, 40) || _WATCHED_OFFSET mod BV32_MUL(1, 40) == BV32_ADD(BV32_MUL(BV32_ADD(1, BV32_ADD(local_id_y$1, 4)), 40), BV32_ADD(local_id_x$1, 4)) mod BV32_MUL(1, 40) || _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(BV32_ADD(local_id_y$1, 4), 40)) mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(BV32_ADD(1, BV32_ADD(local_id_x$1, 4)), BV32_MUL(BV32_ADD(local_id_y$1, 4), 40)) mod 1 )  ); 
