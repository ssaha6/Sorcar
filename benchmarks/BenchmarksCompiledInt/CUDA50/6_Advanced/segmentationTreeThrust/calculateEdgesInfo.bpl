...
implementation {:source_name "calculateEdgesInfo"} {:kernel} $_Z18calculateEdgesInfoPKjS0_S0_PKfPjS3_jj($edgesCount: int, $newVerticesCount: int)
{
  var $0$1: int;
  var $0$2: int;
  var $1$1: int;
  ...
  $0:
    ...
    v4$1 := (if p0$1 then BV32_ULT(v3$1, -1) else v4$1);
    v4$2 := (if p0$2 then BV32_ULT(v3$2, -1) else v4$2);
    ...
    v7$1 := (if p0$1 then BV32_ULT(v3$1, -1) else v7$1);
    v7$2 := (if p0$2 then BV32_ULT(v3$2, -1) else v7$2);
    ...
    $1$1 := (if p4$1 then -1 else $1$1);
    $1$2 := (if p4$2 then -1 else $1$2);
...
const _WATCHED_VALUE_$$newStartpoints: int;

procedure {:inline 1} _LOG_READ_$$newStartpoints(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$newStartpoints;



implementation {:inline 1} _LOG_READ_$$newStartpoints(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$newStartpoints(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$newStartpoints(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$newStartpoints, _WRITE_READ_BENIGN_FLAG_$$newStartpoints;



implementation {:inline 1} _LOG_WRITE_$$newStartpoints(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$newStartpoints(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$newStartpoints(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$newStartpoints;



implementation {:inline 1} _LOG_ATOMIC_$$newStartpoints(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$newStartpoints(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$newStartpoints(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$newStartpoints;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$newStartpoints(_P: bool, _offset: int)
{
