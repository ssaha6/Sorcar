...
assert  my_inv (  (  BV32_SLE(0bv32, $r.0) ) ,  (  BV32_SLE($r.0, 0bv32) ) ,  (  BV32_SGE($r.0, 0bv32) ) ,  (  BV32_ULE($r.0, 0bv32) ) ,  (  BV32_UGE($r.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1))))) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), 16bv32), BV32_DIV(group_id_x$1, $width)), BV32_DIV(local_id_y$1, 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, 16bv32), $width)), BV32_MUL(group_id_y$1, 16bv32)) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1))))) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), 16bv32), BV32_DIV(group_id_x$1, $width)), BV32_DIV(local_id_y$1, 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, 16bv32), $width)), BV32_MUL(group_id_y$1, 16bv32)) )  ); 
