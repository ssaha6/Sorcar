...
assert  my_inv (  (  BV32_SLE(0bv32, $r.0) ) ,  (  BV32_SLE($r.0, 0bv32) ) ,  (  BV32_SGE($r.0, 0bv32) ) ,  (  BV32_ULE($r.0, 0bv32) ) ,  (  BV32_UGE($r.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$odata ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ17transposeDiagonalPfS_iiiE4tile ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17transposeDiagonalPfS_iiiE4tile ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 17bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17transposeDiagonalPfS_iiiE4tile ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 17bv32) ) ,  true ,  true  ); 


    assert {:block_sourceloc} {:sourceloc_num 7} true;
    assert {:originated_from_invariant} {:sourceloc_num 8} {:thread 1} (if _WRITE_HAS_OCCURRED_$$odata ==> BV32_UREM(BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $height), 16bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 9} {:thread 1} (if _WRITE_HAS_OCCURRED_$$odata ==> BV32_UREM(BV32_UDIV(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $height), 16bv32) == local_id_y$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 10} {:thread 1} (if _WRITE_HAS_OCCURRED_$$odata ==> BV32_UDIV(BV32_UDIV(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $height), 16bv32) == $blockIdx_x.0$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 11} {:thread 1} (if _WRITE_HAS_OCCURRED_$$odata ==> BV32_UDIV(BV32_UREM(BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32), $height), 16bv32) == $blockIdx_y.0$1 then 1bv1 else 0bv1) != 0bv1;
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17transposeDiagonalPfS_iiiE4tile ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 17bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17transposeDiagonalPfS_iiiE4tile ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 17bv32) )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(16bv32, 1bv32), $i1.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $i1.0) ) ,  (  BV32_SLE($i1.0, 0bv32) ) ,  (  BV32_SGE($i1.0, 0bv32) ) ,  (  BV32_ULE($i1.0, 0bv32) ) ,  (  BV32_UGE($i1.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true  ); 
  ...
  $truebb1:
    assume {:partition} v4;
    havoc v5$1, v5$2;
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$_ZZ17transposeDiagonalPfS_iiiE4tile(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1), v5$1, $$_ZZ17transposeDiagonalPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$_ZZ17transposeDiagonalPfS_iiiE4tile(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2), v5$2);
