...
assert  my_inv (  (  $r.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($r.0, 0) ) ,  (  BV32_SGE($r.0, 0) ) ,  (  BV32_ULE($r.0, 0) ) ,  (  BV32_UGE($r.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !_WRITE_HAS_OCCURRED_$$odata ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16), local_id_y$1))) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) ) ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  $i.0 mod 16 == 0 mod 16 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) ) ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $i1.0 mod 16 == 0 mod 16 ) ,  (  BV32_SLE($i1.0, 0) ) ,  (  BV32_SGE($i1.0, 0) ) ,  (  BV32_ULE($i1.0, 0) ) ,  (  BV32_UGE($i1.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$odata ==> _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16), local_id_y$1))) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1) )  ); 
