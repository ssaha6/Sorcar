...
procedure {:source_name "transposeNaive"} {:kernel} $_Z14transposeNaivePfS_iii($width: bv32, $height: bv32, $nreps: bv32);
  requires {:sourceloc_num 0} {:thread 1} (if $height == 1024bv32 then 1bv1 else 0bv1) != 0bv1;
...
assert  my_inv (  (  BV32_SLE(0bv32, $r.0) ) ,  (  BV32_SLE($r.0, 0bv32) ) ,  (  BV32_SGE($r.0, 0bv32) ) ,  (  BV32_ULE($r.0, 0bv32) ) ,  (  BV32_UGE($r.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), BV32_ADD(0bv32, BV32_ADD(BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1), BV32_MUL($height, BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1))))) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_x$1, $height)), BV32_DIV(BV32_MUL(local_id_x$1, $height), 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $height), 16bv32), BV32_DIV(group_id_y$1, $height)), BV32_DIV(local_id_x$1, 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $height), BV32_DIV(BV32_MUL(group_id_y$1, 16bv32), $height)), BV32_MUL(group_id_x$1, 16bv32)) ) ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  (  BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32) ) ,  (  BV32_SLE(0bv32, $i.0) ) ,  (  BV32_SLE($i.0, 0bv32) ) ,  (  BV32_SGE($i.0, 0bv32) ) ,  (  BV32_ULE($i.0, 0bv32) ) ,  (  BV32_UGE($i.0, 0bv32) ) ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), BV32_ADD(0bv32, BV32_ADD(BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1), BV32_MUL($height, BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1))))) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_x$1, $height)), BV32_DIV(BV32_MUL(local_id_x$1, $height), 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $height), 16bv32), BV32_DIV(group_id_y$1, $height)), BV32_DIV(local_id_x$1, 16bv32)) ) ,  (  _WRITE_HAS_OCCURRED_$$odata ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $height), BV32_DIV(BV32_MUL(group_id_y$1, 16bv32), $height)), BV32_MUL(group_id_x$1, 16bv32)) )  ); 
  ...
  $truebb0:
    assume {:partition} v3;
    havoc v4$1, v4$2;
    call {:sourceloc} {:sourceloc_num 7} _LOG_WRITE_$$odata(true, BV32_ADD(BV32_ADD(v1$1, BV32_MUL($height, v0$1)), $i.0), v4$1, $$odata[BV32_ADD(BV32_ADD(v1$1, BV32_MUL($height, v0$1)), $i.0)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 7} _CHECK_WRITE_$$odata(true, BV32_ADD(BV32_ADD(v1$2, BV32_MUL($height, v0$2)), $i.0), v4$2);
