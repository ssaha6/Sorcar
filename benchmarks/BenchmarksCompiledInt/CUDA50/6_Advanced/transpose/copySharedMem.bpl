...
var {:source_name "tile"} {:group_shared} $$_ZZ13copySharedMemPfS_iiiE4tile: [bv1][int]int;
...
procedure {:source_name "copySharedMem"} {:kernel} $_Z13copySharedMemPfS_iii($width: int, $height: int, $nreps: int);
  ...
  requires {:sourceloc_num 1} {:thread 1} (if $height == 1024 then 1 else 0) != 0;
  requires {:sourceloc_num 2} {:thread 1} (if $nreps == 1 then 1 else 0) != 0;
...
implementation {:source_name "copySharedMem"} {:kernel} $_Z13copySharedMemPfS_iii($width: int, $height: int, $nreps: int)
{
  var $r.0: int;
  var $i.0: int;
  var $i1.0: int;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1);
    assert {:tag "nowrite"} _b18 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;
    assert {:tag "noread"} _b17 ==> !_READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _WRITE_HAS_OCCURRED_$$odata ==> _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16), local_id_y$1)));
    assert {:tag "nowrite"} _b15 ==> !_WRITE_HAS_OCCURRED_$$odata;
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($r.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($r.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($r.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($r.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> $r.0 mod 1 == 0 mod 1;
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($i.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($i.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($i.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($i.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b5 ==> $i.0 mod 16 == 0 mod 16;
  ...
  __partitioned_block_$falsebb0_1:
    call {:sourceloc_num 15} $bugle_barrier_duplicated_0(-1, -1);
    $i1.0 := 0;
  ...
  $10:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _WRITE_HAS_OCCURRED_$$odata ==> _WATCHED_OFFSET == BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16), local_id_y$1)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($i1.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($i1.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b10 ==> $i1.0 mod 16 == 0 mod 16;
  ...
  $truebb3:
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$_ZZ13copySharedMemPfS_iiiE4tile(p7$1, BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1), $$_ZZ13copySharedMemPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$_ZZ13copySharedMemPfS_iiiE4tile(p7$2, BV32_ADD(BV32_MUL(local_id_y$2, 16), local_id_x$2), $$_ZZ13copySharedMemPfS_iiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 16), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13copySharedMemPfS_iiiE4tile"} true;
    v11$1 := (if p7$1 then $$_ZZ13copySharedMemPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1)] else v11$1);
    v11$2 := (if p7$2 then $$_ZZ13copySharedMemPfS_iiiE4tile[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 16), local_id_x$2)] else v11$2);
  ...
  $truebb0:
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile(p3$1, BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1), v7$1, $$_ZZ13copySharedMemPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13copySharedMemPfS_iiiE4tile(p3$2, BV32_ADD(BV32_MUL(local_id_y$2, 16), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile(p3$2, BV32_ADD(BV32_MUL(local_id_y$2, 16), local_id_x$2), v7$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile"} true;
    $$_ZZ13copySharedMemPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1)] := (if p3$1 then v7$1 else $$_ZZ13copySharedMemPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16), local_id_x$1)]);
...
const _WATCHED_VALUE_$$_ZZ13copySharedMemPfS_iiiE4tile: int;

procedure {:inline 1} _LOG_READ_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int);
  modifies _READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;



implementation {:inline 1} _LOG_READ_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int)
{
...
procedure _CHECK_READ_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int, _value_old: int);
  modifies _WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile, _WRITE_READ_BENIGN_FLAG_$$_ZZ13copySharedMemPfS_iiiE4tile;



implementation {:inline 1} _LOG_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int, _value_old: int)
{
...
procedure _CHECK_WRITE_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int, _value: int);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int)
{
...
procedure _CHECK_ATOMIC_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ13copySharedMemPfS_iiiE4tile;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ13copySharedMemPfS_iiiE4tile(_P: bool, _offset: int)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: int, $1: int)
{
  ...
  anon0:
    assume $0 != 0 ==> !_READ_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;
    assume $0 != 0 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;
    assume $0 != 0 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ13copySharedMemPfS_iiiE4tile;
    goto anon1;
