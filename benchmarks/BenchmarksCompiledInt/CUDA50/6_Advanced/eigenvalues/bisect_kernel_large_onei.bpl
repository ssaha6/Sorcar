...
implementation {:source_name "bisectKernelLarge_OneIntervals"} {:kernel} $_Z30bisectKernelLarge_OneIntervalsPfS_jjS_S_Pjf($n: int, $num_intervals: int, $precision: int)
{
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b88 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b87 ==> !_WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "noread"} _b86 ==> !_READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b85 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b84 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b83 ==> !_WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "noread"} _b82 ==> !_READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b81 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE21converged_all_threads ==> _WATCHED_OFFSET == 0;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b80 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE21converged_all_threads ==> _WATCHED_OFFSET == 0;
    assert {:tag "nowrite"} _b79 ==> !_WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE21converged_all_threads;
    assert {:tag "noread"} _b78 ==> !_READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE21converged_all_threads;
    assert {:tag "predicatedEquality"} _b77 ==> p4$1 && p4$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b76 ==> p4$1 && p4$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b75 ==> p4$1 && p4$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b74 ==> p4$1 && p4$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b73 ==> p4$1 && p4$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b72 ==> p4$1 && p4$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b71 ==> p4$1 && p4$2 ==> v27$1 == v27$2;
    ...
    assert {:tag "predicatedEquality"} _b67 ==> p4$1 && p4$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b66 ==> p4$1 && p4$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b65 ==> p4$1 && p4$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b64 ==> p4$1 && p4$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b63 ==> p4$1 && p4$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b62 ==> p4$1 && p4$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b61 ==> p4$1 && p4$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b60 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b59 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b58 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b57 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b56 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b55 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b54 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b53 ==> p4$1 && p4$2 ==> $converged.1$1 == $converged.1$2;
    assert {:tag "predicatedEquality"} _b52 ==> p4$1 && p4$2 ==> $right.3$1 == $right.3$2;
    assert {:tag "predicatedEquality"} _b51 ==> p4$1 && p4$2 ==> $left.3$1 == $left.3$2;
    assert {:tag "predicatedEquality"} _b50 ==> p4$1 && p4$2 ==> $mid.i1.0$1 == $mid.i1.0$2;
    assert {:tag "predicatedEquality"} _b49 ==> p4$1 && p4$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b48 ==> p4$1 && p4$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b47 ==> p4$1 && p4$2 ==> $right.2$1 == $right.2$2;
    assert {:tag "predicatedEquality"} _b46 ==> p4$1 && p4$2 ==> $left.2$1 == $left.2$2;
    assert {:tag "predicatedEquality"} _b45 ==> p4$1 && p4$2 ==> $converged.2$1 == $converged.2$2;
    assert {:tag "predicatedEquality"} _b44 ==> p4$1 && p4$2 ==> $right.4$1 == $right.4$2;
    assert {:tag "predicatedEquality"} _b43 ==> p4$1 && p4$2 ==> $left.4$1 == $left.4$2;
    assert {:tag "predicatedEquality"} _b42 ==> p4$1 && p4$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b41 ==> p4$1 && p4$2 ==> $k.i.0$1 == $k.i.0$2;
    assert {:tag "predicatedEquality"} _b40 ==> p4$1 && p4$2 ==> $count.i.1$1 == $count.i.1$2;
    assert {:tag "predicatedEquality"} _b39 ==> p4$1 && p4$2 ==> $delta.i.1$1 == $delta.i.1$2;
    assert {:tag "predicatedEquality"} _b38 ==> p4$1 && p4$2 ==> $count.i.2$1 == $count.i.2$2;
    assert {:tag "predicatedEquality"} _b37 ==> p4$1 && p4$2 ==> $delta.i.2$1 == $delta.i.2$2;
    assert {:tag "predicatedEquality"} _b36 ==> p4$1 && p4$2 ==> $i.i.0$1 == $i.i.0$2;
    assert {:tag "predicatedEquality"} _b35 ==> p4$1 && p4$2 ==> $rem.i.0$1 == $rem.i.0$2;
    assert {:tag "predicatedEquality"} _b34 ==> p4$1 && p4$2 ==> $count.i.0$1 == $count.i.0$2;
    assert {:tag "predicatedEquality"} _b33 ==> p4$1 && p4$2 ==> $delta.i.0$1 == $delta.i.0$2;
    assert {:tag "predicatedEquality"} _b32 ==> p4$1 && p4$2 ==> $mid.i.0$1 == $mid.i.0$2;
    assert {:tag "predicatedEquality"} _b31 ==> p4$1 && p4$2 ==> $mid.1$1 == $mid.1$2;
    assert {:tag "predicatedEquality"} _b30 ==> p4$1 && p4$2 ==> $mid.0$1 == $mid.0$2;
    assert {:tag "predicatedEquality"} _b29 ==> p4$1 && p4$2 ==> $converged.0$1 == $converged.0$2;
    assert {:tag "predicatedEquality"} _b28 ==> p4$1 && p4$2 ==> $right.1$1 == $right.1$2;
    assert {:tag "predicatedEquality"} _b27 ==> p4$1 && p4$2 ==> $left.1$1 == $left.1$2;
    assert {:tag "loopPredicateEquality"} _b26 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b25 ==> p4$1 == p4$2;
    ...
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b3 ==> BV32_UGE($converged.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b3 ==> BV32_UGE($converged.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b2 ==> BV32_ULE($converged.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b2 ==> BV32_ULE($converged.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b1 ==> BV32_SGE($converged.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b1 ==> BV32_SGE($converged.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b0 ==> BV32_SLE($converged.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b0 ==> BV32_SLE($converged.0$2, 0);
  ...
  __partitioned_block_$11_0:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b124 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch$ghost$__partitioned_block_$11_0 == _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "disabledMaintainsInstrumentation"} _b123 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch$ghost$__partitioned_block_$11_0 == _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b122 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b121 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b120 ==> !_WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "noread"} _b119 ==> !_READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "disabledMaintainsInstrumentation"} _b118 ==> !p4$1 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch$ghost$__partitioned_block_$11_0 == _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "disabledMaintainsInstrumentation"} _b117 ==> !p4$1 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch$ghost$__partitioned_block_$11_0 == _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b116 ==> _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b115 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert p11$1 ==> p4$1;
    assert p11$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> BV32_ULT($i.i.0$1, $n) ==> p11$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> BV32_ULT($i.i.0$2, $n) ==> p11$2;
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b12 ==> BV32_UGE($rem.i.0$1, $n);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b12 ==> BV32_UGE($rem.i.0$2, $n);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b11 ==> BV32_ULE($rem.i.0$1, $n);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b11 ==> BV32_ULE($rem.i.0$2, $n);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b10 ==> BV32_SGE($rem.i.0$1, $n);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b10 ==> BV32_SGE($rem.i.0$2, $n);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b9 ==> BV32_SLE($rem.i.0$1, $n);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b9 ==> BV32_SLE($rem.i.0$2, $n);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b8 ==> BV32_UGE($i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b8 ==> BV32_UGE($i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b7 ==> BV32_ULE($i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b7 ==> BV32_ULE($i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b6 ==> BV32_SGE($i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b6 ==> BV32_SGE($i.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p11$1 ==> _b5 ==> BV32_SLE($i.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p11$2 ==> _b5 ==> BV32_SLE($i.i.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p11$1 ==> _b4 ==> $i.i.0$1 mod group_size_x == 0 mod group_size_x;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p11$2 ==> _b4 ==> $i.i.0$2 mod group_size_x == 0 mod group_size_x;
  ...
  $16:
    ...
    assert {:tag "disabledMaintainsInstrumentation"} _b128 ==> !p16$1 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch$ghost$$16 == _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b127 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "disabledMaintainsInstrumentation"} _b126 ==> !p16$1 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch$ghost$$16 == _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b125 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p11$1 ==> p4$1;
    assert p11$2 ==> p4$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b24 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $num_intervals);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE15s_right_scratch ==> BV32_ULT($i.i.0$1, $n);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $num_intervals);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b21 ==> _READ_HAS_OCCURRED_$$_ZZ30bisectKernelLarge_OneIntervalsPfS_jjS_S_PjfE14s_left_scratch ==> BV32_ULT($i.i.0$1, $n);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_ULT($i.i.0$1, $n) && BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $num_intervals) && BV32_ULT($k.i.0$1, $0$1) ==> p17$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_ULT($i.i.0$2, $n) && BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $num_intervals) && BV32_ULT($k.i.0$2, $0$2) ==> p17$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p17$1 ==> _b19 ==> p17$1 ==> BV32_ULT($i.i.0$1, $n) && BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $num_intervals);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p17$2 ==> _b19 ==> p17$2 ==> BV32_ULT($i.i.0$2, $n) && BV32_ULT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $num_intervals);
    assert {:tag "loopBound"} {:thread 1} p17$1 ==> _b18 ==> BV32_UGE($k.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p17$2 ==> _b18 ==> BV32_UGE($k.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p17$1 ==> _b17 ==> BV32_ULE($k.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p17$2 ==> _b17 ==> BV32_ULE($k.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p17$1 ==> _b16 ==> BV32_SGE($k.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p17$2 ==> _b16 ==> BV32_SGE($k.i.0$2, 0);
    assert {:tag "loopBound"} {:thread 1} p17$1 ==> _b15 ==> BV32_SLE($k.i.0$1, 0);
    assert {:tag "loopBound"} {:thread 2} p17$2 ==> _b15 ==> BV32_SLE($k.i.0$2, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p17$1 ==> _b14 ==> $k.i.0$1 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 2} p17$2 ==> _b14 ==> $k.i.0$2 mod 1 == 0 mod 1;
