...
assert  my_inv (  ( p0$1 ==> $pos.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p0$2 ==> $pos.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p0$1 ==> BV32_SLE($pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SLE($pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_SGE($pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_SGE($pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_ULE($pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_ULE($pos.0$2, local_id_x$2) ) ,  ( p0$1 ==> BV32_UGE($pos.0$1, local_id_x$1) )  && ( p0$2 ==> BV32_UGE($pos.0$2, local_id_x$2) ) ,  (  BV32_SLT($pos.0$1, BV32_SHL(1, $log2N)) ==> p0$1 )  && (  BV32_SLT($pos.0$2, BV32_SHL(1, $log2N)) ==> p0$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  (  BV32_SLE($stride.0, BV32_ASHR(v0, 2)) ) ,  (  BV32_SGE($stride.0, BV32_ASHR(v0, 2)) ) ,  (  BV32_ULE($stride.0, BV32_ASHR(v0, 2)) ) ,  (  BV32_UGE($stride.0, BV32_ASHR(v0, 2)) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride.0 == 0 || BV32_AND($stride.0, BV32_SUB($stride.0, 1)) == 0 ) ,  (  $stride.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$s_data ) ,  (  !_WRITE_HAS_OCCURRED_$$s_data ) ,  (  _READ_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p6$1 ==> $pos7.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p6$2 ==> $pos7.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p6$1 ==> BV32_SLE($pos7.0$1, local_id_x$1) )  && ( p6$2 ==> BV32_SLE($pos7.0$2, local_id_x$2) ) ,  ( p6$1 ==> BV32_SGE($pos7.0$1, local_id_x$1) )  && ( p6$2 ==> BV32_SGE($pos7.0$2, local_id_x$2) ) ,  ( p6$1 ==> BV32_ULE($pos7.0$1, local_id_x$1) )  && ( p6$2 ==> BV32_ULE($pos7.0$2, local_id_x$2) ) ,  ( p6$1 ==> BV32_UGE($pos7.0$1, local_id_x$1) )  && ( p6$2 ==> BV32_UGE($pos7.0$2, local_id_x$2) ) ,  (  BV32_SLT($pos7.0$1, BV32_SHL(1, $log2N)) ==> p6$1 )  && (  BV32_SLT($pos7.0$2, BV32_SHL(1, $log2N)) ==> p6$2 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> BV32_SLE(BV32_SHL(group_id_x$1, $log2N), _WATCHED_OFFSET) ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> BV32_SLT(_WATCHED_OFFSET, BV32_SHL(BV32_ADD(group_id_x$1, 1), $log2N)) ) ,  (  _WRITE_HAS_OCCURRED_$$d_Output ==> _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _READ_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod group_size_x == local_id_x$1 mod group_size_x ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p3$1 ==> $pos2.0$1 mod group_size_x == local_id_x$1 mod group_size_x )  && ( p3$2 ==> $pos2.0$2 mod group_size_x == local_id_x$2 mod group_size_x ) ,  ( p3$1 ==> BV32_SLE($pos2.0$1, local_id_x$1) )  && ( p3$2 ==> BV32_SLE($pos2.0$2, local_id_x$2) ) ,  ( p3$1 ==> BV32_SGE($pos2.0$1, local_id_x$1) )  && ( p3$2 ==> BV32_SGE($pos2.0$2, local_id_x$2) ) ,  ( p3$1 ==> BV32_ULE($pos2.0$1, local_id_x$1) )  && ( p3$2 ==> BV32_ULE($pos2.0$2, local_id_x$2) ) ,  ( p3$1 ==> BV32_UGE($pos2.0$1, local_id_x$1) )  && ( p3$2 ==> BV32_UGE($pos2.0$2, local_id_x$2) ) ,  ( p3$1 ==> p3$1 ==> BV32_AND($log2N, 1) != 0 )  && ( p3$2 ==> p3$2 ==> BV32_AND($log2N, 1) != 0 ) ,  (  BV32_AND($log2N, 1) != 0 && BV32_SLT($pos2.0$1, BV32_SDIV(BV32_SHL(1, $log2N), 2)) ==> p3$1 )  && (  BV32_AND($log2N, 1) != 0 && BV32_SLT($pos2.0$2, BV32_SDIV(BV32_SHL(1, $log2N), 2)) ==> p3$2 ) ,  (  _READ_HAS_OCCURRED_$$s_data ==> BV32_AND($log2N, 1) != 0 ) ,  (  _WRITE_HAS_OCCURRED_$$s_data ==> BV32_AND($log2N, 1) != 0 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $pos2.0$1 == 0 || BV32_AND($pos2.0$1, BV32_SUB($pos2.0$1, 1)) == 0 ) ,  (  $pos2.0$1 != 0 ) ,  (  $pos2.0$2 == 0 || BV32_AND($pos2.0$2, BV32_SUB($pos2.0$2, 1)) == 0 ) ,  (  $pos2.0$2 != 0 ) ,  (  v20$1 == 0 || BV32_AND(v20$1, BV32_SUB(v20$1, 1)) == 0 ) ,  (  v20$1 != 0 ) ,  (  v20$2 == 0 || BV32_AND(v20$2, BV32_SUB(v20$2, 1)) == 0 ) ,  (  v20$2 != 0 ) ,  (  _READ_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$s_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == BV32_ADD(0, 1) mod 1 )  ); 
