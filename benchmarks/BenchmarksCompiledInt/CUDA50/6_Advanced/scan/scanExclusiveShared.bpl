...
implementation {:source_name "scanExclusiveShared"} {:kernel} $_Z19scanExclusiveSharedP5uint4S0_j($size: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB(BV32_UDIV($size, 4), 1))), BV32_UDIV($size, 4));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB(BV32_UDIV($size, 4), 1))), BV32_UDIV($size, 4)) || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ19scanExclusiveSharedP5uint4S0_jE6s_Data;
    assert {:tag "pow2NotZero"} _b5 ==> $offset.i.i.i.i.0 != 0;
    assert {:tag "pow2"} _b4 ==> $offset.i.i.i.i.0 == 0 || BV32_AND($offset.i.i.i.i.0, BV32_SUB($offset.i.i.i.i.0, 1)) == 0;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($offset.i.i.i.i.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($offset.i.i.i.i.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($offset.i.i.i.i.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($offset.i.i.i.i.0, 1);
