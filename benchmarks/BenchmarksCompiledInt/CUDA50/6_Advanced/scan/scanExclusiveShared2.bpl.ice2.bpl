...
assert  my_inv (  (  BV32_SLE($offset.i.i.0, 1) ) ,  (  BV32_SGE($offset.i.i.0, 1) ) ,  (  BV32_ULE($offset.i.i.0, 1) ) ,  (  BV32_UGE($offset.i.i.0, 1) ) ,  (  $offset.i.i.0 == 0 || BV32_AND($offset.i.i.0, BV32_SUB($offset.i.i.0, 1)) == 0 ) ,  (  $offset.i.i.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ) ,  (  _READ_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB($arrayLength, 1))), $arrayLength) || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ20scanExclusiveShared2PjS_S_jjE6s_Data ==> _WATCHED_OFFSET == BV32_ADD(BV32_SUB(BV32_MUL(2, local_id_x$1), BV32_AND(local_id_x$1, BV32_SUB($arrayLength, 1))), $arrayLength) )  ); 
