...
assert  my_inv (  true ,  true ,  true ,  true ,  (  BV32_SLE($stride2.0, 512) ) ,  (  BV32_SGE($stride2.0, 512) ) ,  (  BV32_ULE($stride2.0, 512) ) ,  (  BV32_UGE($stride2.0, 512) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  $stride2.0 == 0 || BV32_AND($stride2.0, BV32_SUB($stride2.0, 1)) == 0 ) ,  (  $stride2.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_key ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ18bitonicSortShared1PjS_S_S_E5s_val ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true  ); 
