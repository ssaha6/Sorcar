...
assert  my_inv (  (  BV32_SLE($s.0, 1bv32) ) ,  (  BV32_SGE($s.0, 1bv32) ) ,  (  BV32_ULE($s.0, 1bv32) ) ,  (  BV32_UGE($s.0, 1bv32) ) ,  (  $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32 ) ,  (  $s.0 != 0bv32 ) ,  (  !_READ_HAS_OCCURRED_$$__smem ) ,  (  !_WRITE_HAS_OCCURRED_$$__smem ) ,  (  _READ_HAS_OCCURRED_$$__smem ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), BV32_MUL(BV32_MUL(0bv32, 2bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$__smem ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), BV32_MUL(BV32_MUL(0bv32, 2bv32), local_id_x$1)) ) ,  (  _WRITE_HAS_OCCURRED_$$__smem ==> local_id_x$1 == BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $s.0) )  ); 
