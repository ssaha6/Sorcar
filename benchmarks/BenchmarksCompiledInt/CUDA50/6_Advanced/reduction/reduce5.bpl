...
procedure {:source_name "reduce5<int, 256>"} {:kernel} $_Z7reduce5IiLj256EEvPT_S1_j($n: int);
...
implementation {:source_name "reduce5<int, 256>"} {:kernel} $_Z7reduce5IiLj256EEvPT_S1_j($n: int)
{
  var $0$1: int;
  var $0$2: int;
  var $mySum.0$1: int;
  ...
  __partitioned_block_$0_1:
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$__smem(p4$1, BV32_ADD(local_id_x$1, 128), $$__smem[1bv1][BV32_ADD(local_id_x$1, 128)]);
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$__smem(p4$2, BV32_ADD(local_id_x$2, 128), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 128)]);
    ...
    v6$1 := (if p4$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 128)] else v6$1);
    v6$2 := (if p4$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 128)] else v6$2);
  ...
  __partitioned_block_$0_2:
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 64), $$__smem[1bv1][BV32_ADD(local_id_x$1, 64)]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 16} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 64), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 64)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v9$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 64)] else v9$1);
    v9$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 64)] else v9$2);
  ...
  __partitioned_block_$0_3:
    ...
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v12$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 32)] else v12$1);
    v12$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32)] else v12$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 16), $$__smem[1bv1][BV32_ADD(local_id_x$1, 16)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 16), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v14$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 16)] else v14$1);
    v14$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16)] else v14$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 8), $$__smem[1bv1][BV32_ADD(local_id_x$1, 8)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 8), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v16$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 8)] else v16$1);
    v16$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8)] else v16$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 4), $$__smem[1bv1][BV32_ADD(local_id_x$1, 4)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 4), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v18$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 4)] else v18$1);
    v18$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4)] else v18$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 2), $$__smem[1bv1][BV32_ADD(local_id_x$1, 2)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 2), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v20$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 2)] else v20$1);
    v20$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2)] else v20$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    call {:sourceloc} {:sourceloc_num 31} _LOG_READ_$$__smem(p8$1, BV32_ADD(local_id_x$1, 1), $$__smem[1bv1][BV32_ADD(local_id_x$1, 1)]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 31} _CHECK_READ_$$__smem(p8$2, BV32_ADD(local_id_x$2, 1), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v22$1 := (if p8$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 1)] else v22$1);
    v22$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1)] else v22$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p8$1, p8$2);
    ...
    call {:sourceloc} {:sourceloc_num 35} _LOG_READ_$$__smem(p10$1, 0, $$__smem[1bv1][0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 35} _CHECK_READ_$$__smem(p10$2, 0, $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p10$1, p10$2);
    v24$1 := (if p10$1 then $$__smem[1bv1][0] else v24$1);
    v24$2 := (if p10$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0] else v24$2);
