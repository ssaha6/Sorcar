...
implementation {:source_name "reduce4<int, 256>"} {:kernel} $_Z7reduce4IiLj256EEvPT_S1_j($n: int)
{
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _WRITE_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _READ_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1;
