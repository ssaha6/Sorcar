...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> _WATCHED_OFFSET mod 1 == BV32_ADD(-7, local_id_y$1) mod 1 ) ,  (  !p8$1 ==> _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf$ghost$$12 == _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf )  ); 
...
assert  my_inv (  ( p9$1 ==> $k.0$1 mod 1 == -7 mod 1 )  && ( p9$2 ==> $k.0$2 mod 1 == -7 mod 1 ) ,  ( p9$1 ==> BV32_SLE($k.0$1, -7) )  && ( p9$2 ==> BV32_SLE($k.0$2, -7) ) ,  ( p9$1 ==> BV32_SGE($k.0$1, -7) )  && ( p9$2 ==> BV32_SGE($k.0$2, -7) ) ,  ( p9$1 ==> BV32_ULE($k.0$1, -7) )  && ( p9$2 ==> BV32_ULE($k.0$2, -7) ) ,  ( p9$1 ==> BV32_UGE($k.0$1, -7) )  && ( p9$2 ==> BV32_UGE($k.0$2, -7) ) ,  ( p9$1 ==> p9$1 ==> BV32_SGE(local_id_y$1, 7) && BV32_SLT(local_id_y$1, 121) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114), local_id_y$1), 7), 512) )  && ( p9$2 ==> p9$2 ==> BV32_SGE(local_id_y$2, 7) && BV32_SLT(local_id_y$2, 121) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114), local_id_y$2), 7), 512) ) ,  (  BV32_SGE(local_id_y$1, 7) && BV32_SLT(local_id_y$1, 121) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114), local_id_y$1), 7), 512) && BV32_SLE($k.0$1, 7) ==> p9$1 )  && (  BV32_SGE(local_id_y$2, 7) && BV32_SLT(local_id_y$2, 121) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114), local_id_y$2), 7), 512) && BV32_SLE($k.0$2, 7) ==> p9$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SGE(local_id_y$1, 7) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SLT(local_id_y$1, 121) ) ,  (  _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114), local_id_y$1), 7), 512) ) ,  true ,  true  ); 
