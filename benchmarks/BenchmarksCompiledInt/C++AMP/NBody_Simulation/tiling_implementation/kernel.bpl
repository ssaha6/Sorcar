...
implementation {:source_name "tiling_implementation"} {:kernel} $_Z21tiling_implementationP6float4S0_S0_S0_iii($offset: int, $size: int, $num_bodies: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 2) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4), 3);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b13 ==> _READ_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(0, 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 1), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 2), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 3), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 3) mod BV32_MUL(4, 4);
    assert {:tag "nowrite"} _b12 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem;
    assert {:tag "noread"} _b11 ==> !_READ_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem;
    ...
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_UGE($tile.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_ULE($tile.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SGE($tile.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SLE($tile.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b1 ==> $tile.0 mod 1 == 0 mod 1;
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> $particle_idx.0$1 mod 256 == local_id_x$1 mod 256;
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> $particle_idx.0$2 mod 256 == local_id_x$2 mod 256;
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _READ_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(0, 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(0, 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 1), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 1), 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 2), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 2), 4), 3) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_MUL(BV32_ADD(0, 3), 4) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 1) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 2) mod BV32_MUL(4, 4) || _WATCHED_OFFSET mod BV32_MUL(4, 4) == BV32_ADD(BV32_MUL(BV32_ADD(0, 3), 4), 3) mod BV32_MUL(4, 4);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21tiling_implementationP6float4S0_S0_S0_iiiE8tile_mem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_UGE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_ULE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_SGE($j.0, 0);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SLE($j.0, 0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b6 ==> $j.0 mod 4 == 0 mod 4;
