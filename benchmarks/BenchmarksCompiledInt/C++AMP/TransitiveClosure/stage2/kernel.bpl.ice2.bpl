...
assert  my_inv (  (  $k.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($k.0, 0) ) ,  (  BV32_SGE($k.0, 0) ) ,  (  BV32_ULE($k.0, 0) ) ,  (  BV32_UGE($k.0, 0) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer ) ,  (  _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(local_id_y$1, 8)) mod 1 || _WATCHED_OFFSET mod BV32_MUL(1, 8) == BV32_ADD(BV32_MUL(0, 8), local_id_x$1) mod BV32_MUL(1, 8) ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ) ,  (  _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8), local_id_x$1) || _WATCHED_OFFSET mod BV32_MUL(1, 8) == BV32_ADD(BV32_MUL(0, 8), local_id_x$1) mod BV32_MUL(1, 8) || _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(local_id_y$1, 8)) mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8), local_id_x$1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8), local_id_x$1) )  ); 
