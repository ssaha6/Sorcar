...
implementation {:source_name "transitive_closure_stage1_kernel"} {:kernel} $_Z32transitive_closure_stage1_kernelPji($passnum: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage1_kernelPjiE20primary_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage1_kernelPjiE20primary_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8), local_id_x$1) || _WATCHED_OFFSET mod 1 == BV32_ADD(0, BV32_MUL(local_id_y$1, 8)) mod 1 || _WATCHED_OFFSET mod BV32_MUL(1, 8) == BV32_ADD(BV32_MUL(0, 8), local_id_x$1) mod BV32_MUL(1, 8);
    assert {:tag "nowrite"} _b6 ==> !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage1_kernelPjiE20primary_block_buffer;
    assert {:tag "noread"} _b5 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage1_kernelPjiE20primary_block_buffer;
