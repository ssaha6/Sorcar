...
implementation {:source_name "histo_merge_kernel"} {:kernel} $_Z18histo_merge_kernelPjS_()
{
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data ==> _WATCHED_OFFSET mod 1 == BV32_ADD(0, local_id_x$1) mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
