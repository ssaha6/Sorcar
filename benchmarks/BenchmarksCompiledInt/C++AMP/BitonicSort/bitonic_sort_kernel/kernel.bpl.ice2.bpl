...
assert  my_inv (  (  BV32_SLE($j.0, BV32_LSHR($ulevel, 1)) ) ,  (  BV32_SGE($j.0, BV32_LSHR($ulevel, 1)) ) ,  (  BV32_ULE($j.0, BV32_LSHR($ulevel, 1)) ) ,  (  BV32_UGE($j.0, BV32_LSHR($ulevel, 1)) ) ,  (  $j.0 == 0 || BV32_AND($j.0, BV32_SUB($j.0, 1)) == 0 ) ,  (  $j.0 != 0 ) ,  (  !_READ_HAS_OCCURRED_$$_ZZ19bitonic_sort_kernelPfjjE7sh_data ) ,  (  !_WRITE_HAS_OCCURRED_$$_ZZ19bitonic_sort_kernelPfjjE7sh_data ) ,  (  _READ_HAS_OCCURRED_$$_ZZ19bitonic_sort_kernelPfjjE7sh_data ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 ) ,  (  _WRITE_HAS_OCCURRED_$$_ZZ19bitonic_sort_kernelPfjjE7sh_data ==> _WATCHED_OFFSET == local_id_x$1 )  ); 
