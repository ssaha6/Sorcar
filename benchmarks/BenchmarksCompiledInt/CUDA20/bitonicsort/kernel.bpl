...
implementation {:source_name "BitonicKernel"} {:kernel} $_Z13BitonicKernelPi()
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b13 ==> _WRITE_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b12 ==> _READ_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b11 ==> !_WRITE_HAS_OCCURRED_$$shared;
    assert {:tag "noread"} _b10 ==> !_READ_HAS_OCCURRED_$$shared;
    assert {:tag "pow2NotZero"} _b9 ==> $k.0 != 0;
    assert {:tag "pow2"} _b8 ==> $k.0 == 0 || BV32_AND($k.0, BV32_SUB($k.0, 1)) == 0;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($k.0, 2);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($k.0, 2);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($k.0, 2);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($k.0, 2);
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _WRITE_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _READ_HAS_OCCURRED_$$shared ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b15 ==> !_WRITE_HAS_OCCURRED_$$shared;
    assert {:tag "noread"} _b14 ==> !_READ_HAS_OCCURRED_$$shared;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$shared ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($j.0, BV32_UDIV($k.0, 2));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($j.0, BV32_UDIV($k.0, 2));
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($j.0, BV32_UDIV($k.0, 2));
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($j.0, BV32_UDIV($k.0, 2));
