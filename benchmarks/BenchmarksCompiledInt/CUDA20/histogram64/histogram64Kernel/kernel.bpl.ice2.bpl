...
assert  my_inv (  (  $i.0 mod 1 == 0 mod 1 ) ,  (  BV32_SLE($i.0, 0) ) ,  (  BV32_SGE($i.0, 0) ) ,  (  BV32_ULE($i.0, 0) ) ,  (  BV32_UGE($i.0, 0) ) ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> _WATCHED_OFFSET mod BV32_MUL(1, 128) == BV32_ADD(BV32_MUL(0, 128), local_id_x$1) mod BV32_MUL(1, 128) ) ,  true  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  (  !p3$1 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist$ghost$$10 == _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist )  ); 
...
assert  my_inv (  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  true ,  ( p4$1 ==> $j.0$1 mod 1 == 0 mod 1 )  && ( p4$2 ==> $j.0$2 mod 1 == 0 mod 1 ) ,  ( p4$1 ==> BV32_SLE($j.0$1, 0) )  && ( p4$2 ==> BV32_SLE($j.0$2, 0) ) ,  ( p4$1 ==> BV32_SGE($j.0$1, 0) )  && ( p4$2 ==> BV32_SGE($j.0$2, 0) ) ,  ( p4$1 ==> BV32_ULE($j.0$1, 0) )  && ( p4$2 ==> BV32_ULE($j.0$2, 0) ) ,  ( p4$1 ==> BV32_UGE($j.0$1, 0) )  && ( p4$2 ==> BV32_UGE($j.0$2, 0) ) ,  ( p4$1 ==> BV32_SLE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15), 4)) )  && ( p4$2 ==> BV32_SLE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15), 4)) ) ,  ( p4$1 ==> BV32_SGE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15), 4)) )  && ( p4$2 ==> BV32_SGE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15), 4)) ) ,  ( p4$1 ==> BV32_ULE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15), 4)) )  && ( p4$2 ==> BV32_ULE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15), 4)) ) ,  ( p4$1 ==> BV32_UGE($accumPos.0$1, BV32_MUL(BV32_AND(local_id_x$1, 15), 4)) )  && ( p4$2 ==> BV32_UGE($accumPos.0$2, BV32_MUL(BV32_AND(local_id_x$2, 15), 4)) ) ,  ( p4$1 ==> p4$1 ==> BV32_ULT(local_id_x$1, 64) )  && ( p4$2 ==> p4$2 ==> BV32_ULT(local_id_x$2, 64) ) ,  (  BV32_ULT(local_id_x$1, 64) && BV32_SLT($j.0$1, 128) ==> p4$1 )  && (  BV32_ULT(local_id_x$2, 64) && BV32_SLT($j.0$2, 128) ==> p4$2 ) ,  (  _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjS_iE6s_Hist ==> BV32_ULT(local_id_x$1, 64) ) ,  true ,  true  ); 
