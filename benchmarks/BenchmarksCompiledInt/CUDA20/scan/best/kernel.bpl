...
implementation {:source_name "scanBestKernel"} {:kernel} $_Z14scanBestKernelPfS_i($n: int)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b49 ==> _WRITE_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp ==> _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b48 ==> _READ_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "nowrite"} _b47 ==> !_WRITE_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp;
    assert {:tag "noread"} _b46 ==> !_READ_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp;
    ...
    assert {:tag "pow2NotZero"} _b13 ==> v6 != 0;
    assert {:tag "pow2"} _b12 ==> v6 == 0 || BV32_AND(v6, BV32_SUB(v6, 1)) == 0;
  ...
  $9:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b91 ==> _WRITE_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b90 ==> _READ_HAS_OCCURRED_$$_ZZ14scanBestKernelPfS_iE4temp ==> _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod 1 == 0 mod 1;
    ...
    assert {:tag "pow2NotZero"} _b55 ==> v16 != 0;
    assert {:tag "pow2"} _b54 ==> v16 == 0 || BV32_AND(v16, BV32_SUB(v16, 1)) == 0;
