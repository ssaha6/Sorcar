...
implementation {:source_name "kernel"} {:kernel} $_Z6kernelPfS_i($n: int)
{
  ...
  $4:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n) || _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n) || _WATCHED_OFFSET mod 1 == 0 mod 1 || _WATCHED_OFFSET mod BV32_MUL(1, $n) == BV32_ADD(BV32_MUL(0, $n), local_id_x$1) mod BV32_MUL(1, $n);
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp;
    assert {:tag "pow2NotZero"} _b5 ==> $offset.0 != 0;
    assert {:tag "pow2"} _b4 ==> $offset.0 == 0 || BV32_AND($offset.0, BV32_SUB($offset.0, 1)) == 0;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($offset.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($offset.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($offset.0, 1);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($offset.0, 1);
