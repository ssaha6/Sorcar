...
namespace horn_verification
{
	...
	public:
		...
		/**
		 * Reads horn constraints from file. Each line is a comma separated list of natural numbers
		 * and defines a single horn constraint. Each constraint consists of a \e body and a \e head.
		 * <ul>
