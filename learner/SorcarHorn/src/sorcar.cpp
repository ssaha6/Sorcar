...
void display_usage (std::ostream & out)
{
	...
	out << "\t\t\thorndini, sorcar, sorcar-first" << std::endl;
...
enum algorithm
{
	...
	/// Sorcar with greadily adding the first relevant predicates
	SORCAR_FIRST,
...
int main(int argc, char * const argv[]) {
	...
	// Sorcar
	//
	else if (alg == algorithm::SORCAR || alg == algorithm::SORCAR_FIRST)
	{
